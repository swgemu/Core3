...
s,@DEFS@,|#_!!_#|-DPACKAGE_NAME=\\"\\" -DPACKAGE_TARNAME=\\"\\" -DPACKAGE_VERSION=\\"\\" -DPACKAGE_STRING=\\"\\" -DPACKAGE_BUGREPORT=\\"\\" -DPACKAGE=\\"core3\\" -DVERSION=\\"1.0\\",g
s,@ECHO_C@,|#_!!_#|,g
s,@ECHO_N@,|#_!!_#|-n,g
s,@ECHO_T@,|#_!!_#|,g
s,@LIBS@,|#_!!_#|,g
...
s,@target@,|#_!!_#|i686-pc-cygwin,g
s,@target_cpu@,|#_!!_#|i686,g
s,@target_vendor@,|#_!!_#|pc,g
s,@target_os@,|#_!!_#|cygwin,g
...
s,@PACKAGE@,|#_!!_#|core3,g
s,@VERSION@,|#_!!_#|1.0,g
s,@ACLOCAL@,|#_!!_#|${SHELL} /cygdrive/d/Programming/Projects/swgemu/MMOCoreORB/build/unix/config/missing --run aclocal-1.10,g
s,@AUTOCONF@,|#_!!_#|${SHELL} /cygdrive/d/Programming/Projects/swgemu/MMOCoreORB/build/unix/config/missing --run autoconf,g
s,@AUTOMAKE@,|#_!!_#|${SHELL} /cygdrive/d/Programming/Projects/swgemu/MMOCoreORB/build/unix/config/missing --run automake-1.10,g
s,@AUTOHEADER@,|#_!!_#|${SHELL} /cygdrive/d/Programming/Projects/swgemu/MMOCoreORB/build/unix/config/missing --run autoheader,g
s,@MAKEINFO@,|#_!!_#|${SHELL} /cygdrive/d/Programming/Projects/swgemu/MMOCoreORB/build/unix/config/missing --run makeinfo,g
s,@install_sh@,|#_!!_#|$(SHELL) /cygdrive/d/Programming/Projects/swgemu/MMOCoreORB/build/unix/config/install-sh,g
s,@STRIP@,|#_!!_#|,g
...
s,@AMTAR@,|#_!!_#|${SHELL} /cygdrive/d/Programming/Projects/swgemu/MMOCoreORB/build/unix/config/missing --run tar,g
s,@am__tar@,|#_!!_#|${AMTAR} chof - "$$tardir",g
s,@am__untar@,|#_!!_#|${AMTAR} xf -,g
s,@CXX@,|#_!!_#|g++,g
s,@CXXFLAGS@,|#_!!_#|-ggdb -Wno-deprecated ,g
s,@LDFLAGS@,|#_!!_#|,g
s,@CPPFLAGS@,|#_!!_#|,g
s,@ac_ct_CXX@,|#_!!_#|g++,g
s,@EXEEXT@,|#_!!_#|.exe,g
...
s,@CFLAGS@,|#_!!_#|-ggdb -Wno-deprecated ,g
s,@SYSTEM_INCLUDES@,|#_!!_#|,g
s,@SYSTEM_LIBS@,|#_!!_#|-lpthread -lwsock32,g
s,@USER_INCLUDES_PATH@,|#_!!_#|/usr/local/include,g
