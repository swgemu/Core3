...
enragedDuneKimogila = Creature:new {
	objectName = "enragedDuneKimogila",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(enragedDuneKimogila, 533451918) --  Add to Global Table
