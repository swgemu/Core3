...
warrenAgroDroidS01 = Creature:new {
	objectName = "warrenAgroDroidS01",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Warren Teraud",
	gender = "",

	speciesName = "warren_agro_droid_s01",
...
Creatures:addCreature(warrenAgroDroidS01, 162667025) -- Add to Global Table
