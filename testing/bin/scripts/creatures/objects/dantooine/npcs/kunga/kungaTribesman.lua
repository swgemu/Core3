...
kungaTribesman = Creature:new {
	objectName = "kungaTribesman",  -- Lua Object Name
	creatureType = "NPC",
	faction = "kunga_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "kunga_tribesman",
...
Creatures:addCreature(kungaTribesman, 4083847450) --  Add to Global Table
