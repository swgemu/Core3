...
stintarilRavager = Creature:new {
	objectName = "stintarilRavager",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "stintaril_ravager",
	...
	skills = { "stintarilAttack2", "stintarilAttack4" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(stintarilRavager, 3055227574) --  Add to Global Table
