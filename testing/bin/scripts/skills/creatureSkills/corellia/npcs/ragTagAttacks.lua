...
--MERCragTagTABILITY or FITNESS FOR A PARTICULAR PURPOSE. 
...
--license (or modified versions of such code, with uncragTagged license). 
...
AddRandomPoolAttackTargetSkill(ragTagAttack1)
