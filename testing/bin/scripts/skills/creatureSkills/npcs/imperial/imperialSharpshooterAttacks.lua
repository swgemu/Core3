...
imperialSharpshooterAttack1 = { 
	attackname = "imperialSharpshooterAttack1",
...
AddRandomPoolAttackTargetSkill(imperialSharpshooterAttack1)

-----------------------------------------------------------------------

imperialSharpshooterAttack2 = { 
	attackname = "imperialSharpshooterAttack2",
...
AddDirectPoolAttackTargetSkill(imperialSharpshooterAttack2)

-----------------------------------------------------------------------

imperialSharpshooterAttack3 = { 
	attackname = "imperialSharpshooterAttack3",
...
AddRandomPoolAttackTargetSkill(imperialSharpshooterAttack3)

-----------------------------------------------------------------------

imperialSharpshooterAttack4 = { 
	attackname = "imperialSharpshooterAttack4",
...
AddRandomPoolAttackTargetSkill(imperialSharpshooterAttack4)
