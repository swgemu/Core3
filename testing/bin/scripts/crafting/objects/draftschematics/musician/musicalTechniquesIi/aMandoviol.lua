...
aMandoviol = Object:new {
   ...
   tanoAttributes = "objecttype=8204:objectcrc=1784205003:stfFile=obj_n:stfName=obj_mandoviol:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(aMandoviol, 1835965889)--- Add to global DraftSchematics table
