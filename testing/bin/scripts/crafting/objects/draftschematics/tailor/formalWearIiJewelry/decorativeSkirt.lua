...
decorativeSkirt = Object:new {

   objectName = "Decorative Skirt",
   stfName = "skirt_s09",
   stfFile = "wearables_name",
   objectCRC = 2788402647,
...
DraftSchematics:addDraftSchematic(decorativeSkirt, 2788402647)--- Add to global DraftSchematics table
