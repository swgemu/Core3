...
jewelrySetting = Object:new {

   objectName = "Jewelry Setting",
   stfName = "jewelry_setting",
   stfFile = "craft_clothing_ingredients_n",
   objectCRC = 3119926044,
...
DraftSchematics:addDraftSchematic(jewelrySetting, 3119926044)--- Add to global DraftSchematics table
