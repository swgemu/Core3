...
sportsWrap = Object:new {

   objectName = "Sports Wrap",
   stfName = "shirt_s24",
   stfFile = "wearables_name",
   objectCRC = 2529318953,
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=2976519446:stfFile=wearables_name:stfName=shirt_s24:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(sportsWrap, 2529318953)--- Add to global DraftSchematics table
