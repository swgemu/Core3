...
techPack = Object:new {
   ...
   objectName = "Tech Pack",
   stfName = "backpack_s04",
   ...
   resourceTypes = "object/tangible/component/clothing/shared_cargo_pocket.iff, ***BAD NAME***, hide, metal",
...
DraftSchematics:addDraftSchematic(techPack, 316671054)--- Add to global DraftSchematics table
