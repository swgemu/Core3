...
ithorianCamos = Object:new {

   objectName = "Ithorian Camos",
   stfName = "ith_pants_s05",
   stfFile = "wearables_name",
   objectCRC = 2038437687,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=1672135181:stfFile=wearables_name:stfName=clothing_ith_pants_field_05:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianCamos, 2038437687)--- Add to global DraftSchematics table
