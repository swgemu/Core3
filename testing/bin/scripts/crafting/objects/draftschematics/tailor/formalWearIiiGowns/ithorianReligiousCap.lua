...
ithorianReligiousCap = Object:new {

   objectName = "Ithorian Religious Cap",
   stfName = "ith_hat_s02",
   stfFile = "wearables_name",
   objectCRC = 2763835769,
   ...
   tanoAttributes = "objecttype=16777226:objectcrc=1903477549:stfFile=wearables_name:stfName=ith_hat_s02:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianReligiousCap, 2763835769)--- Add to global DraftSchematics table
