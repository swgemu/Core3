...
ithorianStripedSkirt = Object:new {

   objectName = "Ithorian Striped Skirt",
   stfName = "ith_skirt_s01",
   stfFile = "wearables_name",
   objectCRC = 1754490583,
   ...
   tanoAttributes = "objecttype=16777234:objectcrc=1917673273:stfFile=wearables_name:stfName=ith_skirt_s01:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianStripedSkirt, 1754490583)--- Add to global DraftSchematics table
