...
ithorianLeatherGear = Object:new {

   objectName = "Ithorian Leather Gear",
   stfName = "ith_bodysuit_s06",
   stfFile = "wearables_name",
   objectCRC = 1374079687,
...
DraftSchematics:addDraftSchematic(ithorianLeatherGear, 1374079687)--- Add to global DraftSchematics table
