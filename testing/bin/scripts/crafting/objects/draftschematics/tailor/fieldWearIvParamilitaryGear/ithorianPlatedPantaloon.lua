...
ithorianPlatedPantaloon = Object:new {

   objectName = "Ithorian Plated Pantaloon",
   stfName = "ith_pants_s20",
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=1006845171:stfFile=wearables_name:stfName=ith_pants_s20:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianPlatedPantaloon, 640281033)--- Add to global DraftSchematics table
