...
ithorianLargePendant = Object:new {

   objectName = "Ithorian Large Pendant",
   stfName = "ith_necklace_s08",
   stfFile = "wearables_name",
   objectCRC = 3570881933,
...
DraftSchematics:addDraftSchematic(ithorianLargePendant, 3570881933)--- Add to global DraftSchematics table
