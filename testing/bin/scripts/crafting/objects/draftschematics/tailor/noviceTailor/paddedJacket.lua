...
paddedJacket = Object:new {

   objectName = "Padded Jacket",
   stfName = "jacket_s05",
   stfFile = "wearables_name",
   objectCRC = 1894689804,
   ...
   tanoAttributes = "objecttype=:objectcrc=3072681244:stfFile=wearables_name:stfName=jacket_s05:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(paddedJacket, 1894689804)--- Add to global DraftSchematics table
