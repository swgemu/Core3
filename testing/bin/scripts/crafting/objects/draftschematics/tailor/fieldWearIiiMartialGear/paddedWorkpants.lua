...
paddedWorkpants = Object:new {

   objectName = "Padded Workpants",
   stfName = "pants_s30",
   stfFile = "wearables_name",
   objectCRC = 3290815608,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=1326178671:stfFile=wearables_name:stfName=pants_s30:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(paddedWorkpants, 3290815608)--- Add to global DraftSchematics table
