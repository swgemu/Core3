...
dressSlacks = Object:new {

   objectName = "Dress Slacks",
   stfName = "pants_s15",
   stfFile = "wearables_name",
   objectCRC = 1077627351,
...
DraftSchematics:addDraftSchematic(dressSlacks, 1077627351)--- Add to global DraftSchematics table
