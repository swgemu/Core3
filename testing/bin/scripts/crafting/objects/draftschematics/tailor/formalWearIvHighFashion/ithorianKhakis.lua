...
ithorianKhakis = Object:new {

   objectName = "Ithorian Khakis",
   stfName = "ith_pants_s14",
   stfFile = "wearables_name",
   objectCRC = 2256530012,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=831498488:stfFile=wearables_name:stfName=ith_pants_s14:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianKhakis, 2256530012)--- Add to global DraftSchematics table
