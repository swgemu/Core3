...
dressUniformJacket = Object:new {

   objectName = "Dress Uniform Jacket",
   stfName = "jacket_s25",
   stfFile = "wearables_name",
   objectCRC = 4016494034,
   ...
   resourceTypes = "object/tangible/component/clothing/shared_synthetic_cloth.iff, hide, object/tangible/component/clothing/shared_trim.iff, object/tangible/component/clothing/shared_synthetic_cloth.iff",
   resourceQuantities = "0, 30, 2, 3",
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=2171961324:stfFile=wearables_name:stfName=jacket_s25:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(dressUniformJacket, 4016494034)--- Add to global DraftSchematics table
