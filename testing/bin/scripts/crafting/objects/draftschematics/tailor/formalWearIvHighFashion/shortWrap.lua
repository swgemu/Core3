...
shortWrap = Object:new {

   objectName = "Short Wrap",
   stfName = "pants_s32",
   stfFile = "wearables_name",
   objectCRC = 2374531123,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=3708890741:stfFile=wearables_name:stfName=pants_s32:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(shortWrap, 2374531123)--- Add to global DraftSchematics table
