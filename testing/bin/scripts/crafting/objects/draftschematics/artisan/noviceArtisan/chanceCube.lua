...
chanceCube = Object:new {
   ...
   tanoAttributes = "objecttype=8211:objectcrc=572459271:stfFile=dice/dice_details:stfName=eqp_chance_cube_single:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(chanceCube, 3203266155)--- Add to global DraftSchematics table
