...
kanaliWafers = Object:new {

   objectName = "Kanali Wafers",
   stfName = "kanali_wafers",
   stfFile = "food_name",
   objectCRC = 2008463907,
   ...
   tanoAttributes = "objecttype=8202:objectcrc=2212622551:stfFile=food_name:stfName=kanali_wafers:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(kanaliWafers, 2008463907)--- Add to global DraftSchematics table
