...
camoKitTatooine = Object:new {

   objectName = "Camo Kit: Tatooine",
   stfName = "camokit_tatooine",
   objectCRC = 2005529582,
   ...
   tanoAttributes = "objecttype=8211:objectcrc=3199109249:objecttemp=camokit_tatooine:templatetype=item_n:itemmask=65535:",
...
DraftSchematics:addDraftSchematic(camoKitTatooine, 2005529582)--- Add to global DraftSchematics table
