...
tuskenWitchDoctor = Creature:new {
	objectName = "tuskenWitchDoctor", -- name of the lua Object
	
	name = "a Tusken Witch Doctor",
	objectCRC = 344809642,
	socialGroup = "tusken",
	named = TRUE,
...
Creatures:addCreature(tuskenWitchDoctor, 344809642) --- Add to global creature table
