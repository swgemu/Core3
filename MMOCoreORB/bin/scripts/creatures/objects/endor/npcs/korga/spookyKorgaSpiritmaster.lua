...
spookyKorgaSpiritmaster = Creature:new {
	objectName = "spookyKorgaSpiritmaster",  -- Lua Object Name
	creatureType = "NPC",
	faction = "korga_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "spooky_korga_spiritmaster",
...
Creatures:addCreature(spookyKorgaSpiritmaster, 2350961206) --  Add to Global Table
