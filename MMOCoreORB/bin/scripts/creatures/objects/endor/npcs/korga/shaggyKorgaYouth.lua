...
shaggyKorgaYouth = Creature:new {
	objectName = "shaggyKorgaYouth",  -- Lua Object Name
	creatureType = "NPC",
	faction = "korga_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "shaggy_korga_youth",
...
Creatures:addCreature(shaggyKorgaYouth, 2350961206) --  Add to Global Table
