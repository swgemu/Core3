...
jindaOutcast = Creature:new {
      objectName = "jindaOutcast",  -- Lua Object Name
      creatureType = "NPC",
      faction = "self (Jinda Tribe)",
      gender = "",
...
Creatures:addCreature(jindaOutcast, 2962201923) --  Add to Global Table
