...
jindaWarrior = Creature:new {
	objectName = "jindaWarrior",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Jinda Tribe",
	gender = "",

	speciesName = "jinda_warrior",
...
Creatures:addCreature(jindaWarrior, 2886364858) --  Add to Global Table
