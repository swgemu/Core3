...
jindaElderWorker = Creature:new {
	objectName = "jindaElderWorker",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Jinda Tribe",
	gender = "",

	speciesName = "jinda_elder_worker",
...
Creatures:addCreature(jindaElderWorker, 2886364858) --  Add to Global Table
