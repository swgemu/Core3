...
bolleBolFemale = Creature:new {
	objectName = "bolleBolFemale",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "female",

	speciesName = "bolle_bol_female",
...
Creatures:addCreature(bolleBolFemale, 2905349573) --  Add to Global Table
