...
blurrgRaptor = Creature:new {
	objectName = "blurrgRaptor",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "blurrg_raptor",
...
Creatures:addCreature(blurrgRaptor, 2309529743) --  Add to Global Table
