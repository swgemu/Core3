...
barkMiteBurrowerQueen = Creature:new {
	objectName = "barkMiteBurrowerQueen",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "bark_mite_burrower_queen",
...
Creatures:addCreature(barkMiteBurrowerQueen, 1477419452) --  Add to Global Table
