...
bloodFrenziedBoarWolf = Creature:new {
	objectName = "bloodFrenziedBoarWolf",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "blood_frenzied_boar_wolf",
...
Creatures:addCreature(bloodFrenziedBoarWolf, 1815686462) --  Add to Global Table
