...
gleamingLanternBird = Creature:new {
	objectName = "gleamingLanternBird",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "gleaming_lantern_bird",
...
Creatures:addCreature(gleamingLanternBird, 1183906554) --  Add to Global Table
