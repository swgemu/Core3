...
kingMerekHarvester = Creature:new {
	objectName = "kingMerekHarvester",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "king_merek_harvester",
...
Creatures:addCreature(kingMerekHarvester, 696113680) --  Add to Global Table
