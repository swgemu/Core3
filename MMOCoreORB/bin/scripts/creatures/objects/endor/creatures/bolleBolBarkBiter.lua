...
bolleBolBarkBiter = Creature:new {
      objectName = "bolleBolBarkBiter",  -- Lua Object Name
      creatureType = "ANIMAL",
      faction = "Bolle Bol",
      gender = "",

	  speciesName = "bolle_bol_bark_biter",
...
Creatures:addCreature(bolleBolBarkBiter, 2905349573) --  Add to Global Table
