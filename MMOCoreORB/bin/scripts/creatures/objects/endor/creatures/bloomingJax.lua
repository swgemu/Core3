...
bloomingJax = Creature:new {
	objectName = "bloomingJax",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "blooming_jax",
	stfName = "a Blooming Jax",
...
Creatures:addCreature(bloomingJax, 1187375621) --  Add to Global Table
