...
bloodseekerMiteDrone = Creature:new {
	objectName = "bloodseekerMiteDrone",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(bloodseekerMiteDrone, 4102628433) --  Add to Global Table
