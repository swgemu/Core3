...
boarWolfRavager = Creature:new {
	objectName = "boarWolfRavager",  -- Lua Object Name
	creatureType = "ANIMAL",
	faction = "Boar Wolf",
	gender = "",

	speciesName = "boar_wolf_ravager",
...
Creatures:addCreature(boarWolfRavager, 1815686462) --  Add to Global Table
