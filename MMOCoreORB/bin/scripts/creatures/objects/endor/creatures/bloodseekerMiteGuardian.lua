...
bloodseekerMiteGuardian = Creature:new {
      objectName = "bloodseekerMiteGuardian",  -- Lua Object Name
      creatureType = "ANIMAL",
      faction = "Bioodseeker",
      gender = "",
      ...
      skills = { "bloodseekerMiteAttack4", "bloodseekerMiteAttack5", "bloodseekerMiteAttack6" },
      respawnTimer = 60,

      behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(bloodseekerMiteGuardian, 4102628433) --  Add to Global Table
