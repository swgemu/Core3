...
liceRiddenRemmerQueen = Creature:new {
	objectName = "liceRiddenRemmerQueen",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(liceRiddenRemmerQueen, 1979857288) --  Add to Global Table
