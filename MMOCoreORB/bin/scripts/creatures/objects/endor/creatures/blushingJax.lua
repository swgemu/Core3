...
blushingJax = Creature:new {
	objectName = "blushingJax",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "blushing_jax",
...
Creatures:addCreature(blushingJax, 3376386441) --  Add to Global Table
