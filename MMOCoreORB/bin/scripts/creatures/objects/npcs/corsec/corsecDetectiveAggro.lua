...
corsecDetectiveAggro = Creature:new {
	objectName = "corsecDetectiveAggro",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Corsec [aggro]",
	gender = "",

	speciesName = "corsec_detective_aggro",
...
Creatures:addCreature(corsecDetectiveAggro, 1875886160) -- Add to Global Table
