...
corsecCaptain = Creature:new {
	objectName = "corsecCaptain",  -- Lua Object Name
	creatureType = "NPC",
	faction = "corsec", 
	factionPoints = 20,
	gender = "",

	speciesName = "corsec_captain",
...
Creatures:addCreature(corsecCaptain, 16556953) -- Add to Global Table
