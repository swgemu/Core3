...
rebelScout = Creature:new {
	objectName = "rebelScout",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",
	...
	skills = { "rebelScoutAttack1", "rebelScoutAttack2" },
	respawnTimer = 180,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(rebelScout, 2176412218) --  Add to Global Table
