...
rebelMajor = Creature:new {
	objectName = "rebelMajor",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	speciesName = "rebel_major",
	...
	skills = { "rebelMajorAttack1", "rebelMajorAttack2" },
	respawnTimer = 180,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(rebelMajor, 450207030) --  Add to Global Table
