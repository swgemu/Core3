...
rebelWarrantOfficerI = Creature:new {
	objectName = "rebelWarrantOfficerI",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a ed Rebel Warrant Officer I", 
...
Creatures:addCreature(rebelWarrantOfficerI, 3172332319) --  Add to Global Table
