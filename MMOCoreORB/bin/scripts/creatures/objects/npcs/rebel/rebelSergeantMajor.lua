...
rebelSergeantMajor = Creature:new {
	objectName = "rebelSergeantMajor",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a ed Rebel Sergeant Major", 
...
Creatures:addCreature(rebelSergeantMajor, 3881398557) --  Add to Global Table
