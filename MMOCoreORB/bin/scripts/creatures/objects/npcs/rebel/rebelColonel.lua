...
rebelColonel = Creature:new {
	objectName = "rebelColonel",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a ed Rebel colonel",
...
Creatures:addCreature(rebelColonel, 1803030018) --  Add to Global Table
