...
imperialMedic = Creature:new {
	objectName = "imperialMedic",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",
	...
	skills = { "imperialMedicAttack1" },
	respawnTimer = 180,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(imperialMedic, 1258151269) --  Add to Global Table
