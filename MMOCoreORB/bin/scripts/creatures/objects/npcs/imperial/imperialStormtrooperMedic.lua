...
imperialStormTrooperMedic = Creature:new {
	objectName = "imperialStormTrooperMedic",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 	
	factionPoints = 20,
	gender = "",
	...
	skills = { "imperialStormTrooperMedicAttack1" },
	respawnTimer = 180,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(imperialStormTrooperMedic, 425662555) --  Add to Global Table
