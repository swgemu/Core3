...
imperialStormTrooperNovatrooperCaptain = Creature:new {
	objectName = "imperialStormTrooperNovatrooperCaptain",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",
	...
	skills = { "imperialStormTrooperNovaTrooperCaptainAttack1" },
	respawnTimer = 180,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(imperialStormTrooperNovatrooperCaptain, 3498321727) --  Add to Global Table
