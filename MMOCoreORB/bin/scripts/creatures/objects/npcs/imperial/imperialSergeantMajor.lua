...
imperialSergeantMajor = Creature:new {
	objectName = "imperialSergeantMajor",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a ed Imperial Sergeant Major", 
...
Creatures:addCreature(imperialSergeantMajor, 1476291957) --  Add to Global Table
