...
gnarledBarkMiteQueen = Creature:new {
	...
	--skills = { " Disease attack (mild)", " Stun attack", " Ranged attack (spit)" }
	skills = { "barkMiteAttack6", "barkMiteAttack2", "barkMiteAttack3" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(gnarledBarkMiteQueen, 1247872509) --  Add to Global Table
