...
frailSquallMeekAvenger = Creature:new {
	objectName = "frailSquallMeekAvenger",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(frailSquallMeekAvenger, 536393830) --  Add to Global Table
