...
poisonousKrevolQueen = Creature:new {
	...
	--skills = { " Blind attack", " Disease attack (poison)", " Ranged attack (spit)" }
	skills = { "krevolAttack3", "krevolAttack4", "krevolAttack2" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(poisonousKrevolQueen, 1766345516) --  Add to Global Table
