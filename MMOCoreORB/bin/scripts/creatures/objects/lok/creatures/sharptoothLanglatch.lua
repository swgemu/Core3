...
sharptoothLanglatch = Creature:new {
	objectName = "sharptoothLanglatch",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "sharptooth_langlatch",
...
Creatures:addCreature(sharptoothLanglatch, 2513300255) --  Add to Global Table
