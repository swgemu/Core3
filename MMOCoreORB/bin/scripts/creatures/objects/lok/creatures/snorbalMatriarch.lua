...
snorbalMatriarch = Creature:new {
	objectName = "snorbalMatriarch",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "snorbal_matriarch",
...
Creatures:addCreature(snorbalMatriarch, 2831973457) --  Add to Global Table
