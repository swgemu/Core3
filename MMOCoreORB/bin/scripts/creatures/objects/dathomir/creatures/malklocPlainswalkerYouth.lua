...
malklocPlainswalkerYouth = Creature:new {
	objectName = "malklocPlainswalkerYouth",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(malklocPlainswalkerYouth, 3978814666) --  Add to Global Table
