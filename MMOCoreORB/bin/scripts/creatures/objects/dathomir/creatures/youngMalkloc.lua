...
youngMalkloc = Creature:new {
	objectName = "youngMalkloc",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "young_malkloc",
...
Creatures:addCreature(youngMalkloc, 3978814666) --  Add to Global Table
