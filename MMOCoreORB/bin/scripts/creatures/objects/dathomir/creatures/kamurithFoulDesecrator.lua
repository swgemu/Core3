...
kamurithFoulDesecrator = Creature:new {
      objectName = "kamurithFoulDesecrator",  -- Lua Object Name
      creatureType = "ANIMAL",
      faction = "Kamurith",
      gender = "",
...
Creatures:addCreature(kamurithFoulDesecrator, 1766827549) --  Add to Global Table
