...
nightsisterBullRancor = Creature:new {
	objectName = "nightsisterBullRancor",  -- Lua Object Name
	creatureType = "ANIMAL",
	faction = "Nightsister",
	gender = "",

	speciesName = "nightsister_bull_rancor",
...
Creatures:addCreature(nightsisterBullRancor, 837719973) --  Add to Global Table
