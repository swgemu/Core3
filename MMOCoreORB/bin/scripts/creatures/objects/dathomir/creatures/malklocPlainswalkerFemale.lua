...
malklocPlainswalkerFemale = Creature:new {
	objectName = "malklocPlainswalkerFemale",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "female",
...
Creatures:addCreature(malklocPlainswalkerFemale, 197708576) --  Add to Global Table
