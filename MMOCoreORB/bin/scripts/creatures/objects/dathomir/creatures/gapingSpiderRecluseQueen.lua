...
gapingSpiderRecluseQueen = Creature:new {
	objectName = "gapingSpiderRecluseQueen",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(gapingSpiderRecluseQueen, 2216583678) --  Add to Global Table
