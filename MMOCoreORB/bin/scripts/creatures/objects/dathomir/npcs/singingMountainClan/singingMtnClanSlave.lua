...
singingMtnClanSlave = Creature:new {
	objectName = "singingMtnClanSlave",  -- Lua Object Name
	creatureType = "NPC",
	faction = "mtn_clan", 
	factionPoints = 20,
	gender = "",

	speciesName = "singing_mtn_clan_slave",
	...
	alternateWeaponMinDamage = 130,
	alternateWeaponMaxDamage = 140,
	...
	lootGroup = "0,1,3,11,19,", -- Group it belongs to for loot
...
Creatures:addCreature(singingMtnClanSlave, 722215438) --  Add to Global Table
