...
nightsisterSentry = Creature:new {
	objectName = "nightsisterSentry",  -- Lua Object Name
	creatureType = "NPC",
	faction = "nightsister", 
	factionPoints = 20,
	gender = "",

	speciesName = "nightsister_sentry",
	...
	lootGroup = "0,1,3,4,11,15,30", -- Group it belongs to for loot
...
Creatures:addCreature(nightsisterSentry, 531141629) --  Add to Global Table
