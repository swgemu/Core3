...
tuskenWarMaster = Creature:new {
	objectName = "tuskenWarMaster",  -- Lua Object Name
	creatureType = "NPC",
	faction = "tusken_raider", 
	factionPoints = 20,
	gender = "",

	speciesName = "tusken_war_master",
...
Creatures:addCreature(tuskenWarMaster, 3780705985) --  Add to Global Table
