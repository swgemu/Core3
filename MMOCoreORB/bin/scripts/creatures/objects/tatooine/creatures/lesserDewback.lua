...
lesserDewback = Creature:new {
	objectName = "lesserDewback",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "lesser_dewback",
...
Creatures:addCreature(lesserDewback, 3499529322) --  Add to Global Table
