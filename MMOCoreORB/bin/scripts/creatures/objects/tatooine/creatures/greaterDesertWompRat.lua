...
greaterDesertWompRat = Creature:new {
	objectName = "greaterDesertWompRat",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "greater_desert_womprat",
...
Creatures:addCreature(greaterDesertWompRat, 3337882429) --  Add to Global Table
