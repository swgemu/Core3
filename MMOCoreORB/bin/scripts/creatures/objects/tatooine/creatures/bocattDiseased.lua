...
bocattDiseased = Creature:new {
	objectName = "bocattDiseased",  -- Lua Object Name
	creatureType = "ANIMAL",
	faction = "Bocatt",
	gender = "",

	speciesName = "bocatt_diseased",
...
Creatures:addCreature(bocattDiseased, 3725325606) --  Add to Global Table
