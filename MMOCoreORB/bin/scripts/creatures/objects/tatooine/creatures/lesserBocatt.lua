...
lesserBocatt = Creature:new {
	objectName = "lesserBocatt",  -- Lua Object Name
	creatureType = "ANIMAL",
	faction = "Bocatt",
	gender = "",

	speciesName = "lesser_bocatt",
...
Creatures:addCreature(lesserBocatt, 3725325606) --  Add to Global Table
