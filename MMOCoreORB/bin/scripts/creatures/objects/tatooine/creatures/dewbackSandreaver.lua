...
dewbackSandreaver = Creature:new {
	objectName = "dewbackSandreaver",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "dewback_sandreaver",
...
Creatures:addCreature(dewbackSandreaver, 1084332041) --  Add to Global Table
