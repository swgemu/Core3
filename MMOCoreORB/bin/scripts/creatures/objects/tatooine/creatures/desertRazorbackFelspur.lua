...
desertRazorbackFelspur = Creature:new {
	objectName = "desertRazorbackFelspur",  -- Lua Object Name
	creatureType = "ANIMAL",
	faction = "Zucca Boar",
	gender = "",
...
Creatures:addCreature(desertRazorbackFelspur, 3021374410) --  Add to Global Table
