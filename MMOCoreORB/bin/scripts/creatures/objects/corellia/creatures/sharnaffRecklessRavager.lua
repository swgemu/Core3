...
sharnaffRecklessRavager = Creature:new {
	objectName = "sharnaffRecklessRavager",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "sharnaff_reckless_ravager",
...
Creatures:addCreature(sharnaffRecklessRavager, 3709004378) --  Add to Global Table
