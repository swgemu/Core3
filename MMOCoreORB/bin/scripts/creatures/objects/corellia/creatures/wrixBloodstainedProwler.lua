...
--code included in the standard release of Core3 underrespawnTimer = 60, the GNU LGPL 
...
Creatures:addCreature(wrixBloodstainedProwler, 2441033354) --  Add to Global Table
