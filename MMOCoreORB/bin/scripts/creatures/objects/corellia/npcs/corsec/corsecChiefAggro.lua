...
corsecChiefAggro = Creature:new {
	objectName = "corsecChiefAggro",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Corsec (aggro)",
	gender = "",

	speciesName = "corsec_chief_aggro",
...
Creatures:addCreature(corsecChiefAggro, 142160511) -- Add to Global Table
