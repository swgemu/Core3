...
giantDecayMiteSentry = Creature:new {
	objectName = "giantDecayMiteSentry",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "giant_decay_mite_sentry",
...
Creatures:addCreature(giantDecayMiteSentry, 3943467921) --  Add to Global Table
