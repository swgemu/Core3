...
sicklyDecayMiteQueen = Creature:new {
	...
	--skills = { " Ranged attack (spit)", " Disease attack (medium)", " Blind attack" }
	skills = { "decayMiteAttack3", "decayMiteAttack1", "decayMiteAttack7" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(sicklyDecayMiteQueen, 3821753803) --  Add to Global Table
