...
giantDecayMiteQueen = Creature:new {
	objectName = "giantDecayMiteQueen",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(giantDecayMiteQueen, 3943467921) --  Add to Global Table
