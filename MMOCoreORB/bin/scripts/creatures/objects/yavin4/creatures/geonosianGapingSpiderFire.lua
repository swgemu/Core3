...
geonosianGapingSpiderFire = Creature:new {
	...
	weaponTemp = "creature_spit_heavy_flame", -- Weapon Template ex. 'lance_vibrolance'
	weaponClass = "UnarmedMeleeWeapon", -- Weapon Class ex. 'PolearmMeleeWeapon'
	weaponEquipped = 0,
	weaponMinDamage = 715,
	weaponMaxDamage = 1140,
	weaponAttackSpeed = 2,
...
Creatures:addCreature(geonosianGapingSpiderFire, 874176443) --  Add to Global Table
