...
kliknikShredderGuardian = Creature:new {
	objectName = "kliknikShredderGuardian",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(kliknikShredderGuardian, 965104200) --  Add to Global Table
