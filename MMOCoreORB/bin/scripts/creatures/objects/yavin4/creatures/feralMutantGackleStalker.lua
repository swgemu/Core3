...
feralMutantGackleStalker = Creature:new {
	objectName = "feralMutantGackleStalker",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(feralMutantGackleStalker, 2791266544) --  Add to Global Table
