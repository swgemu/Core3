...
giantStintaril = Creature:new {
	objectName = "giantStintaril",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "giant_stintaril",
...
Creatures:addCreature(giantStintaril, 3055227574) --  Add to Global Table
