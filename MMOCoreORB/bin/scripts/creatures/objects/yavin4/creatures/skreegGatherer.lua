...
skreegGatherer = Creature:new {
	objectName = "skreegGatherer",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "skreeg_gatherer",
...
Creatures:addCreature(skreegGatherer, 2391906030) --  Add to Global Table
