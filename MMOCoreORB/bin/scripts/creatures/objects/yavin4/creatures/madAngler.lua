...
madAngler = Creature:new {
	objectName = "madAngler",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "mad_angler",
...
Creatures:addCreature(madAngler, 3645434131) --  Add to Global Table
