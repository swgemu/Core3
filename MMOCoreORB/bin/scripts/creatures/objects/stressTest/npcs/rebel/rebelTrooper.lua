...
rebelTrooperStress = Creature:new {
	objectName = "rebelTrooperStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Rebel trooper", 
...
Creatures:addCreature(rebelTrooperStress, 4012550111) --  Add to Global Table
