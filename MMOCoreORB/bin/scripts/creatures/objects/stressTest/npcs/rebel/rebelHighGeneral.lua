...
rebelHighGeneralStress = Creature:new {
	objectName = "rebelHighGeneralStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Rebel High General", 
...
Creatures:addCreature(rebelHighGeneralStress, 1895884541) --  Add to Global Table
