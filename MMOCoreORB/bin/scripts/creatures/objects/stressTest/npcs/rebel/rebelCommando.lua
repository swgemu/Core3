...
rebelCommandoStress = Creature:new {
	objectName = "rebelCommandoStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Rebel commando", 
...
Creatures:addCreature(rebelCommandoStress, 1340194354) --  Add to Global Table
