...
rebelFirstLieutenantStress = Creature:new {
	objectName = "rebelFirstLieutenantStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Rebel First Lieutenan", 
...
Creatures:addCreature(rebelFirstLieutenantStress, 1053270126) --  Add to Global Table
