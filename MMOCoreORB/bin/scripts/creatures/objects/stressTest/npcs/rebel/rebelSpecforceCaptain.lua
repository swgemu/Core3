...
rebelSpecforceCaptainStress = Creature:new {
	objectName = "rebelSpecforceCaptainStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",
...
Creatures:addCreature(rebelSpecforceCaptainStress, 542195677) --  Add to Global Table
