...
imperialStormTrooperRiflemanStress = Creature:new {
	objectName = "imperialStormTrooperRiflemanStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial stormrifle", 
...
Creatures:addCreature(imperialStormTrooperRiflemanStress, 1298804271) --  Add to Global Table
