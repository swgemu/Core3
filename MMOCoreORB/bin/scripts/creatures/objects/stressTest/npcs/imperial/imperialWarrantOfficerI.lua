...
imperialWarrantOfficerIStress = Creature:new {
	objectName = "imperialWarrantOfficerIStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial Warrant Officer I", 
...
Creatures:addCreature(imperialWarrantOfficerIStress, 1476291957) --  Add to Global Table
