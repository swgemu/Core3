...
imperialStormTrooperSniperStress = Creature:new {
	objectName = "imperialStormTrooperSniperStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",
...
Creatures:addCreature(imperialStormTrooperSniperStress, 2688076350) --  Add to Global Table
