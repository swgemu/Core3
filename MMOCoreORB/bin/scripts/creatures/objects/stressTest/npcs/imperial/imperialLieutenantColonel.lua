...
imperialLieutenantColonelStress = Creature:new {
	objectName = "imperialLieutenantColonelStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial Lieutenant Colonel", 
...
Creatures:addCreature(imperialLieutenantColonelStress, 2701430666) --  Add to Global Table
