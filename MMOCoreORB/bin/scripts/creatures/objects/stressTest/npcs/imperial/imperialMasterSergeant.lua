...
imperialMasterSergeantStress = Creature:new {
	objectName = "imperialMasterSergeantStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",
...
Creatures:addCreature(imperialMasterSergeantStress, 1867395579) --  Add to Global Table
