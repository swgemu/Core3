...
gunganVeermok = Creature:new {
	objectName = "gunganVeermok",  -- Lua Object Name
	creatureType = "ANIMAL",
	faction = "Gungan",
	gender = "",
	...
	skills = { "veermokAttack4" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(gunganVeermok, 798042116) --  Add to Global Table
