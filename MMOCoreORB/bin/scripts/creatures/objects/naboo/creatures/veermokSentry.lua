...
veermokSentry = Creature:new {
	objectName = "veermokSentry",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "veermok_sentry",
...
Creatures:addCreature(veermokSentry, 798042116) --  Add to Global Table
