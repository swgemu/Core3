...
warrenCyborgSlicehound = Creature:new {
	objectName = "warrenCyborgSlicehound",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
	...
	skills = { "slicehoundAttack1", "slicehoundAttack2" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(warrenCyborgSlicehound, 3500363411) --  Add to Global Table
