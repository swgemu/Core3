...
warrenCyborgDunelizard = Creature:new {
	objectName = "warrenCyborgDunelizard",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(warrenCyborgDunelizard, 1142940054) --  Add to Global Table
