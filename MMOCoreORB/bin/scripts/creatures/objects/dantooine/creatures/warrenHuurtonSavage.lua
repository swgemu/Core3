...
warrenHuurtonSavage = Creature:new {
	objectName = "warrenHuurtonSavage",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
	...
	alternateWeaponMinDamage = 230,
	alternateWeaponMaxDamage = 240,
...
Creatures:addCreature(warrenHuurtonSavage, 3011024511) --  Add to Global Table
