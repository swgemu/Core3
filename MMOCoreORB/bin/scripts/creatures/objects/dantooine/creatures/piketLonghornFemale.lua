...
piketLonghornFemale = Creature:new {
	objectName = "piketLonghornFemale",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "female",

	speciesName = "piket_longhorn_female",
...
Creatures:addCreature(piketLonghornFemale, 3816463323) --  Add to Global Table
