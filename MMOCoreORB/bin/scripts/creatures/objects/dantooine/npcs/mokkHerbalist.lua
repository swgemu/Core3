...
mokkHerbalist = Creature:new {
      objectName = "mokkHerbalist",  -- Lua Object Name
      creatureType = "NPC",
      faction = "Mokk Tribe",
      gender = "",
...
Creatures:addCreature(mokkHerbalist, 4083847450) --  Add to Global Table
