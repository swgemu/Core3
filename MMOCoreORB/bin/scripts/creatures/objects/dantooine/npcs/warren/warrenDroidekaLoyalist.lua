...
warrenDroidekaLoyalist = Creature:new {
	objectName = "warrenDroidekaLoyalist",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Warren Teraud",
	gender = "",

	speciesName = "warren_droideka_loyalist",
...
Creatures:addCreature(warrenDroidekaLoyalist, 2412922465) -- Add to Global Table
