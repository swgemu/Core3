...
mokkHarvester = Creature:new {
	objectName = "mokkHarvester",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Mokk Tribe",
	gender = "",

	speciesName = "mokk_harvester",
...
Creatures:addCreature(mokkHarvester, 4083847450) --  Add to Global Table
