...
mokkRockshaper = Creature:new {
	objectName = "mokkRockshaper",  -- Lua Object Name
	creatureType = "NPC",
	faction = "mokk_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "mokk_rockshaper",
...
Creatures:addCreature(mokkRockshaper, 4083847450) --  Add to Global Table
