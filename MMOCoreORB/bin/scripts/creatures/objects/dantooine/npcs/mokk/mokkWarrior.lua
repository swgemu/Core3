...
mokkWarrior = Creature:new {
	objectName = "mokkWarrior",  -- Lua Object Name
	creatureType = "NPC",
	faction = "mokk_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "mokk_warrior",
...
Creatures:addCreature(mokkWarrior, 4083847450) --  Add to Global Table
