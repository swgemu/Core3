...
jantaLoreweaver = Creature:new {
	objectName = "jantaLoreweaver",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Janta Tribe",
	gender = "",

	speciesName = "janta_loreweaver",
...
Creatures:addCreature(jantaLoreweaver, 4083847450) --  Add to Global Table
