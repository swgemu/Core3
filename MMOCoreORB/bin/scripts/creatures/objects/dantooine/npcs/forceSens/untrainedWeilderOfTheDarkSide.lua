...
untrainedWeilderOfTheDarkSide = Creature:new {
	objectName = "untrainedWeilderOfTheDarkSide",  -- Lua Object Name
	creatureType = "NPC",
	gender = "",
...
Creatures:addCreature(untrainedWeilderOfTheDarkSide, 2507849557) --  Add to Global Table
