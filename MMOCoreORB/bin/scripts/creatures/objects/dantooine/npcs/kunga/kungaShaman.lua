...
kungaShaman = Creature:new {
	objectName = "kungaShaman",  -- Lua Object Name
	creatureType = "NPC",
	faction = "kunga_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "kunga_shaman",
	...
	alternateWeaponMinDamage = 450,
	alternateWeaponMaxDamage = 610,
...
Creatures:addCreature(kungaShaman, 4083847450) --  Add to Global Table
