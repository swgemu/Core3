...
kungaSoothsayer = Creature:new {
	objectName = "kungaSoothsayer",  -- Lua Object Name
	creatureType = "NPC",
	faction = "kunga_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "kunga_soothsayer",
	...
	alternateWeaponMinDamage = 270,
	alternateWeaponMaxDamage = 280,
...
Creatures:addCreature(kungaSoothsayer, 4083847450) --  Add to Global Table
