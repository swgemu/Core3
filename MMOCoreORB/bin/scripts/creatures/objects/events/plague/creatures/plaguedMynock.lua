...
plaguedMynock = Creature:new {
	objectName = "plaguedMynock",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
	
	name = "a Plagued Mynock",
	...
	skills = { "plaguedMynockAttack1" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(plaguedMynock, 1848263825) --  Add to Global Table
