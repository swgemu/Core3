...
mineralMiningInstallationDeed = Deed:new {
	stfName = "ore_s2_harvester_deed_name",
	...
	targetObjectFile = "object/installation/mining_ore/shared_mining_ore_harvester_style_2.iff",
	
	targetConstructionObjectCRC = 1589279869,
	
	maintenanceRate = 60.0,
	powerRate = 50.0,
	baseExtractionRate = 5.0,
	hopperSizeMax = 59000,
