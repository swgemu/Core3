...
personalMoistureVaporatorDeed = Deed:new {
	...
	targetStfName = "moisture_mine",
 
	--Required for EnterStructurePlacementModeMessage
	targetObjectFile = "object/installation/mining_liquid/shared_mining_liquid_moisture_harvester.iff",
