...
object_ship_rebel_gunboat = object_ship_shared_rebel_gunboat:new {
	objectName = "@space/space_mobile_type:rebel_gunboat",
	...
	shield_0 = {name = "shd_generic", hitpoints = 10000, armor = 3000, front = 6000, back = 60000, regen = 50},
	...
	weapon_0 = {name = "wpn_incom_blaster", hitpoints = 200, armor = 200, rate = 0.345, drain = 23.6, maxDamage = 150, minDamage = 100, shieldEfficiency = 0, armorEfficiency = 0, ammo = 0, ammo_type = 0},
	weapon_1 = {name = "wpn_incom_blaster", hitpoints = 200, armor = 200, rate = 0.345, drain = 23.6, maxDamage = 150, minDamage = 100, shieldEfficiency = 0, armorEfficiency = 0, ammo = 0, ammo_type = 0},
	weapon_2 = {name = "wpn_incom_blaster", hitpoints = 200, armor = 200, rate = 0.345, drain = 23.6, maxDamage = 150, minDamage = 100, shieldEfficiency = 0, armorEfficiency = 0, ammo = 0, ammo_type = 0},
}
