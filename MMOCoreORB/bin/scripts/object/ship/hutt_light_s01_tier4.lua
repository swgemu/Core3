...
object_ship_hutt_light_s01_tier4 = object_ship_shared_hutt_light_s01_tier4:new {
	objectName = "@space/space_mobile_type:hutt_light_s01_tier4",

	name = "hutt_light_tier4",
	type = "hutt_light_s01_tier4",
	faction = "hutt",
	difficulty = "tier4",
...
ObjectTemplates:addTemplate(object_ship_hutt_light_s01_tier4, "object/ship/hutt_light_s01_tier4.iff")
