...
object_ship_blacksun_heavy_s01_tier3 = object_ship_shared_blacksun_heavy_s01_tier3:new {
	objectName = "@space/space_mobile_type:blacksun_heavy_s01_tier3",

	name = "blacksun_heavy_tier3",
	type = "blacksun_heavy_s01_tier3",
	faction = "blacksun",
	difficulty = "tier3",
...
ObjectTemplates:addTemplate(object_ship_blacksun_heavy_s01_tier3, "object/ship/blacksun_heavy_s01_tier3.iff")
