...
object_ship_hutt_medium_s02_tier3 = object_ship_shared_hutt_medium_s02_tier3:new {
	objectName = "@space/space_mobile_type:hutt_medium_s02_tier3",

	name = "hutt_medium_tier3",
	type = "hutt_medium_s02_tier3",
	faction = "hutt",
	difficulty = "tier3",
...
ObjectTemplates:addTemplate(object_ship_hutt_medium_s02_tier3, "object/ship/hutt_medium_s02_tier3.iff")
