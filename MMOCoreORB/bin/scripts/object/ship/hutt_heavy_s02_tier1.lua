...
object_ship_hutt_heavy_s02_tier1 = object_ship_shared_hutt_heavy_s02_tier1:new {
	objectName = "@space/space_mobile_type:hutt_heavy_s02_tier1",

	name = "hutt_heavy_tier1",
	type = "hutt_heavy_s02_tier1",
	faction = "hutt",
	difficulty = "tier1",
	...
	shield_0 = {name = "shd_generic", hitpoints = 180, armor = 200, front = 720, back = 720, regen = 3},
	armor_0 = {name = "arm_generic", hitpoints = 416, armor = 416},
	armor_1 = {name = "arm_generic", hitpoints = 416, armor = 416},
...
ObjectTemplates:addTemplate(object_ship_hutt_heavy_s02_tier1, "object/ship/hutt_heavy_s02_tier1.iff")
