...
object_ship_player_player_yt1300_decorated_01 = object_ship_player_shared_player_yt1300_decorated_01:new {
	...
	childObjects = {
		...
		{ templateFile = "object/tangible/terminal/terminal_pob_ship.iff", x = -9.95, z = -1.67, y = 1.72, ox = 0, oy = 0.707106, oz = 0, ow = 0.707106, cellid = 3, containmentType = -1 },
		-- Turret Control
		...
		-- Hall 1
		{ templateFile = "object/tangible/ship/interior_components/alarm_interior.iff", x = 8.29, z  = 2.06, y = 2.15, ox = 0, oy = 0, oz = 0, ow = 1, cellid = 1, containmentType = -1 },
		{ templateFile = "object/tangible/ship/interior_components/alarm_interior.iff", x = 9.62, z  = 1.65, y = 6.17, ox = 0, oy = 0, oz = 0, ow = 1, cellid = 1, containmentType = -1 },
		-- Cockpit
		...
		-- Lounge
		{ templateFile = "object/tangible/ship/interior_components/shield_generator_interior.iff", x = 2.48, z  = -0.44, y = 11.7, ox = 1, oy = 0, oz = 0, ow = 1, cellid = 3, containmentType = -1 },
		...
		{ templateFile = "object/tangible/ship/interior_components/alarm_interior.iff", x = -1.25, z  = 0.48, y = 3.52, ox = 0, oy = 0.707106, oz = 0, ow = 1, cellid = 3, containmentType = -1 },
		{ templateFile = "object/tangible/ship/interior_components/plasma_conduit_interior.iff", x = -2.57, z  = -1.03, y = 13.45, ox = 1, oy = 0, oz = 0, ow = 1, cellid = 3, containmentType = -1 },
		{ templateFile = "object/tangible/ship/interior_components/plasma_conduit_interior.iff", x = -0.12, z  = -1.03, y = 13.46, ox = 1, oy = 0, oz = 0, ow = 1, cellid = 3, containmentType = -1 },
		-- Hall 4
		...
		-- Storage 5
		{ templateFile = "object/tangible/ship/interior_components/engine_interior.iff", x = -8.64, z  = -0.05, y = -9.85, ox = 0, oy = 0, oz = 0, ow = 1, cellid = 5, containmentType = -1 },
		...
		{ templateFile = "object/tangible/ship/interior_components/alarm_interior.iff", x = -4.51, z  = 1.26, y = -1.96, ox = 0, oy = 0, oz = 0, ow = 1, cellid = 5, containmentType = -1 },
		{ templateFile = "object/tangible/ship/interior_components/weapon_interior.iff", x = -4.48, z  = 0.04, y = -2.04, ox = 0, oy = 0, oz = 0, ow = 1, cellid = 5, containmentType = -1 },
		{ templateFile = "object/tangible/ship/interior_components/weapon_interior.iff", x = -3.23, z  = 0.04, y = -1.99, ox = 0, oy = 0, oz = 0, ow = 1, cellid = 5, containmentType = -1 },
		-- Storage6
		{ templateFile = "object/tangible/ship/interior_components/reactor_interior.iff", x = 8.61, z  = -0.24, y = -9.87, ox = 0, oy = 0, oz = 0, ow = 1, cellid = 6, containmentType = -1 },
		...
		{ templateFile = "object/tangible/ship/interior_components/capacitor_interior.iff", x = 3.47, z  = -0.15, y = -2.01, ox = 0, oy = 0, oz = 0, ow = 1, cellid = 6, containmentType = -1 },
		{ templateFile = "object/tangible/ship/interior_components/plasma_conduit_interior.iff", x = 3.51, z  = 0.61, y = -2, ox = 0, oy = 0, oz = 0, ow = 1, cellid = 6, containmentType = -1 },
		{ templateFile = "object/tangible/ship/interior_components/alarm_interior.iff", x = 10.73, z  = 0.11, y = -7.75, ox = 0, oy = 0, oz = 0, ow = 1, cellid = 6, containmentType = -1 },
	},
