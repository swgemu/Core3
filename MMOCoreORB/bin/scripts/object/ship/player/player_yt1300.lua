...
object_ship_player_player_yt1300 = object_ship_player_shared_player_yt1300:new {
	...
	childObjects = {
		...
		{ templateFile = "object/tangible/ship/interior_components/alarm_interior.iff", x = 10.73, z  = 0.11, y = -7.75, ow = 0.005, ox = 0.707, oy = -0.707, oz = 0.005, cellid = 6, containmentType = -1 }, -- Faces NW on flat wall
	},
