...
object_ship_blacksun_transport = object_ship_shared_blacksun_transport:new {
	objectName = "@space/space_mobile_type:blacksun_transport",

	name = "blacksun_transport",
	type = "blacksun_transport",
	faction = "blacksun",
	difficulty = "",
...
ObjectTemplates:addTemplate(object_ship_blacksun_transport, "object/ship/blacksun_transport.iff")
