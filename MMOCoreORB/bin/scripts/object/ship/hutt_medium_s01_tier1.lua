...
object_ship_hutt_medium_s01_tier1 = object_ship_shared_hutt_medium_s01_tier1:new {
	objectName = "@space/space_mobile_type:hutt_medium_s01_tier1",

	name = "hutt_medium_tier1",
	type = "hutt_medium_s01_tier1",
	faction = "hutt",
	difficulty = "tier1",
...
ObjectTemplates:addTemplate(object_ship_hutt_medium_s01_tier1, "object/ship/hutt_medium_s01_tier1.iff")
