...
object_ship_freightermedium_tier3 = object_ship_shared_freightermedium_tier3:new {
	objectName = "@space/space_mobile_type:freightermedium_tier3",

	name = "freightermedium_tier3",
	type = "freightermedium_tier3",
	faction = "civilian",
	difficulty = "tier3",
	...
	shield_0 = {name = "shd_generic", hitpoints = 2160, armor = 2160, front = 17280, back = 17280, regen = 11.54},
	armor_0 = {name = "arm_generic", hitpoints = 9216, armor = 9216},
	armor_1 = {name = "arm_generic", hitpoints = 9216, armor = 9216},
