...
object_ship_blacksun_heavy_s04_tier4 = object_ship_shared_blacksun_heavy_s04_tier4:new {
	objectName = "@space/space_mobile_type:blacksun_heavy_s04_tier4",

	name = "blacksun_heavy_tier4",
	type = "blacksun_heavy_s04_tier4",
	faction = "blacksun",
	difficulty = "tier4",
	...
	shield_0 = {name = "shd_generic", hitpoints = 2488.32, armor = 2488.32, front = 10782.7, back = 10782.7, regen = 16.5},
...
ObjectTemplates:addTemplate(object_ship_blacksun_heavy_s04_tier4, "object/ship/blacksun_heavy_s04_tier4.iff")
