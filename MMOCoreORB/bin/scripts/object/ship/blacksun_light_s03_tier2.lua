...
object_ship_blacksun_light_s03_tier2 = object_ship_shared_blacksun_light_s03_tier2:new {
	objectName = "@space/space_mobile_type:blacksun_light_s03_tier2",

	name = "blacksun_light_tier2",
	type = "blacksun_light_s03_tier2",
	faction = "blacksun",
	difficulty = "tier2",
...
ObjectTemplates:addTemplate(object_ship_blacksun_light_s03_tier2, "object/ship/blacksun_light_s03_tier2.iff")
