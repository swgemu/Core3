...
object_ship_blacksun_heavy_s04_tier2 = object_ship_shared_blacksun_heavy_s04_tier2:new {
	objectName = "@space/space_mobile_type:blacksun_heavy_s04_tier2",

	name = "blacksun_heavy_tier2",
	type = "blacksun_heavy_s04_tier2",
	faction = "blacksun",
	difficulty = "tier2",
...
ObjectTemplates:addTemplate(object_ship_blacksun_heavy_s04_tier2, "object/ship/blacksun_heavy_s04_tier2.iff")
