...
object_ship_droid_fighter_tier4 = object_ship_shared_droid_fighter_tier4:new {
	objectName = "@space/space_mobile_type:droid_fighter_tier4",

	name = "droid_fighter_tier4",
	type = "droid_fighter_tier4",
	faction = "civilian",
	difficulty = "tier4",
	...
	weapon_0 = {name = "wpn_incom_blaster", hitpoints = 2073.6, armor = 2073.6, rate = 0.78, drain = 1, maxDamage = 252.44, minDamage = 164.67, shieldEfficiency = 0.56, armorEfficiency = 0.56, ammo = 0, ammo_type = 0},
}
