...
object_ship_hutt_medium_s01_tier4 = object_ship_shared_hutt_medium_s01_tier4:new {
	objectName = "@space/space_mobile_type:hutt_medium_s01_tier4",

	name = "hutt_medium_tier4",
	type = "hutt_medium_s01_tier4",
	faction = "hutt",
	difficulty = "tier4",
...
ObjectTemplates:addTemplate(object_ship_hutt_medium_s01_tier4, "object/ship/hutt_medium_s01_tier4.iff")
