...
object_ship_blacksun_light_s04_tier3 = object_ship_shared_blacksun_light_s04_tier3:new {
	objectName = "@space/space_mobile_type:blacksun_light_s04_tier3",

	name = "blacksun_light_tier3",
	type = "blacksun_light_s04_tier3",
	faction = "blacksun",
	difficulty = "tier3",
...
ObjectTemplates:addTemplate(object_ship_blacksun_light_s04_tier3, "object/ship/blacksun_light_s04_tier3.iff")
