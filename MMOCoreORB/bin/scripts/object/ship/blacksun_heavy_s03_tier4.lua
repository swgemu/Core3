...
object_ship_blacksun_heavy_s03_tier4 = object_ship_shared_blacksun_heavy_s03_tier4:new {
	objectName = "@space/space_mobile_type:blacksun_heavy_s03_tier4",

	name = "blacksun_heavy_tier4",
	type = "blacksun_heavy_s03_tier4",
	faction = "blacksun",
	difficulty = "tier4",
...
ObjectTemplates:addTemplate(object_ship_blacksun_heavy_s03_tier4, "object/ship/blacksun_heavy_s03_tier4.iff")
