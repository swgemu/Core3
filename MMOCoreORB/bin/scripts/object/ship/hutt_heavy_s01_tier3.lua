...
object_ship_hutt_heavy_s01_tier3 = object_ship_shared_hutt_heavy_s01_tier3:new {
	objectName = "@space/space_mobile_type:hutt_heavy_s01_tier3",

	name = "hutt_heavy_tier3",
	type = "hutt_heavy_s01_tier3",
	faction = "hutt",
	difficulty = "tier3",
...
ObjectTemplates:addTemplate(object_ship_hutt_heavy_s01_tier3, "object/ship/hutt_heavy_s01_tier3.iff")
