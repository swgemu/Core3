...
object_ship_ywing_tier3 = object_ship_shared_ywing_tier3:new {
	objectName = "@space/space_mobile_type:ywing_tier3",
	...
	weapon_0 = {name = "wpn_incom_disruptor", hitpoints = 1080, armor = 1080, rate = 0.78, drain = 1, maxDamage = 162.62, minDamage = 111.13, shieldEfficiency = 0.56, armorEfficiency = 0.56, ammo = 0, ammo_type = 0},
	weapon_1 = {name = "wpn_slayn_ioncannon", hitpoints = 1080, armor = 1080, rate = 0.78, drain = 1, maxDamage = 162.62, minDamage = 111.13, shieldEfficiency = 0.56, armorEfficiency = 0.56, ammo = 0, ammo_type = 0},
	weapon_2 = {name = "wpn_seinar_concussion_missile_s01", hitpoints = 1080, armor = 1080, rate = 3, drain = 1, maxDamage = 487.86, minDamage = 222.26, shieldEfficiency = 0.75, armorEfficiency = 0.75, ammo = 4, ammo_type = 18},
}
