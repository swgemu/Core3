...
object_installation_mining_organic_base_shared_mining_organic_base = SharedInstallationObjectTemplate:new {
	clientTemplateFileName = "object/installation/mining_organic/base/shared_mining_organic_base.iff"
...
--[[
	...
	objectName = "@installation_n:organic_harvester",
