...
object_installation_turret_base_shared_turret_base = SharedInstallationObjectTemplate:new {
	clientTemplateFileName = "object/installation/turret/base/shared_turret_base.iff"
