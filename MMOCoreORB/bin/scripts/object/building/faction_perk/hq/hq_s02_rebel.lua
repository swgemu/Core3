...
object_building_faction_perk_hq_hq_s02_rebel = object_building_faction_perk_hq_shared_hq_s02_rebel:new {
		...
		childCreatureObjects = {
			...
			{ mobile="fbase_rebel_grenadier", x=-2.5, z=0, y=50, cellid=-1, respawn=360, containmentType=-1, heading=0},
			...
			{ mobile="fbase_rebel_medic", x=-33, z=0, y=5, cellid=-1, respawn=360, containmentType=-1, heading=0},
			...
			{ mobile="fbase_rebel_commando", x=28, z=0, y=5, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="fbase_rebel_sharpshooter", x=33, z=0, y=5, cellid=-1, respawn=360, containmentType=-1, heading=0},
			...
			{ mobile="fbase_rebel_commando", x=22, z=0, y=37, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="fbase_rebel_command_security_guard", x=27, z=0, y=37, cellid=-1, respawn=360, containmentType=-1, heading=0},
			...
			{ mobile="fbase_rebel_comm_operator", x=-2.3, z=-6.75, y=-16.5, cellid=6, respawn=300, containmentType=-1, heading=0},
			...
			{ mobile="fbase_rebel_colonel", x=3, z=-6.75, y=-1.8, cellid=7, respawn=300, containmentType=-1, heading=0},
			{ mobile="fbase_rebel_sergeant", x=-5.5, z=-13.75, y=-3, cellid=9, respawn=300, containmentType=-1, heading=0},
			{ mobile="fbase_rebel_heavy_trooper", x=.5, z=-13.75, y=-3 ,cellid=9, respawn=300, containmentType=-1, heading=0},
			{ mobile="fbase_rebel_recruit", x=.5, z=-13.75, y=-7.2, cellid=9, respawn=300, containmentType=-1, heading=0},
			{ mobile="fbase_rebel_medic", x=-5.5, z=-13.75, y=-7.2 ,cellid=9, respawn=300, containmentType=-1, heading=0},
			{ mobile="fbase_rebel_army_captain", x=-4.1, z=-13.75, y=-17.3 ,cellid=9, respawn=300, containmentType=-1, heading=0},
