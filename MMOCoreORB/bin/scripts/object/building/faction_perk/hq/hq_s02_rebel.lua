...
object_building_faction_perk_hq_hq_s02_rebel = object_building_faction_perk_hq_shared_hq_s02_rebel:new {
		...
		childObjects = {
			...
			-- turret
			{templateFile = "object/installation/faction_perk/turret/tower_lg.iff", x=11, z=0, y=33, ox=0, oy=-1,  oz=0, ow=0, cellid=-1, containmentType=-1}, -- left turret front
			{templateFile = "object/installation/faction_perk/turret/tower_lg.iff", x=-11, z=0, y=33,  ox=0, oy=1, oz=0, ow=0, cellid=-1, containmentType=-1},
