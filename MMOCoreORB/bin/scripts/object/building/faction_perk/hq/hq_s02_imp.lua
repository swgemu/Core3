...
object_building_faction_perk_hq_hq_s02_imp = object_building_faction_perk_hq_shared_hq_s02_imp:new {
		...
		childObjects = {
			...
			childCreatureObjects = {
		 	...
		 	{ mobile="fbase_at_st", x=0, z=0, y=52, cellid=-1, respawn=720, containmentType=-1, heading=0},
			...
			{ mobile="fbase_dark_trooper", x=-25, z=0, y=-13, cellid=-1, respawn=300, containmentType=-1, heading=0},
		 	{ mobile="fbase_stormtrooper_squad_leader", x=-30, z=0, y=-13, cellid=-1, respawn=300, containmentType=-1, heading=0},
			{ mobile="fbase_stormtrooper", x=-27.5, z=0, y=-10.5, cellid=-1, respawn=300, containmentType=-1, heading=0},
			--if Corellia { mobile="fbase_scout_trooper", x=-27.5, z=0, y=-10.5, cellid=-1, respawn=300, containmentType=-1, heading=0},
			--if Naboo { mobile="fbase_swamp_trooper", x=-27.5, z=0, y=-10.5, cellid=-1, respawn=300, containmentType=-1, heading=0},
			--if Tatooine { mobile="fbase_sand_trooper", x=-27.5, z=0, y=-10.5, cellid=-1, respawn=300, containmentType=-1, heading=0},
			{ mobile="fbase_stormtrooper_medic", x=-25, z=0, y=-8, cellid=-1, respawn=300, containmentType=-1, heading=0},
		 	{ mobile="fbase_stormtrooper_bombardier", x=-30, z=0, y=-8, cellid=-1, respawn=300, containmentType=-1, heading=0},
			...
			{ mobile="fbase_stormtrooper", x=-4, z=0, y=15, cellid=-1, respawn=360, containmentType=-1, heading=0},
		 	{ mobile="fbase_stormtrooper", x=4, z=0, y=15, cellid=-1, respawn=360, containmentType=-1, heading=0},
			--if Corellia { mobile="fbase_scout_trooper", x=-4, z=0, y=15, cellid=-1, respawn=360, containmentType=-1, heading=0},
		 	--if Corellia { mobile="fbase_scout_trooper", x=4, z=0, y=15, cellid=-1, respawn=360, containmentType=-1, heading=0},
			--if Naboo { mobile="fbase_swamp_trooper", x=-4, z=0, y=15, cellid=-1, respawn=360, containmentType=-1, heading=0},
		 	--if Naboo { mobile="fbase_swamp_trooper", x=4, z=0, y=15, cellid=-1, respawn=360, containmentType=-1, heading=0},
			--if Tatooine { mobile="fbase_sand_trooper", x=-4, z=0, y=15, cellid=-1, respawn=360, containmentType=-1, heading=0},
		 	--if Tatooine { mobile="fbase_sand_trooper", x=4, z=0, y=15, cellid=-1, respawn=360, containmentType=-1, heading=0},
			...
			{ mobile="fbase_imperial_colonel", x=-27.5, z=0, y=28.5, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="fbase_stormtrooper", x=25, z=0, y=26, cellid=-1, respawn=360, containmentType=-1, heading=0},
			--if Corellia { mobile="fbase_scout_trooper", x=25, z=0, y=26, cellid=-1, respawn=360, containmentType=-1, heading=0},
			--if Naboo { mobile="fbase_swamp_trooper", x=25, z=0, y=26, cellid=-1, respawn=360, containmentType=-1, heading=0},
			--if Tatooine { mobile="fbase_sand_trooper", x=25, z=0, y=26, cellid=-1, respawn=360, containmentType=-1, heading=0},
		 	{ mobile="fbase_imperial_sharpshooter", x=30, z=0, y=26, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="fbase_stormtrooper_bombardier", x=27.5, z=0, y=28.5, cellid=-1, respawn=360, containmentType=-1, heading=0},
			{ mobile="fbase_imperial_noncom", x=2.6, z=0, y=-4.1, cellid=3, respawn=300, containmentType=-1, heading=0},
			...
			{ mobile="fbase_imperial_warrant_officer_ii", x=2.5, z=-6.75, y=-16.5, cellid=6, respawn=300, containmentType=-1, heading=0},
			{ mobile="fbase_imperial_sergeant", x=7.9, z=-6.75, y=-16.9, cellid=6, respawn=300, containmentType=-1, heading=0},
			{ mobile="fbase_imperial_first_lieutenant", x=8, z=-6.75, y=-6, cellid=7, respawn=300, containmentType=-1, heading=0},
			...
			{ mobile="fbase_imperial_corporal", x=-5.5, z=-13.75, y=-3, cellid=9, respawn=300, containmentType=-1, heading=0},
			...
			{ mobile="fbase_command_security_guard", x=-5.5, z=-13.75, y=-6.6, cellid=9, respawn=300, containmentType=-1, heading=0},
			{ mobile="fbase_imperial_medic", x=1.8, z=-13.75, y=-12.6, cellid=9, respawn=300, containmentType=-1, heading=0},
			{ mobile="fbase_comm_operator", x=-7.6, z=-13.75, y=-12.6, cellid=9, respawn=300, containmentType=-1, heading=0},
