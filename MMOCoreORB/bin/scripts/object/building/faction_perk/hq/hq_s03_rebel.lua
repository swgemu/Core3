...
object_building_faction_perk_hq_hq_s03_rebel = object_building_faction_perk_hq_shared_hq_s03_rebel:new {
	...
	childCreatureObjects = {
		...
		-- 1 entry
		-- 2 hall1
		{ mobile = "fbase_rebel_recruit_hard", x = -4.7, z = 0.3, y = 3.9, cellid = 3, containmentType = -1, respawn = 60, heading = 1.5708},
		{ mobile = "fbase_rebel_cadet", x = -4.6, z = 0.3, y = -3.9, cellid = 3, containmentType = -1, respawn = 60, heading = 1.5708},
		-- 3 hall2
		{ mobile = "fbase_rebel_elite_commando", x = 3.2, z = 0.3, y = -4.9, cellid = 3, containmentType = -1, respawn = 60, heading = 0},
		-- 4 ramp1
		...
		-- 7 room3
		{ mobile = "fbase_rebel_elite_commando", x = -8.9, z = -13.8, y = 6.2, cellid = 7, containmentType = -1, respawn = 60, heading = 3.07178},
