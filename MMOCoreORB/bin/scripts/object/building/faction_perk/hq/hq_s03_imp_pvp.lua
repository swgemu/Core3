...
object_building_faction_perk_hq_hq_s03_imp_pvp = object_building_faction_perk_hq_shared_hq_s03:new {
		...
		childCreatureObjects = {
			...
			{ mobile="fbase_specialist_noncom_hard", x=-4.4, z=0, y=-2.1, cellid=2, respawn=300, containmentType=-1, heading=4.7},
			{ mobile="fbase_elite_dark_trooper_hard", x=-4.4, z=0, y=0.9, cellid=2, respawn=300, containmentType=-1, heading=4.7},
			{ mobile="fbase_dark_trooper_hard", x=4, z=-3.25, y=5, cellid=4, respawn=300, containmentType=-1, heading=3.14},
		 	{ mobile="fbase_imperial_exterminator_hard", x=-4, z=-10.25, y=-6, cellid=5, respawn=300, containmentType=-1, heading=1.57},

			{ mobile="fbase_stormtrooper_hard", x=-2.7, z=-13.75, y=7, cellid=7, respawn=300, containmentType=-1, heading=1.57},
			--if Tatooine { mobile="fbase_elite_sand_trooper_hard", x=-2.7, z=-13.75, y=7, cellid=7, respawn=300, containmentType=-1, heading=1.57},
			...
			{ mobile="fbase_dark_trooper_hard", x=-1.5, z=-20.75, y=6, cellid=9, respawn=300, containmentType=-1, heading=1.57},
			...
			--if Tatooine { mobile="fbase_elite_sand_trooper_hard", x=4.5, z=-20.75, y=15.8, cellid=10, respawn=300, containmentType=-1, heading=4.7},
			{ mobile="fbase_elite_dark_trooper_hard", x=-2, z=-20.75, y=15.8, cellid=10, respawn=300, containmentType=-1, heading=1.57},
			{ mobile="fbase_elite_dark_trooper_hard", x=1.5, z=-20.75, y=24.7, cellid=10, respawn=300, containmentType=-1, heading=0},
