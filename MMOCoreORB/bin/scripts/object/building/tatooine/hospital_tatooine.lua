...
object_building_tatooine_hospital_tatooine = object_building_tatooine_shared_hospital_tatooine:new {
	...
	childObjects = {
		...
		{templateFile = "object/tangible/terminal/terminal_elevator_up.iff", x = 0.14, z = 7.25, y = -2.19, ow = 0.915698, ox = 0, oy = 0.401868, oz = 0, cellid = 14, containmentType = -1},
		{templateFile = "object/tangible/terminal/terminal_elevator_down.iff", x = 0.29, z = 7.25, y = -2.34, ow = 0.944977, ox = 0, oy = 0.327135, oz = 0, cellid = 14, containmentType = -1},
		{templateFile = "object/tangible/terminal/terminal_elevator_down.iff", x = 0.29, z = 13.5, y = -2.34, ow = 0.906308, ox = 0, oy = 0.422618, oz = 0, cellid = 14, containmentType = -1},
		...
		{templateFile = "object/tangible/terminal/terminal_elevator_up.iff", x = 1.05087, z = -3.66955, y = -15.5655, ow = 0.707107, ox = 0, oy = -0.707107, oz = 0, cellid = 14, containmentType = -1},
		{templateFile = "object/tangible/terminal/terminal_elevator_down.iff", x = 1.05852, z = 1.33045, y = -15.563, ow = 0.707107, ox = 0, oy = -0.707107, oz = 0, cellid = 14, containmentType = -1},
