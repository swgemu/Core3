...
ObjectTemplates:addTemplate(object_building_general_space_dungeon_corellian_corvette_rebel, "object/building/general/space_dungeon_corellian_corvette_rebel.iff")
