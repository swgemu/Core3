...
object_building_player_player_house_generic_medium_style_02 = object_building_player_shared_player_house_generic_medium_style_02:new {
	...
	shopSigns = {
			{templateFile = "object/tangible/sign/player/shop_sign_s01.iff", x = 11, z = 0.5, y = 11, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1},
			{templateFile = "object/tangible/sign/player/shop_sign_s02.iff", x = 11, z = 0.5, y = 11, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1},
			{templateFile = "object/tangible/sign/player/shop_sign_s03.iff", x = 11, z = 0.5, y = 11, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1},
			{templateFile = "object/tangible/sign/player/shop_sign_s04.iff", x = 11, z = 0.5, y = 11, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1},			
	},	
