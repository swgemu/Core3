...
object_building_player_player_house_generic_small_style_02_floorplan_02 = object_building_player_shared_player_house_generic_small_style_02_floorplan_02:new {
	...
	shopSigns = {
			...
			{templateFile = "object/tangible/sign/player/house_address.iff", x = -1.91, z = 2, y = 8.35, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1},				
			{templateFile = "object/tangible/sign/player/shop_sign_s01.iff", x = -7, z = 0.5, y = 11, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1},
			{templateFile = "object/tangible/sign/player/shop_sign_s02.iff", x = -7, z = 0.5, y = 11, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1},
			{templateFile = "object/tangible/sign/player/shop_sign_s03.iff", x = -7, z = 0.5, y = 11, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1},
			{templateFile = "object/tangible/sign/player/shop_sign_s04.iff", x = -7, z = 0.5, y = 11, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1},			
	},	
