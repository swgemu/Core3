...
object_building_player_player_house_generic_large_style_02 = object_building_player_shared_player_house_generic_large_style_02:new {
	...
	shopSigns = {
			{templateFile = "object/tangible/sign/player/house_address.iff", x = -13.83, z = 2, y = 9.14, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},				
