...
object_building_player_city_shuttleport_corellia = object_building_player_city_shared_shuttleport_corellia:new {
	...
	childObjects = {
		...
		{templateFile = "object/tangible/terminal/terminal_travel.iff", x = -7, z = 0.6, y = 13.5, ox = 0, oy = 0, oz = 0, ow = 1, cellid = -1, containmentType = -1},
		{templateFile = "object/tangible/travel/ticket_collector/ticket_collector.iff", x = 8, z = 0.8, y = 13.5, ox = 0, oy = 0, oz = 0, ow = 1, cellid = -1, containmentType = -1},
