...
object_tangible_wearables_armor_chitin_shared_armor_chitin_s01_bicep_l = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:armor_chitin_s01_bicep_l",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_chitin_s01_bicep_l",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_chitin_s01_bicep_l",
...
object_tangible_wearables_armor_chitin_shared_armor_chitin_s01_bicep_r = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:armor_chitin_s01_bicep_r",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_chitin_s01_bicep_r",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_chitin_s01_bicep_r",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_chitin_shared_armor_chitin_s01_boots = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:armor_chitin_s01_boots",

	gameObjectType = 263,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_chitin_s01_boots",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_chitin_s01_boots",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_chitin_shared_armor_chitin_s01_bracer_l = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:armor_chitin_s01_bracer_l",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_chitin_s01_bracer_l",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_chitin_s01_bracer_l",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_chitin_shared_armor_chitin_s01_bracer_r = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:armor_chitin_s01_bracer_r",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_chitin_s01_bracer_r",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_chitin_s01_bracer_r",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_chitin_shared_armor_chitin_s01_chest_plate = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:armor_chitin_s01_chest_plate",

	gameObjectType = 257,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_chitin_s01_chest_plate",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_chitin_s01_chest_plate",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_chitin_shared_armor_chitin_s01_gloves = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:armor_chitin_s01_gloves",

	gameObjectType = 262,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_chitin_s01_gloves",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_chitin_s01_gloves",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_chitin_shared_armor_chitin_s01_helmet = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:armor_chitin_s01_helmet",

	gameObjectType = 258,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_chitin_s01_helmet",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_chitin_s01_helmet",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_chitin_shared_armor_chitin_s01_leggings = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:armor_chitin_s01_leggings",

	gameObjectType = 260,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_chitin_s01_leggings",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_chitin_s01_leggings",
	onlyVisibleInTools = 0,
