...
object_tangible_wearables_armor_nightsister_shared_armor_nightsister_bicep_r_s01 = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/wearables/armor/nightsister/shared_armor_nightsister_bicep_r_s01.iff"
...
--[[
	...
	detailedDescription = "@wearables_detail:armor_nightsister_bicep_r",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_nightsister_bicep_r",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_nightsister_bicep_r",
