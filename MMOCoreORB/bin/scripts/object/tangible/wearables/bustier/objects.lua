...
object_tangible_wearables_bustier_shared_bustier_s01 = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:bustier_s01",

	gameObjectType = 16777230,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:bustier_s01",

	noBuildRadius = 0,

	objectName = "@wearables_name:bustier_s01",
...
object_tangible_wearables_bustier_shared_bustier_s02 = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:bustier_s02",

	gameObjectType = 16777230,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:bustier_s02",

	noBuildRadius = 0,

	objectName = "@wearables_name:bustier_s02",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_bustier_shared_bustier_s03 = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:bustier_s03",

	gameObjectType = 16777230,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:bustier_s03",

	noBuildRadius = 0,

	objectName = "@wearables_name:bustier_s03",
	onlyVisibleInTools = 0,
