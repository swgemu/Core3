...
object_tangible_medicine_crafted_medpack_damage_b = object_tangible_medicine_crafted_shared_medpack_damage_b:new {
	...
	experimentalMin = {0, 0, 75, 15, 40, 1000},
	experimentalMax = {0, 0, 200, 30, 25, 1000},
	experimentalPrecision = {0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 4},

}

ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_damage_b, "object/tangible/medicine/crafted/medpack_damage_b.iff")
