...
object_tangible_medicine_crafted_medpack_wound_action_e = object_tangible_medicine_crafted_shared_medpack_wound_action_e:new {
	gameObjectType = 8241,
...
ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_wound_action_e, "object/tangible/medicine/crafted/medpack_wound_action_e.iff")
