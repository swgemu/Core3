...
ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_disease_area_willpower_b, "object/tangible/medicine/crafted/medpack_disease_area_willpower_b.iff")
