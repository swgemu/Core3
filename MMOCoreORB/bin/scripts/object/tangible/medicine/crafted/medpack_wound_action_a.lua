...
object_tangible_medicine_crafted_medpack_wound_action_a = object_tangible_medicine_crafted_shared_medpack_wound_action_a:new {
	gameObjectType = 8241,
...
ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_wound_action_a, "object/tangible/medicine/crafted/medpack_wound_action_a.iff")
