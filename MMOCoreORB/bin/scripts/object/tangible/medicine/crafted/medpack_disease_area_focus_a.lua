...
object_tangible_medicine_crafted_medpack_disease_area_focus_a = object_tangible_medicine_crafted_shared_medpack_disease_area_focus_a:new {
	gameObjectType = 8240,
...
ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_disease_area_focus_a, "object/tangible/medicine/crafted/medpack_disease_area_focus_a.iff")
