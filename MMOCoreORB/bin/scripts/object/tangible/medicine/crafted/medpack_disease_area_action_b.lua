...
object_tangible_medicine_crafted_medpack_disease_area_action_b = object_tangible_medicine_crafted_shared_medpack_disease_area_action_b:new {
	gameObjectType = 8240,
...
ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_disease_area_action_b, "object/tangible/medicine/crafted/medpack_disease_area_action_b.iff")
