...
object_tangible_medicine_crafted_medpack_disease_area_constitution_c = object_tangible_medicine_crafted_shared_medpack_disease_area_constitution_c:new {
	gameObjectType = 8240,
...
ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_disease_area_constitution_c, "object/tangible/medicine/crafted/medpack_disease_area_constitution_c.iff")
