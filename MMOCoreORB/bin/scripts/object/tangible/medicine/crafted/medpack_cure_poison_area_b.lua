...
ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_cure_poison_area_b, "object/tangible/medicine/crafted/medpack_cure_poison_area_b.iff")
