...
object_tangible_medicine_crafted_medpack_cure_poison_area_c = object_tangible_medicine_crafted_shared_medpack_cure_poison_area_c:new {
	...
	experimentalMin = {0, 0, 10, 20, 5, 100, 1000},
	experimentalMax = {0, 0, 450, 40, 10, 100, 1000},
	experimentalPrecision = {0, 0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 4},
}

ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_cure_poison_area_c, "object/tangible/medicine/crafted/medpack_cure_poison_area_c.iff")
