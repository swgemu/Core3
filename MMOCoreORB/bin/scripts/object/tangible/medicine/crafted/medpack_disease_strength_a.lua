...
object_tangible_medicine_crafted_medpack_disease_strength_a = object_tangible_medicine_crafted_shared_medpack_disease_strength_a:new {
	gameObjectType = 8240,
...
ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_disease_strength_a, "object/tangible/medicine/crafted/medpack_disease_strength_a.iff")
