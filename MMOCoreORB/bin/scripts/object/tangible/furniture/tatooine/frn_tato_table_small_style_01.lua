...
ObjectTemplates:addTemplate(object_tangible_furniture_tatooine_frn_tato_table_small_style_01, "object/tangible/furniture/tatooine/frn_tato_table_small_style_01.iff")
