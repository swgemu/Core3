...
ObjectTemplates:addTemplate(object_tangible_furniture_tatooine_frn_tatt_chair_cantina_seat, "object/tangible/furniture/tatooine/frn_tatt_chair_cantina_seat.iff")
