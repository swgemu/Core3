...
ObjectTemplates:addTemplate(object_tangible_furniture_all_frn_all_light_lamp_candlestick_free_s02, "object/tangible/furniture/all/frn_all_light_lamp_candlestick_free_s02.iff")
