...
object_tangible_event_perk_fed_dub_stage_theater = object_tangible_poi_base_shared_poi_base:new {
	invisible = 1,
	...
	childObjects = {
		...
		{ templateFile = "object/mobile/dressed_fed_dub_patrolman_human_male_01.iff", x = 0.01, z = 1.35, y = 5.39, ow = 0.00881, ox = 0, oy = 0.99996, oz = 0, cellid = -1, containmentType = -1 },
		{ templateFile = "object/mobile/dressed_fed_dub_patrolman_human_male_01.iff", x = -6.01, z = 1.35, y = 5.49, ow = 0.00881, ox = 0, oy = 0.99996, oz = 0, cellid = -1, containmentType = -1 },
		{ templateFile = "object/mobile/dressed_fed_dub_patrolman_human_male_01.iff", x = -2.16, z = 1.35, y = 5.43, ow = 0.00881, ox = 0, oy = 0.99996, oz = 0, cellid = -1, containmentType = -1 },
		{ templateFile = "object/mobile/dressed_fed_dub_patrolman_human_male_01.iff", x = 3.75, z = 1.35, y = 5.49, ow = 0.00881, ox = 0, oy = 0.99996, oz = 0, cellid = -1, containmentType = -1 },
...
ObjectTemplates:addTemplate(object_tangible_event_perk_fed_dub_stage_theater, "object/tangible/event_perk/fed_dub_stage_theater.iff")
