...
object_tangible_event_perk_fed_dub_2x10_honorguard = object_tangible_poi_base_shared_poi_base:new {
	invisible = 1,
...
ObjectTemplates:addTemplate(object_tangible_event_perk_fed_dub_2x10_honorguard, "object/tangible/event_perk/fed_dub_2x10_honorguard.iff")
