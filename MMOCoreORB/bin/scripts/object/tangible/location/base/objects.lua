...
object_tangible_location_base_shared_location_base = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/location/base/shared_location_base.iff"
