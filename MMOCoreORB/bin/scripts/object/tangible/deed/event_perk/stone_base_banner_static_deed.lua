...
ObjectTemplates:addTemplate(object_tangible_deed_event_perk_stone_base_banner_static_deed, "object/tangible/deed/event_perk/stone_base_banner_static_deed.iff")
