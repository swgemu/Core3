...
ObjectTemplates:addTemplate(object_tangible_loot_bestine_bestine_painting_schematic_golden_flower_01, "object/tangible/loot/bestine/bestine_painting_schematic_golden_flower_01.iff")
