...
object_tangible_component_shared_barrel_blaster = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/component/shared_barrel_blaster.iff"
...
--[[
	...
	detailedDescription = "@component_detail:barrel_blaster",

	gameObjectType = 262153,

	locationReservationRadius = 0,
	lookAtText = "@component_lookat:barrel_blaster",

	noBuildRadius = 0,

	objectName = "@component_name:barrel_blaster",
...
object_tangible_component_shared_blaster_barrel = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/component/shared_blaster_barrel.iff"
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/test_muzzle.apt",
	arrangementDescriptorFilename = "",
	...
	detailedDescription = "@component_d:blaster_pistol_barrel",
	...
	objectName = "@component_n:blaster_pistol_barrel",
	onlyVisibleInTools = 0,
...
object_tangible_component_shared_blaster_pistol_barrel = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/component/shared_blaster_pistol_barrel.iff"
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	...
	locationReservationRadius = 0,
	lookAtText = "@component_l:blaster_pistol_barrel",
...
object_tangible_component_shared_blaster_power_handler = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/component/shared_blaster_power_handler.iff"
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	...
	detailedDescription = "@component_d:blaster_power_handler",

	gameObjectType = 262153,

	locationReservationRadius = 0,
	lookAtText = "@component_l:blaster_power_handler",

	noBuildRadius = 0,

	objectName = "@component_n:blaster_power_handler",
	onlyVisibleInTools = 0,
...
object_tangible_component_shared_scope_weapon = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/component/shared_scope_weapon.iff"
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	...
	detailedDescription = "@component_d:scope_weapon",

	gameObjectType = 262153,

	locationReservationRadius = 0,
	lookAtText = "@component_l:scope_weapon",

	noBuildRadius = 0,

	objectName = "@component_n:scope_weapon",
	onlyVisibleInTools = 0,
