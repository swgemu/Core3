...
object_tangible_component_droid_droid_brain_advanced = object_tangible_component_droid_shared_droid_brain_advanced:new {
...
ObjectTemplates:addTemplate(object_tangible_component_droid_droid_brain_advanced, "object/tangible/component/droid/droid_brain_advanced.iff")
