...
object_tangible_component_droid_medic_module_1 = object_tangible_component_droid_shared_medic_module_1:new {

	dataObjectComponent = "DroidMedicalModuleDataComponent",
...
ObjectTemplates:addTemplate(object_tangible_component_droid_medic_module_1, "object/tangible/component/droid/medic_module_1.iff")
