...
object_tangible_component_droid_crafting_module_space = object_tangible_component_droid_shared_crafting_module_space:new {

	dataObjectComponent = "DroidCraftingModuleDataComponent",
	templateType = DROIDCRAFTINGMODULE,
	-- CraftingTool::SPACE
	craftingType = 5,
	craftingStationTemplate = "object/tangible/crafting/station/space_station.iff",
	attributeListString = "@obj_attr_n:crafting_station_space",
