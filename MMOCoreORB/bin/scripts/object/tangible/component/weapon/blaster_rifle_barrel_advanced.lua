...
object_tangible_component_weapon_blaster_rifle_barrel_advanced = object_tangible_component_weapon_shared_blaster_rifle_barrel_advanced:new {
	...
	experimentalSubGroupTitles = {"null", "null", "mindamage", "maxdamage", "attackspeed", "woundchance", "hitpoints", "zerorangemod", "maxrangemod", "mindrangemod", "midrangemod"},
