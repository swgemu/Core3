...
object_tangible_component_chemistry_quest_stimpack_a = object_tangible_component_chemistry_shared_quest_stimpack_a:new {
	...
	experimentalMin = {0, 0, 95, 15, 5, 1000},
	experimentalMax = {0, 0, 150, 25, 5, 1000},
	experimentalPrecision = {0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 4},

}

ObjectTemplates:addTemplate(object_tangible_component_chemistry_quest_stimpack_a, "object/tangible/component/chemistry/quest_stimpack_a.iff")
