...
object_tangible_lair_tusken_raider_shared_lair_tusken_raider_npc = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@lair_d:tusken_raider",
	...
	objectName = "@lair_n:tusken_raider",
...
ObjectTemplates:addTemplate(object_tangible_lair_tusken_raider_shared_lair_tusken_raider_npc, 2693069296)
