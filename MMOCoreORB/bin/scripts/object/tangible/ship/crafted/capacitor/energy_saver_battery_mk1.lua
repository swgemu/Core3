...
object_tangible_ship_crafted_capacitor_energy_saver_battery_mk1 = object_tangible_ship_crafted_capacitor_shared_energy_saver_battery_mk1:new {
	...
	experimentalMin = {0, 0, -115, -85},
	experimentalMax = {0, 0, -85, -115},
	experimentalPrecision = {0, 0, 1, 1},
	experimentalCombineType = {0, 0, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_ship_crafted_capacitor_energy_saver_battery_mk1, "object/tangible/ship/crafted/capacitor/energy_saver_battery_mk1.iff")
