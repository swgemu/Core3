...
object_tangible_ship_crafted_capacitor_capacitor_mk1 = object_tangible_ship_crafted_capacitor_shared_capacitor_mk1:new {
	...
	experimentalMin = {0, 0, 128, 1, 1035, 64, 1, 1150, 425, 17},
	experimentalMax = {0, 0, 173, 1, 765, 86, 1, 850, 575, 23},
