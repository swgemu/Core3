...
object_tangible_ship_crafted_capacitor_quick_recharge_battery_mk3 = object_tangible_ship_crafted_capacitor_shared_quick_recharge_battery_mk3:new {
	...
	experimentalMin = {0, 0, -139, 4},
	experimentalMax = {0, 0, -103, 6},
	experimentalPrecision = {0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_ship_crafted_capacitor_quick_recharge_battery_mk3, "object/tangible/ship/crafted/capacitor/quick_recharge_battery_mk3.iff")
