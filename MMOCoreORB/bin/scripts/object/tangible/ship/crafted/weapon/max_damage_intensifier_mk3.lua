...
ObjectTemplates:addTemplate(object_tangible_ship_crafted_weapon_max_damage_intensifier_mk3, "object/tangible/ship/crafted/weapon/max_damage_intensifier_mk3.iff")
