...
object_tangible_ship_crafted_weapon_missile_countermeasure_microchaff_pack = object_tangible_ship_crafted_weapon_missile_shared_countermeasure_microchaff_pack:new {
	...
	experimentalMin = {0, 0, 85, 60, 0.391, 12, 0},
	experimentalMax = {0, 0, 115, 81, 0.289, 16, 0},
