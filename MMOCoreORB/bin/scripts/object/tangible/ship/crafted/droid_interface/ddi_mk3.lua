...
object_tangible_ship_crafted_droid_interface_ddi_mk3 = object_tangible_ship_crafted_droid_interface_shared_ddi_mk3:new {
	...
	experimentalMin = {0, 0, 540, 1, 2875, 270, 1, 633, 26},
	experimentalMax = {0, 0, 730, 1, 2125, 365, 1, 468, 19},
	experimentalPrecision = {0, 0, 1, 0, 1, 1, 0, 1, 1},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_ship_crafted_droid_interface_ddi_mk3, "object/tangible/ship/crafted/droid_interface/ddi_mk3.iff")
