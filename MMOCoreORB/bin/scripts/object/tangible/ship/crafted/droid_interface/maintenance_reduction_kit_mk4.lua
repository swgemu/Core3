...
object_tangible_ship_crafted_droid_interface_maintenance_reduction_kit_mk4 = object_tangible_ship_crafted_droid_interface_shared_maintenance_reduction_kit_mk4:new {
	...
	experimentalMin = {0, 0, 1, -74},
	experimentalMax = {0, 0, 2, -116},
