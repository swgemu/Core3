...
object_tangible_ship_crafted_shields_shield_energy_saver_kit_mk1 = object_tangible_ship_crafted_shields_shared_shield_energy_saver_kit_mk1:new {
	...
	experimentalMin = {0, 0, -58, -58, -213},
	experimentalMax = {0, 0, -43, -43, -288},
	experimentalPrecision = {0, 0, 1, 1, 1},
	experimentalCombineType = {0, 0, 1, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_ship_crafted_shields_shield_energy_saver_kit_mk1, "object/tangible/ship/crafted/shields/shield_energy_saver_kit_mk1.iff")
