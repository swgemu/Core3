...
object_tangible_ship_crafted_shields_shield_overcharger_mk3 = object_tangible_ship_crafted_shields_shared_shield_overcharger_mk3:new {
	...
	experimentalMin = {0, 0, 189, 189, -1.459},
	experimentalMax = {0, 0, 256, 256, -1.079},
