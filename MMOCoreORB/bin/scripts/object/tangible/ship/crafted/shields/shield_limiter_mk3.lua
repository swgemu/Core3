...
object_tangible_ship_crafted_shields_shield_limiter_mk3 = object_tangible_ship_crafted_shields_shared_shield_limiter_mk3:new {
	...
	experimentalMin = {0, 0, -243, -243, 1.510},
	experimentalMax = {0, 0, -180, -180, 2.043},
