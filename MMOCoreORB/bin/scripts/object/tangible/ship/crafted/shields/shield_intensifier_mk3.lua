...
object_tangible_ship_crafted_shields_shield_intensifier_mk3 = object_tangible_ship_crafted_shields_shared_shield_intensifier_mk3:new {
	...
	experimentalMin = {0, 0, 180, 180, 460},
	experimentalMax = {0, 0, 243, 243, 340},
