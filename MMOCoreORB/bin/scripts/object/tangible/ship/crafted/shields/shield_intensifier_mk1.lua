...
object_tangible_ship_crafted_shields_shield_intensifier_mk1 = object_tangible_ship_crafted_shields_shared_shield_intensifier_mk1:new {
	...
	experimentalMin = {0, 0, 43, 43, 288},
	experimentalMax = {0, 0, 58, 58, 213},
	experimentalPrecision = {0, 0, 1, 1, 1},
	experimentalCombineType = {0, 0, 1, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_ship_crafted_shields_shield_intensifier_mk1, "object/tangible/ship/crafted/shields/shield_intensifier_mk1.iff")
