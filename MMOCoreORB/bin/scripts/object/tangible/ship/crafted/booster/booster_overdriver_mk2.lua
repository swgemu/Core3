...
object_tangible_ship_crafted_booster_booster_overdriver_mk2 = object_tangible_ship_crafted_booster_shared_booster_overdriver_mk2:new {
	...
	experimentalMin = {0, 0, 9, 8, 683},
	experimentalMax = {0, 0, 17, 15, 368},
