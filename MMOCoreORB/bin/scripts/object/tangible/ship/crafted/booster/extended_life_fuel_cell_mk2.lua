...
object_tangible_ship_crafted_booster_extended_life_fuel_cell_mk2 = object_tangible_ship_crafted_booster_shared_extended_life_fuel_cell_mk2:new {
	...
	experimentalMin = {0, 0, 308, -14},
	experimentalMax = {0, 0, 572, -8},
	experimentalPrecision = {0, 0, 0, 0},
}

ObjectTemplates:addTemplate(object_tangible_ship_crafted_booster_extended_life_fuel_cell_mk2, "object/tangible/ship/crafted/booster/extended_life_fuel_cell_mk2.iff")
