...
object_tangible_ship_crafted_booster_fast_charge_fuel_cell_mk4 = object_tangible_ship_crafted_booster_shared_fast_charge_fuel_cell_mk4:new {
	...
	experimentalMin = {0, 0, -692, 9},
	experimentalMax = {0, 0, -373, 17},
	experimentalPrecision = {0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_ship_crafted_booster_fast_charge_fuel_cell_mk4, "object/tangible/ship/crafted/booster/fast_charge_fuel_cell_mk4.iff")
