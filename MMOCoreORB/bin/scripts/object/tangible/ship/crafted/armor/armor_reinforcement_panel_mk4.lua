...
object_tangible_ship_crafted_armor_armor_reinforcement_panel_mk4 = object_tangible_ship_crafted_armor_shared_armor_reinforcement_panel_mk4:new {
	...
	experimentalMin = {0, 0, 265, 265, 2162},
	experimentalMax = {0, 0, 358, 358, 1598},
	experimentalPrecision = {0, 0, 1, 1, 1},
	experimentalCombineType = {0, 0, 1, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_ship_crafted_armor_armor_reinforcement_panel_mk4, "object/tangible/ship/crafted/armor/armor_reinforcement_panel_mk4.iff")
