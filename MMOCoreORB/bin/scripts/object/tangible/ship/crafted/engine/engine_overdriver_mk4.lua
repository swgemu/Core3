...
object_tangible_ship_crafted_engine_engine_overdriver_mk4 = object_tangible_ship_crafted_engine_shared_engine_overdriver_mk4:new {
	...
	experimentalMin = {0, 0, 518, 10},
	experimentalMax = {0, 0, 383, 14},
