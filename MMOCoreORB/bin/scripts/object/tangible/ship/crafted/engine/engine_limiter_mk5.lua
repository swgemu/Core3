...
object_tangible_ship_crafted_engine_engine_limiter_mk5 = object_tangible_ship_crafted_engine_shared_engine_limiter_mk5:new {
	...
	experimentalMin = {0, 0, -281, -15},
	experimentalMax = {0, 0, -380, -11},
