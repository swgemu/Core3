...
object_tangible_ship_crafted_reactor_reactor_overcharger_mk3 = object_tangible_ship_crafted_reactor_shared_reactor_overcharger_mk3:new {
	...
	experimentalMin = {0, 0, 630, 1625},
	experimentalMax = {0, 0, 1170, 875},
	experimentalPrecision = {0, 0, 1, 1},
	experimentalCombineType = {0, 0, 1, 1},
}

ObjectTemplates:addTemplate(object_tangible_ship_crafted_reactor_reactor_overcharger_mk3, "object/tangible/ship/crafted/reactor/reactor_overcharger_mk3.iff")
