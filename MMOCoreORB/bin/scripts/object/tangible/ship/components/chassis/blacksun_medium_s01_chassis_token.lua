...
object_tangible_ship_components_chassis_blacksun_medium_s01_chassis_token = object_tangible_ship_components_chassis_shared_blacksun_medium_s01_chassis_token:new {

    templateType = SHIPCHASSIS,
	chassisDeed = "object/tangible/ship/crafted/chassis/blacksun_medium_s01_deed.iff",
	dealerFee = 4000,
