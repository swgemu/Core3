...
ObjectTemplates:addTemplate(object_tangible_ship_components_chassis_tiefighter_chassis_token, "object/tangible/ship/components/chassis/tiefighter_chassis_token.iff")
