...
ObjectTemplates:addTemplate(object_tangible_ship_components_chassis_blacksun_medium_s03_chassis_token, "object/tangible/ship/components/chassis/blacksun_medium_s03_chassis_token.iff")
