...
ObjectTemplates:addTemplate(object_tangible_ship_components_chassis_blacksun_heavy_s02_chassis_token, "object/tangible/ship/components/chassis/blacksun_heavy_s02_chassis_token.iff")
