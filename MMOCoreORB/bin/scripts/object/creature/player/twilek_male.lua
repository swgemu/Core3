...
object_creature_player_twilek_male = object_creature_player_shared_twilek_male:new {
	...
	startingItems = { },
	startingSkills = { "species_twilek", "social_language_basic_comprehend", "social_language_basic_speak" , "social_language_twilek_comprehend", "social_language_twilek_speak" }
}
