...
object_weapon_ranged_pistol_base_shared_pistol_base = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/ranged/pistol/base/shared_pistol_base.iff"
