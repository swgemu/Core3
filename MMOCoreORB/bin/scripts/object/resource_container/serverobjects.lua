...
includeFile("resource_container/base/serverobjects.lua")

-- Server Objects
includeFile("resource_container/energy_gas.lua")
includeFile("resource_container/energy_gas_lg.lua")
includeFile("resource_container/energy_liquid.lua")
includeFile("resource_container/energy_liquid_lg.lua")
includeFile("resource_container/energy_radioactive.lua")
includeFile("resource_container/energy_radioactive_lg.lua")
includeFile("resource_container/energy_solid.lua")
includeFile("resource_container/energy_solid_lg.lua")
includeFile("resource_container/inorganic_bottle_water.lua")
includeFile("resource_container/inorganic_chemicals.lua")
includeFile("resource_container/inorganic_chemicals_lg.lua")
includeFile("resource_container/inorganic_gas.lua")
includeFile("resource_container/inorganic_gas_lg.lua")
includeFile("resource_container/inorganic_minerals.lua")
includeFile("resource_container/inorganic_minerals_lg.lua")
includeFile("resource_container/inorganic_petrochem_liquid.lua")
includeFile("resource_container/inorganic_water.lua")
includeFile("resource_container/inorganic_water_lg.lua")
includeFile("resource_container/organic_bean.lua")
includeFile("resource_container/organic_bottle_milk.lua")
...
includeFile("resource_container/organic_food_lg.lua")
...
includeFile("resource_container/organic_hide_lg.lua")
...
includeFile("resource_container/organic_structure_lg.lua")
