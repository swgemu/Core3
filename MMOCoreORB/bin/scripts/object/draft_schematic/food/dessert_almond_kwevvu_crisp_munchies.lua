...
object_draft_schematic_food_dessert_almond_kwevvu_crisp_munchies = object_draft_schematic_food_shared_dessert_almond_kwevvu_crisp_munchies:new {
   ...
   resourceTypes = {"cereal", "meat", "fruit_fruits", "object/tangible/food/crafted/additive/shared_additive_light.iff"},
   ...
   tanoCRC = 3988122695, -- Script: 'object/tangible/food/crafted/dessert_almond_kwevvu_crisp_munchies.iff'
}
