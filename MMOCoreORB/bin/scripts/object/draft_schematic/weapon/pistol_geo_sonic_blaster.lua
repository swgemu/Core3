...
object_draft_schematic_weapon_pistol_geo_sonic_blaster = object_draft_schematic_weapon_shared_pistol_geo_sonic_blaster:new {
   ...
   resourceTypes = {"aluminum_chromium", "copper_mythra", "aluminum_chromium", "object/tangible/component/weapon/shared_blaster_power_handler.iff", "object/tangible/component/shared_blaster_pistol_barrel.iff", "", "object/tangible/component/weapon/shared_scope_weapon.iff"},
   resourceQuantities = {142, 60, 28, 4, 1, 0, 1},
