...
object_draft_schematic_structure_installation_mining_ore = object_draft_schematic_structure_shared_installation_mining_ore:new {
   ...
   resourceTypes = {"steel", "metal", "ore", "metal", "object/tangible/component/structure/shared_structural_module.iff", "chemical", "object/tangible/component/structure/shared_generator_turbine.iff", "object/tangible/component/structure/shared_wall_module.iff", "object/tangible/component/structure/shared_light_ore_mining_unit.iff"},
   resourceQuantities = {200, 300, 150, 100, 3, 200, 1, 3, 1},
