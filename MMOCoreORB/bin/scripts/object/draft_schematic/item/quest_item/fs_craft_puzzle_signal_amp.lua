...
object_draft_schematic_item_quest_item_fs_craft_puzzle_signal_amp = object_draft_schematic_item_quest_item_shared_fs_craft_puzzle_signal_amp:new {
	templateType = DRAFTSCHEMATIC,

	customObjectName = "Signal Amplifier",
...
ObjectTemplates:addTemplate(object_draft_schematic_item_quest_item_fs_craft_puzzle_signal_amp, "object/draft_schematic/item/quest_item/fs_craft_puzzle_signal_amp.iff")
