...
object_draft_schematic_item_quest_item_fs_craft_puzzle_gyro_receiver = object_draft_schematic_item_quest_item_shared_fs_craft_puzzle_gyro_receiver:new {
	templateType = DRAFTSCHEMATIC,

	customObjectName = "Gyroscopic Receiver",
...
ObjectTemplates:addTemplate(object_draft_schematic_item_quest_item_fs_craft_puzzle_gyro_receiver, "object/draft_schematic/item/quest_item/fs_craft_puzzle_gyro_receiver.iff")
