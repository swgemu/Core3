...
object_draft_schematic_item_quest_item_fs_craft_puzzle_solid_state_array = object_draft_schematic_item_quest_item_shared_fs_craft_puzzle_solid_state_array:new {
	templateType = DRAFTSCHEMATIC,

	customObjectName = "Solid State Array",
...
ObjectTemplates:addTemplate(object_draft_schematic_item_quest_item_fs_craft_puzzle_solid_state_array, "object/draft_schematic/item/quest_item/fs_craft_puzzle_solid_state_array.iff")
