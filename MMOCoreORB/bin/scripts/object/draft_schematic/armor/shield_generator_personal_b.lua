...
object_draft_schematic_armor_shield_generator_personal_b = object_draft_schematic_armor_shared_shield_generator_personal_b:new {
   ...
   ingredientSlotType = {0, 0, 0, 2, 2, 2, 2, 2, 2},
   ...
   resourceQuantities = {60, 20, 20, 1, 1, 1, 1, 1, 1},
   ...
   tanoCRC = 4256080763, -- Script: 'object/tangible/component/armor/shield_generator_personal_b.iff'
}
