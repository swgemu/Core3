...
object_draft_schematic_chemistry_medpack_wound_constitution_d = object_draft_schematic_chemistry_shared_medpack_wound_constitution_d:new {
   ...
   experimentalMin = {0, 0, 30, 25, 50, 1000},
   experimentalMax = {0, 0, 240, 50, 80, 1000},
   experimentalPrecision = {0, 0, 0, 0, 0, 0},

   tanoCRC = 3320958290, -- Script: 'object/tangible/medicine/crafted/medpack_wound_constitution_d.iff'
}
