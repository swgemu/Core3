...
object_draft_schematic_chemistry_medpack_poison_action_c = object_draft_schematic_chemistry_shared_medpack_poison_action_c:new {
   ...
   groupName = "craftApplyPoisonGroupC", -- Group schematic is awarded in (See skills table)
   ...
   resourceQuantities = {8, 20, 20, 1, 1, 1},
   ...
   experimentalMin = {0, 0, 10, 15, 15, 30, 25, 30, 1000},
   experimentalMax = {0, 0, 300, 35, 30, 70, 150, 240, 1000},
   experimentalPrecision = {0, 0, 0, 0, 0, 0, 0, 0, 0},

   tanoCRC = 264871813, -- Script: 'object/tangible/medicine/crafted/medpack_poison_action_c.iff'
}
