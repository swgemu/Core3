...
object_draft_schematic_chemistry_medpack_cure_poison_area_b = object_draft_schematic_chemistry_shared_medpack_cure_poison_area_b:new {
   ...
   groupName = "craftCurePoisonGroupB", -- Group schematic is awarded in (See skills table)
   ...
   experimentalMin = {0, 0, 10, 15, 10, 80, 1000},
   experimentalMax = {0, 0, 180, 30, 0, 80, 1000},
   experimentalPrecision = {0, 0, 0, 0, 0, 0, 0},

   tanoCRC = 3732402691, -- Script: 'object/tangible/medicine/crafted/medpack_cure_poison_area_b.iff'
}
