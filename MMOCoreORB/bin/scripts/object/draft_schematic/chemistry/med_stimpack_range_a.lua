...
object_draft_schematic_chemistry_med_stimpack_range_a = object_draft_schematic_chemistry_shared_med_stimpack_range_a:new {
   ...
   groupName = "craftStimpackRangeGroupA", -- Group schematic is awarded in (See skills table)
   ...
   experimentalMin = {0, 0, 75, 10, 1, 15, 1000},
   experimentalMax = {0, 0, 150, 20, 5, 20, 1000},
   experimentalPrecision = {0, 0, 0, 0, 0, 0, 0},

   tanoCRC = 37400964, -- Script: 'object/tangible/medicine/crafted/medpack_grenade_damage_a.iff'
}
