...
object_draft_schematic_droid_droid_damage_repair_kit_d = object_draft_schematic_droid_shared_droid_damage_repair_kit_d:new {
   ...
   groupName = "craftDroidDamageRepairD", -- Group schematic is awarded in (See skills table)
   ...
   experimentalMin = {0, 0, 525, 14, 1000},
   experimentalMax = {0, 0, 2250, 28, 1000},
   experimentalPrecision = {0, 0, 0, 0, 0},

   tanoCRC = 662012896, -- Script: 'object/tangible/medicine/pet/droid_damage_kit_d.iff'
}
