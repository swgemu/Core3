...
object_draft_schematic_droid_component_harvest_module = object_draft_schematic_droid_component_shared_harvest_module:new {
   ...
   experimentalSubGroupTitles = {"null", "null", "decayrate", "hitpoints", "mechanism_quality", "harvest_power"},
   experimentalMin = {0, 0, 5, 1000, -10, 5},
   experimentalMax = {0, 0, 15, 1000, 15, 20},
   experimentalPrecision = {0, 0, 0, 0, 0, 0},

   tanoCRC = 1840155737, -- Script: 'object/tangible/component/droid/harvest_module.iff'
}
ObjectTemplates:addTemplate(object_draft_schematic_droid_component_harvest_module, "object/draft_schematic/droid/component/harvest_module.iff")
