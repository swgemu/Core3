...
object_draft_schematic_droid_component_item_storage_module_6 = object_draft_schematic_droid_component_shared_item_storage_module_6:new {
   ...
   customObjectName = "Level 6 Droid Item Storage Module",
   ...
   targetTemplate = "object/tangible/component/droid/item_storage_module_6.iff",

   additionalTemplates = {
              "object/tangible/component/droid/shared_item_storage_module_6.iff",
             }
