...
object_draft_schematic_droid_component_item_storage_module_2 = object_draft_schematic_droid_component_shared_item_storage_module_2:new {
   ...
   experimentalMin = {0, 0, 5, 1000, -10, 3},
   experimentalMax = {0, 0, 15, 1000, 15, 5},
   experimentalPrecision = {0, 0, 0, 0, 0, 0},

   tanoCRC = 10819973, -- Script: 'object/tangible/component/droid/item_storage_module_2.iff'
}
ObjectTemplates:addTemplate(object_draft_schematic_droid_component_item_storage_module_2, "object/draft_schematic/droid/component/item_storage_module_2.iff")
