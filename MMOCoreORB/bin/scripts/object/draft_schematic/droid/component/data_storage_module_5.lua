...
object_draft_schematic_droid_component_data_storage_module_5 = object_draft_schematic_droid_component_shared_data_storage_module_5:new {
   ...
   customObjectName = "Level 5 Droid Data Module",
   ...
   targetTemplate = "object/tangible/component/droid/data_storage_module_5.iff",

   additionalTemplates = {
              "object/tangible/component/droid/shared_data_storage_module_5.iff",
             }
