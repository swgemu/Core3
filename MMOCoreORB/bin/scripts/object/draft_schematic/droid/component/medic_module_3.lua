...
object_draft_schematic_droid_component_medic_module_3 = object_draft_schematic_droid_component_shared_medic_module_3:new {
   ...
   customObjectName = "Level 3 Droid Medical Module",
   ...
   targetTemplate = "object/tangible/component/droid/medic_module_3.iff",

   additionalTemplates = {
              "object/tangible/component/droid/shared_medic_module_3.iff",
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_droid_component_medic_module_3, "object/draft_schematic/droid/component/medic_module_3.iff")
