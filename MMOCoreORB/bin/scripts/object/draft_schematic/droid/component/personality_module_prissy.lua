...
object_draft_schematic_droid_component_personality_module_prissy = object_draft_schematic_droid_component_shared_personality_module_prissy:new {
   ...
   ingredientTitleNames = {"module_frame", "thermal_shielding", "data_smart_indexer", "primary_phrase_database"},
   ...
   targetTemplate = "object/tangible/component/droid/personality_module_prissy.iff",

   additionalTemplates = {
              "object/tangible/component/droid/shared_personality_module_prissy.iff",
             }

}
ObjectTemplates:addTemplate(object_draft_schematic_droid_component_personality_module_prissy, "object/draft_schematic/droid/component/personality_module_prissy.iff")
