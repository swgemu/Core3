...
object_draft_schematic_droid_component_performer_effects_d = object_draft_schematic_droid_component_shared_performer_effects_d:new {
   ...
   experimentalMin = {0, 0, 5, 1000, -10, 1000},
   experimentalMax = {0, 0, 15, 1000, 15, 1000},
   experimentalPrecision = {0, 0, 0, 0, 0, 0},

   tanoCRC = 1760996239, -- Script: 'object/tangible/component/droid/performer_effects_d.iff'
}
ObjectTemplates:addTemplate(object_draft_schematic_droid_component_performer_effects_d, "object/draft_schematic/droid/component/performer_effects_d.iff")
