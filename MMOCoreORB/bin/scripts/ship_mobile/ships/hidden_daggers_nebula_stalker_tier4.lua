hidden_daggers_nebula_stalker_tier4 = ShipAgent:new {
...
ShipAgentTemplates:addShipAgentTemplate(hidden_daggers_nebula_stalker_tier4, "hidden_daggers_nebula_stalker_tier4")
