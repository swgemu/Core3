hidden_daggers_nebula_stalker_tier2 = ShipAgent:new {
...
ShipAgentTemplates:addShipAgentTemplate(hidden_daggers_nebula_stalker_tier2, "hidden_daggers_nebula_stalker_tier2")
