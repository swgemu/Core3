...
function MellichaeOutroTheater:sendCompletionSui(pPlayer)
	...
	local closestShrine = ForceShrineMenuComponent:findNearestForceShrine(pPlayer) -- Returns index at for table.
	local pSceneObject = getSceneObject(ForceShrineMenuComponent.ForceShrineOids.zoneName[closestShrine])
