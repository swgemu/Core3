...
-- { template, respawn, x, z, y, heading, cellid, npcFunction, convoTemplate }
-- npcFunction and convoTemplate are left as "" if unused

villageMobileSpawns = {
	[0] = {
		{ "paemos", 5289, 78, -4149, 240, 0, "", "" },
		{ "noldan", 5243, 78, -4224, 0, 0, "", "" },
		{ "rohak_village_elder", 5306, 78, -4145, 0, 0, "", "" },
		{ "whip", 5283.66, 78.5, -4226.31, -143, 0, "", "" },
		{ "quharek", 5373.7, 78.5, -4181.4, -69, 0, "", "" },
		{ "captain_sarguillo", 5313.9, 78.5, -4161.5, -72, 0, "", "" },
		{ "fs_villager_farmer", 5291.31, 78.5, -4037.8, 164, 0, "", "" },
	},

	[1] = {
		{ "sivarra_mechaux", 5391.5, 78.5, -4075.7, -110, 0, "", "" },
		{ "fs_surgical_droid_21b", 5392.1, 78.5, -4072.5, 101, 0, "", "" },
		{ "fs_surgical_droid_21b", 5396.4, 78.5, -4074.7, -104, 0, "", "" },
		{ "fs_surgical_droid_21b", 5158.11, 78.5, -4116.02, -30, 0, "", "" },

		{ "fs_villager_generic", 5388.3, 78.5, -4074.9, 131, 0, "initWoundedVillager", "" },
		{ "fs_villager_generic", 5394.1, 78.5, -4073.2, -130, 0, "initWoundedVillager", "" },
		{ "fs_villager_generic", 5395.1, 78.5, -4077.4, -35, 0, "initWoundedVillager", "" },
		{ "fs_villager_generic", 5392.9, 78.5, -4079.1, -43, 0, "initWoundedVillager", "" },
		{ "fs_villager_generic", 5155.2, 78.5, -4116.3, 12, 0, "initWoundedVillager", "" },
		{ "fs_villager_generic", 5157, 78.5, -4109.7, -167, 0, "initWoundedVillager", "" },

		{ "fs_villager_male", 5346.7, 78.5, -4062.2, -46, 0, "", "fsVillageConvo6MaleTemplate" },
		{ "fs_villager_female", 5227.3, 78.5, -4065.5, -101, 0, "", "" },
		{ "fs_villager_generic", 5159.4, 78.5, -4110.8, 147, 0, "initPukingVillager", "" },
		{ "fs_villager_generic", 5391.8, 78.5, -4074.6, -106, 0, "initPukingVillager", "" },
		{ "fs_villager_generic", 5388.5, 78.5, -4076.5, -119, 0, "initPukingVillager", "" },
		{ "fs_villager_generic", 5176.9, 78.5, -4113.3, -138, 0, "initPanickedVillager", "" },
		{ "fs_villager_generic", 5173.5, 78.5, -4117.5, 36, 0, "initPanickedVillager", "" },
		{ "fs_villager_generic", 5218, 78.5, -4190.5, 88, 0, "initPanickedVillager", "" },
		{ "fs_villager_generic", 5255.2, 78.5, -4225.3, -102, 0, "initPanickedVillager", "" },
		{ "fs_villager_generic", 5322.3, 78.5, -4205.6, -95, 0, "initPanickedVillager", "" },
		{ "fs_villager_generic", 5341.4, 78.5, -4210.2, -65, 0, "initPanickedVillager", "" },
		{ "fs_villager_generic", 5397.9, 78.5, -4198.01, -82, 0, "initPanickedVillager", "" },
		{ "fs_villager_generic", 5393.9, 78.5, -4132.5, -1, 0, "initPanickedVillager", "" },
		{ "fs_villager_generic", 5320.2, 78.5, -4136.4, -131, 0, "initPanickedVillager", "" },
		{ "fs_villager_generic", 5314.3, 78.5, -4142.5, 46, 0, "initPanickedVillager", "" },
		{ "fs_villager_generic", 5197.7, 78.5, -4071.7, 122, 0, "", "fsVillageConvo7Template" },
	},
	[2] = {},
	[3] = {},
	[4] = {},
