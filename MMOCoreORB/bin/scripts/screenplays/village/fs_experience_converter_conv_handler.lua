...
function fs_experience_converter_conv_handler:chooseExperienceTypeForRatio(pCreature, pExperienceType)
	...
	suiManager:sendListBox(pCreature, pCreature, "Experience Conversion", "Select the Experience you wish to convert to: " .. experienceTypeFS, 2, "@canel", "", "@ok", "fs_experience_converter_conv_handler", "notifyTransfer", options)
end
...
function fs_experience_converter_conv_handler:notifyTransfer(pCreature, pSui, cancelPressed, arg0)
	if (not cancelPressed) then
		...
		local suiManager = LuaSuiManager()
		suiManager:sendTransferBox(pCreature, pCreature, "Experience Conversion", "How much of " .. optionsNameFrom .. " do you wish to convert to: " .. optionsTo[1] , "@ok", "fs_experience_converter_conv_handler", "transferExperiencePoints", optionsFrom, optionsTo)
	end
end
