...
function ExperienceConverter:setSuiTransferExperienceSelection(var)
	if (readStringData("suiTransferExperienceSelection") ~= nil) then
		deleteStringData("suiTransferExperienceSelection")
	end
	if (var ~= nil) then
		writeStringData("suiTransferExperienceSelection", var)
	end
end

function ExperienceConverter:getSuiTransferExperienceSelection()
	return readStringData("suiTransferExperienceSelection")
end
