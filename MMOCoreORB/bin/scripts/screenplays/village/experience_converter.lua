...
-- Send a Lua Sui list box to choose which experience type to pick.
-- @param pCreatureObject pointer to the creature object of the player.
function ExperienceConverter:chooseExperienceTypeDialog(pCreatureObject)
		local suiManager = LuaSuiManager()
		suiManager:sendListBox(pCreatureObject, pCreatureObject, "@sui:swg", "@ui:experience_name", 2, "@ok", "", "@cancel", "ExperienceConverter", "chooseRatio")
end

function ExperienceConverter:chooseRatio(pCreature, pSui, cancelPressed, index)
	local suiManager = LuaSuiManager()
	...
	player:sendSystemMessage("Coming Soon...")
end
