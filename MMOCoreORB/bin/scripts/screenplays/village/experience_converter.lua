...
local FORCE_SENSITIVE_COMBAT_PROWESS_STRING = "FSCombatProwess"
local FORCE_SENSITIVE_CRAFTING_MASTERY_STRING = "FSCraftingMastery"
local FORCE_SENSITIVE_ENHANCED_REFLEXES_STRING = "FSEnhancedReflexes"
local FORCE_SENSITIVE_HEIGHTENED_SENSES_STRING = "FSHeightenedSenses"
