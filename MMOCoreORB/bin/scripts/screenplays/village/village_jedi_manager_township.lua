...
VillageJediManagerTownship = ScreenPlay:new {
	...
	phaseChangeTimeOfDay = { hour = 02, min = 45 }, -- Hour of day, server military time, to change the phase. Comment out to disable

	VILLAGE_PHASE_DURATION = 5 * 60 * 1000 -- Testing value.
