...
function Village:checkCurrentPhase()
	...
	local phase1 = hasServerEvent("VillagePhase1")
	local phase2 = hasServerEvent("VillagePhase2")
	local phase3 = hasServerEvent("VillagePhase3")
	local phase4 = hasServerEvent("VillagePhase4")
