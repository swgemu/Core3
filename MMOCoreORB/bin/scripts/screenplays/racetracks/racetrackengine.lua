...
function RaceTrack:startRacing(pPlayer)
	...
	local waypointID = PlayerObject(pGhost):addWaypoint(self.trackConfig.planetName,self.trackConfig.trackCheckpoint .. "0",self.trackConfig.trackCheckpoint .. "0",self.trackConfig.waypoints[1].x, 0, self.trackConfig.waypoints[1].y, WAYPOINT_WHITE,true,true,WAYPOINTRACETRACK)
...
function RaceTrack:actuallyProcessWaypoint(pPlayer, index)
	...
	local waypointID = PlayerObject(pGhost):addWaypoint(self.trackConfig.planetName,self.trackConfig.trackCheckpoint .. index,self.trackConfig.trackCheckpoint .. index,self.trackConfig.waypoints[index+1].x, 0, self.trackConfig.waypoints[index+1].y, WAYPOINT_WHITE,true,true,WAYPOINTRACETRACK)
