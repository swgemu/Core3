...
function TutorialScreenPlay:start(pPlayer)
	...
	self:enablePriorHudElements(pPlayer)
	...
	-- Disable all of the UI but the button bar
...
function TutorialScreenPlay:enablePriorHudElements(pPlayer)
	if (pPlayer == nil) then
		return
	end
	...
	if (self:isRoomComplete(pPlayer, "r8")) then
