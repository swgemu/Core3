...
- Any additional 'flair' stuff that may still be missing
	...
	TODO Add && callback->getTutorialFlag(); to SelectCharacterCallback
	...
	Player with "show new player tutorial" checked are logging into skippedTutorialBuilding
	Subsequent new players log in to the same skippedTutorialBuilding
