...
- 2. Figure out functionality for newbie item dispensers, replace bazaar terminal with an item dispenser
	a. DONE - in Room 3
...
function Tutorial:start(pPlayer)
	...
	for i = 1, #roomNames, 1 do
		...
		print("tutorial: room" .. roomNum .. " complete: " .. tostring(readScreenPlayData(pPlayer, "tutorial", roomNum .. "Complete")))
	end
...
function Tutorial:spawnObjects(pPlayer)
	...
	if (pCell ~= nil) then
		...
		-- TODO: Add tutorial_room1_greeter template and reference here
		-- Greeter
		pMobile = spawnMobile("tutorial", "tutorial_room2_greeter", 0, -9.5, 0, -3.9, 90, cellID)
		...
		spawnMobile("tutorial", "tutorial_stormtrooper_filler", 0, -9.2, 0, 3.6, 0, cellID)
	...
	--TODO: Add MSE droid at 46.6, 0, -31.4, patrol dest to 0.2, 0, -6.6 in r1
	...
	if (pCell ~= nil) then
		...
		if (pMobile ~= nil) then
			...
			if pActiveArea ~= nil then
				...
				print("\n\n***** TUTORIAL: created notifyEnteredCloneDroidArea *****\n\n")
			end
		end
	end
	...
	-- TODO: Add MSE Droid at 76.8, -4, -102, patrol dest at 47.1, -7, -51.5 in r4
	...
	if (pCell ~= nil) then
		...
		-- TODO: Add PILOT at 25.3, -4.2, -160.4 yaw=55, convo about pilot tracks
...
function Tutorial:handleRoomOne(pPlayer)
	...
	print("playerID profession: " .. readStringData(playerID .. ":profession:"))
...
function Tutorial:notifyEnteredCloneDroidArea(pArea, pPlayer)
	print("\n\n***** TUTORIAL: notifyEnteredCloneDroidArea started *****\n\n")
...
-- ROOM TEN
-- Missions/Waypoints
-- TODO: Need trapped_guy at 17.75, -4.2, -144.64, yaw=110, use doTrappedGuySpam
