...
- 1. On logout, player logs in to a different building and screenplay:start doesn't run, resulting in no npcs or objects in the building
	a. This was solved by moving spawnObjects out of the conditional block for isRoomComplete(r1)
	b. This now results in a second instance of the screenplay running, creating duplicate objects throughout the building -- SOLVED by removing unnecessary onLoggedIn function
