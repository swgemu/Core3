...
function TalusDearicScreenPlay:spawnMobiles()
	...
	spawnMobile("talus", "commoner",60,154.399,6,-2932.81,24.6666,0)
	...
	spawnMobile("talus", "commoner",60,323.855,6,-3097.77,92.0799,0)
	spawnMobile("talus", "commoner",60,377.995,6,-2752.04,341.792,0)
