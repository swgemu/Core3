...
function EndorResearchOutpostScreenPlay:spawnMobiles()
	...
	spawnMobile("endor", "commando", 60, 3196.77, 24, -3483.16, 359.892, 0)
	spawnMobile("endor", "commando", 60, 3166, 24, -3454, 130, 0)
	...
	spawnMobile("endor", "commoner", 60, 3212.71, 24.5, -3452.25, 41.6667, 0)
