...
function CorelliaTyrenaScreenPlay:spawnMobiles()
	...
	spawnMobile("corellia", "hunter", 90,-14.01,1.13306,-8.53,120.004,1935445)
	...
	spawnMobile("corellia", "corsec_sergeant", 60,-5059.87,21,-2606.63,195.299,0)
	spawnMobile("corellia", "corsec_trooper", 60,-5506.2,21,-2634.5,102,0)
	spawnMobile("corellia", "corsec_trooper", 60,-5626.49,21,-2812.58,261.279,0)
	spawnMobile("corellia", "corsec_trooper", 60,-5470.84,21,-2565.16,107.104,0)
	spawnMobile("corellia", "corsec_trooper", 60,-5470.71,21,-2566.52,107.123,0)
	--{"corsec_trooper",60,-5061.36,21,-2531.53,180.005,0, "conversation", ""},
	spawnMobile("corellia", "corsec_trooper", 60,-5060.41,21,-2604.37,195.315,0)
	spawnMobile("corellia", "corsec_trooper", 60,-4944.48,21,-2488.58,42.466,0)
	spawnMobile("corellia", "corsec_trooper", 60,-5363.23,24.87,-2595.04,64.2702,0)
	spawnMobile("corellia", "corsec_trooper", 60,-5069.93,21,-2474.8,135.004,0)
	spawnMobile("corellia", "corsec_trooper", 60,-5401.3,21,-2613.1,58,0)
	spawnMobile("corellia", "corsec_trooper", 60,-5058.83,21,-2579.08,135.145,0)

	--Imperials Npcs outside
	spawnMobile("corellia", "crackdown_command_security_guard", 60,-5281.9,21,-2574.6,80,0)
	spawnMobile("corellia", "crackdown_command_security_guard", 60,-5112.1,21,-2279.3,79.0023,0)
	spawnMobile("corellia", "crackdown_command_security_guard", 60,-5048.7,21,-2299.5,256.201,0)
	...
	spawnMobile("corellia", "gubbur", 60,-4826,32.1,-2229.2,18,0)
	spawnMobile("corellia", "gubbur", 60,-4827.25,31.6625,-2225.7,157.208,0)
	...
	--Ragtag's
	spawnMobile("corellia", "ragtag_kook", 60,-5215.15,29.033,-2198.86,133.12,0)
	spawnMobile("corellia", "ragtag_kook", 60,-5220.6,30.4428,-2186.49,348.738,0)
	spawnMobile("corellia", "ragtag_kook", 60,-5211.84,28.4788,-2194.09,10.766,0)
	spawnMobile("corellia", "ragtag_kook", 60,-5219.46,30.4446,-2185.86,7.83436,0)
	spawnMobile("corellia", "ragtag_kook", 60,-4872.65,11.1341,-2390.99,302.831,0)
	spawnMobile("corellia", "ragtag_kook", 60,-4868.58,11.257,-2387.94,83.5642,0)
	spawnMobile("corellia", "ragtag_kook", 60,-5735.79,28.6208,-2610.4,123.649,0)
	spawnMobile("corellia", "ragtag_kook", 60,-5737.79,28.5516,-2607.4,132.784,0)
	spawnMobile("corellia", "ragtag_kook", 60,-5734.79,28.7267,-2609.4,139.039,0)
	spawnMobile("corellia", "ragtag_kook", 60,-5752.38,16.7564,-2798.05,339.808,0)
	spawnMobile("corellia", "ragtag_kook", 60,-5738.79,28.2523,-2614.4,291.78,0)
	spawnMobile("corellia", "ragtag_kook", 60,-5759.38,16.8412,-2798.05,36.2043,0)
	spawnMobile("corellia", "ragtag_kook", 60,-5755.38,16.8078,-2791.05,5.21744,0)
	spawnMobile("corellia", "ragtag_kook", 60,-5757.38,16.8277,-2792.05,209.008,0)
	spawnMobile("corellia", "ragtag_kook", 60,-5750.38,16.684,-2794.05,244.293,0)
	spawnMobile("corellia", "ragtag_loon", 60,-4855.73,11.1455,-2525.71,169.83,0)
	spawnMobile("corellia", "ragtag_loon", 60,-4855.73,11.1789,-2528.71,285.482,0)
	spawnMobile("corellia", "ragtag_loon", 60,-4855.73,11.1489,-2521.71,326.785,0)
	spawnMobile("corellia", "ragtag_loon", 60,-4865.73,10.5102,-2521.71,326.643,0)
	spawnMobile("corellia", "ragtag_mercenary", 60,-5691.26,15.4606,-2887.12,356.964,0)
	spawnMobile("corellia", "ragtag_mercenary", 60,-5672.95,15.312,-2893.61,357.718,0)
	spawnMobile("corellia", "ragtag_mercenary", 60,-5694.23,15.4638,-2884.47,185.304,0)
	spawnMobile("corellia", "ragtag_thug", 60,-5683.98,16.7263,-2843.44,81.9355,0)
	spawnMobile("corellia", "ragtag_thug", 60,-5685.49,17.6827,-2825.55,256.078,0)
	spawnMobile("corellia", "ragtag_thug", 60,-5683.2,16.9368,-2840.36,90.595,0)

	--More misc
	spawnMobile("corellia", "scientist", 60,-5431.41,21,-2685.81,106.943,0)
	--{"slicer",60,-5564.23,21,-2777.78,0,0, "conversation", ""},
	spawnMobile("corellia", "swooper_leader", 60,-5416.8,4.57113,-2286.37,76.0594,0)
	spawnMobile("corellia", "swooper_leader", 60,-5415.8,5.33258,-2277.08,224.956,0)
	spawnMobile("corellia", "swooper_leader", 60,-5420.58,3.58008,-2285.59,200.562,0)
