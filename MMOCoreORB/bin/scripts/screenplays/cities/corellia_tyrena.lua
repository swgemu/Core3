...
function CorelliaTyrenaScreenPlay:spawnMobiles()
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("corellia", "farmer",60,2.2,2.6,3.2,0,2365434)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("corellia", "info_broker",60,27.9,2.1,57.6,57,2365435)
	self:setMoodString(pNpc, "conversation")
	...
	spawnMobile("corellia", "trainer_musician", 0,21.7,2.1,76.1,180,2365436)
	spawnMobile("corellia", "theater_manager", 0,21.9985,2.12818,63.5,0,2365436)
