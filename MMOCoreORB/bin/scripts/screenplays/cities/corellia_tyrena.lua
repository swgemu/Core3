...
function CorelliaTyrenaScreenPlay:spawnMobiles()
	...
	pNpc = spawnMobile("corellia", "trainer_shipwright",60,0.1,0.6,67.2,180,1935687)
	self:setMoodString(pNpc, "neutral")
	pNpc = spawnMobile("corellia", "chassis_dealer",60,-56.6393,0.974563,8.33815,26.9298,1935697)
	self:setMoodString(pNpc, "neutral")
	...
	pNpc = spawnMobile("corellia", "coa3_information_rebel", 60,14.1936,1.13306,-8.97227,335.228,1935453)
	self:setMoodString(pNpc, "calm")

	--Guild Hall -5463 -2722
	pNpc = spawnMobile("corellia", "coa3_tactical_rebel", 60,9.53575,1.13306,0.330446,310.824,1935441)
	self:setMoodString(pNpc, "calm")
	...
	spawnMobile("corellia", "bounty_hunter", 300,-14.01,1.13306,-8.53,120.004,1935445)
	...
	self:setMoodString(pNpc, "sad")
	pNpc = spawnMobile("corellia", "twilek_slave",300,-19.1229,9,14.3195,135.007,1935472)
	self:setMoodString(pNpc, "conversation")
	...
	--Imperials Npcs outside that need to be added again when planet-swap is in
	...
	--rebel spawns that will need to be added again with planet-swap function
	--spawnMobile("corellia", "rebel_surface_marshall", 300,-5279.9,21,-2576.6,80,0)
	--spawnMobile("corellia", "rebel_surface_marshall", 300,-5110.1,21,-2281.3,79.0023,0)
	--spawnMobile("corellia", "rebel_surface_marshall", 300,-5046.7,21,-2301.5,256.201,0)
	--spawnMobile("corellia", "rebel_commando", 400,-4939.2,20.8719,-2524,214.459,0)
	--spawnMobile("corellia", "rebel_commando", 400,-5379.8,20.7451,-2743.1,130.004,0)
	--spawnMobile("corellia", "rebel_commando", 400,-5563.3,20.6891,-2854.06,298.056,0)
	--spawnMobile("corellia", "rebel_commando", 400,-4973.9,20.9989,-2325.7,76.0022,0)
	--pNpc = spawnMobile("corellia", "rebel_commando",400,-5345.92,21.0054,-2442.31,351.468,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("corellia", "rebel_commando", 400,-5654.8,21.1047,-2805.7,191.006,0)
	--pNpc = spawnMobile("corellia", "rebel_lance_corporal",400,-5611.95,21,-2587.97,41.9991,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("corellia", "rebel_lance_corporal", 400,-5604,21.6,-2779.2,82,0)
	--spawnMobile("corellia", "rebel_army_captain", 400,-5296.7,21,-2547.6,32,0)
	--pNpc = spawnMobile("corellia", "rebel_corporal",400,-5588.48,20.3776,-2856.51,311.192,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("corellia", "network_leader",400,-5205.41,21.425,-2249.49,237.999,0)
	--self:setMoodString(pNpc, "conversation")
	--spawnMobile("corellia", "rebel_scout", 400,-5126.84,21,-2654.86,83.2245,0)
	--spawnMobile("corellia", "rebel_scout", 400,-5206.06,21.6077,-2248.46,296.757,0)
	--spawnMobile("corellia", "rebel_scout", 400,-5192.27,20.9887,-2655.85,274.172,0)
	--spawnMobile("corellia", "rebel_scout", 400,-5466.4,21.1828,-2843.6,175.005,0)
	--pNpc = spawnMobile("corellia", "rebel_obscureops_agent",400,-5340.53,21,-2470.78,360.011,0)
	--self:setMoodString(pNpc, "conversation")
	--spawnMobile("corellia", "rebel_commando", 400,-5053.1,21,-2618,137.004,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-4942.3,21,-2389.8,257.008,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-4943.7,21,-2385.1,249.007,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-4934.1,21,-2488.2,197.971,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5029.2,21,-2616.9,278.725,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5090.3,21,-2650.2,175.005,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5133.07,20.9878,-2661.19,86.9316,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5172.6,20.9876,-2658.7,185.005,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5210.9,20.9913,-2652.9,194.006,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5345.5,21,-2473.7,271.008,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5336.7,21,-2429.9,309.009,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5193.9,21,-2255.9,336.01,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5268.9,21,-2362.7,133.004,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5283.8,21,-2351.8,314.009,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5396.3,21,-2763.7,146.004,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5563.5,20.9967,-2844.9,340.795,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5631.8,20.9535,-2826.4,197.006,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5483.9,21,-2587.8,89.0026,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-4940.5,21,-2440.9,106.003,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5554.4,21.6,-2613.8,99.0029,0)
	--pNpc = spawnMobile("corellia", "rebel_trooper",400,-5110.07,21,-2250.89,97.4325,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("corellia", "rebel_trooper", 400,-5042.7,21,-2305,200.405,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5129.1,21,-2419.7,6.00023,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5299.8,21,-2574,244.007,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5304.8,21,-2563.2,247.007,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5397.6,21,-2610.8,241.007,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5394.8,21,-2616.9,251.007,0)
	--spawnMobile("corellia", "rebel_trooper", 400,-5457.6,21.2742,-2843.6,185.005,0)
	--pNpc = spawnMobile("corellia", "rebel_brigadier_general",400,-5084.49,21,-2257.77,216.35,0)
	--self:setMoodString(pNpc, "conversation")
	--spawnMobile("corellia", "rebel_medic", 400,-5300.1,21,-2381.2,225.007,0)
	--spawnMobile("corellia", "rebel_staff_sergeant", 400,-5416.2,20.9379,-2801.6,243.757,0)
	--spawnMobile("corellia", "rebel_staff_sergeant", 400,-5554.4,21.6,-2645.5,79.0023,0)
	--pNpc = spawnMobile("corellia", "rebel_staff_sergeant",400,-5095.16,21,-2273.05,130.264,0)
	--self:setMoodString(pNpc, "neutral")
	--spawnMobile("corellia", "rebel_staff_sergeant", 400,-5121,21,-2427.3,67.002,0)
	--spawnMobile("corellia", "rebel_staff_sergeant", 400,-5243.9,20.9324,-2638.5,228.007,0)
	--spawnMobile("corellia", "rebel_master_sergeant", 400,-5225.3,21,-2274.3,331.01,0)
	--spawnMobile("corellia", "rebel_master_sergeant", 400,-5572.1,20.98,-2845.3,314.848,0)
	--spawnMobile("corellia", "rebel_master_sergeant", 400,-4930.5,20.978,-2429.7,123.004,0)
	--pNpc = spawnMobile("corellia", "rebel_master_sergeant",400,-5092.14,21,-2272.16,45.8873,0)
	--self:setMoodString(pNpc, "neutral")
	--pNpc = spawnMobile("corellia", "specforce_wilderness_operative",400,-5611.85,21,-2586,33.2059,0)
	--self:setMoodString(pNpc, "conversation")
	--pNpc = spawnMobile("corellia", "specforce_wilderness_operative",400,-5103.81,21,-2266.4,126.218,0)
	--self:setMoodString(pNpc, "neutral")
	...
	pNpc = spawnMobile("corellia", "j_pai_brek",60,-5073.17,21,-2342.77,33.2325,0)
	self:setMoodString(pNpc, "neutral")
	...
	pNpc = spawnMobile("corellia", "larek_tatham",60,-5050.23,21,-2291.69,113.059,0)
	self:setMoodString(pNpc, "neutral")
