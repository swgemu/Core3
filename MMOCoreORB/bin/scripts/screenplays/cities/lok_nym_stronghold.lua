LokNymStrongholdScreenPlay = CityScreenPlay:new {
	...
	mobiles = {
		...
		{"mercenary",60,19.8783,1.28309,9.1449,180.006,8145357, "conversation"},
		...
		{"mercenary",60,24.6848,-0.894992,-8.75091,135.009,8145378, "angry"},
		...
		{"mercenary",60,-24.251,-0.894991,22.5325,360.011,8145387, "conversation"},
