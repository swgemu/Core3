...
function RoriRestussScreenPlay:spawnMobiles()
	...
	--misc
	spawnMobile("rori", "imperial_recruiter",0, 5348, 80, 5618, 0, 0)
	spawnMobile("rori", "informant_npc_lvl_1",0, 5401, 80, 5857, 45, 0)
	spawnMobile("rori", "informant_npc_lvl_3",0, 5102, 79.98, 5652, 30, 0)
