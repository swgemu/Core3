...
function RoriNarmleScreenPlay:spawnMobiles()
	...
	--misc
	spawnMobile("rori", "imperial_recruiter",0, -5256, 80, -2256, 270, 0)
	spawnMobile("rori", "informant_npc_lvl_1", 0, -5120, 80, -2269, 0, 0)
	spawnMobile("rori", "informant_npc_lvl_1", 0, -5127, 80, -2266, 45, 0)
	spawnMobile("rori", "informant_npc_lvl_1", 0, -5331, 80, -2233, 180, 0)
	...
	spawnMobile("rori", "trainer_carbine", 0, -5139, 80, -2517, 90, 0)
	spawnMobile("rori", "trainer_chef", 0, -5169, 80, -2326, 140, 0)
	...
	spawnMobile("rori", "trainer_doctor", 0, -5104, 80, -2249, 270, 0)
	...
	spawnMobile("rori", "trainer_pistol", 0, -5242, 80, -2456, 180, 0)
	spawnMobile("rori", "trainer_polearm", 0, -5278, 80, -2328, 180, 0)
	spawnMobile("rori", "trainer_politician", 0, -5165, 80, -2463, 90, 0)
	spawnMobile("rori", "trainer_ranger", 0, -5167, 80, -2535, 180, 0)
	...
	spawnMobile("rori", "trainer_scout", 0, -5211, 82.7, -2925, 180, 0)
	spawnMobile("rori", "trainer_tailor", 0, 11, 0, -13, 0, 4615383)
	spawnMobile("rori", "trainer_unarmed", 0, -5288, 79.0383, -2508, 0, 0)
	spawnMobile("rori", "trainer_weaponsmith", 0, -5274, 80, -2424, 0, 0)
