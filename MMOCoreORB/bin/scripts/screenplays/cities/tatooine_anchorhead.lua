...
function TatooineAnchorheadScreenPlay:setMoodString(pNpc, mood)
...
function TatooineAnchorheadScreenPlay:spawnMobiles()
	...
	TatooineAnchorheadScreenPlay:setMoodString(pNpc, "scared")
	...
	TatooineAnchorheadScreenPlay:setMoodString(pNpc, "conversation")
	...
	TatooineAnchorheadScreenPlay:setMoodString(pNpc, "calm")
