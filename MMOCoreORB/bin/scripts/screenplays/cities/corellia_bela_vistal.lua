CorelliaBelaVistalScreenPlay = ScreenPlay:new {
	numberOfActs = 1,
...
function CorelliaBelaVistalScreenPlay:spawnMobiles()
	...
	spawnMobile("corellia", "hunter", 60, -14.01, 1.13306, -8.53, 120.004, 2365770)
	...
	spawnMobile("corellia", "criminal", 60, 6871.34, 315, -5753.42, 355.947, 0)
	spawnMobile("corellia", "corsec_trooper", 60, 6847.6, 315, -5838.6, -1, 0)
	spawnMobile("corellia", "corsec_trooper", 60, 6852.5, 315, -5838.8, -24, 0) 
	spawnMobile("corellia", "corsec_trooper", 60, 6855.7, 315, -5837.1, -34, 0)
	spawnMobile("corellia", "corsec_trooper", 60, 6860.3, 315, -5833.9, -57, 0)
	...
	spawnMobile("corellia", "crackdown_imperial_army_captain", 400, 6820.49, 315, -5743.53, 353.468, 0)
	...
	spawnMobile("corellia", "crackdown_stormtrooper", 6400, 6819.9, 315, -5720.1, 220.006, 0)
	...
	spawnMobile("corellia", "stormtrooper_bombardier", 60, 6646.02, 330, -5931.59, 357.677, 0)
	spawnMobile("corellia", "stormtrooper_bombardier", 60, 6644.26, 330, -5937.08, 5.98245, 0)
	spawnMobile("corellia", "stormtrooper_bombardier", 60, 6649.56, 330, -5935.6, 128.564, 0)
