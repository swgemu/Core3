...
function CorelliaCoronetScreenPlay:spawnMobiles()
	...
	spawnMobile("corellia", "trainer_marksman",0,-35,0,-4372,269,0)
	...
	spawnMobile("corellia", "trainer_politician",0,-218,0,-4500,0,0)
	spawnMobile("corellia", "trainer_ranger",0,-505,0,-4633,180,0)
