...
function TatooineMosEnthaScreenPlay:spawnMobiles()
	...
	self:setMoodString(pNpc, "conversation")
	spawnMobile(self.planet, "quest_gadget_specialist",60,1209.57,7,2923.54,58.9701,0)
	...
	spawnMobile(self.planet, "kreetle",300,1044.5,7.0287,3032.47,235.314,0)
	spawnMobile(self.planet, "kreetle",300,1049.37,6.92825,3053.45,44.8166,0)
	spawnMobile(self.planet, "kreetle",300,1141.08,29.2815,3442.2,225.319,0)
	spawnMobile(self.planet, "kreetle",300,1159.34,26.0984,3455.89,2.15337,0)
	spawnMobile(self.planet, "kreetle",300,1267.7,8.63449,3561.35,89.6686,0)
	spawnMobile(self.planet, "kreetle",300,1284.04,8.57263,3570.14,42.417,0)
	spawnMobile(self.planet, "kreetle",300,1387.95,7.9817,3558.68,198.042,0)
	spawnMobile(self.planet, "kreetle",300,1381.66,9.90952,3574.83,289.828,0)
	spawnMobile(self.planet, "kreetle",300,1384.58,8.32903,3562.44,60.3494,0)
	spawnMobile(self.planet, "kreetle",300,1385.76,8.10126,3560.41,228.641,0)
	spawnMobile(self.planet, "kreetle",300,1475.43,9.2151,3551.59,342.411,0)
	spawnMobile(self.planet, "kreetle",300,1471.74,9.70389,3555.05,3.28598,0)
	spawnMobile(self.planet, "kreetle",300,1685.87,10.1713,2832.4,275.554,0)
	spawnMobile(self.planet, "kreetle",300,1693.1,10.2439,2830.06,333.897,0)
	spawnMobile(self.planet, "kreetle",300,1694.02,12,3450.08,124.813,0)
	spawnMobile(self.planet, "kreetle",300,1872.92,8.96768,2965.44,91.9334,0)
	spawnMobile(self.planet, "kreetle",300,1859.94,8.77464,2963.42,243.468,0)
	spawnMobile(self.planet, "kreetle",300,1736.14,7.40122,3265.29,238.497,0)
	spawnMobile(self.planet, "kreetle",300,1741.69,8.61579,3276.76,44.2833,0)
	spawnMobile(self.planet, "kreetle",300,1824,6.77883,3233.9,338.908,0)
	spawnMobile(self.planet, "kreetle",300,1834.6,5.40456,3238.51,72.0806,0)
	spawnMobile(self.planet, "kreetle",300,1905.04,14.1019,3085.49,62.9248,0)
	spawnMobile(self.planet, "kreetle",300,1904.71,13.5966,3075.98,152.726,0)
	spawnMobile(self.planet, "kreetle",300,1896.15,12.2618,3089.08,324.915,0)
	spawnMobile(self.planet, "kreetle",300,1897.89,12.4578,3080.4,322.632,0)
	spawnMobile(self.planet, "kreetle",300,1125.1,10.2579,3227.8,188.841,0)
	spawnMobile(self.planet, "kreetle",300,1128.07,13.6707,3250.95,327.357,0)
	spawnMobile(self.planet, "kreetle",300,1109.77,16.1342,3243.99,314.595,0)
	spawnMobile(self.planet, "kreetle",300,1136.03,9.90696,3239.44,67.0593,0)
	spawnMobile(self.planet, "kreetle",300,1113.09,16.5217,3247.43,260.633,0)
	spawnMobile(self.planet, "kreetle",300,1056,7.47361,2942.77,93.8727,0)
	spawnMobile(self.planet, "kreetle",300,1061.3,7.9681,2958.99,164.005,0)
	spawnMobile(self.planet, "kreetle",300,1091.72,7.68251,2909.81,310.6,0)
	spawnMobile(self.planet, "kreetle",300,1085.7,7.64405,2913.73,234.589,0)
	spawnMobile(self.planet, "kreetle",300,1088.35,7.36404,2903.8,301.961,0)
	spawnMobile(self.planet, "kreetle",300,1191.3,7.17686,2848.67,140.25,0)
	spawnMobile(self.planet, "kreetle",300,1193.17,7.38531,2867.31,340.572,0)
	spawnMobile(self.planet, "kreetle",300,1264.36,9.84013,2838.12,116.66,0)
	spawnMobile(self.planet, "kreetle",300,1640.38,6.72345,3534.31,113.55,0)
	spawnMobile(self.planet, "kreetle",300,1633.38,7.78232,3539.31,188.235,0)
	spawnMobile(self.planet, "kreetle",300,1632.38,7.78197,3533.31,310.834,0)
