DantooineMiningOutpostScreenPlay = CityScreenPlay:new {
	...
	combatPatrol = {"commando", "sharpshooter"},

	patrolMobiles = {
		--{patrolPoints, template, level, x, z, y, direction, cell, mood, combatNpc},
		{"r2_1", "r2", 60, -635.747, 3, 2503.81, 354, 0, "", false},
		{"r4_1", "r4", 60, -643.739, 3, 2506.86, 129, 0, "", false},
		{"r4_2", "r4", 60, -666.582, 3, 2494.33, 121, 0, "", false},

		{"npc_1", "combatPatrol", 300, -616, 3, 2509, 314, 0, "", true},
		{"npc_2", "combatPatrol", 300, -562, 3, 2512, 108, 0, "", true},
