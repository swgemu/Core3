...
function TatooineMosEspaScreenPlay:spawnMobiles()
	...
	self:setMoodString(pNpc, "conversation")
	spawnMobile(self.planet, "scientist",60,20.2668,1.56616,15.1105,241.986,1261018)
	...
	--Creatures
	spawnMobile(self.planet, "kreetle",300,-3217.87,6.7851,2010.86,329.47,0)
	spawnMobile(self.planet, "kreetle",300,-3205.35,6.01035,2016.06,32.4216,0)
	spawnMobile(self.planet, "kreetle",300,-3208.98,6.12053,2017.03,118.154,0)
	spawnMobile(self.planet, "kreetle",300,-3246.28,5.42038,2218.4,130.138,0)
	spawnMobile(self.planet, "kreetle",300,-3248.94,5.4228,2116.77,343.61,0)
	spawnMobile(self.planet, "kreetle",300,-2789.62,6.17824,1763.98,98.5487,0)
	spawnMobile(self.planet, "kreetle",300,-2797.01,5.38467,1764.85,345.893,0)
	spawnMobile(self.planet, "kreetle",300,-2713.99,5.73621,1815.47,199.28,0)
	spawnMobile(self.planet, "kreetle",300,-2705.64,5.75105,1820.1,188.657,0)
	spawnMobile(self.planet, "kreetle",300,-2720.95,5.12037,1838.72,69.0059,0)
	spawnMobile(self.planet, "kreetle",300,-3114.39,5.75482,1906.64,235.346,0)
	spawnMobile(self.planet, "kreetle",300,-3093.11,5.06432,1912.45,117.788,0)
	spawnMobile(self.planet, "kreetle",300,-3006.66,7.83559,2697.94,246.037,0)
	spawnMobile(self.planet, "kreetle",300,-2868.66,5.92974,2659.77,280.728,0)
	spawnMobile(self.planet, "kreetle",300,-2879.16,5.3938,2642.48,208.517,0)
	spawnMobile(self.planet, "kreetle",300,-2957.17,6.65151,2663.78,200.677,0)
	spawnMobile(self.planet, "kreetle",300,-2958.99,6.05473,2651.86,35.5292,0)
	spawnMobile(self.planet, "kreetle",300,-2954.14,5.93401,2648.89,80.4338,0)
	spawnMobile(self.planet, "kreetle",300,-2959.73,6.48665,2662.19,351.646,0)
	spawnMobile(self.planet, "kreetle",300,-2599.04,5.20143,2338.05,44.6433,0)
	spawnMobile(self.planet, "kreetle",300,-2592.54,5.37076,2333.19,191.631,0)
	spawnMobile(self.planet, "kreetle",300,-2593.9,5,2038.48,159.546,0)
	spawnMobile(self.planet, "kreetle",300,-2599.47,5,2034.19,249.173,0)
	spawnMobile(self.planet, "kreetle",300,-2626.73,5.0133,1962.54,9.62294,0)
	spawnMobile(self.planet, "kreetle",300,-3248.78,5.22997,2122.05,130.343,0)
