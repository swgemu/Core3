...
function TatooineMosEspaScreenPlay:spawnMobiles()
	...
	spawnMobile("tatooine", "shadowy_figure",60,0,0.5,-6.9,180,1261454)
	spawnMobile("tatooine", "r4",60,-1.9,1.0,5.9,130,1261454)
	spawnMobile("tatooine", "r4",60,1.9,1.0,5.9,-130,1261454)
	spawnMobile("tatooine", "mercenary",60,-6.9,2.0,10,100,1261453)
	spawnMobile("tatooine", "mercenary",60,6.9,2.0,10,-100,1261453)

	--southwest Tavern
	spawnMobile("tatooine", "vendor",60,10,0.4,-5.5,85,1261582)
	spawnMobile("tatooine", "scientist",60,4.6,0.4,1.7,0,1261582)
	spawnMobile("tatooine", "patron_ishitib",60,-4.5,0.4,-5.5,-40,1261582)
	spawnMobile("tatooine", "patron_klaatu",60,-5.1,0.4,-4.3,149,1261582)
	spawnMobile("tatooine", "contractor",60,-6.5,-4.0,-6.8,-90,1261586)
	spawnMobile("tatooine", "commoner_technician",60,-6.3,-4.0,-5.9,-112,1261586)
	...
	spawnMobile("tatooine", "agriculturalist",60,-2.7,0.4,-1.7,75,1261569)
	...
	spawnMobile("tatooine", "chiss_male",60,8.8,-9.5,-6.7,145,1261579)
