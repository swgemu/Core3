...
function CorelliaKorVellaScreenPlay:spawnMobiles()
	...
	--rebels at base near starport at outskirts of city limits to still re-add with planet-swap

	--spawnMobile("corellia", "rebel_trooper", 360, -3001.5, 31.0, 2932.4, 180, 0)
	--spawnMobile("corellia", "rebel_trooper", 360, -3005.5, 31.0, 2932.4, 180, 0)
	--spawnMobile("corellia", "rebel_trooper", 360, -3001.5, 31.0, 2928.4, 180, 0)
	--spawnMobile("corellia", "rebel_trooper", 360, -3005.5, 31.0, 2928.4, 180, 0)
	--spawnMobile("corellia", "rebel_trooper", 360, -3001.5, 31.0, 2924.4, 180, 0)
	--spawnMobile("corellia", "rebel_trooper", 360, -3005.5, 31.0, 2924.4, 180, 0)
	--spawnMobile("corellia", "rebel_trooper", 360, -2990.1, 30.9, 2915.5, -125, 0)
	--spawnMobile("corellia", "rebel_trooper", 360, -2990.1, 30.9, 2905.5, -55, 0)
	--spawnMobile("corellia", "rebel_trooper", 360, 2.7, 0.3, 2.1, 0, 1331934)
	--spawnMobile("corellia", "rebel_trooper", 360, 2.7, 0.3, -3.3, 0, 1331934)
	--spawnMobile("corellia", "rebel_trooper", 360, -2.4, -3.3, 6.2, 180, 1331936)
	--spawnMobile("corellia", "rebel_trooper", 360, 0.3, -6.7, -7.0, 45, 1331937)
	--spawnMobile("corellia", "rebel_trooper", 360, 6.3, -6.7, -7.0, -45, 1331937)
	--spawnMobile("corellia", "rebel_trooper", 360, -4.1, -13.7, 8.5, 180, 1331939)
	--spawnMobile("corellia", "rebel_trooper", 360, -0.9, -13.7, 8.5, 180, 1331939)
	--spawnMobile("corellia", "rebel_medic", 360, -4.7, -13.8, 14.8, -33, 1331940)
	--spawnMobile("corellia", "rebel_second_lieutenant", 360, 15.0, -13.8, 10.6, 180, 1331941)
	--spawnMobile("corellia", "rebel_crewman", 360, 16.0, -13.8, -3.5, -45, 1331941)
	--spawnMobile("corellia", "rebel_major_general", 360, 14.1, -11.5, -21.8, 0, 1331942)
	--spawnMobile("corellia", "rebel_medic", 360, 1.2, 0.1, -4.1, 0, 1331946)
	--spawnMobile("corellia", "rebel_major", 360, 3.6, 0.1, -3.1, -135, 1331948)
	--spawnMobile("corellia", "rebel_trooper", 360, -1.2, 0.1, 2.3, -90, 1331953)
	--spawnMobile("corellia", "rebel_colonel", 360, 3.6, 0.1, -3.1, -135, 1331955)
	...
	--rebel spawns that will need to add back with planet-swap functionality
	
	--spawnMobile("corellia", "specforce_interrogator", 400, -3658.31, 86, 3105.26, 39.0513, 0)
	--spawnMobile("corellia", "rebel_commando", 400, -3771.66, 86, 3205.13, 22.9816, 0)
	--spawnMobile("corellia", "rebel_corporal", 400, -3385, 86, 2962, 95, 0)
	--spawnMobile("corellia", "rebel_corporal", 400, -3402.35, 74, 3349.14, 188, 0)
	--spawnMobile("corellia", "rebel_first_lieutenant", 400, -3660.58, 86, 3092.82, 101, 0)
	--spawnMobile("corellia", "rebel_first_lieutenant", 400, -3072, 31, 2827, 235, 0)
	--spawnMobile("corellia", "rebel_first_lieutenant", 400, -3672.98, 86, 3106.95, 180, 0)
	--spawnMobile("corellia", "rebel_sergeant", 400, -3433, 86, 3036, 90, 0)
	--spawnMobile("corellia", "rebel_sergeant", 400, -3422, 86, 3020, 30, 0)
	--spawnMobile("corellia", "rebel_sergeant", 400, -3366.45, 86, 3244.5, 216, 0)
	--spawnMobile("corellia", "rebel_sergeant", 400, -3364, 86, 3234, 166, 0)
	--spawnMobile("corellia", "rebel_sergeant", 400, -3580, 86, 3145, 333, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3619.27, 86, 3144.55, 28.2333, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3629.32, 86, 3138.46, 252.779, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3408.43, 86, 3144.78, 151.613, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3404.24, 86, 3139.43, 204.684, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3393.4, 86, 3019.79, 72.2994, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3393.16, 86, 3025.07, 57.428, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3342.8, 80.6241, 3242.26, 200.272, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3341.2, 81.762, 3242.54, 177.569, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3765.99, 86, 3182.85, 154.813, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3759.11, 86, 3192.17, 63.2948, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3409.64, 74, 3346.7, 179.356, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3414.53, 74, 3348.57, 326.897, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3155.47, 31, 2799.69, 352.434, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3153.56, 31, 2794.15, 348.853, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3423, 86, 3036, 90, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3366.29, 86, 2951.6, 170.619, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3418, 86, 3036, 90, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3428, 86, 3072, 0, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3428, 86, 3067, 0, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3428, 86, 3062, 0, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3428, 86, 3052, 0, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3379.8, 86, 3300.1, -79, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3717.35, 86, 3177.2, 326.578, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3593.9, 86, 3174.4, 152, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3617.55, 86, 3123.89, 113.533, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3610.9, 86, 3132.8, 95, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3724.46, 86, 3187.97, 120.721, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3752, 86, 3174, -30, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3772.9, 86, 3205.38, 281.283, 0)
	--spawnMobile("corellia", "rebel_crewman", 400, -3772.65, 86, 3206.62, 22.9721, 0)
	--spawnMobile("corellia", "rebel_medic", 400, -3110, 31, 2816, 168, 0)
	--spawnMobile("corellia", "rebel_medic", 400, -3384, 86, 2994, 354.507, 0)
	--spawnMobile("corellia", "rebel_scout", 400, -3091, 31.0391, 2805, 347.01, 0)
	--spawnMobile("corellia", "rebel_scout", 400, -3458.41, 78, 3114.21, 232.636, 0)
	--spawnMobile("corellia", "rebel_scout", 400, -3428, 86, 3057, 0, 0)
	--spawnMobile("corellia", "rebel_scout", 400, -3316.03, 86, 3232.13, 115.958, 0)
	--spawnMobile("corellia", "rebel_scout", 400, -3324.35, 86, 3233.94, 52.9842, 0)
	--spawnMobile("corellia", "rebel_scout", 400, -3600.47, 86, 3216.02, 44.6678, 0)
	--spawnMobile("corellia", "rebel_scout", 400, -3615.06, 86, 3214.07, 47.9151, 0)
	--spawnMobile("corellia", "rebel_scout", 400, -3713.75, 86.0549, 3171.75, 326.9, 0)
