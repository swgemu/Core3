...
function CorelliaKorVellaScreenPlay:spawnMobiles()
	...
	spawnMobile("corellia", "stormtrooper", 400, -3358.96, 86, 3286.34, 64.5472, 0)
	spawnMobile("corellia", "stormtrooper", 400, -3719.35, 86, 3175.2, 326.578, 0)
	spawnMobile("corellia", "stormtrooper", 400, -3567.44, 86, 3144.32, 100.505, 0)
	spawnMobile("corellia", "stormtrooper", 400, -3619.55, 86, 3121.89, 113.533, 0)
	spawnMobile("corellia", "stormtrooper", 400, -3596.69, 86, 3122.97, 236.271, 0)
	...
	spawnMobile("corellia", "corsec_rogue", 360, -3340.49, 86, 3292.76, 100.151, 0)
	spawnMobile("corellia", "corsec_rogue", 360, -3332.89, 86, 3303.69, 68.6738, 0)
	spawnMobile("corellia", "corsec_rogue", 360, -3330.1, 86, 3290.98, 104.099, 0)
	...
	--commoners
	spawnMobile("corellia", "bodyguard", 60, -3587.81, 86, 3134.7, 0, 0)
	spawnMobile("corellia", "bodyguard", 60, -3162.17, 31, 2902.28, 0, 0)
	...
	spawnMobile("corellia", "fringer", 60, -3713.14, 86, 3106.66, 180.0, 0)
	...
	--thugs
	spawnMobile("corellia", "ragtag_kook", 40, -3816.4, 86, 3114.2, 103, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3814.6, 86, 3109.6, 58, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3809.9, 86, 3111.1, -46, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3809.5, 86, 3117.4, -115, 0)

	spawnMobile("corellia", "ragtag_kook", 40, -3801.2, 86, 3251.2, 12, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3797.2, 86, 3251.1, 67, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3793.2, 86, 3255.3, -73, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3797.9, 86, 3259.9, -170, 0)

	spawnMobile("corellia", "ragtag_kook", 40, -3717.2, 86, 3074.9, 29, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3712.6, 86, 3073.8, 104, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3711.0, 86, 3077.6, -38, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3714.8, 86, 3079.9, 19, 0)

	spawnMobile("corellia", "ragtag_kook", 40, -3602.3, 86, 3105.7, -69, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3602.5, 86, 3107.6, 2, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3598.4, 86, 3107.5, -90, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3599.5, 86, 3112.2, 132, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3602.1, 86, 3115.1, -170, 0)

	spawnMobile("corellia", "ragtag_kook", 40, -3632.6, 86, 3232.5, 51, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3630.2, 86, 3236.7, 104, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3630.0, 86, 3232.6, -57, 0)

	spawnMobile("corellia", "ragtag_kook", 40, -3500.5, 78, 3148.0, 107, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3500.8, 78, 3145.0, 114, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3494.1, 78, 3140.4, -53, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3495.8, 78, 3146.1, -88, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3496.7, 78, 3138.3, 2, 0)

	spawnMobile("corellia", "ragtag_kook", 40, -3499.1, 70, 3239.0, 1, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3495.3, 70, 3240.8, 8, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3495.8, 70, 3243.1, -100, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3497.5, 70, 3245.9, -83, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3501.7, 70, 3244.5, 162, 0)

	spawnMobile("corellia", "ragtag_kook", 40, -3467.7, 85.6, 3182.2, 74, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3467.6, 85.9, 3175.1, 15, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3461.5, 85.4, 3179.1, -53, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3462.3, 85.1, 3186.0, 18, 0)

	spawnMobile("corellia", "ragtag_kook", 40, -3309.4, 86, 3285.4, -141, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3309.9, 86, 3281.3, -103, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3309.5, 86, 3276.9, -99, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3314.0, 86, 3277.9, 16, 0)

	spawnMobile("corellia", "ragtag_kook", 40, -3631.5, 86, 3117.4, -67, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3637.5, 86, 3114.4, 22, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3634.5, 86, 3119.4, -167, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3630.5, 86, 3119.4, -30, 0)

	spawnMobile("corellia", "ragtag_kook", 40, -3162.3, 31, 2999.6, 64, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3160.5, 31, 3001.3, 47, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3157.2, 31, 2999.4, 145, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3158.8, 31, 2994.4, -29, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3161.8, 31, 2991.5, -109, 0)

	spawnMobile("corellia", "ragtag_kook", 40, -3417.7, 86, 3118.9, 112, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3421.1, 86, 3120.9, 157, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3424.7, 86, 3115.9, -25, 0)
	spawnMobile("corellia", "ragtag_kook", 40, -3420.1, 86, 3112.9, 148, 0)

	--Creatures
	spawnMobile("corellia", "minor_gubbur", 24, math.random(10) + -3286, 101,math.random(10) + 2986, math.random(360), 0)
	spawnMobile("corellia", "minor_gubbur", 24, math.random(10) + -3286, 101,math.random(10) + 2986, math.random(360), 0)
	spawnMobile("corellia", "minor_gubbur", 24, math.random(10) + -3286, 101,math.random(10) + 2986, math.random(360), 0)
	spawnMobile("corellia", "minor_gubbur", 24, math.random(10) + -3286, 101,math.random(10) + 2986, math.random(360), 0)
	spawnMobile("corellia", "minor_gubbur", 24, math.random(10) + -3286, 101,math.random(10) + 2986, math.random(360), 0)
	...
	spawnMobile("corellia", "durni", 24, math.random(10) + -3177, 101,math.random(10) + 3084, math.random(360), 0)
	spawnMobile("corellia", "durni", 24, math.random(10) + -3177, 101,math.random(10) + 3084, math.random(360), 0)
	spawnMobile("corellia", "durni", 24, math.random(10) + -3177, 101,math.random(10) + 3084, math.random(360), 0)
	spawnMobile("corellia", "durni", 24, math.random(10) + -3177, 101,math.random(10) + 3084, math.random(360), 0)
	spawnMobile("corellia", "durni", 24, math.random(10) + -3177, 101,math.random(10) + 3084, math.random(360), 0)
	...
	spawnMobile("corellia", "paralope", 24, math.random(10) + -3249, 101, math.random(10) + 3308, math.random(360), 0)
	spawnMobile("corellia", "paralope", 24, math.random(10) + -3249, 101, math.random(10) + 3308, math.random(360), 0)
	spawnMobile("corellia", "paralope", 24, math.random(10) + -3249, 101, math.random(10) + 3308, math.random(360), 0)
	spawnMobile("corellia", "paralope", 24, math.random(10) + -3249, 101, math.random(10) + 3308, math.random(360), 0)
	spawnMobile("corellia", "paralope", 24, math.random(10) + -3249, 101, math.random(10) + 3308, math.random(360), 0)
	...
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3335, 101, math.random(10) + 3383, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3335, 101, math.random(10) + 3383, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3335, 101, math.random(10) + 3383, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3335, 101, math.random(10) + 3383, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3335, 101, math.random(10) + 3383, math.random(360), 0)
	...
	spawnMobile("corellia", "verne", 24, math.random(10) + -3389, 37, math.random(10) + 3531, math.random(360), 0)
	spawnMobile("corellia", "verne", 24, math.random(10) + -3389, 37, math.random(10) + 3531, math.random(360), 0)
	spawnMobile("corellia", "verne", 24, math.random(10) + -3389, 37, math.random(10) + 3531, math.random(360), 0)
	spawnMobile("corellia", "verne", 24, math.random(10) + -3389, 37, math.random(10) + 3531, math.random(360), 0)
	spawnMobile("corellia", "verne", 24, math.random(10) + -3389, 37, math.random(10) + 3531, math.random(360), 0)
	...
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3519, 101, math.random(10) + 3469, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3519, 101, math.random(10) + 3469, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3519, 101, math.random(10) + 3469, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3519, 101, math.random(10) + 3469, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3519, 101, math.random(10) + 3469, math.random(360), 0)
	...
	spawnMobile("corellia", "vrelt", 24, math.random(10) + -3698, 101, math.random(10) + 3397, math.random(360), 0)
	spawnMobile("corellia", "vrelt", 24, math.random(10) + -3698, 101, math.random(10) + 3397, math.random(360), 0)
	spawnMobile("corellia", "vrelt", 24, math.random(10) + -3698, 101, math.random(10) + 3397, math.random(360), 0)
	spawnMobile("corellia", "vrelt", 24, math.random(10) + -3698, 101, math.random(10) + 3397, math.random(360), 0)
	spawnMobile("corellia", "vrelt", 24, math.random(10) + -3698, 101, math.random(10) + 3397, math.random(360), 0)
	...
	spawnMobile("corellia", "minor_gubbur", 24, math.random(10) + -3677, 101,math.random(10) + 3294, math.random(360), 0)
	spawnMobile("corellia", "minor_gubbur", 24, math.random(10) + -3677, 101,math.random(10) + 3294, math.random(360), 0)
	spawnMobile("corellia", "minor_gubbur", 24, math.random(10) + -3677, 101,math.random(10) + 3294, math.random(360), 0)
	spawnMobile("corellia", "minor_gubbur", 24, math.random(10) + -3677, 101,math.random(10) + 3294, math.random(360), 0)
	spawnMobile("corellia", "minor_gubbur", 24, math.random(10) + -3677, 101,math.random(10) + 3294, math.random(360), 0)
	...
	spawnMobile("corellia", "durni", 24, math.random(10) + -3808, 101,math.random(10) + 3347, math.random(360), 0)
	spawnMobile("corellia", "durni", 24, math.random(10) + -3808, 101,math.random(10) + 3347, math.random(360), 0)
	spawnMobile("corellia", "durni", 24, math.random(10) + -3808, 101,math.random(10) + 3347, math.random(360), 0)
	spawnMobile("corellia", "durni", 24, math.random(10) + -3808, 101,math.random(10) + 3347, math.random(360), 0)
	spawnMobile("corellia", "durni", 24, math.random(10) + -3808, 101,math.random(10) + 3347, math.random(360), 0)
	...
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3797, 101, math.random(10) + 2958, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3797, 101, math.random(10) + 2958, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3797, 101, math.random(10) + 2958, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3797, 101, math.random(10) + 2958, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -3797, 101, math.random(10) + 2958, math.random(360), 0)
	...
	spawnMobile("corellia", "vrelt", 24, math.random(10) + -3659, 101, math.random(10) + 2855, math.random(360), 0)
	spawnMobile("corellia", "vrelt", 24, math.random(10) + -3659, 101, math.random(10) + 2855, math.random(360), 0)
	spawnMobile("corellia", "vrelt", 24, math.random(10) + -3659, 101, math.random(10) + 2855, math.random(360), 0)
	spawnMobile("corellia", "vrelt", 24, math.random(10) + -3659, 101, math.random(10) + 2855, math.random(360), 0)
	spawnMobile("corellia", "vrelt", 24, math.random(10) + -3659, 101, math.random(10) + 2855, math.random(360), 0)
	...
	spawnMobile("corellia", "paralope", 24, math.random(10) + -3532, 101, math.random(10) + 2821, math.random(360), 0)
	spawnMobile("corellia", "paralope", 24, math.random(10) + -3532, 101, math.random(10) + 2821, math.random(360), 0)
	spawnMobile("corellia", "paralope", 24, math.random(10) + -3532, 101, math.random(10) + 2821, math.random(360), 0)
	spawnMobile("corellia", "paralope", 24, math.random(10) + -3532, 101, math.random(10) + 2821, math.random(360), 0)
	spawnMobile("corellia", "paralope", 24, math.random(10) + -3532, 101, math.random(10) + 2821, math.random(360), 0)
	...
	spawnMobile("corellia", "corellian_butterfly_drone", 24, -3217.9, 29.2, 2732.2, 87, 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, -3220.2, 29.2, 2731.6, -111, 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, -3220.7, 29.2, 2735.2, 1, 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, -3217.6, 29.3, 2737.8, 57, 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, -3219.4, 29.4, 2742.1, -50, 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, -3223.1, 29.3, 2742.4, -87, 0)

	spawnMobile("corellia", "minor_gubbur", 24, -3005.4, 25.5, 2731.1, 60, 0)
	spawnMobile("corellia", "minor_gubbur", 24, -3001.2, 25.8, 2728.8, 118, 0)
	spawnMobile("corellia", "minor_gubbur", 24, -2998.3, 25.9, 2732.4, -18, 0)
	spawnMobile("corellia", "minor_gubbur", 24, -3001.0, 25.7, 2734.2, -60, 0)
	spawnMobile("corellia", "minor_gubbur", 24, -2996.4, 25.9, 2735.7, 77, 0)
	spawnMobile("corellia", "minor_gubbur", 24, -2994.2, 26.2, 2730.8, 177, 0)

	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -2981, 31, math.random(10) + 2988, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -2981, 31, math.random(10) + 2988, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -2981, 31, math.random(10) + 2988, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -2981, 31, math.random(10) + 2988, math.random(360), 0)
	spawnMobile("corellia", "corellian_butterfly_drone", 24, math.random(10) + -2981, 31, math.random(10) + 2988, math.random(360), 0)
	...
	spawnMobile("corellia", "trainer_brawler", 1, -3193, 31, 2799, 201, 0)
	...
	spawnMobile("corellia", "trainer_marksman", 1, -3130, 0, 2791, 0, 0)
	...
	spawnMobile("corellia", "corsec_inspector_sergeant", 60, -62.23, 2.64, 39.73, 0.19, 4255431)
	...
	spawnMobile("corellia", "corsec_chief", 60, 20.6, -0.9, -18.6, 180, 3005400)
	...
	spawnMobile("corellia", "fringer", 60, 22.6, -0.9, 20.7, 180, 3005401)
	...
	spawnMobile("corellia", "corsec_commissioner", 60, -25.7, -0.5, 10.5, 0, 3005409)
	spawnMobile("corellia", "slicer", 60, -25.7, -0.5, 11.5, 180, 3005409)
	spawnMobile("corellia", "corsec_rogue", 60, -45.2, 0.1, -20.7, 180, 3005411)
	...
	spawnMobile("corellia", "corsec_chief", 60, 3.9, -0.05, -3.15, 0, 3005428)
	...
	spawnMobile("corellia", "corsec_agent", 60, -5.69, -5.5, -9.21, 180, 3005430)
	...
	spawnMobile("corellia", "corsec_agent", 60, 0.28, 0.18, 7.39, 0, 3375392)
