...
function CorelliaDoabaGuerfelScreenPlay:spawnMobiles()
	...
	self:setMoodString(pNpc, "conversation")
	spawnMobile(self.planet, "noble", 60,26.93,2.12878,58.19,222.007,4395402)
	...
	spawnMobile(self.planet, "trainer_entertainer", 0,26.5,2.12878,75.5,-172,4395403)
	spawnMobile(self.planet, "trainer_imagedesigner", 0,-2.51106,2.12878,70.8023,2,4395403)
	spawnMobile(self.planet, "trainer_musician", 0,21.8,2.1,75.4,180,4395403)
