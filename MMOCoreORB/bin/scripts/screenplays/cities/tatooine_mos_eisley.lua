...
function TatooineMosEisleyScreenPlay:spawnMobiles()
	...
	spawnMobile("tatooine", "sand_trooper_hard",400,3279.95,5,-4835.74,40,0)
	spawnMobile("tatooine", "sand_trooper_hard",400,3341.8,5,-4750.9,124,0)
	spawnMobile("tatooine", "scout_trooper",400,3585.84,5,-4719.95,281.969,0)
	spawnMobile("tatooine", "scout_trooper_hard",400,3288.12,4.9981,-4842.11,27.4222,0)
	spawnMobile("tatooine", "scout_trooper_hard",400,3377.5,0,-4709,156,0)
