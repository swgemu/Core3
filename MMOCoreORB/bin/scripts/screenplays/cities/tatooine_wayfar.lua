...
function TatooineWayfarScreenPlay:spawnMobiles()
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "noble",60,-9.6227,0.995934,-0.745972,360.011,1134533)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "commoner_old",60,-9.6227,0.995934,0.354028,180.009,1134533)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "farmer_rancher",60,11.9085,0.991375,0.149539,180.01,1134533)
	self:setMoodString(pNpc, "conversation")
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "bounty_hunter",300,34.4931,0.104999,-7.576,0,1134559)
	self:setMoodString(pNpc, "sad")
	...
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "medic",300,11.3838,-0.894992,-3.73465,0,1134560)
	self:setMoodString(pNpc, "conversation")
	pNpc = spawnMobile("tatooine", "mercenary",300,10.2838,-0.894992,-2.63465,135.005,1134560)
	self:setMoodString(pNpc, "calm")
	pNpc = spawnMobile("tatooine", "commoner_fat",300,-3.85346,-0.894991,7.83775,180.003,1134560)
	self:setMoodString(pNpc, "conversation")
	...
	pNpc = spawnMobile("tatooine", "comm_operator",300,-24.5583,-0.894991,23.3065,360.011,1134569)
	self:setMoodString(pNpc, "npc_imperial")
	pNpc = spawnMobile("tatooine", "contractor",300,-24.5583,-0.894991,24.4065,179.993,1134569)
	self:setMoodString(pNpc, "conversation")
	spawnMobile("tatooine", "mercenary",300,-25.6591,-0.519991,10.6171,15.7251,1134570)
