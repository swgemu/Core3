...
function TatooineWayfarScreenPlay:setMoodString(pNpc, mood)
...
function TatooineWayfarScreenPlay:spawnMobiles()
	...
	TatooineWayfarScreenPlay:setMoodString(pNpc, "npc_use_terminal_low")
	pNpc = spawnMobile("tatooine", "entertainer",60,6.82411,0.40827,-8.7422,0,1499419)
	TatooineWayfarScreenPlay:setMoodString(pNpc, "conversation")
	...
	TatooineWayfarScreenPlay:setMoodString(pNpc, "neutral")
	pNpc = spawnMobile("tatooine", "commoner_fat",60,-8.9,0.4,2.2,179,1499419)
	TatooineWayfarScreenPlay:setMoodString(pNpc, "npc_sitting_chair")
	...
	TatooineWayfarScreenPlay:setMoodString(pNpc, "calm")
	...
	TatooineWayfarScreenPlay:setMoodString(pNpc, "npc_sitting_ground")
end
