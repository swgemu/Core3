...
function SpacePatrolScreenplay:notifyEnteredQuestArea(pActiveArea, pShip)
	...
	if (pWaypoint ~= nil) then
		...
		-- Player effect for player
		CreatureObject(pPilot):playEffect("clienteffect/ui_quest_waypoint_patrol.cef", "")
	end
	...
	SpaceHelpers:sendQuestUpdate(pPilot, "@space/quest:patrol_new_waypoint") -- "Patrol waypoint located."
