...
escort_corellia_privateer_14 = SpaceEscortScreenplay:new {
	...
	escortPoints = {
		{name = "yavin4_privateer_escort_1", zoneName = "space_corellia", x = -2163, z = 956, y = 4991, escortNumber = 1, radius = 250},
		{name = "yavin4_privateer_escort_2", zoneName = "space_corellia", x = -637, z = -295, y = 4770, escortNumber = 2, radius = 250},
		{name = "yavin4_privateer_escort_3", zoneName = "space_corellia", x = 2043, z = -1230, y = 5414, escortNumber = 3, radius = 250},
		{name = "yavin4_privateer_escort_4", zoneName = "space_corellia", x = -2064, z = -929, y = -3183, escortNumber = 4, radius = 250},
	},
