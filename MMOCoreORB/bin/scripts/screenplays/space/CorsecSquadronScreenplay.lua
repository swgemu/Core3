...
escort_corellia_privateer_3 = SpaceEscortScreenplay:new {
	...
	escortPoints = {
		{zoneName = "space_corellia", x = -5034, z = -5439, y = -4558, escortNumber = 1, radius = 150},
		{zoneName = "space_corellia", x = -2103, z = -5336, y = -5600, escortNumber = 2, radius = 150},
		{zoneName = "space_corellia", x = 1262, z = -5572, y = -5035, escortNumber = 3, radius = 150},
		{zoneName = "space_corellia", x = 5940, z = -5892, y = -4039, escortNumber = 4, radius = 150},
	},
}
