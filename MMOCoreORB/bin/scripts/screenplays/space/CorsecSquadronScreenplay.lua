...
function CorsecSquadronScreenplay:resetRheaQuests(pPlayer)
	...
	patrol_corellia_privateer_1:failQuest(pPlayer, "true")
	destroy_surpriseattack_corellia_privateer_1:failQuest(pPlayer, "true")
	destroy_corellia_privateer_2:failQuest(pPlayer, "true")
	patrol_corellia_privateer_3:failQuest(pPlayer, "true")
	escort_corellia_privateer_3:failQuest(pPlayer, "true")
	assassinate_corellia_privateer_tier1_4a:failQuest(pPlayer, "true")
	...
	SpaceHelpers:clearSpaceQuest(pPlayer, self.QUEST_STRING_3_SIDE.type, self.QUEST_STRING_3_SIDE.name, 1)
