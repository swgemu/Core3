...
function turoldineConvoHandler:getInitialScreen(pPlayer, pNpc, pConvTemplate)
	...
	local questOneComplete = SpaceHelpers:isSpaceQuestComplete(pPlayer, CorsecSquadronScreenplay.TIER4_QUEST_STRING_1.type, CorsecSquadronScreenplay.TIER4_QUEST_STRING_1.name) and
							SpaceHelpers:isSpaceQuestComplete(pPlayer, CorsecSquadronScreenplay.TIER4_QUEST_STRING_1_SIDE1.type, CorsecSquadronScreenplay.TIER4_QUEST_STRING_1_SIDE1.name) and
							SpaceHelpers:isSpaceQuestComplete(pPlayer, CorsecSquadronScreenplay.TIER4_QUEST_STRING_1_SIDE2.type, CorsecSquadronScreenplay.TIER4_QUEST_STRING_1_SIDE2.name)
	local questTwoComplete = SpaceHelpers:isSpaceQuestComplete(pPlayer, CorsecSquadronScreenplay.TIER4_QUEST_STRING_2.type, CorsecSquadronScreenplay.TIER4_QUEST_STRING_2.name) and
							SpaceHelpers:isSpaceQuestComplete(pPlayer, CorsecSquadronScreenplay.TIER4_QUEST_STRING_2_SIDE1.type, CorsecSquadronScreenplay.TIER4_QUEST_STRING_2_SIDE1.name)
...
function turoldineConvoHandler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	elseif (screenID == "accept_third_mission" or screenID == "accept_third_mission2") then
		...
		-- REMOVE AFTER IMPLEMENTATION SPACE BATTLE
		CreatureObject(pPlayer):sendSystemMessage("Space Battle Missions have not been implemented yet, mission has been auto-completed.")

		createEvent(2000, "space_battle_corellia_privateer_tier4_3a", "completeQuest", pPlayer, "true")
	elseif (screenID == "accept_second_mission" or screenID == "failed_second_mission") then
		...
		--createEvent(1000, "assassinate_corellia_privateer_tier4_2a", "completeQuest", pPlayer, "true")
		--createEvent(4000, "escort_corellia_privateer_tier4_2b", "completeQuest", pPlayer, "true")
