...
function turoldineConvoHandler:getInitialScreen(pPlayer, pNpc, pConvTemplate)
	...
	--createEvent(2000, "space_battle_corellia_privateer_tier4_3a", "failQuest", pPlayer, "true")\
	...
	local questThreeStarted = SpaceHelpers:isSpaceQuestActive(pPlayer, CorsecSquadronScreenplay.TIER4_QUEST_STRING_3.type, CorsecSquadronScreenplay.TIER4_QUEST_STRING_3.name) or
							...
							SpaceHelpers:isSpaceQuestActive(pPlayer, CorsecSquadronScreenplay.TIER4_QUEST_STRING_3_SIDE2.type, CorsecSquadronScreenplay.TIER4_QUEST_STRING_3_SIDE2.name) or
							SpaceHelpers:isSpaceQuestActive(pPlayer, CorsecSquadronScreenplay.TIER4_QUEST_STRING_3_SIDE3.type, CorsecSquadronScreenplay.TIER4_QUEST_STRING_3_SIDE3.name)
	...
	local questThreeComplete = SpaceHelpers:isSpaceQuestComplete(pPlayer, CorsecSquadronScreenplay.TIER4_QUEST_STRING_3_SIDE3.type, CorsecSquadronScreenplay.TIER4_QUEST_STRING_3_SIDE3.name)
