...
function rheaConvoHandler:getInitialScreen(pPlayer, pNpc, pConvTemplate)
	...
	if (1 ~= 1) then
		...
		SpaceHelpers:clearSpaceQuest(pPlayer, "patrol", "corellia_privateer_1", true)

		--SpaceHelpers:clearSpaceQuest(pPlayer, "patrol", "corellia_privateer_1")
		--SpaceHelpers:clearSpaceQuest(pPlayer, "destroy", "corellia_privateer_2")
		--SpaceHelpers:clearSpaceQuest(pPlayer, "patrol", "corellia_privateer_3")
		--SpaceHelpers:clearSpaceQuest(pPlayer, "assassinate", "corellia_privateer_tier1_4a")
	...
	elseif (questOneComplete) then
		...
		-- Activate Quest 2
		SpaceHelpers:activateSpaceQuest(pPlayer, pNpc, "destroy", "corellia_privateer_2", true)
...
function rheaConvoHandler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	elseif (screenID == "yes_im_ready") then
		SpaceHelpers:activateSpaceQuest(pPlayer, pNpc, "patrol", "corellia_privateer_1", true)
