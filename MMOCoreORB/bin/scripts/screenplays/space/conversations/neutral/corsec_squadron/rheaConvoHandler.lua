...
function rheaConvoHandler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	elseif (screenID == "train_player_droid") then
		if (skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_neutral_droid_01")) then
			-- Train player Skill Box
			SpaceHelpers:grantSpaceSkill(pPlayer, "pilot_neutral_droid_01")
		end
	elseif (screenID == "train_player_basics") then
		if (skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_neutral_procedures_01")) then
			-- Train player Skill Box
			SpaceHelpers:grantSpaceSkill(pPlayer, "pilot_neutral_procedures_01")
		end
	elseif (screenID == "train_player_fighters") then
		if (skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_neutral_starships_01")) then
			-- Train player Skill Box
			SpaceHelpers:grantSpaceSkill(pPlayer, "pilot_neutral_starships_01")
		end
	elseif (screenID == "train_player_component") then
		if (skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_neutral_weapons_01")) then
			-- Train player Skill Box
			SpaceHelpers:grantSpaceSkill(pPlayer, "pilot_neutral_weapons_01")
		end
