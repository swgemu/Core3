...
function rheaConvoHandler:getInitialScreen(pPlayer, pNpc, pConvTemplate)
	...
	-- TODO: Remove
	--SpaceHelpers:failSpaceQuest(pPlayer, CorsecSquadronScreenplay.QUEST_STRING_2.type, CorsecSquadronScreenplay.QUEST_STRING_2.name, 1)
	--SpaceHelpers:clearSpaceQuest(pPlayer, CorsecSquadronScreenplay.QUEST_STRING_2.type, CorsecSquadronScreenplay.QUEST_STRING_2.name, 1)
	--setQuestStatus(playerID .. ":CorsecSquadron", CorsecSquadronScreenplay.ACCEPTED_MISSION_2)
...
function rheaConvoHandler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	elseif (screenID == "yes_im_ready") then
		...
		SpaceHelpers:activateSpaceQuest(pPlayer, pNpc, CorsecSquadronScreenplay.QUEST_STRING_1.type, CorsecSquadronScreenplay.QUEST_STRING_1.name, 1)
	...
	elseif (screenID == "train_me2") then
		...
		SpaceHelpers:activateSpaceQuest(pPlayer, pNpc, CorsecSquadronScreenplay.QUEST_STRING_2.type, CorsecSquadronScreenplay.QUEST_STRING_2.name, 1)
