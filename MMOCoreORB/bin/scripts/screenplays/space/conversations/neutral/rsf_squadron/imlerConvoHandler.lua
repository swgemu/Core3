imlerConvoHandler = conv_handler:new {}

function imlerConvoHandler:getInitialScreen(pPlayer, pNpc, pConvTemplate)
	...
	-- RSF neutral pilot has not completed Tier3
	if (pilotTier < 4) then
		return convoTemplate:getScreen("not_proper_tier")
	end

	local questOneStarted = SpaceHelpers:isSpaceQuestActive(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_1.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_1.name) or
	...
	local questTwoStarted = SpaceHelpers:isSpaceQuestActive(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_2.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_2.name) or
							...
							SpaceHelpers:isSpaceQuestActive(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_2_SIDE3.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_2_SIDE3.name)
	local questThreeStarted = SpaceHelpers:isSpaceQuestActive(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_3.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_3.name) or
	...
	local questFourStarted = SpaceHelpers:isSpaceQuestActive(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_4.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_4.name) or
							...
							SpaceHelpers:isSpaceQuestActive(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_4_SIDE2.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_4_SIDE2.name)

	local questOneComplete = SpaceHelpers:isSpaceQuestComplete(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_1_SIDE1.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_1_SIDE1.name)
	local questTwoComplete = SpaceHelpers:isSpaceQuestComplete(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_2_SIDE3.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_2_SIDE3.name)
	local questThreeComplete = SpaceHelpers:isSpaceQuestComplete(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_3_SIDE2.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_3_SIDE2.name)
	local questFourComplete = SpaceHelpers:isSpaceQuestComplete(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_4_SIDE2.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_4_SIDE2.name)

	local duty1Started = SpaceHelpers:isSpaceQuestActive(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_1.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_1.name)
	local duty2Started = SpaceHelpers:isSpaceQuestActive(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_2.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_2.name)
	local duty3Started = SpaceHelpers:isSpaceQuestActive(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_3.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_3.name)
	local duty4Started = SpaceHelpers:isSpaceQuestActive(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_4.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_4.name)

	local duty1Complete = SpaceHelpers:isSpaceQuestComplete(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_1.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_1.name)
	local duty2Complete = SpaceHelpers:isSpaceQuestComplete(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_2.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_2.name)
	local duty3Complete = SpaceHelpers:isSpaceQuestComplete(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_3.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_3.name)
	local duty4Complete = SpaceHelpers:isSpaceQuestComplete(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_4.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_DUTY_4.name)
	...
	-- Player has an active mission from Imler
	...
	-- Check if players have all the tier4 skill boxes and finished the last mission, then send them to master or duty missions
	elseif (questFourComplete and completedTier4) then
		-- Players has all the skill boxes, they should be a tier 5. Increment if not proper
	...
	-- Reward Checks
	elseif (questFourComplete and getQuestStatus(playerID .. RsfSquadronScreenplay.TIER4_QUEST_STRING_4.name .. ":reward") ~= "1") then
			return convoTemplate:getScreen("fourth_mission_success")
	elseif (questThreeComplete and getQuestStatus(playerID .. RsfSquadronScreenplay.TIER4_QUEST_STRING_3.name .. ":reward") ~= "1") then
			return convoTemplate:getScreen("third_mission_success")
	elseif (questTwoComplete and getQuestStatus(playerID .. RsfSquadronScreenplay.TIER4_QUEST_STRING_2.name .. ":reward") ~= "1") then
			return convoTemplate:getScreen("second_mission_success")
	elseif (questOneComplete and getQuestStatus(playerID .. RsfSquadronScreenplay.TIER4_QUEST_STRING_1.name .. ":reward") ~= "1") then
	...
	-- Has not spoken to Imler yet
	elseif (getQuestStatus(playerID .. "RsfSquadronScreenplay:StartedImler") ~= "1") then
		setQuestStatus(playerID .. "RsfSquadronScreenplay:StartedImler", 1)
...
function imlerConvoHandler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	if (screenID == "ready_train_pilot") then
		...
		if (SpaceHelpers:isSpaceQuestComplete(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_4_SIDE2.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_4_SIDE2.name)) then
			responseString = "final_"
		elseif (SpaceHelpers:isSpaceQuestComplete(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_3_SIDE2.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_3_SIDE2.name)) then
			responseString = "mission4_"
		elseif (SpaceHelpers:isSpaceQuestComplete(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_2_SIDE3.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_2_SIDE3.name)) then
			responseString = "mission3_"
		elseif (SpaceHelpers:isSpaceQuestComplete(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_1_SIDE1.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_1_SIDE1.name)) then
		...
		if (not CreatureObject(pPlayer):hasSkill("pilot_neutral_starships_04") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_neutral_starships_04")) then
			clonedConversation:addOption("@conversation/naboo_privateer_tier4:s_train_starships", responseString .. "train_fighters") -- I want to learn exotic vessels.
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_neutral_weapons_04") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_neutral_weapons_04")) then
			clonedConversation:addOption("@conversation/naboo_privateer_tier4:s_train_weapons", responseString .. "train_components") -- I want to learn heavy starship component use.
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_neutral_procedures_04") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_neutral_procedures_04")) then
			clonedConversation:addOption("@conversation/naboo_privateer_tier4:s_train_procedures", responseString .. "train_techniques") -- I want to learn expert techniques.
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_neutral_droid_04") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_neutral_droid_04")) then
			clonedConversation:addOption("@conversation/naboo_privateer_tier4:s_train_droid", responseString .. "train_algorithms") -- I want to learn droid intelligence theory.
		end
	...
	elseif (string.find(screenID, "_train_")) then
		...
		if (SpaceHelpers:hasExperienceForTraining(pPlayer, 4) or SpaceHelpers:isSpaceQuestComplete(pPlayer, RsfSquadronScreenplay.TIER4_QUEST_STRING_4_SIDE2.type, RsfSquadronScreenplay.TIER4_QUEST_STRING_4_SIDE2.name)) then
	...
	elseif (screenID == "fourth_mission_success") then
		...
		-- Grant Reward
		space_battle_naboo_privateer_tier4_4c:rewardPlayer(pPlayer)
	elseif (screenID == "third_mission_success") then
		...
		-- Grant Reward
		survival_naboo_privateer_tier4_3c:rewardPlayer(pPlayer)
	elseif (screenID == "second_mission_success") then
		...
		-- Grant Reward
		destroy_surpriseattack_naboo_privateer_tier4_2d:rewardPlayer(pPlayer)
	elseif (screenID == "first_mission_success") then
		...
		-- Grant Reward
		escort_naboo_privateer_tier4_1b:rewardPlayer(pPlayer)
	...
	elseif (screenID == "accept_third_mission" or screenID == "failed_third_mission") then
