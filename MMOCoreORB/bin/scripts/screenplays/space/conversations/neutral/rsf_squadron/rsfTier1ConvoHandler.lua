rsfTier1ConvoHandler = conv_handler:new {}

function rsfTier1ConvoHandler:getInitialScreen(pPlayer, pNpc, pConvTemplate)
...
function rsfTier1ConvoHandler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
