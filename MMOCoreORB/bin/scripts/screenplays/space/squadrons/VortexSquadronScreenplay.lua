...
--[[
	...
	Vortex Squadron Missions (Rebel - Naboo-based)

]]

--[[
	Tier 1 -- Evin Main Missions (Naboo)
]]
...
patrol_naboo_rebel_1 = SpacePatrolScreenplay:new {
	...
	patrolPoints = {
		{patrolPointName = "rebel_naboo_patrol_1", x = -3000, z = -2000, y = 2200, patrolNumber = 1, radius = 150},
		{patrolPointName = "rebel_naboo_patrol_2", x = -2500, z = -2500, y = 2800, patrolNumber = 2, radius = 150},
		{patrolPointName = "rebel_naboo_patrol_3", x = -2000, z = -2200, y = 3200, patrolNumber = 3, radius = 150},
	},
}
...
destroy_naboo_rebel_2 = SpaceDestroyScreenplay:new {
	...
	shipLocations = {
		{patrolPointName = "imperial_naboo_1", x = -1500, z = -2000, y = 2500},
		{patrolPointName = "imperial_naboo_2", x = -2000, z = -1500, y = 3000},
	},
...
escort_naboo_rebel_3 = SpaceEscortScreenplay:new {
	...
	escortPoints = {
		{patrolPointName = "rebel_naboo_escort_1", zoneName = "space_naboo", x = -3000, z = -2500, y = 3000, escortNumber = 1, radius = 250},
		{patrolPointName = "rebel_naboo_escort_2", zoneName = "space_naboo", x = -2500, z = -2800, y = 3500, escortNumber = 2, radius = 250},
		{patrolPointName = "rebel_naboo_escort_3", zoneName = "space_naboo", x = -2000, z = -3000, y = 4000, escortNumber = 3, radius = 250},
	},
...
assassinate_naboo_rebel_4 = SpaceAssassinateScreenplay:new {
	...
	targetPatrols = {
		{patrolPointName = "rebel_naboo_assassinate_1", x = -2500, z = -1800, y = 2800},
		{patrolPointName = "rebel_naboo_assassinate_2", x = -1800, z = -2200, y = 3200},
	},
}
...
escort_duty_naboo_rebel_7 = SpaceDutyEscortScreenplay:new {
	...
	escortPoints = {
		{patrolPointName = "rebel_naboo_escort_duty_1", zoneName = "space_naboo", x = -3000, z = -2500, y = 3000, escortNumber = 1, radius = 250},
		{patrolPointName = "rebel_naboo_escort_duty_2", zoneName = "space_naboo", x = -2500, z = -2800, y = 3500, escortNumber = 2, radius = 250},
		{patrolPointName = "rebel_naboo_escort_duty_3", zoneName = "space_naboo", x = -2000, z = -3000, y = 4000, escortNumber = 3, radius = 250},
	},
...
--[[
	Tier 2 -- Ezkiel Main Missions (Dantooine)
]]

-- Mission 1: Destroy
destroy_ezkiel_rebel_1 = SpaceDestroyScreenplay:new {
	className = "destroy_ezkiel_rebel_1",

	questName = "dantooine_rebel_1",
	questType = "destroy",
...
registerScreenPlay("destroy_ezkiel_rebel_1", true)

-- Mission 2: Patrol
patrol_ezkiel_rebel_2 = SpacePatrolScreenplay:new {
	className = "patrol_ezkiel_rebel_2",

	questName = "dantooine_rebel_2",
	questType = "patrol",
	...
	patrolPoints = {
		{patrolPointName = "ezkiel_patrol_1", x = -2500, z = -2000, y = 3000, patrolNumber = 1, radius = 150},
		{patrolPointName = "ezkiel_patrol_2", x = -2000, z = -2500, y = 3500, patrolNumber = 2, radius = 150},
		{patrolPointName = "ezkiel_patrol_3", x = -1500, z = -2200, y = 4000, patrolNumber = 3, radius = 150},
	},
}

registerScreenPlay("patrol_ezkiel_rebel_2", true)

-- Mission 3: Escort
escort_ezkiel_rebel_3 = SpaceEscortScreenplay:new {
	className = "escort_ezkiel_rebel_3",

	questName = "dantooine_rebel_3",
	questType = "escort",
	...
	escortPoints = {
		{patrolPointName = "ezkiel_escort_1", zoneName = "space_dantooine", x = -2163, z = 956, y = 4991, escortNumber = 1, radius = 250},
		{patrolPointName = "ezkiel_escort_2", zoneName = "space_dantooine", x = -637, z = -295, y = 4770, escortNumber = 2, radius = 250},
		{patrolPointName = "ezkiel_escort_3", zoneName = "space_dantooine", x = 2043, z = -1230, y = 5414, escortNumber = 3, radius = 250},
	},
...
registerScreenPlay("escort_ezkiel_rebel_3", true)

-- Mission 4: Destroy
destroy_ezkiel_rebel_4 = SpaceDestroyScreenplay:new {
	className = "destroy_ezkiel_rebel_4",

	questName = "dantooine_rebel_4",
	questType = "destroy",
...
registerScreenPlay("destroy_ezkiel_rebel_4", true)

-- Ezkiel Duty Missions
destroy_duty_ezkiel_rebel_1 = SpaceDutyDestroyScreenplay:new {
	className = "destroy_duty_ezkiel_rebel_1",

	questName = "dantooine_rebel_duty_6",
	questType = "destroy_duty",
...
registerScreenPlay("destroy_duty_ezkiel_rebel_1", true)

escort_duty_ezkiel_rebel_2 = SpaceDutyEscortScreenplay:new {
	className = "escort_duty_ezkiel_rebel_2",

	questName = "dantooine_rebel_duty_7",
	questType = "escort_duty",
	...
	escortPoints = {
		{patrolPointName = "ezkiel_escort_duty_1", zoneName = "space_dantooine", x = -3000, z = -2500, y = 3000, escortNumber = 1, radius = 250},
		{patrolPointName = "ezkiel_escort_duty_2", zoneName = "space_dantooine", x = -2500, z = -2800, y = 3500, escortNumber = 2, radius = 250},
	},
...
registerScreenPlay("escort_duty_ezkiel_rebel_2", true)

--[[
	Tier 3 -- V3-FX Main Missions (Naboo)
]]
...
recovery_naboo_rebel_tier3_1 = SpaceRecoveryScreenplay:new {
	...
	preRecoveryPoints = {
		{patrolPointName = "v3fx_recovery_pre_1", zoneName = "space_naboo", x = 2500, z = 1200, y = 3000, escortNumber = 1, radius = 250},
	},

	recoveryPoints = {
		{patrolPointName = "v3fx_recovery_1", zoneName = "space_naboo", x = 3000, z = -600, y = 3500, escortNumber = 1, radius = 250},
	},
...
delivery_naboo_rebel_tier3_3 = SpaceDeliveryScreenplay:new {
	...
	deliveryPoints = {
		{patrolPointName = "v3fx_delivery_1", zoneName = "space_naboo", x = 3000, z = -600, y = 3500, deliveryNumber = 1, radius = 250},
		{patrolPointName = "v3fx_delivery_2", zoneName = "space_naboo", x = 3500, z = -1000, y = 3000, deliveryNumber = 2, radius = 250},
	},
}
...
assassinate_naboo_rebel_tier3_4 = SpaceAssassinateScreenplay:new {
	...
	targetPatrols = {
		{patrolPointName = "v3fx_assassinate_1", x = -500, z = -1000, y = 2500},
		{patrolPointName = "v3fx_assassinate_2", x = 500, z = -500, y = 1500},
	},
}
...
--[[
	Tier 4 -- Vrovel Main Missions (Naboo)
]]

-- Mission 1: Space Battle
space_battle_naboo_rebel_tier4_1 = SpaceBattleScreenplay:new {
	className = "space_battle_naboo_rebel_tier4_1",
...
registerScreenPlay("space_battle_naboo_rebel_tier4_1", true)

-- Mission 2: Recovery
recovery_naboo_rebel_tier4_2 = SpaceRecoveryScreenplay:new {
	className = "recovery_naboo_rebel_tier4_2",
	...
	preRecoveryPoints = {
		{patrolPointName = "vrovel_recovery_pre_1", zoneName = "space_naboo", x = 2500, z = 1200, y = 3000, escortNumber = 1, radius = 250},
	},

	recoveryPoints = {
		{patrolPointName = "vrovel_recovery_1", zoneName = "space_naboo", x = 3000, z = -600, y = 3500, escortNumber = 1, radius = 250},
	},
...
registerScreenPlay("recovery_naboo_rebel_tier4_2", true)
...
-- Mission 4: Assassinate
assassinate_naboo_rebel_tier4_4 = SpaceAssassinateScreenplay:new {
	className = "assassinate_naboo_rebel_tier4_4",
	...
	targetPatrols = {
		{patrolPointName = "vrovel_assassinate_1", x = -500, z = -1000, y = 2500},
		{patrolPointName = "vrovel_assassinate_2", x = 500, z = -500, y = 1500},
	},
}

registerScreenPlay("assassinate_naboo_rebel_tier4_4", true)

-- Master Mission: Destroy
destroy_naboo_rebel_master = SpaceDestroyScreenplay:new {
	className = "destroy_naboo_rebel_master",

	questName = "naboo_rebel_master",
	questType = "destroy",
...
registerScreenPlay("destroy_naboo_rebel_master", true)

-- Vrovel Duty Missions
escort_duty_naboo_rebel_tier4_1 = SpaceDutyEscortScreenplay:new {
	...
	escortPoints = {
		{patrolPointName = "vrovel_escort_duty_1", zoneName = "space_naboo", x = -3000, z = -2500, y = 3000, escortNumber = 1, radius = 250},
		{patrolPointName = "vrovel_escort_duty_2", zoneName = "space_naboo", x = -2500, z = -2800, y = 3500, escortNumber = 2, radius = 250},
	},
...
recovery_duty_naboo_rebel_tier4_1 = SpaceDutyDestroyScreenplay:new {
...
rescue_duty_naboo_rebel_tier4_1 = SpaceDutyDestroyScreenplay:new {
...
VortexSquadronScreenplay = ScreenPlay:new {
	...
	QUEST_STRING_3 = {type = "escort", name = "naboo_rebel_3"},
	...
	-- Tier 2 (Ezkiel)
	TIER2_QUEST_STRING_1 = {type = "destroy", name = "dantooine_rebel_1"},
	TIER2_QUEST_STRING_2 = {type = "patrol", name = "dantooine_rebel_2"},
	TIER2_QUEST_STRING_3 = {type = "escort", name = "dantooine_rebel_3"},
	TIER2_QUEST_STRING_4 = {type = "destroy", name = "dantooine_rebel_4"},
	TIER2_QUEST_STRING_DUTY_1 = {type = "destroy_duty", name = "dantooine_rebel_duty_6"},
	TIER2_QUEST_STRING_DUTY_2 = {type = "escort_duty", name = "dantooine_rebel_duty_7"},
	...
	-- Tier 4 (Vrovel)
	TIER4_QUEST_STRING_1 = {type = "space_battle", name = "naboo_rebel_tier4_1"},
	TIER4_QUEST_STRING_2 = {type = "recovery", name = "naboo_rebel_tier4_2"},
	TIER4_QUEST_STRING_3 = {type = "space_battle", name = "naboo_rebel_tier4_3"},
	TIER4_QUEST_STRING_4 = {type = "assassinate", name = "naboo_rebel_tier4_4"},
	TIER4_QUEST_STRING_MASTER = {type = "destroy", name = "naboo_rebel_master"},
	TIER4_QUEST_STRING_DUTY_1 = {type = "escort_duty", name = "naboo_rebel_tier4_1"},
	TIER4_QUEST_STRING_DUTY_2 = {type = "destroy_duty", name = "naboo_rebel_tier4_1"},
	TIER4_QUEST_STRING_DUTY_3 = {type = "recovery_duty", name = "naboo_rebel_tier4_1"},
	TIER4_QUEST_STRING_DUTY_4 = {type = "rescue_duty", name = "naboo_rebel_tier4_1"},
}
...
function VortexSquadronScreenplay:resetEvinQuests(pPlayer)
	if (pPlayer == nil) then
		return
	end
...
function VortexSquadronScreenplay:resetVrovelQuests(pPlayer)
	if (pPlayer == nil) then
		return
	end

	-- Mission 1
	space_battle_naboo_rebel_tier4_1:resetQuest(pPlayer)
	SpaceHelpers:clearSpaceQuest(pPlayer, self.TIER4_QUEST_STRING_1.type, self.TIER4_QUEST_STRING_1.name, false)

	-- Mission 2
	recovery_naboo_rebel_tier4_2:resetQuest(pPlayer)
