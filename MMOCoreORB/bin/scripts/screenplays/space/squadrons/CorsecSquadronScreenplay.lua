...
escort_corellia_privateer_tier3_3_pre_a = SpaceEscortScreenplay:new {
	...
	escortPoints = {
		{name = "corellia_privateer_tier3_delivery", zoneName = "space_dantooine", x = 1633, z = -2059, y = -1925, escortNumber = 1, radius = 250},
		{name = "corellia_privateer_tier3_patrol_4", zoneName = "space_dantooine", x = -4468, z = -3583, y = 624, escortNumber = 2, radius = 250},
		{name = "corellia_privateer_tier3_patrol_1", zoneName = "space_dantooine", x = -4204, z = -3241, y = 3652, escortNumber = 3, radius = 250},
	},
...
patrol_corellia_privateer_tier3_3_a = SpacePatrolScreenplay:new {
	...
	patrolPoints = {
		{name = "corellia_privateer_tier3_patrol_1", zoneName = "space_dantooine", x = 1633, z = -2059, y = -1925, patrolNumber = 1, radius = 150},
		{name = "corellia_privateer_tier3_patrol_2", zoneName = "space_dantooine", x = -4468, z = -3583, y = 624, patrolNumber = 2, radius = 150},
		{name = "corellia_privateer_tier3_patrol_3", zoneName = "space_dantooine", x = -4204, z = -3241, y = 3652, patrolNumber = 3, radius = 150},
		{name = "corellia_privateer_tier3_patrol_4", zoneName = "space_dantooine", x = -4204, z = -3241, y = 3652, patrolNumber = 4, radius = 150},
	},
}
...
escort_corellia_privateer_tier4_2b = SpaceEscortScreenplay:new {
	...
	escortPoints = {
		{name = "corellia_privateer_tier4_leg_2_escort_1", zoneName = "space_dathomir", x = 2611, z = -387, y = 3617, escortNumber = 1, radius = 250},
		{name = "corellia_privateer_tier4_leg_2_escort_2", zoneName = "space_dathomir", x = 683, z = 1485, y = 3209, escortNumber = 2, radius = 250},
		{name = "corellia_privateer_tier4_leg_2_escort_3", zoneName = "space_dathomir", x = -1642, z = 3578, y = 2633, escortNumber = 3, radius = 250},
		{name = "corellia_privateer_tier4_leg_2_escort_4", zoneName = "space_dathomir", x = -2146, z = 5611, y = 2738, escortNumber = 4, radius = 250},
		{name = "corellia_privateer_tier4_leg_2_escort_5", zoneName = "space_dathomir", x = -2682, z = 7408, y = 2855, escortNumber = 4, radius = 250},
	},
...
space_battle_corellia_privateer_tier4_3a = SpaceBattleScreenplay:new {
	...
	battleLocation = {name = "corellia_privateer_tier4_leg_3_space_battle_one", x = 5063, y = -816, z = -3364},
...
space_battle_corellia_privateer_tier4_3c_win = SpaceBattleScreenplay:new {
	...
	battleLocation = {name = "corellia_privateer_tier4_leg_3_space_battle_two", x = 7512, z = -5651, y = 1803},
...
escort_duty_corellia_privateer_tier4_1 = SpaceDutyEscortScreenplay:new {
	...
	escortPoints = {
		{name = "corellia_privateer_tier4_escort_duty_1", zoneName = "space_dathomir", x = 3523, z = 400, y = -4024, escortNumber = 1, radius = 250},
		{name = "corellia_privateer_tier4_escort_duty_2", zoneName = "space_dathomir", x = 2089, z = 4103, y = -4060, escortNumber = 2, radius = 250},
		{name = "corellia_privateer_tier4_escort_duty_3", zoneName = "space_dathomir", x = 1396, z = 5751, y = -3946, escortNumber = 3, radius = 250},
		{name = "corellia_privateer_tier4_escort_duty_4", zoneName = "space_dathomir", x = 817, z = 7127, y = -3851, escortNumber = 4, radius = 250},
		{name = "corellia_privateer_tier4_escort_duty_5", zoneName = "space_dathomir", x = 23729, z = 7391, y = -1995, escortNumber = 5, radius = 250},
	},
...
CorsecSquadronScreenplay = ScreenPlay:new {
	...
	TIER4_QUEST_STRING_3_SIDE2B = {type = "space_battle", name = "space_battle_corellia_privateer_tier4_3c_lose"},
	TIER4_QUEST_STRING_4 = {type = "assassinate", name = "corellia_privateer_tier4_4a"},
	TIER4_QUEST_STRING_4_SIDE1 = {type = "space_battle", name = "corellia_privateer_tier4_3a"},
	TIER4_QUEST_STRING_4_SIDE2 = {type = "space_battle", name = "corellia_privateer_tier4_3a"},
	TIER4_QUEST_STRING_4_SIDE3 = {type = "space_battle", name = "corellia_privateer_tier4_3a"},
...
function CorsecSquadronScreenplay:resetRheaQuests(pPlayer)
	...
	-- Mission 1
	patrol_corellia_privateer_1:resetQuest(pPlayer, "false")
	destroy_surpriseattack_corellia_privateer_1:resetQuest(pPlayer, "false")
	...
	-- Mission 2
	destroy_corellia_privateer_2:resetQuest(pPlayer, "false")
	SpaceHelpers:clearSpaceQuest(pPlayer, self.QUEST_STRING_2.type, self.QUEST_STRING_2.name, false)

	-- Mission 3
	patrol_corellia_privateer_3:resetQuest(pPlayer, "false")
	escort_corellia_privateer_3:resetQuest(pPlayer, "false")
	...
	-- Mission 4
	assassinate_corellia_privateer_tier1_4a:resetQuest(pPlayer, "false")
...
function CorsecSquadronScreenplay:resetRamnaQuests(pPlayer)
	...
	-- Mission 1
	recovery_corellia_privateer_tier3_1:resetQuest(pPlayer, "false")
	patrol_corellia_privateer_tier3_1_a:resetQuest(pPlayer, "false")
	escort_corellia_privateer_tier3_1_b:resetQuest(pPlayer, "false")
	destroy_surpriseattack_corellia_privateer_tier3_1_c:resetQuest(pPlayer, "false")
	...
	-- Mission 2
	inspect_corellia_privateer_tier3_2:resetQuest(pPlayer, "false")
	survival_corellia_privateer_tier3_2_a:resetQuest(pPlayer, "false")
	delivery_corellia_privateer_tier3_2_b:resetQuest(pPlayer, "false")
	destroy_surpriseattack_corellia_privateer_tier3_2_c:resetQuest(pPlayer, "false")
	...
	-- Mission 3
	delivery_corellia_privateer_tier3_3:resetQuest(pPlayer, "false")
	escort_corellia_privateer_tier3_3_pre_a:resetQuest(pPlayer, "false")
	patrol_corellia_privateer_tier3_3_a:resetQuest(pPlayer, "false")
	assassinate_corellia_privateer_tier3_3d:resetQuest(pPlayer, "false")
	...
	-- Mission 4
	assassinate_corellia_privateer_tier3_4:resetQuest(pPlayer, "false")
	survival_corellia_privateer_tier3_4_a:resetQuest(pPlayer, "false")
...
function CorsecSquadronScreenplay:resetTuroldineQuests(pPlayer)
	...
	-- Mission 1
	patrol_corellia_privateer_tier4_1a:resetQuest(pPlayer, "false")
	assassinate_corellia_privateer_tier4_1b:resetQuest(pPlayer, "false")
	destroy_surpriseattack_corellia_privateer_tier4_1c:resetQuest(pPlayer, "false")
	...
	-- Mission 2
	assassinate_corellia_privateer_tier4_2a:resetQuest(pPlayer, "false")
	escort_corellia_privateer_tier4_2b:resetQuest(pPlayer, "false")
	...
	-- Mission 3
	space_battle_corellia_privateer_tier4_3a:resetQuest(pPlayer, "false")
	assassinate_corellia_privateer_tier4_3b:resetQuest(pPlayer, "false")
	space_battle_corellia_privateer_tier4_3c_win:resetQuest(pPlayer, "false")
	space_battle_corellia_privateer_tier4_3c_lose:resetQuest(pPlayer, "false")
	...
	-- Mission 4
	assassinate_corellia_privateer_tier4_4a:resetQuest(pPlayer, "false")
	assassinate_corellia_privateer_tier4_4b:resetQuest(pPlayer, "false")
	destroy_surpriseattack_corellia_privateer_tier4_4c:resetQuest(pPlayer, "false")
	assassinate_corellia_privateer_tier4_4d:resetQuest(pPlayer, "false")
