...
function ForceShrineMenuComponent:startNextJediPadawanTrial(pObject, pPlayer)
	...
	-- JediPadawanTrialCraftLightsaberScreenPlay:start(pPlayer)
		...
		if (#uncompletedTrials <= 0) then -- Finished all trials.
			...
			-- TODO: Research if padawan was unlocked after completing last trial and meditating.
		else -- Still more.
			...
			writeScreenPlayData(pPlayer, "JediPadawanTrial", "CurrentTrial", rand + trialsCompleted)
		end
	end
