...
function JediPadawanTrialArchitechScreenPlay:start(pCreature)
	...
	-- These need to be stringidchat parms or else it 
	local msg1 = "A Jedi must gather all possible information before making a decision. Travel to the planet " .. tostring(zoneName)
	local msg2 = ". Once there, a waypoint will be uploaded to your datapad leading you to an architect by the name of Kant Graf in the city of " .. tostring(regionString)
