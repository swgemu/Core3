...
function PadawanTrials:startTrial(pPlayer, trialNum, skipNotification)
	...
	if (trialData == nil) then
		printLuaError("PadawanTrials:startTrial, unable to get trial data for player " .. CreatureObject(pPlayer):getFirstName() .. " on trial " .. trialNum)
		return 1
	end
...
function PadawanTrials:notifyCraftedTrainingSaber(pPlayer, pItem)
	...
	if (trialData == nil) then
		printLuaError("PadawanTrials:notifyCraftedTrainingSaber, unable to get trial data for player " .. CreatureObject(pPlayer):getFirstName() .. " on trial " .. trialNum)
		return 1
	end
...
function PadawanTrials:notifyTunedLightsaberCrystal(pPlayer, pItem)
	...
	if (trialData == nil) then
		printLuaError("PadawanTrials:notifyTunedLightsaberCrystal, unable to get trial data for player " .. CreatureObject(pPlayer):getFirstName() .. " on trial " .. trialNum)
		return 1
	end
...
function PadawanTrials:setupHuntTrial(pPlayer)
	...
	if (trialData == nil) then
		printLuaError("PadawanTrials:setupHuntTrial, unable to get trial data for player " .. CreatureObject(pPlayer):getFirstName() .. " on trial " .. trialNumber)
		return
	end
...
function PadawanTrials:hasCompletedHunt(pPlayer)
	...
	if (trialData == nil) then
		printLuaError("PadawanTrials:hasCompletedHunt, unable to get trial data for player " .. CreatureObject(pPlayer):getFirstName() .. " on trial " .. trialNumber)
		return false
	end
...
function PadawanTrials:notifyKilledHuntTarget(pPlayer, pVictim)
	...
	if (trialData == nil) then
		printLuaError("PadawanTrials:notifyKilledHuntTarget, unable to get trial data for player " .. CreatureObject(pPlayer):getFirstName() .. " on trial " .. trialNumber)
		return 1
	end
...
function PadawanTrials:createMainLocation(pPlayer)
	...
	if (trialData == nil) then
		printLuaError("PadawanTrials:createMainLocation, unable to get trial data for player " .. CreatureObject(pPlayer):getFirstName() .. " on trial " .. trialNum)
		return
	end
...
function PadawanTrials:sendSuiNotification(pPlayer)
	...
	if (trialData == nil) then
		printLuaError("PadawanTrials:sendSuiNotification, unable to get trial data for player " .. CreatureObject(pPlayer):getFirstName() .. " on trial " .. trialNumber)
		return
	end
...
function PadawanTrials:createTargetLocation(pPlayer, isThirdLocation)
	...
	if (trialData == nil) then
		printLuaError("PadawanTrials:createTargetLocation, unable to get trial data for player " .. CreatureObject(pPlayer):getFirstName() .. " on trial " .. trialNumber)
		return
	end
...
function PadawanTrials:notifyQuestTargetDead(pVictim, pAttacker)
	...
	if (readData(npcID .. ":destroyNpcOnExit") ~= 1) then
		...
		if (trialData == nil) then
			printLuaError("PadawanTrials:notifyQuestTargetDead, unable to get trial data for player " .. CreatureObject(pPlayer):getFirstName() .. " on trial " .. trialNumber)
			return 1
		end
