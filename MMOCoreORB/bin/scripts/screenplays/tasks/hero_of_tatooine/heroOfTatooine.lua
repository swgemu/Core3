...
function HeroOfTatooineScreenPlay:start()
	if (isZoneEnabled("tatooine")) then
		...
		local pRanchHouse = getSceneObject(4005939)
...
function HeroOfTatooineScreenPlay:doHonorMove(pAgent, nextPoint)
	if (pAgent == nil) then
		return
	end
...
function HeroOfTatooineScreenPlay:onEnteredRanchHouse(pObject)
