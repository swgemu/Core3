...
function HeroOfTatooineScreenPlay:spawnAltruismObjects()
	...
	writeData("hero_of_tat:caveWallStatus", 1) -- Spawned
end
...
function HeroOfTatooineScreenPlay:createCourageEvent()
	createServerEvent(self.eventChangeTime, "HeroOfTatooineScreenPlay", "doCourageChange", "HeroOfTatCourage")
end

function HeroOfTatooineScreenPlay:createAltruismEvent()
	createServerEvent(self.eventChangeTime, "HeroOfTatooineScreenPlay", "doAltruismChange", "HeroOfTatAltruism")
end
...
function HeroOfTatooineScreenPlay:despawnAltruismObjects()
	...
	writeData("hero_of_tat:caveWallStatus", 0) -- Not spawned
...
function HeroOfTatooineScreenPlay:destroyCaveWall(pCrevice)
	...
	writeData("hero_of_tat:caveWallStatus", 2) -- Destroyed
end
