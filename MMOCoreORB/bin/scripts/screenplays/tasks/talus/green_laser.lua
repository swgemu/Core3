green_laser_missions =
	{
		...
		},
		{
			...
			primarySpawns =
			{--*SOE string-file dialogs contradicts the name of purple waypoint, as well as the other breech dialog from
				--the target npc (Green says "Corsec" , the wp & breech say "Fed Dub" ) . So, i took 1 of each.
				{ npcTemplate = "fed_dub_investigator", npcName = "" }
			},
			secondarySpawns =
			{
				{ npcTemplate = "corsec_detective", npcName = "a Corsec Patrol Officer" }
			},
			itemSpawns = 
			{
			},
