durgur_pyne_missions =
	{
		...
		},
		{
			...
			{--*questgiver Durgur says in string-file dialog "I'll contact a couple of my officers to give you some backup"
				{ objectTemplate = "object/mobile/dressed_corsec_captain_human_male_01.iff", objectName = "Corsec Officer" },
				{ objectTemplate = "object/mobile/dressed_corsec_captain_human_female_01.iff", objectName = "Corsec Officer" }
			},
			itemSpawns =
			{
			},
