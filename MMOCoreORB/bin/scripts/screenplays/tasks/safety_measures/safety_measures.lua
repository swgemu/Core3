...
function SafetyMeasures:notifyKilledCreature(pPlayer, pVictim)
	...
	if (ghost:isJournalQuestActive(QuestManager.questCRC.QUEST_LF_SAFETY1) and not ghost:isJournalQuestComplete(QuestManager.questCRC.QUEST_LF_SAFETY1) and victimName == "worrt") then
