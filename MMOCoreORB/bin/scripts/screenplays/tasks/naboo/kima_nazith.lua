	...
	{
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "gungan_mercenary", planetName = "naboo", npcName = "Benbul Leedee" }
			},
			secondarySpawns =
			{
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "kima_trandoshan_slavemaster", planetName = "naboo", npcName = "Hrodius Goragg" }
			},
			secondarySpawns =
			{
				{ npcTemplate = "imperial_trooper", planetName = "naboo", npcName = "" },
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "lesser_prophet_of_the_dark_side", planetName = "naboo", npcName = "Kunn Kuroosh" }
			},
			secondarySpawns =
			{
				{ npcTemplate = "stormtrooper", planetName = "naboo", npcName = "" },
