...
function RishaSinan:finalTask(pPlayer)
	...
	local waypointID = PlayerObject(pGhost):addWaypoint("rori", "Return to Risha Sinan", "", 5335, 0, 5637, WAYPOINT_YELLOW, true, true, 0, 0)
...
function RishaSinan:giveWaypoints(pPlayer)
	...
	local waypointID = PlayerObject(pGhost):addWaypoint("rori", "Giant Mite Cave", "", 3572, 0, 5424, WAYPOINT_YELLOW, true, true, 0, 0)
	...
	waypointID = PlayerObject(pGhost):addWaypoint("rori", "Risha Sinan", "", 5335, 0, 5637, WAYPOINT_YELLOW, false, true, 0, 0)
	setQuestStatus(playerID .. ":rishaSinanWaypointID", waypointID)
end
