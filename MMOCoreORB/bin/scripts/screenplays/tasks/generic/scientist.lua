	...
	{
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "scientist_target_robber", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = 
			{
				{ npcTemplate = "thug", genericQuest = true, npcName = "a Thug" }
			},
			itemSpawns =
			{
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "scientist_target_spy", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns =
			{
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "criminal", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns = {},
			rewards =
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "scientist_target_crazed_scientist", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns = {},
			rewards =
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "scientist_target_scientist", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns = {},
			rewards =
