	...
	{
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "businessman_target", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns = {},
			rewards =
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "businessman_target_thief_briefcase", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns =
			{
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "businessman_target_thief_award", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns =
			{
