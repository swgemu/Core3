	...
	{
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "noble_target_heirloom", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns =
			{
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "noble_target_ledger", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns =
			{
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "noble_target_hyperdrive", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns =
			{
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "noble_target_bowl", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns =
			{
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "noble_target", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns = {},
			rewards =
