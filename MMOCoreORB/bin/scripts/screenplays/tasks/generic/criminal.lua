	...
	{
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "criminal_target", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns = {},
			rewards =
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "criminal_target_black_sun", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns =
			{
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "criminal_target_merchant", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns =
			{
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "criminal_target_noble", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns =
			{
		...
		},
		{
			...
			primarySpawns =
			{
				{ npcTemplate = "criminal_target_rival", genericQuest = true, npcName = "random" }
			},
			secondarySpawns = {},
			itemSpawns =
			{
