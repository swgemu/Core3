...
{
	{
		...
		itemSpawns =
		{
			{ itemTemplate = "object/tangible/mission/mission_datadisk.iff", itemName = "Fraud Evidence" }
		},
		rewards =
		{
			{ rewardType = "credits", amount = 100 }
	...
	},
	{
		...
		itemSpawns =
		{
			{ itemTemplate = "object/tangible/mission/mission_datadisk.iff", itemName = "Investigation Disk" }
		},
		rewards =
		{
