...
createObserver(OBJECTINRANGEMOVED, "hedon_istee_screenplay", "notifyDrognuzBark", pDrognuz)
end
...
spatialChat(pDrognuz, "@static_npc/tatooine/hedon_istee:npc_breech_1") --Grunt!
