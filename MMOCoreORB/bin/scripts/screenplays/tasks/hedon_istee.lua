...
--playerObject:addWaypoint("dathomir", "@static_npc/dathomir/dathomir_imperialprison_hedon_istee:waypoint_name_1", "@static_npc/dathomir/dathomir_imperialprison_hedon_istee:waypoint_description_1", hedon_istee_screenplay.loc.prisoner.x, hedon_istee_screenplay.loc.prisoner.y, WAYPOINTBLUE, true, true)
