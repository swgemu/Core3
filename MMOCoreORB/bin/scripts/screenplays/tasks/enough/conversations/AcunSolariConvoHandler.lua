...
function AcunSolariConvoHandler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	elseif (screenID == "response_start") then
		...
		-- Waypoint to Pilot
		local waypointID = ghost:addWaypoint("corellia", "Escape Pod Crash Site", "Escape Pod Crash Site", -5463, 0, -930, WAYPOINT_YELLOW, true, true, EnoughQuest.REBEL_CRC)
		writeScreenPlayData(pPlayer, "EnoughQuest", "PilotWaypointID", waypointID)

		-- Waypoint to quest giver
		waypointID = ghost:addWaypoint("corellia", "Acun Solari", "Acun Solari", -5200, 0, -2575, WAYPOINT_YELLOW, true, true, EnoughQuest.REBEL_CRC)
	...
	elseif (screenID == "help_accept") then
		...
		local waypointID = ghost:addWaypoint("corellia", "Flail Camp", "Flail Camp", -4737, 0, -1519, WAYPOINT_YELLOW, true, true, EnoughQuest.REBEL_CRC)
		writeScreenPlayData(pPlayer, "EnoughQuest", "KilllWaypointID", waypointID)

		-- Waypoint to Binayre Camp
		waypointID = ghost:addWaypoint("talus", "Binayre Camp", "Binayre Camp", -1622, 0, 618, WAYPOINT_YELLOW, true, true, EnoughQuest.REBEL_CRC)
