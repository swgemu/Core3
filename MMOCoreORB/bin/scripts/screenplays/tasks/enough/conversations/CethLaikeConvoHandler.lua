...
function CethLaikeConvoHandler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	elseif (screenID == "response_start") then
		...
		-- Waypoint to Pilot
		local waypointID = ghost:addWaypoint("talus", "Tie Fighter Crash Site", "Tie Fighter Crash Site", -2449, 0, 3843, WAYPOINT_YELLOW, true, true, EnoughQuest.IMPERIAL_CRC)
		writeScreenPlayData(pPlayer, "EnoughQuest", "PilotWaypointID", waypointID)

		-- Waypoint to quest giver
		waypointID = ghost:addWaypoint("talus", "Ceth Laike", "Ceth Laike", -2179, 0, 2273, WAYPOINT_YELLOW, true, true, EnoughQuest.IMPERIAL_CRC)
	...
	elseif (screenID == "help_accept") then
		...
		local waypointID = ghost:addWaypoint("talus", "Binayre Pirate Camp", "Binayre Pirate Camp", -1622, 0, 618, WAYPOINT_YELLOW, true, true, EnoughQuest.IMPERIAL_CRC)
		writeScreenPlayData(pPlayer, "EnoughQuest", "KilllWaypointID", waypointID)

		-- Waypoint to Flail Camp
		waypointID = ghost:addWaypoint("corellia", "Flail Camp", "Flail Camp", -4737, 0, -1519, WAYPOINT_YELLOW, true, true, EnoughQuest.IMPERIAL_CRC)
