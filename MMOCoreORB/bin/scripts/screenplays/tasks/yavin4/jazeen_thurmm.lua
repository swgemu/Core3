	...
	{
		{
			...
			staticObjects =
			{
				{ objectTemplate = "object/static/creature/naboo_kaadu.iff" },
				{ objectTemplate = "object/mobile/dressed_commoner_tatooine_nikto_male_04.iff", objectName = "Surveyor" },
				{ objectTemplate = "object/mobile/dressed_commoner_tatooine_aqualish_female_07.iff", objectName = "Surveyor" },
				{ objectTemplate = "object/mobile/dressed_commoner_tatooine_ishitib_male_02.iff", objectName = "Surveyor" }
			},
			itemSpawns =
			{
