yith_seenath_missions =
	{
		...
		},
		{
			...
			secondarySpawns =
			{
				...
				{ npcTemplate = "swamp_trooper", npcName = "" },
				{ npcTemplate = "swamp_trooper", npcName = "" }
			--^Research guide says "4 escorts" but string-file dialog says "2 of his best men", so i split the difference.
			},
			itemSpawns =
			{
			},
		...
		},
		{
			...
			secondarySpawns =
			{
				...
				{ npcTemplate = "storm_commando", npcName = "" },
				{ npcTemplate = "storm_commando", npcName = "" }
		--TODO: string-file dialog says to "blow up a munitions depot", so can we spawn a 'theater' structure here in
			--basic tp logic format?  Or do i have to write an entirely separate screenplay, like COA or Village style?
			},
			itemSpawns =
			{
			},
