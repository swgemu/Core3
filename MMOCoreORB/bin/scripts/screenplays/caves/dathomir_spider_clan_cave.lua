...
function SpiderClanCaveScreenPlay:spawnMobiles()
        ...
        spawnMobile("dathomir", "spiderclan_web_dancer", 900, 2.7, -63.4, -229.7, -99, 3695708)
          --v Spiders Here v--
        spawnMobile("dathomir", "spiderclan_cavern_spider", 900, -23.0, -65.6, -241.3, 67, 3695708)
        spawnMobile("dathomir", "spiderclan_cavern_spider", 900, -3.1, -65.2, -242.3, 7, 3695708)
        spawnMobile("dathomir", "spiderclan_cavern_spider", 900, 0.4, -63.6, -235.9, -161, 3695708)
        spawnMobile("dathomir", "spiderclan_cavern_spider", 900, -13.3, -63.6, -226.1, 5, 3695708)
        spawnMobile("dathomir", "spiderclan_cavern_spider", 900, -20.8, -65.2, -213.6, 57, 3695708)
        spawnMobile("dathomir", "spiderclan_cavern_spider", 900, -0.6, -65.0, -209.6, -81, 3695708)
          --^ Spiders Here ^--
          
        --Cell[3695709]
        spawnMobile("dathomir", "spiderclan_cavern_spider", 900, -64.8, -70.3, -197.4, 26, 3695709) 
        spawnMobile("dathomir", "spiderclan_web_dancer", 900, -64.5, -69.3, -187.8, 164, 3695709)
        spawnMobile("dathomir", "spiderclan_cavern_spider", 900, -56.4, -70.5, -192.1, -123, 3695709)  
        spawnMobile("dathomir", "spiderclan_web_dancer", 900, -117.9, -69.6, -200.4, 118, 3695709)
        spawnMobile("dathomir", "spiderclan_cavern_spider", 900, -111.1, -69.0, -205.1, -58, 3695709)  
        spawnMobile("dathomir", "spiderclan_cavern_spider", 900, -120.3, -69.0, -167.5, -174, 3695709)
        spawnMobile("dathomir", "spiderclan_web_dancer", 900, -120.4, -69.4, -172.0, 0, 3695709) 
        spawnMobile("dathomir", "spiderclan_cavern_spider", 900, -97.0, -73.7, -167.3, 163, 3695709)
        spawnMobile("dathomir", "spiderclan_web_dancer", 900, -93.5, -73.4, -174.1, -35, 3695709)
        spawnMobile("dathomir", "spiderclan_cavern_spider", 900, -101.1, -71.7, -175.6, 26, 3695709)
