...
function NarglatchCaveScreenPlay:spawnMobiles()
	...
	spawnMobile("naboo", "narglatch", 300,  74.1, -76, -54.4, 240, 5285898)
	...
	spawnMobile("naboo", "narglatch", 300,  56.6, -72, -118.7, 300, 5285900)
	spawnMobile("naboo", "narglatch", 300,  58.8, -72, -121.2, 110, 5285900)
