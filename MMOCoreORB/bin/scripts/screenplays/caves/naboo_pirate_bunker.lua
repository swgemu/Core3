...
function NabooPirateBunkerScreenPlay:spawnMobiles()
	...
	spawnMobile("naboo", "naboo_pirate", 300, math.random(25) + -1540.0, 278, math.random(30) + -1759.7, math.random(360) + 0, 0)
	spawnMobile("naboo", "naboo_gunrunner", 300, math.random(25) + -1540.0, 278, math.random(30) + -1759.7, math.random(360) + 0, 0)
	spawnMobile("naboo", "naboo_pirate", 300, math.random(25) + -1540.0, 278, math.random(30) + -1759.7, math.random(360) + 0, 0)
	spawnMobile("naboo", "naboo_gunrunner", 300, math.random(25) + -1540.0, 278, math.random(30) + -1759.7, math.random(360) + 0, 0)
	spawnMobile("naboo", "naboo_pirate", 300, math.random(25) + -1540.0, 278, math.random(30) + -1759.7, math.random(360) + 0, 0)
	spawnMobile("naboo", "naboo_gunrunner", 300, math.random(25) + -1540.0, 278, math.random(30) + -1759.7, math.random(360) + 0, 0)
	...
	spawnMobile("naboo", "naboo_pirate_crewman", 300, math.random(8) + -1.3, -12.0, math.random(8) + 26.1, math.random(360) + 0, 5535567)
	spawnMobile("naboo", "naboo_pirate_cutthroat", 300, math.random(8) + -1.3, -12.0, math.random(8) + 26.1, math.random(360) + 0, 5535567)
	...
	spawnMobile("naboo", "naboo_pirate_crewman", 300, math.random(44) + 39.5, -16.0, math.random(24) + 58.4, math.random(360) + 0, 5535571)
	spawnMobile("naboo", "naboo_pirate_crewman", 300, math.random(44) + 39.5, -16.0, math.random(24) + 58.4, math.random(360) + 0, 5535571)
	spawnMobile("naboo", "naboo_pirate_cutthroat", 300, math.random(44) + 39.5, -16.0, math.random(24) + 58.4, math.random(360) + 0, 5535571)
	spawnMobile("naboo", "naboo_pirate_cutthroat", 300, math.random(44) + 39.5, -16.0, math.random(24) + 58.4, math.random(360) + 0, 5535571)
	spawnMobile("naboo", "naboo_pirate_cutthroat", 300, math.random(44) + 39.5, -16.0, math.random(24) + 58.4, math.random(360) + 0, 5535571)
	spawnMobile("naboo", "naboo_pirate", 300, math.random(44) + 39.5, -16.0, math.random(24) + 58.4, math.random(360) + 0, 5535571)
	spawnMobile("naboo", "naboo_gunrunner", 300, math.random(44) + 39.5, -16.0, math.random(24) + 58.4, math.random(360) + 0, 5535571)
	spawnMobile("naboo", "naboo_pirate", 300, math.random(44) + 39.5, -16.0, math.random(24) + 58.4, math.random(360) + 0, 5535571)
	spawnMobile("naboo", "naboo_gunrunner", 300, math.random(44) + 39.5, -16.0, math.random(24) + 58.4, math.random(360) + 0, 5535571)
	spawnMobile("naboo", "naboo_pirate", 300, math.random(44) + 39.5, -16.0, math.random(24) + 58.4, math.random(360) + 0, 5535571)

	spawnMobile("naboo", "naboo_pirate", 300, math.random(37) + -15.5, -16.0, math.random(10) + 72.5, math.random(360) + 0, 5535570)
	spawnMobile("naboo", "naboo_gunrunner", 300, math.random(37) + -15.5, -16.0, math.random(10) + 72.5, math.random(360) + 0, 5535570)
	spawnMobile("naboo", "naboo_pirate", 300, math.random(37) + -15.5, -16.0, math.random(10) + 72.5, math.random(360) + 0, 5535570)
	spawnMobile("naboo", "naboo_gunrunner", 300, math.random(37) + -15.5, -16.0, math.random(10) + 72.5, math.random(360) + 0, 5535570)
	spawnMobile("naboo", "naboo_pirate", 300, math.random(37) + -15.5, -16.0, math.random(10) + 72.5, math.random(360) + 0, 5535570)
