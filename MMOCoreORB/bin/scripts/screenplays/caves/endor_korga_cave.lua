...
function EndorKorgaCaveScreenPlay:spawnMobiles()
	...
	spawnMobile("endor", "korga_cub",90,95.3,-45.8,-145.5,-88,733370)
	spawnMobile("endor", "korga_cub",90,94.5,-46.2,-148.2,-53,733370)
	spawnMobile("endor", "korga_cub",90,92.1,-46.1,-149.1,-5,733370)
	spawnMobile("endor", "korga_adept",90,93.4,-46.2,-143.1,-169,733370)
