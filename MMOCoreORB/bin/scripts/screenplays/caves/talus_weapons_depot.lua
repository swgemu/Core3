...
function TalusWeaponsDepotScreenPlay:spawnImperials(pBuilding)
	...
	ObjectManager.withBuildingObject(pBuilding, function(building)
		...
		--2nd floor down
		building:spawnChildCreature("talus", "detention_security_guard", 300, 23.9, -20.0, 115.3, -99, 9686165)
		building:spawnChildCreature("talus", "imperial_probe_drone", 300, 19.5, -20.0, 96.0, 175, 9686164)
		building:spawnChildCreature("talus", "command_security_guard", 300, 18.4, -20.0, 88.2, -90, 9686164)
		building:spawnChildCreature("talus", "rebel_obscureops_agent", 300, 6.8, -20.0, 110.0, -45, 9686165)
		building:spawnChildCreature("talus", "rebel_obscureops_agent", 300, -15.0, -20.0, 115.5, 90, 9686165)
		building:spawnChildCreature("talus", "judge", 300, 1.2, -20.0, 121.0, 1, 9686165)
		building:spawnChildCreature("talus", "twilek_slave", 300, 14.5, -20.0, 126.9, 89, 9686165)
		building:spawnChildCreature("talus", "assault_trooper", 300, 19.2, -20.0, 129.1, 178, 9686165)
		building:spawnChildCreature("talus", "assault_trooper", 300, 12.6, -20.0, 114.7, 88, 9686165)
		building:spawnChildCreature("talus", "comm_operator", 300, 18.1, -20.0, 45.2, 170, 9686163)
		building:spawnChildCreature("talus", "imperial_stealth_operative", 300, 53.0, -20.0, 59.4, -89, 9686166)

		--3rd floor down
		building:spawnChildCreature("talus", "signalman", 300, 39.7, -50.0, 25.2, 88, 9686175)
		building:spawnChildCreature("talus", "assault_trooper", 300, 25.3, -50.0, 31.4, -178, 9686175)
		building:spawnChildCreature("talus", "special_missions_engineer", 300, 30.5, -50.0, 72.9, -91, 9686177)
		building:spawnChildCreature("talus", "droid_corps_junior_technician", 300, -0.5, -50.0, 74.1, -7, 9686178)
...
function TalusWeaponsDepotScreenPlay:spawnRebels(pBuilding)
	...
	ObjectManager.withBuildingObject(pBuilding, function(building)
		...
		--2nd floor down
		building:spawnChildCreature("talus", "area_coordinator", 300, 23.4, -20.0, 115.0, -95, 9686165)
		building:spawnChildCreature("talus", "tamed_razor_cat", 300, 19.5, -20.0, 95.5, 175, 9686164)
		building:spawnChildCreature("talus", "network_leader", 300, 18.2, -20.0, 88.3, -90, 9686164)
		building:spawnChildCreature("talus", "royal_imperial_guard", 300, 7.0, -20.0, 109.5, -45, 9686165)
		building:spawnChildCreature("talus", "royal_imperial_guard", 300, -14.5, -20.0, 115.1, 90, 9686165)
		building:spawnChildCreature("talus", "bounty_hunter", 300, 1.4, -20.0, 120.0, -1, 9686165)
		building:spawnChildCreature("talus", "imperial_stealth_operative", 300, 14.2, -20.0, 126.4, 85, 9686165)
		building:spawnChildCreature("talus", "rebel_commando", 300, 18.8, -20.0, 130.2, 179, 9686165)
		building:spawnChildCreature("talus", "rebel_commando", 300, 12.1, -20.0, 114.9, 85, 9686165)
		building:spawnChildCreature("talus", "rebel_network_leader", 300, 18.3, -20.0, 45.3, 177, 9686163)
		building:spawnChildCreature("talus", "specops_agent", 300, 55.0, -20.0, 59.0, -89, 9686166)

		--3rd floor down
		building:spawnChildCreature("talus", "rebel_master_sergeant", 300, 39.0, -50.0, 25.1, 89, 9686175)
		building:spawnChildCreature("talus", "rebel_commando", 300, 25.5, -50.0, 32.0, -179, 9686175)
		building:spawnChildCreature("talus", "specforce_procurement_specialist", 300, 31.5, -50.0, 73.0, -92, 9686177)
		building:spawnChildCreature("talus", "rebel_crewman", 300, -1.5, -50.0, 73.5, -6, 9686178)
