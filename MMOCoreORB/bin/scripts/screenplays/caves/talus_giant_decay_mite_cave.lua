...
function TalusGiantDecayMiteCaveScreenPlay:spawnMobiles()
	...
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -12.2, -36.1, -137.9, 137, 5625541)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -11.0, -36.6, -142.1, 112, 5625541)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5.6, -38.6, -150.7, -132, 5625541)
