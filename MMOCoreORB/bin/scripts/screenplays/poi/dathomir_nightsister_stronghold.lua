...
function NightSisterStrongholdScreenPlay:clearProtectors(pActiveArea)
	if (pAxkvaMin ~= nil and (AiAgent(pAxkvaMin):isPeaced())) then
		oObj:destroyObjectFromWorld(getCreatureObject(deleteData("NightSisterStrongholdScreenPlay:CreatureID_0" .. i)))
	end
	return 0
end
...
function NightSisterStrongholdScreenPlay:destroy(objectID)
	...
	if (sObj ~= nil) then
		...
		if (oObj ~= nil) then
			oObj:destroyObjectFromWorld(getCreatureObject(deleteData("NightSisterStrongholdScreenPlay:CreatureID_0")))
			oObj:destroyObjectFromWorld(getCreatureObject(deleteData("NightSisterStrongholdScreenPlay:CreatureID_0" .. i)))
