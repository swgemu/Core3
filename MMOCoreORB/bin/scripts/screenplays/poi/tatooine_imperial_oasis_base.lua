...
function TatooineImperialOasisBaseScreenPlay:spawnSceneObjects()
...
function TatooineImperialOasisBaseScreenPlay:spawnMobiles()
	...
	pNpc = spawnMobile("tatooine", "bounty_hunter",60,10.0,-4.0,-1.6,-88,6016537)
	self:setMoodString(pNpc, "npc_sitting_chair")
	...
	--Outside
	pNpc = spawnMobile("tatooine", "bounty_hunter",60,-5285.8,7.2,2714.3,-89,0)
	self:setMoodString(pNpc, "npc_sitting_chair")
