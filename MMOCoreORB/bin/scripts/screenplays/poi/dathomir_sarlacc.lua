...
function DathominrSarlaccScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "mutant_baz_nitch", 240, -2132.8, 26.7, 3280.0, 76, 0)
	spawnMobile("dathomir", "mutant_baz_nitch", 240, -2128.8, 26.8, 3286.6, -176, 0)
	spawnMobile("dathomir", "mutant_baz_nitch", 240, -2124.6, 26.9, 3280.5, 146, 0)
	spawnMobile("dathomir", "mutant_baz_nitch", 240, -1965.2, 42.5, 3208.5, -175, 0)
	spawnMobile("dathomir", "mutant_baz_nitch", 240, -1960.4, 43.1, 3200.5, -106, 0)
	spawnMobile("dathomir", "mutant_baz_nitch", 240, -1967.6, 44.1, 3196.3, -146, 0)
	spawnMobile("dathomir", "mutant_baz_nitch", 240, -1960.7, 44.6, 3190.5, 146, 0)
	spawnMobile("dathomir", "mutant_baz_nitch", 240, -1949.6, 43.9, 3191.5, 46, 0)

	spawnMobile("dathomir", "disturbed_bolma", 240, -1905.1, 48.3, 3151.9, 0, 0)
	spawnMobile("dathomir", "disturbed_bolma", 240, -1898.1, 47.8, 3151.9, 0, 0)
	spawnMobile("dathomir", "disturbed_bolma", 240, -1891.1, 47.3, 3151.9, 0, 0)
	spawnMobile("dathomir", "disturbed_bolma", 240, -2002.2, 21.6, 3057.1, -90, 0)
	spawnMobile("dathomir", "disturbed_bolma", 240, -2002.2, 21.3, 3050.1, -90, 0)
	spawnMobile("dathomir", "disturbed_bolma", 240, -2002.2, 21.0, 3043.1, -90, 0)
	spawnMobile("dathomir", "disturbed_bolma", 240, -2200.4, 28.1, 3132.1, -110, 0)
	spawnMobile("dathomir", "disturbed_bolma", 240, -2208.4, 28.5, 3139.5, -110, 0)

	spawnMobile("dathomir", "nocuous_kamurith", 240, -2140.5, 26.0, 3210.5, 180, 0)
	spawnMobile("dathomir", "nocuous_kamurith", 240, -2159.9, 24.4, 3180.5, 171, 0)
	spawnMobile("dathomir", "nocuous_kamurith", 240, -2113.0, 20.0, 3140.5, -161, 0)
	spawnMobile("dathomir", "nocuous_kamurith", 240, -2002.9, 43.2, 3142.0, 1, 0)
	spawnMobile("dathomir", "nocuous_kamurith", 240, -2171.9, 27.6, 2992.5, -18, 0)
