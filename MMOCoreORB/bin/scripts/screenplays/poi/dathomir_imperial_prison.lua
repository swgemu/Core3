...
function ImperialPrisonScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "crimelord", 300, -4.9, 0.1, -2.4, 16, 5335791)
	spawnMobile("dathomir", "common_thief", 300, -4.2, 0.1, -3.6, -66, 5335791)
	spawnMobile("dathomir", "common_thief", 300, -4.5, 0.1, -4.8, 96, 5335791)
