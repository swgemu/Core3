...
function ImperialPrisonScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "imperial_probe_drone", 180, -5936.1, 131.5, 986.2, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -5932.6, 134.6, 916.6, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -5942.9, 121.7, 831.3, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6001.3, 127.5, 698.4, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6086.3, 132.6, 600.2, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6173.1, 130.3, 546.8, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6292.1, 127.1, 509.3, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6436.6, 195.6, 511.6, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6577.3, 211.6, 565.3, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6781.0, 467.9, 886.7, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6728.0, 432.7, 720.9, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6769.6, 525.8, 1036.8, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6683.9, 469.5, 1204.1, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6582.0, 400.0, 1291.0, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6367.3, 212.6, 1355.1, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6265.7, 150.0, 1344.9, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6107.0, 112.3, 1273.3, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6002.5, 155.3, 1162.9, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -6067.7, 133.7, 752.1, 45, 0)
	spawnMobile("dathomir", "imperial_probe_drone", 180, -5961.9, 124.7, 1084.6, 45, 0)
	...
	spawnMobile("dathomir", "pirate", 30, -6276.5, 119.9, 897.4, -140, 0)
	spawnMobile("dathomir", "crimelord", 30, -6306.5, 119.9, 905.4, 140, 0)
	spawnMobile("dathomir", "common_thief", 30, -6297.6, 119.9, 874.6, -100, 0)
	spawnMobile("dathomir", "thug", 30, -6302.5, 119.9, 872.4, 60, 0)
	spawnMobile("dathomir", "thug", 30, -6299.5, 119.9, 877.7, 160, 0)
	spawnMobile("dathomir", "crimelord", 30, -6319.5, 119.9, 873.4, -140, 0)
	spawnMobile("dathomir", "thug", 30, -6339.5, 119.9, 877.4, 40, 0)
	spawnMobile("dathomir", "common_thief", 30, -6357.5, 119.9, 853.4, -21, 0)
	spawnMobile("dathomir", "thug", 30, -6419.8, 129.5, 883.9, -62, 0)

	spawnMobile("dathomir", "common_thief", 30, -6190.2, 119.9, 992.6, -126, 0)
	spawnMobile("dathomir", "pirate_privateer", 30, -6201.2, 119.9, 993.6, 176, 0)
	spawnMobile("dathomir", "thug", 30, -6186.2, 119.9, 954.2, 166, 0)
	spawnMobile("dathomir", "crimelord", 30, -6258.5, 119.9, 1006.6, -126, 0)
	spawnMobile("dathomir", "thug", 30, -6325.2, 119.9, 958.6, -16, 0)
	spawnMobile("dathomir", "common_thief", 30, -6463.7, 119.9, 992.6, 136, 0)
	spawnMobile("dathomir", "thug", 30, -6429.2, 119.9, 1001.6, 86, 0)
	spawnMobile("dathomir", "pirate_privateer", 30, -6414.3, 119.9, 1042.4, -156, 0)
	spawnMobile("dathomir", "crimelord", 30, -6415.7, 119.9, 1039.3, 24, 0)
	spawnMobile("dathomir", "thug", 30, -6427.9, 119.9, 920.6, 100, 0)
	...
	spawnMobile("dathomir", "thug", 30, -4.5, 0.1, -1.2, 166, 5335770)

	spawnMobile("dathomir", "commoner_old", 30, -4.5, 0.1, -1.2, 166, 5335777)
	spawnMobile("dathomir", "crimelord", 30, -4.9, 0.1, -2.4, 16, 5335777)
	spawnMobile("dathomir", "common_thief", 30, -4.2, 0.1, -3.6, -66, 5335777)
	spawnMobile("dathomir", "common_thief", 30, -4.5, 0.1, -4.8, 96, 5335777)
	...
	spawnMobile("dathomir", "imprisoned_jabba_employee", 30, 4.5, 0.1, -2.2, 40, 5335804)
	spawnMobile("dathomir", "crimelord", 30, 4.5, 0.1, -3.6, 180, 5335804)
	spawnMobile("dathomir", "commoner_old", 30, 3.0, 0.1, -5.6, -60, 5335804)

	spawnMobile("dathomir", "thug", 30, -4.5, 0.1, -1.2, 166, 5335819)
	spawnMobile("dathomir", "thug", 30, -4.9, 0.1, -2.4, 16, 5335819)
	spawnMobile("dathomir", "thug", 30, -4.2, 0.1, -3.6, -66, 5335819)
	spawnMobile("dathomir", "thug", 30, -4.5, 0.1, -4.8, 96, 5335819)
	spawnMobile("dathomir", "pirate", 30, 4.5, 0.1, -2.2, 0, 5335818)
	spawnMobile("dathomir", "pirate", 30, 4.5, 0.1, -3.6, 90, 5335818)
	spawnMobile("dathomir", "pirate", 30, 3.0, 0.1, -5.6, -60, 5335818)
	spawnMobile("dathomir", "pirate_privateer", 30, 3.8, 0.1, 1.5, 0, 5335817)
	...
	spawnMobile("dathomir", "gaping_spider_broodling", 240, -6.8, -48.5, -182.7, -33, 2635357)
	spawnMobile("dathomir", "gaping_spider_broodling", 240, -4.3, -48.3, -181.5, -43, 2635357)
	spawnMobile("dathomir", "gaping_spider_broodling", 240, -1.3, -48.4, -180.6, 133, 2635357)
	spawnMobile("dathomir", "gaping_spider_broodling", 240, -1.3, -48.9, -177.2, 73, 2635357)
	spawnMobile("dathomir", "gaping_spider_broodling", 240, -4.6, -48.6, -174.8, -13, 2635357)
	spawnMobile("dathomir", "gaping_spider_broodling", 240, 9.6, -50.6, -158.3, -167, 2635357)
	spawnMobile("dathomir", "gaping_spider_broodling", 240, 12.0, -51.0, -163.3, -133, 2635357)
	...
	spawnMobile("dathomir", "gaping_spider_broodling", 240, 62.3, -80.9, -229.7, -83, 2635363)
	spawnMobile("dathomir", "gaping_spider_broodling", 240, 63.5, -81.9, -234.1, -83, 2635363)
	spawnMobile("dathomir", "gaping_spider_broodling", 240, 59.8, -81.9, -238.3, -23, 2635363)
	spawnMobile("dathomir", "gaping_spider_broodling", 240, 51.9, -79.5, -249.4, -43, 2635363)
	spawnMobile("dathomir", "gaping_spider_broodling", 240, 42.5, -79.3, -250.8, -23, 2635363)
