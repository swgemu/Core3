...
function EndorEwokTreeVillage01ScreenPlay:spawnMobiles()
	...
	--spawnMobile("endor", "ewok_outcast",10,76,9,37,114,0)
	--spawnMobile("endor", "ewok_outcast",T,Z,X,Y,D,C)
	--T = Respawn Time
	--Z = Cords
	--X = Cords
	--Y = Cords
	--D = Direction The NPC looks
	--C = CellID not sure exactly how it works, but I do know its for inside buidlings.(0 = outside)
	--Test
	--spawnMobile("endor", "panshee_tribesman",10,62,9,20,-45,0)--North-West ( -45 )
	--spawnMobile("endor", "ewok_outcast",10,48,9,33,1,0)--North ( 1 )
	--spawnMobile("endor", "panshee_tribesman",10,42,9,35,45,0)--North-East ( 45 )
	--spawnMobile("endor", "ewok_outcast",10,52,9,32,90,0)--East ( 90 )
	--spawnMobile("endor", "panshee_tribesman",10,52,9,27,135,0)--South-East ( 135 )
	--spawnMobile("endor", "ewok_outcast",10,47,9,25,180,0)--South ( 180 )
	--spawnMobile("endor", "panshee_tribesman",10,62,9,27,-135,0)--South-West ( -135 )
	--spawnMobile("endor", "ewok_outcast",10,62,9,32,-90,0)--West ( -90 )
