...
function RoriPoacherVsCreatureBattleScreenPlay:spawnMobiles()
	...
	spawnMobile("rori", "poacher", 120, 773.7, 82.0, -2091.8, -45, 0)
	spawnMobile("rori", "poacher", 120, 776.3, 81.7, -2086.6, -99, 0)
	spawnMobile("rori", "poacher", 120, 768.3, 82.2, -2091.5, 50, 0)
	spawnMobile("rori", "poacher", 120, 773.5, 81.9, -2086.1, 155, 0)
	spawnMobile("rori", "poacher", 120, 772.3, 81.8, -2090.0, 42, 0)
	spawnMobile("rori", "hunter", 120, 751.3, 84.9, -2092.7, -24, 0)
	spawnMobile("rori", "hunter", 120, 752.9, 84.7, -2089.8, -24, 0)
	spawnMobile("rori", "hunter", 120, 753.4, 89.5, -2061.8, -90, 0)
	spawnMobile("rori", "hunter", 120, 752.9, 89.8, -2059.2, -90, 0)
	spawnMobile("rori", "poacher", 120, 764.8, 85.7, -2044.5, 65, 0)
	spawnMobile("rori", "poacher", 120, 764.2, 85.4, -2041.5, 72, 0)
	spawnMobile("rori", "poacher", 120, 805.9, 85.4, -2065.8, -45, 0)
	spawnMobile("rori", "poacher", 120, 809.5, 84.6, -2061.6, -55, 0)

	spawnMobile("rori", "potbellied_vrobal", 90, 779.7, 83.1, -2055.5, -160, 0)
	spawnMobile("rori", "potbellied_vrobal", 90, 779.9, 82.3, -2061.2, -160, 0)
	spawnMobile("rori", "potbellied_vrobal", 90, 783.9, 81.8, -2058.1, -160, 0)
	spawnMobile("rori", "potbellied_vrobal", 90, 785.5, 81.3, -2063.0, -160, 0)

	spawnMobile("rori", "vrobal_bull", 120, 745.8, 89.1, -2037.6, 140, 0)
	spawnMobile("rori", "vrobal_sow", 120, 743.5, 89.6, -2040.4, 140, 0)
	spawnMobile("rori", "vrobal_sow", 120, 738.5, 90.6, -2040.8, 140, 0)
	spawnMobile("rori", "vrobal_bull", 120, 739.1, 89.7, -2065.2, 130, 0)
	spawnMobile("rori", "vrobal_bull", 120, 738.4, 89.0, -2073.2, 130, 0)
	spawnMobile("rori", "vrobal_bull", 120, 756.6, 86.9, -2073.0, 117, 0)
	spawnMobile("rori", "vrobal_bull", 120, 757.1, 85.5, -2078.0, 117, 0)

	spawnMobile("rori", "leviasquall", 120, 796.9, 78.3, -2031.4, 173, 0)
	spawnMobile("rori", "leviasquall", 120, 792.2, 78.5, -2031.3, -168, 0)
	spawnMobile("rori", "leviasquall", 120, 741.1, 87.0, -2092.2, 68, 0)
	spawnMobile("rori", "leviasquall", 120, 744.5, 86.7, -2085.3, 68, 0)


	local pHunter = spawnMobile("rori", "hunter", 90, 768.3, 82.5, -2085.6, -44, 0)
	createObserver(OBJECTDESTRUCTION, "RoriPoacherVsCreatureBattleScreenPlay", "notifyHunterDead", pHunter)

	local pLeviasquall = spawnMobile("rori", "leviasquall", 120, 794.5, 78.5, -2033.9, -177, 0)
	createObserver(OBJECTDESTRUCTION, "RoriPoacherVsCreatureBattleScreenPlay", "notifyLeviasquallDead", pLeviasquall)

	local pProwler = spawnMobile("rori", "kai_tok_prowler", 120, 801.5, 86.4, -2080.0, -49, 0)
	createObserver(OBJECTDESTRUCTION, "RoriPoacherVsCreatureBattleScreenPlay", "notifyProwlerDead", pProwler)

	local pBull = spawnMobile("rori", "vrobal_bull", 120, 779.5, 82.2, -2066.0, -160, 0)
