...
ImperialVsGunganScreenPlay = ScreenPlay:new {
	...
	gunganMobiles = {
		{ "gungan_priest", 420, 4760.9, 13.7, -3894.2, 11 },
		{ "gungan_boss", 300, 4763.8, 28.2, -3929.1, 0 },
		{ "rebel_gungan_captain", 300, 4764.3, 28.2, -3922.5, -90 },
		{ "gungan_general", 300, 4755.2, 28.2, -3925.0, 0 },
		{ "rebel_gungan_captain", 300, 4757.7, 28.2, -3929.1, 0 },
		{ "rebel_gungan_war_chief", 300, 4755.2, 28.2, -3922.5, 180 },
		{ "gungan_guard", 300, 4767.2, 13.9, -3898.5, -90 },
		{ "gungan_guard", 300, 4751.1, 13.9, -3898.5, 90 },
		{ "gungan_war_chief", 300, 4750.8, 13.9, -3906.6, 0 },
		{ "rebel_gungan_war_chief", 300, 4767.1, 14.0, -3903.5, 0 },
		{ "gungan_kaadu_rider", 300, 4786.8, 14.7, -3924.9, 0 },
		{ "gungan_kaadu_rider", 300, 4789.3, 14.4, -3937.6, 0 },
		...
		{ "gungan_bomber", 300, 4729.9, 13.2, -3914.7, 0 },
		{ "gungan_falumpaset", 300, 4727.5, 13.2, -3917.2, 0 },

		{ "gungan_priest", 300, 4730.8, 12.8, -3897.9, 20 },
		{ "gungan_priest", 300, 4751.0, 12.8, -3887.1, 2 },
		{ "gungan_grand_army_soldier", 300, 4766.8, 13.6, -3886.4, 0 },
		{ "gungan_grand_army_soldier", 300, 4753.0, 12.5, -3874.9, 10 },
		{ "gungan_grand_army_soldier", 300, 4780.4, 13.5, -3876.3, 0 },
		{ "gungan_grand_army_soldier", 300, 4791.8, 13.6, -3876.4, 0 },

		{ "gungan_scout", 300, 4727.9, 10.4, -3852.1, 44 },
		{ "gungan_scout", 300, 4811.4, 13.2, -3867.5, -34 },
		{ "gungan_scout", 300, 4802.3, 14.5, -3893.8, -24 },
		{ "gungan_bomber", 300, 4743.6, 12.2, -3876.0, 10 },
		{ "gungan_bomber", 300, 4761.9, 12.7, -3873.5, 15 },
		{ "gungan_guard", 300, 4772.4, 13.1, -3875.1, 13 }
	},
...
function ImperialVsGunganScreenPlay:spawnMobiles()
	...
	for i = 1, table.getn(mobileTable), 1 do
		...
		TangibleObject(pMobile):setFaction(FACTIONREBEL)
	end
