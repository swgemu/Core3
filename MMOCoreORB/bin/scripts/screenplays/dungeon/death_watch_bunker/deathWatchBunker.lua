...
DeathWatchBunkerScreenPlay = ScreenPlay:new {
	...
	mineCells = {
		5996352, 5996353, 5996354, 5996356, 5996357, 5996358, 5996359, 5996360, 5996361, 5996362,
...
function DeathWatchBunkerScreenPlay:spawnObjects()
	...
	local spawn = deathWatchSpecialSpawns["droidengineerdroid"]
	spawnedPointer = spawnMobile("endor", spawn[1], spawn[2], spawn[3], spawn[4], spawn[5], spawn[6], spawn[7])
	spawnedSceneObject:_setObject(spawnedPointer)
	spawnedSceneObject:setCustomObjectName("Crafting Droid")
	spawnedSceneObject:setContainerComponent("deathWatchCraftingDroid")
	...
	local droid = spawnedSceneObject:getObjectID()
	...
	local spawn = deathWatchSpecialSpawns["tailordroid"]
	spawnedPointer = spawnMobile("endor", spawn[1], spawn[2], spawn[3], spawn[4], spawn[5], spawn[6], spawn[7])
	spawnedSceneObject:_setObject(spawnedPointer)
	spawnedSceneObject:setCustomObjectName("Crafting Droid")
	spawnedSceneObject:setContainerComponent("deathWatchCraftingDroid")
	...
	local spawn = deathWatchSpecialSpawns["jetpackdroid"]
	spawnedPointer = spawnMobile("endor", spawn[1], spawn[2], spawn[3], spawn[4], spawn[5], spawn[6], spawn[7])
	spawnedSceneObject:_setObject(spawnedPointer)
...
function DeathWatchBunkerScreenPlay:spawnNextC(creatureObject)
	...
	elseif nextSpawn == 2 then
		...
		spawnMobile("endor", spawn[1], spawn[2], spawn[3], spawn[4], spawn[5], spawn[6], spawn[7])
		local spawn = deathWatchSpecialSpawns["fenri_dalso_add2"]
		spawnMobile("endor", spawn[1], spawn[2], spawn[3], spawn[4], spawn[5], spawn[6], spawn[7])
		local spawn = deathWatchSpecialSpawns["fenri_dalso_add3"]
		spawnMobile("endor", spawn[1], spawn[2], spawn[3], spawn[4], spawn[5], spawn[6], spawn[7])
		local spawn = deathWatchSpecialSpawns["fenri_dalso_add4"]
		spawnMobile("endor", spawn[1], spawn[2], spawn[3], spawn[4], spawn[5], spawn[6], spawn[7])
		local spawn = deathWatchSpecialSpawns["fenri_dalso"]
		spawnMobile("endor", spawn[1], spawn[2], spawn[3], spawn[4], spawn[5], spawn[6], spawn[7])
	end
end
...
function DeathWatchBunkerScreenPlay:hasRebreather(pSceneObject)
	...
	local headObject = LuaSceneObject(pRebreather)
	local headSlot = headObject:getTemplateObjectPath()

	if (headSlot == self.bunkerItems.mandoRebreather) then
		return rebreather:getCustomObjectName() == "Advanced Rebreather"
...
function DeathWatchBunkerScreenPlay:spawnDefenders(number, pCreature)
	...
	if number == 1 then
		...
		local spawn = deathWatchSpecialSpawns["entrance2"]
