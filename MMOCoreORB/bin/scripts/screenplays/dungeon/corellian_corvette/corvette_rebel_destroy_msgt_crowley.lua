...
crowleyCompensation = { { compType = "credits", amount = 500 } }

crowley = { planetName = "corellia", npcTemplate = "crowley", x = -3404.73, z = 86, y = 3092.64, direction = 323, cellID = 0, position = STAND }
