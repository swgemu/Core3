...
function CorellianCorvetteScreenPlay:spawnSceneObjects(pCorvette)
	...
	ObjectManager.withBuildingObject(pCorvette, function(corvette)
		...
		for i = 1, #self.escapeTerminals, 1 do
			...
			local spawnedPointer = spawnSceneObject("dungeon1", "object/tangible/terminal/terminal_geo_bunker.iff", escTerm.x, escTerm.z, escTerm.y, cellId, escTerm.dw, escTerm.dx, escTerm.dy, escTerm.dz)
	...
	ObjectManager.withBuildingObject(pCorvette, function(corvette)
		if faction == "rebel" then
			for i,v in ipairs(rebelStaticSpawns) do
				...
				cellId = SceneObject(corvette:getNamedCell(v[7])):getObjectID()
