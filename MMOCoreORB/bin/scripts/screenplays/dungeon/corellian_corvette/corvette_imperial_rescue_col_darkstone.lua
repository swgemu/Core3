...
darkstoneCompensation = { { compType = "credits", amount = 500 } }

darkstone = { planetName = "tatooine", npcTemplate = "colonel_darkstone", x = -5313 , z = 8.4, y = 2662, direction = -175, cellID = 0, position = STAND, mood = "npc_imperial"}
