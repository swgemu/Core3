...
function geonosian_lab_screenplay:spawnMobiles()
	...
	spawnMobile("yavin4", "cavern_spider",210,85,-33.9,-348.1,46,1627823)
	spawnMobile("yavin4", "cavern_spider",210,90.2,-34,-312.3,-180,1627823)
	...
	spawnMobile("yavin4", "enhanced_kwi",210,102.3,-33.7,-310.8,-156,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",210,26,-31.5,-78,170,1627798)
	spawnMobile("yavin4", "enhanced_kliknik",210,98.7,-33.4,-344.9,-37,1627823)
	spawnMobile("yavin4", "enhanced_kliknik",210,85.6,-34.2,-310.4,150,1627823)
	...
	spawnMobile("yavin4", "enhanced_kliknik",210,-153.6,-34.2,-372,60,1627818)
	spawnMobile("yavin4", "enhanced_kliknik",210,-87,-34.1,-386.5,210,1627819)
	spawnMobile("yavin4", "enhanced_force_kliknik",210,-127.6,-34.5,-324.3,-30,1627817)
	spawnMobile("yavin4", "enhanced_force_kliknik",210,-143.8,-33.7,-326.1,63,1627817)
	spawnMobile("yavin4", "enhanced_force_kliknik",210,-125,-34,-375.6,-30,1627818)
	spawnMobile("yavin4", "enhanced_force_kliknik",210,-71.5,-34,-348.1,-95,1627819)
	spawnMobile("yavin4", "enhanced_force_kliknik",210,-54.5,-33.3,-373.4,-60,1627819)
