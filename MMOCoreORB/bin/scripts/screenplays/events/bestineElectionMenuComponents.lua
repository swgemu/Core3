...
function BestineElectionTerminalMenuComponent:fillObjectMenuResponse(pSceneObject, pMenuResponse, pPlayer)
	...
	--ScreenPlayData(conversingPlayer,"BestineElection", "questn_term_searched")
	--ScreenPlayData(conversingPlayer,"BestineElection", "questp_term_searched")
	--ScreenPlayData(conversingPlayer,"BestineElection", "questn_desk_searched")
	--ScreenPlayData(conversingPlayer,"BestineElection", "questp_desk_searched")
