...
function StoneMerchantConvoHandler:runScreenHandlers(conversationTemplate, conversingPlayer, conversingNPC, selectedOption, conversationScreen)
	...
	elseif (screenID == "may_have_stones") then
		if StoneMerchantConvoHandler:SearchforStones(conversingPlayer, CARVED) then
		...
		if StoneMerchantConvoHandler:SearchforStones(conversingPlayer, SMOOTH) then
	...
	elseif (screenID == "have_more_stones") then
		if StoneMerchantConvoHandler:SearchforStones(conversingPlayer, CARVED) then
	...
	elseif (screenID == "give_smooth_stone") then
		StoneMerchantConvoHandler:giveReward(conversingPlayer, SMOOTH)
	elseif (screenID == "give_carved_stone") then
		StoneMerchantConvoHandler:giveReward(conversingPlayer, CARVED)
	end
