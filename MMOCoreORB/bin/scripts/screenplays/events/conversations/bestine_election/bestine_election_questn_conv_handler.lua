	...
	elseif (screenID == "convo_start_give") then
		...
		elseif (screenID == "noroom_returned") then
			if (questID == "capitol") then
				...
				clonedConversation:addOption("@conversation/victor_questn_capitol:s_da9a29e9","noroom_returned_reply")
			elseif (questID == "cantina") then
				if BestineElectionScreenPlay:hasFullInventory(pPlayer) then
				...
				clonedConversation:addOption("@conversation/victor_questn_cantina:s_62bf3631","noroom_returned_reply")
			end
		end
	end
	return pConvScreen
