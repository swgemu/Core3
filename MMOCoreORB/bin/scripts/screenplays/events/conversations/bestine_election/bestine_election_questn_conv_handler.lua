...
function BestineElectionQuestnConvoHandler:getInitialScreen(pPlayer, pNpc, pConversationTemplate)
	...
	elseif (string.find(objectName,"victor") ~= nil and seanTrenwellConvoHandler:seanNegQuest(pPlayer)) or (string.find(objectName,"sean") ~= nil and victorVisalisConvoHandler:victorNegQuest(pPlayer)) then
