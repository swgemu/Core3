...
function BestineElectionQuestpConvoHandler:getInitialScreen(pPlayer, pNpc, pConversationTemplate)
	...
	elseif (pNpcName == "Sean Trenwell" and not seanTrenwellConvoHandler:seanNegQuest(pPlayer)) or (pNpcName == "Victor Visalis" and not victorVisalisConvoHandler:victorNegQuest(pPlayer)) then
