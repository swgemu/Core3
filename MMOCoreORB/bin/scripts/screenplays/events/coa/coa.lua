...
function CriesOfAlderaan:setState(pPlayer, stateName, val)
	--print("CriesOfAlderaan:setState - " .. stateName .. " Value = " .. val)
...
function CriesOfAlderaan:determineWinningFaction()
	...
	if ((checkTime + checkDelay) > time) then
		...
		Logger:log("CriesofAlderaan:determinewinningFfaction -- rescheduled in " .. timeDiff .. " seconds", LT_INFO)
	...
	Logger:log("CriesofAlderaan:determinewinningFfaction -- Set Winning Faction " .. winningFaction, LT_INFO)
