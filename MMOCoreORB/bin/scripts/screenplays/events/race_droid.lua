...
function raceDroidEventPerk:createNextRacePoint(pPlayer, pNpc)
	...
	local waypointID = PlayerObject(pGhost):addWaypoint(SceneObject(pPlayer):getZoneName(), "@event_perk:racing_waypoint_name", "@theme_park/racing/racing:waypoint_desc_1", nextPoint[1], 0, nextPoint[2], WAYPOINT_BLUE, true, true, WAYPOINTRACETRACK, 0)
