...
function buffTerminalMenuComponent:handleObjectMenuSelect(pSceneObject, pPlayer, selectedID)
	...
	if selectedID == 20 then
		--enhanceCharacter(pPlayer, medicalBuff, medicalDuration, performanceBuff, performanceSecondaryBuff, performanceDuation, resistanceBuff, resistanceDuration, absorption)
		CreatureObject(pPlayer):enhanceCharacter(pPlayer, 2400, 7200, 1200, 800, 7200, 225, 2700, 10)
