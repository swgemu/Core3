...
{
	{
		...
		secondarySpawns =
		{
			{ npcTemplate = "imperial_trooper", planetName = "dathomir", npcName = "Prison Guard" },
			{ npcTemplate = "imperial_trooper", planetName = "dathomir", npcName = "Prison Guard" }
		},
		itemSpawns =
		{
...
{
	{
		...
		primarySpawns =
		{
			{ npcTemplate = "nightsister_initiate", planetName = "dathomir", npcName = "Daverda" }
		},
		secondarySpawns =
		{
	...
	},
	{
		...
		primarySpawns =
		{
			{ npcTemplate = "singing_mountain_clan_huntress_quest", planetName = "dathomir", npcName = "" }
		},
		secondarySpawns =
		{
...
{
	{
		...
		primarySpawns =
		{
			{ npcTemplate = "gaping_spider_queen_quest", planetName = "dathomir", npcName = "" }
		},
		secondarySpawns =
		{
	...
	},
	{
		...
		primarySpawns =
		{
			{ npcTemplate = "malkloc_quest", planetName = "dathomir", npcName = "" }
		},
		secondarySpawns =
		{
	...
	},
	{
		...
		primarySpawns =
		{
			{ npcTemplate = "theme_park_imperial_stealth_operative", planetName = "dathomir", npcName = "a Coerced Guard" }
		},
		secondarySpawns =
		{
...
{
	{
		...
		primarySpawns =
		{
			{ npcTemplate = "nightsister_slave_quest", planetName = "dathomir", npcName = "Dal" }
		},
		secondarySpawns =
		{
	...
	},
	{
		...
		primarySpawns =
		{
			{ npcTemplate = "singing_mountain_clan_arch_witch_quest", planetName = "dathomir", npcName = "Chastina" }
		},
		secondarySpawns =
		{
...
npcMapNightsister =
{
	...
	{
		spawnData = { planetName = "dathomir", npcTemplate = "fath_hray", x = -4118.7, z = 137.7, y = -157.0, direction = 15, cellID = 189384, position = STAND },
		npcNumber = 2,
		stfFile = "@static_npc/dathomir/dathomir_nightsisterstronghold_fath_hray",
		missions = fath_hray_missions
	},
	{
		spawnData = { planetName = "dathomir", npcTemplate = "diax", x = -4119.4, z = 137.7, y = -144.5, direction = 140, cellID = 189384, position = STAND },
		npcNumber = 4,
		stfFile = "@static_npc/dathomir/diax",
		missions = diax_missions
	},
	{
		spawnData = { planetName = "dathomir", npcTemplate = "kais", x = -4084.7, z = 137.7, y = -156.6, direction = -82, cellID = 189382, position = STAND },
		npcNumber = 8,
		stfFile = "@static_npc/dathomir/kais",
		missions = kais_missions
	},
	{
		spawnData = { planetName = "dathomir", npcTemplate = "gethzerion", x = -4088.3, z = 137.7, y = -135.5, direction = -145, cellID = 189383, position = STAND },
		npcNumber = 16,
