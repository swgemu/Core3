...
thrown_missions =
{
	...
	{ 
		...
		primarySpawns = 
		{ 
			{ npcTemplate = "theme_park_imperial_escort", planetName = "naboo", npcName = "a Seller" } 
		}, 
		secondarySpawns = {}, 
		itemSpawns = 
		{ 
			{ itemTemplate = "object/tangible/component/item/large_sensor_package.iff", itemName = "a Painting Brush" }
		},	
			rewards = 
		{ 
...
veers_missions =
{
	...
	{ 
		...
		primarySpawns = 
		{ 
			{ npcTemplate = "theme_park_imperial_escort", planetName = "naboo", npcName = "a Thug" }
		}, 
		secondarySpawns = {}, 
		itemSpawns = 
		{ 
			{ itemTemplate = "object/tangible/component/item/large_sensor_package.iff", itemName = "a Manifest" }
		},	
			rewards = 
		{ 
...
palpatine_missions =
{
	...
	{ 
		...
		primarySpawns = 
		{ 
			{ npcTemplate = "theme_park_imperial_escort", planetName = "naboo", npcName = "a Handmaiden" } 
		}, 
		secondarySpawns =
     		{
		}, 
