SmuggleConversationHandler = Object:new {
}

function SmuggleConversationHandler:runScreenHandlers(pConversationTemplate, pConversingPlayer, pConversingNPC, selectedOption, pConversationScreen)
...
function SmuggleConversationHandler:getInitialScreen(pPlayer, pNpc, pConversationTemplate)
...
function SmuggleConversationHandler:getNextConversationScreen(pConversationTemplate, pPlayer, selectedOption, pConversingNpc)
	local player = LuaCreatureObject(pPlayer)
