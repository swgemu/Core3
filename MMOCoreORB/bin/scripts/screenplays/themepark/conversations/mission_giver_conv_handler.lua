...
function mission_giver_conv_handler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	elseif screenID == "npc_quit" then
		pConvScreen = self:handleScreenNpcQuit(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	end
...
function mission_giver_conv_handler:handleScreenNpcQuit(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	self.themePark:resetCurrentMission(pPlayer)
