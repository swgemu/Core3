...
function TalusStaticSpawnsSouthScreenPlay:spawnMobiles()
	...
	spawnMobile("talus", "frenzied_fynock_guardian", 240, -2446.4, 35.2, -2206.6, 145, 0)
	spawnMobile("talus", "frenzied_fynock_guardian", 240, -2445.0, 34.2, -2233.7, 54, 0)
	spawnMobile("talus", "frenzied_fynock_guardian", 240, -2429.7, 36.8, -2246.8, -5, 0)
	spawnMobile("talus", "fynock", 240, -2415.8, 33.9, -2229.6, -75, 0)
	spawnMobile("talus", "jungle_fynock", 240, -2427.2, 35.0, -2208.3, -129, 0)
	spawnMobile("talus", "frenzied_fynock_guardian", 240, -2442.0, 35.3, -2199.7, 165, 0)
	spawnMobile("talus", "jungle_fynock", 240, -2445.3, 35.2, -2207.2, 130, 0)
	spawnMobile("talus", "clipped_fynock", 240, -2445.7, 35.0, -2213.1, -90, 0)
	spawnMobile("talus", "clipped_fynock", 240, -2446.1, 34.8, -2219.8, 178, 0)
	spawnMobile("talus", "fynock", 240, -2450.7, 34.8, -2221.4, -109, 0)
	spawnMobile("talus", "fynock", 240, -2450.5, 35.0, -2214.9, 102, 0)
	spawnMobile("talus", "jungle_fynock", 240, -2436.7, 34.2, -2234.0, 33, 0)
	spawnMobile("talus", "clipped_fynock", 240, -2436.8, 34.8, -2242.5, -169, 0)
	spawnMobile("talus", "jungle_fynock", 240, -2430.2, 34.2, -2240.9, 73, 0)
	...
	spawnMobile("talus", "sleemo_scamp", 240, -488.0, 40.3, -2074.6, 10, 0)
	spawnMobile("talus", "sleemo_vandal", 240, -486.7, 40.1, -2070.6, 90, 0)
