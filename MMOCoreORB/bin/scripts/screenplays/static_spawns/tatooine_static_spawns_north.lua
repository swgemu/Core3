...
function TatooineStaticSpawnsNorthScreenPlay:spawnMobiles()
	...
	spawnMobile("tatooine", "bounty_hunter", 1, 7039.7, 71.4, 7045.3, 145, 0)
	spawnMobile("tatooine", "bounty_hunter", 1, 7047.8, 70.6, 7042.2, -90, 0)
	spawnMobile("tatooine", "bounty_hunter", 1, 7039.3, 70.6, 7036.1, -160, 0)
