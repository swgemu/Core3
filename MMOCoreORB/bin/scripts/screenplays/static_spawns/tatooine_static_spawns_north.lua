...
function TatooineStaticSpawnsNorthScreenPlay:spawnMobiles()
	...
	spawnMobile("tatooine", "bounty_hunter_thug", 1, 7039.7, 71.4, 7045.3, 145, 0)
	spawnMobile("tatooine", "bounty_hunter_thug", 1, 7047.8, 70.6, 7042.2, -90, 0)
	spawnMobile("tatooine", "bounty_hunter_thug", 1, 7039.3, 70.6, 7036.1, -160, 0)
	...
	--Burried Building + Flag (-2041,2593)

	--Burried Walls & Tents (-2294,2936)
	...
	spawnMobile("tatooine", "pirate_privateer", 300, math.random(13) + -4959, 9.7, math.random(18) + 1265, math.random(360), 0)
	spawnMobile("tatooine", "pirate_privateer", 300, math.random(13) + -4959, 9.7, math.random(18) + 1265, math.random(360), 0)
	spawnMobile("tatooine", "pirate_privateer", 300, math.random(13) + -4959, 9.7, math.random(18) + 1265, math.random(360), 0)
	spawnMobile("tatooine", "pirate_privateer", 300, math.random(13) + -4959, 9.7, math.random(18) + 1265, math.random(360), 0)
