...
function TalusStaticSpawnsNorthScreenPlay:spawnMobiles()
	...
	spawnMobile("talus", "stormtrooper_squad_leader", 360, -2416.3, 28.3, 2034.3, 180, 0)
	...
	spawnMobile("talus", "aakuan_warder", 240, -1838.7, 7.5, 1437.7, 115, 0)
	spawnMobile("talus", "aakuan_keeper", 240, -1825.0, 8.9, 1425.7, 122, 0)
	spawnMobile("talus", "aakuan_keeper", 240, -1824.4, 7.9, 1442.6, 0, 0)

	--Bridge (-150,323)

	--Dath Tree (-695,156)
	spawnMobile("talus", "foaming_vynock", 240, -687.8, 44.3, 170.1, 45, 0)
	spawnMobile("talus", "foaming_vynock", 240, -699.9, 43.6, 174.7, -70, 0)
	spawnMobile("talus", "foaming_vynock", 240, -712.1, 42.7, 169.4, -60, 0)
	spawnMobile("talus", "foaming_vynock", 240, -714.6, 42.5, 152.3, 140, 0)
	spawnMobile("talus", "foaming_vynock", 240, -705.1, 43.2, 142.1, 60, 0)
	spawnMobile("talus", "foaming_vynock", 240, -690.8, 44.2, 141.7, 70, 0)
	spawnMobile("talus", "foaming_vynock", 240, -678.8, 44.8, 150.9, 30, 0)
	spawnMobile("talus", "foaming_vynock", 240, -680.9, 44.7, 160.6, 180, 0)
	spawnMobile("talus", "foaming_vynock", 240, -694.2, 43.9, 153.6, -130, 0)
	spawnMobile("talus", "foaming_vynock", 240, -705.8, 43.2, 155.6, -177, 0)
	spawnMobile("talus", "foaming_vynock", 240, -697.8, 43.7, 166.6, 108, 0)

	--Probe Droid (-2599,101)
	spawnMobile("talus", "rebel_commando", 240, -2601.8, 47.9, 101.0, 88, 0)
	spawnMobile("talus", "rebel_commando", 240, -2605.7, 45.1, 88.6, -48, 0)
	spawnMobile("talus", "rebel_commando", 240, -2609.7, 45.9, 97.7, 70, 0)
	spawnMobile("talus", "rebel_commando", 240, -2618.8, 42.7, 91.7, 68, 0)
	spawnMobile("talus", "rebel_commando", 240, -2613.2, 46.4, 114.5, 126, 0)

	--Ribcage (-4472,65)
	spawnMobile("talus", "decay_mite", 240, -4464.8, 17.6, 63.4, -123, 0)
	spawnMobile("talus", "decay_mite", 240, -4465.5, 19.2, 60.8, -123, 0)
	spawnMobile("talus", "decay_mite", 240, -4469.1, 20.5, 61.9, -63, 0)
	spawnMobile("talus", "decay_mite", 240, -4470.9, 22.1, 60.3, -43, 0)
	spawnMobile("talus", "decay_mite", 240, -4472.5, 23.6, 57.9, -163, 0)
	spawnMobile("talus", "decay_mite", 240, -4476.6, 22.9, 62.5, 63, 0)
	spawnMobile("talus", "decay_mite", 240, -4478.0, 21.3, 66.0, 53, 0)
	spawnMobile("talus", "decay_mite", 240, -4474.8, 17.4, 70.4, 135, 0)
	spawnMobile("talus", "decay_mite", 240, -4473.5, 14.0, 74.8, 13, 0)
	spawnMobile("talus", "decay_mite", 240, -4468.5, 12.3, 75.8, 113, 0)
	spawnMobile("talus", "decay_mite", 240, -4467.1, 12.2, 79.4, -163, 0)
	spawnMobile("talus", "decay_mite", 240, -4466.7, 17.2, 65.5, -98, 0)
	spawnMobile("talus", "decay_mite", 240, -4465.1, 14.7, 68.2, -63, 0)
	spawnMobile("talus", "decay_mite", 240, -4469.1, 14.5, 71.3, -143, 0)
	spawnMobile("talus", "decay_mite", 240, -4460.4, 13.5, 72.2, -133, 0)
	...
	spawnMobile("talus", "clipped_fynock", 240, -1454.1, 28.8, 1225.1, -60, 0)
	spawnMobile("talus", "clipped_fynock", 240, -1456.6, 28.8, 1228.1, -50, 0)
	spawnMobile("talus", "clipped_fynock", 240, -1453.1, 28.5, 1230.1, -90, 0)

	--Three Stones (-1362,1060)

	--Bones (-1243,1496)
	spawnMobile("talus", "decay_mite", 240, -1243.0, 6.8, 1500.2, -148, 0)
	spawnMobile("talus", "decay_mite", 240, -1240.9, 7.7, 1595.0, -51, 0)
	...
	--Dath Tree (-55,980)
	spawnMobile("talus", "sludge_panther", 360, -71.0, 16.9, 982.6, 2, 0)
	...
	--Stones (169,3409)
	spawnMobile("talus", "rot_mite", 180, 164.3, 73.2, 3408.4, 71, 0)
	spawnMobile("talus", "rot_mite", 180, 163.1, 73.5, 3402.7, 171, 0)
	spawnMobile("talus", "rot_mite", 180, 169.1, 73.5, 3400.2, -31, 0)
	spawnMobile("talus", "rot_mite", 180, 175.7, 72.3, 3412.2, 7, 0)
	...
	spawnMobile("talus", "rot_mite", 180, -522.5, 51.9, 3795.8, 81, 0)
	spawnMobile("talus", "rot_mite", 180, -516.9, 51.7, 3796.0, 31, 0)
	spawnMobile("talus", "rot_mite", 180, -508.4, 50.9, 3790.2, 124, 0)
	spawnMobile("talus", "rot_mite", 180, -513.1, 50.3, 3780.8, -131, 0)
	spawnMobile("talus", "rot_mite", 180, -522.8, 50.4, 3780.3, -50, 0)
	spawnMobile("talus", "rot_mite", 180, -528.1, 50.1, 3778.3, 1, 0)
	spawnMobile("talus", "rot_mite", 180, -534.2, 51.0, 3783.8, 131, 0)
	spawnMobile("talus", "rot_mite", 180, -520.8, 51.5, 3789.1, 45, 0)
	spawnMobile("talus", "rot_mite", 180, -531.4, 51.8, 3793.4, -31, 0)
	...
	spawnMobile("talus", "imperial_sharpshooter", 240, -2033.9, 141.7, 2807.1, 75, 0)
	spawnMobile("talus", "imperial_sharpshooter", 240, -2040.6, 141.0, 2816.8, 0, 0)
	spawnMobile("talus", "imperial_sharpshooter", 240, -2050.3, 141.2, 2819.5, -55, 0)
	spawnMobile("talus", "imperial_sharpshooter", 240, -2050.5, 140.6, 2811.7, -125, 0)
	spawnMobile("talus", "imperial_sharpshooter", 240, -2044.1, 141.6, 2806.9, 180, 0)
	spawnMobile("talus", "imperial_sergeant_major", 240, -2041.2, 140.7, 2811.6, -175, 0)

	--Road/Trail north of Imperial Outpost (-2255,2467) to (-2059,2444)
	spawnMobile("talus", "imperial_first_lieutenant", 240, -2251.1, 66.7, 2487.0, -5, 0)
	spawnMobile("talus", "imperial_trooper", 240, -2251.3, 67.4, 2491.0, -5, 0)
	spawnMobile("talus", "imperial_trooper", 240, -2251.5, 68.0, 2495.0, -5, 0)
	spawnMobile("talus", "imperial_trooper", 240, -2251.7, 68.6, 2499.0, -5, 0)
	spawnMobile("talus", "imperial_trooper", 240, -2251.9, 69.1, 2503.0, -5, 0)
	spawnMobile("talus", "imperial_trooper", 240, -2252.1, 69.6, 2507.0, -5, 0)
	spawnMobile("talus", "imperial_trooper", 240, -2252.3, 70.0, 2511.0, -5, 0)
	...
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5110.2, 19.2, 3214.0, -158, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5109.2, 18.8, 3210.4, 165, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5113.5, 19.9, 3220.9, -33, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5104.6, 20.7, 3221.9, 145, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5108.5, 20.8, 3225.0, -50, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5116.6, 20.1, 3224.8, -90, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5119.5, 18.8, 3216.5, -165, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5116.1, 18.4, 3211.4, 65, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5114.9, 17.7, 3204.9, 170, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5121.8, 17.2, 3205.7, -88, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5130.4, 16.1, 3202.6, -111, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5127.3, 16.0, 3199.7, 115, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5126.2, 19.7, 3228.4, -45, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5101.7, 19.6, 3211.4, -65, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5102.2, 18.6, 3204.6, -145, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5106.4, 17.8, 3201.0, -65, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5117.3, 16.5, 3197.5, -35, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 240, -5119.3, 20.7, 3231.2, 175, 0)
	...
	spawnMobile("talus", "giant_decay_mite_harvester", 240, -5105.9, 25.3, 3258.8, -9, 0)
	spawnMobile("talus", "giant_decay_mite_harvester", 240, -5118.5, 25.5, 3269.7, 49, 0)
	spawnMobile("talus", "giant_decay_mite_harvester", 240, -5147.5, 21.4, 3259.0, -114, 0)
	...
	spawnMobile("talus", "clipped_fynock", 240, -5284.4, 52.2, 5049.1, -4, 0)
	spawnMobile("talus", "clipped_fynock", 240, -5286.0, 53.5, 5063.4, 145, 0)
	spawnMobile("talus", "clipped_fynock", 240, -5265.7, 11.2, 5062.1, 174, 0)
	spawnMobile("talus", "clipped_fynock", 240, -5263.5, 10.4, 5046.0, -24, 0)
	...
	spawnMobile("talus", "female_roba", 180, -5466.8, 43.4, 5813.3, 180, 0)
	spawnMobile("talus", "female_roba", 180, -5459.9, 44.2, 5816.9, 180, 0)
	spawnMobile("talus", "male_roba", 180, -5458.6, 44.8, 5806.0, -90, 0)

	--Escape Pod & Skeletons (-4984,5753)
	spawnMobile("talus", "rot_mite", 180, -4988.6, 41.9, 5757.4, 81, 0)
	spawnMobile("talus", "rot_mite", 180, -4993.8, 41.2, 5749.9, 116, 0)
	spawnMobile("talus", "rot_mite", 180, -4990.1, 42.5, 5744.7, 41, 0)
	...
	spawnMobile("talus", "guf_drolg_female", 240, -4590.0, 29.3, 5687.1, 45, 0)
	...
	spawnMobile("talus", "foaming_vynock", 180, -3330.5, 75.5, 5167.9, -28, 0)
	spawnMobile("talus", "foaming_vynock", 180, -3325.8, 75.0, 5171.1, -91, 0)
	spawnMobile("talus", "foaming_vynock", 180, -3336.1, 75.9, 5164.7, 48, 0)
