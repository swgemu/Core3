...
function TalusStaticSpawnsNorthScreenPlay:spawnMobiles()
	...
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5110.2, 19.2, 3214.0, -158, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5109.2, 18.8, 3210.4, 165, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5113.5, 19.9, 3220.9, -33, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5104.6, 20.7, 3221.9, 145, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5108.5, 20.8, 3225.0, -50, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5116.6, 20.1, 3224.8, -90, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5119.5, 18.8, 3216.5, -165, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5116.1, 18.4, 3211.4, 65, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5114.9, 17.7, 3204.9, 170, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5121.8, 17.2, 3205.7, -88, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5130.4, 16.1, 3202.6, -111, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5127.3, 16.0, 3199.7, 115, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5126.2, 19.7, 3228.4, -45, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5101.7, 19.6, 3211.4, -65, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5102.2, 18.6, 3204.6, -145, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5106.4, 17.8, 3201.0, -65, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5117.3, 16.5, 3197.5, -35, 0)
	spawnMobile("talus", "giant_decay_mite_hatchliing", 300, -5119.3, 20.7, 3231.2, 175, 0)
