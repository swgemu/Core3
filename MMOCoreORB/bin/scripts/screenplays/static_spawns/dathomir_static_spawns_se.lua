...
function DathomirStaticSpawnsSeScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "thug", 30, 76.6, 127.1, -164.5, -90, 0)
	spawnMobile("dathomir", "thug", 30, 74.3, 126.3, -175.8, -10, 0)
	spawnMobile("dathomir", "thug", 30, 83.3, 127.1, -173.8, 90, 0)
	spawnMobile("dathomir", "thug", 30, 90.9, 128.7, -167.8, 15, 0)
	spawnMobile("dathomir", "thug", 30, 80.1, 128.0, -152.9, -90, 0)
	spawnMobile("dathomir", "thug", 30, 72.7, 126.9, -156.3, -110, 0)
	spawnMobile("dathomir", "thug", 30, 79.0, 127.9, -150.3, 90, 0)
	spawnMobile("dathomir", "thug", 30, 80.2, 127.0, -171.3, 180, 0)

	spawnMobile("dathomir", "injured_verne", 45, 28.5, 127.3, -184.8, -150, 0)
	spawnMobile("dathomir", "injured_verne", 45, 33.2, 127.9, -190.7, 140, 0)
	spawnMobile("dathomir", "injured_verne", 45, 27.4, 128.2, -191.2, -90, 0)
	spawnMobile("dathomir", "injured_verne", 45, 21.6, 129.0, -196.9, 40, 0)
