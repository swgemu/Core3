...
function RoriStaticSpawnsScreenPlay:spawnMobiles()
	...
	spawnMobile("rori", "nudfuh", 120, 212.8, 76.1, 5127.3, 75, 0)
	...
	--Crashed Corellian Corvette (0,2013)
	spawnMobile("rori", "junk_dealer", 240, 3.2, 75.7, 2003.0, -155, 0)
	spawnMobile("rori", "rebel_colonel", 240, 1.2, 75.0, 2003.0, 74, 0)
	spawnMobile("rori", "rebel_commando", 240, -9.5, 76.5, 1998.8, -135, 0)
	spawnMobile("rori", "rebel_crewman", 240, -25.7, 75.5, 2008.9, 99, 0)
	spawnMobile("rori", "rebel_medic", 240, -35.2, 75.7, 2031.1, -35, 0)
	spawnMobile("rori", "rebel_ensign", 240, -39.5, 75.5, 2010.4, 170, 0)
	spawnMobile("rori", "rebel_army_captain", 240, -46.9, 76.0, 2003.4, 110, 0)
	spawnMobile("rori", "rebel_commando", 240, -24.1, 77.8, 1995.4, 33, 0)
	spawnMobile("rori", "rebel_pilot", 240, -3.6, 77.2, 1987.0, -79, 0)
	spawnMobile("rori", "rebel_trooper", 240, -13.6, 77.3, 1984.1, -31, 0)
	spawnMobile("rori", "rebel_general", 240, -9.7, 77.4, 1989.0, 55, 0)

	spawnMobile("rori", "rebel_crewman", 240,math.random(40) + -65.7,77.6, math.random(30) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "rebel_crewman", 240,math.random(40) + -65.7,77.6, math.random(30) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "rebel_crewman", 240,math.random(40) + -65.7,77.6, math.random(30) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "rebel_crewman", 240,math.random(40) + -65.7,77.6, math.random(30) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "rebel_crewman", 240,math.random(40) + -65.7,77.6, math.random(30) + 2046.8,math.random(360), 0)
	...
	spawnMobile("rori", "rebel_trooper", 240,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "rebel_trooper", 240,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "rebel_trooper", 240,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "rebel_trooper", 240,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "rebel_trooper", 240,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	...
	spawnMobile("rori", "rebel_trooper", 240,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "rebel_trooper", 240,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "rebel_medic", 240,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "rebel_medic", 240,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "rebel_medic", 240,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "rebel_medic", 240,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
