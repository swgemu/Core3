...
function RoriStaticSpawnsScreenPlay:spawnMobiles()
	...
	spawnMobile("rori", "strong_mercenary", 300,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "strong_mercenary", 300,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "strong_mercenary", 300,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "strong_mercenary", 300,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	spawnMobile("rori", "strong_mercenary", 300,math.random(40) + -65.7,77.6, math.random(40) + 2046.8,math.random(360), 0)
	...
	spawnMobile("rori", "domestic_bearded_jax", 300,math.random(8) + -435.7, 75.7,math.random(15) + -5454.5, 50, 0)
	spawnMobile("rori", "domestic_bearded_jax", 300,math.random(8) + -435.7, 75.7,math.random(15) + -5454.5, 90, 0)
	spawnMobile("rori", "domestic_bearded_jax", 300,math.random(8) + -435.7, 75.7,math.random(15) + -5454.5, -40, 0)
	spawnMobile("rori", "domestic_bearded_jax", 300,math.random(8) + -435.7, 75.7,math.random(15) + -5454.5, 180, 0)
	spawnMobile("rori", "domestic_bearded_jax", 300,math.random(8) + -435.7, 75.7,math.random(15) + -5454.5, 75, 0)
	spawnMobile("rori", "domestic_bearded_jax", 300,math.random(8) + -435.7, 75.7,math.random(15) + -5454.5, -50, 0)

	spawnMobile("rori", "rancher", 300, -433.7, 75.7, -5441.2, 180, 0)
	spawnMobile("rori", "domestic_tusk_cat", 300, -436.2, 75.7, -5441.2, 180, 0)

	spawnMobile("rori", "nudfuh", 300,math.random(40) + -419.7, 75.7,math.random(75) + -5484.5,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(40) + -419.7, 75.7,math.random(75) + -5484.5,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(40) + -419.7, 75.7,math.random(75) + -5484.5,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(40) + -419.7, 75.7,math.random(75) + -5484.5,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(40) + -419.7, 75.7,math.random(75) + -5484.5,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(95) + -480, 75.7,math.random(35) + -5484.5,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(95) + -480, 75.7,math.random(35) + -5484.5,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(95) + -480, 75.7,math.random(35) + -5484.5,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(95) + -480, 75.7,math.random(35) + -5484.5,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(95) + -480, 75.7,math.random(35) + -5484.5,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(95) + -480, 75.7,math.random(35) + -5425,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(95) + -480, 75.7,math.random(35) + -5425,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(95) + -480, 75.7,math.random(35) + -5425,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(95) + -480, 75.7,math.random(35) + -5425,math.random(360), 0)
	spawnMobile("rori", "nudfuh", 300,math.random(95) + -480, 75.7,math.random(35) + -5425,math.random(360), 0)
