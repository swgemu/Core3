...
function DathomirStaticSpawnsNeScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "escaped_nightsister_slave", 240, 7204.2, 533.0, 5552.5, 65, 0)
	spawnMobile("dathomir", "escaped_nightsister_slave", 240, 7207.9, 533.1, 5552.3, -65, 0)
	spawnMobile("dathomir", "escaped_nightsister_slave", 240, 7205.5, 532.8, 5545.0, -155, 0)
	spawnMobile("dathomir", "escaped_singing_mountain_clan_slave", 240, 7200.2, 536.0, 5565.8, 25, 0)
	spawnMobile("dathomir", "escaped_singing_mountain_clan_slave", 240, 7202.0, 536.5, 5568.9, -145, 0)
	spawnMobile("dathomir", "escaped_singing_mountain_clan_slave", 240, 7196.1, 536.3, 5569.7, 115, 0)
