...
recruiterScreenplay = Object:new {
	...
	recruiterTemplates = {
		rebel = { "crackdown_rebel_guard_captain", "rebel_army_captain", "rebel_brigadier_general", "rebel_colonel", "rebel_general", "rebel_high_general", "rebel_lieutenant_colonel", "rebel_lieutenant_general",
			"rebel_major_general", "rebel_major", "rebel_medic", "rebel_obscureops_agent", "rebel_recruiter", "rebel_sergeant_major", "rebel_specforce_captain", "rebel_specforce_colonel", "rebel_specforce_general",
			"rebel_warrant_officer_i", "rebel_warrant_officer_ii", "specforce_major" },
		imperial = { "crackdown_imperial_colonel", "crackdown_imperial_medic", "crackdown_imperial_warrant_officer_ii", "crackdown_imperial_warrant_officer_li", "crackdown_stormtrooper_captain",
			"imperial_army_captain", "imperial_brigadier_general", "imperial_captain", "imperial_colonel", "imperial_general", "imperial_high_general", "imperial_lieutenant_colonel", "imperial_lieutenant_general",
			"imperial_major_general", "imperial_major", "imperial_medic", "imperial_recruiter", "imperial_sergeant_major", "imperial_stealth_operative", "imperial_warrant_officer_i", "imperial_warrant_officer_ii",
			"stormtrooper_colonel", "stormtrooper_major" }
	},
...
function recruiterScreenplay:getRecruiterFaction(pNpc)
	local npcTemplate = SceneObject(pNpc):getObjectName()
	for i = 1, table.getn(self.recruiterTemplates.rebel), 1 do
		if npcTemplate == self.recruiterTemplates.rebel[i] then
			return "rebel"
		end
	end
	for i = 1, table.getn(self.recruiterTemplates.imperial), 1 do
		if npcTemplate == self.recruiterTemplates.imperial[i] then
			return "imperial"
		end
	end
	printf("ERROR: Unable to determine faction of npc with recruiter convotemplate. Template must be added to recruiterScreenplay template table.\n")
	return nil
end
