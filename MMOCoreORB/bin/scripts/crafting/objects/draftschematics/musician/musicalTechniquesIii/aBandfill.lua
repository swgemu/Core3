...
aBandfill = Object:new {

   objectName = "a Bandfill",
   stfName = "obj_bandfill",
   objectCRC = 1069929316,
   ...
   tanoAttributes = "objecttype=8204:objectcrc=838757271:objecttemp=bandfill:templatetype=obj_n:itemmask=65535:",
...
DraftSchematics:addDraftSchematic(aBandfill, 1069929316)--- Add to global DraftSchematics table
