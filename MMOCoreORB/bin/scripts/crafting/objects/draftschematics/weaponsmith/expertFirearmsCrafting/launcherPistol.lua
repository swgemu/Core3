...
launcherPistol = Object:new {

   objectName = "Launcher Pistol",
   stfName = "pistol_launcher",
   stfFile = "weapon_name",
   objectCRC = 1800323184,
...
DraftSchematics:addDraftSchematic(launcherPistol, 1800323184)--- Add to global DraftSchematics table
