...
advancedProjectileFeedMechanism = Object:new {
   ...
   tanoAttributes = "objecttype=262155:objectcrc=4156025153:stfFile=craft_weapon_ingredients_n:stfName=projectile_feed_mechanism_advanced:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(advancedProjectileFeedMechanism, 262118266)--- Add to global DraftSchematics table
