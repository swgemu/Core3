...
advancedProjectilePistolBarrel = Object:new {

   objectName = "Advanced Projectile Pistol Barrel",
   stfName = "projectile_pistol_barrel_advanced",
   stfFile = "craft_weapon_ingredients_n",
   objectCRC = 3111961622,
   ...
   tanoAttributes = "objecttype=262155:objectcrc=3447151631:stfFile=craft_weapon_ingredients_n:stfName=projectile_pistol_barrel_advanced:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(advancedProjectilePistolBarrel, 3111961622)--- Add to global DraftSchematics table
