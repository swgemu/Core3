...
advancedProjectileRifleBarrel = Object:new {

   objectName = "Advanced Projectile Rifle Barrel",
   stfName = "projectile_rifle_barrel_advanced",
   stfFile = "craft_weapon_ingredients_n",
   objectCRC = 1631155967,
   ...
   tanoAttributes = "objecttype=262155:objectcrc=594573612:objecttemp=projectile_rifle_barrel_advanced:templatetype=craft_weapon_ingredients_n:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(advancedProjectileRifleBarrel, 1631155967)--- Add to global DraftSchematics table
