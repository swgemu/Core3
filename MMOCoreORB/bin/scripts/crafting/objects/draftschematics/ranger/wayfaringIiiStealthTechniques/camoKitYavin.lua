...
camoKitYavin = Object:new {

   objectName = "Camo Kit: Yavin",
   stfFile = "item_n",
   stfDetail = "item_d",
   stfName = "camokit_yavin",
   objectCRC = 2300033935,
   ...
   tanoAttributes = "objecttype=8232:objectcrc=1119412885:stfFile=item_n:stfName=camokit_yavin:stfDetail=item_d:itemmask=65535:customattributes=:",
...
DraftSchematics:addDraftSchematic(camoKitYavin, 2300033935)--- Add to global DraftSchematics table
