...
camoKitLok = Object:new {

   objectName = "Camo Kit: Lok",
   stfName = "camokit_lok",
   objectCRC = 594480745,
   ...
   tanoAttributes = "objecttype=8211:objectcrc=3919662514:objecttemp=camokit_lok:templatetype=item_n:itemmask=65535:",
...
DraftSchematics:addDraftSchematic(camoKitLok, 594480745)--- Add to global DraftSchematics table
