...
camoKitEndor = Object:new {

   objectName = "Camo Kit: Endor",
   stfName = "camokit_endor",
   objectCRC = 1218082990,
   ...
   tanoAttributes = "objecttype=8211:objectcrc=2201297332:objecttemp=camokit_endor:templatetype=item_n:itemmask=65535:",
...
DraftSchematics:addDraftSchematic(camoKitEndor, 1218082990)--- Add to global DraftSchematics table
