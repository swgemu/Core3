...
adhesiveMesh = Object:new {

   objectName = "Adhesive Mesh",
   stfName = "trap_webber",
   stfFile = "item_n",
   objectCRC = 2895113899,
   ...
   tanoAttributes = "objecttype=8212:objectcrc=3441092972:stfFile=item_n:stfName=trap_webber:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(adhesiveMesh, 2895113899)--- Add to global DraftSchematics table
