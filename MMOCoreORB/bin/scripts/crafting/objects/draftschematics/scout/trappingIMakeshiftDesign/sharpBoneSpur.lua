...
sharpBoneSpur = Object:new {

   objectName = "Sharp Bone Spur",
   stfName = "trap_enraging_spur",
   objectCRC = 253853379,
...
DraftSchematics:addDraftSchematic(sharpBoneSpur, 253853379)--- Add to global DraftSchematics table
