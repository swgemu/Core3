...
multipersonCampKit = Object:new {

   objectName = "Multiperson Camp Kit",
   stfName = "camp_multi",
   stfFile = "item_n",
   objectCRC = 3178673319,
...
DraftSchematics:addDraftSchematic(multipersonCampKit, 3178673319)--- Add to global DraftSchematics table
