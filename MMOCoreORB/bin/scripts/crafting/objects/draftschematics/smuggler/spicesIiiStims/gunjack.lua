...
gunjack = Object:new {
   ...
   tanoAttributes = "objecttype=8202:objectcrc=3162646760:stfFile=food_name:stfName=gunjack:stfDetail=food_detail:itemmask=65535:customattributes=effectType=5;buffName=gunjack;modifierString=strength=500,quickness=-200,focus=-100;duration=600;:",
