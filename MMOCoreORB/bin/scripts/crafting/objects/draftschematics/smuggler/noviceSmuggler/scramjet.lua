...
scramjet = Object:new {
   ...
   tanoAttributes = "objecttype=8202:objectcrc=3992242678:stfFile=food_name:stfName=scramjet:stfDetail=food_detail:itemmask=65535:customattributes=effectType=5;buffName=scramjet;modifierString=strength=300;duration=700;:",
