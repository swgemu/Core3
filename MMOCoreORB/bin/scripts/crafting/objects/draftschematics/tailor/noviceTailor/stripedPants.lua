...
stripedPants = Object:new {

   objectName = "Striped Pants",
   stfName = "pants_s01",
   stfFile = "wearables_name",
   objectCRC = 3527386114,
   ...
   tanoAttributes = "objecttype=:objectcrc=729715050:stfFile=wearables_name:stfName=pants_s01:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(stripedPants, 3527386114)--- Add to global DraftSchematics table
