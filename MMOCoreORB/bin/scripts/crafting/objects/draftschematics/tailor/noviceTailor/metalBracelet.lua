...
metalBracelet = Object:new {

   objectName = "Metal Bracelet",
   stfName = "bracelet_s06",
...
DraftSchematics:addDraftSchematic(metalBracelet, 979627405)--- Add to global DraftSchematics table
