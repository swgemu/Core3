...
plainShirt = Object:new {

   objectName = "Plain Shirt",
   stfName = "shirt_s03",
   stfFile = "wearables_name",
   objectCRC = 1534159309,
   ...
   tanoAttributes = "objecttype=:objectcrc=2094605554:stfFile=wearables_name:stfName=shirt_s03:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(plainShirt, 1534159309)--- Add to global DraftSchematics table
