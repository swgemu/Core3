...
ithorianMetalNecklace = Object:new {

   objectName = "Ithorian Metal Necklace",
   stfName = "ith_necklace_s06",
...
DraftSchematics:addDraftSchematic(ithorianMetalNecklace, 667950610)--- Add to global DraftSchematics table
