...
militaryTravelPack = Object:new {

   objectName = "Military Travel Pack",
   stfName = "backpack_s03",
   stfFile = "wearables_name",
   objectCRC = 3909300058,
...
DraftSchematics:addDraftSchematic(militaryTravelPack, 3909300058)--- Add to global DraftSchematics table
