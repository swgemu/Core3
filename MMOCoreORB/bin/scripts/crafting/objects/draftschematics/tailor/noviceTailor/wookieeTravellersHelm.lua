...
wookieeTravellersHelm = Object:new {

   objectName = "Wookiee Traveller's Helm",
   stfName = "wke_hat_s01",
   stfFile = "wearables_name",
   objectCRC = 1693934374,
   ...
   tanoAttributes = "objecttype=:objectcrc=143220595:stfFile=:stfName=:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(wookieeTravellersHelm, 1693934374)--- Add to global DraftSchematics table
