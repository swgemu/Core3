...
weightedWaistWrap = Object:new {

   objectName = "Weighted Waist Wrap",
   stfName = "wke_skirt_s03",
   stfFile = "wearables_name",
   objectCRC = 1921422657,
   ...
   tanoAttributes = "objecttype=:objectcrc=1012928573:stfFile=wearables_name:stfName=wke_skirt_s03:stfDetail=:itemmask=61955::",
...
DraftSchematics:addDraftSchematic(weightedWaistWrap, 1921422657)--- Add to global DraftSchematics table
