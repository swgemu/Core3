...
woolyJacket = Object:new {

   objectName = "Wooly Jacket",
   stfName = "jacket_s14",
   ...
   tanoAttributes = "objecttype=:objectcrc=3841986537:stfFile=wearables_name:stfName=jacket_s14:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(woolyJacket, 583780089)--- Add to global DraftSchematics table
