...
largePendant = Object:new {

   objectName = "Large Pendant",
   stfName = "necklace_s08",
   stfFile = "wearables_name",
   objectCRC = 1913077569,
...
DraftSchematics:addDraftSchematic(largePendant, 1913077569)--- Add to global DraftSchematics table
