...
councilmansRobe = Object:new {

   objectName = "Councilman's Robe",
   stfName = "dress_s23",
   stfFile = "wearables_name",
   objectCRC = 2844639067,
   ...
   tanoAttributes = "objecttype=:objectcrc=3912298622:stfFile=:stfName=:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(councilmansRobe, 2844639067)--- Add to global DraftSchematics table
