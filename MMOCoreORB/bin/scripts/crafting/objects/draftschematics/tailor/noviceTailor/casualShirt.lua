...
casualShirt = Object:new {

   objectName = "Casual Shirt",
   stfName = "shirt_s07",
   stfFile = "wearables_name",
   objectCRC = 2072373838,
...
DraftSchematics:addDraftSchematic(casualShirt, 2072373838)--- Add to global DraftSchematics table
