...
reinforcedPullover = Object:new {

   objectName = "Reinforced Pullover",
   stfName = "jacket_s18",
   stfFile = "wearables_name",
   objectCRC = 1138115196,
...
DraftSchematics:addDraftSchematic(reinforcedPullover, 1138115196)--- Add to global DraftSchematics table
