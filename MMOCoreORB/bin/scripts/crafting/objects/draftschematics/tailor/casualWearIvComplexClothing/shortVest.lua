...
shortVest = Object:new {

   objectName = "Short Vest",
   stfName = "vest_s03",
   stfFile = "wearables_name",
   objectCRC = 1886486734,
   ...
   tanoAttributes = "objecttype=16777231:objectcrc=2727280266:stfFile=wearables_name:stfName=vest_s03:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(shortVest, 1886486734)--- Add to global DraftSchematics table
