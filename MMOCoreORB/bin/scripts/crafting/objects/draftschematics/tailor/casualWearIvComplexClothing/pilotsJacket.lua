...
pilotsJacket = Object:new {

   objectName = "Pilot's Jacket",
   stfName = "jacket_s36",
   stfFile = "wearables_name",
   objectCRC = 2256605971,
   ...
   tanoAttributes = "objecttype=:objectcrc=1095424515:stfFile=:stfName=:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(pilotsJacket, 2256605971)--- Add to global DraftSchematics table
