...
strangeIthorianPants = Object:new {

   objectName = "Strange Ithorian Pants",
   stfName = "ith_pants_s21",
   stfFile = "wearables_name",
   objectCRC = 1797683956,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=1963875198:stfFile=wearables_name:stfName=ith_pants_s21:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(strangeIthorianPants, 1797683956)--- Add to global DraftSchematics table
