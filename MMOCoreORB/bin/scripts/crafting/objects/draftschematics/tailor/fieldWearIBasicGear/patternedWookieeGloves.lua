...
patternedWookieeGloves = Object:new {

   objectName = "Patterned Wookiee Gloves",
   stfName = "wke_gloves_s01",
   stfFile = "wearables_name",
   objectCRC = 3557216934,
...
DraftSchematics:addDraftSchematic(patternedWookieeGloves, 3557216934)--- Add to global DraftSchematics table
