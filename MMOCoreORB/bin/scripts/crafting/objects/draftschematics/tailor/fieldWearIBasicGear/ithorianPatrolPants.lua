...
ithorianPatrolPants = Object:new {

   objectName = "Ithorian Patrol Pants",
   stfName = "ith_pants_s06",
   stfFile = "wearables_name",
   objectCRC = 2727853984,
   ...
   resourceTypes = "object/tangible/component/clothing/shared_synthetic_cloth.iff, petrochem_inert, object/tangible/component/clothing/shared_metal_fasteners.iff, ***BAD NAME***",
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=3099421338:stfFile=wearables_name:stfName=ith_pants_s06:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianPatrolPants, 2727853984)--- Add to global DraftSchematics table
