...
infiltrationSuit = Object:new {

   objectName = "Infiltration Suit",
   stfName = "bodysuit_s16",
...
DraftSchematics:addDraftSchematic(infiltrationSuit, 906386191)--- Add to global DraftSchematics table
