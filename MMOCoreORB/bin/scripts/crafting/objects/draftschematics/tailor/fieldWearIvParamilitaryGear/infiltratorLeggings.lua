...
infiltratorLeggings = Object:new {

   objectName = "Infiltrator Leggings",
   stfName = "pants_s22",
   stfFile = "wearables_name",
   objectCRC = 1293360666,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=3325633293:stfFile=wearables_name:stfName=pants_s22:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(infiltratorLeggings, 1293360666)--- Add to global DraftSchematics table
