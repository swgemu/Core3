...
ithorianTechnicalSuit = Object:new {

   objectName = "Ithorian Technical Suit",
   stfName = "ith_bodysuit_s02",
   stfFile = "wearables_name",
   objectCRC = 3768102972,
...
DraftSchematics:addDraftSchematic(ithorianTechnicalSuit, 3768102972)--- Add to global DraftSchematics table
