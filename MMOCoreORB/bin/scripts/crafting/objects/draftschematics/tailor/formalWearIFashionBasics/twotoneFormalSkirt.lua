...
twotoneFormalSkirt = Object:new {

   objectName = "Two-Tone Formal Skirt",
   stfName = "skirt_s14",
   stfFile = "wearables_name",
   objectCRC = 2500545447,
...
DraftSchematics:addDraftSchematic(twotoneFormalSkirt, 2500545447)--- Add to global DraftSchematics table
