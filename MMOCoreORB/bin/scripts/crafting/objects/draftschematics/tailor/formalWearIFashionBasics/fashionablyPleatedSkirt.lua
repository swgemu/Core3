...
fashionablyPleatedSkirt = Object:new {

   objectName = "Fashionably Pleated Skirt",
   stfName = "skirt_s07",
   stfFile = "wearables_name",
   objectCRC = 1429532232,
   ...
   tanoAttributes = "objecttype=16777234:objectcrc=107176467:stfFile=wearables_name:stfName=clothing_skirt_formal_07:stfDetail=:itemmask=62974::",
...
DraftSchematics:addDraftSchematic(fashionablyPleatedSkirt, 1429532232)--- Add to global DraftSchematics table
