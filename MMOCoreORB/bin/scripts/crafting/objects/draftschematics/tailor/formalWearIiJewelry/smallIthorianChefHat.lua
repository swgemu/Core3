...
smallIthorianChefHat = Object:new {

   objectName = "Small Ithorian Chef Hat",
   stfName = "hat_chef_s02_ith",
   stfFile = "wearables_name",
   objectCRC = 2359702568,
...
DraftSchematics:addDraftSchematic(smallIthorianChefHat, 2359702568)--- Add to global DraftSchematics table
