...
ithorianBucklePants = Object:new {

   objectName = "Ithorian Buckle Pants",
   stfName = "ith_pants_s10",
   stfFile = "wearables_name",
   objectCRC = 2794154463,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=293284731:stfFile=wearables_name:stfName=ith_pants_s10:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianBucklePants, 2794154463)--- Add to global DraftSchematics table
