...
wookieeSagesHood = Object:new {

   objectName = "Wookiee Sage's Hood",
   stfName = "wke_hood_s02",
   ...
   tanoAttributes = "objecttype=:objectcrc=4110734572:objecttemp=:templatetype=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(wookieeSagesHood, 311548959)--- Add to global DraftSchematics table
