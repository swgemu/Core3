...
cloakedDress = Object:new {

   objectName = "Cloaked Dress",
   stfName = "dress_s16",
   stfFile = "wearables_name",
   objectCRC = 3977006301,
   ...
   tanoAttributes = "objecttype=16777223:objectcrc=2914059256:objecttemp=dress_s16:templatetype=wearables_name:itemmask=62974::",
...
DraftSchematics:addDraftSchematic(cloakedDress, 3977006301)--- Add to global DraftSchematics table
