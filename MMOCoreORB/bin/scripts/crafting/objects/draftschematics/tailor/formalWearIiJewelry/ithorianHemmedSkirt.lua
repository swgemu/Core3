...
ithorianHemmedSkirt = Object:new {

   objectName = "Ithorian Hemmed Skirt",
   stfName = "ith_skirt_s02",
   stfFile = "wearables_name",
   objectCRC = 3011825216,
   ...
   tanoAttributes = "objecttype=16777234:objectcrc=2841311150:stfFile=wearables_name:stfName=ith_skirt_s02:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianHemmedSkirt, 3011825216)--- Add to global DraftSchematics table
