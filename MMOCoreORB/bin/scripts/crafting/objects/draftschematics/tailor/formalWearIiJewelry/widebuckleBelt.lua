...
widebuckleBelt = Object:new {

   objectName = "Widebuckle Belt",
   stfName = "belt_s19",
   stfFile = "wearables_name",
   objectCRC = 1754914777,
   ...
   tanoAttributes = "objecttype=16777218:objectcrc=3467220186:stfFile=wearables_name:stfName=belt_s19:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(widebuckleBelt, 1754914777)--- Add to global DraftSchematics table
