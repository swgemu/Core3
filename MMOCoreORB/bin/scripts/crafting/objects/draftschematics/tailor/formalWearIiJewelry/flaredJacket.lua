...
flaredJacket = Object:new {

   objectName = "Flared Jacket",
   stfName = "jacket_s26",
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=1516427131:stfFile=wearables_name:stfName=jacket_s26:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(flaredJacket, 879852869)--- Add to global DraftSchematics table
