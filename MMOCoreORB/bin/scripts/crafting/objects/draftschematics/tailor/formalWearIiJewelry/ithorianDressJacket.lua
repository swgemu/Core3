...
ithorianDressJacket = Object:new {

   objectName = "Ithorian Dress Jacket",
   stfName = "ith_dress_short_s01",
   stfFile = "wearables_name",
   objectCRC = 3950463673,
...
DraftSchematics:addDraftSchematic(ithorianDressJacket, 3950463673)--- Add to global DraftSchematics table
