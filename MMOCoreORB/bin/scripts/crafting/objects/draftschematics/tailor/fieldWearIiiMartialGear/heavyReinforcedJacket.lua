...
heavyReinforcedJacket = Object:new {

   objectName = "Heavy Reinforced Jacket",
   stfName = "jacket_s10",
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=3321138282:stfFile=wearables_name:stfName=jacket_s10:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(heavyReinforcedJacket, 785609939)--- Add to global DraftSchematics table
