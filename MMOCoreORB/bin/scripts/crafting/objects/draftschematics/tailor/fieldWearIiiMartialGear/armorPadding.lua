...
armorPadding = Object:new {

   objectName = "Armor Padding",
   stfName = "padding_segment",
   stfFile = "craft_clothing_ingredients_n",
   objectCRC = 1984198906,
...
DraftSchematics:addDraftSchematic(armorPadding, 1984198906)--- Add to global DraftSchematics table
