...
specopsDuster = Object:new {

   objectName = "Spec-Ops Duster",
   stfName = "jacket_s21",
   stfFile = "wearables_name",
   objectCRC = 1252394198,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=2709650543:stfFile=wearables_name:stfName=jacket_s21:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(specopsDuster, 1252394198)--- Add to global DraftSchematics table
