...
wookieeShoulderPad = Object:new {

   objectName = "Wookiee Shoulder Pad",
   stfName = "wke_shoulder_pads_s02",
   stfFile = "wearables_name",
   objectCRC = 3119079046,
...
DraftSchematics:addDraftSchematic(wookieeShoulderPad, 3119079046)--- Add to global DraftSchematics table
