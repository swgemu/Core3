...
rankSash = Object:new {
   ...
   objectName = "Rank Sash",
   stfName = "bandolier_s06",
   stfFile = "wearables_name",
   objectCRC = 1879693932,
...
DraftSchematics:addDraftSchematic(rankSash, 1879693932)--- Add to global DraftSchematics table
