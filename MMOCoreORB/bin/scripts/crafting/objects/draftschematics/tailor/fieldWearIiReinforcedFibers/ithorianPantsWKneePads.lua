...
ithorianPantsWKneePads = Object:new {

   objectName = "Ithorian Pants w/ Knee Pads",
   stfName = "ith_pants_s07",
   stfFile = "wearables_name",
   objectCRC = 3952793645,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=4054846743:stfFile=wearables_name:stfName=ith_pants_s07:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianPantsWKneePads, 3952793645)--- Add to global DraftSchematics table
