...
ammoBandolier = Object:new {

   objectName = "Ammo Bandolier",
   stfName = "bandolier_s05",
   stfFile = "wearables_name",
   objectCRC = 2870899451,
   ...
   tanoAttributes = "objecttype=16777217:objectcrc=1572936874:stfFile=wearables_name:stfName=bandolier_s05:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(ammoBandolier, 2870899451)--- Add to global DraftSchematics table
