...
ithorianCargoPants = Object:new {

   objectName = "Ithorian Cargo Pants",
   stfName = "ith_pants_s12",
   stfFile = "wearables_name",
   objectCRC = 2571841883,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=2204230753:stfFile=wearables_name:stfName=ith_pants_s12:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianCargoPants, 2571841883)--- Add to global DraftSchematics table
