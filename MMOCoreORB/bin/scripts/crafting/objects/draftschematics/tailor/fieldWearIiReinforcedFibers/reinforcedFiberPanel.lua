...
reinforcedFiberPanel = Object:new {
   ...
   stfDetail = "string/en/craft_clothing_ingredients_d.stf",
   ...
   tanoAttributes = "objecttype=262147:objectcrc=142903413:stfFile=craft_clothing_ingredients_n:stfName=reinforced_fiber_panels:stfDetail=craft_clothing_ingredients_d:itemmask=65535:customattributes=:",
