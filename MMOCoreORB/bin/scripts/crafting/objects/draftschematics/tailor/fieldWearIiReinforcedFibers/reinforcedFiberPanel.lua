...
reinforcedFiberPanel = Object:new {

   objectName = "Reinforced Fiber Panel",
   stfName = "reinforced_fiber_panels",
...
DraftSchematics:addDraftSchematic(reinforcedFiberPanel, 394655839)--- Add to global DraftSchematics table
