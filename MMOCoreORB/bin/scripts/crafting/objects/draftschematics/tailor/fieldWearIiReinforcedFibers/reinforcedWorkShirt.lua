...
reinforcedWorkShirt = Object:new {
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=3169222941:stfFile=wearables_name:stfName=shirt_s10:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(reinforcedWorkShirt, 116665857)--- Add to global DraftSchematics table
