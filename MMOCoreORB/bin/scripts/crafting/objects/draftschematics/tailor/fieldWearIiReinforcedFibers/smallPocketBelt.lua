...
smallPocketBelt = Object:new {

   objectName = "Small Pocket Belt",
   stfName = "belt_s01",
   stfFile = "wearables_name",
   objectCRC = 2241263026,
   ...
   tanoAttributes = "objecttype=16777218:objectcrc=2489884324:objecttemp=belt_s01:templatetype=wearables_name:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(smallPocketBelt, 2241263026)--- Add to global DraftSchematics table
