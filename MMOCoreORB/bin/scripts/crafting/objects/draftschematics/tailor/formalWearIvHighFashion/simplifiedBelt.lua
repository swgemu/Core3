...
simplifiedBelt = Object:new {

   objectName = "Simplified Belt",
   stfFile = "wearables_name",
   stfDetail = "wearables_detail",
   stfName = "belt_s20",
   objectCRC = 1292216538,
   ...
   tanoAttributes = "objecttype=16777218:objectcrc=3946177497:stfFile=wearables_name:stfName=belt_s20:stfDetail=wearables_detail:itemmask=65535:customattributes=:",
...
DraftSchematics:addDraftSchematic(simplifiedBelt, 1292216538)--- Add to global DraftSchematics table
