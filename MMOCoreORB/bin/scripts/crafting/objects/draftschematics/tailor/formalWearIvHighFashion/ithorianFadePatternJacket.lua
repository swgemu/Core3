...
ithorianFadePatternJacket = Object:new {

   objectName = "Ithorian Fade Pattern Jacket",
   stfFile = "wearables_name",
   stfDetail = "wearables_detail",
   stfName = "ith_jacket_s15",
   objectCRC = 3667499273,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=4036147599:stfFile=wearables_name:stfName=ith_jacket_s15:stfDetail=wearables_detail:itemmask=63491:customattributes=:",
...
DraftSchematics:addDraftSchematic(ithorianFadePatternJacket, 3667499273)--- Add to global DraftSchematics table
