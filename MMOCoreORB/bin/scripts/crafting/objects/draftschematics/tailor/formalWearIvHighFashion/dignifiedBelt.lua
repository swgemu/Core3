...
dignifiedBelt = Object:new {

   objectName = "Dignified Belt",
   stfName = "belt_s13",
   stfFile = "wearables_name",
   objectCRC = 3144292293,
   ...
   tanoAttributes = "objecttype=16777218:objectcrc=492461254:stfFile=wearables_name:stfName=belt_s13:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(dignifiedBelt, 3144292293)--- Add to global DraftSchematics table
