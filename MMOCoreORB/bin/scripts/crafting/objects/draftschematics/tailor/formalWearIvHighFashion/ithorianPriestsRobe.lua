...
ithorianPriestsRobe = Object:new {

   objectName = "Ithorian Priest's Robe",
   stfName = "ith_robe_s02",
   stfFile = "wearables_name",
   objectCRC = 3469187502,
   ...
   tanoAttributes = "objecttype=:objectcrc=3329776583:stfFile=:stfName=:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(ithorianPriestsRobe, 3469187502)--- Add to global DraftSchematics table
