...
luxuriousGown = Object:new {

   objectName = "Luxurious Gown",
   stfName = "dress_s34",
   stfFile = "wearables_name",
   objectCRC = 1229363511,
   ...
   ingredientSlotType = "0, 1, 0, 0, 1, 0",
   resourceTypes = "hide, object/tangible/component/clothing/shared_trim.iff, ***BAD NAME***, metal, object/tangible/component/clothing/shared_synthetic_cloth.iff, object/tangible/component/clothing/shared_synthetic_cloth.iff",
   resourceQuantities = "40, 2, 1, 20, 2, 1",
   combineTypes = "0, 1, 0, 0, 1, 0",
   ...
   tanoAttributes = "objecttype=16777223:objectcrc=167499282:stfFile=wearables_name:stfName=dress_s34:stfDetail=:itemmask=62974::",
...
DraftSchematics:addDraftSchematic(luxuriousGown, 1229363511)--- Add to global DraftSchematics table
