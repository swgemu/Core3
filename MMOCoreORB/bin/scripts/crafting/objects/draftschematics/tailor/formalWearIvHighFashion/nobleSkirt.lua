...
nobleSkirt = Object:new {

   objectName = "Noble Skirt",
   stfName = "skirt_s11",
   stfFile = "wearables_name",
   objectCRC = 4243763113,
   ...
   tanoAttributes = "objecttype=16777234:objectcrc=2946835442:objecttemp=skirt_s11:templatetype=wearables_name:itemmask=62974::",
...
DraftSchematics:addDraftSchematic(nobleSkirt, 4243763113)--- Add to global DraftSchematics table
