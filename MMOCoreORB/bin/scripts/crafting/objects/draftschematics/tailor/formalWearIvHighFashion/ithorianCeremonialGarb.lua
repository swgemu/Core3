...
ithorianCeremonialGarb = Object:new {

   objectName = "Ithorian Ceremonial Garb",
   stfName = "ith_hat_s04",
   ...
   tanoAttributes = "objecttype=16777226:objectcrc=3281686452:stfFile=wearables_name:stfName=ith_hat_s04:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianCeremonialGarb, 374506976)--- Add to global DraftSchematics table
