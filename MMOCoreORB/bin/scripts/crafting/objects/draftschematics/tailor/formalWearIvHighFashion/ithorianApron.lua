...
ithorianApron = Object:new {

   objectName = "Ithorian Apron",
   stfName = "apron_chef_jacket_s01_ith",
   stfFile = "wearables_name",
   objectCRC = 3567680505,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=2484025416:stfFile=wearables_name:stfName=apron_chef_jacket_s01_ith:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianApron, 3567680505)--- Add to global DraftSchematics table
