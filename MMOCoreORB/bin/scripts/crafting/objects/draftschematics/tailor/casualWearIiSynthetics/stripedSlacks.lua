...
stripedSlacks = Object:new {

   objectName = "Striped Slacks",
   stfName = "pants_s08",
   stfFile = "wearables_name",
   objectCRC = 3671835785,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=597357025:objecttemp=pants_s08:templatetype=wearables_name:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(stripedSlacks, 3671835785)--- Add to global DraftSchematics table
