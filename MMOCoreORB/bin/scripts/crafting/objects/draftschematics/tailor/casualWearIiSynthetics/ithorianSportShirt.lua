...
ithorianSportShirt = Object:new {

   objectName = "Ithorian Sport Shirt",
   stfName = "ith_shirt_s13",
   stfFile = "wearables_name",
   objectCRC = 3473973427,
...
DraftSchematics:addDraftSchematic(ithorianSportShirt, 3473973427)--- Add to global DraftSchematics table
