...
ithorianBaggies = Object:new {

   objectName = "Ithorian Baggies",
   stfFile = "wearables_name",
   stfDetail = "wearables_detail",
   stfName = "ith_pants_s08",
   objectCRC = 1435631759,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=1270489349:stfFile=wearables_name:stfName=ith_pants_s08:stfDetail=wearables_detail:itemmask=63491:customattributes=:",
...
DraftSchematics:addDraftSchematic(ithorianBaggies, 1435631759)--- Add to global DraftSchematics table
