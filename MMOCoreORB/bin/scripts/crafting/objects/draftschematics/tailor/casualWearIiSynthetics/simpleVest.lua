...
simpleVest = Object:new {

   objectName = "Simple Vest",
   stfName = "vest_s04",
   stfFile = "wearables_name",
   objectCRC = 2341645274,
   ...
   tanoAttributes = "objecttype=16777231:objectcrc=1500370334:stfFile=wearables_name:stfName=vest_s04:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(simpleVest, 2341645274)--- Add to global DraftSchematics table
