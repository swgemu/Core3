...
heavyShoulderPad = Object:new {

   objectName = "Heavy Shoulder Pad",
   stfName = "wke_shoulder_pads_s01",
   stfFile = "wearables_name",
   objectCRC = 1660876305,
...
DraftSchematics:addDraftSchematic(heavyShoulderPad, 1660876305)--- Add to global DraftSchematics table
