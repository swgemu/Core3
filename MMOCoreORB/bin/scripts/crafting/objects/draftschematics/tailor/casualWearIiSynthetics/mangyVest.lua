...
mangyVest = Object:new {

   objectName = "Mangy Vest",
   stfName = "vest_s10",
   stfFile = "wearables_name",
   objectCRC = 2957911329,
   ...
   ingredientSlotType = "3, 0, 2",
   resourceTypes = "object/tangible/component/clothing/shared_synthetic_cloth.iff, fiberplast, ***BAD NAME***",
...
DraftSchematics:addDraftSchematic(mangyVest, 2957911329)--- Add to global DraftSchematics table
