...
ithorianMysticPants = Object:new {

   objectName = "Ithorian Mystic Pants",
   stfName = "ith_pants_s09",
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=45565576:stfFile=wearables_name:stfName=ith_pants_s09:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianMysticPants, 480208642)--- Add to global DraftSchematics table
