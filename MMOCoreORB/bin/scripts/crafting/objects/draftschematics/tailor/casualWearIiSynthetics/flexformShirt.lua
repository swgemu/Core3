...
flexformShirt = Object:new {

   objectName = "Flex-form Shirt",
   stfName = "shirt_s38",
   stfFile = "wearables_name",
   objectCRC = 3975664084,
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=3412040939:stfFile=wearables_name:stfName=shirt_s38:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(flexformShirt, 3975664084)--- Add to global DraftSchematics table
