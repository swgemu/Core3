...
beltedJacket = Object:new {

   objectName = "Belted Jacket",
   stfName = "jacket_s17",
   stfFile = "wearables_name",
   objectCRC = 4191972974,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=1041737598:stfFile=wearables_name:stfName=jacket_s17:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(beltedJacket, 4191972974)--- Add to global DraftSchematics table
