...
muscleShirt = Object:new {

   objectName = "Muscle Shirt",
   stfName = "shirt_s42",
   stfFile = "wearables_name",
   objectCRC = 2128362400,
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=1500804767:objecttemp=shirt_s42:templatetype=wearables_name:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(muscleShirt, 2128362400)--- Add to global DraftSchematics table
