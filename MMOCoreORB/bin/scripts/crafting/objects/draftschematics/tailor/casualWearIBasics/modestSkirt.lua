...
modestSkirt = Object:new {

   objectName = "Modest Skirt",
   stfName = "skirt_s05",
   stfFile = "wearables_name",
   objectCRC = 1861632636,
...
DraftSchematics:addDraftSchematic(modestSkirt, 1861632636)--- Add to global DraftSchematics table
