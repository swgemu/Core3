...
ithorianMysticShirt = Object:new {

   objectName = "Ithorian Mystic Shirt",
   stfName = "ith_shirt_s10",
   stfFile = "wearables_name",
   objectCRC = 3185535754,
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=678629574:stfFile=wearables_name:stfName=ith_shirt_s10:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianMysticShirt, 3185535754)--- Add to global DraftSchematics table
