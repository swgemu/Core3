...
bikiniLeggings = Object:new {

   objectName = "Bikini Leggings",
   stfName = "bikini_s01_leggings",
   stfFile = "wearables_name",
   objectCRC = 3560259623,
...
DraftSchematics:addDraftSchematic(bikiniLeggings, 3560259623)--- Add to global DraftSchematics table
