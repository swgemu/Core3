...
transportFlightsuit = Object:new {

   objectName = "Transport Flightsuit",
   stfName = "bodysuit_s08",
   stfFile = "wearables_name",
   objectCRC = 3174599388,
...
DraftSchematics:addDraftSchematic(transportFlightsuit, 3174599388)--- Add to global DraftSchematics table
