...
metalBikini = Object:new {

   objectName = "Metal Bikini",
   stfName = "bikini_s02",
   stfFile = "wearables_name",
   objectCRC = 4135956866,
...
DraftSchematics:addDraftSchematic(metalBikini, 4135956866)--- Add to global DraftSchematics table
