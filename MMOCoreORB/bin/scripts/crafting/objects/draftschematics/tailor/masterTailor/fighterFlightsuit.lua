...
fighterFlightsuit = Object:new {

   objectName = "Fighter Flightsuit",
   stfName = "bodysuit_s14",
   stfFile = "wearables_name",
   objectCRC = 2753336341,
   ...
   tanoAttributes = "objecttype=16777219:objectcrc=2736401933:stfFile=wearables_name:stfName=bodysuit_s14:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(fighterFlightsuit, 2753336341)--- Add to global DraftSchematics table
