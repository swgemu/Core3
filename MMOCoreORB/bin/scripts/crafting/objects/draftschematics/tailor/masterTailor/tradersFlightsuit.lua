...
tradersFlightsuit = Object:new {

   objectName = "Trader's Flightsuit",
   stfName = "bodysuit_s12",
   stfFile = "wearables_name",
   objectCRC = 1977831352,
   ...
   tanoAttributes = "objecttype=:objectcrc=301228692:stfFile=:stfName=:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(tradersFlightsuit, 1977831352)--- Add to global DraftSchematics table
