...
revealingBikini = Object:new {

   objectName = "Revealing Bikini",
   stfName = "bikini_s01",
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=798815144:objecttemp=bikini_s01:templatetype=wearables_name:itemmask=62974::",
...
DraftSchematics:addDraftSchematic(revealingBikini, 764549397)--- Add to global DraftSchematics table
