...
ithorianWarmJacket = Object:new {

   objectName = "Ithorian Warm Jacket",
   stfName = "ith_jacket_s12",
   stfFile = "wearables_name",
   objectCRC = 2292371763,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=191992475:stfFile=wearables_name:stfName=ith_jacket_s12:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianWarmJacket, 2292371763)--- Add to global DraftSchematics table
