...
ithorianRacingGear = Object:new {

   objectName = "Ithorian Racing Gear",
   stfName = "ith_hat_s03",
   stfFile = "wearables_name",
   objectCRC = 1147784666,
   ...
   tanoAttributes = "objecttype=16777226:objectcrc=947496096:stfFile=wearables_name:stfName=ith_hat_s03:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianRacingGear, 1147784666)--- Add to global DraftSchematics table
