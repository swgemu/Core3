...
decorativeDress = Object:new {

   objectName = "Decorative Dress",
   stfName = "dress_s05",
   stfFile = "wearables_name",
   objectCRC = 2230028828,
...
DraftSchematics:addDraftSchematic(decorativeDress, 2230028828)--- Add to global DraftSchematics table
