...
ithorianCasualShorts = Object:new {

   objectName = "Ithorian Casual Shorts",
   stfName = "ith_pants_s16",
   stfFile = "wearables_name",
   objectCRC = 3183298152,
   ...
   ingredientSlotType = "2, 0, 2, 1",
   resourceTypes = "object/tangible/component/clothing/shared_synthetic_cloth.iff, petrochem_inert, ***BAD NAME***, object/tangible/component/clothing/shared_synthetic_cloth.iff",
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=2744477666:stfFile=wearables_name:stfName=ith_pants_s16:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianCasualShorts, 3183298152)--- Add to global DraftSchematics table
