...
largeHeadwrap = Object:new {

   objectName = "Large Headwrap",
   stfName = "hat_s12",
   stfFile = "wearables_name",
   objectCRC = 2802613383,
...
DraftSchematics:addDraftSchematic(largeHeadwrap, 2802613383)--- Add to global DraftSchematics table
