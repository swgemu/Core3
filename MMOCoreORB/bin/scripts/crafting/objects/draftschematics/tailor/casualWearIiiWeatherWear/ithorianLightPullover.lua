...
ithorianLightPullover = Object:new {

   objectName = "Ithorian Light Pullover",
   stfName = "ith_jacket_s14",
...
DraftSchematics:addDraftSchematic(ithorianLightPullover, 978099626)--- Add to global DraftSchematics table
