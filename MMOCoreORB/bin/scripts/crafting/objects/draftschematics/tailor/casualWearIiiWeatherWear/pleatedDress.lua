...
pleatedDress = Object:new {

   objectName = "Pleated Dress",
   ...
   tanoAttributes = "objecttype=16777223:objectcrc=4287916301:stfFile=wearables_name:stfName=dress_s07:stfDetail=wearables_detail:itemmask=62974:customattributes=:",
...
DraftSchematics:addDraftSchematic(pleatedDress, 384910598)--- Add to global DraftSchematics table
