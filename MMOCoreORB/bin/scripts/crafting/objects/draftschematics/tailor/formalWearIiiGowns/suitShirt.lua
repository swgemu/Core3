...
suitShirt = Object:new {

   objectName = "Suit Shirt",
   stfName = "shirt_s32",
   stfFile = "wearables_name",
   objectCRC = 2531031782,
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=413947127:objecttemp=clothing_shirt_formal_32:templatetype=wearables_name:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(suitShirt, 2531031782)--- Add to global DraftSchematics table
