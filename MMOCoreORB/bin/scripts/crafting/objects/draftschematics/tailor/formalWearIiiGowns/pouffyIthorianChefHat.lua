...
pouffyIthorianChefHat = Object:new {

   objectName = "Pouffy Ithorian Chef Hat",
   stfName = "hat_chef_s01_ith",
   stfFile = "wearables_name",
   objectCRC = 1471257791,
   ...
   resourceTypes = "object/tangible/component/clothing/shared_synthetic_cloth.iff, petrochem_inert, object/tangible/component/clothing/shared_trim.iff, ***BAD NAME***",
   ...
   tanoAttributes = "objecttype=16777226:objectcrc=1415345053:stfFile=wearables_name:stfName=clothing_ith_hat_chef_01:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(pouffyIthorianChefHat, 1471257791)--- Add to global DraftSchematics table
