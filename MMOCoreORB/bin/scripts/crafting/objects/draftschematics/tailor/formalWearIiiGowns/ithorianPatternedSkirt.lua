...
ithorianPatternedSkirt = Object:new {

   objectName = "Ithorian Patterned Skirt",
   stfName = "ith_skirt_s03",
   stfFile = "wearables_name",
   objectCRC = 4203325901,
...
DraftSchematics:addDraftSchematic(ithorianPatternedSkirt, 4203325901)--- Add to global DraftSchematics table
