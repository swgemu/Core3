...
ithorianHeavyJacket = Object:new {

   objectName = "Ithorian Heavy Jacket",
   stfName = "ith_jacket_s10",
   stfFile = "wearables_name",
   objectCRC = 3009445127,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=2573950337:stfFile=wearables_name:stfName=ith_jacket_s10:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianHeavyJacket, 3009445127)--- Add to global DraftSchematics table
