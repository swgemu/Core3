...
decorativeHeaddress = Object:new {

   objectName = "Decorative Headdress",
   stfName = "hat_s13",
   stfFile = "wearables_name",
   objectCRC = 1205434404,
...
DraftSchematics:addDraftSchematic(decorativeHeaddress, 1205434404)--- Add to global DraftSchematics table
