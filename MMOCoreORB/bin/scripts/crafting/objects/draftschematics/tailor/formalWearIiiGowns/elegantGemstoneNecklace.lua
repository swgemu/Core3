...
elegantGemstoneNecklace = Object:new {

   objectName = "Elegant Gemstone Necklace",
   stfName = "necklace_s12",
   stfFile = "wearables_name",
   objectCRC = 3135044133,
...
DraftSchematics:addDraftSchematic(elegantGemstoneNecklace, 3135044133)--- Add to global DraftSchematics table
