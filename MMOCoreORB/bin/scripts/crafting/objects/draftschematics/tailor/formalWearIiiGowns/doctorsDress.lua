...
doctorsDress = Object:new {

   objectName = "Doctor's Dress",
   stfName = "dress_s19",
   stfFile = "wearables_name",
   objectCRC = 1460035791,
   ...
   tanoAttributes = "objecttype=:objectcrc=398143466:stfFile=:stfName=:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(doctorsDress, 1460035791)--- Add to global DraftSchematics table
