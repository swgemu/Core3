...
mabariArmorweaveChestPlate = Object:new {
   ...
   tanoAttributes = "objecttype=257:objectcrc=3303691594:stfFile=wearables_name:stfName=armor_zam_wesell_chest_plate:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=blasteffectiveness,heateffectiveness;vunerability=energyeffectiveness,acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4129;:",

   blueFrogAttributes = "specialprotection=blasteffectiveness,heateffectiveness;vunerability=energyeffectiveness,acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4129;",
   blueFrogEnabled = 1,
