...
chitinArmorLeggings = Object:new {
   ...
   tanoAttributes = "objecttype=260:objectcrc=1149232129:stfFile=wearables_name:stfName=armor_chitin_s01_leggings:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,heateffectiveness,coldeffectiveness,electricaleffectiveness,restraineffectiveness;armorPiece=262;armorStyle=4102;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,heateffectiveness,coldeffectiveness,electricaleffectiveness,restraineffectiveness;armorPiece=262;armorStyle=4102;",
   blueFrogEnabled = 1,
