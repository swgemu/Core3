...
ithorianGuardianBracerLeft = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=2320041547:stfFile=wearables_name:stfName=ith_armor_s02_bracer_l:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=258;armorStyle=4107;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=258;armorStyle=4107;",
   blueFrogEnabled = 1,
