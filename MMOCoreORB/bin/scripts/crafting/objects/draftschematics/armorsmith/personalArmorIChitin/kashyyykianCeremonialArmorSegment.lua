...
kashyyykianCeremonialArmorSegment = Object:new {

   objectName = "Kashyyykian Ceremonial Armor Segment",
   stfName = "armor_segment_kashyyykian_ceremonial",
   stfFile = "craft_clothing_ingredients_n",
   objectCRC = 1171031092,
   ...
   tanoAttributes = "objecttype=262145:objectcrc=3045138551:stfFile=craft_clothing_ingredients_n:stfName=armor_segment_kashyyykian_ceremonial:stfDetail=:itemmask=65535:customattributes=specialprotection=kineticeffectiveness;:",
...
DraftSchematics:addDraftSchematic(kashyyykianCeremonialArmorSegment, 1171031092)--- Add to global DraftSchematics table
