...
chitinArmorRightBicep = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=1314822802:stfFile=wearables_name:stfName=armor_chitin_s01_bicep_r:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,heateffectiveness,coldeffectiveness,electricaleffectiveness,restraineffectiveness;armorPiece=261;armorStyle=4102;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,heateffectiveness,coldeffectiveness,electricaleffectiveness,restraineffectiveness;armorPiece=261;armorStyle=4102;",
   blueFrogEnabled = 1,
