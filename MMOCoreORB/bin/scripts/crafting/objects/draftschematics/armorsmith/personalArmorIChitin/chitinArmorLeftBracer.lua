...
chitinArmorLeftBracer = Object:new {

   objectName = "Chitin Armor Left Bracer",
   stfName = "armor_chitin_s01_bracer_l",
   stfFile = "wearables_name",
   objectCRC = 2757715857,
...
DraftSchematics:addDraftSchematic(chitinArmorLeftBracer, 2757715857)--- Add to global DraftSchematics table
