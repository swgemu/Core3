...
ithorianGuardianBracerRight = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=4204544984:stfFile=wearables_name:stfName=ith_armor_s02_bracer_r:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=260;armorStyle=4107;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=260;armorStyle=4107;",
   blueFrogEnabled = 1,
