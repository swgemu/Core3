...
ithorianGuardianBicepRight = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=954579709:stfFile=wearables_name:stfName=ith_armor_s02_bicep_r:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=261;armorStyle=4107;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=261;armorStyle=4107;",
   blueFrogEnabled = 1,
