...
armorSegment = Object:new {

   objectName = "Armor Segment",
   stfName = "armor_segment",
   stfFile = "craft_armor_ingredients_n",
   objectCRC = 1286868407,
   ...
   tanoAttributes = "objecttype=262145:objectcrc=1357044619:stfFile=craft_clothing_ingredients_n:stfName=armor_segment:stfDetail=:itemmask=65535:customattributes=specialprotection=energyeffectiveness;:",
...
DraftSchematics:addDraftSchematic(armorSegment, 1286868407)--- Add to global DraftSchematics table
