...
ithorianGuardianBoots = Object:new {
   ...
   tanoAttributes = "objecttype=263:objectcrc=2071589825:stfFile=wearables_name:stfName=ith_armor_s02_boots:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4107;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4107;",
   blueFrogEnabled = 1,
