...
ithorianGuardianHelmet = Object:new {
   ...
   tanoAttributes = "objecttype=258:objectcrc=2210419364:stfFile=wearables_name:stfName=clothing_armor_ithorian_guardian_helmet:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=264;armorStyle=4107;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=264;armorStyle=4107;",
   blueFrogEnabled = 1,
