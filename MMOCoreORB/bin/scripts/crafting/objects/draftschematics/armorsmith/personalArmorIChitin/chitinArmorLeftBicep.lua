...
chitinArmorLeftBicep = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=1049353985:stfFile=wearables_name:stfName=armor_chitin_s01_bicep_l:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,heateffectiveness,coldeffectiveness,electricaleffectiveness,restraineffectiveness;armorPiece=259;armorStyle=4102;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,heateffectiveness,coldeffectiveness,electricaleffectiveness,restraineffectiveness;armorPiece=259;armorStyle=4102;",
   blueFrogEnabled = 1,
