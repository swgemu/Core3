...
chitinArmorLeftBicep = Object:new {

   objectName = "Chitin Armor Left Bicep",
   stfName = "armor_chitin_s01_bicep_l",
   stfFile = "wearables_name",
   objectCRC = 3047595124,
...
DraftSchematics:addDraftSchematic(chitinArmorLeftBicep, 3047595124)--- Add to global DraftSchematics table
