...
chitinArmorChestPlate = Object:new {

   objectName = "Chitin Armor Chest Plate",
   stfName = "armor_chitin_s01_chest_plate",
   stfFile = "wearables_name",
   objectCRC = 1335874545,
...
DraftSchematics:addDraftSchematic(chitinArmorChestPlate, 1335874545)--- Add to global DraftSchematics table
