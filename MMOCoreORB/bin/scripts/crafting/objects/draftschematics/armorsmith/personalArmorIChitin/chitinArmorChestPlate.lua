...
chitinArmorChestPlate = Object:new {
   ...
   tanoAttributes = "objecttype=257:objectcrc=590081831:stfFile=wearables_name:stfName=armor_chitin_s01_chest_plate:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,heateffectiveness,coldeffectiveness,electricaleffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4102;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,heateffectiveness,coldeffectiveness,electricaleffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4102;",
   blueFrogEnabled = 1,
