...
ithorianGuardianLeggings = Object:new {

   objectName = "Ithorian Guardian Leggings",
   stfName = "ith_armor_s02_leggings",
...
DraftSchematics:addDraftSchematic(ithorianGuardianLeggings, 571547680)--- Add to global DraftSchematics table
