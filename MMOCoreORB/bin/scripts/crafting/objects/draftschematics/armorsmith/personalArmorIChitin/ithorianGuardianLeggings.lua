...
ithorianGuardianLeggings = Object:new {
   ...
   tanoAttributes = "objecttype=260:objectcrc=91085652:stfFile=wearables_name:stfName=ith_armor_s02_leggings:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=262;armorStyle=4107;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=262;armorStyle=4107;",
   blueFrogEnabled = 1,
