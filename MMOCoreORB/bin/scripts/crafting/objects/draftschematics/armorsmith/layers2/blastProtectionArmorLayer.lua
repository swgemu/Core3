...
blastProtectionArmorLayer = Object:new {

   objectName = "Blast Protection Armor Layer", -- name of the lua Object
   stfName = "armor_layer_blast", 
   objectCRC = 180189865, 
   groupName = "craftArmorLightLayersGroupB", 
...
DraftSchematics:addDraftSchematic(blastProtectionArmorLayer, 180189865)--- Add to global DraftSchematics table
