...
kashyyykianHuntingArmorSegment = Object:new {
   ...
   objectName = "Kashyyykian Hunting Armor Segment", -- name of the lua Object
  ...
  numberExperimentalProperties = "1, 1, 1, 2, 2, 2, 2, 2, 1, 1, 2",
   ...
   tanoAttributes = "objecttype=262144:objectcrc=3253647713:objecttemp=armor_segment_kashyyykian_hunting:templatetype=craft_armor_ingredients_n:",
