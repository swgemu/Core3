...
tantelArmorChestPlate = Object:new {

   objectName = "Tantel Armor Chest Plate",
   stfName = "armor_tantel_skreej_chest_plate",
   stfFile = "wearables_name",
   objectCRC = 1482977914,
...
DraftSchematics:addDraftSchematic(tantelArmorChestPlate, 1482977914)--- Add to global DraftSchematics table
