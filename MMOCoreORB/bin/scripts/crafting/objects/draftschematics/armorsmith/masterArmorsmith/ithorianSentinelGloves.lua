...
ithorianSentinelGloves = Object:new {
   ...
   tanoAttributes = "objecttype=262:objectcrc=2451608631:stfFile=wearables_name:stfName=ith_armor_s03_gloves:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=257;armorStyle=4108;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=257;armorStyle=4108;",
   blueFrogEnabled = 1,
