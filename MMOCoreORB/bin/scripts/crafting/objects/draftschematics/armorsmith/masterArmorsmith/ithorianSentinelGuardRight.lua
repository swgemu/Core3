...
ithorianSentinelGuardRight = Object:new {

   objectName = "Ithorian Sentinel Guard (Right)",
   stfName = "ith_armor_s03_bicep_r",
   stfFile = "wearables_name",
   objectCRC = 1695669753,
   ...
   tanoAttributes = "objecttype=261:objectcrc=4155123702:stfFile=wearables_name:stfName=ith_armor_s03_bicep_r:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness;armorPiece=261;armorStyle=4108;:",
...
DraftSchematics:addDraftSchematic(ithorianSentinelGuardRight, 1695669753)--- Add to global DraftSchematics table
