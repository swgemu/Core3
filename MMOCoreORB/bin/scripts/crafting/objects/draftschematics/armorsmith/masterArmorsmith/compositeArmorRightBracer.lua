...
compositeArmorRightBracer = Object:new {

   objectName = "Composite Armor Right Bracer",
   stfName = "armor_composite_bracer_r",
   stfFile = "wearables_name",
   objectCRC = 2947933831,
...
DraftSchematics:addDraftSchematic(compositeArmorRightBracer, 2947933831)--- Add to global DraftSchematics table
