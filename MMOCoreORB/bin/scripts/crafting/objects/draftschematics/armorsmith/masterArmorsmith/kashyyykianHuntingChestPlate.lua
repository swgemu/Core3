...
kashyyykianHuntingChestPlate = Object:new {
   ...
   tanoAttributes = "objecttype=257:objectcrc=3776759545:stfFile=wearables_name:stfName=armor_kashyyykian_hunting_chest_plate:stfDetail=wearables_detail:itemmask=61955:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4111;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4111;",
   blueFrogEnabled = 1,
