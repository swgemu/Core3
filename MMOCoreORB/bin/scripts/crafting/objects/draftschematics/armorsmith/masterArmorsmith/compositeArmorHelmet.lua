...
compositeArmorHelmet = Object:new {

   objectName = "Composite Armor Helmet",
   stfName = "armor_composite_helmet",
   stfFile = "wearables_name",
   objectCRC = 4114805601,
...
DraftSchematics:addDraftSchematic(compositeArmorHelmet, 4114805601)--- Add to global DraftSchematics table
