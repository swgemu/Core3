...
ithorianSentinelChestPlate = Object:new {

   objectName = "Ithorian Sentinel Chest Plate",
   stfName = "ith_armor_s03_chest_plate",
   stfFile = "wearables_name",
   objectCRC = 3252204608,
...
DraftSchematics:addDraftSchematic(ithorianSentinelChestPlate, 3252204608)--- Add to global DraftSchematics table
