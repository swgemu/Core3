...
ithorianSentinelBracerLeft = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=2685476975:stfFile=wearables_name:stfName=ith_armor_s03_bracer_l:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=258;armorStyle=4108;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=258;armorStyle=4108;",
   blueFrogEnabled = 1,
