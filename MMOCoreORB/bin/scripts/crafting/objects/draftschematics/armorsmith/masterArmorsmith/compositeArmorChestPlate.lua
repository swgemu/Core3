...
compositeArmorChestPlate = Object:new {
   ...
   tanoAttributes = "objecttype=257:objectcrc=2068279078:stfFile=wearables_name:stfName=armor_composite_chest_plate:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=electricaleffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4097;:",

   blueFrogAttributes = "specialprotection=electricaleffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4097;",
   blueFrogEnabled = 1,
