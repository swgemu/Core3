...
ithorianSentinelLeggings = Object:new {

   objectName = "Ithorian Sentinel Leggings",
   stfName = "ith_armor_s03_leggings",
   stfFile = "wearables_name",
   objectCRC = 3092312704,
...
DraftSchematics:addDraftSchematic(ithorianSentinelLeggings, 3092312704)--- Add to global DraftSchematics table
