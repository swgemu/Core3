...
ithorianSentinelHelmet = Object:new {

   objectName = "Ithorian Sentinel Helmet",
   stfName = "ith_armor_s03_helmet",
...
DraftSchematics:addDraftSchematic(ithorianSentinelHelmet, 760219445)--- Add to global DraftSchematics table
