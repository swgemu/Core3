...
compositeArmorRightBicep = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=1668390786:stfFile=wearables_name:stfName=armor_composite_bicep_r:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=electricaleffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=261;armorStyle=4097;:",

   blueFrogAttributes = "specialprotection=electricaleffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=261;armorStyle=4097;",
   blueFrogEnabled = 1,
