...
kineticProtectionArmorLayer = Object:new {

   objectName = "Kinetic Protection Armor Layer",
   stfName = "armor_layer_kinetic",
   stfFile = "craft_armor_ingredients_n",
   objectCRC = 4175436808,
   ...
   tanoAttributes = "objecttype=262145:objectcrc=2095312993:stfFile=craft_armor_ingredients_n:stfName=armor_layer_kinetic:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(kineticProtectionArmorLayer, 4175436808)--- Add to global DraftSchematics table
