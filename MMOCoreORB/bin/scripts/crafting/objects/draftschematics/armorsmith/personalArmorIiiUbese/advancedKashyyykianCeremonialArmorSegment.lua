...
advancedKashyyykianCeremonialArmorSegment = Object:new {

   objectName = "Advanced Kashyyykian Ceremonial Armor Segment",
   stfName = "armor_segment_kashyyykian_ceremonial_advanced",
   stfFile = "craft_clothing_ingredients_n",
   objectCRC = 1897422446,
   ...
   tanoAttributes = "objecttype=262145:objectcrc=2163584319:stfFile=craft_clothing_ingredients_n:stfName=armor_segment_kashyyykian_ceremonial_advanced:stfDetail=:itemmask=65535:customattributes=specialprotection=kineticeffectiveness;:",
...
DraftSchematics:addDraftSchematic(advancedKashyyykianCeremonialArmorSegment, 1897422446)--- Add to global DraftSchematics table
