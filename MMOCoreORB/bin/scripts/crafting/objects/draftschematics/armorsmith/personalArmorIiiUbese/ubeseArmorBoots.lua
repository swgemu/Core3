...
ubeseArmorBoots = Object:new {

   objectName = "Ubese Armor Boots",
   stfName = "armor_ubese_boots",
   stfFile = "wearables_name",
   objectCRC = 1268014346,
...
DraftSchematics:addDraftSchematic(ubeseArmorBoots, 1268014346)--- Add to global DraftSchematics table
