...
ubeseArmorSegment = Object:new {

   objectName = "Ubese Armor Segment",
   stfName = "armor_segment_ubese",
   stfFile = "craft_clothing_ingredients_n",
   objectCRC = 3533039838,
   ...
   tanoAttributes = "objecttype=262144:objectcrc=2314491777:objecttemp=armor_segment_ubese:templatetype=craft_clothing_ingredients_n:itemmask=65535:customattributes=specialprotection=kineticeffectiveness;vunerability=;armorType=262144;armorStyle=;:",
...
DraftSchematics:addDraftSchematic(ubeseArmorSegment, 3533039838)--- Add to global DraftSchematics table
