...
ubeseArmorLeftBracer = Object:new {

   objectName = "Ubese Armor Left Bracer",
   stfName = "armor_ubese_bracer_l",
   stfFile = "wearables_name",
   objectCRC = 1416333578,
...
DraftSchematics:addDraftSchematic(ubeseArmorLeftBracer, 1416333578)--- Add to global DraftSchematics table
