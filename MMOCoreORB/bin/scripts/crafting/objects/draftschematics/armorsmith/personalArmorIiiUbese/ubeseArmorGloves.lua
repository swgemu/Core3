...
ubeseArmorGloves = Object:new {
   ...
   tanoAttributes = "objecttype=262:objectcrc=1597327192:stfFile=wearables_name:stfName=armor_ubese_gloves:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=257;armorStyle=4127;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=257;armorStyle=4127;",
   blueFrogEnabled = 1,
