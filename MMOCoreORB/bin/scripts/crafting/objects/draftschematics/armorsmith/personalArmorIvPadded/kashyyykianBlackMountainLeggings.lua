...
kashyyykianBlackMountainLeggings = Object:new {

   objectName = "Kashyyykian Black Mountain Leggings",
   stfName = "armor_kashyyykian_black_mtn_leggings",
...
DraftSchematics:addDraftSchematic(kashyyykianBlackMountainLeggings, 770408031)--- Add to global DraftSchematics table
