...
ithorianDefenderBoots = Object:new {
   ...
   tanoAttributes = "objecttype=263:objectcrc=2766594033:stfFile=wearables_name:stfName=ith_armor_s01_boots:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4106;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4106;",
   blueFrogEnabled = 1,
