...
paddedArmorRightBicep = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=2918354957:objecttemp=clothing_armor_padded_bicep_r:templatetype=wearables_name:itemmask=62975:customattributes=specialprotection=blasteffectiveness;vunerability=stuneffectiveness,heateffectiveness,acideffectiveness;armorType=261;armorStyle=4121;:",
