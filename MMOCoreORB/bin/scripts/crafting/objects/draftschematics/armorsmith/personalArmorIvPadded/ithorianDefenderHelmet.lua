...
ithorianDefenderHelmet = Object:new {

   objectName = "Ithorian Defender Helmet",
   stfName = "ith_armor_s01_helmet",
   ...
   tanoAttributes = "objecttype=258:objectcrc=892900592:stfFile=wearables_name:stfName=ith_armor_s01_helmet:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness;armorPiece=264;armorStyle=4106;:",
...
DraftSchematics:addDraftSchematic(ithorianDefenderHelmet, 720169382)--- Add to global DraftSchematics table
