...
paddedArmorLeftBicep = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=3710375326:stfFile=wearables_name:stfName=armor_padded_s01_bicep_l:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=259;armorStyle=4128;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=259;armorStyle=4128;",
   blueFrogEnabled = 1,
