...
paddedArmorLeftBicep = Object:new {

   objectName = "Padded Armor Left Bicep",
   stfName = "armor_padded_s01_bicep_l",
...
DraftSchematics:addDraftSchematic(paddedArmorLeftBicep, 18400770)--- Add to global DraftSchematics table
