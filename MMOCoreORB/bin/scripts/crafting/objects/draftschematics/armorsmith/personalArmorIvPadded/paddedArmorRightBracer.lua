...
paddedArmorRightBracer = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=3748586285:stfFile=wearables_name:stfName=armor_padded_s01_bicep_r:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=260;armorStyle=4128;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=260;armorStyle=4128;",
   blueFrogEnabled = 1,
