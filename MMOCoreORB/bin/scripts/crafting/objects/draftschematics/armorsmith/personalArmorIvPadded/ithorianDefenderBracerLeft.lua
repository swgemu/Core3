...
ithorianDefenderBracerLeft = Object:new {

   objectName = "Ithorian Defender Bracer (Left)",
   stfName = "ith_armor_s01_bracer_l",
   stfFile = "wearables_name",
   objectCRC = 1712998399,
...
DraftSchematics:addDraftSchematic(ithorianDefenderBracerLeft, 1712998399)--- Add to global DraftSchematics table
