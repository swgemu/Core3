...
paddedArmorGloves = Object:new {

   objectName = "Padded Armor Gloves",
   stfName = "armor_padded_s01_gloves",
   stfFile = "wearables_name",
   objectCRC = 1613154645,
...
DraftSchematics:addDraftSchematic(paddedArmorGloves, 1613154645)--- Add to global DraftSchematics table
