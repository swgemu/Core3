...
kashyyykianBlackMountainChestPlate = Object:new {

   objectName = "Kashyyykian Black Mountain Chest Plate",
   stfName = "armor_kashyyykian_black_mtn_chest_plate",
   stfFile = "wearables_name",
   objectCRC = 4154804782,
   ...
   ingredientSlotType = "0, 0, 0, 0, 0, 1, 1, 2, 0",
   ...
   tanoAttributes = "objecttype=257:objectcrc=2677805339:stfFile=wearables_name:stfName=armor_kashyyykian_black_mtn_chest_plate:stfDetail=:itemmask=61955:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness;armorPiece=256;armorStyle=4109;:",
...
DraftSchematics:addDraftSchematic(kashyyykianBlackMountainChestPlate, 4154804782)--- Add to global DraftSchematics table
