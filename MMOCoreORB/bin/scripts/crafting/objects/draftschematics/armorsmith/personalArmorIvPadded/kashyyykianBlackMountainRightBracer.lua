...
kashyyykianBlackMountainRightBracer = Object:new {

   objectName = "Kashyyykian Black Mountain Right Bracer",
   stfName = "armor_kashyyykian_black_mtn_bracer_r",
   stfFile = "wearables_name",
   objectCRC = 3524978387,
...
DraftSchematics:addDraftSchematic(kashyyykianBlackMountainRightBracer, 3524978387)--- Add to global DraftSchematics table
