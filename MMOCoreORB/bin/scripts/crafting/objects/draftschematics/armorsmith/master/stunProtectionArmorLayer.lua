...
stunProtectionArmorLayer = Object:new {

   objectName = "Stun Protection Armor Layer", -- name of the lua Object
   stfName = "armor_layer_stun", 
   objectCRC = 2919500503, 
...
DraftSchematics:addDraftSchematic(stunProtectionArmorLayer, 2919500503)--- Add to global DraftSchematics table
