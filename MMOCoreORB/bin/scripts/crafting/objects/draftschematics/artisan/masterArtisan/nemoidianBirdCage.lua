...
nemoidianBirdCage = Object:new {
   ...
   tanoAttributes = "objecttype=8211:objectcrc=1639031767:stfFile=item_n:stfName=bird_cage:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(nemoidianBirdCage, 2785425064)--- Add to global DraftSchematics table
