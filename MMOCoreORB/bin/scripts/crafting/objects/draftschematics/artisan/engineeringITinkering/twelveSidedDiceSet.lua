...
twelveSidedDiceSet = Object:new {
   ...
   tanoAttributes = "objecttype=8211:objectcrc=2176227197:stfFile=dice/dice_details:stfName=eqp_twelve_sided_dice_set_single:stfDetail=:itemmask=65535:customattributes=:",
