...
type5Firework = Object:new {

   objectName = "Type 5 Firework",
   stfName = "firework_five",
   stfFile = "firework_n",
   objectCRC = 879669640,
...
DraftSchematics:addDraftSchematic(type5Firework, 879669640)--- Add to global DraftSchematics table
