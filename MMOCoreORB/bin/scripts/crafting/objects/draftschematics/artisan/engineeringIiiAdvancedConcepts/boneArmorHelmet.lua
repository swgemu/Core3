...
boneArmorHelmet = Object:new {
   ...
   tanoAttributes = "objecttype=258:objectcrc=1186889343:stfFile=wearables_name:stfName=armor_bone_s01_helmet:stfDetail=wearables_detail:itemmask=62975:customattributes=specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness,coldeffectiveness;armorPiece=264;armorStyle=4129;:",

   blueFrogAttributes = "specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness,coldeffectiveness;armorPiece=264;armorStyle=4129;",
   blueFrogEnabled = 1,
