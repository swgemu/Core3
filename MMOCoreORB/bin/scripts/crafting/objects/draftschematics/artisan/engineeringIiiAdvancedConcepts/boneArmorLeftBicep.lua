...
boneArmorLeftBicep = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=2085871516:stfFile=wearables_name:stfName=armor_bone_s01_bicep_l:stfDetail=wearables_detail:itemmask=62975:customattributes=specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness,coldeffectiveness;armorPiece=259;armorStyle=4129;:",

   blueFrogAttributes = "specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness,coldeffectiveness;armorPiece=259;armorStyle=4129;",
   blueFrogEnabled = 1,
