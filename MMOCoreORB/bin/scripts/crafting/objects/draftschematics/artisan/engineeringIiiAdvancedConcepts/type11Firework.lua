...
type11Firework = Object:new {

   objectName = "Type 11 Firework",
   stfName = "firework_s11",
   stfFile = "firework_n",
   objectCRC = 2713986341,
   ...
   tanoAttributes = "objecttype=8209:objectcrc=243655837:stfFile=firework_n:stfName=firework_s11:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(type11Firework, 2713986341)--- Add to global DraftSchematics table
