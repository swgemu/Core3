...
type1Firework = Object:new {
   ...
   tanoAttributes = "objecttype=8209:objectcrc=4192390072:stfFile=firework_n:stfName=firework_one:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(type1Firework, 2052759177)--- Add to global DraftSchematics table
