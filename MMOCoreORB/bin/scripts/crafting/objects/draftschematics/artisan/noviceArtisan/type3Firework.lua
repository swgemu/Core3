...
type3Firework = Object:new {

   objectName = "Type 3 Firework",
   stfName = "firework_three",
   stfFile = "firework_n",
   objectCRC = 1853917921,
   ...
   tanoAttributes = "objecttype=8209:objectcrc=1356885356:stfFile=firework_n:stfName=firework_three:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(type3Firework, 1853917921)--- Add to global DraftSchematics table
