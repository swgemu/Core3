...
type2Firework = Object:new {

   objectName = "Type 2 Firework",
   stfName = "firework_two",
   stfFile = "firework_n",
   objectCRC = 2570243587,
   ...
   tanoAttributes = "objecttype=8209:objectcrc=445291314:stfFile=firework_n:stfName=firework_two:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(type2Firework, 2570243587)--- Add to global DraftSchematics table
