...
lightFoodAdditive = Object:new {
   ...
   tanoAttributes = "objecttype=8224:objectcrc=1231667281:stfFile=food_name:stfName=food_additive_light:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(lightFoodAdditive, 363998896)--- Add to global DraftSchematics table
