...
dustcrepe = Object:new {
   ...
   experimentalProperties = "XX, XX, XX, PE, OQ, DR, PE, DR, OQ",
   experimentalWeights = "1, 1, 1, 2, 1, 1, 3, 3, 1",
...
DraftSchematics:addDraftSchematic(dustcrepe, 451779682)--- Add to global DraftSchematics table
