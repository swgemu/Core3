...
rubyBliel = Object:new {
   ...
   tanoAttributes = "objecttype=8216:objectcrc=4051771038:stfFile=food_name:stfName=ruby_bliel:stfDetail=food_detail:itemmask=65535:customattributes=effectType=3;buffName=food.heal_recovery;modifierString=heal_recovery;fillingMin=22;fillingMax=18;flavorMin=12;flavorMax=22;nutritionMin=20;nutritionMax=35;quantityMin=4;quantityMax=5;:",
