...
pocketedWorkPants = Object:new {

   objectName = "Pocketed Work Pants",
   stfName = "pants_s04",
   stfFile = "wearables_name",
   objectCRC = 3383314547,
   ...
   tanoAttributes = "objecttype=:objectcrc=1116173668:objecttemp=pants_s04:templatetype=wearables_name:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(pocketedWorkPants, 3383314547)--- Add to global DraftSchematics table
