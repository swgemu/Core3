...
boneArmorChestPlate = Object:new {

   objectName = "Bone Armor Chest Plate",
   stfName = "armor_bone_s01_chest_plate",
   ...
   resourceQuantities = "40, 40, 40, 25, 25, 25, 1, 1, 1",
...
DraftSchematics:addDraftSchematic(boneArmorChestPlate, 450361637)--- Add to global DraftSchematics table
