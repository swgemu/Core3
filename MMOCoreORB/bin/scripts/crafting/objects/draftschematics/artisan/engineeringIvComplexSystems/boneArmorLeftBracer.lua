...
boneArmorLeftBracer = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=778039047:stfFile=wearables_name:stfName=armor_bone_s01_bracer_l:stfDetail=wearables_detail:itemmask=62975:customattributes=specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness;armorPiece=258;armorStyle=4129;:",

   blueFrogAttributes = "specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness;armorPiece=258;armorStyle=4129;",
   blueFrogEnabled = 1,
