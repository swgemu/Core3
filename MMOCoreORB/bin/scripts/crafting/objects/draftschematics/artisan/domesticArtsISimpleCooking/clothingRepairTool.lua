...
clothingRepairTool = Object:new {
   ...
   tanoAttributes = "objecttype=32771:objectcrc=4032677980:stfFile=crafting:stfName=clothing_repair_name:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(clothingRepairTool, 2082185823)--- Add to global DraftSchematics table
