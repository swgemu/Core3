...
treedwellersHood = Object:new {

   objectName = "Tree-Dweller's Hood",
   stfName = "wke_hood_s01",
   stfFile = "wearables_name",
   objectCRC = 3381032072,
   ...
   tanoAttributes = "objecttype=:objectcrc=773028987:stfFile=:stfName=:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(treedwellersHood, 3381032072)--- Add to global DraftSchematics table
