...
caf = Object:new {
   ...
   tanoAttributes = "objecttype=:objectcrc=2701899786:stfFile=food_name:stfName=caf:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(caf, 3676820545)--- Add to global DraftSchematics table
