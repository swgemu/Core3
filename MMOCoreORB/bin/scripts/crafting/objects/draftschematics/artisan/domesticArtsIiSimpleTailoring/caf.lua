...
caf = Object:new {
   ...
   tanoAttributes = "objecttype=8216:objectcrc=2701899786:stfFile=food_name:stfName=caf:stfDetail=food_detail:itemmask=65535:customattributes=effectType=1;buffName=food.drink_caf;modifierString=willpower;fillingMin=17;fillingMax=10;flavorMin=1800;flavorMax=3600;nutritionMin=35;nutritionMax=60;quantityMin=6;quantityMax=10;:",
