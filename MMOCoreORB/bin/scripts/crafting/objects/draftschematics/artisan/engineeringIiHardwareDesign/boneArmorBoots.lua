...
boneArmorBoots = Object:new {
   ...
   tanoAttributes = "objecttype=263:objectcrc=802627120:stfFile=wearables_name:stfName=armor_bone_s01_boots:stfDetail=wearables_detail:itemmask=62967:customattributes=specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness,coldeffectiveness;armorPiece=263;armorStyle=4129;:",

   blueFrogAttributes = "specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness,coldeffectiveness;armorPiece=263;armorStyle=4129;",
   blueFrogEnabled = 1,
