...
boneArmorGloves = Object:new {

   objectName = "Bone Armor Gloves",
   stfName = "armor_bone_s01_gloves",
   stfFile = "wearables_name",
   objectCRC = 2920088501,
   ...
   resourceQuantities = "10, 10, 10, 5, 3, 5, 1, 1, 1",
...
DraftSchematics:addDraftSchematic(boneArmorGloves, 2920088501)--- Add to global DraftSchematics table
