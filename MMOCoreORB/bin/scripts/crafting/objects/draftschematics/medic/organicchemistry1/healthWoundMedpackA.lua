...
healthWoundMedpackA = Object:new {

   objectName = "Health Wound Medpack  A", -- name of the lua Object
   stfName = "medpack_wound_health_a", 
   objectCRC = 4145474083, 
   groupName = "craftMedpackGroupA", 
   ...
   tanoAttributes = "objecttype=8205:objectcrc=1826587380:objecttemp=medpack_wound_health_a:templatetype=medicine_name:",
   ...
   attributesMinMax = "1, 10, 1, 50, 5, 5, 1, 1"

}

DraftSchematics:addDraftSchematic(healthWoundMedpackA, 4145474083)--- Add to global DraftSchematics table
