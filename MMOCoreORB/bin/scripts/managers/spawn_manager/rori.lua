...
rori_regions = {
	...
	{"world_spawner",0,0,-1,3,1,"rori_world_creatures"},
}
...
rori_badges = {
	{"badge_imp_camp",-5633,-5661,30,96},
	{"badge_imp_hyperdrive_fac",-1130,4544,30,97},
	{"badge_kobala_spice_mine",7371,169,30,94},
	{"badge_rebel_outpost",3664,-6501,30,95},
}
