...
dantooine_regions = {
	...
	{"eastern_steppes_1",0,0,{1,0},UNDEFINEDAREA,1},
        ...
        {"fence",-4723,4023,{1,30},STATICSPAWNAREA + NOSPAWNAREA + NOBUILDZONEAREA,1},
	...
	{"jedi_temple_1",0,0,{1,0},UNDEFINEDAREA,1},
        ...
        {"large_stone_hut",3198,6006,{1,30},STATICSPAWNAREA + NOSPAWNAREA + NOBUILDZONEAREA,1},
	...
	{"river_9",0,0,{1,0},UNDEFINEDAREA,1},
        ...
        {"ruins_3",442,4606,{1,30},STATICSPAWNAREA + NOSPAWNAREA + NOBUILDZONEAREA,1},
        {"skeleton",-3791,2591,{1,25},STATICSPAWNAREA + NOSPAWNAREA + NOBUILDZONEAREA,1},
        {"skeleton_2",-3793,2943,{1,25},STATICSPAWNAREA + NOSPAWNAREA + NOBUILDZONEAREA,1},
        {"skeleton_3",7019,1009,{1,25},STATICSPAWNAREA + NOSPAWNAREA + NOBUILDZONEAREA,1},
	...
	{"southwestern_steppes_1",0,0,{1,0},UNDEFINEDAREA,1},
        ...
        {"statue_and_columns",-4794,6369,{1,50},STATICSPAWNAREA + NOSPAWNAREA + NOBUILDZONEAREA,1},
        ...
        {"stone_marker",3735,3359,{1,30},STATICSPAWNAREA + NOSPAWNAREA + NOBUILDZONEAREA,1},
        {"stone_pillars",-7827,4320,{1,30},STATICSPAWNAREA + NOSPAWNAREA + NOBUILDZONEAREA,1},
