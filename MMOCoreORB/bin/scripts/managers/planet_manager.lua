...
endor = {
	...
	planetTravelPoints = {
		{name = "Smuggler Outpost", x = -950.59241, z = 73, y = 1553.4125, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, incomingTravelAllowed = 1},
		{name = "Research Outpost", x = 3201.6599, z = 24, y = -3499.76, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, incomingTravelAllowed = 1}
	},
...
rori = {
	...
	planetTravelPoints = {
		{name = "Restuss Starport", x = 5394.64, z = 80, y = 5770.13, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1},
