...
dathomir = {
	...
	navAreas = {
		{"ancient_stone_hut",3490,-395,15},
		{"burial_site_nw",-5259,1299,25},
		{"burial_site_west",-7124,1174,10},
		{"ceremonial_site",1072,-4485,30},
		{"decorative_rock",-999,856,25},
		{"destroyed_rebel_base",-4705,-4772,50},
		{"empty_hut",-6894,-4854,20},
		{"fenced_building",50,-164,15},
		{"floating_rocks_ne",3000,5145,20},
		{"floating_rocks_sw_2",-6603,-745,60},
		{"free_slaves_and_huts",7205,5560,20},
		{"imperial_prison",-6360,930,225},
		{"lookout_station",-4573,-6556,25},
		{"nightsister_beach_tower",915,6858,25},
		{"nightsister_camp",1070,-4490,50},
		{"nightsister_guard_camp",-4179,-854,30},
		{"nightsister_outcast_camp",-2597,4953,25},
		{"nightsister_outcasts_home",-3250,-6585,15},
		{"nightsister_stalkers_home",-2933,-1025,15},
		{"nightsister_stronghold",-4050,-175,200},
		{"rebel_camp_dathomir_nw",-50,86,25},
		{"sentry_tower",1555,-64,5},
		{"singing_mountain_clan_arch",1125,-1022,10},
		{"singing_mountain_clan_hut",5556,-688,10},
		{"singing_mountain_clan_outcasts_hut",7480,-912,10},
		{"singing_mountain_clan_rock_se",5205,-3084,10},
		{"singing_mountain_clan_rock_sw",-2419,-3111,15},
		{"singing_mountain_clan_village",530,4205,100},
		{"singing_mountain_clan_village_nw",-7081,5888,50},
		{"spell_weavers_trees",-850,2195,25},
		{"spiderclan_floating_rocks",-7120,2931,15},
		{"spiderclan_stone_arch",7070,-6440,10},
		{"torch",-2610,-4861,5},
		{"tower_and_stones",-443,-1156,10},
		{"tree_hut",-5045,-2773,15},
		{"wall",7442,-3024,20},
		{"worship_stone",-6953,-3032,20},
	},
...
lok = {
	...
	navAreas = {
		...
		{"broken_wall_lok",-4433,-5750,10},
		{"camp_ruins",5075,-4117,15},
		{"canyon_corsair_stronghold",-3868,-3820,75},
		{"downed_blood_razor_transport",3640,2178,128},
		{"great_maze",3827,-540,50},
		{"gurk_camp",-3763,-3477,10},
		{"imperial_lookout",-2569,-861,15},
		{"imperial_outpost_lok",-1913,-3082,150},
		{"kimogila_town",-78,2710,50},
		{"lokkian_fountain",6399,5102,32},
		{"rebel_house",-4751,3525,75},
		{"torches_and_arches",716,-3380,15},
	},
...
naboo = {
	...
	navAreas = {
		{"amidala's_beach",-5526,-31,128},
		{"arch_and_debris",-6592,-2682,15},
		{"arch_and_statue",-4421,-2224,15},
		{"beach_crashed_pod",433,6975,10},
		{"beach_gungan_ruins",7570,6968,32},
		{"broken_wall_naboo",3485,-2882,10},
		{"crashed_escape_pod_naboo",-2433,-2492,10},
		{"emperor's_retreat",2415,-3921,100},
		{"fire_and_pillars",-1775,-487,10},
		{"fishing_pond",-6312,-5086,10},
		{"gate_and_gazebo",-258,-61,25},
		{"gazebo_naboo",1012,-3464,15},
		{"gungan_ruins",0,-1866,10},
		{"gungan_sacred_place",-1991,-5422,200},
		{"mauler_stronghold",2912,1118,50},
		{"imperial_outpost_naboo",-4769,-3982,20},
		{"naboo_pirate_outpost",-1496,-1728,50},
		{"pillars_naboo",7263,-2973,10},
		{"ruined_gate",-7324,-4149,10},
		{"ruined_walls",-3586,-880,10},
		{"statue_and_ruins",-189,-905,10},
		{"statue_heads",3377,5022,100},
		{"statues_with_fire",-1634,-4035,10},
		{"weapon_development_faciliy",-6505,-3310,50},
	},
...
rori = {
	...
	navAreas = {
		{"4_columns",-432,3264,10},
		{"bounty_hunter_camp_rori",-3650,5531,10},
		{"cobral_tent",-4972,-670,10},
		{"crashed_corvette",0,2012,50},
		{"crashed_escape_pod_rori_east",4272,2509,10},
		{"crashed_escape_pod_rori_north",959,6899,10},
		{"debris_rori",-989,-315,10},
		{"flooded_ruins",2528,7260,15},
		{"gate",2996,-3668,15},
		{"gazebo",3783,-4473,20},
		{"graveyard",-1710,6144,15},
		{"imperial_encampment",-5565,-5660,75},
		{"narmle_militia_estate",5207,1023,25},
		{"partially_buried_gazebo",1001,5360,10},
		{"rancher_and_pets",-431,-5434,20},
		{"rebel_outpost",-5348,5042,75},
		{"rorgungan_gravestones",1163,698,10},
		{"rorgungan_monument_north",-70,5229,32},
		{"rorgungan_monument_nw",-5819,5826,32},
		{"rorgungan_ruins_east_1",3593,345,32},
		{"rorgungan_ruins_east_2",6119,-509,15},
		{"rorgungan_ruins_central",-1491,1684,32},
		{"rorgungan_ruins_ne",3379,5861,25},
		{"rorgungan_ruins_north",956,4049,15},
		{"rorgungan_ruins_se",3462,-2174,20},
		{"rorgungan_ruins_south",-2641,-752,32},
		{"rorgungan_ruins_sw",-6967,-5642,32},
		{"rorgungan_shield",-5507,2096,10},
		{"rorgungan_swamp_town",-2069,3301,100},
		{"ruined_outpost",5083,4676,15},
		{"ruins_east",5584,2436,20},
		{"ruins_ne",6684,6882,10},
		{"ruins_north",958,6521,10},
		{"ruins_nw_1",-4706,3580,10},
		{"ruins_nw_2",-2713,4486,15},
		{"ruins_south",-760,-4085,20},
		{"ruins_west",-4493,1085,20},
		{"ruins_in_lake",1871,1761,10},
		{"small_imperial_base",6520,-4766,25},
		{"spike",-3392,-2098,10},
		{"statue",-2902,2588,10},
		{"statue_head_north_1",1116,3833,10},
		{"statue_head_north_2",961,4493,10},
		{"statue_head_west",-2140,614,10},
		{"sunken_ruins_rori",5961,-2598,20},
		{"wall_rori_1",959,5080,20},
		{"wall_rori_2",-1230,-3207,32},
	},
...
talus = {
	...
	navAreas = {
		{"atst_cabin",-2771,1568,10},
		{"aqualish_fishing_spot",5348,4545,10},
		{"backbone",-5730,2856,20},
		{"binyare_pirate_bunker",5583,-4080,32},
		{"bridge",-150,323,20},
		{"bridge_and_debris",5480,1085,50},
		{"broken_atat",-2434,-2218,20},
		{"broken_bridge",-4046,3663,20},
		{"broken_flora_harvester",-4350,1542,10},
		{"broken_gas_harvester",-4020,5952,15},
		{"broken_walls_talus",1115,1489,20},
		{"burning_rocks",4310,2563,10},
		{"campsite_talus",-2716,-2265,10},
		{"crashed_escape_pod_talus",-4984,5753,10},
		{"crashed_transport",-2400,2033,15},
		{"debris_talus_central",-1729,-2886,10},
		{"debris_talus_sw",-1011,-5092,10},
		{"detainment_center",4989,-6037,50},
		{"diseased_debris",-5139,3706,15},
		{"diseased_ruins",-5117,3213,50},
		{"erran_sif",2147,-5632,32},
		{"flag",-3460,1550,10},
		{"fountain_talus",-3153,-922,15},
		{"four_stone_fire",-1832,1438,10},
		{"gas_harvester",-1470,1231,15},
		{"gateway",2338,2936,15},
		{"generator_talus",-5647,-2370,10},
		{"geyser",-4595,5707,10},
		{"imperial_house_talus_central",1718,1610,25},
		{"imperial_house_talus_east",5985,-1185,32},
		{"imperial_watch_tower",3209,1262,15},
		{"kahmurra_biogenetic_research_station",-4799,-4752,25},
		{"large_broken_tower",-5517,1064,15},
		{"lake_monument",2445,2485,15},
		{"lost_aqualish_house",17,-910,32},
		{"lost_village_of_durbin",4215,1003,165},
		{"pillar",618,1100,10},
		{"pillars_ruins",4974,3849,10},
		{"quarantined_building",3886,-2848,32},
		{"rebel_camp_talus",3100,-4044,15},
		{"rebel_installation",2371,-4989,50},
		{"red_fire",-1833,1437,15},
		{"ruined_lookout_tower",-4382,2673,15},
		{"ruins_talus_central_1",-1394,2117,15},
		{"ruins_talus_central_2",-1600,-540,15},
		{"ruins_talus_east",5190,-1735,20},
		{"ruins_talus_nw",-3492,3697,15},
		{"scientist_camp",-3640,6332,32},
		{"selonian_camp",145,-5583,20},
		{"skeleton_and_debris",-3394,2497,15},
		{"small_moisture_farm",-4916,-4510,15},
		{"stones_and_skull",-3710,2891,10},
		{"sunken_ruins_talus",-4575,4356,15},
		{"three_stones",-1362,1060,10},
		{"weapons_depot",-4925,-3119,25},
		{"wind_generators_talus",-4557,-2906,15},
		{"worship_stone",-861,1020,10},
	},
...
tatooine = {
	...
	navAreas = {
		{"bounty_hunter_camp_tatooine",7044,7047,20},
		{"broken_house",2315,3255,15},
		{"broken_machinery",-4698,5456,10},
		{"broken_walls_tatooine",2980,6465,32},
		{"building_ruins_1",588,348,50},
		{"building_ruins_2",6395,195,15},
		{"buried_building",-2041,2593,15},
		{"comms_dish",-5469,2135,5},
		{"crashed_escape_pod_tatooine_2",-6174,5886,10},
		{"darklighter_estate",-695,-6721,128},
		{"fort_tusken",-3981,6261,60},
		{"imperial_oasis",-5315,2685,128},
		{"jawa_traders",-6120,1872,100},
		{"makeshift_camp",-4464,5784,10},
		{"mark_of_honor_ranch",5002,-4684,75},
		{"pirate_camp",-4931,1260,10},
		{"tatooine_maze",-3029,-5113,32},
		{"tusken_bunker",-1476,-180,32},
		{"tusken_king_outpost",-5315,-4440,60},
		{"tusken_outpost_east",5693,1871,75},
		{"rancher's_camp",-3168,3638,15},
		{"rock_pillar",-6449,2614,15},
		{"ruined_building",-4878,2950,15},
		{"ruins_and_skeletons",-5723,6483,10},
	},
