...
describe("SithShadowIntroTheater", function()
  ...
  describe("useTheaterDatapad", function()
    ...
    describe("and the player has looted a datapad", function()
      it("Should check if GoToDathomir is called correctly, if they have completed the quest.", function()
        QuestManagerMocks.hasCompletedQuest(pCreatureObject, QuestManagerMocks.quests.GOT_DATAPAD_2)
