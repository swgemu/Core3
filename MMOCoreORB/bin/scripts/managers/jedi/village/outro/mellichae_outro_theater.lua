...
function MellichaeOutroTheater:addLoot(pMellichae)
	local pInventory = SceneObject(pMellchae):getSlottedObject("inventory")
...
function MellichaeOutroTheater:onEnteredActiveArea(pCreatureObject, spawnedSithShadowsList)
	...
	spatialChat(spawnedSithShadowsList[6], greetingString:_getObject()) -- %TT, You shall pay for your tresspass here - SOLDIERS - defend the crystals! Let no one leave here alive.
