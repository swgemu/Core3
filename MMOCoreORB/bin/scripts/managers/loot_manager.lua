...
yellowChance = 1000000 -- 1 in 1,0000
...
yellowModifier = 0.5 --1.5 
exceptionalModifier = 1.0 --2.5
legendaryModifier = 1.5 --5.0
...
randomDotStrength = {10, 100} --{10, 200} Set for disease. Fire will be x1.5, poison x2.
randomDotDuration = {30, 200} --{30, 240} Set for poison. Fire will be x1.5, disease x5.
randomDotPotency = {1, 100}
randomDotUses = {250, 999} --9999
