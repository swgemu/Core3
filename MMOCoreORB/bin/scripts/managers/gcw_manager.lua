	...
	{ "hq_s01_rebel",
		{
			...
			{ 0.59, 0.1, 2.4, 0, 0, 1, 0, 3 },
			{ -1.2, 0.1, -0.69, 0, 0.707, 0, 0.707, 3 },
			{ 5.92, 0.1, -0.3, 0, -0.707, 0, 0.707, 4 },
			{ 2.85, 0.1, -0.89, 0, 0, 0, 1, 4 },
			{ 4.13, 0.1, -6.17, 0, 0, 0, 1, 5 },
			{ 5.92, 0.1, -2.57, 0, -0.707, 0, 0.707, 5 },
			{ -5.93, 0.1, -4.02, 0, 0.707, 0, 0.707, 6 },
			{ -5.93, 0.1, -2.1, 0, 0.707, 0, 0.707, 6 },
		}
	},
	-- Imperial Field Hospital
	{ "hq_s02_imp",
		{
			{ 1.06, 0.25, 3.25, 0, 0.707, 0, -0.707, 3 },
			{ -4.93, 0.25, -2.54, 0, 0.707, 0, 0.707, 3 },
			{ -0.09, 0.25, -5.2, 0, 0, 0, 1, 4 },
			{ -8.2, -6.75, -3.94, 0, 0.707, 0, 0.707, 6 },
			{ -0.79, -6.75, -4.06, 0, 0.707, 0, -0.707, 6 },
			{ -6.99, -6.77, -17.94, 0, 0, 0, 1, 7 },
			{ 7.98, -6.77, -17.94, 0, 0, 0, 1, 7 },
			{ 3.43, -6.75, 0.47, 0, 0, 1, 0, 8 },
			{ 0.67, -13.75, -17.18, 0, 0, 0, 1, 10 },
			{ -5.69, -13.75, -17.18, 0, 0, 0, 1, 10 },
		}
	},
	-- Rebel Field Hospital
	{ "hq_s02_rebel",
		{
			{ -5.15, 0, 3.25, 0, 0.707, 0, 0.707, 3 },
			{ -2.79, 0, -10.35, 0, 0, 0, 1, 6 },
			{ -9.29, 0, -4.9, 0, 0, 1, 0, 0, 0, 1, 6 },
			{ -6.71, 0, -12, 0, 0, 1, 0, 0, 0, 1, 7 },
			{ 7.4, 0, -12, 0, 0, 1, 0, 0, 0, 1, 7 },
			{ 1.67, 0, -8.98, 0, 0.707, 0, 0.707, 8 },
			{ 5.16, 0, -13.13, 0, -0.707, 0, 0.707, 10 },
			{ -10.16, 0, -13.13, 0, 0.707, 0, 0.707, 10 },
			{ 3.82, 0, -3.5, 0, -0.707, 0, 0.707, 10 },
		}
	},
	-- Imperial Tactical Center
	{ "hq_s03_imp",
		{
			{ 0.06, 0.25, 1.58, 0, 0, 0, 1, 2 },
			{ 3.47, 0.25, -5.7, 0, 0, 0, 1, 3 },
			{ -0.11, 0.25, -2.82, 0, 0, 1, 0, 3 },
			{ 4.54, -13.75, 1.95, 0, 0.707, 0, -0.707, 6 },
			{ 4.34, -13.75, 10.44, 0, 0, 1, 0, 7 },
			{ -7.32, -13.75, 10.44, 0, 0, 1, 0, 7 },
	...
	{ "hq_s04_imp",
		{
			...
			{ -0.5, 0.25, -2.77, 0, 0, 1, 0, 3 },
			{ -3.48, 0.25, -5.7, 0, 0, 0, 1, 3 },
			{ 6.22, -6.75, -10.44, 0, 0, 0, 1, 5 },
			{ 0.21, -13.75, -1.81, 0, 0.707, 0, -0.707, 7 },
			{ 10.78, -13.76, 13.69, 0, 0, 1, 0, 8 },
			{ 18.41, -13.76, 8.56, 0, 0.707, 0, -0.707, 9 },
			{ 18.41, -13.76, 5.43, 0, 0.707, 0, -0.707, 9 },
			{ 13.77, -13.76, -4.1, 0, 0, 1, 0, 10 },
		}
	},
	-- Rebel Detachment HQ
	{ "hq_s04_rebel",
		{
			{ 5.15, 0, -1.88, 0, -0.707, 0, 0.707, 2 },
			{ 6.21, 0, -10.58, 0, 0, 0, 1, 5 },
			{ 0.3, 0, -5.53, 0, -0.707, 0, 0.707, 7 },
			{ 0.3, 0, -13.75, 0, -0.707, 0, 0.707, 7 },
			{ 10.8, 0, 13.78, 0, 0, 1, 0, 8 },
			{ 18.57, 0, 8.89, 0, -0.707, 0, 0.707, 9 },
			{ 18.57, 0, 5.07, 0, -0.707, 0, 0.707, 9 },
			{ 17.21, 0, -3.71, 0, 0, 1, 0, 10 },
			{ 13.81, 0, -3.71, 0, 0, 1, 0, 10 },
		}
	}
}
