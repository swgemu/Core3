...
veteranRewards = {
	...
	{templateFile = "object/tangible/camp/camp_lantern_s1.iff", milestone=15, oneTime=false, description="Camp Lantern (Style 1)"},
	{templateFile = "object/tangible/camp/camp_lantern_s2.iff", milestone=15, oneTime=false, description="Camp Lantern (Style 2)"},
	{templateFile = "object/tangible/camp/camp_lantern_s3.iff", milestone=15, oneTime=false, description="Camp Lantern (Style 3)"},
	...
	{templateFile = "object/tangible/camp/camp_cot_s1.iff", milestone=15, oneTime=false, description="Cot (Simple)"},
	{templateFile = "object/tangible/camp/camp_cot_s2.iff", milestone=15, oneTime=false, description="Cot (Modern)"},
	{templateFile = "object/tangible/camp/camp_cot_s3.iff", milestone=15, oneTime=false, description="Cot(High Tech)"},
