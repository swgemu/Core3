...
dathomir_regions = {
	...
	--	dathomir_dry_rock_mountains_sw
	--	dathomir_hard_gaping_spider_se
	--	dathomir_hard_graul_se
	--	dathomir_hard_graul_sw
	--	dathomir_hard_malklok_se
	-- dathomir_hard_rancor_nw
	--	dathomir_hard_purbole_sw
	-- dathomir_hard_purbole_nw
	--	dathomir_hard_reptilian_flyer_ne
	--	dathomir_hard_reptilian_flyer_sw
	--	dathomir_hard_shear_mite_ne
	-- dathomir_medium_baz_nitch_ne
	-- dathomir_medium_baz_nitch_nw
