...
function JediManager:withCreaturePlayerObject(pCreatureObject, performThisFunction)
	return self:withCreatureObject(pCreatureObject, function(creatureObject) return self:withPlayerObject(creatureObject.getPlayerObject(), performThisFunction) end)
end
