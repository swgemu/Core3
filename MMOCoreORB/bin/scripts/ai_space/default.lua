...
moveDefault = {
	...
	{id="1509831534",	name="IfSpace",	pid="368441587"},
	{id="14448982",	name="CheckHasPatrol",	pid="1509831534"},
	{id="3848206840",	name="IfSpace",	pid="368441587"},
	{id="539785228",	name="CheckDestination",	pid="3848206840",	args={condition=0}},
...
rootDefault = {
	...
	{id="869798738",	name="TreeSocketSpace",	pid="1234597753",	args={slot=IDLESPACE}}}
