...
awareDefault = {
	...
	{id="2515118288",	name="CheckProspectInRange",	pid="4225492471",	args={condition=0.0}},
	...
	{id="464125663",	name="SetMovementState",	pid="4198580351",	args={state=WATCHING}},
...
lookDefault = {
	...
	{id="2178900812",	name="IfSpace",	pid="2349982047"},
	{id="2737704374",	name="CheckMovementState",	pid="2178900812",	args={condition=OBLIVIOUS}},
	{id="3742455244",	name="IfSpace",	pid="2349982047"},
...
rootDefault = {
	...
	{id="4046659080",	name="ParallelSequenceSpace",	pid="2051740559"},
	{id="1752525902",	name="TreeSocketSpace",	pid="4046659080",	args={slot=TARGETSPACE}},
	{id="1729558672",	name="TreeSocketSpace",	pid="4046659080",	args={slot=MOVESPACE}},
