...
awareDefault = {
	{id="aware0",	name="LookForTarget",		pid="none"},
	{id="aware1",	name="Selector",			pid="aware0"},
	...
	{id="aware6",	name="CheckFollowState",	pid="aware4",	args="condition=1"}, -- TODO: 1 == WATCHING
	{id="aware7",	name="CheckFollowState",	pid="aware4",	args="condition=2"}, -- TODO: 2 == STALKING
	{id="aware8",	name="TreeSocket",			pid="aware5",	args="slot=AGGRO"},
	{id="aware9",	name="TreeSocket",			pid="aware5",	args="slot=RUNAWAY"}
}
...
addAiTemplate("weaponDefault", weaponDefault)
