...
healDefault = {
	...
	{id="2730487382",	name="Wait",	pid="3412645993",	args={durationMax=4.0, durationMin=8.0}}}
...
idleDefault = {
	...
	{id="3890989887",	name="CheckArrivedAtPatrol",	pid="480022165"},
	{id="2896409758",	name="WriteBlackboard",	pid="3408558848",	args={key="moveMode", val=WALK}},
	{id="852586211",	name="Wait",	pid="3408558848",	args={durationMax=10.0, durationMin=5.0}},
	...
	{id="1864140521",	name="Wait",	pid="3620709194",	args={durationMax=10.0, durationMin=5.0}},
	...
	{id="1656848534",	name="Not",	pid="4072235030"},
	{id="3374252162",	name="If",	pid="1656848534"},
	{id="1514297658",	name="CheckHasPatrol",	pid="3374252162"},
	{id="2300404191",	name="Not",	pid="4072235030"},
	{id="910333348",	name="If",	pid="2300404191"},
	{id="1431589090",	name="CheckMovementState",	pid="910333348",	args={condition=CONVERSING}},
	{id="936689026",	name="Not",	pid="4072235030"},
...
rootDefault = {
	...
	{id="4005807570",	name="AlwaysSucceed",	pid="3085594992"},
	{id="2197461733",	name="TreeSocket",	pid="4005807570",	args={slot=EQUIP}},
