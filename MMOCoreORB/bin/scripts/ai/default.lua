rootDefault = {
	...
	--{id="checkcombat",  name="CheckIsInCombat",      pid="attack"},
...
awareDefault = {
	...
	{id="aware.3",	name="CheckProspectInRange",	pid="aware.1"},
	...
	{id="aware11",	name="Sequence",				pid="aware10"},
	{id="aware12",	name="EraseBlackboard",			pid="aware11",	args={param="aggroMod"}},
	{id="aware13",	name="EraseBlackboard",			pid="aware11",	args={param="targetProspect"}},
}
...
targetDefault = {
	...
	{id="getta1.5",	name="AlwaysFail",					pid="gettar0"},
	{id="gettar2",	name="ExitCombat",					pid="getta1.5",	args={clearDefenders=true}},
	...
	{id="gettar7",	name="SetDefenderFromProspect",		pid="gettar3"},
	{id="gettar11",	name="Selector",					pid="gettar9"},
	{id="gettar12",	name="GetProspectFromThreatMap",	pid="gettar11"},
	{id="gettar13",	name="GetProspectFromDefenders",	pid="gettar11"},
	...
	{id="gettar26",	name="DropProspectFromDefenders",	pid="gettar25"},
	{id="gettar27",	name="EraseBlackboard",				pid="gettar25",	args={param="targetProspect"}},
...
attackDefault = {
	...
	{id="selatt1.6",    name="EnqueueAttack",        pid="selatt0"},
	...
	{id="selatt9",		name="Sequence",					pid="selatt2"},
	{id="selatt10",		name="CheckAttackInRange",			pid="selatt8"},
	{id="selatt11",		name="CheckAttackIsValid",			pid="selatt8"},
	{id="selatt12",		name="WriteBlackboard",				pid="selatt9",	args={key="attackType", val=DEFAULT}},
	{id="selatt13",		name="SelectAttack",				pid="selatt9"},
	{id="selatt14",    name="EnqueueAttack",        pid="selatt9"}
}
...
lookDefault = {
	...
	{id="look2",	name="CheckProspectSpeed",	pid="look0",	args={condition=FAST}},
	{id="look3",	name="CheckProspectLOS",	pid="look0"},
...
aggroDefault = {
	...
	{id="aggro1",	name="CheckProspectAggression",	pid="aggro0"},
	{id="aggro2",	name="CheckProspectLOS",		pid="aggro0"},
	{id="aggro3",	name="SetDefenderFromProspect",	pid="aggro0"}
}
...
scareDefault = {
	...
	{id="scare2",	name="CheckProspectLevel",			pid="scare0"},
	{id="scare3",	name="CheckProspectBackAggression",	pid="scare0"},
	{id="scare4",	name="CheckProspectSpeed",			pid="scare0",	args={condition=FAST}},
	{id="scare5",	name="CheckProspectFacing",			pid="scare0"},
	{id="scare6",	name="CheckProspectLOS",			pid="scare0"},
