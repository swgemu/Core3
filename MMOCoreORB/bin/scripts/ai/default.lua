...
awareDefault = {
	...
	{id="2200708579",	name="CheckFollowState",	pid="1491613169",	args={condition=WATCHING}},
	...
	{id="922359392",	name="CheckFollowState",	pid="115067313",	args={condition=WATCHING}},
	{id="2011944136",	name="If",	pid="3753019142"},
	{id="3410143777",	name="CheckFollowState",	pid="2011944136",	args={condition=STALKING}},
