...
wanderStatic = {
	...
	{id="walkset",	name="WriteBlackboard",	pid="wander",	args={key="moveMode", val=WALK}},
	{id="walkmove",	name="TreeSocket",		pid="wander",	args={slot=MOVE}},
...
escortRun = {
	{id="wander",	name="Selector",		pid="none"},
	{id="runset",	name="WriteBlackboard",	pid="wander",	args={key="moveMode", val=RUN}},
	{id="runmove",	name="TreeSocket",		pid="wander",	args={slot=MOVE}},
	{id="wait0",	name="Wait",			pid="wander"}
}
