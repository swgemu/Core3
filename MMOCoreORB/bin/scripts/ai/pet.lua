idlePet = {
	...
	{id="idle6",	name="Wait",				pid="idle0",	args={duration=5}},
	{id="idle7",	name="Not",					pid="idle1"},
	{id="idle8",	name="WriteBlackboard",		pid="idle1",	args={key="moveMode", val=RUN}},
	{id="idle9",	name="AlwaysSucceed",		pid="idle1"},
	{id="idle10",	name="TreeSocket",			pid="idle9",	args={slot=MOVE}},
	{id="idle11",	name="CheckFollowState",	pid="idle7",	args={condition=OBLIVIOUS}}
}
...
targetPet = {
	...
	{id="gettar5",	name="SetDefenderFromProspect",		pid="gettar1"},
	...
	{id="gettar24",	name="GetProspectFromTarget",		pid="gettar14"},
	...
	{id="gettar29",	name="GetProspectFromCommand",		pid="gettar17"},
	{id="gettar30",	name="Selector",					pid="gettar19"},
	{id="gettar31",	name="DropProspectFromDefenders",	pid="gettar23"},
	{id="gettar32",	name="EraseBlackboard",				pid="gettar23",	args={param="targetProspect"}},
	{id="gettar33",	name="GetProspectFromThreatMap",	pid="gettar30"},
	{id="gettar34",	name="GetProspectFromDefenders",	pid="gettar30"}
}
