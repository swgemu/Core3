...
function empiredayCaptainCarkor_convo_handler:getInitialScreen(pPlayer, pNpc, pConvTemplate)
	...
	elseif (empiredayImpStatus == "3" or empiredayImpStatus == "4" or empiredayImpStatus == "7" or empiredayImpStatus == "8") then
		return convoTemplate:getScreen("Service_Noted")
    end
    if (empiredayImpSatus == "6" or empiredayImpStatus == "5") then
