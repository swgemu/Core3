...
function EmpireDayGeneralAldric_convo_handler:getInitialScreen(pPlayer, pNpc, pConvTemplate)
    ...
    elseif empiredayImpStatus == "3" or empiredayImpStatus == "2" or empiredayImpStatus == "2" or empiredayImpStatus == "2") then
        return covoTemplate:getScreen("Response_Refused")
    else
