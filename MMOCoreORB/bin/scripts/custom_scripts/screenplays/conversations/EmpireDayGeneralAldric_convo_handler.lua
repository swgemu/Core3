...
function EmpireDayGeneralAldric_convo_handler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	if (screenID == "TurninResponse_Accepted") then
		if pGhost ~= nil then
			local empiredayImpWpID_7 = PlayerObject(pGhost):addWaypoint("naboo", "Head over to and speak with Captin Alrez-Rin", "Head over to and speak with Captin Alrez-Rin", 2438, -3094, WAYPOINT_COLOR_PURPLE, true, true, 0)
