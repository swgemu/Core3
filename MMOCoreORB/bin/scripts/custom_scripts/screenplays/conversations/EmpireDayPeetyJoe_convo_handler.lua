...
function empiredayPeetyJoe_convo_handler:getInitialScreen(pPlayer, pNpc, pConvTemplate)
	...
	elseif (empiredayImpStatus == "2" or empiredayImpStatus == "4" or empiredayImpStatus == "5" or empiredayImpStatus == "6" or empiredayImpStatus == "7" or empiredayImpStatus == "8") then
