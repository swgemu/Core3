...
EmpireDayCaptainAlrezrin_convo_handler = conv_handler:new {}

function EmpireDayCaptainAlrezrin_convo_handler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
...
function EmpireDayCaptainAlrezrin_convo_handler:getInitialScreen(pPlayer, pNpc, pConvTemplate)
