...
InitialConvoScreen = ConvoScreen:new {
	...
	options = {
		{"I see what you are saying, at least we can record them for now. Maybe something more can be done later.", "Response_01"},
		{"Here's the datapad. We'll collect what we can. That's all we can do." , "Response_02"},
	}
}
...
EmpireDayCaptainEdwardsConvoTemplate:addScreen(Faction_Deny);
