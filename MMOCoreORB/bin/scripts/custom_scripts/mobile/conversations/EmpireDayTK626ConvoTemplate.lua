...
InitialConvoScreen = ConvoScreen:new {
	...
	options = {
		{"It's Empire Day already? Of course I'll help! Just tell me where I'm needed.", "Response_Accepted"},
		{"You're not going to have me crammed into one of those tin cans driving it for hours on a desert planet, right?", "Response_Accepted"},
		{"I'm not really going to be of much help, but I'll try to attend the festivities.", "Response_Declined"}
	}
}
...
EmpireDayTK626ConvoTemplate:addScreen(Deny_Faction);
...
EmpireDayTK626ConvoTemplate:addScreen(Service_Noted);
