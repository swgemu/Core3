...
InitialConvoScreen = ConvoScreen:new {
	...
	options = {
		{"I know you're looking to cause a commotion. We both know you won't get far, best turn back now and we can all go home safely.", "Response_01"},
		{"You're the terrorist! For your crimes against the Empire, I'm taking you in... Dead or alive!" , "Response_02"},
	}
}
