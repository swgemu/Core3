...
TurnInConvoScreen = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"It's this thing right? Are you sure this is ediable?", "TurninResponce_01"},
		{"Here is your 'super special secret ingredient' you were asking about.", "TurnInResponce_02"},
	}
}
AnniversarySnoopStewartConvoTemplate:addScreen(TurnInConvoScreen);

TurninResponce_01 = ConvoScreen:new {
	id = "TurninResponce_01",
...
AnniversarySnoopStewartConvoTemplate:addScreen(TurninResponce_01);

TurninResponce_02 = ConvoScreen:new {
	id = "TurninResponce_02",
	customDialogText = "Thank you oh so much, traveller! This will most certainly be worthy of being the best across the galaxy. As promised, here is your reward. You've more than earned it.",
	stopConversation = "true",
	options = {
	}
}
AnniversarySnoopStewartConvoTemplate:addScreen(TurnInResponce_02)
