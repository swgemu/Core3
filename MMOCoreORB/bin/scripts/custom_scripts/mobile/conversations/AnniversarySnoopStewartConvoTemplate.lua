...
NoItem = ConvoScreen:new {
	id = "NoItem",
	customDialogText = "It looks like you may have misplaced the secret ingredient. Can you please go retrive it from the thief?",
	stopConversation = "false",
	options = {
		{"Yes, I would like another chance to go get the item.", "Reset_Response"},
		{"No, I give up.", "Sad_Reply"},
	}
}
AnniversarySnoopStewartConvoTemplate:addScreen(NoItem);

Reset_Response = ConvoScreen:new {
	id = "Reset_Response",
	customDialogText = "Thank you, this is very important to me! Please hurry back.",
	stopConversation = "True",
	options = {}
}
AnniversarySnoopStewartConvoTemplate:addScreen(Reset_Response);

Sad_Reply = ConvoScreen:new {
	id = "Sad_Reply",
	customDialogText = "I am sorry to hear that. If you change your mind, please come back to me.",
	stopConversation = "True",
	options = {}
}
AnniversarySnoopStewartConvoTemplate:addScreen(Sad_Reply);
