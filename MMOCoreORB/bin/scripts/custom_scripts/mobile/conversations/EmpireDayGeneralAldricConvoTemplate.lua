...
TurnInConvoScreen = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"Senseless, this violence and to acomplish what? It's sad, but they are dealt with, Sir.", "TurninResponse_Accepted"},
		{"The threat was removed, Sir. It is done.", "TurninResponse_Accepted"},
	}
}
