...
InitialConvoScreen = ConvoScreen:new {
	...
	options = {
		{"Why would they attack a parade representing the miltiary might of the Empire, sir?", "Response_01"},
		{"This seems foolish, even for rebels, right Sir?", "Response_02"},
	}
}
...
EmpireDayGeneralAldricConvoTemplate:addScreen(Faction_Deny);
...
EmpireDayGeneralAldricConvoTemplate:addScreen(Service_Noted);
