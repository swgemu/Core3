...
InitialConvoScreen = ConvoScreen:new {
	...
	options = {
		{"What kind of orders?", "Response_01"},
		{"Rather ominoius, but I'll help.", "Response_02"},
...
TurnInConvoScreen = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"I see. I imagine the empire would love to destroy all records of those who remember what they've done. That's the point of celebrating Empire Day isn't it?", "TurninResponse_01"},
		{"Remember Alderaan! Let's make sure nothing here was forgotten.", "TurninResponse_02"},
	}
}
