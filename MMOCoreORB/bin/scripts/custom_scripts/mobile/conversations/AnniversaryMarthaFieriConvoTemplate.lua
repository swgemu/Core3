...
InitialConvoScreen = ConvoScreen:new {
	...
	options = {
		{"Here it is, I'm not sure why you know our 'friend' but sure...let's see what happens.", "Response_01"},
		{"It's time to find out who's behind this.", "Response_02"},
	}
}
...
AnniversaryMarthaFieriConvoTemplate:addScreen(Response_01);
...
AnniversaryMarthaFieriConvoTemplate:addScreen(Response_02);
