EmpireDayCorporalZuvordConvoTemplate = ConvoTemplate:new {
	...
	templateType = "Lua",
	luaClassHandler = "EmpireDayCorporalZuvord_convo_handler",
	screens = {}
}
...
InitialConvoScreen = ConvoScreen:new {
	...
	options = {
		{"I am, they're hoping to collect as close to life representations of these memorial sites for safe keeping. If you can help me with this recording...", "Response_Accepted"},
		{"Let's work get this done then, if you'll help me here." , "Response_Accepted"},
	}
}
