...
InitialConvoScreen = ConvoScreen:new {
	...
	options = {
		{"What can I do to help you with this?", "Response_01"},
		{"Are you sure this is legitimate? You don't see random guys offering a mission for the Alliance just anywhere these days.", "Response_02"},
...
Response_01 = ConvoScreen:new {
	id = "Response_01",
	customDialogText = "Don't worry, he will fill you in once you arrive here is the waypoint to his location. He is expecting you.",
	stopConversation = "true",
	options = {
	}
}
VisionsSheriRayConvoTemplate:addScreen(Response_01);
...
VisionsSheriRayConvoTemplate:addScreen(Response_02);
