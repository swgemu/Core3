...
VisionsJohnRoyConvoTemplate:addScreen(Cant_Give_Reward)
...
VisionsJohnRoyConvoTemplate:addScreen(Time_Wasted)

No_Quest = ConvoScreen:new {
	id = "No_Quest",
	customDialogText = "I do not believe we have business with one another.",
	stopConversation = "true",
	options = {
	}
}
VisionsJohnRoyConvoTemplate:addScreen(No_Quest)
