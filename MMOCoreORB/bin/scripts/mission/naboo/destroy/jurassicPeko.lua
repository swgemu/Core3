...
jurassicPeko = Mission:new {
	missionKey = "tjpk", -- UNIQUE internal key used to identify the mission. No spaces, keep small
	...
	customTitle = "Jurassic Peko", -- if stfTitleKey is not used, set a custom title here
	...
	destinationY = 3850.0, -- Y coordinate for destination of mission
	destinationPlanetStr = "naboo", -- Destination planet name, must be lowercase

	-- Rewards
	rewardCredits = 2000, -- Amount of credits awarded to bank
	...
	customDescription = "These animals are an annoyance to my daily walks! Please kill 7 of them.", -- if stfDescriptionKey is not used, set a custom description here

	-- Objective & Target
	targetName = "(7x) Peko Peko", --Name of target to display
	depictedObjectCrc = 2319882660, -- Object CRC of the object pictured in mission window
	objectiveDefaults = "1:0:0:7:peko_peko:0", --Objective String. See documentation for formatting
