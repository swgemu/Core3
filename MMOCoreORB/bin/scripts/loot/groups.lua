...
includeFile("groups/npc/nightsister_crystals_1.lua")
includeFile("groups/npc/nightsister_crystals_2.lua")
includeFile("groups/npc/nightsister_crystals_3.lua")
includeFile("groups/npc/nightsister_crystals_4.lua")
