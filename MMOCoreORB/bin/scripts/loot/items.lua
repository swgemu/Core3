...
--loot_components sub-folder
includeFile("items/loot_components/balanced_feed_mechanism.lua")
includeFile("items/loot_components/fine_tuned_vibro_motor.lua")
includeFile("items/loot_components/high_frequency_vibro_motor.lua")
includeFile("items/loot_components/high_powered_energy_capacitor.lua")
includeFile("items/loot_components/high_powered_vibro_motor.lua")
includeFile("items/loot_components/high_velocity_feed_mechanism.lua")
includeFile("items/loot_components/large_energy_capacitor.lua")
includeFile("items/loot_components/blaster_pistol_barrel.lua")
includeFile("items/loot_components/blaster_power_handler.lua")
includeFile("items/loot_components/blaster_rifle_barrel.lua")
includeFile("items/loot_components/projectile_feed_mechanism.lua")
includeFile("items/loot_components/projectile_pistol_barrel.lua")
includeFile("items/loot_components/projectile_rifle_barrel.lua")
includeFile("items/loot_components/scope_weapon.lua")
includeFile("items/loot_components/sword_core.lua")
includeFile("items/loot_components/vibro_unit.lua")
