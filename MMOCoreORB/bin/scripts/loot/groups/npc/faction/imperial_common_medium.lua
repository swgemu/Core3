imperial_common_medium = {
	...
	lootItems = {
		...
		{groupTemplate = "weapon_components", weight = 200000},
		{groupTemplate = "weapon_components_advanced", weight = 50000},
	}
}

addLootGroupTemplate("imperial_common_medium", imperial_common_medium)
