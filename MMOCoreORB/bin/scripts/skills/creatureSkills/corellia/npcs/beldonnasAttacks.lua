...
--MERCbeldonnasTABILITY or FITNESS FOR A PARTICULAR PURPOSE. 
...
--license (or modified versions of such code, with uncbeldonnasged license). 
...
AddRandomPoolAttackTargetSkill(beldonnasAttack1)
