...
--MERCcorsecTABILITY or FITNESS FOR A PARTICULAR PURPOSE. 
...
--license (or modified versions of such code, with unccorsecged license). 
...
corsecAttack1 = {
	...
	healthAttackCcorsecce = 100,
	actionAttackCcorsecce = 0,
	mindAttackCcorsecce = 0,
