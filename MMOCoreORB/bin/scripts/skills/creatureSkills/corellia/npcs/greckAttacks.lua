...
--MERCgreckTABILITY or FITNESS FOR A PARTICULAR PURPOSE. 
...
--license (or modified versions of such code, with uncgreckged license). 
...
AddRandomPoolAttackTargetSkill(greckAttack1)
