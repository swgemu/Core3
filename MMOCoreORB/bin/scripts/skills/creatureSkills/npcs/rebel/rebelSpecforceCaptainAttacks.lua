...
rebelSpecforceCaptainAttack1 = { 
	attackname = "rebelSpecforceCaptainAttack1",
...
AddDotPoolAttackTargetSkill(rebelSpecforceCaptainAttack1)

-----------------------------------------------------------------------

rebelSpecforceCaptainAttack2 = { 
	attackname = "rebelSpecforceCaptainAttack2",
...
AddRandomPoolAttackTargetSkill(rebelSpecforceCaptainAttack2)
