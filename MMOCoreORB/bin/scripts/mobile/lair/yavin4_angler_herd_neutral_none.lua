yavin4_angler_herd_neutral_none = Lair:new {
	mobiles = {{"angler_recluse", 0}, {"bone_angler", 0}},
	spawnLimit = 15,
...
addLairTemplate("yavin4_angler_herd_neutral_none", yavin4_angler_herd_neutral_none)
