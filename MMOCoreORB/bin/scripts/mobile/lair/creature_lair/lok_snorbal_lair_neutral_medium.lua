lok_snorbal_lair_neutral_medium = Lair:new {
	mobiles = {{"snorbal", 1},{"female_snorbal_calf", 1},{"mature_snorbal_male", 1}},
	spawnLimit = 15,
...
addLairTemplate("lok_snorbal_lair_neutral_medium", lok_snorbal_lair_neutral_medium)
