dathomir_stallion_bolma_lair_neutral_medium = Lair:new {
	mobiles = {{"alpha_bolma",1},{"bolma_male",1}},
	spawnLimit = 15,
...
addLairTemplate("dathomir_stallion_bolma_lair_neutral_medium", dathomir_stallion_bolma_lair_neutral_medium)
