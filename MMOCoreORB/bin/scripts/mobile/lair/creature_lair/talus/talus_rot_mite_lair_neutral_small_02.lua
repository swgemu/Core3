talus_rot_mite_lair_neutral_small_02 = Lair:new {
	mobiles = {{"cyst_covered_rot_mite_guard",1}},
	spawnLimit = 15,
...
addLairTemplate("talus_rot_mite_lair_neutral_small_02", talus_rot_mite_lair_neutral_small_02)
