naboo_hermit_spider_lair_neutral_boss_01 = Lair:new {
	mobiles = {{"hermit_spider",1}},
	bossMobiles = {{"hermit_spider_queen",1}},
	spawnLimit = 15,
...
addLairTemplate("naboo_hermit_spider_lair_neutral_boss_01", naboo_hermit_spider_lair_neutral_boss_01)
