endor_merek_lair_neutral_medium_01 = Lair:new {
	mobiles = {{"merek_assassin",1},{"blood_stained_merek",1}},
	spawnLimit = 15,
...
addLairTemplate("endor_merek_lair_neutral_medium_01", endor_merek_lair_neutral_medium_01)
