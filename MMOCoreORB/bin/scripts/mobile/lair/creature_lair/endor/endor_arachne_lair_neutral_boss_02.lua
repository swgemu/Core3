endor_arachne_lair_neutral_boss_02 = Lair:new {
	mobiles = {{"arachne_drone",1}},
	bossMobiles = {{"arachne_fleshripper",1}},
	spawnLimit = 15,
...
addLairTemplate("endor_arachne_lair_neutral_boss_02", endor_arachne_lair_neutral_boss_02)
