talus_lost_aqualish_warchief_camp_neutral_large_theater = Lair:new {
	mobiles = {{"lost_aqualish_warchief",1},{"lost_aqualish_bomber",1},{"lost_aqualish_soldier",1},{"lost_aqualish_warrior",1}},
	spawnLimit = 15,
...
addLairTemplate("talus_lost_aqualish_warchief_camp_neutral_large_theater", talus_lost_aqualish_warchief_camp_neutral_large_theater)
