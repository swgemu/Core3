talus_sleemo_vandal_camp_neutral_medium_theater = Lair:new {
	mobiles = {{"sleemo_vandal", 1}, {"sleemo_punk", 1}, {"sleemo_scamp", 1}},
	spawnLimit = 12,
...
addLairTemplate("talus_sleemo_vandal_camp_neutral_medium_theater", talus_sleemo_vandal_camp_neutral_medium_theater)
