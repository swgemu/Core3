corellia_lord_nyax_chapel_neutral_medium_theater = Lair:new {
	mobiles = {{"disciple_of_lord_nyax",1},{"servant_of_lord_nyax",1},{"fanatic_of_lord_nyax",1}},
	spawnLimit = 15,
...
addLairTemplate("corellia_lord_nyax_chapel_neutral_medium_theater", corellia_lord_nyax_chapel_neutral_medium_theater)
