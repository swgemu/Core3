global_imperial_spec_non_com_camp_imperial_small_theater = Lair:new {
	mobiles = {
		{"specialist_noncom",1}
	},
	spawnLimit = 9,
...
addLairTemplate("global_imperial_spec_non_com_camp_imperial_small_theater", global_imperial_spec_non_com_camp_imperial_small_theater)
