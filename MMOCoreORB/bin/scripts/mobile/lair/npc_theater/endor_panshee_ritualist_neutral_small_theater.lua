endor_panshee_ritualist_neutral_small_theater = Lair:new {
	mobiles = {
		{"panshee_ritualist",1},
		{"wise_panshee_ritualist",1},
		{"competent_panshee_ritualist",1},
		{"archaic_panshee_ritualist",1}
	},
	spawnLimit = 9,
...
addLairTemplate("endor_panshee_ritualist_neutral_small_theater", endor_panshee_ritualist_neutral_small_theater)
