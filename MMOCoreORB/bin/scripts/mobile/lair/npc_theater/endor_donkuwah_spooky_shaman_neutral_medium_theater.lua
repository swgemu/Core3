endor_donkuwah_spooky_shaman_neutral_medium_theater = Lair:new {
	mobiles = {
...
addLairTemplate("endor_donkuwah_spooky_shaman_neutral_medium_theater", endor_donkuwah_spooky_shaman_neutral_medium_theater)
