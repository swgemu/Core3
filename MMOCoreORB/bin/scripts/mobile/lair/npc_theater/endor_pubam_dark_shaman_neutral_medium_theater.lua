endor_pubam_dark_shaman_neutral_medium_theater = Lair:new {
	mobiles = {
		{"bewitching_pubam_dark_shaman",1},
		{"tainted_pubam_dark_shaman",1},
		{"pubam_dark_shaman",1}
	},
	spawnLimit = 12,
...
addLairTemplate("endor_pubam_dark_shaman_neutral_medium_theater", endor_pubam_dark_shaman_neutral_medium_theater)
