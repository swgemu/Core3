dathomir_escaped_nightsister_slave_camp_neutral_medium_theater = Lair:new {
	mobiles = {
		...
		{"domesticated_brackaset_slave",1},
	},
	spawnLimit = 12,
...
addLairTemplate("dathomir_escaped_nightsister_slave_camp_neutral_medium_theater", dathomir_escaped_nightsister_slave_camp_neutral_medium_theater)
