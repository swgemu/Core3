talus_binayre_chief_camp_neutral_large_theater = Lair:new {
	mobiles = {{"binayre_chief",1},{"binayre_smuggler",1},{"binayre_pirate",1}},
	spawnLimit = 15,
...
addLairTemplate("talus_binayre_chief_camp_neutral_large_theater", talus_binayre_chief_camp_neutral_large_theater)
