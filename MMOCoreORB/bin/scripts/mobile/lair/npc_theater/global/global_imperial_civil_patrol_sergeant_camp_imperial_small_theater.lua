global_imperial_civil_patrol_sergeant_camp_imperial_small_theater = Lair:new {
	mobiles = {
		{"civil_patrol_sergeant",1},
...
addLairTemplate("global_imperial_civil_patrol_sergeant_camp_imperial_small_theater", global_imperial_civil_patrol_sergeant_camp_imperial_small_theater)
