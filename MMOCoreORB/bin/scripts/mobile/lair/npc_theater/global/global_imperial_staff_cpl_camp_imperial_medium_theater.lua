global_imperial_staff_cpl_camp_imperial_medium_theater = Lair:new {
	mobiles = {{"imperial_staff_corporal",1}},
	spawnLimit = 12,
...
addLairTemplate("global_imperial_staff_cpl_camp_imperial_medium_theater", global_imperial_staff_cpl_camp_imperial_medium_theater)
