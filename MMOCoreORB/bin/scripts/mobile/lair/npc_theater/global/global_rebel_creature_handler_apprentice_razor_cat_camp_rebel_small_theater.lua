...
addLairTemplate("global_rebel_creature_handler_apprentice_razor_cat_camp_rebel_small_theater", global_rebel_creature_handler_apprentice_razor_cat_camp_rebel_small_theater)
