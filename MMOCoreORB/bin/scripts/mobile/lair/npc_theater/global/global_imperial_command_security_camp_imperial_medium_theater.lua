global_imperial_command_security_camp_imperial_medium_theater = Lair:new {
...
addLairTemplate("global_imperial_command_security_camp_imperial_medium_theater", global_imperial_command_security_camp_imperial_medium_theater)
