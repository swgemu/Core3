naboo_plasma_thief_camp_neutral_large_theater = Lair:new {
...
addLairTemplate("naboo_plasma_thief_camp_neutral_large_theater", naboo_plasma_thief_camp_neutral_large_theater)
