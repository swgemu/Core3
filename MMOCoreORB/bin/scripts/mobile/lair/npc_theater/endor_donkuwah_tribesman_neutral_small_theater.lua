endor_donkuwah_tribesman_neutral_small_theater = Lair:new {
	mobiles = {
...
addLairTemplate("endor_donkuwah_tribesman_neutral_small_theater", endor_donkuwah_tribesman_neutral_small_theater)
