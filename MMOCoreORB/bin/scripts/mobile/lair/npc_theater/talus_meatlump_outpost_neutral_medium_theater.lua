talus_meatlump_outpost_neutral_medium_theater = Lair:new {
...
addLairTemplate("talus_meatlump_outpost_neutral_medium_theater", talus_meatlump_outpost_neutral_medium_theater)
