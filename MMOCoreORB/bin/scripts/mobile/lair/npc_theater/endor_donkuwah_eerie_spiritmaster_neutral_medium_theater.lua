endor_donkuwah_eerie_spiritmaster_neutral_medium_theater = Lair:new {
	mobiles = {
		{"eerie_donkuwah_spiritmaster",1},
		{"donkuwah_shaman",1}
	},
	spawnLimit = 12,
...
addLairTemplate("endor_donkuwah_eerie_spiritmaster_neutral_medium_theater", endor_donkuwah_eerie_spiritmaster_neutral_medium_theater)
