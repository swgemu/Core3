endor_korga_dark_shaman_neutral_small_theater = Lair:new {
	mobiles = {
		{"korga_dark_shaman",1},
...
addLairTemplate("endor_korga_dark_shaman_neutral_small_theater", endor_korga_dark_shaman_neutral_small_theater)
