corellia_lord_nyax_church_neutral_medium_theater = Lair:new {
	mobiles = {{"zealot_of_lord_nyax",1},{"fanatic_of_lord_nyax",1},{"disciple_of_lord_nyax",1}},
	spawnLimit = 15,
...
addLairTemplate("corellia_lord_nyax_church_neutral_medium_theater", corellia_lord_nyax_church_neutral_medium_theater)
