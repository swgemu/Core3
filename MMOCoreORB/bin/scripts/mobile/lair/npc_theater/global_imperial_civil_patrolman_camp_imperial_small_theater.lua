global_imperial_civil_patrolman_camp_imperial_small_theater = Lair:new {
	mobiles = {
		{"civilian_patrolman",1}
	},
	spawnLimit = 9,
...
addLairTemplate("global_imperial_civil_patrolman_camp_imperial_small_theater", global_imperial_civil_patrolman_camp_imperial_small_theater)
