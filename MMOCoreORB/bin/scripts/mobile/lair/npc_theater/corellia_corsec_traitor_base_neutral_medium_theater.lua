corellia_corsec_traitor_base_neutral_medium_theater = Lair:new {
	mobiles = {{"corsec_traitor",1}},
	spawnLimit = 15,
...
addLairTemplate("corellia_corsec_traitor_base_neutral_medium_theater", corellia_corsec_traitor_base_neutral_medium_theater)
