dathomir_bolma_craggy_lair_neutral_medium = Lair:new {
	mobiles = {{"craggy_bolma", 0}},
	spawnLimit = 15,
...
addLairTemplate("dathomir_bolma_craggy_lair_neutral_medium", dathomir_bolma_craggy_lair_neutral_medium)
