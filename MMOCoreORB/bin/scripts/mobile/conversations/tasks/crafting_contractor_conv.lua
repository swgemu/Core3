...
init = ConvoScreen:new {
	...
	options = {
		{"@conversation/crafting_contractor:s_14e7249", "what_sort_of_job"}, -- Yes, I am interested.
		{"@conversation/crafting_contractor:s_14e7249", "come_back_for_work"}, -- No, not right now.
	}
}
...
how_challenging = ConvoScreen:new {
	id = "how_challenging",
	leftDialog = "@conversation/crafting_contractor:s_8cadb7f", -- How challenging of a task would you like?
	stopConversation = "false",
	options = {
...
craftingContractorConvoTemplate:addScreen(how_challenging);
...
come_back_for_work = ConvoScreen:new {
	...
	leftDialog = "@conversation/crafting_contractor:s_436186dd", -- Alright. Come back if you need the work.
...
init_incomplete_job = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/crafting_contractor:s_e3aab67f", "back_when_finished"}, -- I'll get back to work.
		{"@conversation/crafting_contractor:s_e3aab67f", "take_back_crate"}, -- I've changed my mind. I don't want to do this job.
	}
}
