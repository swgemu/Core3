...
init = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/lf_safetyquestgiver:s_138", ""}, -- Nasty?  Only if you are too weak to protect yourself.
	}
}
...
meaning1 = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/lf_safetyquestgiver:s_115", "giveQuest1_2"}, -- I'd be happy to clear the way.
...
explanation = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/lf_safetyquestgiver:s_127", "giveQuest1_1"}, -- I'd be happy to help you make the area safer.
...
gerakVurtimisConvoTemplate:addScreen(giveQuest1_1);

giveQuest1_2 = ConvoScreen:new {
	id = "giveQuest1_2",
...
gerakVurtimisConvoTemplate:addScreen(giveQuest1_2);
...
prompt_quest2 = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/lf_safetyquestgiver:s_186", ""}, -- Sure.  I'm always ready for a good fight.
		{"@conversation/lf_safetyquestgiver:s_194", ""}, -- Sorry, I'm too busy right now.
	}
}
...
prompt_quest3 = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/lf_safetyquestgiver:s_226", ""}, -- What do you mean?
		{"@conversation/lf_safetyquestgiver:s_265", ""}, -- Good.  I want to go after tougher prey.  Tell me more.
	}
}
...
quest3_status = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/lf_safetyquestgiver:s_284", "new_loc"}, -- Actually, I'm lost.  Can you give me that waypoint again?
	}
}
