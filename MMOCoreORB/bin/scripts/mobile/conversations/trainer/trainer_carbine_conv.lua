trainer_carbine_convotemplate = ConvoTemplate:new {
	initialScreen = "convoscreen1",
	screens = {}
}

trainer_carbine_convoscreen1 = ConvoScreen:new {
	id = "convoscreen1",
	leftDialog = "@skill_teacher:trainer_carbine", -- Hello friend.  I teach basic use of the carbine.  I assume you're here to learn?
	options = { 
...
trainer_carbine_convotemplate:addScreen(trainer_carbine_convoscreen1);

-- Screen coming with the optionlist of all currently learnable skills
trainer_carbine_convoscreen2 = ConvoScreen:new {
	id = "convoscreen2",
...
trainer_carbine_convotemplate:addScreen(trainer_carbine_convoscreen2);

-- coming with the optionlist for all the skills you are able to learn next?
trainer_carbine_convoscreen3 = ConvoScreen:new {
	id = "convoscreen3",
...
trainer_carbine_convotemplate:addScreen(trainer_carbine_convoscreen3);

-- poping up when conversing with a trainer you are not qualified for
trainer_carbine_convoscreen4 = ConvoScreen:new {
	id = "convoscreen4",
...
trainer_carbine_convotemplate:addScreen(trainer_carbine_convoscreen4);

-- after clicking on a learable skill
trainer_carbine_convoscreen5 = ConvoScreen:new {
	id = "convoscreen5",
...
trainer_carbine_convotemplate:addScreen(trainer_carbine_convoscreen5);

-- after clicking yes when asked "Are you sure..."
trainer_carbine_convoscreen6 = ConvoScreen:new {
	id = "convoscreen6",
	leftDialog = "@skill_teacher:msg_yes", --Excellent! Let's get started then...
	options = { }
}
trainer_carbine_convotemplate:addScreen(trainer_carbine_convoscreen6);

-- after clicking no when asked "Are you sure..."
trainer_carbine_convoscreen7 = ConvoScreen:new {
	id = "convoscreen7",
...
trainer_carbine_convotemplate:addScreen(trainer_carbine_convoscreen7);

-- after successfully learning a skill and still having skills left to learn (enogh xp already or not)
trainer_carbine_convoscreen8 = ConvoScreen:new {
	id = "convoscreen8",
...
trainer_carbine_convotemplate:addScreen(trainer_carbine_convoscreen8);

-- after successfully learning the last available skill from a trainer
trainer_carbine_convoscreen9 = ConvoScreen:new {
	id = "convoscreen9",
...
trainer_carbine_convotemplate:addScreen(trainer_carbine_convoscreen9);

-- after clicking a skill from the "What skills will I be able to learn next?" optionlist
trainer_carbine_convoscreen10 = ConvoScreen:new {
	id = "convoscreen10",
...
trainer_carbine_convotemplate:addScreen(trainer_carbine_convoscreen10);

-- after clicking "I'm interested in learning a skill." and not having enogh xp for any skill
trainer_carbine_convoscreen11 = ConvoScreen:new {
	id = "convoscreen11",
...
trainer_carbine_convotemplate:addScreen(trainer_carbine_convoscreen11);

trainer_carbine_convoscreen12 = ConvoScreen:new {
	id = "convoscreen12",
...
trainer_carbine_convotemplate:addScreen(trainer_carbine_convoscreen12);

-- conversing with a trainer after reaching master in that profession
trainer_carbine_convoscreen13 = ConvoScreen:new {
	id = "convoscreen13",
...
trainer_carbine_convotemplate:addScreen(trainer_carbine_convoscreen13);

addConversationTemplate("trainer_carbine_convotemplate", trainer_carbine_convotemplate);
