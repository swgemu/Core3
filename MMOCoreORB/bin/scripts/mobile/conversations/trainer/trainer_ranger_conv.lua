trainer_ranger_convotemplate = ConvoTemplate:new {
	initialScreen = "convoscreen1",
	screens = {}
}

trainer_ranger_convoscreen1 = ConvoScreen:new {
	id = "convoscreen1",
	leftDialog = "@skill_teacher:trainer_ranger", -- I can track a bird on a cloudy day.  If you want to even approach my skills you better pay attention.
	options = { 
...
trainer_ranger_convotemplate:addScreen(trainer_ranger_convoscreen1);

-- Screen coming with the optionlist of all currently learnable skills
trainer_ranger_convoscreen2 = ConvoScreen:new {
	id = "convoscreen2",
...
trainer_ranger_convotemplate:addScreen(trainer_ranger_convoscreen2);

-- coming with the optionlist for all the skills you are able to learn next?
trainer_ranger_convoscreen3 = ConvoScreen:new {
	id = "convoscreen3",
...
trainer_ranger_convotemplate:addScreen(trainer_ranger_convoscreen3);

-- poping up when conversing with a trainer you are not qualified for
trainer_ranger_convoscreen4 = ConvoScreen:new {
	id = "convoscreen4",
...
trainer_ranger_convotemplate:addScreen(trainer_ranger_convoscreen4);

-- after clicking on a learable skill
trainer_ranger_convoscreen5 = ConvoScreen:new {
	id = "convoscreen5",
...
trainer_ranger_convotemplate:addScreen(trainer_ranger_convoscreen5);

-- after clicking yes when asked "Are you sure..."
trainer_ranger_convoscreen6 = ConvoScreen:new {
	id = "convoscreen6",
	leftDialog = "@skill_teacher:msg_yes", --Excellent! Let's get started then...
	options = { }
}
trainer_ranger_convotemplate:addScreen(trainer_ranger_convoscreen6);

-- after clicking no when asked "Are you sure..."
trainer_ranger_convoscreen7 = ConvoScreen:new {
	id = "convoscreen7",
...
trainer_ranger_convotemplate:addScreen(trainer_ranger_convoscreen7);

-- after successfully learning a skill and still having skills left to learn (enogh xp already or not)
trainer_ranger_convoscreen8 = ConvoScreen:new {
	id = "convoscreen8",
...
trainer_ranger_convotemplate:addScreen(trainer_ranger_convoscreen8);

-- after successfully learning the last available skill from a trainer
trainer_ranger_convoscreen9 = ConvoScreen:new {
	id = "convoscreen9",
...
trainer_ranger_convotemplate:addScreen(trainer_ranger_convoscreen9);

-- after clicking a skill from the "What skills will I be able to learn next?" optionlist
trainer_ranger_convoscreen10 = ConvoScreen:new {
	id = "convoscreen10",
...
trainer_ranger_convotemplate:addScreen(trainer_ranger_convoscreen10);

-- after clicking "I'm interested in learning a skill." and not having enogh xp for any skill
trainer_ranger_convoscreen11 = ConvoScreen:new {
	id = "convoscreen11",
...
trainer_ranger_convotemplate:addScreen(trainer_ranger_convoscreen11);

trainer_ranger_convoscreen12 = ConvoScreen:new {
	id = "convoscreen12",
...
trainer_ranger_convotemplate:addScreen(trainer_ranger_convoscreen12);

-- conversing with a trainer after reaching master in that profession
trainer_ranger_convoscreen13 = ConvoScreen:new {
	id = "convoscreen13",
...
trainer_ranger_convotemplate:addScreen(trainer_ranger_convoscreen13);

addConversationTemplate("trainer_ranger_convotemplate", trainer_ranger_convotemplate);
