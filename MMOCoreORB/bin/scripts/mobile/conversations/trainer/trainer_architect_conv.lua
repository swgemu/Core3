trainer_architect_convotemplate = ConvoTemplate:new {
	initialScreen = "convoscreen1",
	screens = {}
}

trainer_architect_convoscreen1 = ConvoScreen:new {
	id = "convoscreen1",
	leftDialog = "@skill_teacher:trainer_architect", -- I built the biggest houses with the best layouts on every planet from here to Dathomir.  And now my knowledge is yours.
	options = { 
...
trainer_architect_convotemplate:addScreen(trainer_architect_convoscreen1);

-- Screen coming with the optionlist of all currently learnable skills
trainer_architect_convoscreen2 = ConvoScreen:new {
	id = "convoscreen2",
...
trainer_architect_convotemplate:addScreen(trainer_architect_convoscreen2);

-- coming with the optionlist for all the skills you are able to learn next?
trainer_architect_convoscreen3 = ConvoScreen:new {
	id = "convoscreen3",
...
trainer_architect_convotemplate:addScreen(trainer_architect_convoscreen3);

-- poping up when conversing with a trainer you are not qualified for
trainer_architect_convoscreen4 = ConvoScreen:new {
	id = "convoscreen4",
...
trainer_architect_convotemplate:addScreen(trainer_architect_convoscreen4);

-- after clicking on a learable skill
trainer_architect_convoscreen5 = ConvoScreen:new {
	id = "convoscreen5",
...
trainer_architect_convotemplate:addScreen(trainer_architect_convoscreen5);

-- after clicking yes when asked "Are you sure..."
trainer_architect_convoscreen6 = ConvoScreen:new {
	id = "convoscreen6",
	leftDialog = "@skill_teacher:msg_yes", --Excellent! Let's get started then...
	options = { }
}
trainer_architect_convotemplate:addScreen(trainer_architect_convoscreen6);

-- after clicking no when asked "Are you sure..."
trainer_architect_convoscreen7 = ConvoScreen:new {
	id = "convoscreen7",
...
trainer_architect_convotemplate:addScreen(trainer_architect_convoscreen7);

-- after successfully learning a skill and still having skills left to learn (enogh xp already or not)
trainer_architect_convoscreen8 = ConvoScreen:new {
	id = "convoscreen8",
...
trainer_architect_convotemplate:addScreen(trainer_architect_convoscreen8);

-- after successfully learning the last available skill from a trainer
trainer_architect_convoscreen9 = ConvoScreen:new {
	id = "convoscreen9",
...
trainer_architect_convotemplate:addScreen(trainer_architect_convoscreen9);

-- after clicking a skill from the "What skills will I be able to learn next?" optionlist
trainer_architect_convoscreen10 = ConvoScreen:new {
	id = "convoscreen10",
...
trainer_architect_convotemplate:addScreen(trainer_architect_convoscreen10);

-- after clicking "I'm interested in learning a skill." and not having enogh xp for any skill
trainer_architect_convoscreen11 = ConvoScreen:new {
	id = "convoscreen11",
...
trainer_architect_convotemplate:addScreen(trainer_architect_convoscreen11);

trainer_architect_convoscreen12 = ConvoScreen:new {
	id = "convoscreen12",
...
trainer_architect_convotemplate:addScreen(trainer_architect_convoscreen12);

-- conversing with a trainer after reaching master in that profession
trainer_architect_convoscreen13 = ConvoScreen:new {
	id = "convoscreen13",
...
trainer_architect_convotemplate:addScreen(trainer_architect_convoscreen13);

addConversationTemplate("trainer_architect_convotemplate", trainer_architect_convotemplate);
