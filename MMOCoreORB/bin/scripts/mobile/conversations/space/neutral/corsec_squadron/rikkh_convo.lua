...
failed_second_mission = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/corellia_privateer_trainer_2:s_158b60f", "fail_first_terrible"}, -- Just fine
	}
}
...
fourth_mission = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/corellia_privateer_trainer_2:s_82e1c248", "accept_assassinate"}, -- What kind of orders?
	}
}
...
failed_fourth_mission = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/corellia_privateer_trainer_2:s_1e666f74", ""}, -- Equipment malfunction
	}
}
...
pilot_error = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/corellia_privateer_trainer_2:s_f9c365f7", ""}, -- I don't know
	}
}
...
pilot_error = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/corellia_privateer_trainer_2:s_4e94fa0f", "s_485284b6"}, -- I'll try again
	}
}
rikkh_convo_template:addScreen(pilot_error)
