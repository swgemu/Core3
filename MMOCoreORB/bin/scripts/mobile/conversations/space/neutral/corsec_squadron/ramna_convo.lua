...
every_move = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/corellia_privateer_tier3:s_1001fca4", ""}, -- Of course they do! We've already discussed the problem.
	}
}
...
engineers_not_done = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/corellia_privateer_tier3:s_d2ab8937", ""}, -- Then we're out of luck.
	}
}
...
pirates_had_intel = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/corellia_privateer_tier3:s_671470cf", ""}, -- It's almost like they KNEW I was going to be there.
		{"@conversation/corellia_privateer_tier3:s_6b7c6e79", ""}, -- Of course they did! We've already discussed the problem.
	}
}
...
comlink_hole = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/corellia_privateer_tier3:s_ad973bd9", ""}, -- Yeah.
	}
}
