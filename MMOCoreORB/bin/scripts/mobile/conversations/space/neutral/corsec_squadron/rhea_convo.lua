...
more_training = ConvoScreen:new {
	...
	animation = "salute1",
	options = {
		--{"@conversation/corellia_privateer_trainer:s_b7fc5e5d", "train_player_droid"}, -- I'm interested in droid interface basics.
		--{"@conversation/corellia_privateer_trainer:s_8523e1fc", "train_player_basics"}, -- I'm interested in basic training.
		--{"@conversation/corellia_privateer_trainer:s_c06c7aa9", "train_player_fighters"}, -- I'm interested in basic fighters.
		--{"@conversation/corellia_privateer_trainer:s_d1431f95", "train_player_component"}, -- I'm interested in basic starship component use.
	}
}
