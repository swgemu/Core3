...
kreezo_convo_grant_quest1 = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/corellia_rebel_trainer_1:s_b39049de", "when_train_quest1"}, -- When will you train me?
	}
}
...
-- When will you train me - Quest 1
kreezo_convo_when_train_quest1 = ConvoScreen:new {
	id = "when_train_quest1",
	leftDialog = "@conversation/corellia_rebel_trainer_1:s_fe5c41db", -- Slow down, there, %NU. I need to know you can be trusted to complete assignments as they are given. I'll train you AFTER you've finished doing a few things for me. Now, are you ready to get started?
	stopConversation = "false",
	animation = "slow_down",
	options = {
		{"@conversation/corellia_rebel_trainer_1:s_d731f764", "quest1_accepted"}, -- (Shrug and smile.)
...
kreezo_convo:addScreen(kreezo_convo_when_train_quest1)
...
-- When will you train me - Quest 3
kreezo_convo_when_train_quest3 = ConvoScreen:new {
	id = "when_train_quest3",
	leftDialog = "@conversation/corellia_rebel_trainer_1:s_190d7fcd", -- Slow down, there, %NU. I need to know you can be trusted to complete assignments as they are given. I'll train you AFTER you've finished doing a couple more things for me. Now, about that lost transport...
	stopConversation = "false",
	animation = "slow_down",
	options = {
		...
		{"@conversation/corellia_rebel_trainer_1:s_5adefc5c", "quest3_monsters"}, -- Refugees?! Those monsters!
		{"@conversation/corellia_rebel_trainer_1:s_b39049de", "when_train_quest3"}, -- When will you train me?
	}
}
kreezo_convo:addScreen(kreezo_convo_when_train_quest3)
...
kreezo_convo_quest2_goodbye = ConvoScreen:new {
	id = "quest2_goodbye",
	leftDialog = "@conversation/corellia_rebel_trainer_1:s_90f5b9d8", -- Make sure you stay in one piece, man! (male default, female set in handler)
	animation = "wave_finger_warning",
	stopConversation = "true",
	options = {}
}
...
-- Quest 3 Monsters ("Refugees?! Those monsters!" path)
kreezo_convo_quest3_monsters = ConvoScreen:new {
	id = "quest3_monsters",
	leftDialog = "@conversation/corellia_rebel_trainer_1:s_1bd844f1", -- You said it! We need you to track down the transport and escort it safely out of Corellia space. You ready?
	stopConversation = "false",
	animation = "explain",
	options = {
		{"@conversation/corellia_rebel_trainer_1:s_dc649bb3", "quest3_monsters_goodbye"}, -- I'm on my way.
		{"@conversation/corellia_rebel_trainer_1:s_bccfa654", "quest3_monsters_location"}, -- Where was it last seen?
	}
}
kreezo_convo:addScreen(kreezo_convo_quest3_monsters)

-- Quest 3 Monsters Goodbye
kreezo_convo_quest3_monsters_goodbye = ConvoScreen:new {
	id = "quest3_monsters_goodbye",
	leftDialog = "@conversation/corellia_rebel_trainer_1:s_a80d9308", -- Good luck!
	stopConversation = "true",
	animation = "wave2",
	options = {}
}
kreezo_convo:addScreen(kreezo_convo_quest3_monsters_goodbye)

-- Quest 3 Monsters Location
kreezo_convo_quest3_monsters_location = ConvoScreen:new {
	id = "quest3_monsters_location",
	leftDialog = "@conversation/corellia_rebel_trainer_1:s_e2e4a27d", -- No idea. The comm traffic is a mess...
	stopConversation = "true",
	animation = "shake_head_no",
	options = {}
}
kreezo_convo:addScreen(kreezo_convo_quest3_monsters_location)
...
kreezo_convo_quest4_salute_goodbye = ConvoScreen:new {
	...
	leftDialog = "@conversation/corellia_rebel_trainer_1:s_472", -- Good luck. (female default, male gets s_fe6d50dd)
	stopConversation = "true",
	animation = "goodbye",
	options = {}
}
...
kreezo_convo_first_training = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/corellia_rebel_trainer_1:s_d70dba34", "train_starships"}, -- Yes.
	}
}
...
kreezo_convo_ground_forces = ConvoScreen:new {
	id = "ground_forces",
	leftDialog = "@conversation/corellia_rebel_trainer_1:s_28eea20", -- Woah! I didn't see that coming! You're sure you know what you're getting into? You could be opening yourself to attack when you least expect it... even as a covert operative.
	stopConversation = "false",
	animation = "slow_down",
	options = {
		{"@conversation/corellia_rebel_trainer_1:s_13d3df42", "ground_forces_acknowledge"}, -- I know
	}
}
kreezo_convo:addScreen(kreezo_convo_ground_forces)

-- Ground Forces Acknowledge
kreezo_convo_ground_forces_acknowledge = ConvoScreen:new {
	id = "ground_forces_acknowledge",
	leftDialog = "@conversation/corellia_rebel_trainer_1:s_2098126f", -- Excellent! The Rebel Alliance can use some more boots on the ground, too. You can change your level of commitment to the Rebellion using the /pvp command. This will allow you to switch between being a combatant and in special forces.
	stopConversation = "true",
	animation = "pound_fist_chest",
	options = {}
}
kreezo_convo:addScreen(kreezo_convo_ground_forces_acknowledge)
