...
kreezo_convo_female_join_confirm = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/corellia_rebel_trainer_1:s_e6f57b04", "female_angry"}, -- Call me that again and you die!
	}
}
kreezo_convo:addScreen(kreezo_convo_female_join_confirm)

-- Female response - kidding
kreezo_convo_female_kidding = ConvoScreen:new {
	id = "female_kidding",
	leftDialog = "@conversation/corellia_rebel_trainer_1:s_10338636", -- Just kidding. I hate the Empire!
	stopConversation = "false",
	animation = "belly_laugh",
	options = {
		{"@conversation/corellia_rebel_trainer_1:s_13d3df42", "female_please"}, -- I know
	}
}
