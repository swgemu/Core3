...
kreezo_convo_quest2_location = ConvoScreen:new {
	id = "quest2_location",
	leftDialog = "@conversation/corellia_rebel_trainer_1:s_8a3ee988", -- Corellia System. They can be found all over the place in the Corellia system. Four TIE Fighters and you're done. Good luck!
	animation = "explain",
	stopConversation = "true",
	options = {}
}
...
kreezo_convo_quest2_goodbye = ConvoScreen:new {
	id = "quest2_goodbye",
	leftDialog = "@conversation/corellia_rebel_trainer_1:s_2c88c41d", -- Good luck, pilot! Make 'em pay!
	animation = "goodbye",
	stopConversation = "true",
	options = {}
}
