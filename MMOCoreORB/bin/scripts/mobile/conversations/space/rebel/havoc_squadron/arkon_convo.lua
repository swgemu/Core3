...
excellent_work = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/corellia_rebel_tier4:s_95c399f6", "ready_train_pilot"}, -- I sure do.
...
-- Both paths converge here → training
intro_enlightened = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/corellia_rebel_tier4:s_98588d70", "ready_train_pilot"}, -- OK fine.
	}
}
