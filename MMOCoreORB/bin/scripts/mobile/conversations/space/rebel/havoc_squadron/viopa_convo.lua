...
viopa_convo_mission2_brief = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/lok_rebel_trainer_2:s_95a207fe", "mission2_count_on_you"}, -- Alright, what do you need help with, milady?
		{"@conversation/lok_rebel_trainer_2:s_eb569089", "mission2_charming"}, -- Sounds great. This interests me why?
		{"@conversation/lok_rebel_trainer_2:s_38aeb877", "mission2_hurry_back"}, -- Oh I was just passing by. I can't help right now.
	}
}
viopa_convo:addScreen(viopa_convo_mission2_brief)

-- Branch 63: Polite path - "I'm so glad I can always count on you..."
viopa_convo_mission2_count_on_you = ConvoScreen:new {
	id = "mission2_count_on_you",
	...
	stopConversation = "false",
	options = {
		{"@conversation/lok_rebel_trainer_2:s_c84e7a8", "mission2_why_me"}, -- Why me? I'm a pilot.
		{"@conversation/lok_rebel_trainer_2:s_d14eedc8", "mission2_accept_1"}, -- Of course. Where can I find him?
	}
}
viopa_convo:addScreen(viopa_convo_mission2_count_on_you)

-- Branch 64: "Why me? I'm a pilot." explanation
viopa_convo_mission2_why_me = ConvoScreen:new {
	id = "mission2_why_me",
	...
	stopConversation = "false",
	options = {
		{"@conversation/lok_rebel_trainer_2:s_97f6ca14", "mission2_accept_1"}, -- I see. All right, where do I find him?
		{"@conversation/lok_rebel_trainer_2:s_2ccdbfbb", "mission2_decline_reschedule_1"}, -- I'm afraid I can't right now though, milady.
	}
}
viopa_convo:addScreen(viopa_convo_mission2_why_me)

-- Branch 66: Sarcastic path - "You're so charming, dear..."
viopa_convo_mission2_charming = ConvoScreen:new {
	id = "mission2_charming",
	...
	stopConversation = "false",
	options = {
		{"@conversation/lok_rebel_trainer_2:s_d6d2881d", "mission2_not_errand_boy"}, -- I'm not an errand boy.
		{"@conversation/lok_rebel_trainer_2:s_35e906c1", "mission2_accept_2"}, -- Fine. I don't really have anything to do right now anyway.
	}
}
viopa_convo:addScreen(viopa_convo_mission2_charming)

-- Branch 67: "I'm not an errand boy." explanation
viopa_convo_mission2_not_errand_boy = ConvoScreen:new {
	id = "mission2_not_errand_boy",
	...
	stopConversation = "false",
	options = {
		{"@conversation/lok_rebel_trainer_2:s_6e6242ff", "mission2_accept_1"}, -- That's an understatement. All right, I'll do it. Where is he?
		{"@conversation/lok_rebel_trainer_2:s_b59feb8d", "mission2_decline_reschedule_2"}, -- You could say that again. I can't right now, though.
	}
}
viopa_convo:addScreen(viopa_convo_mission2_not_errand_boy)

-- Mission 2 Accept 1: Polite accept path
viopa_convo_mission2_accept_1 = ConvoScreen:new {
	id = "mission2_accept_1",
...
viopa_convo:addScreen(viopa_convo_mission2_accept_1)

-- Mission 2 Accept 2: Sarcastic accept path
viopa_convo_mission2_accept_2 = ConvoScreen:new {
	id = "mission2_accept_2",
	leftDialog = "@conversation/lok_rebel_trainer_2:s_92199b82", -- Excellent. He's agreed to meet a contact of ours on Corellia. His name is Vrak and he will be waiting in the cantina of Tyrena. Do be careful, dear. I've found out that the Empire is scouring the galaxy for the data you stole. It must be terribly important.
	animation = "bow3",
	playerAnimation = "goodbye",
	stopConversation = "true",
	options = {}
}
viopa_convo:addScreen(viopa_convo_mission2_accept_2)

-- Mission 2 Hurry Back: Decline - just passing by
viopa_convo_mission2_hurry_back = ConvoScreen:new {
	id = "mission2_hurry_back",
	leftDialog = "@conversation/lok_rebel_trainer_2:s_6bb4b597", -- Do hurry back though, sweetie. This is quite important.
	animation = "nod_head_once",
	playerAnimation = "goodbye",
	stopConversation = "true",
	options = {}
}
viopa_convo:addScreen(viopa_convo_mission2_hurry_back)

-- Mission 2 Decline: Reschedule 1 (from why_me path)
viopa_convo_mission2_decline_reschedule_1 = ConvoScreen:new {
	id = "mission2_decline_reschedule_1",
...
viopa_convo:addScreen(viopa_convo_mission2_decline_reschedule_1)

-- Mission 2 Decline: Reschedule 2 (from not_errand_boy path)
viopa_convo_mission2_decline_reschedule_2 = ConvoScreen:new {
	id = "mission2_decline_reschedule_2",
	leftDialog = "@conversation/lok_rebel_trainer_2:s_194e698d", -- All right, %NU. I'll see if I can reschedule the meeting with the smuggler. Come back soon for a update.
	animation = "rub_chin_thoughtful",
	playerAnimation = "goodbye",
	stopConversation = "true",
	options = {}
}
viopa_convo:addScreen(viopa_convo_mission2_decline_reschedule_2)
