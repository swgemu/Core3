...
need_supplies = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/padawan_artist_01:s_bdf1fbc8", "meet_assistant"}, -- I get the picture. What can I do to help?
		{"@conversation/padawan_artist_01:s_bdf1fbc8", "forget_i_asked"} -- Lady, you're a freak. Get a real job and leave the rest of us alone.
	}
}
...
intro_spoke_to_target = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/padawan_artist_01:s_cc45360d", "why_i_bothered"}, -- I haven't been able to find your assistant.
