...
more_again = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/padawan_the_ring_02:s_36ab201c", "more_stuff"} -- If you insist on a fight, I won't back down.
	}
}
...
more_stuff = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/padawan_the_ring_02:s_77a2c8a3"}, -- We will see about that.
