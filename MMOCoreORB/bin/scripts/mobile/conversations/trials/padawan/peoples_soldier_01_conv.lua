...
intro = ConvoScreen:new {
	...
	options = {
		{"@conversation/padawan_peoples_soldier_01:s_df607c49", "more"} -- I'm listening.
	}
}
...
trialsPadawanPeoplesSoldier01ConvoTemplate:addScreen(more);
...
trialsPadawanPeoplesSolder01ConvoTemplate:addScreen(continue_too);

continue_gone = ConvoScreen:new {
	id = "continue_gone",
	leftDialog = "@conversation/padawan_peoples_solder_01:s_c0a878d5", -- Indeed. Then fare thee well. No... make that fare thee poorly.
	stopConversation = "true",
	options = {}
}
trialsPadawanPeoplesSolder01ConvoTemplate:addScreen(continue_gone);
