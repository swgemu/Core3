padawan_sludge_panther_01_convo_template = ConvoTemplate:new {
	initialScreen = "",
	templateType = "Lua",
...
padawan_sludge_panther_01_convo_template:addScreen(intro);
...
padawan_sludge_panther_01_convo_template:addScreen(bad_meat);
...
padawan_sludge_panther_01_convo_template:addScreen(dumped_meat);
...
padawan_sludge_panther_01_convo_template:addScreen(find_and_kill);
...
padawan_sludge_panther_01_convo_template:addScreen(intro_in_progress);
...
padawan_sludge_panther_01_convo_template:addScreen(intro_reached_goal);
...
padawan_sludge_panther_01_convo_template:addScreen(quest_completed);
...
padawan_sludge_panther_01_convo_template:addScreen(not_quest_owner);

addConversationTemplate("padawan_sludge_panther_01_convo_template", padawan_sludge_panther_01_convo_template);
