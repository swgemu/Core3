...
issue_giving_schematics = ConvoScreen:new {
	...
	leftDialog = "@conversation/qtqc_phase_3:s_31b4836a", -- I'm sorry, something went wrong; you could not be given the project schematics.
	stopConversation = "true",
	options = {}
}
villageQtQcPhase3ConvoTemplate:addScreen(issue_giving_schematics);
