...
excellent = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/combat_quest_p3:s_52917b0d", "exact_frequency"}, -- It's that easy, huh?
	}
}
...
work_with_friend = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/combat_quest_p3:s_8767a129", "power_down_generator"}, -- Tell me about powering down the shield generator...
		{"@conversation/combat_quest_p3:s_8767a129", "join_a_group"}, -- Tell me about capturing the camp's commander...
	}
}
