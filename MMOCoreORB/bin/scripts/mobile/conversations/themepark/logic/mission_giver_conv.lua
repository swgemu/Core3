...
createMissionGiverConvoTemplate("theme_park_singing_mountain_clan_mission_giver_convotemplate", "theme_park_singing_mountain_clan_mission_giver_conv_handler")
createMissionGiverConvoTemplate("theme_park_singing_mountain_clan2_mission_giver_convotemplate", "theme_park_singing_mountain_clan2_mission_giver_conv_handler")
createMissionGiverConvoTemplate("theme_park_singing_mountain_clan3_mission_giver_convotemplate", "theme_park_singing_mountain_clan3_mission_giver_conv_handler")
