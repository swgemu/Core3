...
createMissionGiverConvoTemplate("theme_park_singing_mountain_clan_zideera_mission_giver_convotemplate", "theme_park_singing_mountain_clan_zideera_mission_giver_conv_handler")
