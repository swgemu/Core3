...
createMissionTargetConvoTemplate("theme_park_singing_mountain_clan_zideera_mission_target_convotemplate", "theme_park_singing_mountain_clan_zideera_mission_target_conv_handler")
