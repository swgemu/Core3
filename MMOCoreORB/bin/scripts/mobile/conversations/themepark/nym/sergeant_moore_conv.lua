...
what_you_got = ConvoScreen:new {
       ...
       stopConversation = "false",
       options = {
               -- Add these via conv handler, need to check for credits, otherwise return you_got_nothing
               --{"@celebrity/imperial_bribe:give_50", "medium_info"}, -- How about 50 credits?
               --{"@celebrity/imperial_bribe:give_100", "the_good_stuff"}, -- I could spare 100 credits...
       }
}
