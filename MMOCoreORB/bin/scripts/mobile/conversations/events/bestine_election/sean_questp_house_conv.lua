...
quest_start2 = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/sean_questp_house:s_ab4c4ff8","quest_start_final"} --Really? Can you help me with something?
	}
}
...
seanQuestpHouseConvoTemplate:addScreen(quest_start_final);
