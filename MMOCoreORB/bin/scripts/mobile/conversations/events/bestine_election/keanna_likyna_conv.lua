keannaLikynaConvoTemplate = ConvoTemplate:new {
	initialScreen = "",
	templateType = "Lua",
	luaClassHandler = "keanna_likyna_conv_handler",
	screens = {}
}
...
no_election = ConvoScreen:new {
	...
	options = {
		{"@conversation/keanna_likyna:s_d6ecfaf4","no_election_end"} -- Okay. Thank You.
	}
}
keannaLikynaConvoTemplate:addScreen(no_election);
...
keannaLikynaConvoTemplate:addScreen(no_election_end);
