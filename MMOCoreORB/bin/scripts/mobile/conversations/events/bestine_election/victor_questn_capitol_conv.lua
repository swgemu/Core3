...
convo_start = ConvoScreen:new {
	...
	options = {
		{"@conversation/victor_questn_capitol:s_496168b6","convo_start2"}, --I need your help...
		{"@conversation/victor_questn_capitol:s_e50dbfc0","im_leaving"} --Fine. I'm leaving.
	}
}
...
victorQuestnCapitolConvoTemplate:addScreen(convo_start2);
...
noroom_returned_noroom2 = ConvoScreen:new {
	id = "noroom_returned_noroom2",
	leftDialog = "@conversation/victor_questn_capitol:s_42deb08e", --Wasting my time is not a smart idea...
	stopConversation = "true",
	options = {}
}
victorQuestnCapitolConvoTemplate:addScreen(noroom_returned_noroom2);
