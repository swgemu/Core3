indigoSiyanConvoTemplate = ConvoTemplate:new {
	initialScreen = "",
	templateType = "Lua",
	luaClassHandler = "indigo_siyan_conv_handler",
	screens = {}
}
...
no_election = ConvoScreen:new {
	...
	options = {
		{"@conversation/indigo_siyan:s_b9b27823","no_election_end"}, -- Thank you
	}
}
indigoSiyanConvoTemplate:addScreen(no_election);

no_election_end = ConvoScreen:new {
	id = "no_election_end",
	leftDialog = "@conversation/indigo_siyan:s_abf4a6a9", --My pleasure!
	stopConversation = "true",
	options = {}
}
indigoSiyanConvoTemplate:addScreen(no_election_end);
