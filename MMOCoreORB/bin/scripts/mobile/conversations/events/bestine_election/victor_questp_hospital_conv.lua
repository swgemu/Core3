...
victorQuestpHospitalConvoTemplate:addScreen(default_reply);
...
victorQuestpHospitalConvoTemplate:addScreen(no_office);
...
victorQuestpHospitalConvoTemplate:addScreen(noroom_returned_nochance);
...
quest_start = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/victor_questp_hospital:s_67a10ef6","quest_start2"}, --Who was the politician?
		{"@conversation/victor_questp_hospital:s_58411386","good_bye_2"} --No, I'm not. Good bye.
	}
}
victorQuestpHospitalConvoTemplate:addScreen(quest_start);
...
quest_start2 = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/victor_questp_hospital:s_ad2e138","quest_start_final"}, --I know how you can.
		{"@conversation/victor_questp_hospital:s_dafadce6","good_bye"}, --Yeah. Anyway, I have to go.
	}
}
victorQuestpHospitalConvoTemplate:addScreen(quest_start2);
...
victorQuestpHospitalConvoTemplate:addScreen(quest_start_final);
...
victorQuestpHospitalConvoTemplate:addScreen(good_bye);

good_bye_2 = ConvoScreen:new {
	id = "good_bye_2",
	leftDialog = "@conversation/victor_questp_hospital:s_2dc62c40", --Uh... bye! Come back soon! And be sure to make a donation next time!
	stopConversation = "true",
	options = {}
}
victorQuestpHospitalConvoTemplate:addScreen(good_bye_2);
