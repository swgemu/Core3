victorVisalisPhase2ConvoTemplate = ConvoTemplate:new {
	initialScreen = "",
	templateType = "Lua",
	luaClassHandler = "victorVisalisPhase2ConvoHandler",
	screens = {}
}
...
victorVisalisPhase2ConvoTemplate:addScreen(convo_start);
...
victorVisalisPhase2ConvoTemplate:addScreen(proposed_changes);
...
victorVisalisPhase2ConvoTemplate:addScreen(proposed_changes2);
...
victorVisalisPhase2ConvoTemplate:addScreen(here_to_vote);
...
victorVisalisPhase2ConvoTemplate:addScreen(here_to_vote2);
...
victorVisalisPhase2ConvoTemplate:addScreen(here_to_vote3);
...
victorVisalisPhase2ConvoTemplate:addScreen(about_tuskens);
...
victorVisalisPhase2ConvoTemplate:addScreen(about_tuskens2);
...
victorVisalisPhase2ConvoTemplate:addScreen(notInOffice_noElection);
...
victorVisalisPhase2ConvoTemplate:addScreen(rival_player);
...
victorVisalisPhase2ConvoTemplate:addScreen(voted_victor_this_election);
...
victorVisalisPhase2ConvoTemplate:addScreen(voted_sean_this_election);
...
victorVisalisPhase2ConvoTemplate:addScreen(nquest_joincampaign);
...
victorVisalisPhase2ConvoTemplate:addScreen(joincampaign_noroom);
...
victorVisalisPhase2ConvoTemplate:addScreen(returned_noroom);
...
victorVisalisPhase2ConvoTemplate:addScreen(noroom_returned_noroom);
...
victorVisalisPhase2ConvoTemplate:addScreen(noroom_returned_joincampaign);
...
victorVisalisPhase2ConvoTemplate:addScreen(cant_find_evidence);
...
victorVisalisPhase2ConvoTemplate:addScreen(decided_no_vote);
...
victorVisalisPhase2ConvoTemplate:addScreen(endconvo_friendly);
...
victorVisalisPhase2ConvoTemplate:addScreen(changed_mind);
...
victorVisalisPhase2ConvoTemplate:addScreen(action_nquest);
...
victorVisalisPhase2ConvoTemplate:addScreen(joinCampaign_giveDisk);
...
victorVisalisPhase2ConvoTemplate:addScreen(nquest_return);
...
victorVisalisPhase2ConvoTemplate:addScreen(nquest_found);
...
victorVisalisPhase2ConvoTemplate:addScreen(nquest_notfound);
...
victorVisalisPhase2ConvoTemplate:addScreen(nquest_nojoin);
...
victorVisalisPhase2ConvoTemplate:addScreen(ask_voted);
...
victorVisalisPhase2ConvoTemplate:addScreen(checkForVote_true);
...
victorVisalisPhase2ConvoTemplate:addScreen(checkForVote_false);
...
victorVisalisPhase2ConvoTemplate:addScreen(victor_inOffice);
...
victorVisalisPhase2ConvoTemplate:addScreen(inOffice_votedvictor);
...
victorVisalisPhase2ConvoTemplate:addScreen(inOffice_votedsean);
...
victorVisalisPhase2ConvoTemplate:addScreen(inOffice_newElection);
...
victorVisalisPhase2ConvoTemplate:addScreen(endconvo_verywell);
...
victorVisalisPhase2ConvoTemplate:addScreen(tuskenquest_complete);
...
victorVisalisPhase2ConvoTemplate:addScreen(tuskenquest_foundstones);
...
victorVisalisPhase2ConvoTemplate:addScreen(inOffice_onTuskenQuest);
...
victorVisalisPhase2ConvoTemplate:addScreen(destroyed_target);
...
victorVisalisPhase2ConvoTemplate:addScreen(tusken_reward_given);
...
victorVisalisPhase2ConvoTemplate:addScreen(retell_tusken_quest);
...
victorVisalisPhase2ConvoTemplate:addScreen(still_looking);
...
victorVisalisPhase2ConvoTemplate:addScreen(quit_tusken_quest);
...
victorVisalisPhase2ConvoTemplate:addScreen(found_stones);
...
victorVisalisPhase2ConvoTemplate:addScreen(already_received_election_reward);
...
victorVisalisPhase2ConvoTemplate:addScreen(give_election_reward);
...
victorVisalisPhase2ConvoTemplate:addScreen(election_reward_noroom);
...
victorVisalisPhase2ConvoTemplate:addScreen(tuskenquest_intro);
...
victorVisalisPhase2ConvoTemplate:addScreen(tuskenquest_letmehelp);
...
victorVisalisPhase2ConvoTemplate:addScreen(tuskenquest_decline);
...
victorVisalisPhase2ConvoTemplate:addScreen(tuskenquest_accept);
...
victorVisalisPhase2ConvoTemplate:addScreen(tuskenquest_toughdeal);

addConversationTemplate("victorVisalisPhase2ConvoTemplate", victorVisalisPhase2ConvoTemplate);
