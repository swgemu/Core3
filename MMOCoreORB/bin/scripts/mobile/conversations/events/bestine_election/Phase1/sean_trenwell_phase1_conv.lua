seanTrenwellPhase1ConvoTemplate = ConvoTemplate:new {
	initialScreen = "",
	templateType = "Lua",
	luaClassHandler = "seanTrenwellPhase1ConvoHandler",
	screens = {}
}
...
convo_start = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/sean_trenwell:s_bab1f93a","goodbye_pleasant"},--I have to go. Sorry!
	}
}
seanTrenwellPhase1ConvoTemplate:addScreen(convo_start);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_newElection);
...
seanTrenwellPhase1ConvoTemplate:addScreen(proposed_changes);
...
seanTrenwellPhase1ConvoTemplate:addScreen(proposed_changes2);
...
seanTrenwellPhase1ConvoTemplate:addScreen(proposed_changes3);
...
seanTrenwellPhase1ConvoTemplate:addScreen(about_tuskins);
...
here_to_vote = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/sean_trenwell:s_540ac7e9","here_to_vote_continue"},--Continue
	}
}
seanTrenwellPhase1ConvoTemplate:addScreen(here_to_vote);

here_to_vote_continue = ConvoScreen:new {
	id = "here_to_vote_continue",
...
seanTrenwellPhase1ConvoTemplate:addScreen(here_to_vote_continue);
...
seanTrenwellPhase1ConvoTemplate:addScreen(returned_noroom);
...
seanTrenwellPhase1ConvoTemplate:addScreen(ask_voted);
...
seanTrenwellPhase1ConvoTemplate:addScreen(checkForVote_true);
...
seanTrenwellPhase1ConvoTemplate:addScreen(checkForVote_false);
...
seanTrenwellPhase1ConvoTemplate:addScreen(get_going);
...
seanTrenwellPhase1ConvoTemplate:addScreen(returned_noroom_nojoin);
...
seanTrenwellPhase1ConvoTemplate:addScreen(joincampaign_givedisk);
...
seanTrenwellPhase1ConvoTemplate:addScreen(joincampaign_noroom);
...
seanTrenwellPhase1ConvoTemplate:addScreen(noroom_returned_noroom);
...
seanTrenwellPhase1ConvoTemplate:addScreen(cant_find_evidence);
...
rival_player = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/sean_trenwell:s_b826b85a","rival_nquest_start"}, -- I want to join your campaign.
		{"@conversation/sean_trenwell:s_82e87c1c","goodbye_then"},--I gotta go.
	}
}
seanTrenwellPhase1ConvoTemplate:addScreen(rival_player);
...
seanTrenwellPhase1ConvoTemplate:addScreen(voted_sean_this_election);
...
seanTrenwellPhase1ConvoTemplate:addScreen(voted_victor_this_election);

rival_nquest_start = ConvoScreen:new {
	id = "rival_nquest_start",
...
seanTrenwellPhase1ConvoTemplate:addScreen(rival_nquest_start);
...
seanTrenwellPhase1ConvoTemplate:addScreen(action_nquest);
...
seanTrenwellPhase1ConvoTemplate:addScreen(decline_nquest);
...
seanTrenwellPhase1ConvoTemplate:addScreen(nquest_return);
...
seanTrenwellPhase1ConvoTemplate:addScreen(nquest_found);
...
seanTrenwellPhase1ConvoTemplate:addScreen(nquest_notfound);
...
seanTrenwellPhase1ConvoTemplate:addScreen(nquest_nojoin);

joincampaign_changedmind = ConvoScreen:new {
	id = "joincampaign_changedmind",
...
seanTrenwellPhase1ConvoTemplate:addScreen(joincampaign_changedmind);

goodbye_then = ConvoScreen:new {
	id = "goodbye_then",
	leftDialog = "@conversation/sean_trenwell:s_bad1d1bb", -- Good bye, then.
	stopConversation = "true",
	options = {}
}
seanTrenwellPhase1ConvoTemplate:addScreen(goodbye_then);
...
seanTrenwellPhase1ConvoTemplate:addScreen(notInOffice_noElection);
...
seanTrenwellPhase1ConvoTemplate:addScreen(disk_to_hutt);

goodbye_pleasant = ConvoScreen:new {
	id = "goodbye_pleasant",
	leftDialog = "@conversation/sean_trenwell:s_91cc7d0", --I wish you well. Come back soon!
	stopConversation = "true",
	options = {}
}
seanTrenwellPhase1ConvoTemplate:addScreen(goodbye_pleasant);
...
seanTrenwellPhase1ConvoTemplate:addScreen(sean_inOffice);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_alreadyReceivedReward);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_giveReward);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_giveReward_noroom);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_giveHistoryReward_noroom_returned);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_giveHistoryReward);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_HowsWork);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_playerVoted);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_yourPlans);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_yourPlans_2);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_youre_wrong);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_adventurer);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_accept_HQuest);
...
seanTrenwellPhase1ConvoTemplate:addScreen(inOffice_decline_HQuest);
...
seanTrenwellPhase1ConvoTemplate:addScreen(historyQuest_SpokeToContact);
...
seanTrenwellPhase1ConvoTemplate:addScreen(historyQuest_HasDisk);
...
seanTrenwellPhase1ConvoTemplate:addScreen(historyQuest_DestroyedDisk_noroom);
...
seanTrenwellPhase1ConvoTemplate:addScreen(historyQuest_DestroyedDisk);
...
seanTrenwellPhase1ConvoTemplate:addScreen(historyQuest_SearchedCrashSite);
...
seanTrenwellPhase1ConvoTemplate:addScreen(SearchedCrashSite_Found);
...
seanTrenwellPhase1ConvoTemplate:addScreen(HistoryQuest_ShowDisk);
...
seanTrenwellPhase1ConvoTemplate:addScreen(HistoryQuest_SeansContact);
...
seanTrenwellPhase1ConvoTemplate:addScreen(SearchedCrashSite_NotFound);
...
seanTrenwellPhase1ConvoTemplate:addScreen(historyQuest_SeanHistorian);
...
seanTrenwellPhase1ConvoTemplate:addScreen(historyQuest_CrashSite);
...
seanTrenwellPhase1ConvoTemplate:addScreen(historyQuest_CrashSite_dothat);
...
seanTrenwellPhase1ConvoTemplate:addScreen(historyQuest_CrashSite_quit);

addConversationTemplate("seanTrenwellPhase1ConvoTemplate", seanTrenwellPhase1ConvoTemplate);
