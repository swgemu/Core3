...
victorQuestpSlumsConvoTemplate:addScreen(default_reply);
...
victorQuestpSlumsConvoTemplate:addScreen(no_office);
...
victorQuestpSlumsConvoTemplate:addScreen(noroom_returned_nochance);
...
quest_start = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/victor_questp_slums:s_8611417a","quest_start2"}, --What story?
		{"@conversation/victor_questp_slums:s_aa91e763","no_time_exit"}, --No time for stories.
	 }
}
victorQuestpSlumsConvoTemplate:addScreen(quest_start);
...
quest_start2 = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/victor_questp_slums:s_540ac7e9","quest_start3"}, --Continue.
	}
}
victorQuestpSlumsConvoTemplate:addScreen(quest_start2);
...
quest_start3 = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/victor_questp_slums:s_d5f19466","quest_start_final"}, --I need your help.
		{"@conversation/victor_questp_slums:s_a9ac4d51","nice_story_end"},--Nice story. I must be going.
	}
}
victorQuestpSlumsConvoTemplate:addScreen(quest_start3);

quest_start_final = ConvoScreen:new {
	id = "quest_start_final",
...
victorQuestpSlumsConvoTemplate:addScreen(quest_start_final);

nice_story_end = ConvoScreen:new {
	id = "nice_story_end",
	leftDialog = "@conversation/victor_questp_slums:s_76f08368",--I'm glad you liked it! I hope you are well today.
	stopConversation = "true",
	options = { }
}
victorQuestpSlumsConvoTemplate:addScreen(nice_story_end);
