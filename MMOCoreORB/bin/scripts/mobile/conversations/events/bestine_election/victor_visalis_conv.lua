...
convo_start = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/victor_visalis:s_87b97dc","no_thanks"}, --I need to go. I'm sorry.
	}
}
...
about_tuskens2 = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/victor_visalis:s_6cf7afee","no_thanks"}, --I should go.
	}
}
...
rival_player = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/victor_visalis:s_67dbab18","no_thanks"}, --Sorry, I have to go.
	}
}
...
victorVisalisConvoTemplate:addScreen(no_thanks);
