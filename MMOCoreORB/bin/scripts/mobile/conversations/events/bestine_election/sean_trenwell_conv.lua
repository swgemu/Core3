...
seanTrenwellConvoTemplate:addScreen(here_to_vote_continue);
...
seanTrenwellConvoTemplate:addScreen(joincampaign_noroom);
...
seanTrenwellConvoTemplate:addScreen(voted_victor_this_election);
...
seanTrenwellConvoTemplate:addScreen(rival_nquest_start);
...
seanTrenwellConvoTemplate:addScreen(joincampaign_changedmind);
...
seanTrenwellConvoTemplate:addScreen(goodbye_then);
...
seanTrenwellConvoTemplate:addScreen(goodbye_pleasant);
...
historyQuest_SearchedCrashSite = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/sean_trenwell:s_b30bd73c","SearchedCrashSite_Found"},  --Yes, I did.  HistoryQuest_ShowDisk
