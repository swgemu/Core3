...
inOffice_giveReward_noroom_returned = ConvoScreen:new {
	id = "inOffice_giveReward_noroom_returned",
...
seanTrenwellConvoTemplate:addScreen(inOffice_giveReward_noroom_returned);
...
--s_64c62370 I hear you spoke to the governor and voted for me. I appreciate that! When the election is over, if I win I'd like to thank you for your support. Come back and speak to me if that happens.
...
inOffice_IVoted
inOffice_voteReward
inOffice_destroyedDisk
inOffice_mess1
inOffice_itemFound
inOffice_find1
inOffice_historyQuresthelp
inOffice_newElection


--player_votedSeanCurrentElection
