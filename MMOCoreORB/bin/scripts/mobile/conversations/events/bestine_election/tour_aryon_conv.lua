...
more_information_please_3 = ConvoScreen:new {
	...
	stopConversation = "false",
	options = {
		{"@conversation/tour_aryon:s_eea34749", "more_information_please_exit"}, --Okay. Thank you!
	}
}
tourAryonConvoTemplate:addScreen(more_information_please_3);


more_information_please_exit = ConvoScreen:new {
	id = "more_information_please_exit",
	leftDialog = "@conversation/tour_aryon:s_ab50056b", -- --I wish you well
	stopConversation = "true",
	options = {}
}
tourAryonConvoTemplate:addScreen(more_information_please_exit);
