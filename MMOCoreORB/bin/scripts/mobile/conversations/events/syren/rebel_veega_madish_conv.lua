...
start = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/c_story1_1_reb_quest:s_171", "s_183"} -- I'd rather not.  I have a lot to do right now.
	}
}
...
welcome_back_found_datapad = ConvoScreen:new {
	id = "welcome_back_found_datapad",
	leftDialog = "@conversation/c_story1_1_reb_quest:s_193", -- Welcome back.  Did you find anything interesting?
	stopConversation = "false",
	options = {
...
rebelVeegaMadishConvoTemplate:addScreen(welcome_back_found_datapad);
...
welcome_back_no_second_datapad = ConvoScreen:new {
	id = "welcome_back_no_second_datapad",
	leftDialog = "@conversation/c_story1_1_reb_quest:s_301", -- Can I talk to you later?  I'm tracking down a tough bit of information.
	stopConversation = "true",
	options = {}
}

rebelVeegaMadishConvoTemplate:addScreen(welcome_back_no_second_datapad);
