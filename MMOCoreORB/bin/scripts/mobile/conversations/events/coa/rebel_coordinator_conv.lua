...
coa3_init_go_to_tact_w = ConvoScreen:new {
	id = "coa3_init_go_to_tact_w",
...
rebelCoordinatorConvoTemplate:addScreen(coa3_init_go_to_tact_w);

coa3_init_completed_tact_w = ConvoScreen:new {
	id = "coa3_init_completed_tact_w",
...
rebelCoordinatorConvoTemplate:addScreen(coa3_init_completed_tact_w);

coa3_big_impression_w = ConvoScreen:new {
	id = "coa3_big_impression_w",
...
rebelCoordinatorConvoTemplate:addScreen(coa3_big_impression_w);

coa3_count_on_support_w = ConvoScreen:new {
	id = "coa3_count_on_support_w",
...
rebelCoordinatorConvoTemplate:addScreen(coa3_count_on_support_w);
...
coa3_init_go_to_tact_l = ConvoScreen:new {
	id = "coa3_init_go_to_tact_l",
...
rebelCoordinatorConvoTemplate:addScreen(coa3_init_go_to_tact_l);

coa3_init_completed_tact_l = ConvoScreen:new {
	id = "coa3_init_completed_tact_l",
...
rebelCoordinatorConvoTemplate:addScreen(coa3_init_completed_tact_l);

coa3_big_impression_l = ConvoScreen:new {
	id = "coa3_big_impression_l",
	leftDialog = "@conversation/coa3lcoordinator:s_a97e415d", -- I thought you'd say that. You've made a big impression and the Princess has decided to oversee the operation herself. She said she wanted to speak with you personally about it. I've added a waypoint to your datapad with the location of the off-world headquarters. I'd head there at once so you don't keep her waiting.
	stopConversation = "true",
	options = {}
}
rebelCoordinatorConvoTemplate:addScreen(coa3_big_impression_l);

coa3_count_on_support_l = ConvoScreen:new {
	id = "coa3_count_on_support_l",
...
rebelCoordinatorConvoTemplate:addScreen(coa3_count_on_support_l);
