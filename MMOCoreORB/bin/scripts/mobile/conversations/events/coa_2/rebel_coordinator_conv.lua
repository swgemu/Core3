...
coa_m2_begin_encoded = ConvoScreen:new {
	id = "coa_m2_begin_encoded",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_begin_encoded);

coa_m2_begin = ConvoScreen:new {
	id = "coa_m2_begin",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_begin);

coa_m2_begin_info1 = ConvoScreen:new {
	id = "coa_m2_begin_info1",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_begin_info1);

coa_m2_begin_info2 = ConvoScreen:new {
	id = "coa_m2_begin_info2",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_begin_info2);

coa_m2_begin_yes = ConvoScreen:new {
	id = "coa_m2_begin_yes",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_begin_yes);

coa_m2_begin_no = ConvoScreen:new {
	id = "coa_m2_begin_no",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_begin_no);

coa_m2_refused = ConvoScreen:new {
	id = "coa_m2_refused",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_refused);

coa_m2_refused_info1 = ConvoScreen:new {
	id = "coa_m2_refused_info1",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_refused_info1);

coa_m2_refused_info2 = ConvoScreen:new {
	id = "coa_m2_refused_info2",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_refused_info2);

coa_m2_refused_yes = ConvoScreen:new {
	id = "coa_m2_refused_yes",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_refused_yes);

coa_m2_refused_no = ConvoScreen:new {
	id = "coa_m2_refused_no",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_refused_no);

coa_m2_active = ConvoScreen:new {
	id = "coa_m2_active",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_active);

coa_m2_active_working = ConvoScreen:new {
	id = "coa_m2_active_working",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_active_working);

coa_m2_active_abort = ConvoScreen:new {
	id = "coa_m2_active_abort",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_active_abort);

coa_m2_active_restart = ConvoScreen:new {
	id = "coa_m2_active_restart",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_active_restart);

coa_m2_finish = ConvoScreen:new {
	id = "coa_m2_finish",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_finish);

coa_m2_finish_yes = ConvoScreen:new {
	id = "coa_m2_finish_yes",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_finish_yes);

coa_m2_finish_no = ConvoScreen:new {
	id = "coa_m2_finish_no",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m2_finish_no);

coa_m3_begin = ConvoScreen:new {
	id = "coa_m3_begin",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m3_begin);

coa_m3_begin_yes = ConvoScreen:new {
	id = "coa_m3_begin_yes",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m3_begin_yes);

coa_m3_begin_no = ConvoScreen:new {
	id = "coa_m3_begin_no",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m3_begin_no);

coa_m3_active = ConvoScreen:new {
	id = "coa_m3_active",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m3_active);

coa_m3_active_working = ConvoScreen:new {
	id = "coa_m3_active_working",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m3_active_working);

coa_m3_active_abort = ConvoScreen:new {
	id = "coa_m3_active_abort",
	leftDialog = "@theme_park/alderaan/act2/rebel_missions:m3_active_abort_response", -- I'm not able to do this mission now.
	stopConversation = "true",
	options = {}
}

rebelCoordinatorConvoTemplate:addScreen(coa_m3_active_abort);

coa_m3_active_restart = ConvoScreen:new {
	id = "coa_m3_active_restart",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m3_active_restart);

coa_m3_finish = ConvoScreen:new {
	id = "coa_m3_finish",
...
rebelCoordinatorConvoTemplate:addScreen(coa_m3_finish);
