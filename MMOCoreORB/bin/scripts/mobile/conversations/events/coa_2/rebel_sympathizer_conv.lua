...
m1_sympathizer_invalid = ConvoScreen:new {
	...
	leftDialog = "@theme_park/alderaan/act2/imperial_missions:m1_sympathizer_invalid", -- I'm sorry, I can't chat right now. I'm waiting for a friend to arrive.
...
m1_sympathizer_complete = ConvoScreen:new {
	...
	leftDialog = "@theme_park/alderaan/act2/imperial_missions:m1_sympathizer_complete", -- What are you waiting for. You need to get that disk to the Alliance.
	stopConversation = "true",
	options = {}
}
