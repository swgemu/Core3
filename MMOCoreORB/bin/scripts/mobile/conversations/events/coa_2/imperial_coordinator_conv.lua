...
m1_begin_info2 = ConvoScreen:new {
	id = "m1_begin_info2",
	leftDialog = "@theme_park/alderaan/act2/imperial_missions:m1_begin_info1_response", -- That information is need-to-know only and you don't need to know. Be assured that success of project Dead Eye is extremely important to the Empire.
	stopConversation = "false",
	options = {
		{"@theme_park/alderaan/act2/imperial_missions:m1_begin_info1", "m1_begin_info1"}, -- Who is this agent?
		{"@theme_park/alderaan/act2/imperial_missions:m1_begin_yes", "m1_begin_yes"}, -- I would like to help.
