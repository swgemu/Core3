...
welcome = ConvoScreen:new {
	...
	options = {
		{"@conversation/event_promoter:s_9", "more_about_what"}, -- Tell me more about all of this
		{"@conversation/event_promoter:s_11", "sale_decorations"}, -- I'm interested in decorations
	--		{"@conversation/event_promoter:s_26", "sale_venues"}, -- I'm interested in venues
	--		{"@conversation/event_promoter:s_42", "sale_games_supplies"}, -- I'm interested in games and supplies
	--		{"@conversation/event_promoter:s_80", "sale_personnel"}, -- I'm interested in hiring personnel
	}
}
eventPromoterConvoTemplate:addScreen(welcome);

more_about_what = ConvoScreen:new {
	id = "more_about_what",
...
eventPromoterConvoTemplate:addScreen(more_about_what);
