...
includeFile("dantooine/coer_clem.lua")
...
includeFile("dantooine/stoos_bandit.lua")
includeFile("dantooine/stoos_imperial_ensign.lua")
includeFile("dantooine/stoos_stormtrooper_squad_leader.lua")
...
includeFile("dantooine/warren_thune.lua")
