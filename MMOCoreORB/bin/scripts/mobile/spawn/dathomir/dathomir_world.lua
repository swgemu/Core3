dathomir_world = {
	...
	lairSpawns = {
		...
		{
			lairTemplateName = "gaping_spider_recluse_giant_neutral_medium_boss_01",
			spawnLimit = -1,
			minDifficulty = 44,
			maxDifficulty = 68,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "dathomir_rancor_young_pack_neutral_none",
			spawnLimit = -1,
			minDifficulty = 45,
			maxDifficulty = 49,
			numberToSpawn = 0,
		...
		{
			lairTemplateName = "dathomir_rancor_enraged_bull_lair_neutral_large",
			spawnLimit = -1,
			minDifficulty = 89,
			maxDifficulty = 93,
			numberToSpawn = 0,
