crackdown_rebel_soldier_hard = Creature:new {
	objectName = "@mob/creature_names:crackdown_rebel_soldier_hard",
	...
	attacks = merge(commandonovice,pistoleernovice,carbineermaster,brawlermid)
}

CreatureTemplates:addCreatureTemplate(crackdown_rebel_soldier_hard, "crackdown_rebel_soldier_hard")