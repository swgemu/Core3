crackdown_rebel_rifleman_hard = Creature:new {
	objectName = "@mob/creature_names:crackdown_rebel_rifleman_hard",
	...
	attacks = merge(carbineernovice,marksmanmaster,riflemanmaster,pistoleernovice)
}

CreatureTemplates:addCreatureTemplate(crackdown_rebel_rifleman_hard, "crackdown_rebel_rifleman_hard")
