crackdown_rebel_sergeant = Creature:new {
	objectName = "@mob/creature_names:crackdown_rebel_sergeant",
	...
	attacks = merge(brawlernovice,marksmanmid,riflemannovice,carbineermid,pistoleermid)
}

CreatureTemplates:addCreatureTemplate(crackdown_rebel_sergeant, "crackdown_rebel_sergeant")
