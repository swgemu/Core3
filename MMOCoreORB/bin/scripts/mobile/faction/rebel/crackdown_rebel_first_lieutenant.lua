crackdown_rebel_first_lieutenant = Creature:new {
	objectName = "@mob/creature_names:crackdown_rebel_first_lieutenant",
	...
	attacks = merge(brawlermid,marksmanmaster,pistoleermid)
}

CreatureTemplates:addCreatureTemplate(crackdown_rebel_first_lieutenant, "crackdown_rebel_first_lieutenant")
