crackdown_rebel_recruit = Creature:new {
	objectName = "@mob/creature_names:crackdown_rebel_recruit",
...
CreatureTemplates:addCreatureTemplate(crackdown_rebel_recruit, "crackdown_rebel_recruit")
