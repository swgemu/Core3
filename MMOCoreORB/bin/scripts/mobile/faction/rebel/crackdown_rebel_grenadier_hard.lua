crackdown_rebel_grenadier_hard = Creature:new {
	objectName = "@mob/creature_names:crackdown_rebel_grenadier_hard",
	...
	attacks = merge(pistoleermid,carbineermaster,commandomid)
}

CreatureTemplates:addCreatureTemplate(crackdown_rebel_grenadier_hard, "crackdown_rebel_grenadier_hard")
