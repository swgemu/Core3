crackdown_rebel_recruit_hard = Creature:new {
	objectName = "@mob/creature_names:crackdown_rebel_recruit_hard",
	...
	attacks = merge(marksmanmid,pistoleernovice)
}

CreatureTemplates:addCreatureTemplate(crackdown_rebel_recruit_hard, "crackdown_rebel_recruit_hard")
