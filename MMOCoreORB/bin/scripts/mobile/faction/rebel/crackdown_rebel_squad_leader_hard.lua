crackdown_rebel_squad_leader_hard = Creature:new {
	objectName = "@mob/creature_names:crackdown_rebel_squad_leader_hard",
	...
	attacks = merge(brawlermid,marksmanmid,carbineermid,pistoleermid,riflemannovice)
}

CreatureTemplates:addCreatureTemplate(crackdown_rebel_squad_leader_hard, "crackdown_rebel_squad_leader_hard")
