fbase_rebel_recruiter = Creature:new {
  ...
  optionsBitmask = CONVERSABLE + AIENABLED

}

CreatureTemplates:addCreatureTemplate(fbase_rebel_recruiter, "fbase_rebel_recruiter")