crackdown_rebel_sharpshooter = Creature:new {
	objectName = "@mob/creature_names:crackdown_rebel_sharpshooter",
	...
	attacks = merge(carbineermid,riflemanmid,marksmanmaster,pistoleernovice)
}

CreatureTemplates:addCreatureTemplate(crackdown_rebel_sharpshooter, "crackdown_rebel_sharpshooter")
