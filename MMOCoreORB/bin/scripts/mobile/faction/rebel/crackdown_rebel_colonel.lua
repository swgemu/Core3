crackdown_rebel_colonel = Creature:new {
	objectName = "@mob/creature_names:crackdown_rebel_colonel",
	...
	attacks = merge(commandonovice,marksmanmaster,carbineermid,pistoleermaster)
}

CreatureTemplates:addCreatureTemplate(crackdown_rebel_colonel, "crackdown_rebel_colonel")
