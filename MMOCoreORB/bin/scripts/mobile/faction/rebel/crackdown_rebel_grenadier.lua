crackdown_rebel_grenadier = Creature:new {
	objectName = "@mob/creature_names:crackdown_rebel_grenadier",
	...
	attacks = merge(pistoleermid,carbineermid,commandonovice)
}

CreatureTemplates:addCreatureTemplate(crackdown_rebel_grenadier, "crackdown_rebel_grenadier")
