crackdown_stormtrooper_hard = Creature:new {
	objectName = "@mob/creature_names:crackdown_stormtrooper_hard",
...
CreatureTemplates:addCreatureTemplate(crackdown_stormtrooper_hard, "crackdown_stormtrooper_hard")
