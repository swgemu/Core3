tutorial_imperial_broker = Creature:new {
	...
	conversationTemplate = "tutorial_imperial_broker_convo_template",
...
CreatureTemplates:addCreatureTemplate(tutorial_imperial_broker, "tutorial_imperial_broker")
