...
exquisiteGown = Object:new {

   objectName = "Exquisite Gown",
   stfName = "dress_s14",
   stfFile = "wearables_name",
   objectCRC = 2132181959,
   ...
   tanoAttributes = "objecttype=16777223:objectcrc=1068223714:stfFile=wearables_name:stfName=dress_s14:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(exquisiteGown, 2132181959)--- Add to global DraftSchematics table
