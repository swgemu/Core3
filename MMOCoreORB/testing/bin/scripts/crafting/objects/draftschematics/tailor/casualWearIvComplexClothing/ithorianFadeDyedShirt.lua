...
ithorianFadeDyedShirt = Object:new {

   objectName = "Ithorian Fade Dyed Shirt",
   stfName = "ith_shirt_s09",
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=1002405173:stfFile=wearables_name:stfName=ith_shirt_s09:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianFadeDyedShirt, 130770391)--- Add to global DraftSchematics table
