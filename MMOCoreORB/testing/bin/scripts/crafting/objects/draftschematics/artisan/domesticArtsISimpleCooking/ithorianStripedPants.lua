...
ithorianStripedPants = Object:new {

   objectName = "Ithorian Striped Pants",
   stfName = "ith_pants_s01",
   stfFile = "wearables_name",
   objectCRC = 1568038916,
   ...
   tanoAttributes = "objecttype=:objectcrc=1130250638:stfFile=wearables_name:stfName=ith_pants_s01:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianStripedPants, 1568038916)--- Add to global DraftSchematics table
