...
shoulderStrap = Object:new {
   ...
   tanoAttributes = "objecttype=16777217:objectcrc=3487290288:stfFile=wearables_name:stfName=bandolier_s07:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(shoulderStrap, 956612065)--- Add to global DraftSchematics table
