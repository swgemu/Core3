...
exoproteinWafers = Object:new {

   objectName = "Exo-Protein Wafers",
   stfName = "exo_protein_wafers",
   stfFile = "food_name",
   objectCRC = 4045225099,
   ...
   experimentalProperties = "XX, XX, XX, PE, OQ, FL, OQ, DR, SR, DR, OQ",
   ...
   tanoAttributes = "objecttype=8202:objectcrc=2915488362:stfFile=food_name:stfName=exo_protein_wafers:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(exoproteinWafers, 4045225099)--- Add to global DraftSchematics table
