...
kashyyykianHuntingArmorSegment = Object:new {

   objectName = "Kashyyykian Hunting Armor Segment",
   stfName = "armor_segment_kashyyykian_hunting",
   stfFile = "craft_armor_ingredients_n",
   objectCRC = 4257597570,
   ...
   ingredientSlotType = "0, 0, 0, 4, 4, 4, 2",
   ...
   tanoAttributes = "objecttype=262145:objectcrc=3253647713:stfFile=craft_armor_ingredients_n:stfName=armor_segment_kashyyykian_hunting:stfDetail=:itemmask=65535:customattributes=specialprotection=kineticeffectiveness;:",
...
DraftSchematics:addDraftSchematic(kashyyykianHuntingArmorSegment, 4257597570)--- Add to global DraftSchematics table
