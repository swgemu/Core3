...
chitinArmorRightBicep = Object:new {

   objectName = "Chitin Armor Right Bicep",
   stfName = "armor_chitin_s01_bicep_r",
   stfFile = "wearables_name",
   objectCRC = 3312703975,
...
DraftSchematics:addDraftSchematic(chitinArmorRightBicep, 3312703975)--- Add to global DraftSchematics table
