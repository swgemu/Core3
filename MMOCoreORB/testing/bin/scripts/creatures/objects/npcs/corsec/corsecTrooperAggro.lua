...
corsecTrooperAggro = Creature:new {
	objectName = "corsecTrooperAggro",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Corsec [aggro]",
	gender = "",

	speciesName = "corsec_trooper_aggro",
...
Creatures:addCreature(corsecTrooperAggro, 3630538207) -- Add to Global Table
