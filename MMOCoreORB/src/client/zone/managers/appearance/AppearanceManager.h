...
class AppearanceManager : public Mutex, public Logger, public Singleton<AppearanceManager>, public Object {
	...
	static ObjectFactory<ClientAppearance* (const AppearanceTemplate*), uint32> appearanceFactory;
	void registerObjectTypes();
public:
	AppearanceManager();
	virtual ~AppearanceManager();

	ClientAppearance* getAppearance(const AppearanceTemplate *tmpl) const;
};
