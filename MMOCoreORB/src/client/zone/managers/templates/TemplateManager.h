...
#include "zone/templates/slots/SlotDescriptor.h"
#include "zone/templates/slots/ArrangementDescriptor.h"
...
//	ObjectFactory<IffTemplate* (), uint32> boundingVolumeFactory;
...
public:
	...
	void addTemplate(uint32 key, const String& fullName);
	...
	String getAppearanceTemplateString(const AppearanceTemplate* tmpl);
	...
	friend class zone::templates::SharedObjectTemplate;
};
