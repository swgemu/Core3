...
public:
  ...
  LambdaObserverFunction(std::function<int(uint32, Observable*, ManagedObject*, uint64)> f) : func(std::forward<std::function<int(uint32, Observable*, ManagedObject*, uint64)> >(f)) { }
};
