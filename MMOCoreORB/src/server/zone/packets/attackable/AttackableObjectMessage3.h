...
#ifndef ATTACKABLEOBJECTMESSAGE3_H_
#define ATTACKABLEOBJECTMESSAGE3_H_

#include "../BaseLineMessage.h"

#include "../../objects/attackable/AttackableObject.h"

class AttackableObjectMessage3 : public BaseLineMessage {
public:
	AttackableObjectMessage3(AttackableObject* tano) 
			: BaseLineMessage(tano->getObjectID(), 0x54414E4F, 3, 0x0D) {
		insertFloat(100.0);
...
#endif /*ATTACKABLEOBJECTMESSAGE3_H_*/
