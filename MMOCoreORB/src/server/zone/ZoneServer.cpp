...
void ZoneServerImplementation::test() {
	...
	// server/zone/ZoneServer.idl(146):  Zone zone = new Zone(this, null, 0);
	Zone* zone = _ref0 = new Zone(_this, NULL, 0);
}
...
void ZoneServerImplementation::increaseOnlinePlayers() {
	...
	// server/zone/ZoneServer.idl(201):  ++
	if ( ++currentPlayers > maximumPlayers)	// server/zone/ZoneServer.idl(202):  maximumPlayers = currentPlayers;
	maximumPlayers = currentPlayers;
	// server/zone/ZoneServer.idl(204):  totalPlayers;
	 ++totalPlayers;
}

void ZoneServerImplementation::decreaseOnlinePlayers() {
	Locker _locker(_this);
	// server/zone/ZoneServer.idl(208):  currentPlayers = currentPlayers - 1;
	currentPlayers = currentPlayers - 1;
}

void ZoneServerImplementation::increaseTotalDeletedPlayers() {
	Locker _locker(_this);
	// server/zone/ZoneServer.idl(212):  ++totalDeletedPlayers;
	 ++totalDeletedPlayers;
}

int ZoneServerImplementation::getGalaxyID() {
	// server/zone/ZoneServer.idl(216):  return galaxyID;
	return galaxyID;
}

bool ZoneServerImplementation::isServerLocked() {
	// server/zone/ZoneServer.idl(222):  return serverState == LOCKED;
	return serverState == LOCKED;
}

bool ZoneServerImplementation::isServerOnline() {
	// server/zone/ZoneServer.idl(226):  return serverState == ONLINE;
	return serverState == ONLINE;
}

bool ZoneServerImplementation::isServerOffline() {
	// server/zone/ZoneServer.idl(230):  return serverState == OFFLINE;
	return serverState == OFFLINE;
}

bool ZoneServerImplementation::isServerLoading() {
	// server/zone/ZoneServer.idl(234):  return serverState == LOADING;
	return serverState == LOADING;
}

int ZoneServerImplementation::getServerState() {
	// server/zone/ZoneServer.idl(238):  return serverState;
	return serverState;
}

Zone* ZoneServerImplementation::getZone(int index) {
	Locker _locker(_this);
	// server/zone/ZoneServer.idl(242):  return zones.get(index);
	return (&zones)->get(index);
}

int ZoneServerImplementation::getMaxPlayers() {
	// server/zone/ZoneServer.idl(246):  return maximumPlayers;
	return maximumPlayers;
}

int ZoneServerImplementation::getTotalPlayers() {
	// server/zone/ZoneServer.idl(250):  return totalPlayers;
	return totalPlayers;
}

int ZoneServerImplementation::getDeletedPlayers() {
	// server/zone/ZoneServer.idl(254):  return totalDeletedPlayers;
	return totalDeletedPlayers;
}

PlayerManager* ZoneServerImplementation::getPlayerManager() {
	// server/zone/ZoneServer.idl(258):  return playerManager;
	return playerManager;
}

ChatManager* ZoneServerImplementation::getChatManager() {
	// server/zone/ZoneServer.idl(262):  return chatManager;
	return chatManager;
}

ObjectController* ZoneServerImplementation::getObjectController() {
	// server/zone/ZoneServer.idl(266):  return objectController;
	return objectController;
}

RadialManager* ZoneServerImplementation::getRadialManager() {
	// server/zone/ZoneServer.idl(270):  return radialManager;
	return radialManager;
}

void ZoneServerImplementation::setGalaxyID(int galaxyid) {
	Locker _locker(_this);
	// server/zone/ZoneServer.idl(280):  galaxyID = galaxyid;
	galaxyID = galaxyid;
}

void ZoneServerImplementation::setServerState(int state) {
	Locker _locker(_this);
	// server/zone/ZoneServer.idl(284):  serverState = state;
	serverState = state;
}
