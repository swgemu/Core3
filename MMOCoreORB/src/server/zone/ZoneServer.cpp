...
String ZoneServer::printInfo() {
	...
	if (_implementation == NULL) {
		...
		method.executeWithAsciiReturn(_return_printInfo);
		return _return_printInfo;
	} else
		return _implementation->printInfo();
}
...
String ZoneServerAdapter::printInfo() {
	return (static_cast<ZoneServer*>(stub))->printInfo();
}
