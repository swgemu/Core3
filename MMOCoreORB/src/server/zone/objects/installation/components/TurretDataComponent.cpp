...
#ifdef DEBUG_RESIST_DECAY
		info(true) << " max condition = " << maxCondition << " Total Damage Mitigated = " << resistMitigation << " Start Armor value: " << value << " New Armor Value = " << newValue << " Reduction percent = " << reduction;
#endif
	}
