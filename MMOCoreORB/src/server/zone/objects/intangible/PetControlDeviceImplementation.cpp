...
void PetControlDeviceImplementation::trick1(CreatureObject* player){
	...
	// Heal 10% of base in wounds and battle fatigue
	int mindHeal = pet->getBaseHAM(CreatureAttribute::MIND) / 10;
	int focusHeal = pet->getBaseHAM(CreatureAttribute::FOCUS) / 10;
	int willHeal = pet->getBaseHAM(CreatureAttribute::WILLPOWER) / 10;
	int shockHeal = pet->getBaseHAM(CreatureAttribute::MIND) / 10;
...
void PetControlDeviceImplementation::trick2(CreatureObject* player){
	...
	// Heal 20% of base in wounds and battle fatigue
	int mindHeal = pet->getBaseHAM(CreatureAttribute::MIND) / 20;
	int focusHeal = pet->getBaseHAM(CreatureAttribute::FOCUS) / 20;
	int willHeal = pet->getBaseHAM(CreatureAttribute::WILLPOWER) / 20;
	int shockHeal = pet->getBaseHAM(CreatureAttribute::MIND) / 20;
