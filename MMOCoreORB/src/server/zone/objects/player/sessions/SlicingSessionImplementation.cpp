...
void SlicingSessionImplementation::detachPowerUp(CreatureObject* player, TangibleObject* weapon) {

	if (weapon == NULL || player == NULL || !weapon->isWeaponObject())
		return;

	WeaponObject* weap = cast<WeaponObject*>(weapon);
