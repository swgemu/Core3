...
void EntertainingSessionImplementation::activateEntertainerBuff(CreatureObject* creature, int performanceType) {
	...
	try {
		...
		case PerformanceType::MUSIC:
		{
			uint32 focusBuffCRC = String::hashCode("performance_enhance_music_focus");
			uint32 willBuffCRC = String::hashCode("performance_enhance_music_willpower");
		...
		case PerformanceType::DANCE:
		{
			uint32 mindBuffCRC = String::hashCode("performance_enhance_dance_mind");
