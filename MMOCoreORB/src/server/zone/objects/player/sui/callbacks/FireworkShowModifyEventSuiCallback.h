...
public:
	...
	void run(CreatureObject* player, SuiBox* suiBox, bool cancelPressed, Vector<UnicodeString>* args) {
		...
		float fireworkDelay = Float::valueOf(fireworkShowData->getFireworkDelay(fireworkIndex));
		...
		suiDelayBox->addFrom("Available", String::valueOf(100 - fireworkDelay), String::valueOf(100 - fireworkDelay), "1");
		suiDelayBox->addTo("Delay", String::valueOf(fireworkDelay), String::valueOf(fireworkDelay), "1");
