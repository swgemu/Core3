...
public:
	CustomVehicleSuiCallback(ZoneServer* serv,int palette, TangibleObject* customizationKit ) :
		SuiCallback(serv), numPalette(palette), customizationKit(customizationKit) {
	}
