...
void PlayerObject::setForcePowerRegen(int val) {
	PlayerObjectImplementation* _implementation = static_cast<PlayerObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_SETFORCEPOWERREGEN__INT_);
		method.addSignedIntParameter(val);

		method.executeWithVoidReturn();
	} else
		_implementation->setForcePowerRegen(val);
}
...
float PlayerObject::getVisibility() {
	PlayerObjectImplementation* _implementation = static_cast<PlayerObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
PlayerObjectImplementation::PlayerObjectImplementation() {
	...
	forcePowerMax = 0;
	// server/zone/objects/player/PlayerObject.idl():  		forcePowerRegen = 0;
	forcePowerRegen = 0;
...
void PlayerObjectImplementation::setForcePowerRegen(int val) {
	// server/zone/objects/player/PlayerObject.idl():  		forcePowerRegen = val;
	forcePowerRegen = val;
}

int PlayerObjectImplementation::getForcePowerRegen() {
	// server/zone/objects/player/PlayerObject.idl():  		return forcePowerRegen;
...
bool PlayerObjectImplementation::getDebug() {
	// server/zone/objects/player/PlayerObject.idl():  		return debugOutput;
	return debugOutput;
}

float PlayerObjectImplementation::getVisibility() {
...
bool PlayerObjectImplementation::isJedi() {
...
void PlayerObjectAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case RPC_SETJEDISTATE__INT_BOOL_:
		{
			setJediState(inv->getSignedIntParameter(), inv->getBooleanParameter());
		}
		break;
	...
	case RPC_DODIGEST__INT_:
		{
			doDigest(inv->getSignedIntParameter());
		}
		break;
	...
	case RPC_HASPERMISSIONGROUP__STRING_:
		{
			String group; 
			resp->insertBoolean(hasPermissionGroup(inv->getAsciiParameter(group)));
		}
		break;
...
void PlayerObjectAdapter::setForcePowerRegen(int val) {
	(static_cast<PlayerObject*>(stub))->setForcePowerRegen(val);
}
...
bool PlayerObjectAdapter::getDebug() {
	return (static_cast<PlayerObject*>(stub))->getDebug();
}

float PlayerObjectAdapter::getVisibility() {
