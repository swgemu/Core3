...
String PlayerObject::getBankLocation() {
	PlayerObjectImplementation* _implementation = static_cast<PlayerObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
void PlayerObject::setFactionStatus(int status) {
	PlayerObjectImplementation* _implementation = static_cast<PlayerObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
String PlayerObject::getStarterProfession() {
	PlayerObjectImplementation* _implementation = static_cast<PlayerObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
void PlayerObject::addToBountyLockList(CreatureObject* player) {
	PlayerObjectImplementation* _implementation = static_cast<PlayerObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_ADDTOBOUNTYLOCKLIST__CREATUREOBJECT_);
		method.addObjectParameter(player);

		method.executeWithVoidReturn();
	} else
		_implementation->addToBountyLockList(player);
}

bool PlayerObject::isInBountyLockList(CreatureObject* player) {
	PlayerObjectImplementation* _implementation = static_cast<PlayerObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_ISINBOUNTYLOCKLIST__CREATUREOBJECT_);
		method.addObjectParameter(player);

		return method.executeWithBooleanReturn();
	} else
		return _implementation->isInBountyLockList(player);
}

void PlayerObject::removeFromBountyLockList(CreatureObject* player) {
	PlayerObjectImplementation* _implementation = static_cast<PlayerObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_REMOVEFROMBOUNTYLOCKLIST__CREATUREOBJECT_);
		method.addObjectParameter(player);

		method.executeWithVoidReturn();
	} else
		_implementation->removeFromBountyLockList(player);
}
...
unsigned long long PlayerObject::getPerformanceBuffTarget() {
	PlayerObjectImplementation* _implementation = static_cast<PlayerObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
bool PlayerObjectImplementation::readObjectMember(ObjectInputStream* stream, const String& _name) {
	...
	if (_name == "PlayerObject.bountyLockList") {
		TypeInfo<SortedVector<ManagedReference<CreatureObject* > > >::parseFromBinaryStream(&bountyLockList, stream);
		return true;
	}
...
String PlayerObjectImplementation::getStarterProfession() {
...
void PlayerObjectImplementation::addToBountyLockList(CreatureObject* player) {
	// server/zone/objects/player/PlayerObject.idl():  		bountyLockList.put(player);
	(&bountyLockList)->put(player);
}

bool PlayerObjectImplementation::isInBountyLockList(CreatureObject* player) {
	// server/zone/objects/player/PlayerObject.idl():  		return bountyLockList.contains(player);
	return (&bountyLockList)->contains(player);
}
...
bool PlayerObjectImplementation::isBountyLocked() {
	// server/zone/objects/player/PlayerObject.idl():  		return bountyLockList.size() > 0;
	return (&bountyLockList)->size() > 0;
}

unsigned long long PlayerObjectImplementation::getPerformanceBuffTarget() {
...
void PlayerObjectAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case RPC_SETSTARTERPROFESSION__STRING_:
		...
		break;
	case RPC_ADDTOBOUNTYLOCKLIST__CREATUREOBJECT_:
		addToBountyLockList(static_cast<CreatureObject*>(inv->getObjectParameter()));
		break;
	case RPC_ISINBOUNTYLOCKLIST__CREATUREOBJECT_:
		resp->insertBoolean(isInBountyLockList(static_cast<CreatureObject*>(inv->getObjectParameter())));
		break;
	case RPC_REMOVEFROMBOUNTYLOCKLIST__CREATUREOBJECT_:
		removeFromBountyLockList(static_cast<CreatureObject*>(inv->getObjectParameter()));
		break;
...
String PlayerObjectAdapter::getBankLocation() {
...
void PlayerObjectAdapter::setFactionStatus(int status) {
	(static_cast<PlayerObject*>(stub))->setFactionStatus(status);
}
...
String PlayerObjectAdapter::getStarterProfession() {
...
void PlayerObjectAdapter::addToBountyLockList(CreatureObject* player) {
	(static_cast<PlayerObject*>(stub))->addToBountyLockList(player);
}

bool PlayerObjectAdapter::isInBountyLockList(CreatureObject* player) {
	return (static_cast<PlayerObject*>(stub))->isInBountyLockList(player);
}

void PlayerObjectAdapter::removeFromBountyLockList(CreatureObject* player) {
	(static_cast<PlayerObject*>(stub))->removeFromBountyLockList(player);
}
...
unsigned long long PlayerObjectAdapter::getPerformanceBuffTarget() {
