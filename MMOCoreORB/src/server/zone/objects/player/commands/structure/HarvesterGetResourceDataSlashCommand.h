...
class HarvesterGetResourceDataSlashCommand : public QueueCommand {
public:

	HarvesterGetResourceDataSlashCommand(const String& name, ZoneProcessServerImplementation* server)
