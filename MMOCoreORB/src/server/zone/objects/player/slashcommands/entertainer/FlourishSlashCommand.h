...
class FlourishSlashCommand : public SlashCommand {
public:

	FlourishSlashCommand(const String& name, ZoneProcessServerImplementation* server)
		: SlashCommand(name, server) {

	}

	/*
	 * TODO: revisit this. isnt flourish a skill? we need the actioncrc to be passed into here,
	 * which wont work for normal commands...only skills.
	 */
