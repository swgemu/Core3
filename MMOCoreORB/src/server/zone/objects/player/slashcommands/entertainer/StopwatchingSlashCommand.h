...
class StopwatchingSlashCommand : public SlashCommand {
public:

	StopwatchingSlashCommand(const String& name, ZoneProcessServerImplementation* server)
	...
	bool doSlashCommand(Player* player, Message* packet) {
		...
		uint64 watchID = packet->parseLong();
