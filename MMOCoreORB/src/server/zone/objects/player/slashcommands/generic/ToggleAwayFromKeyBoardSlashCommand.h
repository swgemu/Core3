...
class ToggleAwayFromKeyBoardSlashCommand : public SlashCommand {
public:

	ToggleAwayFromKeyBoardSlashCommand(const String& name, ZoneProcessServerImplementation* server)
