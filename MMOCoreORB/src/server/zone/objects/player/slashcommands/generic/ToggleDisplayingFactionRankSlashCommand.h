...
class ToggleDisplayingFactionRankSlashCommand : public SlashCommand {
public:

	ToggleDisplayingFactionRankSlashCommand(const String& name, ZoneProcessServerImplementation* server)
