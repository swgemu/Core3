...
#ifndef ANONSLASHCOMMAND_H_

#define ANONSLASHCOMMAND_H_


#include "../../../scene/SceneObject.h"
#include "../../PlayerObjectImplementation.h"

class AnonSlashCommand : public SlashCommand {
public:

	AnonSlashCommand(const String& name, ZoneProcessServerImplementation* server)
