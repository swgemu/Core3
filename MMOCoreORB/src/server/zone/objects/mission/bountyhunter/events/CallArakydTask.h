...
public:
	...
	void run() {
		...
		case 0: {
				...
				droid = cast<AiAgent*>(playerRef->getZone()->getCreatureManager()->spawnCreature(String::hashCode("probot"), 0, droidPosition.getX(), droidPosition.getZ(), droidPosition.getY(), 0));
