...
TransactionLog::TransactionLog(SceneObject* src, SceneObject* dst, SceneObject* subject, TrxCode code, bool exportSubject, const char* file, const char* function, int line) {
	if (!isEnabled()) {
		return;
	}
...
TransactionLog::TransactionLog(SceneObject* src, SceneObject* dst, TrxCode code, int amount, bool isCash, const char* file, const char* function, int line) {
	if (!isEnabled()) {
		return;
	}
...
TransactionLog::TransactionLog(uint64 srcObjectID, TrxCode code, uint amount, bool isCash, const char* file, const char* function, int line) {
	if (!isEnabled()) {
		return;
	}
...
TransactionLog::TransactionLog(CreditObject* creditObject, SceneObject* dst, TrxCode code, int amount, bool isCash, const char* file, const char* function, int line) {
	if (!isEnabled()) {
		return;
	}
...
StringBuffer& TransactionLog::abort(const char* file, const char* function, int line) {
	mAborted = true;
...
void TransactionLog::initializeCommon(SceneObject* src, SceneObject* dst, TrxCode code, const char* file, const char* function, int line) {
