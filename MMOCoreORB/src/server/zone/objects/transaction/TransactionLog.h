...
public:
	TransactionLog(SceneObject* src,
				   SceneObject* dst,
				   SceneObject* subject,
				   TrxCode code,
				   bool exportSubject = false,
	...
	TransactionLog(SceneObject* src, TrxCode code, uint amount, bool isCash = true, const char* file = __builtin_FILE(), const char* function = __builtin_FUNCTION(), int line = __builtin_LINE())
		: TransactionLog(src, nullptr, code, amount, isCash, file, function, line) {
	}

	TransactionLog(TrxCode code, SceneObject* dst, uint amount, bool isCash = true, const char* file = __builtin_FILE(), const char* function = __builtin_FUNCTION(), int line = __builtin_LINE())
		: TransactionLog((SceneObject*)nullptr, dst, code, amount, isCash, file, function, line) {
	}

	TransactionLog(uint64 srcObjectID, TrxCode code, uint amount, bool isCash = true, const char* file = __builtin_FILE(), const char* function = __builtin_FUNCTION(), int line = __builtin_LINE());

	TransactionLog(CreditObject* creditObject,
				   SceneObject* dst,
				   TrxCode code,
				   int amount,
				   bool isCash = true,
	...
	StringBuffer& abort(const char* file = __builtin_FILE(), const char* function = __builtin_FUNCTION(), int line = __builtin_LINE());
...
private:
	...
	void initializeCommon(SceneObject* src, SceneObject* dst, TrxCode code, const char* file = __builtin_FILE(), const char* function = __builtin_FUNCTION(), int line = __builtin_LINE());
