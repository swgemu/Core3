...
enum TrxCode {
	...
	TRANSFERSTRUCT       = 100, // Transfer Structure
	PLAYERTIP            = 101, // sui Tip
	CITYINCOMETAX        = 102, // City income taxes
	CHARACTERBUILDER     = 104, // Character Builder
	CITYTREASURY         = 105, // City Treasury
	AUCTIONSALESFEE      = 106, // Auction Sales Fee
	INSTANTBUY           = 107, // Instant Buy
	CITYSALESTAX         = 108, // City Sales taxes
	PLAYERTRADE          = 109, // Player Trade
	ACCESSFEE            = 110, // Access Fee
	LUASCRIPT            = 111, // LUA Script
	LOTTERYDROID         = 112, // Lottery Droid
	AUCTIONBID           = 113, // Auction Bid Escrow
	NPCLOOTCLAIM         = 114, // NPC Loot Claimed
	IMAGEDESIGN          = 115, // Image Design Fees
	TRANSFERITEMMISC     = 116, // /transferitemmisc command
	VETERANREWARD        = 117, // /claimveteranreward command
};
...
public:
	...
	void setTrxGroup(const TransactionLog& leadTrx) {
		mTransaction["trxGroup"] = leadTrx.mTransaction["trxGroup"];
	}
