...
bool BuildingObject::transferObject(SceneObject* object, int containmentType, bool notifyClient, bool allowOverflow) {
	BuildingObjectImplementation* _implementation = static_cast<BuildingObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
int BuildingObject::getFactionBaseType() {
	BuildingObjectImplementation* _implementation = static_cast<BuildingObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
int BuildingObjectImplementation::getFactionBaseType() {
...
void BuildingObjectAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case RPC_HASTEMPLATEEJECTIONPOINT__:
		{
			resp->insertBoolean(hasTemplateEjectionPoint());
		}
		break;
	...
	case RPC_GETFACTIONBASETYPE__:
		{
			resp->insertSignedInt(getFactionBaseType());
		}
		break;
	default:
...
bool BuildingObjectAdapter::transferObject(SceneObject* object, int containmentType, bool notifyClient, bool allowOverflow) {
	return (static_cast<BuildingObject*>(stub))->transferObject(object, containmentType, notifyClient, allowOverflow);
}
...
int BuildingObjectAdapter::getFactionBaseType() {
