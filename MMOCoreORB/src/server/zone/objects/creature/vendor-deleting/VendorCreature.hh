...
package server.zone.objects.creature.vendor;
...
class VendorCreature extends CreatureObject {
	...
	public VendorCreature() {
		...
		//permissions.setAllowPermission("owner, ")
	}
	...
	public void setOwnerID(unsigned long ownerID) {
