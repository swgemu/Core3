...
void AiAgentImplementation::setBitmaskFromString(const String& maskStr) {
	// TODO: don't actually use this. Use this as grep fodder to replace the old AI template string setter
}
