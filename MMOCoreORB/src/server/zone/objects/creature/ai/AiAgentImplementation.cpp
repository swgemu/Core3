...
void AiAgentImplementation::loadWeaponTemplateData() {
	...
	WeaponObject* defaultWeap = getSlottedObject("default_weapon").castTo<WeaponObject*>();
...
void AiAgentImplementation::setupAttackMaps() {
	...
	WeaponObject* defaultWeap = getDefaultWeapon();
	WeaponObject* primaryWeap = getPrimaryWeapon();
	WeaponObject* secondaryWeap = getSecondaryWeapon();
...
void AiAgentImplementation::unequipWeapons() {
	WeaponObject* currentWeap = getCurrentWeapon();
	WeaponObject* defaultWeap = getDefaultWeapon();
...
bool AiAgentImplementation::selectSpecialAttack() {
	...
	if (System::random(100) > 95) {
		Reference<WeaponObject*> thrownWeapRef = thrownWeapon.get();
...
void AiAgentImplementation::destroyAllWeapons() {
	...
	WeaponObject* thrownWeap = getThrownWeapon();
