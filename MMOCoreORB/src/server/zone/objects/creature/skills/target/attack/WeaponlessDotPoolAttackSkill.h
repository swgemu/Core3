...
#ifndef WEAPONLESSDOTPOOLATTACKSKILL_H_
#define WEAPONLESSDOTPOOLATTACKSKILL_H_

#include "../AttackTargetSkill.h"

class WeaponlessDotPoolAttackSkill : public AttackTargetSkill {
protected:
...
public:
	WeaponlessDotPoolAttackSkill(const String& name, const String& anim, ZoneProcessServerImplementation* serv) : AttackTargetSkill(name, anim, WEAPONLESS, serv) {
...
#endif /* WEAPONLESSDOTPOOLATTACKSKILL_H_ */
