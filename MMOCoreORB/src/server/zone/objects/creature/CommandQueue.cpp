...
private:
	...
	WeakReference<CommandQueueActionVector*> commandQ;
...
public:
	...
	void run() {
		...
		Reference<CommandQueueActionVector*> commandQueue = commandQ.get();
...
void CommandQueue::handleRunningState() {
	...
	if (creature == nullptr || queueVector == nullptr)
		return;
...
#ifdef DEBUG_QUEUE
	creature->info("CommandQueue - enqueueCommand Called \n", true);
#endif
