...
void CreatureObject::initializeMembers() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->initializeMembers();
}
...
void CreatureObject::setRunSpeed(float newSpeed, bool notifyClient) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setRunSpeed(newSpeed, notifyClient);
}
...
int CreatureObject::inflictDamage(TangibleObject* attacker, int damageType, int damage, bool destroy, bool notifyClient) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->inflictDamage(attacker, damageType, damage, destroy, notifyClient);
}
...
bool CreatureObject::hasDamage(int attribute) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->hasDamage(attribute);
}
...
int CreatureObject::healDamage(TangibleObject* healer, int damageType, int damage, bool notifyClient) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->healDamage(healer, damageType, damage, notifyClient);
}
...
int CreatureObject::addWounds(int type, int value, bool notifyClient) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->addWounds(type, value, notifyClient);
}
...
void CreatureObject::addMaxHAM(int type, int value, bool notifyClient) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->addMaxHAM(type, value, notifyClient);
}
...
void CreatureObject::addEncumbrance(int type, int value, bool notifyClient) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->addEncumbrance(type, value, notifyClient);
}
...
int CreatureObject::notifyObjectInserted(SceneObject* object) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->notifyObjectInserted(object);
}
...
void CreatureObject::setShockWounds(int newShock, bool notifyClient) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setShockWounds(newShock, notifyClient);
}
...
void CreatureObject::addShockWounds(int shockToAdd, bool notiyClient) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->addShockWounds(shockToAdd, notiyClient);
}
...
void CreatureObject::addBuff(Buff* buff) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->addBuff(buff);
}
...
void CreatureObject::removeBuff(unsigned int buffcrc) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->removeBuff(buffcrc);
}
...
void CreatureObject::removeBuff(Buff* buff) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->removeBuff(buff);
}
...
void CreatureObject::clearBuffs(bool updateclient) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->clearBuffs(updateclient);
}
...
Buff* CreatureObject::getBuff(unsigned int buffcrc) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->getBuff(buffcrc);
}
...
int CreatureObject::addDotState(unsigned long long dotType, unsigned int strength, byte type, unsigned int duration, float potency, unsigned int defense) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->addDotState(dotType, strength, type, duration, potency, defense);
}
...
bool CreatureObject::healDot(unsigned long long dotType, int reduction) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->healDot(dotType, reduction);
}
...
void CreatureObject::clearDots() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->clearDots();
}
...
bool CreatureObject::hasBuff(unsigned int buffcrc) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->hasBuff(buffcrc);
}
...
void CreatureObject::notifySelfPositionUpdate() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->notifySelfPositionUpdate();
}
...
void CreatureObject::notifyPostureChange(int newPosture) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->notifyPostureChange(newPosture);
}
...
void CreatureObject::updateToDatabaseAllObjects(bool startTask) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->updateToDatabaseAllObjects(startTask);
}
...
bool CreatureObject::isResuscitable() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isResuscitable();
}
...
void CreatureObject::addCashCredits(int credits, bool notifyClient) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->addCashCredits(credits, notifyClient);
}
...
void CreatureObject::substractCashCredits(int credits) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->substractCashCredits(credits);
}
...
bool CreatureObject::verifyCashCredits(int credits) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->verifyCashCredits(credits);
}
...
bool CreatureObject::verifyBankCredits(int credits) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->verifyBankCredits(credits);
}
...
void CreatureObject::setMoodString(const String& animation, bool notifyClient) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setMoodString(animation, notifyClient);
}
...
bool CreatureObject::setState(unsigned long long state, bool notifyClient) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->setState(state, notifyClient);
}
...
bool CreatureObject::clearState(unsigned long long state, bool notifyClient) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->clearState(state, notifyClient);
}
...
void CreatureObject::setControlDevice(ControlDevice* device) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setControlDevice(device);
}
...
void CreatureObject::setCreatureLink(CreatureObject* object, bool notifyClient) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setCreatureLink(object, notifyClient);
}
...
void CreatureObject::executeObjectControllerAction(unsigned int actionCRC) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->executeObjectControllerAction(actionCRC);
}
...
void CreatureObject::executeObjectControllerAction(unsigned int actionCRC, unsigned long long targetID, const UnicodeString& args) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->executeObjectControllerAction(actionCRC, targetID, args);
}
...
bool CreatureObject::isAttackableBy(CreatureObject* object) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isAttackableBy(object);
}
...
void CreatureObject::sendConversationStartTo(SceneObject* player) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->sendConversationStartTo(player);
}
...
void CreatureObject::selectConversationOption(int option, SceneObject* obj) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->selectConversationOption(option, obj);
}
...
bool CreatureObject::canTreatInjuries() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->canTreatInjuries();
}
...
bool CreatureObject::canTreatStates() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->canTreatStates();
}
...
bool CreatureObject::canTreatWounds() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->canTreatWounds();
}
...
bool CreatureObject::canTreatConditions() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->canTreatConditions();
}
...
void CreatureObject::dismount() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->dismount();
}
...
float CreatureObject::calculateBFRatio() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->calculateBFRatio();
}
...
void CreatureObject::setDizziedState(int durationSeconds) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setDizziedState(durationSeconds);
}
...
void CreatureObject::setAimingState(int durationSeconds) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setAimingState(durationSeconds);
}
...
void CreatureObject::setCoverState() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setCoverState();
}
...
void CreatureObject::setBerserkedState(unsigned int duration) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setBerserkedState(duration);
}
...
void CreatureObject::setStunnedState(int durationSeconds) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setStunnedState(durationSeconds);
}
...
void CreatureObject::setBlindedState(int durationSeconds) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setBlindedState(durationSeconds);
}
...
void CreatureObject::setIntimidatedState(int durationSeconds) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setIntimidatedState(durationSeconds);
}
...
void CreatureObject::setSnaredState(int durationSeconds) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setSnaredState(durationSeconds);
}
...
void CreatureObject::setRootedState(int durationSeconds) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setRootedState(durationSeconds);
}
...
bool CreatureObject::setNextAttackDelay(int del) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->setNextAttackDelay(del);
}
...
void CreatureObject::setMeditateState() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->setMeditateState();
}
...
void CreatureObject::activateHAMRegeneration() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->activateHAMRegeneration();
}
...
void CreatureObject::activateStateRecovery() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->activateStateRecovery();
}
...
void CreatureObject::updateTimeOfDeath() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->updateTimeOfDeath();
}
...
bool CreatureObject::hasAttackDelay() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->hasAttackDelay();
}
...
bool CreatureObject::hasSpice() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->hasSpice();
}
...
void CreatureObject::updateLastSuccessfulCombatAction() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->updateLastSuccessfulCombatAction();
}
...
void CreatureObject::updateKnockdownRecovery() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->updateKnockdownRecovery();
}
...
void CreatureObject::queueDizzyFallEvent() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->queueDizzyFallEvent();
}
...
void CreatureObject::updateLastKnockdown() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->updateLastKnockdown();
}
...
bool CreatureObject::checkKnockdownRecovery() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->checkKnockdownRecovery();
}
...
bool CreatureObject::checkLastKnockdown() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->checkLastKnockdown();
}
...
void CreatureObject::updatePostureDownRecovery() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->updatePostureDownRecovery();
}
...
void CreatureObject::updatePostureUpRecovery() {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->updatePostureUpRecovery();
}
...
bool CreatureObject::checkPostureDownRecovery() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->checkPostureDownRecovery();
}
...
bool CreatureObject::checkPostureUpRecovery() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->checkPostureUpRecovery();
}
...
void CreatureObject::updateCooldownTimer(const String& coooldownTimer, unsigned int miliSecondsToAdd) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->updateCooldownTimer(coooldownTimer, miliSecondsToAdd);
}
...
bool CreatureObject::checkCooldownRecovery(const String& cooldown) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->checkCooldownRecovery(cooldown);
}
...
void CreatureObject::addCooldown(const String& name, unsigned int miliseconds) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->addCooldown(name, miliseconds);
}
...
int CreatureObject::canAddObject(SceneObject* object, String& errorDescription) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->canAddObject(object, errorDescription);
}
...
void CreatureObject::doAnimation(const String& animation) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->doAnimation(animation);
}
...
void CreatureObject::doCombatAnimation(CreatureObject* defender, unsigned int animationCRC, byte hit) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->doCombatAnimation(defender, animationCRC, hit);
}
...
void CreatureObject::playEffect(const String& file, const String& aux) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->playEffect(file, aux);
}
...
void CreatureObject::playEffect(const String& file) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->playEffect(file);
}
...
void CreatureObject::showFlyText(const String& file, const String& uax, byte red, byte green, byte blue) {
	if (isNull()) {
		...
		((CreatureObjectImplementation*) _getImplementation())->showFlyText(file, uax, red, green, blue);
}
...
CreatureObject* CreatureObject::getLinkedCreature() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->getLinkedCreature();
}
...
bool CreatureObject::hasStates() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->hasStates();
}
...
bool CreatureObject::hasSkillBox(const String& skillBox) {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->hasSkillBox(skillBox);
}
...
bool CreatureObject::isCreatureObject() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isCreatureObject();
}
...
bool CreatureObject::isTrainerCreature() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isTrainerCreature();
}
...
bool CreatureObject::isSwimming() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isSwimming();
}
...
bool CreatureObject::isRidingMount() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isRidingMount();
}
...
ControlDevice* CreatureObject::getControlDevice() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->getControlDevice();
}
...
float CreatureObject::getSwimHeight() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->getSwimHeight();
}
...
bool CreatureObject::isIncapacitated() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isIncapacitated();
}
...
bool CreatureObject::isDead() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isDead();
}
...
bool CreatureObject::isKnockedDown() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isKnockedDown();
}
...
bool CreatureObject::isStanding() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isStanding();
}
...
bool CreatureObject::isSitting() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isSitting();
}
...
bool CreatureObject::isSkillAnimating() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isSkillAnimating();
}
...
bool CreatureObject::isInCombat() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isInCombat();
}
...
bool CreatureObject::isDizzied() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isDizzied();
}
...
bool CreatureObject::isIntimidated() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isIntimidated();
}
...
bool CreatureObject::isSnared() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isSnared();
}
...
bool CreatureObject::isRooted() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isRooted();
}
...
bool CreatureObject::isDiseased() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isDiseased();
}
...
bool CreatureObject::isPoisoned() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isPoisoned();
}
...
bool CreatureObject::isBleeding() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isBleeding();
}
...
bool CreatureObject::isOnFire() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isOnFire();
}
...
bool CreatureObject::isMounted() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isMounted();
}
...
bool CreatureObject::isRidingCreature() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isRidingCreature();
}
...
bool CreatureObject::isPeaced() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isPeaced();
}
...
bool CreatureObject::isMeditating() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isMeditating();
}
...
bool CreatureObject::isShuttleCreature() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isShuttleCreature();
}
...
bool CreatureObject::isNonPlayerCreature() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isNonPlayerCreature();
}
...
bool CreatureObject::isCreature() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isCreature();
}
...
bool CreatureObject::isAiAgent() {
	if (isNull()) {
		...
		return ((CreatureObjectImplementation*) _getImplementation())->isAiAgent();
}
...
CreatureObjectImplementation::CreatureObjectImplementation() {
	_initializeImplementation();
	// server/zone/objects/creature/CreatureObject.idl(196):  		Logger.setLoggingName("CreatureObject");
	Logger::setLoggingName("CreatureObject");
	// server/zone/objects/creature/CreatureObject.idl(198):  		initializeMembers();
	initializeMembers();
}

bool CreatureObjectImplementation::hasDamage(int attribute) {
	// server/zone/objects/creature/CreatureObject.idl(333):  		return maxHamList.get(attribute) - hamList.get(attribute);
	return (&maxHamList)->get(attribute) - (&hamList)->get(attribute);
}

Buff* CreatureObjectImplementation::getBuff(unsigned int buffcrc) {
	// server/zone/objects/creature/CreatureObject.idl(468):  		return 
	if ((&creatureBuffs)->hasBuff(buffcrc))	// server/zone/objects/creature/CreatureObject.idl(469):  			return creatureBuffs.getBuffByCRC(buffcrc);
	return (&creatureBuffs)->getBuffByCRC(buffcrc);
	// server/zone/objects/creature/CreatureObject.idl(471):  null;
	return NULL;
}
...
int CreatureObjectImplementation::addDotState(unsigned long long dotType, unsigned int strength, byte type, unsigned int duration, float potency, unsigned int defense) {
	// server/zone/objects/creature/CreatureObject.idl(475):  		return damageOverTimeList.addDot(this, duration, dotType, type, strength, potency, defense);
...
bool CreatureObjectImplementation::healDot(unsigned long long dotType, int reduction) {
	// server/zone/objects/creature/CreatureObject.idl(479):  		return damageOverTimeList.healState(this, dotType, reduction);
	return (&damageOverTimeList)->healState(_this, dotType, reduction);
}

void CreatureObjectImplementation::clearDots() {
	// server/zone/objects/creature/CreatureObject.idl(483):  		damageOverTimeList.clear();
	(&damageOverTimeList)->clear();
}

bool CreatureObjectImplementation::hasBuff(unsigned int buffcrc) {
	// server/zone/objects/creature/CreatureObject.idl(487):  		return creatureBuffs.hasBuff(buffcrc);
	return (&creatureBuffs)->hasBuff(buffcrc);
}

void CreatureObjectImplementation::addBankCredits(int credits, bool notifyClient) {
	// server/zone/objects/creature/CreatureObject.idl(498):  		int newCredits = bankCredits + credits;
	int newCredits = bankCredits + credits;
	// server/zone/objects/creature/CreatureObject.idl(499):  		setBankCredits(newCredits);
	setBankCredits(newCredits);
}

void CreatureObjectImplementation::addCashCredits(int credits, bool notifyClient) {
	// server/zone/objects/creature/CreatureObject.idl(503):  		int newCredits = cashCredits + credits;
	int newCredits = cashCredits + credits;
	// server/zone/objects/creature/CreatureObject.idl(504):  		setCashCredits(newCredits);
	setCashCredits(newCredits);
}

void CreatureObjectImplementation::substractBankCredits(int credits) {
	// server/zone/objects/creature/CreatureObject.idl(508):  		int newCredits = bankCredits - credits;
	int newCredits = bankCredits - credits;
	// server/zone/objects/creature/CreatureObject.idl(509):  		setBankCredits(newCredits);
	setBankCredits(newCredits);
}

void CreatureObjectImplementation::substractCashCredits(int credits) {
	// server/zone/objects/creature/CreatureObject.idl(513):  		int newCredits = cashCredits - credits;
	int newCredits = cashCredits - credits;
	// server/zone/objects/creature/CreatureObject.idl(514):  		setCashCredits(newCredits);
	setCashCredits(newCredits);
}

bool CreatureObjectImplementation::verifyCashCredits(int credits) {
	// server/zone/objects/creature/CreatureObject.idl(518):  		if 
	if (credits < 0)	// server/zone/objects/creature/CreatureObject.idl(519):  			return false;
	return false;
	// server/zone/objects/creature/CreatureObject.idl(521):  		return 
	if (cashCredits < credits)	// server/zone/objects/creature/CreatureObject.idl(522):  			return false;
	return false;
	// server/zone/objects/creature/CreatureObject.idl(524):  true;
	return true;
}

bool CreatureObjectImplementation::verifyBankCredits(int credits) {
	// server/zone/objects/creature/CreatureObject.idl(528):  		if 
	if (credits < 0)	// server/zone/objects/creature/CreatureObject.idl(529):  			return false;
	return false;
	// server/zone/objects/creature/CreatureObject.idl(531):  		return 
	if (bankCredits < credits)	// server/zone/objects/creature/CreatureObject.idl(532):  			return false;
	return false;
	// server/zone/objects/creature/CreatureObject.idl(534):  true;
	return true;
}

void CreatureObjectImplementation::setControlDevice(ControlDevice* device) {
	// server/zone/objects/creature/CreatureObject.idl(673):  		controlDevice = device;
	controlDevice = device;
}

bool CreatureObjectImplementation::isAttackableBy(CreatureObject* object) {
	// server/zone/objects/creature/CreatureObject.idl(704):  		return false;
	return false;
}
...
bool CreatureObjectImplementation::canTreatInjuries() {
	// server/zone/objects/creature/CreatureObject.idl(726):  		return super.getPendingTask("injuryTreatment") == null;
	return TangibleObjectImplementation::getPendingTask("injuryTreatment") == NULL;
}

bool CreatureObjectImplementation::canTreatStates() {
	// server/zone/objects/creature/CreatureObject.idl(730):  		return super.getPendingTask("stateTreatment") == null;
	return TangibleObjectImplementation::getPendingTask("stateTreatment") == NULL;
}

bool CreatureObjectImplementation::canTreatWounds() {
	// server/zone/objects/creature/CreatureObject.idl(734):  		return super.getPendingTask("woundTreatment") == null;
...
bool CreatureObjectImplementation::canTreatConditions() {
	// server/zone/objects/creature/CreatureObject.idl(738):  		return super.getPendingTask("conditionTreatment") == null;
...
void CreatureObjectImplementation::updateTimeOfDeath() {
	// server/zone/objects/creature/CreatureObject.idl(770):  		timeOfDeath.updateToCurrentTime();
	(&timeOfDeath)->updateToCurrentTime();
}

bool CreatureObjectImplementation::hasAttackDelay() {
	// server/zone/objects/creature/CreatureObject.idl(774):  		return !cooldownTimerMap.isPast("nextAttackDelay");
	return !(&cooldownTimerMap)->isPast("nextAttackDelay");
}

bool CreatureObjectImplementation::hasSpice() {
	// server/zone/objects/creature/CreatureObject.idl(778):  		return creatureBuffs.hasSpice();
	return (&creatureBuffs)->hasSpice();
}

void CreatureObjectImplementation::updateLastSuccessfulCombatAction() {
	// server/zone/objects/creature/CreatureObject.idl(782):  		lastSuccessfulCombatAction.updateToCurrentTime();
	(&lastSuccessfulCombatAction)->updateToCurrentTime();
}

void CreatureObjectImplementation::updateKnockdownRecovery() {
	// server/zone/objects/creature/CreatureObject.idl(786):  		cooldownTimerMap.updateToCurrentAndAddMili("knockdownRecovery", 30000);
	(&cooldownTimerMap)->updateToCurrentAndAddMili("knockdownRecovery", 30000);
}

void CreatureObjectImplementation::updateLastKnockdown() {
	// server/zone/objects/creature/CreatureObject.idl(793):  		cooldownTimerMap.updateToCurrentAndAddMili("lastKnockdown", 60000);
	(&cooldownTimerMap)->updateToCurrentAndAddMili("lastKnockdown", 60000);
}

bool CreatureObjectImplementation::checkKnockdownRecovery() {
	// server/zone/objects/creature/CreatureObject.idl(797):  		return cooldownTimerMap.isPast("knockdownRecovery");
	return (&cooldownTimerMap)->isPast("knockdownRecovery");
}

bool CreatureObjectImplementation::checkLastKnockdown() {
	// server/zone/objects/creature/CreatureObject.idl(801):  		return cooldownTimerMap.isPast("lastKnockdown");
	return (&cooldownTimerMap)->isPast("lastKnockdown");
}

void CreatureObjectImplementation::updatePostureDownRecovery() {
	// server/zone/objects/creature/CreatureObject.idl(805):  		cooldownTimerMap.updateToCurrentAndAddMili("postureDownRecovery", 30000);
...
void CreatureObjectImplementation::updatePostureUpRecovery() {
	// server/zone/objects/creature/CreatureObject.idl(809):  		cooldownTimerMap.updateToCurrentAndAddMili("postureUpRecovery", 30000);
...
bool CreatureObjectImplementation::checkPostureDownRecovery() {
	// server/zone/objects/creature/CreatureObject.idl(813):  		return cooldownTimerMap.isPast("postureDownRecovery");
	return (&cooldownTimerMap)->isPast("postureDownRecovery");
}

bool CreatureObjectImplementation::checkPostureUpRecovery() {
	// server/zone/objects/creature/CreatureObject.idl(817):  		return cooldownTimerMap.isPast("postureUpRecovery");
...
void CreatureObjectImplementation::updateCooldownTimer(const String& coooldownTimer, unsigned int miliSecondsToAdd) {
	// server/zone/objects/creature/CreatureObject.idl(821):  
	if (miliSecondsToAdd != 0){
	// server/zone/objects/creature/CreatureObject.idl(822):  			cooldownTimerMap.updateToCurrentAndAddMili(coooldownTimer, miliSecondsToAdd);
	(&cooldownTimerMap)->updateToCurrentAndAddMili(coooldownTimer, miliSecondsToAdd);
}

	else {
	// server/zone/objects/creature/CreatureObject.idl(824):  			cooldownTimerMap.updateToCurrentTime(coooldownTimer);
...
bool CreatureObjectImplementation::checkCooldownRecovery(const String& cooldown) {
	// server/zone/objects/creature/CreatureObject.idl(829):  		return cooldownTimerMap.isPast(cooldown);
...
void CreatureObjectImplementation::addCooldown(const String& name, unsigned int miliseconds) {
	// server/zone/objects/creature/CreatureObject.idl(833):  		cooldownTimerMap.updateToCurrentAndAddMili(name, miliseconds);
...
void CreatureObjectImplementation::playEffect(const String& file) {
	// server/zone/objects/creature/CreatureObject.idl(844):  		playEffect(file, "");
	playEffect(file, "");
}

bool CreatureObjectImplementation::isGroupped() {
	// server/zone/objects/creature/CreatureObject.idl(854):  		return group != null;
	return group != NULL;
}

int CreatureObjectImplementation::getBankCredits() {
	// server/zone/objects/creature/CreatureObject.idl(858):  		return bankCredits;
	return bankCredits;
}

int CreatureObjectImplementation::getCashCredits() {
	// server/zone/objects/creature/CreatureObject.idl(862):  		return cashCredits;
	return cashCredits;
}

int CreatureObjectImplementation::getBaseHAM(int idx) {
	// server/zone/objects/creature/CreatureObject.idl(866):  		return baseHAM.get(idx);
	return (&baseHAM)->get(idx);
}

int CreatureObjectImplementation::getWounds(int idx) {
	// server/zone/objects/creature/CreatureObject.idl(870):  		return wounds.get(idx);
	return (&wounds)->get(idx);
}

DeltaVector<int>* CreatureObjectImplementation::getWounds() {
	// server/zone/objects/creature/CreatureObject.idl(875):  		return wounds;
	return (&wounds);
}

int CreatureObjectImplementation::getHAM(int idx) {
	// server/zone/objects/creature/CreatureObject.idl(879):  		return hamList.get(idx);
	return (&hamList)->get(idx);
}

DeltaVector<int>* CreatureObjectImplementation::getHAM() {
	// server/zone/objects/creature/CreatureObject.idl(884):  		return hamList;
	return (&hamList);
}

int CreatureObjectImplementation::getMaxHAM(int idx) {
	// server/zone/objects/creature/CreatureObject.idl(888):  		return maxHamList.get(idx);
	return (&maxHamList)->get(idx);
}

DeltaVector<int>* CreatureObjectImplementation::getMaxHAM() {
	// server/zone/objects/creature/CreatureObject.idl(893):  		return maxHamList;
	return (&maxHamList);
}

int CreatureObjectImplementation::getEncumbrance(int idx) {
	// server/zone/objects/creature/CreatureObject.idl(897):  		return encumbrances.get(idx);
	return (&encumbrances)->get(idx);
}

DeltaVector<int>* CreatureObjectImplementation::getEncumbrances() {
	// server/zone/objects/creature/CreatureObject.idl(902):  		return encumbrances;
	return (&encumbrances);
}

byte CreatureObjectImplementation::getPosture() {
	// server/zone/objects/creature/CreatureObject.idl(906):  		return posture;
	return posture;
}

byte CreatureObjectImplementation::getFactionRank() {
	// server/zone/objects/creature/CreatureObject.idl(910):  		return factionRank;
	return factionRank;
}

CreatureObject* CreatureObjectImplementation::getLinkedCreature() {
	// server/zone/objects/creature/CreatureObject.idl(914):  		return linkedCreature;
	return linkedCreature;
}

unsigned long long CreatureObjectImplementation::getCreatureLinkID() {
	// server/zone/objects/creature/CreatureObject.idl(918):  
	if (linkedCreature != NULL)	// server/zone/objects/creature/CreatureObject.idl(919):  			return linkedCreature.getObjectID();
	return linkedCreature->getObjectID();

	else 	// server/zone/objects/creature/CreatureObject.idl(921):  			return 0;
	return 0;
}

float CreatureObjectImplementation::getShockWounds() {
	// server/zone/objects/creature/CreatureObject.idl(925):  		return shockWounds;
	return shockWounds;
}

unsigned long long CreatureObjectImplementation::getStateBitmask() {
	// server/zone/objects/creature/CreatureObject.idl(929):  		return stateBitmask;
	return stateBitmask;
}

bool CreatureObjectImplementation::hasState(unsigned long long state) {
	// server/zone/objects/creature/CreatureObject.idl(933):  		return stateBitmask & state;
	return stateBitmask & state;
}

bool CreatureObjectImplementation::hasStates() {
	// server/zone/objects/creature/CreatureObject.idl(937):  		return stateBitmask != 0;
	return stateBitmask != 0;
}

unsigned long long CreatureObjectImplementation::getListenID() {
	// server/zone/objects/creature/CreatureObject.idl(941):  		return listenToID;
	return listenToID;
}

float CreatureObjectImplementation::getRunSpeed() {
	// server/zone/objects/creature/CreatureObject.idl(945):  		return runSpeed;
	return runSpeed;
}

float CreatureObjectImplementation::getWalkSpeed() {
	// server/zone/objects/creature/CreatureObject.idl(949):  		return walkSpeed;
	return walkSpeed;
}

float CreatureObjectImplementation::getTerrainNegotiation() {
	// server/zone/objects/creature/CreatureObject.idl(953):  		return terrainNegotiation;
	return terrainNegotiation;
}

float CreatureObjectImplementation::getRunAcceleration() {
	// server/zone/objects/creature/CreatureObject.idl(957):  		return runAcceleration;
	return runAcceleration;
}

float CreatureObjectImplementation::getWalkAcceleration() {
	// server/zone/objects/creature/CreatureObject.idl(961):  		return walkAcceleration;
	return walkAcceleration;
}

String CreatureObjectImplementation::getPerformanceAnimation() {
	// server/zone/objects/creature/CreatureObject.idl(965):  		return performanceAnimation;
	return performanceAnimation;
}

String CreatureObjectImplementation::getMoodString() {
	// server/zone/objects/creature/CreatureObject.idl(969):  		return moodString;
	return moodString;
}

unsigned long long CreatureObjectImplementation::getWeaponID() {
	// server/zone/objects/creature/CreatureObject.idl(973):  
	if (weapon == NULL)	// server/zone/objects/creature/CreatureObject.idl(974):  			return 0;
	return 0;

	else 	// server/zone/objects/creature/CreatureObject.idl(976):  			return weapon.getObjectID();
	return weapon->getObjectID();
}

WeaponObject* CreatureObjectImplementation::getWeapon() {
	// server/zone/objects/creature/CreatureObject.idl(980):  
	if (weapon == NULL){
	// server/zone/objects/creature/CreatureObject.idl(981):  			return (WeaponObject) super.getSlottedObject("default_weapon");
	return (WeaponObject*) TangibleObjectImplementation::getSlottedObject("default_weapon");
}

	else 	// server/zone/objects/creature/CreatureObject.idl(983):  			return weapon;
	return weapon;
}

unsigned long long CreatureObjectImplementation::getGroupID() {
	// server/zone/objects/creature/CreatureObject.idl(987):  
	if (group != NULL)	// server/zone/objects/creature/CreatureObject.idl(988):  			return group.getObjectID();
	return group->getObjectID();

	else 	// server/zone/objects/creature/CreatureObject.idl(990):  			return 0;
	return 0;
}

unsigned long long CreatureObjectImplementation::getGroupInviterID() {
	// server/zone/objects/creature/CreatureObject.idl(994):  		return groupInviterID;
	return groupInviterID;
}

GroupObject* CreatureObjectImplementation::getGroup() {
	// server/zone/objects/creature/CreatureObject.idl(998):  		return group;
	return group;
}

unsigned long long CreatureObjectImplementation::getGroupInviteCounter() {
	// server/zone/objects/creature/CreatureObject.idl(1002):  		return groupInviteCounter;
	return groupInviteCounter;
}

int CreatureObjectImplementation::getGuildID() {
	// server/zone/objects/creature/CreatureObject.idl(1006):  		return guildID;
	return guildID;
}

unsigned long long CreatureObjectImplementation::getTargetID() {
	// server/zone/objects/creature/CreatureObject.idl(1010):  		return targetID;
	return targetID;
}

byte CreatureObjectImplementation::getMoodID() {
	// server/zone/objects/creature/CreatureObject.idl(1014):  		return moodID;
	return moodID;
}

float CreatureObjectImplementation::getSlopeModPercent() {
	// server/zone/objects/creature/CreatureObject.idl(1018):  		return slopeModPercent;
	return slopeModPercent;
}

int CreatureObjectImplementation::getPerformanceCounter() {
	// server/zone/objects/creature/CreatureObject.idl(1022):  		return performanceCounter;
	return performanceCounter;
}

int CreatureObjectImplementation::getInstrumentID() {
	// server/zone/objects/creature/CreatureObject.idl(1026):  		return instrumentID;
	return instrumentID;
}

byte CreatureObjectImplementation::getFrozen() {
	// server/zone/objects/creature/CreatureObject.idl(1030):  		return frozen;
	return frozen;
}

float CreatureObjectImplementation::getHeight() {
	// server/zone/objects/creature/CreatureObject.idl(1034):  		return height;
	return height;
}

int CreatureObjectImplementation::getSpecies() {
	// server/zone/objects/creature/CreatureObject.idl(1038):  		return species;
	return species;
}

DeltaVector<int>* CreatureObjectImplementation::getBaseHAM() {
	// server/zone/objects/creature/CreatureObject.idl(1043):  		return baseHAM;
	return (&baseHAM);
}

SkillBoxList* CreatureObjectImplementation::getSkillBoxList() {
	// server/zone/objects/creature/CreatureObject.idl(1048):  		return skillBoxList;
	return (&skillBoxList);
}

long long CreatureObjectImplementation::getSkillMod(const String& skillmod) {
	// server/zone/objects/creature/CreatureObject.idl(1052):  		return skillModList.get(skillmod);
	return (&skillModList)->get(skillmod);
}

bool CreatureObjectImplementation::hasSkillBox(const String& skillBox) {
	// server/zone/objects/creature/CreatureObject.idl(1056):  		return skillBoxList.containsSkillBox(skillBox);
...
DeltaVectorMap<String, long long>* CreatureObjectImplementation::getSkillModList() {
	// server/zone/objects/creature/CreatureObject.idl(1061):  		return skillModList;
	return (&skillModList);
}

void CreatureObjectImplementation::setHeight(float heigh) {
	// server/zone/objects/creature/CreatureObject.idl(1065):  		height = heigh;
	height = heigh;
}

bool CreatureObjectImplementation::isCreatureObject() {
	// server/zone/objects/creature/CreatureObject.idl(1069):  		return true;
	return true;
}

bool CreatureObjectImplementation::isTrainerCreature() {
	// server/zone/objects/creature/CreatureObject.idl(1073):  		return false;
	return false;
}

bool CreatureObjectImplementation::isSwimming() {
	// server/zone/objects/creature/CreatureObject.idl(1077):  		return stateBitmask & CreatureState.SWIMMING;
	return stateBitmask & CreatureState::SWIMMING;
}

bool CreatureObjectImplementation::isRidingMount() {
	// server/zone/objects/creature/CreatureObject.idl(1081):  		return stateBitmask & CreatureState.RIDINGMOUNT;
	return stateBitmask & CreatureState::RIDINGMOUNT;
}

ControlDevice* CreatureObjectImplementation::getControlDevice() {
	// server/zone/objects/creature/CreatureObject.idl(1085):  		return controlDevice;
	return controlDevice;
}

float CreatureObjectImplementation::getSwimHeight() {
	// server/zone/objects/creature/CreatureObject.idl(1089):  		return swimHeight;
	return swimHeight;
}

bool CreatureObjectImplementation::isIncapacitated() {
	// server/zone/objects/creature/CreatureObject.idl(1093):  		return posture == CreaturePosture.INCAPACITATED;
	return posture == CreaturePosture::INCAPACITATED;
}

bool CreatureObjectImplementation::isDead() {
	// server/zone/objects/creature/CreatureObject.idl(1097):  		return posture == CreaturePosture.DEAD;
	return posture == CreaturePosture::DEAD;
}

bool CreatureObjectImplementation::isKnockedDown() {
	// server/zone/objects/creature/CreatureObject.idl(1101):  		return posture == CreaturePosture.KNOCKEDDOWN;
	return posture == CreaturePosture::KNOCKEDDOWN;
}

bool CreatureObjectImplementation::isKneeling() {
	// server/zone/objects/creature/CreatureObject.idl(1105):  		return posture == CreaturePosture.CROUCHED;
	return posture == CreaturePosture::CROUCHED;
}

bool CreatureObjectImplementation::isProne() {
	// server/zone/objects/creature/CreatureObject.idl(1109):  		return posture == CreaturePosture.PRONE;
	return posture == CreaturePosture::PRONE;
}

bool CreatureObjectImplementation::isStanding() {
	// server/zone/objects/creature/CreatureObject.idl(1113):  		return posture == CreaturePosture.UPRIGHT;
	return posture == CreaturePosture::UPRIGHT;
}

bool CreatureObjectImplementation::isSitting() {
	// server/zone/objects/creature/CreatureObject.idl(1117):  		return posture == CreaturePosture.SITTING;
	return posture == CreaturePosture::SITTING;
}

bool CreatureObjectImplementation::isSkillAnimating() {
	// server/zone/objects/creature/CreatureObject.idl(1121):  		return posture == CreaturePosture.SKILLANIMATING;
	return posture == CreaturePosture::SKILLANIMATING;
}

bool CreatureObjectImplementation::isInCombat() {
	// server/zone/objects/creature/CreatureObject.idl(1125):  		return stateBitmask & CreatureState.COMBAT;
	return stateBitmask & CreatureState::COMBAT;
}

bool CreatureObjectImplementation::isDizzied() {
	// server/zone/objects/creature/CreatureObject.idl(1129):  		return stateBitmask & CreatureState.DIZZY;
	return stateBitmask & CreatureState::DIZZY;
}

bool CreatureObjectImplementation::isBerserked() {
	// server/zone/objects/creature/CreatureObject.idl(1133):  		return stateBitmask & CreatureState.BERSERK;
	return stateBitmask & CreatureState::BERSERK;
}

bool CreatureObjectImplementation::isStunned() {
	// server/zone/objects/creature/CreatureObject.idl(1137):  		return stateBitmask & CreatureState.STUNNED;
	return stateBitmask & CreatureState::STUNNED;
}

bool CreatureObjectImplementation::isBlinded() {
	// server/zone/objects/creature/CreatureObject.idl(1141):  		return stateBitmask & CreatureState.BLINDED;
	return stateBitmask & CreatureState::BLINDED;
}

bool CreatureObjectImplementation::isIntimidated() {
	// server/zone/objects/creature/CreatureObject.idl(1145):  		return stateBitmask & CreatureState.INTIMIDATED;
	return stateBitmask & CreatureState::INTIMIDATED;
}

bool CreatureObjectImplementation::isSnared() {
	// server/zone/objects/creature/CreatureObject.idl(1149):  		return stateBitmask & CreatureState.SNARED;
	return stateBitmask & CreatureState::SNARED;
}

bool CreatureObjectImplementation::isRooted() {
	// server/zone/objects/creature/CreatureObject.idl(1153):  		return stateBitmask & CreatureState.ROOTED;
	return stateBitmask & CreatureState::ROOTED;
}

bool CreatureObjectImplementation::isDiseased() {
	// server/zone/objects/creature/CreatureObject.idl(1157):  		return stateBitmask & CreatureState.DISEASED;
	return stateBitmask & CreatureState::DISEASED;
}

bool CreatureObjectImplementation::isPoisoned() {
	// server/zone/objects/creature/CreatureObject.idl(1161):  		return stateBitmask & CreatureState.POISONED;
	return stateBitmask & CreatureState::POISONED;
}

bool CreatureObjectImplementation::isBleeding() {
	// server/zone/objects/creature/CreatureObject.idl(1165):  		return stateBitmask & CreatureState.BLEEDING;
	return stateBitmask & CreatureState::BLEEDING;
}

bool CreatureObjectImplementation::isOnFire() {
	// server/zone/objects/creature/CreatureObject.idl(1169):  		return stateBitmask & CreatureState.ONFIRE;
	return stateBitmask & CreatureState::ONFIRE;
}

bool CreatureObjectImplementation::isMounted() {
	// server/zone/objects/creature/CreatureObject.idl(1173):  		return stateBitmask & CreatureState.RIDINGMOUNT;
	return stateBitmask & CreatureState::RIDINGMOUNT;
}

bool CreatureObjectImplementation::isRidingCreature() {
	// server/zone/objects/creature/CreatureObject.idl(1177):  		return stateBitmask & CreatureState.MOUNTEDCREATURE;
	return stateBitmask & CreatureState::MOUNTEDCREATURE;
}

bool CreatureObjectImplementation::isPeaced() {
	// server/zone/objects/creature/CreatureObject.idl(1181):  		return stateBitmask & CreatureState.PEACE;
	return stateBitmask & CreatureState::PEACE;
}

bool CreatureObjectImplementation::isMeditating() {
	// server/zone/objects/creature/CreatureObject.idl(1185):  		return stateBitmask & CreatureState.ALERT;
	return stateBitmask & CreatureState::ALERT;
}

bool CreatureObjectImplementation::isAiming() {
	// server/zone/objects/creature/CreatureObject.idl(1189):  		return stateBitmask & CreatureState.AIMING;
	return stateBitmask & CreatureState::AIMING;
}

bool CreatureObjectImplementation::isInCover() {
	// server/zone/objects/creature/CreatureObject.idl(1193):  		return stateBitmask & CreatureState.COVER;
	return stateBitmask & CreatureState::COVER;
}

bool CreatureObjectImplementation::isShuttleCreature() {
	// server/zone/objects/creature/CreatureObject.idl(1197):  		return false;
	return false;
}

bool CreatureObjectImplementation::isNonPlayerCreature() {
	// server/zone/objects/creature/CreatureObject.idl(1201):  		return false;
	return false;
}

bool CreatureObjectImplementation::isCreature() {
	// server/zone/objects/creature/CreatureObject.idl(1205):  		return false;
	return false;
}
