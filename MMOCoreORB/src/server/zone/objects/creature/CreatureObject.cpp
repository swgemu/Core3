...
void CreatureObject::notifyInsert(QuadTreeEntry* entry) {
	CreatureObjectImplementation* _implementation = static_cast<CreatureObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		throw ObjectNotLocalException(this);
...
void CreatureObject::notifyDissapear(QuadTreeEntry* entry) {
	CreatureObjectImplementation* _implementation = static_cast<CreatureObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		throw ObjectNotLocalException(this);
...
bool CreatureObjectImplementation::readObjectMember(ObjectInputStream* stream, const String& _name) {
	...
	if (_name == "CreatureObject.invisible") {
...
int CreatureObjectImplementation::writeObjectMembers(ObjectOutputStream* stream) {
	...
	_name = "CreatureObject.invisible";
	_name.toBinaryStream(stream);
	_offset = stream->getOffset();
	stream->writeInt(0);
...
void CreatureObjectImplementation::notifyInsert(QuadTreeEntry* entry) {
	// server/zone/objects/creature/CreatureObject.idl():  		notifyObservers(ObserverEventType.OBJECTINSERTED, entry, 0);
	notifyObservers(ObserverEventType::OBJECTINSERTED, entry, 0);
	// server/zone/objects/creature/CreatureObject.idl():  		super.notifyInsert(entry);
	TangibleObjectImplementation::notifyInsert(entry);
}

void CreatureObjectImplementation::notifyDissapear(QuadTreeEntry* entry) {
	// server/zone/objects/creature/CreatureObject.idl():  		notifyObservers(ObserverEventType.OBJECTDISAPPEARED, entry, 0);
	notifyObservers(ObserverEventType::OBJECTDISAPPEARED, entry, 0);
	// server/zone/objects/creature/CreatureObject.idl():  		super.notifyDissapear(entry);
