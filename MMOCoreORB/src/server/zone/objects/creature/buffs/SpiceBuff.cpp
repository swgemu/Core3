...
DistributedObjectServant* SpiceBuff::_getImplementationForRead() {
	return _impl;
}
...
void SpiceBuffImplementation::readObject(ObjectInputStream* stream) {
	...
	for (int i = 0; i < _varCount; ++i) {
		...
		if(SpiceBuffImplementation::readObjectMember(stream, _nameHashCode)) {
		}
...
bool SpiceBuffImplementation::readObjectMember(ObjectInputStream* stream, const uint32& nameHashCode) {
