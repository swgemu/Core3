...
void AiAgentImplementation::sendReactionChat(int type, int state) {
	if (!getCooldownTimerMap()->isPast("reaction_chat")) {
		return;
	}
	...
	switch(type) {
	case CreatureManager::ALERT:
		chance = 25;
		typeString = "alert_";
		break;
	case CreatureManager::ALLY:
		chance = 25;
		typeString = "ally_";
		break;
	case CreatureManager::ASSIST:
		chance = 25;
		typeString = "assist_";
		break;
	...
	case CreatureManager::GLOAT:
		...
		typeString = "gloat_";
		break;
	case CreatureManager::HELP:
		chance = 25;
		typeString = "help_";
		break;
	case CreatureManager::HI:
		chance = 25;
		typeString = "hi_";
		break;
