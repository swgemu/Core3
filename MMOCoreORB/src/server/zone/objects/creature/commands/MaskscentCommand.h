...
public:
	...
	int doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
		...
		uint32 crc = String::hashCode("skill_buff_mask_scent_self");
	...
	bool checkMaskScent(CreatureObject* creature) const {
		...
		if(creature->hasBuff(String::hashCode("skill_buff_mask_scent")) || creature->getSkillModFromBuffs("private_conceal") > 0) {
