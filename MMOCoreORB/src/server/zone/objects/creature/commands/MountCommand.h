...
public:
	...
	int doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
		if (creature->isRidingMount()) {
			...
			objectController->activateCommand(creature, String::hashCode("dismount"), 0, 0, "");
		...
		try {
			...
			if (creature->hasBuff(String::hashCode("burstrun"))
					|| creature->hasBuff(String::hashCode("retreat"))) {
