...
class RequestCharacterSheetInfoSlashCommand : public QueueCommand {
public:

	RequestCharacterSheetInfoSlashCommand(const String& name, ZoneProcessServerImplementation* server)
