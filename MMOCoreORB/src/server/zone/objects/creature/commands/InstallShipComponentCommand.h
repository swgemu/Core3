...
public:
	...
	int doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
		...
		if (component == nullptr || !component->isComponent() || !(component->getGameObjectType() & SceneObjectType::SHIPATTACHMENT)) {
			return GENERALERROR;
		}

		ManagedReference<SceneObject*> componentRoot = component->getRootParent();

		if (componentRoot == nullptr || componentRoot != creature) {
			return GENERALERROR;
		}
