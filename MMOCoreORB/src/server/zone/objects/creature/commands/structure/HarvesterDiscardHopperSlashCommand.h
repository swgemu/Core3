...
class HarvesterDiscardHopperSlashCommand : public QueueCommand {
public:

	HarvesterDiscardHopperSlashCommand(const String& name, ZoneProcessServerImplementation* server)
