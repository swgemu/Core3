...
#ifndef HARVESTERACTIVATESLASHCOMMAND_H_

#define HARVESTERACTIVATESLASHCOMMAND_H_
...
class HarvesterActivateSlashCommand : public QueueCommand {
public:

	HarvesterActivateSlashCommand(const String& name, ZoneProcessServerImplementation* server)
...
#endif //HARVESTERACTIVATESLASHCOMMAND_H_
