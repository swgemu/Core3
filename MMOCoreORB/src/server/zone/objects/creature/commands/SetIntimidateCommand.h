...
//			params.setTO("@skl_n:" + skill->getSkillName());
		...
		if (message.isEmpty()){
			...
			ghost->removeCommandMessageString(String::hashCode("intimidate1"));
			ghost->removeCommandMessageString(String::hashCode("intimidate2"));
			return SUCCESS;
		}
		...
		ghost->setCommandMessageString(String::hashCode("intimidate1"), message);
		ghost->setCommandMessageString(String::hashCode("intimidate2"), message);
