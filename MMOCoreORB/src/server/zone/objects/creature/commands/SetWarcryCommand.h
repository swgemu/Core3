...
//			params.setTO("@skl_n:" + skill->getSkillName());
		...
		if (message.isEmpty()){
			...
			ghost->removeCommandMessageString(String::hashCode("warcry1"));
			ghost->removeCommandMessageString(String::hashCode("warcry2"));
			return SUCCESS;
		}
		...
		ghost->setCommandMessageString(String::hashCode("warcry1"), message);
		ghost->setCommandMessageString(String::hashCode("warcry2"), message);
