...
: ForceHealQueueCommand(name, server) {
	...
	int doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) {
		...
		uint32 healedConstitutionWound = creature->healWound(creature, CreatureAttribute::CONSTITUTION, healWoundAmount);

		uint32 healedActionWound = creature->healWound(creature, CreatureAttribute::ACTION, healWoundAmount);
		uint32 healedQuicknessWound = creature->healWound(creature, CreatureAttribute::QUICKNESS, healWoundAmount);
		uint32 healedStaminaWound = creature->healWound(creature, CreatureAttribute::STAMINA, healWoundAmount);

		uint32 healedMindWound = creature->healWound(creature, CreatureAttribute::MIND, healWoundAmount);
		uint32 healedFocusWound = creature->healWound(creature, CreatureAttribute::FOCUS, healWoundAmount);
		uint32 healedWillpowerWound = creature->healWound(creature, CreatureAttribute::WILLPOWER, healWoundAmount);
