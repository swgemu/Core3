...
class HealActionWoundOther2Command : public JediQueueCommand {

public:
	HealActionWoundOther2Command(const String& name, ZoneProcessServer* server)
: JediQueueCommand(name, server) {
		animation = "force_healing_1";
		healAttributesWounds.put(CreatureAttribute::ACTION, 150);
		healingType = JediQueueCommand::TARGETONLY;
	}
