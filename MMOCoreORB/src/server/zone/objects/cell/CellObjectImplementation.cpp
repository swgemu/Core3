...
void CellObjectImplementation::notifyLoadFromDatabase() {
	...
	//if (!isClientObject())
	//	info("forceLoadObjectCount = " + String::valueOf(forceLoadObjectCount.get()) + " for cell number " + String::valueOf(cellNumber) + " in " + getParent().get()->getObjectTemplate()->getFullTemplateString(), true);
	...
	if (!containerObjects.hasDelayedLoadOperationMode() || hasForceLoadObject()) {
		...
		if (!isClientObject())
			info("Forced load of container objects for cell number " + String::valueOf(cellNumber) + " in " + getParent().get()->getObjectTemplate()->getFullTemplateString() + " with forceLoadObjectCount = " + String::valueOf(forceLoadObjectCount.get()), true);
	}
}
...
void CellObjectImplementation::onContainerLoaded() {
	...
	if (!isClientObject()) {
		info("Loaded container objects for cell number " + String::valueOf(cellNumber) + " in " + building->getObjectTemplate()->getFullTemplateString() + " with forceLoadObjectCount = " + String::valueOf(forceLoadObjectCount.get()), true);
	}
}
