...
bool SceneObject::isThrownWeaponObject() {
	SceneObjectImplementation* _implementation = static_cast<SceneObjectImplementation*>(_getImplementationForRead());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_ISTHROWNWEAPONOBJECT__);

		return method.executeWithBooleanReturn();
	} else
		return _implementation->isThrownWeaponObject();
}

bool SceneObject::isSpecialHeavyWeapon() {
	SceneObjectImplementation* _implementation = static_cast<SceneObjectImplementation*>(_getImplementationForRead());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
bool SceneObjectImplementation::isThrownWeaponObject() {
	// server/zone/objects/scene/SceneObject.idl():  		return gameObjectType == SceneObjectType.THROWNWEAPON;
	return gameObjectType == SceneObjectType::THROWNWEAPON;
}

bool SceneObjectImplementation::isSpecialHeavyWeapon() {
	// server/zone/objects/scene/SceneObject.idl():  		return gameObjectType == SceneObjectType.SPECIALHEAVYWEAPON;
	return gameObjectType == SceneObjectType::SPECIALHEAVYWEAPON;
}
...
void SceneObjectAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case RPC_ISTRAPOBJECT__:
		...
		break;
	case RPC_ISTHROWNWEAPONOBJECT__:
		{
			resp->insertBoolean(isThrownWeaponObject());
		}
		break;
...
bool SceneObjectAdapter::isThrownWeaponObject() {
	return (static_cast<SceneObject*>(stub))->isThrownWeaponObject();
}

bool SceneObjectAdapter::isSpecialHeavyWeapon() {
	return (static_cast<SceneObject*>(stub))->isSpecialHeavyWeapon();
}
