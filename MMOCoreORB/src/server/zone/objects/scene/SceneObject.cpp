...
bool SceneObjectImplementation::isDecoration() {
	// server/zone/objects/scene/SceneObject.idl():  		if(
	if ((&dataObjectComponent) == NULL)	// server/zone/objects/scene/SceneObject.idl():  			return false;
	return false;
	// server/zone/objects/scene/SceneObject.idl():  		return 
	if ((&dataObjectComponent)->get() == NULL)	// server/zone/objects/scene/SceneObject.idl():  			return false;
	return false;
	// server/zone/objects/scene/SceneObject.idl():  		return dataObjectComponent.get().isDecoration();
	return (&dataObjectComponent)->get()->isDecoration();
}
