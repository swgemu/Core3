...
void SceneObjectImplementation::addSerializableVariables() {
	addSerializableVariable("objectType", &objectType);
	addSerializableVariable("objectCRC", &objectCRC);
	addSerializableVariable("customName", &customName);
	addSerializableVariable("stfFile", &stfFile);
	addSerializableVariable("stfName", &stfName);
	addSerializableVariable("stfDetail", &stfDetail);
	addSerializableVariable("zoneID" , &zoneID);
	addSerializableVariable("attributeString", &attributeString);
	addSerializableVariable("customizationVariables", &customizationVariables);
	addSerializableVariable("itemAttributes", itemAttributes);
	...
	addSerializableVariable("directionX", &directionX);
	addSerializableVariable("directionZ", &directionZ);
	addSerializableVariable("directionY", &directionY);
	addSerializableVariable("directionW", &directionW);
	addSerializableVariable("objectID", &objectID);
	addSerializableVariable("directionAngle", &directionAngle);
	addSerializableVariable("linkType", &linkType);
}
