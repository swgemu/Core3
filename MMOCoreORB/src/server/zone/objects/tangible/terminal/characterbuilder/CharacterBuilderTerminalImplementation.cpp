...
void CharacterBuilderTerminalImplementation::grantJediInitiate(CreatureObject* player) {
	...
	Reference<LuaFunction*> luaVillageGmCmd = lua->createFunction("VillageGmSui", "completeVillageIntro", 0);
	*luaVillageGmCmd << player;
	...
	luaVillageGmCmd = lua->createFunction("VillageGmSui", "completeVillageOutro", 0);
	*luaVillageGmCmd << player;
