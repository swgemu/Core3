...
void GuildTerminalImplementation::fillObjectMenuResponse(ObjectMenuResponse* menuResponse, CreatureObject* player) {
	...
	if (ConfigManager::instance()->useGuildEnhancements())
		menuResponse->addRadialMenuItem(200, 3, "Retrieve Guild Access Device");
...
void GuildTerminalImplementation::giveAccessDevice(CreatureObject* player) {
	...
	String accessDeviceTemplate = "object/intangible/guild_access_device.iff";
