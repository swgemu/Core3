...
public:
	...
	void getChemical(Vector<String>* chemical);

	void getCreature(Vector<String>* creature);

	void getFlora(Vector<String>* flora);

	void getMetal(Vector<String>* metal);

	void getOre(Vector<String>* ore);
