...
#ifndef ONEHANDEDMELEEWEAPONIMPLEMENTATION_H_
#define ONEHANDEDMELEEWEAPONIMPLEMENTATION_H_
...
public:
	...
	void init() {
		...
		setSpeedSkillMod("onehandmelee_speed");
	}
};



#endif /*ONEHANDEDMELEEWEAPONIMPLEMENTATION_H_*/
