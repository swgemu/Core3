...
int WeaponObject::getNumberOfDots() {
	WeaponObjectImplementation* _implementation = static_cast<WeaponObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
int WeaponObject::getDotType(int index) {
	WeaponObjectImplementation* _implementation = static_cast<WeaponObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
int WeaponObject::getDotAttribute(int index) {
	WeaponObjectImplementation* _implementation = static_cast<WeaponObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
int WeaponObject::getDotStrength(int index) {
	WeaponObjectImplementation* _implementation = static_cast<WeaponObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
int WeaponObject::getDotDuration(int index) {
	WeaponObjectImplementation* _implementation = static_cast<WeaponObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
int WeaponObject::getDotPotency(int index) {
	WeaponObjectImplementation* _implementation = static_cast<WeaponObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
int WeaponObject::getDotUses(int index) {
	WeaponObjectImplementation* _implementation = static_cast<WeaponObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
VectorMap<String, int>* WeaponObject::getWearableSkillMods() {
	WeaponObjectImplementation* _implementation = static_cast<WeaponObjectImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		throw ObjectNotLocalException(this);
...
bool WeaponObjectImplementation::readObjectMember(ObjectInputStream* stream, const uint32& nameHashCode) {
	...
	case 0x40433917: //WeaponObject.dotType
		TypeInfo<SortedVector<int> >::parseFromBinaryStream(&dotType, stream);
		return true;

	case 0x5662a29d: //WeaponObject.dotAttribute
		TypeInfo<SortedVector<int> >::parseFromBinaryStream(&dotAttribute, stream);
		return true;

	case 0xe6ae6a5b: //WeaponObject.dotStrength
		TypeInfo<SortedVector<int> >::parseFromBinaryStream(&dotStrength, stream);
		return true;

	case 0xe8f7f5b9: //WeaponObject.dotDuration
		TypeInfo<SortedVector<int> >::parseFromBinaryStream(&dotDuration, stream);
		return true;

	case 0x8f640033: //WeaponObject.dotPotency
		TypeInfo<SortedVector<int> >::parseFromBinaryStream(&dotPotency, stream);
		return true;

	case 0x40a17332: //WeaponObject.dotUses
		TypeInfo<SortedVector<int> >::parseFromBinaryStream(&dotUses, stream);
		return true;
...
int WeaponObjectImplementation::writeObjectMembers(ObjectOutputStream* stream) {
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<SortedVector<int> >::toBinaryStream(&dotType, stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<SortedVector<int> >::toBinaryStream(&dotAttribute, stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<SortedVector<int> >::toBinaryStream(&dotStrength, stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<SortedVector<int> >::toBinaryStream(&dotDuration, stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<SortedVector<int> >::toBinaryStream(&dotPotency, stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<SortedVector<int> >::toBinaryStream(&dotUses, stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
...
int WeaponObjectImplementation::getDotStrength(int index) {
...
int WeaponObjectImplementation::getDotDuration(int index) {
...
VectorMap<String, int>* WeaponObjectImplementation::getWearableSkillMods() {
...
void WeaponObjectAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case RPC_GETNUMBEROFDOTS__:
		{
			resp->insertSignedInt(getNumberOfDots());
		}
		break;
	...
	case RPC_ADDDOTTYPE__INT_:
		{
			addDotType(inv->getSignedIntParameter());
		}
		break;
	case RPC_ADDDOTATTRIBUTE__INT_:
		{
			addDotAttribute(inv->getSignedIntParameter());
		}
		break;
	case RPC_ADDDOTSTRENGTH__INT_:
		{
			addDotStrength(inv->getSignedIntParameter());
		}
		break;
	case RPC_ADDDOTDURATION__INT_:
		{
			addDotDuration(inv->getSignedIntParameter());
		}
		break;
	case RPC_ADDDOTPOTENCY__INT_:
		{
			addDotPotency(inv->getSignedIntParameter());
		}
		break;
	case RPC_ADDDOTUSES__INT_:
		{
			addDotUses(inv->getSignedIntParameter());
		}
		break;
	case RPC_SETDOTUSES__INT_INT_:
		{
			setDotUses(inv->getSignedIntParameter(), inv->getSignedIntParameter());
		}
		break;
