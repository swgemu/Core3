...
protected:
	...
	int moduleType;
	VectorMap<String, int> moduleProperties;
...
public:
	...
	inline void addProperty( String propertyName, int value){
		moduleProperties.put(propertyName,value);
	}

	inline int getProperty( String propertyName ){
		return moduleProperties.get(propertyName);
	}

	inline bool hasProperty( String propertyName ){
		return moduleProperties.contains(propertyName);
	}
