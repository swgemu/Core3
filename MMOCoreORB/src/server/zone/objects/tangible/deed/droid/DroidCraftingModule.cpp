...
bool DroidCraftingModule::isWeaponDroidGeneric(){
	if( !hasProperty("crafting_module") )
		return false;

	return getProperty("crafting_module") == WEAPON_DROID_GENERIC;
}
...
bool DroidCraftingModule::isFoodChemical(){
	...
	return getProperty("crafting_module") == FOOD_CHEMICAL;
}
...
bool DroidCraftingModule::isClothingArmor(){
	...
	return getProperty("crafting_module") == CLOTHING_ARMOR;
}
...
bool DroidCraftingModule::isStructureFurniture(){
	...
	return getProperty("crafting_module") == STRUCTURE_FURNITURE;
}
...
bool DroidCraftingModule::isShip(){
	...
	return getProperty("crafting_module") == SHIP;
}
