...
enum {RPC_INITIALIZETRANSIENTMEMBERS__ = 6,RPC_GETDURATION__,RPC_GETBUFFCRC__,};
...
VectorMap<String, float>* SkillBuff::getModifiers() {
	SkillBuffImplementation* _implementation = static_cast<SkillBuffImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		throw ObjectNotLocalException(this);

	} else
		return _implementation->getModifiers();
}
...
int SkillBuffImplementation::getDuration() {
	// server/zone/objects/tangible/skill_buff/SkillBuff.idl():  		return duration;
	return duration;
}

int SkillBuffImplementation::getBuffCRC() {
	// server/zone/objects/tangible/skill_buff/SkillBuff.idl():  		return buffCRC;
	return buffCRC;
}

VectorMap<String, float>* SkillBuffImplementation::getModifiers() {
	// server/zone/objects/tangible/skill_buff/SkillBuff.idl():  		return modifiers;
	return (&modifiers);
}
...
int SkillBuffAdapter::getDuration() {
	return (static_cast<SkillBuff*>(stub))->getDuration();
}

int SkillBuffAdapter::getBuffCRC() {
	return (static_cast<SkillBuff*>(stub))->getBuffCRC();
}
