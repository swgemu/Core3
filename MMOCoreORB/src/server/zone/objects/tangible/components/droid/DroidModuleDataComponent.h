...
#ifndef DROIDMODULEDATACOMPONENT_H_
#define DROIDMODULEDATACOMPONENT_H_
...
class DroidModuleDataComponent : public DataObjectComponent, public Logger {
...
#endif /*DROIDMODULEDATACOMPONENT_H_*/
