...
#include "DroidModuleDataComponent.h"
...
class DroidCraftingModuleDataComponent : public DroidModuleDataComponent {
...
public:
	...
	inline CraftingStation* getCraftingStation(){ return craftingStation; }

	inline int getCraftingType(){ return craftingType; }
