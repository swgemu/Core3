...
public:
	...
	void deleteTrack(int slotIndex);
	void setTrack( String song, int instrument, int slotIndex );
	bool toBinaryStream(ObjectOutputStream* stream);
	bool parseFromBinaryStream(ObjectInputStream* stream);
	String getCurrentTrack();
	int getCurrentInstrument();
	void sessionTimeout() { System::out << "Session timeout\n";}
	void songChanged() {}
	void songStopped() { recording = false;}
