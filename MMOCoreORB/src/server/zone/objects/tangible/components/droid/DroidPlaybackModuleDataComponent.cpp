...
void DroidPlaybackModuleDataComponent::deleteTrack(int slotIndex) {
...
void DroidPlaybackModuleDataComponent::setTrack( String song, int instrument, int slotIndex ){
	if( 0 <= slotIndex && slotIndex <= tracks.size() ){
		tracks.setElementAt( slotIndex, song );
		instruments.setElementAt(slotIndex,instrument);
	}
}
