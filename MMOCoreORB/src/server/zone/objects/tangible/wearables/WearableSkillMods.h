...
public:
	...
	String getRandomAttachmentMod(int type) {
		...
		case 40:
			...
			break;
		case 41:
			randomskill = "posture_change_up_defenses";
			break;
		case 42:
		...
		case 57:
			...
			break;
		case 58:
			randomskill = "twohandmelee_amage";
			break;
		case 59:
			randomskill = "polearm_damage";
			break;
		case 60:
			randomskill = "aim";
			break;
		...
		case 82:
			...
			break;
		case 83:
			randomskill = "tracking_droids";
			break;
		case 84:
			randomskill = "tracking_droid_effectiveness";
			break;
		case 85:
			randomskill = "droid_find_speed";
			break;
		case 86:
			randomskill = "droid_find_chance";
			break;
		case 87:
