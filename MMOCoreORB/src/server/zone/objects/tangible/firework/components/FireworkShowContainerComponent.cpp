...
#include "FireworkShowContainerComponent.h"
#include "server/zone/objects/scene/SceneObject.h"
#include "server/zone/objects/tangible/TangibleObject.h"
#include "server/zone/managers/object/ObjectManager.h"

int FireworkShowContainerComponent::canAddObject(SceneObject* sceneObject, SceneObject* object, int containmentType, String& errorDescription) {
	if(object == NULL || !object->isFireworkObject())
		return TransferErrorCode::INVALIDTYPE;

	if(object->getContainerObjectsSize() > 0)
		return TransferErrorCode::INVALIDTYPE;
...
bool FireworkShowContainerComponent::transferObject(SceneObject* sceneObject, SceneObject* object, int containmentType, bool notifyClient) {
	...
	if(tano->getUseCount() > 1) {
		...
		ManagedReference<TangibleObject*> clone = cast<TangibleObject*>( objectManager->cloneObject(tano));
		if(clone == NULL)
			return false;
 ...
 */
int FireworkShowContainerComponent::notifyObjectInserted(SceneObject* sceneObject, SceneObject* object) {
 ...
 * @param object object that has been inserted
 */
int FireworkShowContainerComponent::notifyObjectRemoved(SceneObject* sceneObject, SceneObject* object, SceneObject* destination) {
