...
uint32 FsBuffItemImplementation::getBuffCRC() {
	...
	case 8: return BuffCRC::PERFORMANCE_ENHANCE_DANCE_MIND;
	case 9: return BuffCRC::PERFORMANCE_ENHANCE_MUSIC_FOCUS;
	case 10: return BuffCRC::PERFORMANCE_ENHANCE_MUSIC_WILLPOWER;
