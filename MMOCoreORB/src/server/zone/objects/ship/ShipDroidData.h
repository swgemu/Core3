...
public:
	...
	static uint32 getDroidType(uint32 droidCrc) {
		switch (droidCrc) {
			case String::hashCode("object/intangible/pet/r2.iff"):				return ASTROMECH;
			case String::hashCode("object/intangible/pet/r2_crafted.iff"):			return ASTROMECH;
			case String::hashCode("object/intangible/pet/r3.iff"):				return ASTROMECH;
			case String::hashCode("object/intangible/pet/r3_crafted.iff"):			return ASTROMECH;
			case String::hashCode("object/intangible/pet/r4.iff"):				return ASTROMECH;
			case String::hashCode("object/intangible/pet/r4_crafted.iff"):			return ASTROMECH;
			case String::hashCode("object/intangible/pet/r5.iff"):				return ASTROMECH;
			case String::hashCode("object/intangible/pet/r5_crafted.iff"):			return ASTROMECH;
			case String::hashCode("object/intangible/pet/nhelper_droid.iff"):		return ASTROMECH;
			case String::hashCode("object/intangible/ship/navicomputer_1.iff"):		return FLIGHTCOMPUTER;
			case String::hashCode("object/intangible/ship/navicomputer_2.iff"):		return FLIGHTCOMPUTER;
			case String::hashCode("object/intangible/ship/navicomputer_3.iff"):		return FLIGHTCOMPUTER;
			case String::hashCode("object/intangible/ship/navicomputer_4.iff"):		return FLIGHTCOMPUTER;
			case String::hashCode("object/intangible/ship/navicomputer_5.iff"):		return FLIGHTCOMPUTER;
			case String::hashCode("object/intangible/ship/navicomputer_6.iff"):		return FLIGHTCOMPUTER;
			default :return NONE;
		}
	}
};
