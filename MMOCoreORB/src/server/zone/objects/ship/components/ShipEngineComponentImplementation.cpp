...
void ShipEngineComponentImplementation::install(CreatureObject* owner, ShipObject* ship, int slot, bool notifyClient) {
    ...
    ship->setEngineAccelerationRate(30.0f, notifyClient, message);
    ship->setEngineDecelerationRate(30.0f, notifyClient, message);
    ship->setMaxSpeed(maxSpeed, notifyClient, message);
    ship->setChassisSpeed(maxSpeed, notifyClient, message);
    ...
    ship->setShipAccelerationRate(30.0f, notifyClient, message);
    ship->setShipDecelerationRate(30.0f, notifyClient, message);
