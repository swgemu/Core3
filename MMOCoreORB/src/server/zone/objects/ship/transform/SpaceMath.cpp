...
float SpaceMath::getVelocityTime(const Vector3& rotationEnd, const Vector3 rotationStart, float maxY, float maxP) {
	return getRotationTime(velocityToRotation(rotationEnd - rotationStart), Vector3::ZERO, maxY, maxP);
}
