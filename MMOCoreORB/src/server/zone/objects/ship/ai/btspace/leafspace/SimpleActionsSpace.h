...
class UpdateDisabledEngineSpeed : public BehaviorSpace {
public:
	UpdateDisabledEngineSpeed(const String& className, const uint32 id, const LuaObject& args) : BehaviorSpace(className, id, args) {
	}

	UpdateDisabledEngineSpeed(const FindNextPosition& a) : BehaviorSpace(a) {
	}
