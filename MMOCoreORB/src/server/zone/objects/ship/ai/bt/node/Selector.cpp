...
Behavior::Status Selector::execute(ShipAiAgent* agent, unsigned int startIdx) const {
...
Behavior::Status ParallelSelector::execute(ShipAiAgent* agent, unsigned int startIdx) const {
...
Behavior::Status RandomSelector::execute(ShipAiAgent* agent, unsigned int startIdx) const {
