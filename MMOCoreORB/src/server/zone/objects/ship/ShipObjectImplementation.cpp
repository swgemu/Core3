	...
	for (int i = 0; i < componentMap->size(); ++i) {
		...
		switch (slot) {
			...
			case Components::SHIELD1: {
				...
				int frontDecay = frontShieldDamage / 10;
				...
				int rearDecay = rearShieldDamage / 10;
			...
			case Components::CAPACITOR: {
				...
				int capacitorDecay = capacitorDamage * repair;
			...
			case Components::BOOSTER: {
				...
				int boosterDecay = boosterDamage / 10;
