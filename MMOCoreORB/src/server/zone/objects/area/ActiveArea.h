...
public:
	ActiveArea(Coordinate * center, float width, float height) : Area(center, width, height) {

	}

	ActiveArea(float minXPos, float maxXPos, float minYPos, float maxYPos) : Area(minXPos, maxXPos, minYPos, maxYPos) {
