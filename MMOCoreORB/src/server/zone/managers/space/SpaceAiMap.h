...
public:
	...
	void loadTemplates() {
		...
		// SpaceAI
		lua->setGlobalInt("NONE", BehaviorTreeSlotSpace::NONE);
		lua->setGlobalInt("AWARE", BehaviorTreeSlotSpace::AWARE);
		lua->setGlobalInt("IDLE", BehaviorTreeSlotSpace::IDLE);
		lua->setGlobalInt("ATTACK", BehaviorTreeSlotSpace::ATTACK);
