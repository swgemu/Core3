...
void TemplateManager::loadAssetCustomizationManager() {
	...
	AssetCustomizationManagerTemplate::instance()->getCustomizationVariables(String::hashCode("appearance/wp_mle_sword_lightsaber_blade_anakin.lsb"), variables, false);
