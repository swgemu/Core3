...
namespace ship {
	...
	public:
		...
		void readObject(LuaObject& obj) {
			...
			String capitalShip = "object/ship/" + obj.getStringField("capitalShip") + ".iff";

			Logger::console.info(true) << "Adding Capital Ship: " << capitalShip;

			capitalShipCRC = capitalShip.hashCode();
		}
