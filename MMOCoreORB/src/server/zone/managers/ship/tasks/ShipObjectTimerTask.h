...
class ShipObjectTimerTask : public Task, public Logger {
	...
	protected:
		...
		SortedVector<ManagedReference<ShipObject*>> shipVector;
		SortedVector<ManagedReference<ShipAiAgent*>> agentVector;
		SortedVector<ManagedWeakReference<ShipObject*>> queueVector;
