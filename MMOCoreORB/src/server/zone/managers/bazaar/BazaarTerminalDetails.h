...
#ifndef BAZAARTERMINALDETAILS_H_
#define BAZAARTERMINALDETAILS_H_
...
public:
	BazaarMap(int initsize) : HashTable<uint64, BazaarTerminalDetails*>(initsize), HashTableIterator<uint64, BazaarTerminalDetails*>(this) {
		setNullValue(NULL);
	}

};

#endif /*BAZAARTERMINALDETAILS_H_*/
