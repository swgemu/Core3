...
void PlanetManagerImplementation::loadNavAreas(LuaObject* areas) {
	...
	info("Loading planet navAreas from navareas.db for zone: " + zoneName, true);

	ObjectDatabaseManager* dbManager = ObjectDatabaseManager::instance();
	ObjectDatabase* navAreasDatabase = ObjectDatabaseManager::instance()->loadObjectDatabase("navareas", true);
	...
	if (navAreasDatabase != NULL) {
		...
		error("Could not load the nav areas database.");
	}
