...
void GCWManagerImplementation::spawnSecurityPatrol(BuildingObject* building, String &patrol, Vector3 &location, uint64 parentID, float direction, bool stationary) {
...
void GCWManagerImplementation::spawnBaseSecurityPatrols(BuildingObject* building) {
	...
	for (int i = 0; i < spawns; i++) {
		...
		spawnSecurityPatrol(building, patrol, location, 0, patrolSpawn->getDirection(), false);
	}
}
