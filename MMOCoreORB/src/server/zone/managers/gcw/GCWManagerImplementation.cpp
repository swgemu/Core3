...
int GCWManagerImplementation::looserBonus = 0;
...
void GCWManagerImplementation::loadLuaConfig(){
	...
	looserBonus = lua->getGlobalInt("looserBonus");
...
// includes racial penalty and Bonus&Penality for Looser and Winner side
