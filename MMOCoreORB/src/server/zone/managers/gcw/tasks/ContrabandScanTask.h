	...
	void dismountPlayer(AiAgent* scanner, CreatureObject* player) {
		if (player->isRidingMount()) {
			...
			if (scanner->getFaction() == Factions::FACTIONIMPERIAL) {
				dismoutFaction.setStringId("@imperial_presence/contraband_search:dismount_imperial");
			} else {
				dismoutFaction.setStringId("@imperial_presence/contraband_search:dismount_rebel");
			}
