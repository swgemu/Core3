...
int GCWManager::getGCWDiscount(CreatureObject* creature) {
	GCWManagerImplementation* _implementation = static_cast<GCWManagerImplementation*>(_getImplementation());
	if (_implementation == NULL) {
		throw ObjectNotLocalException(this);
...
int GCWManagerImplementation::getGCWDiscount(CreatureObject* creature) {
	// server/zone/managers/gcw/GCWManager.idl():  		return 
	if (getWinningFaction() != creature->getFaction() && creature->getFaction() != 0)	// server/zone/managers/gcw/GCWManager.idl():  			return bonusDiscount;
	return bonusDiscount;
	// server/zone/managers/gcw/GCWManager.idl():  		return 0;
	return 0;
}
