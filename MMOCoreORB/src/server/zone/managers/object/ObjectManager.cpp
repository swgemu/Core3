...
void ObjectManager::registerObjectTypes() {
	...
	objectFactory.registerObject<ShipShieldComponent>(SceneObjectType::SHIPSHIELDSUBCOMPONET);
	...
	objectFactory.registerObject<ShipCapacitorComponent>(SceneObjectType::SHIPCAPACITORSUBCOMPONET);
	objectFactory.registerObject<ShipBoosterComponent>(SceneObjectType::SHIPBOOSTER);
	objectFactory.registerObject<ShipBoosterComponent>(SceneObjectType::SHIPBOOSTERSUBCOMPONET);
	...
	objectFactory.registerObject<ShipWeaponComponent>(SceneObjectType::SHIPWEAPONSUBCOMPONET);
