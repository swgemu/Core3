...
uint32 ObjectManager::serverObjectCrcHashCode = String::hashCode("SceneObject.serverObjectCRC");
uint32 ObjectManager::_classNameHashCode = String::hashCode("_className");
