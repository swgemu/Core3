...
int PlayerManagerAdapter::getMedicalFacilityRating(CreatureObject* creature) {
	return (static_cast<PlayerManager*>(stub))->getMedicalFacilityRating(creature);
}
