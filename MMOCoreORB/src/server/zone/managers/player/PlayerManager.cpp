...
bool PlayerManager::kickUser(const String& name, const String& admin) {
	if (_impl == NULL) {
		...
		return ((PlayerManagerImplementation*) _impl)->kickUser(name, admin);
}
...
SceneObject* PlayerManager::getInRangeStructureWithAdminRights(CreatureObject* creature, unsigned long long targetID) {
	if (_impl == NULL) {
		...
		return ((PlayerManagerImplementation*) _impl)->getInRangeStructureWithAdminRights(creature, targetID);
}
...
void PlayerManager::stopWatch(CreatureObject* creature, unsigned long long entid, bool doSendPackets, bool forced, bool doLock, bool outOfRange) {
	if (_impl == NULL) {
		...
		((PlayerManagerImplementation*) _impl)->stopWatch(creature, entid, doSendPackets, forced, doLock, outOfRange);
}
...
void PlayerManager::stopListen(CreatureObject* creature, unsigned long long entid, bool doSendPackets, bool forced, bool doLock, bool outOfRange) {
	if (_impl == NULL) {
		...
		((PlayerManagerImplementation*) _impl)->stopListen(creature, entid, doSendPackets, forced, doLock, outOfRange);
}
...
void PlayerManager::startWatch(CreatureObject* creature, unsigned long long entid) {
	if (_impl == NULL) {
		...
		((PlayerManagerImplementation*) _impl)->startWatch(creature, entid);
}
...
void PlayerManager::startListen(CreatureObject* creature, unsigned long long entid) {
	if (_impl == NULL) {
		...
		((PlayerManagerImplementation*) _impl)->startListen(creature, entid);
}
...
bool PlayerManager::squadLeaderCheck(PlayerCreature* player, GroupObject* group) {
	if (_impl == NULL) {
		...
		return ((PlayerManagerImplementation*) _impl)->squadLeaderCheck(player, group);
}
...
void PlayerManager::awardSquadLeaderExperience(GroupObject* group, int amount, TangibleObject* source) {
	if (_impl == NULL) {
		...
		((PlayerManagerImplementation*) _impl)->awardSquadLeaderExperience(group, amount, source);
}
