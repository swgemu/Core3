...
void PlayerManagerAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case RPC_EJECTPLAYERFROMBUILDING__CREATUREOBJECT_:
		{
			ejectPlayerFromBuilding(static_cast<CreatureObject*>(inv->getObjectParameter()));
		}
		break;
