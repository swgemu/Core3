...
void PlayerManagerImplementation::loadLuaConfig() {
	...
	performanceSecondaryBuff = lua->getGlobalInt("performanceSecondaryBuff");
	performanceDuration = lua->getGlobalInt("performanceDuration");
	resistanceBuff = lua->getGlobalInt("resistanceBuff");
	resistanceDuration = lua->getGlobalInt("resistanceDuration");
	absorption = lua->getGlobalInt("absorption");
