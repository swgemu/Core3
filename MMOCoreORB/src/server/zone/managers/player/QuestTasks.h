...
public:
	...
	String getprerequisiteTasks() {
		return prerequisiteTasks;
	}
	
	String getExclusionTasks() {
	...
	String getJournalEntryTitle() {
		return journalEntryTitle;
	}
	
	String getJournalEntryDescription() {
		return journalEntryDescription;
	}
	
	Vector<int> getTasksOnComplete() {
		return tasksOnComplete;
	}
	
	Vector<int> getTasksOnFail() {
		return tasksOnFail;
	}
	...
	int getLootItemsRequired() {
		return lootItemsRequired;
	}
	
	int getLootDropPercent() {
