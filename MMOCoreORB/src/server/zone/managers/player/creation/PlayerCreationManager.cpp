...
bool PlayerCreationManager::createCharacter(MessageCallback* data) {
	...
	box->setPromptText("You are limited to creating one character every 24 hours. Attempting to create another character or deleting your character before the timer expires will reset the timer back to 24 hours.");
