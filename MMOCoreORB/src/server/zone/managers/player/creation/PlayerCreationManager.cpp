...
bool PlayerCreationManager::createCharacter(MessageCallback* data) {
	...
	box->setPromptText("You are limited to creating one character per hour. Attempting to create another character or deleting your character before the Z hour timer expires will reset the timer.");
