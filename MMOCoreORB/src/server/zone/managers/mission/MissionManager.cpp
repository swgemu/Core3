...
BountyTargetListElement* MissionManager::getRandomPlayerBounty() {
	...
	if (_implementation == NULL) {
		...
		DistributedMethod method(this, RPC_GETRANDOMPLAYERBOUNTY__);

		return static_cast<BountyTargetListElement*>(method.executeWithObjectReturn());
	} else
		return _implementation->getRandomPlayerBounty();
}
...
BountyTargetListElement* MissionManagerAdapter::getRandomPlayerBounty() {
	return (static_cast<MissionManager*>(stub))->getRandomPlayerBounty();
}
