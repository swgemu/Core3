...
void MissionManagerImplementation::createCraftingMissionObjectives(MissionObject* mission, MissionTerminal* missionTerminal, CreatureObject* player) {
	...
	mission->setTargetTemplate(TemplateManager::instance()->getTemplate(String::hashCode("object/tangible/mission/quest_item/attunement_grid.iff")));
...
void MissionManagerImplementation::randomizeGenericBountyMission(CreatureObject* player, MissionObject* mission, const int faction) {
	...
	mission->setTargetTemplate(TemplateManager::instance()->getTemplate(String::hashCode("object/tangible/mission/mission_bounty_target.iff")));
...
bool MissionManagerImplementation::randomGenericDeliverMission(CreatureObject* player, MissionObject* mission, bool inTownMission, const int faction) {
	...
	NameManager* nm = processor->getNameManager();
	mission->setCreatorName(nm->makeCreatureName());
	mission->setMissionTargetName(TemplateManager::instance()->getTemplate(String::hashCode("object/tangible/mission/mission_datadisk.iff"))->getObjectName());
	...
	mission->setTargetTemplate(TemplateManager::instance()->getTemplate(String::hashCode("object/tangible/mission/mission_datadisk.iff")));
...
void MissionManagerImplementation::randomizeGenericEntertainerMission(CreatureObject* player, MissionObject* mission, const int faction, const int missionType) {
	...
	mission->setTargetTemplate(TemplateManager::instance()->getTemplate(String::hashCode("object/building/general/mun_all_guild_theater_s01.iff")));
...
void MissionManagerImplementation::randomizeGenericReconMission(CreatureObject* player, MissionObject* mission, const int faction) {
	...
	mission->setMissionTargetName(TemplateManager::instance()->getTemplate(String::hashCode("object/tangible/mission/mission_recon_target.iff"))->getObjectName());
	mission->setTargetTemplate(TemplateManager::instance()->getTemplate(String::hashCode("object/tangible/mission/mission_recon_target.iff")));
