...
void MissionManagerImplementation::randomizeGenericBountyMission(CreatureObject* player, MissionObject* mission, const int faction) {
	...
	if (npcTarget) {
		...
		UnicodeString numberOfEntries = StringIdManager::instance()->getStringId(STRING_HASHCODE("@" + stfFile + diffString + ":" + "number_of_entries"));
		...
		UnicodeString possibleCreatorName = StringIdManager::instance()->getStringId(STRING_HASHCODE("@" + stfFile + diffString + ":" + "m" + String::valueOf(randTexts) + "o"));
		String creatorName = "";
		...
		if (target != NULL) {
			...
			UnicodeString numberOfEntries = StringIdManager::instance()->getStringId(STRING_HASHCODE("@" + stfFile  + ":" + "number_of_entries"));
			...
			UnicodeString possibleCreatorName = StringIdManager::instance()->getStringId(STRING_HASHCODE("@" + stfFile + "m" + String::valueOf(randTexts) + "o"));
			String creatorName = "";
