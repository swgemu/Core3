...
class ImageDesignManager : public Singleton<ImageDesignManager>, public Object, public Logger {
	...
	void updateColorCustomization(CreatureObject* imageDesigner, CustomizationData* customData, uint32 value, bool isHairUpdate, TangibleObject* hairObject, CreatureObject* creo = NULL);
...
public:
	...
	void updateColorCustomization(CreatureObject* imageDesigner, const String& customizationName, uint32 value, bool isHairUpdate, TangibleObject* hairObject, CreatureObject* creo = NULL);
