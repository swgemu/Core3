...
public:
	...
	SortedVector<ManagedReference<TangibleObject*> > getAreaTargets(TangibleObject* attacker, WeaponObject* weapon, TangibleObject* defenderObject, const CreatureAttackData& data);
