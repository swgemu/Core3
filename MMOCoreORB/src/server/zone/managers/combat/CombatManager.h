...
public:
	...
	const static int HIT_RARM = 0x3;
	const static int HIT_LLEG = 0x4;
	const static int HIT_RLEG = 0x5;
	const static int HIT_HEAD = 0x6;
...
protected:
	...
	/*ArmorObject* getHealthArmor( CreatureObject* defender, uint8 hitLocation = HIT_BODY);
	ArmorObject* getActionArmor(CreatureObject* defender, uint8 hitLocation = HIT_LLEG);
	ArmorObject* getMindArmor(CreatureObject* defender, uint8 hitLocation = HIT_HEAD);*/
