...
public:
	...
	void finalCombatSpam(TangibleObject* attacker, WeaponObject* item, const CreatureAttackData & data) const;

	void broadcastCombatAction(CreatureObject* attacker, WeaponObject* weapon, const CreatureAttackData& data) const;
...
protected:
	...
	void doTargetCombatAction(CreatureObject* attacker, WeaponObject* weapon, const CreatureAttackData& data) const;
	void creoTargetCombatAction(CreatureObject* attacker, WeaponObject* weapon, CreatureObject* defender, DefenderHitList* hitList, const CreatureAttackData& data) const;

	void doTargetCombatAction(TangibleObject* attacker, WeaponObject* weapon, const CreatureAttackData& data) const;
	void tanoTargetCombatAction(TangibleObject* attacker, WeaponObject* weapon, CreatureObject* defenderObject, DefenderHitList* targetHitList, const CreatureAttackData& data) const;
	...
	void applyDamage(TangibleObject* attacker, WeaponObject* weapon, CreatureObject* defender, DefenderHitList* defenderHitList, int damage, float damageMultiplier, int poolsToDamage, uint8& hitLocation, const CreatureAttackData& data) const;
	void applyDamage(CreatureObject* attacker, WeaponObject* weapon, TangibleObject* defender, DefenderHitList* defenderHitList, int poolsToDamage, const CreatureAttackData& data) const;

	void woundCreatureTargets(CreatureObject* defender, WeaponObject* weapon, Vector<int> poolsToWound) const;

	void applyStates(CreatureObject* creature, CreatureObject* targetCreature, const CreatureAttackData& data) const;


	int getArmorReduction(TangibleObject* attacker, WeaponObject* item, CreatureObject* defender, DefenderHitList* hitList, float damage, int hitLocation, const CreatureAttackData& data) const;
