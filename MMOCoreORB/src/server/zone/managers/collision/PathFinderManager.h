...
protected:
	...
	bool getPathFromMesh(RecastNavMesh *navMesh, const Vector3 &startPosition, const Vector3 &targetPosition, Vector<WorldCoordinates> *path, float &len, bool allowPartial);
