...
bool CollisionManager::checkLineOfSight(SceneObject* object1, SceneObject* object2) {
	if (object1->isCreatureObject()) {
		object1->asCreatureObject()->sendSystemMessage(" checkLineOfSight called ");
	}
	...
	if (object1->isCreatureObject()) {
		object1->asCreatureObject()->sendSystemMessage(" point 1 ");
	}
	...
	if (object1->isCreatureObject()) {
		object1->asCreatureObject()->sendSystemMessage(" point 2 ");
	}
