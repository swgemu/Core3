...
void DirectorManager::initializeLuaEngine(Lua* luaEngine) {
	...
	luaEngine->registerFunction("disableTutorial", disableTutorial);
...
int DirectorManager::disableTutorial(lua_State* L) {
	bool result = ConfigManager::instance()->disableTutorial();
