...
bool APIRequest::hasPathField(const String& fieldName) {
...
bool APIRequest::parseQueryFields(bool failOnError) {
	if (mParsedQueryFields)
		return true;
...
bool APIRequest::hasQueryField(const String& fieldName) {
	if (!mParsedQueryFields) {
		parseQueryFields(false);
	}
...
bool APIRequest::hasRequestField(const String& fieldName) {
