...
public:
	...
	static Reference<MeshData*> getFloorMesh(ManagedReference<SceneObject*> parent, Vector3& position, float meshSize, float chunkSize, float distanceBetweenHeights);
