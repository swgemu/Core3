...
object_draft_schematic_food_drink_elshandruu_pica_thundercloud = object_draft_schematic_food_shared_drink_elshandruu_pica_thundercloud:new {
   ...
   experimentalProperties = {"XX", "XX", "XX", "XX", "DR", "OQ", "FL", "OQ", "DR", "OQ", "DR", "OQ", "XX"},
   ...
   tanoCRC = 3328378890, -- Script: 'object/tangible/food/crafted/drink_elshandruu_pica_thundercloud.iff'
}
