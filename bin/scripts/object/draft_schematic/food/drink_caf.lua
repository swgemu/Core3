...
object_draft_schematic_food_drink_caf = object_draft_schematic_food_shared_drink_caf:new {
   ...
   experimentalGroupTitles = {"null", "null", "null", "null", "exp_nutrition", "exp_nutrition", "exp_quantity", "exp_filling", "null"},
   ...
   tanoCRC = 1543376981, -- Script: 'object/tangible/food/crafted/drink_caf.iff'
}
