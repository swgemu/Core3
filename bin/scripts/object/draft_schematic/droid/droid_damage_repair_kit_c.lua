...
object_draft_schematic_droid_droid_damage_repair_kit_c = object_draft_schematic_droid_shared_droid_damage_repair_kit_c:new {
   ...
   groupName = "craftDroidDamageRepairC", -- Group schematic is awarded in (See skills table)
   ...
   experimentalMin = {0, 0, 450, 12, 1000},
   experimentalMax = {0, 0, 1500, 24, 1000},
   experimentalPrecision = {0, 0, 0, 0, 0},

   tanoCRC = 3700861172, -- Script: 'object/tangible/medicine/pet/droid_damage_kit_c.iff'
}
