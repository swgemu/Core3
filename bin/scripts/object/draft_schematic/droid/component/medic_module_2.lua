...
object_draft_schematic_droid_component_medic_module_2 = object_draft_schematic_droid_component_shared_medic_module_2:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Level 2 Droid Medical Module",
   ...
   tanoCRC = 1449724487, -- Script: 'object/tangible/component/droid/medic_module_2.iff'
}
ObjectTemplates:addTemplate(object_draft_schematic_droid_component_medic_module_2, "object/draft_schematic/droid/component/medic_module_2.iff")
