...
object_draft_schematic_droid_component_struct_maint_module_2 = object_draft_schematic_droid_component_shared_struct_maint_module_2:new {
   ...
   tanoCRC = 3520889576, -- Script: 'object/tangible/component/droid/struct_maint_module_2.iff'
}
ObjectTemplates:addTemplate(object_draft_schematic_droid_component_struct_maint_module_2, "object/draft_schematic/droid/component/struct_maint_module_2.iff")
