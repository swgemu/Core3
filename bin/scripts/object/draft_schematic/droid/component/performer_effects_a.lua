...
object_draft_schematic_droid_component_performer_effects_a = object_draft_schematic_droid_component_shared_performer_effects_a:new {
   ...
   tanoCRC = 17780609, -- Script: 'object/tangible/component/droid/performer_effects_a.iff'
}
ObjectTemplates:addTemplate(object_draft_schematic_droid_component_performer_effects_a, "object/draft_schematic/droid/component/performer_effects_a.iff")
