...
object_draft_schematic_chemistry_medpack_disease_constitution_b = object_draft_schematic_chemistry_shared_medpack_disease_constitution_b:new {
   ...
   resourceQuantities = {6, 15, 20, 1, 1, 1},
   ...
   experimentalMin = {0, 0, 10, 10, 15, 30, 25, 120, 1000},
   experimentalMax = {0, 0, 40, 25, 30, 50, 100, 800, 1000},
   experimentalPrecision = {0, 0, 0, 0, 0, 0, 0, 0, 0},

   tanoCRC = 1164046340, -- Script: 'object/tangible/medicine/crafted/medpack_disease_constitution_b.iff'
}
