...
object_draft_schematic_chemistry_medpack_disease_constitution_a = object_draft_schematic_chemistry_shared_medpack_disease_constitution_a:new {
   ...
   experimentalMin = {0, 0, 10, 5, 15, 15, 25, 120, 1000},
   experimentalMax = {0, 0, 25, 15, 20, 30, 50, 600, 1000},
   experimentalPrecision = {0, 0, 0, 0, 0, 0, 0, 0, 0},

   tanoCRC = 2658556051, -- Script: 'object/tangible/medicine/crafted/medpack_disease_constitution_a.iff'
}
