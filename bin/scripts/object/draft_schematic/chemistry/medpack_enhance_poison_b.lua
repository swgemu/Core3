...
object_draft_schematic_chemistry_medpack_enhance_poison_b = object_draft_schematic_chemistry_shared_medpack_enhance_poison_b:new {
   ...
   resourceTypes = {"creature_resources", "flora_resources", "petrochem_inert", "ore_carbonate_low_grade", "object/tangible/component/chemistry/shared_solid_delivery_shell.iff", "object/tangible/component/chemistry/shared_release_mechanism_duration.iff", "object/tangible/component/chemistry/shared_biologic_effect_controller.iff"},
   resourceQuantities = {10, 10, 10, 10, 1, 1, 1},
   ...
   tanoCRC = 2749613834, -- Script: 'object/tangible/medicine/crafted/medpack_enhance_poison_b.iff'
}
