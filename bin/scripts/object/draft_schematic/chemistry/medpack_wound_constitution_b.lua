...
object_draft_schematic_chemistry_medpack_wound_constitution_b = object_draft_schematic_chemistry_shared_medpack_wound_constitution_b:new {
   ...
   groupName = "craftMedpackBGroupB", -- Group schematic is awarded in (See skills table)
   ...
   tanoCRC = 1998553547, -- Script: 'object/tangible/medicine/crafted/medpack_wound_constitution_b.iff'
}
