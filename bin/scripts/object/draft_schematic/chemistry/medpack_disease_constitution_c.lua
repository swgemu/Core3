...
object_draft_schematic_chemistry_medpack_disease_constitution_c = object_draft_schematic_chemistry_shared_medpack_disease_constitution_c:new {
   ...
   resourceQuantities = {8, 15, 25, 1, 1, 1},
   ...
   experimentalMin = {0, 0, 10, 15, 15, 40, 25, 120, 1000},
   experimentalMax = {0, 0, 60, 35, 30, 80, 150, 1000, 1000},
   experimentalPrecision = {0, 0, 0, 0, 0, 0, 0, 0, 0},

   tanoCRC = 208443273, -- Script: 'object/tangible/medicine/crafted/medpack_disease_constitution_c.iff'
}
