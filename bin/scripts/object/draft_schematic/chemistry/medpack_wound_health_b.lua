...
object_draft_schematic_chemistry_medpack_wound_health_b = object_draft_schematic_chemistry_shared_medpack_wound_health_b:new {
   ...
   groupName = "craftMedpackGroupB", -- Group schematic is awarded in (See skills table)
   ...
   tanoCRC = 571239539, -- Script: 'object/tangible/medicine/crafted/medpack_wound_health_b.iff'
}
