...
object_building_naboo_bank_naboo = object_building_naboo_shared_bank_naboo:new {
	childObjects = {
...
ObjectTemplates:addTemplate(object_building_naboo_bank_naboo, "object/building/naboo/bank_naboo.iff")
