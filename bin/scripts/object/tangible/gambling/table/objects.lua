...
object_tangible_gambling_table_shared_table_base = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@item_n:gambling_table",
	...
	objectName = "@item_n:gambling_table",
...
ObjectTemplates:addTemplate(object_tangible_gambling_table_shared_table_base, "object/tangible/gambling/table/shared_table_base.iff")
