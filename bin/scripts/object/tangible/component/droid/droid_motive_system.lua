...
object_tangible_component_droid_droid_motive_system = object_tangible_component_droid_shared_droid_motive_system:new {
...
ObjectTemplates:addTemplate(object_tangible_component_droid_droid_motive_system, "object/tangible/component/droid/droid_motive_system.iff")
