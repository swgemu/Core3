...
object_tangible_medicine_crafted_medpack_disease_constitution_a = object_tangible_medicine_crafted_shared_medpack_disease_constitution_a:new {
	gameObjectType = 8240,
	...
	experimentalMin = {0, 0, 10, 5, 15, 30, 25, 120, 1000},
	experimentalMax = {0, 0, 25, 15, 20, 15, 50, 600, 1000},
	experimentalPrecision = {0, 0, 0, 0, 0, 0, 0, 0, 0},
}

ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_disease_constitution_a, "object/tangible/medicine/crafted/medpack_disease_constitution_a.iff")
