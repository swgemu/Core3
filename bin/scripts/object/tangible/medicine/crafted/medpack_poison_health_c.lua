...
object_tangible_medicine_crafted_medpack_poison_health_c = object_tangible_medicine_crafted_shared_medpack_poison_health_c:new {
	gameObjectType = 8240,
	...
	experimentalMin = {0, 0, 10, 15, 15, 70, 25, 30, 1000},
	experimentalMax = {0, 0, 300, 35, 30, 30, 150, 240, 1000},
	experimentalPrecision = {0, 0, 0, 0, 0, 0, 0, 0, 0},
}

ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_poison_health_c, "object/tangible/medicine/crafted/medpack_poison_health_c.iff")
