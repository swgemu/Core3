...
ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_poison_area_mind_a, "object/tangible/medicine/crafted/medpack_poison_area_mind_a.iff")
