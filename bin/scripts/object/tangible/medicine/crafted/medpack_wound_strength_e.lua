...
object_tangible_medicine_crafted_medpack_wound_strength_e = object_tangible_medicine_crafted_shared_medpack_wound_strength_e:new {
	gameObjectType = 8241,
...
ObjectTemplates:addTemplate(object_tangible_medicine_crafted_medpack_wound_strength_e, "object/tangible/medicine/crafted/medpack_wound_strength_e.iff")
