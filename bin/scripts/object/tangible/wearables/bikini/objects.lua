...
object_tangible_wearables_bikini_shared_bikini_leggings_s01 = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:bikini_s01",

	gameObjectType = 16777228,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:bikini_s01_leggings",

	noBuildRadius = 0,

	objectName = "@wearables_name:bikini_s01_leggings",
...
object_tangible_wearables_bikini_shared_bikini_s01 = SharedTangibleObjectTemplate:new {
	...
	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:bikini_s01",

	noBuildRadius = 0,

	objectName = "@wearables_name:bikini_s01",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_bikini_shared_bikini_s02 = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:bikini_s02",

	gameObjectType = 16777230,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:bikini_s02",

	noBuildRadius = 0,

	objectName = "@wearables_name:bikini_s02",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_bikini_shared_bikini_s03 = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:bikini_s03",

	gameObjectType = 16777230,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:bikini_s03",

	noBuildRadius = 0,

	objectName = "@wearables_name:bikini_s03",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_bikini_shared_bikini_s04 = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:bikini_s04",

	gameObjectType = 16777230,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:bikini_s04",

	noBuildRadius = 0,

	objectName = "@wearables_name:bikini_s04",
	onlyVisibleInTools = 0,
