...
object_tangible_wearables_armor_singing_mountain_clan_shared_armor_smc_s01_bicep_r = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:armor_singing_mountain_clan_s01_bicep_r",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_singing_mountain_clan_s01_bicep_r",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_singing_mountain_clan_s01_bicep_r",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_singing_mountain_clan_shared_armor_smc_s01_bracer_l = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:armor_singing_mountain_clan_s01_bracer_l",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_singing_mountain_clan_s01_bracer_l",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_singing_mountain_clan_s01_bracer_l",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_singing_mountain_clan_shared_armor_smc_s01_bracer_r = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@wearables_detail:armor_singing_mountain_clan_s01_bracer_r",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_singing_mountain_clan_s01_bracer_r",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_singing_mountain_clan_s01_bracer_r",
	onlyVisibleInTools = 0,
