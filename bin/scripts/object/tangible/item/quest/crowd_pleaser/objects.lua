...
object_tangible_item_quest_crowd_pleaser_shared_dance_reward = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@quest_item_d:crowd_pleaser_dance_reward",
	...
	objectName = "@quest_item_n:crowd_pleaser_dance_reward",
...
object_tangible_item_quest_crowd_pleaser_shared_music_reward = SharedTangibleObjectTemplate:new {
	...
	detailedDescription = "@quest_item_d:crowd_pleaser_music_reward",
	...
	objectName = "@quest_item_n:crowd_pleaser_music_reward",
	onlyVisibleInTools = 0,
