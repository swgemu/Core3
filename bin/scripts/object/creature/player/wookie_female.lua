object_creature_player_wookiee_female = SharedCreatureObjectTemplate:new {
	acceleration = {36,12},
...
ObjectTemplates:addTemplate(object_creature_player_wookiee_female, "object/creature/player/wookie_female.iff")