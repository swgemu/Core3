...
exoproteinWafers = Object:new {
   ...
   tanoAttributes = "objecttype=8202:objectcrc=2915488362:stfFile=food_name:stfName=exo_protein_wafers:stfDetail=food_detail:itemmask=65535:customattributes=effectType=3;buffName=food.mitigate_damage;modifierString=mitigate_damage;fillingMin=5;fillingMax=4;flavorMin=10;flavorMax=25;nutritionMin=10;nutritionMax=18;quantityMin=6;quantityMax=10;:",
