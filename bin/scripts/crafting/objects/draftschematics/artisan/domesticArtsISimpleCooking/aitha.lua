...
aitha = Object:new {
   ...
   tanoAttributes = "objecttype=8216:objectcrc=2316612245:stfFile=food_name:stfName=aitha:stfDetail=food_detail:itemmask=65535:customattributes=effectType=6;modifierString=mind;fillingMin=18;fillingMax=11;flavorMin=0;flavorMax=0;nutritionMin=110;nutritionMax=180;quantityMin=4;quantityMax=7;:",
