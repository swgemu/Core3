...
blobCandy = Object:new {
   ...
   tanoAttributes = "objecttype=8202:objectcrc=254187661:stfFile=food_name:stfName=blob_candy:stfDetail=food_detail:itemmask=65535:customattributes=effectType=1;buffName=food.dessert_blob_candy;modifierString=action;fillingMin=11;fillingMax=7;flavorMin=1800;flavorMax=5400;nutritionMin=35;nutritionMax=60;quantityMin=6;quantityMax=10;:",
