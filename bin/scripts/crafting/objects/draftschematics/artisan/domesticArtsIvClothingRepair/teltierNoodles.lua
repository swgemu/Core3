...
teltierNoodles = Object:new {
   ...
   tanoAttributes = "objecttype=8202:objectcrc=601858027:stfFile=food_name:stfName=teltier_noodles:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(teltierNoodles, 3118947489)--- Add to global DraftSchematics table
