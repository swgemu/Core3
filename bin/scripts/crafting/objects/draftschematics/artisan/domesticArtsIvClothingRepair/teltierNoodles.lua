...
teltierNoodles = Object:new {
   ...
   tanoAttributes = "objecttype=8202:objectcrc=601858027:stfFile=food_name:stfName=teltier_noodles:stfDetail=food_detail:itemmask=65535:customattributes=effectType=1;buffName=food.dish_teltier_noodles;modifierString=stamina;fillingMin=17;fillingMax=10;flavorMin=1800;flavorMax=3600;nutritionMin=35;nutritionMax=60;quantityMin=6;quantityMax=10;:",
