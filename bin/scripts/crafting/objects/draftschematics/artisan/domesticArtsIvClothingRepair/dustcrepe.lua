...
dustcrepe = Object:new {
   ...
   tanoAttributes = "objecttype=8202:objectcrc=3723091380:stfFile=food_name:stfName=dustcrepe:stfDetail=food_detail:itemmask=65535:customattributes=effectType=0;modifierString=slow_dot;fillingMin=29;fillingMax=20;flavorMin=0;flavorMax=0;nutritionMin=11;nutritionMax=18;quantityMin=3;quantityMax=4;:",
