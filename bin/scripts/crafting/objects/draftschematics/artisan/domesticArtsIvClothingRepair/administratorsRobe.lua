...
administratorsRobe = Object:new {

   objectName = "Administrator's Robe",
   stfName = "dress_s18",
   ...
   tanoAttributes = "objecttype=:objectcrc=1589004391:objecttemp=:templatetype=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(administratorsRobe, 504039234)--- Add to global DraftSchematics table
