...
labourJacket = Object:new {

   objectName = "Labour Jacket",
   stfName = "jacket_s15",
   objectCRC = 1193971933,
...
DraftSchematics:addDraftSchematic(labourJacket, 1193971933)--- Add to global DraftSchematics table
