...
jaar = Object:new {
   ...
   tanoAttributes = "objecttype=8216:objectcrc=355298575:stfFile=food_name:stfName=jaar:stfDetail=food_detail:itemmask=65535:customattributes=effectType=1;buffIcon=0;buffType=0;modifierString=wookiee_roar;fillingMin=11;fillingMax=7;flavorMin=0;flavorMax=0;nutritionMin=20;nutritionMax=30;quantityMin=5;quantityMax=10;speciesRestriction=4;:",
