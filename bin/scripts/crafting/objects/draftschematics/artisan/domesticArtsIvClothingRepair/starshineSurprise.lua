...
starshineSurprise = Object:new {
   ...
   tanoAttributes = "objecttype=8216:objectcrc=789489529:stfFile=food_name:stfName=starshine_surprise:stfDetail=food_detail:itemmask=65535:customattributes=effectType=3;buffName=food.incap_recovery;modifierString=incap_recovery;fillingMin=36;fillingMax=21;flavorMin=1;flavorMax=1;nutritionMin=21;nutritionMax=36;quantityMin=1;quantityMax=6;:",
