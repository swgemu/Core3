...
largeGlass = Object:new {
   ...
   tanoAttributes = "objecttype=8224:objectcrc=1157356093:stfFile=craft_food_ingredients_n:stfName=large_glass:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(largeGlass, 3740654207)--- Add to global DraftSchematics table
