...
jawaBeer = Object:new {
   ...
   tanoAttributes = "objecttype=8216:objectcrc=3314105882:stfFile=food_name:stfName=jawa_beer:stfDetail=food_detail:itemmask=65535:customattributes=effectType=4;buffName=food.drink_jawa_beer;modifierString=mask_scent;fillingMin=24;fillingMax=14;flavorMin=720;flavorMax=1440;nutritionMin=7.5;nutritionMax=12;quantityMin=4;quantityMax=9;:",
