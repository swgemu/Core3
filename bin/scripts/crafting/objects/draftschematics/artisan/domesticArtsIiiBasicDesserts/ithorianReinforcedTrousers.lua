...
ithorianReinforcedTrousers = Object:new {

   objectName = "Ithorian Reinforced Trousers",
   stfFile = "wearables_name",
   stfDetail = "",
   stfName = "ith_pants_s04",
   objectCRC = 814575802,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=715629952:stfFile=wearables_name:stfName=ith_pants_s04:stfDetail=:itemmask=63491:customattributes=:",
...
DraftSchematics:addDraftSchematic(ithorianReinforcedTrousers, 814575802)--- Add to global DraftSchematics table
