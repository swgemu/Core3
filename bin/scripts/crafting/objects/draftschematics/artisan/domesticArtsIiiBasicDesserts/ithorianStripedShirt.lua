...
ithorianStripedShirt = Object:new {
   ...
   tanoAttributes = "objecttype=16777234:objectcrc=3367515818:stfFile=wearables_name:stfName=ith_shirt_s07:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianStripedShirt, 4107021896)--- Add to global DraftSchematics table
