...
rubyBliel = Object:new {
   ...
   tanoAttributes = "objecttype=:objectcrc=4051771038:stfFile=food_name:stfName=ruby_bliel:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(rubyBliel, 1465295596)--- Add to global DraftSchematics table
