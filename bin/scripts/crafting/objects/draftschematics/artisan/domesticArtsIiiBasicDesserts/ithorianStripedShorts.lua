...
ithorianStripedShorts = Object:new {

   objectName = "Ithorian Striped Shorts",
   stfName = "ith_pants_s17",
   stfFile = "wearables_name",
   objectCRC = 4105183717,
   ...
   tanoAttributes = "objecttype=:objectcrc=3935830127:stfFile=wearables_name:stfName=ith_pants_s17:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianStripedShorts, 4105183717)--- Add to global DraftSchematics table
