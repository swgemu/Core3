...
fishingPole = Object:new {

   objectName = "Fishing Pole",
   stfFile = "item_n",
   stfDetail = "item_d",
   stfName = "fishing_pole",
   objectCRC = 4197036370,
...
DraftSchematics:addDraftSchematic(fishingPole, 4197036370)--- Add to global DraftSchematics table
