...
armorRepairTool = Object:new {

   objectName = "Armor Repair Tool",
   stfName = "armor_repair_name",
   objectCRC = 1371712760,
...
DraftSchematics:addDraftSchematic(armorRepairTool, 1371712760)--- Add to global DraftSchematics table
