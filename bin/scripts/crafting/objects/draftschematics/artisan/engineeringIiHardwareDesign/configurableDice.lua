...
configurableDice = Object:new {
   ...
   tanoAttributes = "objecttype=8211:objectcrc=1212860070:stfFile=dice/dice_details:stfName=eqp_configurable_group_dice_single:stfDetail=:itemmask=65535:customattributes=:",
