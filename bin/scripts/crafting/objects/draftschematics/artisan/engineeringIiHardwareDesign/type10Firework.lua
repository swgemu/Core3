...
type10Firework = Object:new {

   objectName = "Type 10 Firework",
   stfName = "firework_s10",
   stfFile = "firework_n",
   objectCRC = 1345222985,
...
DraftSchematics:addDraftSchematic(type10Firework, 1345222985)--- Add to global DraftSchematics table
