...
boneArmorGloves = Object:new {
   ...
   tanoAttributes = "objecttype=262:objectcrc=4034830199:stfFile=wearables_name:stfName=armor_bone_s01_gloves:stfDetail=wearables_detail:itemmask=62975:customattributes=specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness,coldeffectiveness;armorPiece=257;armorStyle=4129;:",

   blueFrogAttributes = "specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness,coldeffectiveness;armorPiece=257;armorStyle=4129;",
   blueFrogEnabled = 1,
