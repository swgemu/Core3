...
boneArmorSegment = Object:new {
   ...
   tanoAttributes = "objecttype=262145:objectcrc=1150752581:stfFile=craft_armor_ingredients_n:stfName=armor_segment_bone:stfDetail=:itemmask=65535:customattributes=specialprotection=energyeffectiveness;:",
...
DraftSchematics:addDraftSchematic(boneArmorSegment, 1007340042)--- Add to global DraftSchematics table
