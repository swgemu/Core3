...
fireworksShowPackage = Object:new {
   ...
   tanoAttributes = "objecttype=8220:objectcrc=4211144857:stfFile=firework_n:stfName=show:stfDetail=firework_d:itemmask=65535:customattributes=:",
...
DraftSchematics:addDraftSchematic(fireworksShowPackage, 2196218270)--- Add to global DraftSchematics table
