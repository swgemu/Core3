...
boneArmorRightBicep = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=210147855:stfFile=wearables_name:stfName=armor_bone_s01_bicep_r:stfDetail=wearables_detail:itemmask=62975:customattributes=specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness,coldeffectiveness;armorPiece=261;armorStyle=4129;:",

   blueFrogAttributes = "specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness,coldeffectiveness;armorPiece=261;armorStyle=4129;",
   blueFrogEnabled = 1,
