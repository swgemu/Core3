...
deedForPersonalMineralExtractor = Object:new {
   ...
   tanoAttributes = "objecttype=8388610:objectcrc=2126009375:stfFile=deed_detail:stfName=ore_s1_harvester_deed_name:stfDetail=deed_detail:itemmask=65535:customattributes=targetObjectTypeSub=HARVESTER;targetStfFile=installation_n;targetStfName=small_ore_mine;targetObjectFile=object/installation/mining_ore/shared_mining_ore_harvester_style_1.iff;targetConstructionObjectCRC=2242761962;maintenanceRate=30.0;powerRate=25.0;harvesterType=RESOURCETYPE_MINERAL;lotSize=1;:",
