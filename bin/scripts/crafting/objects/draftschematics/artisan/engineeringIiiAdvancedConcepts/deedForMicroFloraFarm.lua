...
deedForMicroFloraFarm = Object:new {
   ...
   tanoAttributes = "objecttype=8388610:objectcrc=2840949012:stfFile=deed_detail:stfName=flora_harvester_deed_name:stfDetail=deed_detail:itemmask=65535:customattributes=targetObjectSubType=HARVESTER;targetStfFile=installation_n;targetStfName=flora_farm_small;targetObjectFile=object/installation/mining_organic/shared_mining_organic_flora_farm.iff;targetConstructionObjectCRC=2242761962;maintenanceRate=30.0;powerRate=25.0;harvesterType=RESOURCETYPE_FLORA;lotSize=1;:",
