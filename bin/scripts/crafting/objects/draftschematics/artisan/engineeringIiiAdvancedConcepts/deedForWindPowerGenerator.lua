...
deedForWindPowerGenerator = Object:new {
   ...
   tanoAttributes = "objecttype=8388610:objectcrc=3871805863:stfFile=deed_detail:stfName=wind_generator_deed_name:stfDetail=deed_detail:itemmask=65535:customattributes=targetObjectSubType=GENERATOR;targetStfFile=installation_n;targetStfName=wind_generator;targetObjectFile=object/installation/generators/shared_power_generator_wind_style_1.iff;targetConstructionObjectCRC=2242761962;maintenanceRate=60.0;harvestType=RESOURCE_WIND;lotSize=1;:",
