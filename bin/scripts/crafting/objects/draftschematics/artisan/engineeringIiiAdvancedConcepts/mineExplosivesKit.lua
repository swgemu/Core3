...
mineExplosivesKit = Object:new {

   objectName = "Mine Explosives Kit",
   stfName = "weapon_mine_explosive",
   stfFile = "powerup_n",
   objectCRC = 797092971,
...
DraftSchematics:addDraftSchematic(mineExplosivesKit, 797092971)--- Add to global DraftSchematics table
