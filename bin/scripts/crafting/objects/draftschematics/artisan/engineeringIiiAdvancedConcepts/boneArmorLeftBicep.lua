...
boneArmorLeftBicep = Object:new {

   objectName = "Bone Armor Left Bicep",
   stfName = "armor_bone_s01_bicep_l",
   stfFile = "wearables_name",
   objectCRC = 1272321681,
...
DraftSchematics:addDraftSchematic(boneArmorLeftBicep, 1272321681)--- Add to global DraftSchematics table
