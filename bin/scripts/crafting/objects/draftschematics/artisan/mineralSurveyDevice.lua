...
mineralSurveyDevice = Object:new {
  objectName = "Mineral Survey Device", -- name of the lua Object
  
  stfName = "",
  
  name = "Mineral Survey Device",
  ...
  tanoAttributes = "objecttype=32770:objectcrc=2862265132:objecttemp=survey_tool_mineral:",
