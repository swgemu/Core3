...
weaponDroidAndGeneralItemCraftingTool = Object:new {
...
DraftSchematics:addDraftSchematic(weaponDroidAndGeneralItemCraftingTool, 806231782)--- Add to global DraftSchematics table
