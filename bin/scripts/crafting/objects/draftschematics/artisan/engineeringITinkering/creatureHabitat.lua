...
creatureHabitat = Object:new {

   objectName = "Creature Habitat",
   stfName = "bug_habitat",
   objectCRC = 3662038442,
...
DraftSchematics:addDraftSchematic(creatureHabitat, 3662038442)--- Add to global DraftSchematics table
