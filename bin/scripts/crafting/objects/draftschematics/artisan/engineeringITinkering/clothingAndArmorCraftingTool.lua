...
clothingAndArmorCraftingTool = Object:new {
   ...
   tanoAttributes = "objecttype=32769:objectcrc=753735496:stfFile=crafting:stfName=clothing_tool_name:stfDetail=crafting_detail:itemmask=65535:customattributes=effectiveness=-15;type=1;craftingTabs=2,8,16384,32768;status=tool_status_ready;:",

   blueFrogAttributes = "effectiveness=0:type=1:craftingTabs=2,8,16384,32768:status=tool_status_ready:;",
   blueFrogEnabled = 1,
