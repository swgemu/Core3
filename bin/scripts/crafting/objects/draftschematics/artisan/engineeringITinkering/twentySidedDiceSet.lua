...
twentySidedDiceSet = Object:new {

   objectName = "Twenty Sided Dice Set",
   stfName = "eqp_twenty_sided_dice_set_single",
   objectCRC = 1156487020,
...
DraftSchematics:addDraftSchematic(twentySidedDiceSet, 1156487020)--- Add to global DraftSchematics table
