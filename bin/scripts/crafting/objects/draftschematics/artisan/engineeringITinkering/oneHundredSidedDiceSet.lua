...
oneHundredSidedDiceSet = Object:new {
   ...
   tanoAttributes = "objecttype=8211:objectcrc=2182985448:stfFile=dice/dice_details:stfName=eqp_one_hundred_sided_dice_set_single:stfDetail=:itemmask=65535:customattributes=:",
