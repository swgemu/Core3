...
controlUnit = Object:new {
   ...
   tanoAttributes = "objecttype=262149:objectcrc=814846904:stfFile=craft_item_ingredients_n:stfName=electronic_control_unit:stfDetail=craft_item_ingredients_d:itemmask=65535:customattributes=:",
...
DraftSchematics:addDraftSchematic(controlUnit, 989624055)--- Add to global DraftSchematics table
