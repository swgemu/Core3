...
powerConditioner = Object:new {

   objectName = "Power Conditioner",
   stfName = "electronic_power_conditioner",
   stfFile = "craft_item_ingredients_n",
   objectCRC = 3615264224,
   ...
   tanoAttributes = "objecttype=262150:objectcrc=1024745663:stfFile=craft_food_ingredients_n:stfName=power_conditioner:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(powerConditioner, 3615264224)--- Add to global DraftSchematics table
