...
electronicsMemoryModule = Object:new {
   ...
   tanoAttributes = "objecttype=8200:objectcrc=3552886678:stfFile=craft_item_ingredients_n:stfName=electronics_memory_module:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(electronicsMemoryModule, 2170102415)--- Add to global DraftSchematics table
