...
boneArmorChestPlate = Object:new {
   ...
   tanoAttributes = "objecttype=257:objectcrc=3552584942:stfFile=wearables_name:stfName=armor_bone_s01_chest_plate:stfDetail=wearables_detail:itemmask=62975:customattributes=specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4129;:",

   blueFrogAttributes = "specialProtection=energyeffectiveness;vunerability=kineticeffectiveness,blasteffectiveness,stuneffectiveness,heateffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4129;",
   blueFrogEnabled = 1,
