...
deedForPersonalChemicalExtractor = Object:new {
   ...
   tanoAttributes = "objecttype=8388610:objectcrc=3335458434:stfFile=deed:stfName=liquid_harvester_deed_name:stfDetail=deed_detail:itemmask=65535:customattributes=targetObjectTypeSub=HARVESTER;targetStfFile=installation_n;targetStfName=liquid_mine;targetObjectFile=object/installation/mining_liquid/shared_mining_liquid_harvester_style_1.iff;targetConstructionObjectCRC=2242761962;maintenanceRate=30.0;powerRate=25.0;harvesterType=RESOURCETYPE_CHEMICAL;lotSize=1;:",
