...
deedForPersonalNaturalGasProcessor = Object:new {
   ...
   tanoAttributes = "objecttype=8388610:objectcrc=2231503385:stfFile=deed_detail:stfName=gas_harvester_deed_name:stfDetail=deed_detail:itemmask=65535:customattributes=targetObjectSubType=HARVESTER;targetStfFile=installation_n;targetStfName=gas_mine_small;targetObjectFile=object/installation/mining_gas/shared_mining_gas_harvester_style_1.iff;targetConstructionObjectCRC=2242761962;maintenanceRate=30.0;powerRate=25.0;harvesterType=RESOURCETYPE_GAS;lotSize=1;:",
