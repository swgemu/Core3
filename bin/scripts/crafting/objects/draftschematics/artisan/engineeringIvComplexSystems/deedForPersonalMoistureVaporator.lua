...
deedForPersonalMoistureVaporator = Object:new {
   ...
   tanoAttributes = "objecttype=8388610:objectcrc=1578846375:stfFile=deed_detail:stfName=moisture_harvester_deed_name:stfDetail=deed_detail:itemmask=65535:customattributes=targetObjectSubType=HARVESTER;targetStfFile=installation_n;targetStfName=moisture_mine;targetObjectFile=object/installation/mining_liquid/shared_mining_liquid_moisture_harvester.iff;targetConstructionObjectCRC=2242761962;maintenanceRate=30.0;powerRate=25.0;harvesterType=RESOURCETYPE_WATER;lotSize=1;:",
