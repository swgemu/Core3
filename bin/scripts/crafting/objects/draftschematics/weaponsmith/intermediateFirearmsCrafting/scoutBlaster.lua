...
scoutBlaster = Object:new {
   ...
   tanoAttributes = "objecttype=131082:objectcrc=3883785442:stfFile=weapon_name:stfName=pistol_scout_blaster:stfDetail=weapon_detail:itemmask=65535:customattributes=damagetype=2;armorpiercing=0;cert=cert_pistol_scout_blaster;:",
