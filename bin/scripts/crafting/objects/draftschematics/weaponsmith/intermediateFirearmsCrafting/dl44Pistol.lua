...
dl44Pistol = Object:new {
   ...
   tanoAttributes = "objecttype=131082:objectcrc=2829612927:objecttemp=pistol_dl44:templatetype=weapon_name:itemmask=65535:customattributes=damagetype=2;:",
...
DraftSchematics:addDraftSchematic(dl44Pistol, 408961925)--- Add to global DraftSchematics table
