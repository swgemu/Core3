...
dh17ShortCarbine = Object:new {

   objectName = "DH17 Short Carbine",
   stfName = "carbine_dh17_snubnose",
   stfFile = "weapon_name",
   objectCRC = 2025642760,
...
DraftSchematics:addDraftSchematic(dh17ShortCarbine, 2025642760)--- Add to global DraftSchematics table
