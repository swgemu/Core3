...
tanglePistol = Object:new {
   ...
   tanoAttributes = "objecttype=131082:objectcrc=2758629867:stfFile=weapon_name:stfName=pistol_tangle:stfDetail=weapon_detail:itemmask=65535:customattributes=damagetype=4;armorpiercing=0;cert=cert_pistol_tangle;:",

   blueFrogAttributes = "damagetype=4:armorpiercing;",
   blueFrogEnabled = 1,
