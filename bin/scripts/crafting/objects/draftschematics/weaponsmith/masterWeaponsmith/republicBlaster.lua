...
republicBlaster = Object:new {
   ...
   tanoAttributes = "objecttype=131082:objectcrc=258355020:stfFile=weapon_name:stfName=pistol_republic_blaster:stfDetail=weapon_detail:itemmask=65535:customattributes=damagetype=2;armorpiercing=1;cert=cert_pistol_republic_blaster;:",

   blueFrogAttributes = "damagetype=2:armorpiercing;",
   blueFrogEnabled = 1,
