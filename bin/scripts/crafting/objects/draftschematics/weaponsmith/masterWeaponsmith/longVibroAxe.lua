...
longVibroAxe = Object:new {
   ...
   tanoAttributes = "objecttype=131081:objectcrc=1723256113:stfFile=weapon_name:stfName=lance_vibro_axe:stfDetail=weapon_detail:itemmask=65535:customattributes=damagetype=1;armorpiercing=2;cert=cert_lance_vibro_axe;:",

   blueFrogAttributes = "damagetype=1:armorpiercing;",
   blueFrogEnabled = 1,
