...
vibroLance = Object:new {
   ...
   tanoAttributes = "objecttype=131081:objectcrc=22784428:stfFile=weapon_name:stfName=lance_vibrolance:stfDetail=weapon_detail:itemmask=65535:customattributes=damagetype=3;armorpiercing=1;cert=cert_lance_vibrolance;:",

   blueFrogAttributes = "damagetype=3:armorpiercing;",
   blueFrogEnabled = 1,
