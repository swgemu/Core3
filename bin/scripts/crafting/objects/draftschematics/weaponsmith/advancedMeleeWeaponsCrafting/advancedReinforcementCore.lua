...
advancedReinforcementCore = Object:new {
   ...
   tanoAttributes = "objecttype=262153:objectcrc=276012891:stfFile=craft_weapon_ingredients_n:stfName=reinforcement_core_advanced:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(advancedReinforcementCore, 1668239813)--- Add to global DraftSchematics table
