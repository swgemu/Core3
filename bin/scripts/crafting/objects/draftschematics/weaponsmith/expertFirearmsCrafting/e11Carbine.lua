...
e11Carbine = Object:new {

   objectName = "E11 Carbine",
   stfName = "carbine_e11",
   stfFile = "weapon_name",
   objectCRC = 24679666,
   ...
   tanoAttributes = "objecttype=131083:objectcrc=3034123480:stfFile=weapon_name:stfName=carbine_e11:stfDetail=:itemmask=65535:customattributes=damagetype=2;:",
...
DraftSchematics:addDraftSchematic(e11Carbine, 24679666)--- Add to global DraftSchematics table
