...
power5Pistol = Object:new {
   ...
   experimentalMin = "0, 0, 18, 88, 4.7, 7, 10, 750, -12, -70, 10, -3, 18, 43, 17",
...
DraftSchematics:addDraftSchematic(power5Pistol, 4124760882)--- Add to global DraftSchematics table
