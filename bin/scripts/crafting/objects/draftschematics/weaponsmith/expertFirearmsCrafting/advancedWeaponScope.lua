...
advancedWeaponScope = Object:new {
   ...
   tanoAttributes = "objecttype=262155:objectcrc=210395856:stfFile=craft_weapon_ingredients_n:stfName=scope_weapon_advanced:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(advancedWeaponScope, 3611829706)--- Add to global DraftSchematics table
