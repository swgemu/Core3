...
ee3Carbine = Object:new {
   ...
   tanoAttributes = "objecttype=131083:objectcrc=749154215:stfFile=weapon_name:stfName=carbine_ee3:stfDetail=weapon_detail:itemmask=65535:customattributes=damagetype=6;armorpiercing=0;cert=cert_carbine_ee3;:",

   blueFrogAttributes = "damagetype=6;armorpiercing=0;",
   blueFrogEnabled = 1,
