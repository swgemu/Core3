...
laserCarbine = Object:new {
   ...
   resourceQuantities = {50, 30, 12, 1, 1, 1, 1},
   ...
   tanoAttributes = "objecttype=131083:objectcrc=2121432077:stfFile=weapon_name:stfName=carbine_laser:stfDetail=weapon_detail:itemmask=65535:customattributes=damagetype=2;armorpiercing=2;cert=cert_carbine_laser;:",
