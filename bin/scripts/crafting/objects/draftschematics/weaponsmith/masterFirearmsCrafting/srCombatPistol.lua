...
srCombatPistol = Object:new {
   ...
   resourceQuantities = {45, 20, 10, 1, 1, 1},
   ...
   tanoAttributes = "objecttype=131082:objectcrc=874294352:stfFile=weapon_name:stfName=pistol_srcombat:stfDetail=weapon_detail:itemmask=65535:customattributes=damagetype=2;armorpiercing=1;cert=cert_pistol_srcombat;:",
