...
ubeseArmorJacket = Object:new {
   ...
   tanoAttributes = "objecttype=257:objectcrc=3696152390:stfFile=wearables_name:stfName=armor_ubese_jacket:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4127;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4127;",
   blueFrogEnabled = 1,
