...
ubeseArmorBoots = Object:new {
   ...
   tanoAttributes = "objecttype=263:objectcrc=1207105731:stfFile=wearables_name:stfName=armor_ubese_boots:stfDetail=wearables_detail:itemmask=62967:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4127;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4127;",
   blueFrogEnabled = 1,
