...
advancedKashyyykianBlackMountainArmorSegment = Object:new {

   objectName = "Advanced Kashyyykian Black Mountain Armor Segment",
   stfName = "armor_segment_kashyyykian_black_mtn_advanced",
   ...
   tanoAttributes = "objecttype=262145:objectcrc=4080254682:stfFile=craft_clothing_ingredients_n:stfName=armor_segment_kashyyykian_black_mtn_advanced:stfDetail=:itemmask=65535:customattributes=specialprotection=kineticeffectiveness;:",
...
DraftSchematics:addDraftSchematic(advancedKashyyykianBlackMountainArmorSegment, 737525903)--- Add to global DraftSchematics table
