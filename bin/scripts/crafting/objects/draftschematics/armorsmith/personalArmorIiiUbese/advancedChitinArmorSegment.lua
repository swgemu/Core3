...
advancedChitinArmorSegment = Object:new {

   objectName = "Advanced Chitin Armor Segment",
   stfFile = "craft_clothing_ingredients_n",
   stfDetail = "",
   stfName = "armor_segment_chitin_advanced",
   objectCRC = 892546099,
   ...
   tanoAttributes = "objecttype=262145:objectcrc=2809337004:stfFile=craft_clothing_ingredients_n:stfName=armor_segment_chitin_advanced:stfDetail=craft_clothing_ingredients_d:itemmask=65535:customattributes=:",
...
DraftSchematics:addDraftSchematic(advancedChitinArmorSegment, 892546099)--- Add to global DraftSchematics table
