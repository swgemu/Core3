...
ubeseArmorGloves = Object:new {

   objectName = "Ubese Armor Gloves",
   stfName = "armor_ubese_gloves",
...
DraftSchematics:addDraftSchematic(ubeseArmorGloves, 211555644)--- Add to global DraftSchematics table
