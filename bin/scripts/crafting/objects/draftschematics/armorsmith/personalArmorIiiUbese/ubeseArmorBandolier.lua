...
ubeseArmorBandolier = Object:new {

   objectName = "Ubese Armor Bandolier",
   stfName = "armor_ubese_bandolier",
   stfFile = "wearables_name",
   objectCRC = 1802019036,
...
DraftSchematics:addDraftSchematic(ubeseArmorBandolier, 1802019036)--- Add to global DraftSchematics table
