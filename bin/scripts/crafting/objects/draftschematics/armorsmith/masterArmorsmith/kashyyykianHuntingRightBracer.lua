...
kashyyykianHuntingRightBracer = Object:new {

   objectName = "Kashyyykian Hunting Right Bracer",
   stfName = "armor_kashyyykian_hunting_bracer_r",
   stfFile = "wearables_name",
   objectCRC = 1421501766,
...
DraftSchematics:addDraftSchematic(kashyyykianHuntingRightBracer, 1421501766)--- Add to global DraftSchematics table
