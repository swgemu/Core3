...
compositeArmorPants = Object:new {

   objectName = "Composite Armor Pants",
   stfName = "armor_composite_pants",
   stfFile = "wearables_name",
   objectCRC = 1346665995,
...
DraftSchematics:addDraftSchematic(compositeArmorPants, 1346665995)--- Add to global DraftSchematics table
