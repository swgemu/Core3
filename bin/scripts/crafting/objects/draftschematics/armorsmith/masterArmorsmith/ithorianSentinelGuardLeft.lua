...
ithorianSentinelGuardLeft = Object:new {

   objectName = "Ithorian Sentinel Guard (Left)",
   stfName = "ith_armor_s03_bicep_l",
...
DraftSchematics:addDraftSchematic(ithorianSentinelGuardLeft, 365205610)--- Add to global DraftSchematics table
