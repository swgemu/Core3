...
kashyyykianHuntingLeggings = Object:new {

   objectName = "Kashyyykian Hunting Leggings",
   stfName = "armor_kashyyykian_hunting_leggings",
   stfFile = "wearables_name",
   objectCRC = 2873884106,
   ...
   tanoAttributes = "objecttype=260:objectcrc=4053289243:stfFile=wearables_name:stfName=armor_kashyyykian_hunting_leggings:stfDetail=:itemmask=61955:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness;armorPiece=262;armorStyle=4111;:",
...
DraftSchematics:addDraftSchematic(kashyyykianHuntingLeggings, 2873884106)--- Add to global DraftSchematics table
