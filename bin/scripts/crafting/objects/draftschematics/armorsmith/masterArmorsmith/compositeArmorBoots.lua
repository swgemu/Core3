...
compositeArmorBoots = Object:new {
   ...
   tanoAttributes = "objecttype=263:objectcrc=3683772891:stfFile=wearables_name:stfName=armor_composite_boots:stfDetail=wearables_detail:itemmask=62967:customattributes=specialprotection=electricaleffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4097;:",

   blueFrogAttributes = "specialprotection=electricaleffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4097;",
   blueFrogEnabled = 1,
