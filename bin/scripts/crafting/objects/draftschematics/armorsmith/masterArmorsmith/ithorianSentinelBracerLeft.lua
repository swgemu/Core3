...
ithorianSentinelBracerLeft = Object:new {

   objectName = "Ithorian Sentinel Bracer (Left)",
   stfName = "ith_armor_s03_bracer_l",
   ...
   tanoAttributes = "objecttype=261:objectcrc=2685476975:stfFile=wearables_name:stfName=ith_armor_s03_bracer_l:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness;armorPiece=258;armorStyle=4108;:",
...
DraftSchematics:addDraftSchematic(ithorianSentinelBracerLeft, 930361247)--- Add to global DraftSchematics table
