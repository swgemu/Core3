...
ithorianSentinelHelmet = Object:new {
   ...
   tanoAttributes = "objecttype=258:objectcrc=618689855:stfFile=wearables_name:stfName=ith_armor_s03_helmet:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=264;armorStyle=4108;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=264;armorStyle=4108;",
   blueFrogEnabled = 1,
