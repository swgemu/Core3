...
ithorianSentinelBoots = Object:new {

   objectName = "Ithorian Sentinel Boots",
   stfFile = "wearables_name",
   stfDetail = "",
   stfName = "ith_armor_s03_boots",
   objectCRC = 3805329247,
   ...
   tanoAttributes = "objecttype=263:objectcrc=3974465933:stfFile=wearables_name:stfName=ith_armor_s03_boots:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4108;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4108;",
   blueFrogEnabled = 1,
...
DraftSchematics:addDraftSchematic(ithorianSentinelBoots, 3805329247)--- Add to global DraftSchematics table
