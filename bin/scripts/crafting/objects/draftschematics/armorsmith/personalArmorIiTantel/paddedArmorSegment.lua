...
paddedArmorSegment = Object:new {

   objectName = "Padded Armor Segment",
   stfName = "armor_segment_padded",
   stfFile = "craft_clothing_ingredients_n",
   objectCRC = 1432695926,
   ...
   tanoAttributes = "objecttype=262144:objectcrc=1728449296:objecttemp=armor_segment_padded:templatetype=craft_armor_ingredients_n:itemmask=65535:customattributes=specialprotection=blasteffectiveness;:",
...
DraftSchematics:addDraftSchematic(paddedArmorSegment, 1432695926)--- Add to global DraftSchematics table
