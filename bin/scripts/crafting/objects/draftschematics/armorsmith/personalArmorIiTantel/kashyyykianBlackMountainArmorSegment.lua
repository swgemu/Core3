...
kashyyykianBlackMountainArmorSegment = Object:new {

   objectName = "Kashyyykian Black Mountain Armor Segment",
   stfFile = "craft_armor_ingredients_n",
   stfDetail = "craft_clothing_ingredients_d",
   stfName = "armor_segment_kashyyykian_black_mtn",
   objectCRC = 168895200,
   ...
   tanoAttributes = "objecttype=262145:objectcrc=923046063:stfFile=craft_armor_ingredients_n:stfName=armor_segment_kashyyykian_black_mtn:stfDetail=craft_clothing_ingredients_d:itemmask=65535:customattributes=:",
...
DraftSchematics:addDraftSchematic(kashyyykianBlackMountainArmorSegment, 168895200)--- Add to global DraftSchematics table
