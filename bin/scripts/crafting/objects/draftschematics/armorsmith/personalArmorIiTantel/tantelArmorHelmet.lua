...
tantelArmorHelmet = Object:new {

   objectName = "Tantel Armor Helmet",
   stfName = "armor_tantel_skreej_helmet",
   stfFile = "wearables_name",
   objectCRC = 2520970916,
...
DraftSchematics:addDraftSchematic(tantelArmorHelmet, 2520970916)--- Add to global DraftSchematics table
