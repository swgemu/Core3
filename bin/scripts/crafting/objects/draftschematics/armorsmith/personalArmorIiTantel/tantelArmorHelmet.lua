...
tantelArmorHelmet = Object:new {
   ...
   tanoAttributes = "objecttype=258:objectcrc=1458475008:stfFile=wearables_name:stfName=armor_tantel_skreej_helmet:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=energyeffectiveness;vunerability=restraineffectiveness;armorPiece=264;armorStyle=4127;:",

   blueFrogAttributes = "specialprotection=energyeffectiveness;vunerability=restraineffectiveness;armorPiece=264;armorStyle=4127;",
   blueFrogEnabled = 1,
