...
tantelArmorChestPlate = Object:new {
   ...
   tanoAttributes = "objecttype=257:objectcrc=290985679:stfFile=wearables_name:stfName=armor_tantel_skreej_chest_plate:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=energyeffectiveness;vunerability=restraineffectiveness;armorPiece=256;armorStyle=4127;:",

   blueFrogAttributes = "specialprotection=energyeffectiveness;vunerability=restraineffectiveness;armorPiece=256;armorStyle=4127;",
   blueFrogEnabled = 1,
