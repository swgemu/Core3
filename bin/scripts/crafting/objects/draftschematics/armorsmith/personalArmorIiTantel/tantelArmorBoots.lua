...
tantelArmorBoots = Object:new {
   ...
   tanoAttributes = "objecttype=263:objectcrc=917083893:stfFile=wearables_name:stfName=armor_tantel_skreej_boots:stfDetail=wearables_detail:itemmask=62967:customattributes=specialprotection=energyeffectiveness;vunerability=restraineffectiveness;armorPiece=263;armorStyle=4127;:",

   blueFrogAttributes = "specialprotection=energyeffectiveness;vunerability=restraineffectiveness;armorPiece=263;armorStyle=4127;",
   blueFrogEnabled = 1,
