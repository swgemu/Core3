...
kineticProtectionArmorLayer = Object:new {
   ...
   objectName = "Kinetic Protection Armor Layer", -- name of the lua Object
...
DraftSchematics:addDraftSchematic(kineticProtectionArmorLayer, 0)--- Add to global DraftSchematics table
