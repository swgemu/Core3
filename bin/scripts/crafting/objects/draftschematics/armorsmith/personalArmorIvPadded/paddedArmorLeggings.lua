...
paddedArmorLeggings = Object:new {
   ...
   tanoAttributes = "objecttype=260:objectcrc=547322785:stfFile=wearables_name:stfName=armor_padded_s01_leggings:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=262;armorStyle=4128;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=262;armorStyle=4128;",
   blueFrogEnabled = 1,
