...
paddedArmorLeggings = Object:new {

   objectName = "Padded Armor Leggings",
   stfName = "armor_padded_s01_leggings",
   ...
   ingredientSlotType = "0, 0, 0, 0, 0, 0, 1, 1, 2",
...
DraftSchematics:addDraftSchematic(paddedArmorLeggings, 991639340)--- Add to global DraftSchematics table
