...
paddedArmorBelt = Object:new {

   objectName = "Padded Armor Belt",
   stfName = "armor_padded_s01_belt",
   stfFile = "wearables_name",
   objectCRC = 1238463430,
...
DraftSchematics:addDraftSchematic(paddedArmorBelt, 1238463430)--- Add to global DraftSchematics table
