...
paddedArmorBoots = Object:new {

   objectName = "Padded Armor Boots",
   stfName = "armor_padded_s01_boots",
...
DraftSchematics:addDraftSchematic(paddedArmorBoots, 428470854)--- Add to global DraftSchematics table
