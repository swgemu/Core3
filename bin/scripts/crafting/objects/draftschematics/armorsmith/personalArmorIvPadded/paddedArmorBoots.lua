...
paddedArmorBoots = Object:new {
   ...
   tanoAttributes = "objecttype=263:objectcrc=343908402:stfFile=wearables_name:stfName=armor_padded_s01_boots:stfDetail=wearables_detail:itemmask=62967:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4128;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4128;",
   blueFrogEnabled = 1,
