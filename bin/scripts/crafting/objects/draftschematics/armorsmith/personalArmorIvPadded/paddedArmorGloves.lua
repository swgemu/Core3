...
paddedArmorGloves = Object:new {
   ...
   tanoAttributes = "objecttype=262:objectcrc=2813934470:stfFile=wearables_name:stfName=armor_padded_s01_gloves:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=257;armorStyle=4128;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=257;armorStyle=4128;",
   blueFrogEnabled = 1,
