...
compositeArmorSegment = Object:new {

   objectName = "Composite Armor Segment",
   stfName = "armor_segment_composite",
   stfFile = "craft_clothing_ingredients_n",
   objectCRC = 1778592860,
   ...
   tanoAttributes = "objecttype=262145:objectcrc=3596548182:objecttemp=armor_segment_composite:templatetype=craft_clothing_ingredients_n:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(compositeArmorSegment, 1778592860)--- Add to global DraftSchematics table
