...
paddedArmorRightBracer = Object:new {

   objectName = "Padded Armor Right Bracer",
   stfName = "armor_padded_s01_bracer_r",
   stfFile = "wearables_name",
   objectCRC = 3303714720,
   ...
   tanoAttributes = "objecttype=261:objectcrc=3748586285:stfFile=wearables_name:stfName=armor_padded_s01_bicep_r:stfDetail=:itemmask=62975:customattributes=specialprotection=blasteffectiveness;vunerability=stuneffectiveness,heateffectiveness,acideffectiveness;armorPiece=260;armorStyle=4121;:",
...
DraftSchematics:addDraftSchematic(paddedArmorRightBracer, 3303714720)--- Add to global DraftSchematics table
