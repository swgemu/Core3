...
paddedArmorRightBracer = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=3748586285:objecttemp=armor_padded_s01_bicep_r:templatetype=wearables_name:itemmask=62975:customattributes=specialprotection=blasteffectiveness;vunerability=stuneffectiveness,heateffectiveness,acideffectiveness;armorType=260;armorStyle=4121;:",
