...
paddedArmorRightBicep = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=2918354957:stfFile=wearables_name:stfName=clothing_armor_padded_bicep_r:stfDetail=:itemmask=62975:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=261;armorStyle=4128;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=261;armorStyle=4128;",
   blueFrogEnabled = 1,
