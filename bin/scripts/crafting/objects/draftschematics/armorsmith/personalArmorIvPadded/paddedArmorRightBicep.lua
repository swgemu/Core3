...
paddedArmorRightBicep = Object:new {

   objectName = "Padded Armor Right Bicep",
   stfName = "armor_padded_s01_bicep_r",
   stfFile = "wearables_name",
   objectCRC = 1909293969,
   ...
   tanoAttributes = "objecttype=261:objectcrc=2918354957:stfFile=wearables_name:stfName=clothing_armor_padded_bicep_r:stfDetail=:itemmask=62975:customattributes=specialprotection=blasteffectiveness;vunerability=stuneffectiveness,heateffectiveness,acideffectiveness;armorPiece=261;armorStyle=4121;:",
...
DraftSchematics:addDraftSchematic(paddedArmorRightBicep, 1909293969)--- Add to global DraftSchematics table
