...
ithorianDefenderHelmet = Object:new {
   ...
   tanoAttributes = "objecttype=258:objectcrc=892900592:stfFile=wearables_name:stfName=ith_armor_s01_helmet:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=264;armorStyle=4106;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=264;armorStyle=4106;",
   blueFrogEnabled = 1,
