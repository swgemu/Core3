...
paddedArmorChestPlate = Object:new {
   ...
   tanoAttributes = "objecttype=257:objectcrc=927787210:stfFile=wearables_name:stfName=armor_padded_s01_chest_plate:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4128;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4128;",
   blueFrogEnabled = 1,
