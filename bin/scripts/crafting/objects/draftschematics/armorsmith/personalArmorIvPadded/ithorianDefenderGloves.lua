...
ithorianDefenderGloves = Object:new {

   objectName = "Ithorian Defender Gloves",
   stfFile = "wearables_name",
   stfDetail = "",
   stfName = "ith_armor_s01_gloves",
   objectCRC = 2620131502,
   ...
   tanoAttributes = "objecttype=262:objectcrc=2214098424:stfFile=wearables_name:stfName=ith_armor_s01_gloves:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=257;armorStyle=4106;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=257;armorStyle=4106;",
   blueFrogEnabled = 1,
...
DraftSchematics:addDraftSchematic(ithorianDefenderGloves, 2620131502)--- Add to global DraftSchematics table
