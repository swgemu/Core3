...
ithorianDefenderBracerLeft = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=3020283121:stfFile=wearables_name:stfName=ith_armor_s01_bracer_l:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=258;armorStyle=4106;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=258;armorStyle=4106;",
   blueFrogEnabled = 1,
