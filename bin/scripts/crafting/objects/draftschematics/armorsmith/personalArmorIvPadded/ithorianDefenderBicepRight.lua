...
ithorianDefenderBicepRight = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=1738223153:stfFile=wearables_name:stfName=ith_armor_s01_bicep_r:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=261;armorStyle=4106;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=261;armorStyle=4106;",
   blueFrogEnabled = 1,
