...
ithorianDefenderBicepRight = Object:new {

   objectName = "Ithorian Defender Bicep (Right)",
   stfName = "ith_armor_s01_bicep_r",
   stfFile = "wearables_name",
   objectCRC = 3350732540,
...
DraftSchematics:addDraftSchematic(ithorianDefenderBicepRight, 3350732540)--- Add to global DraftSchematics table
