...
paddedArmorHelmet = Object:new {

   objectName = "Padded Armor Helmet",
   stfName = "armor_padded_s01_helmet",
   stfFile = "wearables_name",
   objectCRC = 3605407837,
...
DraftSchematics:addDraftSchematic(paddedArmorHelmet, 3605407837)--- Add to global DraftSchematics table
