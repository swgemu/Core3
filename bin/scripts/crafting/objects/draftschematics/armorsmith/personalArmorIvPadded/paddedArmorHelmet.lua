...
paddedArmorHelmet = Object:new {
   ...
   tanoAttributes = "objecttype=258:objectcrc=293198478:stfFile=wearables_name:stfName=armor_padded_s01_helmet:stfDetail=wearables_detail:itemmask=62975:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=264;armorStyle=4128;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=264;armorStyle=4128;",
   blueFrogEnabled = 1,
