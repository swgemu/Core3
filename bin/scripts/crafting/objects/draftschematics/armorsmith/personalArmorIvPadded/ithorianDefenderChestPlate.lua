...
ithorianDefenderChestPlate = Object:new {

   objectName = "Ithorian Defender Chest Plate",
   stfName = "ith_armor_s01_chest_plate",
...
DraftSchematics:addDraftSchematic(ithorianDefenderChestPlate, 264113310)--- Add to global DraftSchematics table
