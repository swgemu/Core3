...
ithorianDefenderChestPlate = Object:new {
   ...
   tanoAttributes = "objecttype=257:objectcrc=2075456355:stfFile=wearables_name:stfName=ith_armor_s01_chest_plate:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4106;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4106;",
   blueFrogEnabled = 1,
