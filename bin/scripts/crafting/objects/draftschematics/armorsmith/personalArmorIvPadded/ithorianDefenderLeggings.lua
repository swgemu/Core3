...
ithorianDefenderLeggings = Object:new {
   ...
   tanoAttributes = "objecttype=260:objectcrc=992018926:stfFile=wearables_name:stfName=ith_armor_s01_leggings:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=262;armorStyle=4106;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=262;armorStyle=4106;",
   blueFrogEnabled = 1,
