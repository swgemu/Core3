...
ithorianDefenderBicepLeft = Object:new {

   objectName = "Ithorian Defender Bicep (Left)",
   stfFile = "wearables_name",
   stfDetail = "",
   stfName = "ith_armor_s01_bicep_l",
   objectCRC = 3077397359,
   ...
   tanoAttributes = "objecttype=261:objectcrc=391015330:stfFile=wearables_name:stfName=ith_armor_s01_bicep_l:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=259;armorStyle=4106;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=heateffectiveness,stuneffectiveness,coldeffectiveness,restraineffectiveness;armorPiece=259;armorStyle=4106;",
   blueFrogEnabled = 1,
...
DraftSchematics:addDraftSchematic(ithorianDefenderBicepLeft, 3077397359)--- Add to global DraftSchematics table
