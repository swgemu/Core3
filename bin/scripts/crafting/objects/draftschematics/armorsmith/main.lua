...
RunDraftSchematicFile("objects/draftschematics/armorsmith/layers1/kineticProtectionArmorLayer.lua")

-- Layers 2
RunDraftSchematicFile("objects/draftschematics/armorsmith/layers2/heatProtectionArmorLayer.lua")
RunDraftSchematicFile("objects/draftschematics/armorsmith/layers2/blastProtectionArmorLayer.lua")

-- Layers 3
RunDraftSchematicFile("objects/draftschematics/armorsmith/layers3/coldProtectionArmorLayer.lua")
RunDraftSchematicFile("objects/draftschematics/armorsmith/layers3/electricalProtectionArmorLayer.lua")

-- Layers 4
RunDraftSchematicFile("objects/draftschematics/armorsmith/layers4/acidProtectionArmorLayer.lua")

-- Master Armorsmith
RunDraftSchematicFile("objects/draftschematics/armorsmith/master/stunProtectionArmorLayer.lua")
