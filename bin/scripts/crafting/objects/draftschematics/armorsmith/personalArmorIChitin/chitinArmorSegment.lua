...
chitinArmorSegment = Object:new {

   objectName = "Chitin Armor Segment",
   stfName = "armor_segment_chitin",
   stfFile = "craft_armor_ingredients_n",
   objectCRC = 3865019752,
   ...
   resourceTypes = "bone, metal_ferrous, object/tangible/component/armor/shared_armor_segment.iff",
...
DraftSchematics:addDraftSchematic(chitinArmorSegment, 3865019752)--- Add to global DraftSchematics table
