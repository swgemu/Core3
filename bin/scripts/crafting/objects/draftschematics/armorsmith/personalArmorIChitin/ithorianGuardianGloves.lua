...
ithorianGuardianGloves = Object:new {
   ...
   tanoAttributes = "objecttype=262:objectcrc=889238444:stfFile=wearables_name:stfName=clothing_armor_ithorian_guardian_gloves:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=257;armorStyle=4107;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=257;armorStyle=4107;",
   blueFrogEnabled = 1,
