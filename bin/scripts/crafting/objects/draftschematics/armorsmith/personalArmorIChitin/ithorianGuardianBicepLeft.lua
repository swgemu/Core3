...
ithorianGuardianBicepLeft = Object:new {
   ...
   tanoAttributes = "objecttype=261:objectcrc=1211170670:stfFile=wearables_name:stfName=ith_armor_s02_bicep_l:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=259;armorStyle=4107;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=259;armorStyle=4107;",
   blueFrogEnabled = 1,
