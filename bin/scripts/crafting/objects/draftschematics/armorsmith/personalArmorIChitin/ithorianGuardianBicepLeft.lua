...
ithorianGuardianBicepLeft = Object:new {

   objectName = "Ithorian Guardian Bicep (Left)",
   stfName = "ith_armor_s02_bicep_l",
   stfFile = "wearables_name",
   objectCRC = 4137038776,
...
DraftSchematics:addDraftSchematic(ithorianGuardianBicepLeft, 4137038776)--- Add to global DraftSchematics table
