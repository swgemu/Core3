...
ithorianGuardianChestPlate = Object:new {
   ...
   tanoAttributes = "objecttype=257:objectcrc=1560721233:stfFile=wearables_name:stfName=ith_armor_s01_chest_plate:stfDetail=:itemmask=63491:customattributes=specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4107;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=256;armorStyle=4107;",
   blueFrogEnabled = 1,
