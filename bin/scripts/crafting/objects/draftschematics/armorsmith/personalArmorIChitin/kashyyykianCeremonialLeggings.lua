...
kashyyykianCeremonialLeggings = Object:new {
   ...
   tanoAttributes = "objecttype=260:objectcrc=2303407451:stfFile=wearables_name:stfName=armor_kashyyykian_ceremonial_leggings:stfDetail=wearables_detail:itemmask=61955:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,acideffectiveness,restraineffectiveness;armorPiece=262;armorStyle=4110;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,acideffectiveness,restraineffectiveness;armorPiece=262;armorStyle=4110;",
   blueFrogEnabled = 1,
