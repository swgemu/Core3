...
kashyyykianCeremonialLeggings = Object:new {

   objectName = "Kashyyykian Ceremonial Leggings",
   stfName = "armor_kashyyykian_ceremonial_leggings",
   stfFile = "wearables_name",
   objectCRC = 4177631029,
...
DraftSchematics:addDraftSchematic(kashyyykianCeremonialLeggings, 4177631029)--- Add to global DraftSchematics table
