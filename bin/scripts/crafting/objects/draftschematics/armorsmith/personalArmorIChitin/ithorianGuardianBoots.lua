...
ithorianGuardianBoots = Object:new {

   objectName = "Ithorian Guardian Boots",
   stfName = "ith_armor_s02_boots",
   stfFile = "wearables_name",
   objectCRC = 3355136251,
...
DraftSchematics:addDraftSchematic(ithorianGuardianBoots, 3355136251)--- Add to global DraftSchematics table
