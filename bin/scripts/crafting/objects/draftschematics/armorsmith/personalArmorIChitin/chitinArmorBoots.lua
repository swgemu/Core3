...
chitinArmorBoots = Object:new {
   ...
   tanoAttributes = "objecttype=263:objectcrc=1961496739:stfFile=wearables_name:stfName=armor_chitin_s01_boots:stfDetail=wearables_detail:itemmask=62967:customattributes=specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,heateffectiveness,coldeffectiveness,electricaleffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4102;:",

   blueFrogAttributes = "specialprotection=kineticeffectiveness;vunerability=stuneffectiveness,heateffectiveness,coldeffectiveness,electricaleffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4102;",
   blueFrogEnabled = 1,
