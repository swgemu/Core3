...
chitinArmorBoots = Object:new {

   objectName = "Chitin Armor Boots",
   stfName = "armor_chitin_s01_boots",
   stfFile = "wearables_name",
   objectCRC = 1821888750,
...
DraftSchematics:addDraftSchematic(chitinArmorBoots, 1821888750)--- Add to global DraftSchematics table
