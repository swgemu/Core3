...
kashyyykianCeremonialChestPlate = Object:new {

   objectName = "Kashyyykian Ceremonial Chest Plate",
   stfName = "armor_kashyyykian_ceremonial_chest_plate",
   stfFile = "wearables_name",
   objectCRC = 2034172347,
...
DraftSchematics:addDraftSchematic(kashyyykianCeremonialChestPlate, 2034172347)--- Add to global DraftSchematics table
