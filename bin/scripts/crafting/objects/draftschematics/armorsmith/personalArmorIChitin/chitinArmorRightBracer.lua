...
chitinArmorRightBracer = Object:new {

   objectName = "Chitin Armor Right Bracer",
   stfName = "armor_chitin_s01_bracer_r",
   stfFile = "wearables_name",
   objectCRC = 3565822466,
...
DraftSchematics:addDraftSchematic(chitinArmorRightBracer, 3565822466)--- Add to global DraftSchematics table
