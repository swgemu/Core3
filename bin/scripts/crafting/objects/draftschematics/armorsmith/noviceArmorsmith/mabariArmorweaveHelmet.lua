...
mabariArmorweaveHelmet = Object:new {
   ...
   tanoAttributes = "objecttype=258:objectcrc=519414104:stfFile=wearables_name:stfName=armor_zam_wesell_helmet:stfDetail=wearables_detail:itemmask=62975:customattributes=vunerability=energyeffectiveness,acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=264;armorStyle=4129;specialprotection=blasteffectiveness,heateffectiveness;:",

   blueFrogAttributes = "vunerability=energyeffectiveness;restraineffectiveness:armorPiece=264:armorStyle=4129:specialprotection=blasteffectiveness;",
   blueFrogEnabled = 1,
