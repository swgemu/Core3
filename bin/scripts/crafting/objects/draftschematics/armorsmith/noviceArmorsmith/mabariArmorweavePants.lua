...
mabariArmorweavePants = Object:new {
   ...
   tanoAttributes = "objecttype=260:objectcrc=2684655133:stfFile=wearables_name:stfName=armor_zam_wesell_pants:stfDetail=wearables_detail:itemmask=62975:customattributes=vunerability=energyeffectiveness,acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=262;armorStyle=4129;specialprotection=blasteffectiveness,heateffectiveness;:",

   blueFrogAttributes = "vunerability=energyeffectiveness;restraineffectiveness:armorPiece=262:armorStyle=4129:specialprotection=blasteffectiveness;",
   blueFrogEnabled = 1,
