...
mabariArmorweaveGloves = Object:new {
   ...
   tanoAttributes = "objecttype=262:objectcrc=2822062160:stfFile=wearables_name:stfName=armor_zam_wesell_gloves:stfDetail=wearables_detail:itemmask=62975:customattributes=vunerability=energyeffectiveness,acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=257;armorStyle=4129;specialprotection=blasteffectiveness,heateffectiveness;:",
