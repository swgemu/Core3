...
armorUpgradeKit = Object:new {

   objectName = "Armor Upgrade Kit",
   stfFile = "item_n",
   stfDetail = "item_d",
   stfName = "armor_upgrade_kit",
   objectCRC = 1225468655,
   ...
   tanoAttributes = "objecttype=32768:objectcrc=2423629000:stfFile=item_n:stfName=armor_upgrade_kit:stfDetail=item_d:itemmask=65535:customattributes=toolType=103;kitType=0;:",
...
DraftSchematics:addDraftSchematic(armorUpgradeKit, 1225468655)--- Add to global DraftSchematics table
