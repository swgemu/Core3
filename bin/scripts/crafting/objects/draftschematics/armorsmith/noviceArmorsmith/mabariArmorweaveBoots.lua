...
mabariArmorweaveBoots = Object:new {

   objectName = "Mabari Armorweave Boots",
   stfName = "armor_zam_wesell_boots",
...
DraftSchematics:addDraftSchematic(mabariArmorweaveBoots, 210074770)--- Add to global DraftSchematics table
