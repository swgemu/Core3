...
mabariArmorweaveBoots = Object:new {
   ...
   tanoAttributes = "objecttype=263:objectcrc=509585055:stfFile=wearables_name:stfName=armor_zam_wesell_boots:stfDetail=wearables_detail:itemmask=62967:customattributes=vunerability=energyeffectiveness,acideffectiveness,stuneffectiveness,restraineffectiveness;armorPiece=263;armorStyle=4129;specialprotection=blasteffectiveness,heateffectiveness;:",
