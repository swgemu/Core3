...
ubeseArmorJacket = Object:new {

   objectName = "Ubese Armor Jacket", -- name of the lua Object
   stfName = "armor_ubese_jacket", 
   objectCRC = 2414320930, 
   ...
   attributesMinMax = "1, 30, 20000, 49000, 119, 74, 54, 36, 28, 20, 1, 40, 1, 40"
}

DraftSchematics:addDraftSchematic(ubeseArmorJacket, 2414320930)--- Add to global DraftSchematics table
