...
dualWaveSynthesizer = Object:new {
   ...
   stfDetail = "craft_furniture_ingredients_d",
   ...
   tanoAttributes = "objecttype=262144:objectcrc=264284589:stfFile=craft_furniture_ingredients_n:stfName=dual_wave_synthesizer:stfDetail=craft_furniture_ingredients_d:itemmask=65535:customattributes=:",
