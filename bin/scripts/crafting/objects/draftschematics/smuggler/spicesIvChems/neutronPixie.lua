...
neutronPixie = Object:new {
   ...
   tanoAttributes = "objecttype=8202:objectcrc=3750021953:stfFile=food_name:stfName=neutron_pixey:stfDetail=food_detail:itemmask=65535:customattributes=effectType=5;buffName=neutron_pixey;modifierString=health=1000,strength=200,constitution=200,action=500,quickness=50,stamina=50;duration=800;:",
