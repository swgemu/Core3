...
crashNBurn = Object:new {
   ...
   tanoAttributes = "objecttype=8202:objectcrc=96283804:stfFile=food_name:stfName=crash_n_burn:stfDetail=food_detail:itemmask=65535:customattributes=effectType=5;buffName=crash_n_burn;modifierString=action=-200,quickness=-200,mind=400,focus=200;duration=600;:",
