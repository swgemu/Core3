...
thrusterHead = Object:new {
   ...
   tanoAttributes = "objecttype=8202:objectcrc=732545867:stfFile=food_name:stfName=thruster_head:stfDetail=food_detail:itemmask=65535:customattributes=effectType=5;buffName=thruster_head;modifierString=mind=600,focus=200;duration=400;:",
