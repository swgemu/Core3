...
thrusterHead = Object:new {

   objectName = "Thruster Head",
   stfName = "thruster_head",
   stfFile = "food_name",
   objectCRC = 2661232828,
   ...
   tanoAttributes = "objecttype=8202:objectcrc=732545867:objecttemp=thruster_head:templatetype=spice/spice:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(thrusterHead, 2661232828)--- Add to global DraftSchematics table
