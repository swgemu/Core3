...
zypoleneDroidLubricant = Object:new {
   ...
   tanoAttributes = "objecttype=8202:objectcrc=1700944368:stfFile=food_name:stfName=droid_lube:stfDetail=food_detail:itemmask=65535:customattributes=effectType=5;buffName=driod_lube;modifierString=health=250,strength=250,constitution=250;duration=600;:",
