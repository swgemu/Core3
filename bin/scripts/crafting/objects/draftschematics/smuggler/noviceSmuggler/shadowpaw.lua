...
shadowpaw = Object:new {
   ...
   tanoAttributes = "objecttype=8202:objectcrc=2778111395:stfFile=food_name:stfName=shadowpaw:stfDetail=food_detail:itemmask=65535:customattributes=effectType=5;buffName=shadowpaw;modifierString=strength=-100,action=250,quickness=250;duration=600;:",
