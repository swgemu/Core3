...
doubleRobe = Object:new {

   objectName = "Double Robe",
   stfName = "robe_s04",
   stfFile = "wearables_name",
   objectCRC = 4156696135,
...
DraftSchematics:addDraftSchematic(doubleRobe, 4156696135)--- Add to global DraftSchematics table
