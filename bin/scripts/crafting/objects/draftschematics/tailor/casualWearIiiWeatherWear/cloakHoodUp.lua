...
cloakHoodUp = Object:new {

   objectName = "Cloak (Hood Up)",
   stfName = "robe_s05b",
   stfFile = "wearables_name",
   objectCRC = 3903710802,
   ...
   tanoAttributes = "objecttype=16777221:objectcrc=956309254:stfFile=wearables_name:stfName=robe_s05b:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(cloakHoodUp, 3903710802)--- Add to global DraftSchematics table
