...
wookieeSmock = Object:new {

   objectName = "Wookiee Smock",
   stfName = "robe_s18",
   stfFile = "wearables_name",
   objectCRC = 2381819834,
...
DraftSchematics:addDraftSchematic(wookieeSmock, 2381819834)--- Add to global DraftSchematics table
