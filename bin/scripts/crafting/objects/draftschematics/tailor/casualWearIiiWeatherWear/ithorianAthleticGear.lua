...
ithorianAthleticGear = Object:new {

   objectName = "Ithorian Athletic Gear",
   stfFile = "wearables_name",
   stfDetail = "wearables_detail",
   stfName = "ith_bodysuit_s04",
   objectCRC = 1780770547,
   ...
   tanoAttributes = "objecttype=16777219:objectcrc=153902942:stfFile=wearables_name:stfName=ith_bodysuit_s04:stfDetail=wearables_detail:itemmask=63491:customattributes=:",
...
DraftSchematics:addDraftSchematic(ithorianAthleticGear, 1780770547)--- Add to global DraftSchematics table
