...
sportsBustier = Object:new {

   objectName = "Sports Bustier",
   stfName = "bustier_s03",
   stfFile = "wearables_name",
   objectCRC = 1937208949,
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=901073191:stfFile=wearables_name:stfName=bustier_s03:stfDetail=:itemmask=62974::",
...
DraftSchematics:addDraftSchematic(sportsBustier, 1937208949)--- Add to global DraftSchematics table
