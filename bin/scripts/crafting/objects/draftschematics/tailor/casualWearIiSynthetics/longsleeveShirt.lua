...
longsleeveShirt = Object:new {
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=235457924:stfFile=wearables_name:stfName=shirt_s16:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(longsleeveShirt, 698384571)--- Add to global DraftSchematics table
