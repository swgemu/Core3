...
ithorianKnittedShirt = Object:new {

   objectName = "Ithorian Knitted Shirt",
   stfName = "ith_shirt_s03",
   stfFile = "wearables_name",
   objectCRC = 3560484299,
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=3897341225:objecttemp=ith_shirt_s03:templatetype=wearables_name:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianKnittedShirt, 3560484299)--- Add to global DraftSchematics table
