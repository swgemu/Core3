...
scoutJacket = Object:new {

   objectName = "Scout Jacket",
   stfName = "jacket_s07",
   stfFile = "wearables_name",
   objectCRC = 3807666966,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=624929286:stfFile=wearables_name:stfName=jacket_s07:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(scoutJacket, 3807666966)--- Add to global DraftSchematics table
