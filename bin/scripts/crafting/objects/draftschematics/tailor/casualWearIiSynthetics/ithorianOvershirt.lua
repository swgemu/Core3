...
ithorianOvershirt = Object:new {

   objectName = "Ithorian Overshirt",
   stfFile = "wearables_name",
   stfDetail = "wearables_detail",
   stfName = "ith_jacket_s09",
   objectCRC = 158626778,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=2326212722:stfFile=wearables_name:stfName=ith_jacket_s09:stfDetail=wearables_detail:itemmask=62975:customattributes=:",
...
DraftSchematics:addDraftSchematic(ithorianOvershirt, 158626778)--- Add to global DraftSchematics table
