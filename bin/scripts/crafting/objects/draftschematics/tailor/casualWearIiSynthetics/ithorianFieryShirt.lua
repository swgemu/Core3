...
ithorianFieryShirt = Object:new {

   objectName = "Ithorian Fiery Shirt",
   stfName = "ith_shirt_s14",
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=143102789:stfFile=wearables_name:stfName=ith_shirt_s14:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianFieryShirt, 888376231)--- Add to global DraftSchematics table
