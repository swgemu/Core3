...
ithorianEasyFitShirt = Object:new {

   objectName = "Ithorian Easy Fit Shirt",
   stfFile = "wearables_name",
   stfDetail = "wearables_detail",
   stfName = "ith_shirt_s05",
   objectCRC = 2365718462,
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=1520630192:stfFile=wearables_name:stfName=ith_shirt_s05:stfDetail=wearables_detail:itemmask=63491:customattributes=:",
...
DraftSchematics:addDraftSchematic(ithorianEasyFitShirt, 2365718462)--- Add to global DraftSchematics table
