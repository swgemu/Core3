...
wookieeBattlePadding = Object:new {

   objectName = "Wookiee Battle Padding",
   stfName = "wke_shirt_s03",
   stfFile = "wearables_name",
   objectCRC = 2057154635,
   ...
   tanoAttributes = "objecttype=16777232:objectcrc=880489783:stfFile=wearables_name:stfName=wke_shirt_s03:stfDetail=:itemmask=61955::",
...
DraftSchematics:addDraftSchematic(wookieeBattlePadding, 2057154635)--- Add to global DraftSchematics table
