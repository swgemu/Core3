...
pocketedShorts = Object:new {

   objectName = "Pocketed Shorts",
   stfName = "pants_s27",
   ...
   resourceTypes = "***BAD NAME***, petrochem_inert, object/tangible/component/clothing/shared_metal_fasteners.iff, object/tangible/component/clothing/shared_synthetic_cloth.iff",
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=2948646659:stfFile=wearables_name:stfName=pants_s27:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(pocketedShorts, 619641364)--- Add to global DraftSchematics table
