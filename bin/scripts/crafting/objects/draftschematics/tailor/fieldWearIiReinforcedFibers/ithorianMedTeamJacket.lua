...
ithorianMedTeamJacket = Object:new {

   objectName = "Ithorian Med Team Jacket",
   stfFile = "wearables_name",
   stfDetail = "wearables_detail",
   stfName = "ith_jacket_s05",
   objectCRC = 3544930723,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=3954881783:stfFile=wearables_name:stfName=ith_jacket_s05:stfDetail=wearables_detail:itemmask=63491:customattributes=:",
...
DraftSchematics:addDraftSchematic(ithorianMedTeamJacket, 3544930723)--- Add to global DraftSchematics table
