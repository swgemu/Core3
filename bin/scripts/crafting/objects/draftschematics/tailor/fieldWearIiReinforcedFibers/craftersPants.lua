...
craftersPants = Object:new {

   objectName = "Crafter's Pants",
   stfName = "pants_s29",
   stfFile = "wearables_name",
   objectCRC = 3622416779,
...
DraftSchematics:addDraftSchematic(craftersPants, 3622416779)--- Add to global DraftSchematics table
