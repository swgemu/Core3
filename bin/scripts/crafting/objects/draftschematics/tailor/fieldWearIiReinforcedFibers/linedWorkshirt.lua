...
linedWorkshirt = Object:new {

   objectName = "Lined Workshirt",
   stfName = "shirt_s26",
   stfFile = "wearables_name",
   objectCRC = 2573366544,
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=594598412:stfFile=wearables_name:stfName=shirt_s26:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(linedWorkshirt, 2573366544)--- Add to global DraftSchematics table
