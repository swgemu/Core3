...
womensShoes = Object:new {

   objectName = "Women's Shoes",
   stfFile = "wearables_name",
   stfDetail = "wearables_detail",
   stfName = "shoes_s08",
   objectCRC = 2536966602,
   ...
   tanoAttributes = "objecttype=16777222:objectcrc=3681832074:stfFile=wearables_name:stfName=shoes_s08:stfDetail=wearables_detail:itemmask=62974:customattributes=:",
...
DraftSchematics:addDraftSchematic(womensShoes, 2536966602)--- Add to global DraftSchematics table
