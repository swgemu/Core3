...
ithorianThreeStripedPants = Object:new {

   objectName = "Ithorian Three Striped Pants",
   stfName = "ith_pants_s02",
   stfFile = "wearables_name",
   objectCRC = 2254555283,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=2554980633:objecttemp=ith_pants_s02:templatetype=wearables_name:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianThreeStripedPants, 2254555283)--- Add to global DraftSchematics table
