...
ithorianFrilledJacket = Object:new {

   objectName = "Ithorian Frilled Jacket",
   stfName = "ith_jacket_s03",
   stfFile = "wearables_name",
   objectCRC = 3666328518,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=1498740846:stfFile=wearables_name:stfName=ith_jacket_s03:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianFrilledJacket, 3666328518)--- Add to global DraftSchematics table
