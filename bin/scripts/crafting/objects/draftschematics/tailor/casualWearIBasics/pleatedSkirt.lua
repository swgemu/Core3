...
pleatedSkirt = Object:new {

   objectName = "Pleated Skirt",
   stfName = "skirt_s04",
   ...
   tanoAttributes = "objecttype=16777234:objectcrc=3715418756:stfFile=wearables_name:stfName=skirt_s04:stfDetail=:itemmask=62974::",
...
DraftSchematics:addDraftSchematic(pleatedSkirt, 670770673)--- Add to global DraftSchematics table
