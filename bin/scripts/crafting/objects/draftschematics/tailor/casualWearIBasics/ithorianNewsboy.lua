...
ithorianNewsboy = Object:new {

   objectName = "Ithorian Newsboy",
   stfName = "ith_hat_s01",
   stfFile = "wearables_name",
   objectCRC = 3597861568,
   ...
   tanoAttributes = "objecttype=16777226:objectcrc=2858642362:stfFile=wearables_name:stfName=ith_hat_s01:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianNewsboy, 3597861568)--- Add to global DraftSchematics table
