...
twostrapBandolier = Object:new {

   objectName = "Two-Strap Bandolier",
   stfName = "bandolier_s03",
   ...
   tanoAttributes = "objecttype=16777217:objectcrc=4012855347:stfFile=wearables_name:stfName=bandolier_s03:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(twostrapBandolier, 435175010)--- Add to global DraftSchematics table
