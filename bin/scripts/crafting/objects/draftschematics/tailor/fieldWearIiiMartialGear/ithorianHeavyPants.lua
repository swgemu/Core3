...
ithorianHeavyPants = Object:new {

   objectName = "Ithorian Heavy Pants",
   stfName = "ith_pants_s13",
   stfFile = "wearables_name",
   objectCRC = 3494270678,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=3396109292:stfFile=wearables_name:stfName=ith_pants_s13:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianHeavyPants, 3494270678)--- Add to global DraftSchematics table
