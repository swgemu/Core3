...
mercenaryBandolier = Object:new {

   objectName = "Mercenary Bandolier",
   stfName = "bandolier_s02",
   stfFile = "wearables_name",
   objectCRC = 1358780911,
   ...
   tanoAttributes = "objecttype=16777217:objectcrc=2787260350:stfFile=item_n:stfName=mercenary_bandolier:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(mercenaryBandolier, 1358780911)--- Add to global DraftSchematics table
