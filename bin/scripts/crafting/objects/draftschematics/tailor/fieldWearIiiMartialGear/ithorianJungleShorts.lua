...
ithorianJungleShorts = Object:new {

   objectName = "Ithorian Jungle Shorts",
   stfName = "ith_pants_s15",
   stfFile = "wearables_name",
   objectCRC = 1655183951,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=2021838709:stfFile=wearables_name:stfName=ith_pants_s15:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianJungleShorts, 1655183951)--- Add to global DraftSchematics table
