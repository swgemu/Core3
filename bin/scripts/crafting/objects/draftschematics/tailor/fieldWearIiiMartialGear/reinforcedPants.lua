...
reinforcedPants = Object:new {

   objectName = "Reinforced Pants",
   stfFile = "wearables_name",
   stfDetail = "wearables_detail",
   stfName = "pants_s28",
   objectCRC = 2665797126,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=365619985:stfFile=wearables_name:stfName=pants_s28:stfDetail=wearables_detail:itemmask=62975:customattributes=:",
...
DraftSchematics:addDraftSchematic(reinforcedPants, 2665797126)--- Add to global DraftSchematics table
