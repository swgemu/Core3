...
specopsPack = Object:new {

   objectName = "Spec-Ops Pack",
   stfName = "backpack_s06",
   stfFile = "wearables_name",
   objectCRC = 2163919700,
...
DraftSchematics:addDraftSchematic(specopsPack, 2163919700)--- Add to global DraftSchematics table
