...
desertCommandJacket = Object:new {

   objectName = "Desert Command Jacket",
   stfName = "jacket_s35",
   stfFile = "wearables_name",
   objectCRC = 1903856173,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=2589815444:stfFile=wearables_name:stfName=jacket_s35:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(desertCommandJacket, 1903856173)--- Add to global DraftSchematics table
