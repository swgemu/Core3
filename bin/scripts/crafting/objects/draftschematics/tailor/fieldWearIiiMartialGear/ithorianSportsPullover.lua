...
ithorianSportsPullover = Object:new {

   objectName = "Ithorian Sports Pullover",
   stfName = "ith_jacket_s13",
   stfFile = "wearables_name",
   objectCRC = 2056067138,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=1115485462:stfFile=wearables_name:stfName=ith_jacket_s13:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianSportsPullover, 2056067138)--- Add to global DraftSchematics table
