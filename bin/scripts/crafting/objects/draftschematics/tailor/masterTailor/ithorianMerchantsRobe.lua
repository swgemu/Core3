...
ithorianMerchantsRobe = Object:new {

   objectName = "Ithorian Merchant's Robe",
   stfName = "ith_robe_s03",
   ...
   tanoAttributes = "objecttype=:objectcrc=2406825034:stfFile=:stfName=:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(ithorianMerchantsRobe, 365965625)--- Add to global DraftSchematics table
