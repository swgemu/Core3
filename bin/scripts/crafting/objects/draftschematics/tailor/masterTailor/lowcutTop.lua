...
lowcutTop = Object:new {

   objectName = "Low-Cut Top",
   stfName = "bikini_s03",
   stfFile = "wearables_name",
   objectCRC = 3213415951,
...
DraftSchematics:addDraftSchematic(lowcutTop, 3213415951)--- Add to global DraftSchematics table
