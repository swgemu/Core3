...
heavyFlightsuit = Object:new {

   objectName = "Heavy Flightsuit",
   stfName = "bodysuit_s01",
   stfFile = "wearables_name",
   objectCRC = 3603791203,
   ...
   tanoAttributes = "objecttype=16777219:objectcrc=3519793019:stfFile=wearables_name:stfName=bodysuit_s01:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(heavyFlightsuit, 3603791203)--- Add to global DraftSchematics table
