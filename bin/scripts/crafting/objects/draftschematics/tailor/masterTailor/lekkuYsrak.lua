...
lekkuYsrak = Object:new {

   objectName = "Lekku Ys'rak",
   stfName = "hat_twilek_s04",
   stfFile = "wearables_name",
   objectCRC = 1491611024,
...
DraftSchematics:addDraftSchematic(lekkuYsrak, 1491611024)--- Add to global DraftSchematics table
