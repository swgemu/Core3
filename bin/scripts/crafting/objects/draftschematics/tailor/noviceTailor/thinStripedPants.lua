...
thinStripedPants = Object:new {

   objectName = "Thin Striped Pants",
   stfName = "pants_s05",
   stfFile = "wearables_name",
   objectCRC = 4073400193,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=193598185:stfFile=craft_clothing_ingredients_n:stfName=clothing_pants_casual_05:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(thinStripedPants, 4073400193)--- Add to global DraftSchematics table
