...
sleevelessDress = Object:new {

   objectName = "Sleeveless Dress",
   stfName = "dress_s29",
   stfFile = "wearables_name",
   objectCRC = 2055108423,
...
DraftSchematics:addDraftSchematic(sleevelessDress, 2055108423)--- Add to global DraftSchematics table
