...
ribbedPants = Object:new {
   ...
   tanoAttributes = "objecttype=:objectcrc=3499997822:stfFile=wearables_name:stfName=pants_s06:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(ribbedPants, 702320406)--- Add to global DraftSchematics table
