...
ruggedJacket = Object:new {

   objectName = "Rugged Jacket",
   stfName = "jacket_s08",
   stfFile = "wearables_name",
   objectCRC = 1947369133,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=2671085076:stfFile=craft_clothing_ingredients_n:stfName=clothing_jacket_field_08:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(ruggedJacket, 1947369133)--- Add to global DraftSchematics table
