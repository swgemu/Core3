...
sigiledWaistWrap = Object:new {

   objectName = "Sigiled Waist Wrap",
   stfName = "wke_skirt_s02",
   ...
   tanoAttributes = "objecttype=16777232:objectcrc=1970108336:stfFile=wearables_name:stfName=wke_skirt_s02:stfDetail=:itemmask=61955::",
...
DraftSchematics:addDraftSchematic(sigiledWaistWrap, 999027404)--- Add to global DraftSchematics table
