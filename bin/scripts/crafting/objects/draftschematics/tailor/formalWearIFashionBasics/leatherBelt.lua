...
leatherBelt = Object:new {

   objectName = "Leather Belt",
   stfName = "belt_s16",
   stfFile = "wearables_name",
   objectCRC = 3532911563,
...
DraftSchematics:addDraftSchematic(leatherBelt, 3532911563)--- Add to global DraftSchematics table
