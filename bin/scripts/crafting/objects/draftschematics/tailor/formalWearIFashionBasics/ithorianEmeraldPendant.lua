...
ithorianEmeraldPendant = Object:new {

   objectName = "Ithorian Emerald Pendant",
   stfName = "ith_necklace_s07",
   stfFile = "wearables_name",
   objectCRC = 1860008351,
...
DraftSchematics:addDraftSchematic(ithorianEmeraldPendant, 1860008351)--- Add to global DraftSchematics table
