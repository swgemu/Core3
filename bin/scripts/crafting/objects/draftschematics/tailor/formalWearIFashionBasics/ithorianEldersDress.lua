...
ithorianEldersDress = Object:new {

   objectName = "Ithorian Elder's Dress",
   stfName = "ith_dress_s03",
   ...
   tanoAttributes = "objecttype=:objectcrc=3968833653:stfFile=:stfName=:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(ithorianEldersDress, 278159789)--- Add to global DraftSchematics table
