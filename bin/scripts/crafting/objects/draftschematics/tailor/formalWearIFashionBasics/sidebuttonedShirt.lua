...
sidebuttonedShirt = Object:new {

   objectName = "Sidebuttoned Shirt",
   stfName = "shirt_s08",
   stfFile = "wearables_name",
   objectCRC = 1750574450,
...
DraftSchematics:addDraftSchematic(sidebuttonedShirt, 1750574450)--- Add to global DraftSchematics table
