...
ithorianHeavyPantaloon = Object:new {

   objectName = "Ithorian Heavy Pantaloon",
   stfName = "ith_pants_s19",
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=429870064:stfFile=wearables_name:stfName=ith_pants_s19:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianHeavyPantaloon, 62234314)--- Add to global DraftSchematics table
