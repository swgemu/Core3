...
crestedBattlePadding = Object:new {

   objectName = "Crested Battle Padding",
   stfName = "wke_shirt_s04",
   stfFile = "wearables_name",
   objectCRC = 2172558175,
...
DraftSchematics:addDraftSchematic(crestedBattlePadding, 2172558175)--- Add to global DraftSchematics table
