...
ithorianOfficersJacket = Object:new {

   objectName = "Ithorian Officer's Jacket",
   stfName = "ith_jacket_s11",
   stfFile = "wearables_name",
   objectCRC = 3902265176,
   ...
   tanoAttributes = "objecttype=:objectcrc=3496360460:stfFile=:stfName=:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(ithorianOfficersJacket, 3902265176)--- Add to global DraftSchematics table
