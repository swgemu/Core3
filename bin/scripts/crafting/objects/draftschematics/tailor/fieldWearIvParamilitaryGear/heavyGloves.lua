...
heavyGloves = Object:new {

   objectName = "Heavy Gloves",
   stfName = "gloves_s10",
   stfFile = "wearables_name",
   objectCRC = 3775249290,
...
DraftSchematics:addDraftSchematic(heavyGloves, 3775249290)--- Add to global DraftSchematics table
