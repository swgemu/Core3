...
paddedPullover = Object:new {

   objectName = "Padded Pullover",
   stfName = "vest_s06",
   stfFile = "wearables_name",
   objectCRC = 1370249556,
...
DraftSchematics:addDraftSchematic(paddedPullover, 1370249556)--- Add to global DraftSchematics table
