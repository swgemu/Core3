...
ithorianCargoJacket = Object:new {

   objectName = "Ithorian Cargo Jacket",
   stfName = "ith_jacket_s02",
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=274309091:stfFile=wearables_name:stfName=ith_jacket_s02:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianCargoJacket, 682128055)--- Add to global DraftSchematics table
