...
reinforcedJacket = Object:new {

   objectName = "Reinforced Jacket",
   stfName = "jacket_s13",
   stfFile = "wearables_name",
   objectCRC = 4123319364,
...
DraftSchematics:addDraftSchematic(reinforcedJacket, 4123319364)--- Add to global DraftSchematics table
