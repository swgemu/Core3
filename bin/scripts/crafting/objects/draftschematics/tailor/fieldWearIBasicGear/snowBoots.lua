...
snowBoots = Object:new {

   objectName = "Snow Boots",
   stfName = "boots_s34",
   ...
   tanoAttributes = "objecttype=:objectcrc=2804071472:stfFile=wearables_name:stfName=boots_s34:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(snowBoots, 862910034)--- Add to global DraftSchematics table
