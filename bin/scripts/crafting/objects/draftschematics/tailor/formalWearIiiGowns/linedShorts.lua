...
linedShorts = Object:new {

   objectName = "Lined Shorts",
   stfName = "pants_s33",
   stfFile = "wearables_name",
   objectCRC = 3297058750,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=2484881912:objecttemp=pants_s33:templatetype=wearables_name:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(linedShorts, 3297058750)--- Add to global DraftSchematics table
