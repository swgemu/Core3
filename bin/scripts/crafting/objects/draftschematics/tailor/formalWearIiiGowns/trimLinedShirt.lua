...
trimLinedShirt = Object:new {

   objectName = "Trim Lined Shirt",
   stfName = "shirt_s15",
   stfFile = "wearables_name",
   objectCRC = 1534020354,
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=3575604499:stfFile=wearables_name:stfName=clothing_shirt_formal_15:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(trimLinedShirt, 1534020354)--- Add to global DraftSchematics table
