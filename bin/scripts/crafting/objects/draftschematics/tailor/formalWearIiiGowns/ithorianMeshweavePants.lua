...
ithorianMeshweavePants = Object:new {

   objectName = "Ithorian Meshweave Pants",
   stfName = "ith_pants_s11",
   stfFile = "wearables_name",
   objectCRC = 4018540114,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=1484147958:stfFile=wearables_name:stfName=ith_pants_s11:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianMeshweavePants, 4018540114)--- Add to global DraftSchematics table
