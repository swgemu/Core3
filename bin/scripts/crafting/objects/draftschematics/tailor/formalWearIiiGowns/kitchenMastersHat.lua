...
kitchenMastersHat = Object:new {

   objectName = "Kitchen Master's Hat",
   stfName = "hat_chef_s01",
   stfFile = "wearables_name",
   objectCRC = 3580572048,
   ...
   tanoAttributes = "objecttype=:objectcrc=4237787733:stfFile=:stfName=:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(kitchenMastersHat, 3580572048)--- Add to global DraftSchematics table
