...
formalGown = Object:new {

   objectName = "Formal Gown",
   stfName = "dress_s27",
   stfFile = "wearables_name",
   objectCRC = 2306424024,
...
DraftSchematics:addDraftSchematic(formalGown, 2306424024)--- Add to global DraftSchematics table
