...
ithorianSilverPendant = Object:new {

   objectName = "Ithorian Silver Pendant",
   stfName = "ith_necklace_s09",
   stfFile = "wearables_name",
   objectCRC = 2648322560,
...
DraftSchematics:addDraftSchematic(ithorianSilverPendant, 2648322560)--- Add to global DraftSchematics table
