...
elegantGown = Object:new {

   objectName = "Elegant Gown",
   stfName = "dress_s30",
   stfFile = "wearables_name",
   objectCRC = 1773279924,
...
DraftSchematics:addDraftSchematic(elegantGown, 1773279924)--- Add to global DraftSchematics table
