...
dressRobe = Object:new {

   objectName = "Dress Robe",
   stfName = "jacket_s22",
   ...
   tanoAttributes = "objecttype=16777229:objectcrc=2056672504:objecttemp=jacket_s22:templatetype=wearables_name:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(dressRobe, 344325830)--- Add to global DraftSchematics table
