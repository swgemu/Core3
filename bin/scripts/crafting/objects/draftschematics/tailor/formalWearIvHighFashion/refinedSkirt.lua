...
refinedSkirt = Object:new {

   objectName = "Refined Skirt",
   stfName = "skirt_s12",
   ...
   tanoAttributes = "objecttype=16777234:objectcrc=1957858149:stfFile=wearables_name:stfName=skirt_s12:stfDetail=:itemmask=62974::",
...
DraftSchematics:addDraftSchematic(refinedSkirt, 669321022)--- Add to global DraftSchematics table
