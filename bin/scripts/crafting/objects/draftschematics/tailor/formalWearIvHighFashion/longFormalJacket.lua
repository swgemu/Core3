...
longFormalJacket = Object:new {

   objectName = "Long Formal Jacket",
   stfName = "jacket_s03",
   stfFile = "wearables_name",
   objectCRC = 1809351611,
...
DraftSchematics:addDraftSchematic(longFormalJacket, 1809351611)--- Add to global DraftSchematics table
