...
ithorianJazzyJacket = Object:new {

   objectName = "Ithorian Jazzy Jacket",
   stfName = "ith_jacket_s04",
   stfFile = "wearables_name",
   objectCRC = 2294084604,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=2729956218:stfFile=wearables_name:stfName=clothing_ith_jacket_formal_04:stfDetail=:itemmask=63491::",
...
DraftSchematics:addDraftSchematic(ithorianJazzyJacket, 2294084604)--- Add to global DraftSchematics table
