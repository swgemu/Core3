...
decorativeVest = Object:new {

   objectName = "Decorative Vest",
   stfName = "vest_s15",
   stfFile = "wearables_name",
   objectCRC = 1886364161,
   ...
   tanoAttributes = "objecttype=16777231:objectcrc=189316971:stfFile=wearables_name:stfName=vest_s15:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(decorativeVest, 1886364161)--- Add to global DraftSchematics table
