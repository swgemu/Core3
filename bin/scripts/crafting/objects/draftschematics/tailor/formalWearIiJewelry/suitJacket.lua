...
suitJacket = Object:new {

   objectName = "Suit Jacket",
   stfName = "jacket_s11",
   stfFile = "wearables_name",
   objectCRC = 3807003097,
   ...
   tanoAttributes = "objecttype=16777227:objectcrc=2365189095:stfFile=wearables_name:stfName=jacket_s11:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(suitJacket, 3807003097)--- Add to global DraftSchematics table
