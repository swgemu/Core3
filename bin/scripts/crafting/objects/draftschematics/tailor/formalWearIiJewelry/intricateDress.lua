...
intricateDress = Object:new {

   objectName = "Intricate Dress",
   stfName = "dress_s32",
   stfFile = "wearables_name",
   objectCRC = 4222145966,
   ...
   tanoAttributes = "objecttype=16777223:objectcrc=3138755211:stfFile=wearables_name:stfName=dress_s32:stfDetail=:itemmask=62974::",
...
DraftSchematics:addDraftSchematic(intricateDress, 4222145966)--- Add to global DraftSchematics table
