...
bakeMastersCap = Object:new {

   objectName = "Bake Master's Cap",
   stfFile = "wearables_name",
   stfDetail = "wearables_detail",
   stfName = "hat_chef_s02",
   objectCRC = 243046663,
   ...
   tanoAttributes = "objecttype=16777226:objectcrc=662710978:stfFile=wearables_name:stfName=hat_chef_s02:stfDetail=wearables_detail:itemmask=62975:customattributes=:",
...
DraftSchematics:addDraftSchematic(bakeMastersCap, 243046663)--- Add to global DraftSchematics table
