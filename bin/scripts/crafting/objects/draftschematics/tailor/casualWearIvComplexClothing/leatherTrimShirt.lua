...
leatherTrimShirt = Object:new {

   objectName = "Leather Trim Shirt",
   stfName = "shirt_s30",
   stfFile = "wearables_name",
   objectCRC = 2904479442,
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=2327223277:stfFile=wearables_name:stfName=shirt_s30:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(leatherTrimShirt, 2904479442)--- Add to global DraftSchematics table
