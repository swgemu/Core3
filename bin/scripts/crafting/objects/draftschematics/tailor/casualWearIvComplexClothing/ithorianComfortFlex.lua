...
ithorianComfortFlex = Object:new {

   objectName = "Ithorian Comfort-Flex",
   stfName = "ith_bodysuit_s01",
...
DraftSchematics:addDraftSchematic(ithorianComfortFlex, 64848637)--- Add to global DraftSchematics table
