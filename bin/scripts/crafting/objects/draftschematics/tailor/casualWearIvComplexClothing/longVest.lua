...
longVest = Object:new {
   ...
   objectName = "Long Vest",
   stfName = "vest_s11",
   stfFile = "wearables_name",
   objectCRC = 4181934764,
   ...
   tanoAttributes = "objecttype=16777231:objectcrc=733756648:stfFile=wearables_name:stfName=vest_s11:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(longVest, 4181934764)--- Add to global DraftSchematics table
