...
woolyShirt = Object:new {

   objectName = "Wooly Shirt",
   stfName = "shirt_s11",
   stfFile = "wearables_name",
   objectCRC = 3527650223,
   ...
   tanoAttributes = "objecttype=16777230:objectcrc=4125877904:stfFile=wearables_name:stfName=shirt_s11:stfDetail=:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(woolyShirt, 3527650223)--- Add to global DraftSchematics table
