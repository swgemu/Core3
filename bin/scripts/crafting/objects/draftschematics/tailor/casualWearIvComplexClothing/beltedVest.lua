...
beltedVest = Object:new {

   objectName = "Belted Vest",
   stfFile = "wearables_name",
   stfDetail = "wearables_detail",
   stfName = "vest_s01",
   objectCRC = 3798683604,
   ...
   tanoAttributes = "objecttype=16777231:objectcrc=815018384:stfFile=wearables_name:stfName=vest_s01:stfDetail=wearables_detail:itemmask=62975:customattributes=:",
...
DraftSchematics:addDraftSchematic(beltedVest, 3798683604)--- Add to global DraftSchematics table
