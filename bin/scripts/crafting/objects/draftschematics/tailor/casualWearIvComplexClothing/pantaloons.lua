...
pantaloons = Object:new {

   objectName = "Pantaloons",
   stfName = "pants_s24",
   stfFile = "wearables_name",
   objectCRC = 2375441148,
   ...
   tanoAttributes = "objecttype=16777228:objectcrc=1960275860:objecttemp=pants_s24:templatetype=wearables_name:itemmask=62975::",
...
DraftSchematics:addDraftSchematic(pantaloons, 2375441148)--- Add to global DraftSchematics table
