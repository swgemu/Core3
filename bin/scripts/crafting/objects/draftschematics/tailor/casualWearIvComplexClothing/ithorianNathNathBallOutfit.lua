...
ithorianNathNathBallOutfit = Object:new {

   objectName = "Ithorian Nath-Nath Ball Outfit",
   stfName = "ith_bodysuit_s05",
...
DraftSchematics:addDraftSchematic(ithorianNathNathBallOutfit, 589889918)--- Add to global DraftSchematics table
