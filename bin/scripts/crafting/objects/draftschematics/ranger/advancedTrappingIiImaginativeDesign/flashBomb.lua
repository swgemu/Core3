...
flashBomb = Object:new {
   ...
   tanoAttributes = "objecttype=8212:objectcrc=708754512:stfFile=item_n:stfName=trap_flash_bomb:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(flashBomb, 1322113998)--- Add to global DraftSchematics table
