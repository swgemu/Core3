...
camoKitRori = Object:new {

   objectName = "Camo Kit: Rori",
   stfFile = "item_n",
   stfDetail = "item_d",
   stfName = "camokit_rori",
   objectCRC = 380917503,
   ...
   tanoAttributes = "objecttype=8232:objectcrc=2868366256:stfFile=item_n:stfName=camokit_rori:stfDetail=item_d:itemmask=65535:customattributes=:",
...
DraftSchematics:addDraftSchematic(camoKitRori, 380917503)--- Add to global DraftSchematics table
