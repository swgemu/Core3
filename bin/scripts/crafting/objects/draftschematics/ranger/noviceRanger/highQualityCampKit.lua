...
highQualityCampKit = Object:new {
   ...
   tanoAttributes = "objecttype=32772:objectcrc=3484724123:stfFile=item_n:stfName=camp_quality:stfDetail=:itemmask=65535::",
...
DraftSchematics:addDraftSchematic(highQualityCampKit, 1609906001)--- Add to global DraftSchematics table
