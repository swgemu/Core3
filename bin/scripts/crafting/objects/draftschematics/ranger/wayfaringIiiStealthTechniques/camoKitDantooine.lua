...
camoKitDantooine = Object:new {
   ...
   objectName = "Camo Kit: Dantooine",
   stfFile = "item_n",
   stfDetail = "item_d",
   stfName = "camokit_dantooine",
   objectCRC = 1726167672,
   ...
   tanoAttributes = "objecttype=8232:objectcrc=1054553582:stfFile=item_n:stfName=camokit_dantooine:stfDetail=item_d:itemmask=65535:customattributes=:",
...
DraftSchematics:addDraftSchematic(camoKitDantooine, 1726167672)--- Add to global DraftSchematics table
