...
chemicalReleaseDurationMechanism = Object:new {

   objectName = "Chemical Release Duration Mechanism", -- name of the lua Object
   stfName = "release_mech_duration", 
   objectCRC = 756180985, 
   ...
   experimentalProperties = "XX, XX, OQ, UT",
   experimentalWeights = "1, 1, 2, 1",
   experimentalGroupTitles = "exp_charges",
   ...
   attributesMinMax = "1, 37"

}

DraftSchematics:addDraftSchematic(chemicalReleaseDurationMechanism, 756180985)--- Add to global DraftSchematics table
