...
actionWoundMedpackA = Object:new {

   objectName = "Action Wound Medpack  A", -- name of the lua Object
   stfName = "medpack_wound_action_a", 
   objectCRC = 1923718175, 
   ...
   attributesMinMax = "1, 10, 1, 50, 5, 5, 4, 4"

}

DraftSchematics:addDraftSchematic(actionWoundMedpackA, 1923718175)--- Add to global DraftSchematics table
