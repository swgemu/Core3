...
--RunDraftSchematicFile("objects/draftschematics/chef/main.lua")
--RunDraftSchematicFile("objects/draftschematics/combatMedic/main.lua")
--RunDraftSchematicFile("objects/draftschematics/doctor/main.lua")
--RunDraftSchematicFile("objects/draftschematics/droidEngineer/main.lua")
--RunDraftSchematicFile("objects/draftschematics/entertainer/main.lua")
--RunDraftSchematicFile("objects/draftschematics/forceProgression/main.lua")
--RunDraftSchematicFile("objects/draftschematics/jediPadawan/main.lua")
--RunDraftSchematicFile("objects/draftschematics/lightsaber/main.lua")
