...
--MERCmeatlumpTABILITY or FITNESS FOR A PARTICULAR PURPOSE. 
...
--license (or modified versions of such code, with uncmeatlumpged license). 
...
AddRandomPoolAttackTargetSkill(meatlumpAttack1)
