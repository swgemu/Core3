...
--MERCmonumenterTABILITY or FITNESS FOR A PARTICULAR PURPOSE. 
...
--license (or modified versions of such code, with uncmonumenterged license). 
...
AddRandomPoolAttackTargetSkill(monumenterAttack1)
