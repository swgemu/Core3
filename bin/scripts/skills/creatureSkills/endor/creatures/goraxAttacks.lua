...
AddRandomPoolAttackTargetSkill(goraxAttack1)

-----------------------------------------------

goraxAttack2 = {
	attackname = "goraxAttack2",
	animation = "creature_attack_light",
...
AddRandomPoolAttackTargetSkill(goraxAttack5)
