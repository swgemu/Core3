...
rebelFirstLieutenantAttack1 = { 
	attackname = "rebelFirstLieutenantAttack1",
...
AddDotPoolAttackTargetSkill(rebelFirstLieutenantAttack1)

-----------------------------------------------------------------------

rebelFirstLieutenantAttack2 = { 
	attackname = "rebelFirstLieutenantAttack2",
...
AddRandomPoolAttackTargetSkill(rebelFirstLieutenantAttack2)
