...
rebelSergeantMajorAttack1 = { 
	attackname = "rebelSergeantMajorAttack1",
...
AddDotPoolAttackTargetSkill(rebelSergeantMajorAttack1)

-----------------------------------------------------------------------

rebelSergeantMajorAttack2 = { 
	attackname = "rebelSergeantMajorAttack2",
...
AddRandomPoolAttackTargetSkill(rebelSergeantMajorAttack2)
