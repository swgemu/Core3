...
rebelHighGeneralAttack1 = { 
	attackname = "rebelHighGeneralAttack1",
...
AddDotPoolAttackTargetSkill(rebelHighGeneralAttack1)

-----------------------------------------------------------------------

rebelHighGeneralAttack2 = { 
	attackname = "rebelHighGeneralAttack2",
...
AddRandomPoolAttackTargetSkill(rebelHighGeneralAttack2)
