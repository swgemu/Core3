...
imperialStormTrooperNovaTrooperCommanderAttack1 = {
	attackname = "imperialStormTrooperNovaTrooperCommanderAttack1",
...
AddRandomPoolAttackTargetSkill(imperialStormTrooperNovaTrooperCommanderAttack1)
