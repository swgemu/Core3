...
imperialStormTrooperNovaTrooperCaptainAttack1 = {
	attackname = "imperialStormTrooperNovaTrooperCaptainAttack1",
...
AddRandomPoolAttackTargetSkill(imperialStormTrooperNovaTrooperCaptainAttack1)
