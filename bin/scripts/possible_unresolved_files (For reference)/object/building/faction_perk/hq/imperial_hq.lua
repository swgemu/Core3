...
object_building_faction_perk_hq_hq_s05_imp = object_building_faction_perk_hq_shared_hq_s05_imp:new {
		lotSize = 1,
		maintenanceCost = 1337,
		allowedZones = {0,1,4,5,6,7,8}
}

ObjectTemplates:addTemplate(object_building_faction_perk_hq_hq_s05_imp, "object/building/faction_perk/hq/hq_s05_imp.iff")
