...
jindaShaman = Creature:new {
	objectName = "jindaShaman",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Jinda Tribe",
	gender = "",

	speciesName = "jinda_shaman",
...
Creatures:addCreature(jindaShaman, 2886364858) --  Add to Global Table
