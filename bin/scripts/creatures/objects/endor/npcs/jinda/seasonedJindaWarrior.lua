...
seasonedJindaWarrior = Creature:new {
	objectName = "seasonedJindaWarrior",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Jinda Tribe",
	gender = "",

	speciesName = "seasoned_jinda_warrior",
...
Creatures:addCreature(seasonedJindaWarrior, 2886364858) --  Add to Global Table
