...
weatheredJindaShaman = Creature:new {
	objectName = "weatheredJindaShaman",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Jinda Tribe",
	gender = "",

	speciesName = "weathered_jinda_shaman",
...
Creatures:addCreature(weatheredJindaShaman, 2886364858) --  Add to Global Table
