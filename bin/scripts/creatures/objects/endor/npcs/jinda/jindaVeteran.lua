...
jindaVeteran = Creature:new {
	objectName = "jindaVeteran",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Jinda Tribe",
	gender = "",

	speciesName = "jinda_veteran",
...
Creatures:addCreature(jindaVeteran, 2886364858) --  Add to Global Table
