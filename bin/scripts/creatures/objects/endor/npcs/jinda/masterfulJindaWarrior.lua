...
masterfulJindaWarrior = Creature:new {
	objectName = "masterfulJindaWarrior",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Jinda Tribe",
	gender = "",

	speciesName = "masterful_jinda_warrior",
...
Creatures:addCreature(masterfulJindaWarrior, 242045215) --  Add to Global Table
