...
naiveJindaWorkling = Creature:new {
	objectName = "naiveJindaWorkling",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Jinda Tribe",
	gender = "",

	speciesName = "naive_jinda_workling",
...
Creatures:addCreature(naiveJindaWorkling, 2886364858) --  Add to Global Table
