...
jindaTribesman = Creature:new {
	objectName = "jindaTribesman",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Jinda Tribe",
	gender = "",

	speciesName = "jinda_tribesman",
...
Creatures:addCreature(jindaTribesman, 2886364858) --  Add to Global Table
