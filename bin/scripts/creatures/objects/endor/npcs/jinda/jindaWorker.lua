...
jindaWorker = Creature:new {
	objectName = "jindaWorker",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Jinda Tribe",
	gender = "",

	speciesName = "jinda_worker",
...
Creatures:addCreature(jindaWorker, 2886364858) --  Add to Global Table
