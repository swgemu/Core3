...
proficientJindaWorker = Creature:new {
	objectName = "proficientJindaWorker",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Jinda Tribe",
	gender = "",

	speciesName = "proficient_jinda_worker",
...
Creatures:addCreature(proficientJindaWorker, 2886364858) --  Add to Global Table
