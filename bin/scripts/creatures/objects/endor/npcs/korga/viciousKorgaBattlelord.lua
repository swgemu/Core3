...
viciousKorgaBattlelord = Creature:new {
	objectName = "viciousKorgaBattlelord",  -- Lua Object Name
	creatureType = "NPC",
	faction = "korga_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "vicious_korga_battlelord",
...
Creatures:addCreature(viciousKorgaBattlelord, 2350961206) --  Add to Global Table
