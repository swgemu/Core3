...
korgaAncient = Creature:new {
	objectName = "korgaAncient",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Korga Tribe",
	gender = "",

	speciesName = "korga_ancient",
...
Creatures:addCreature(korgaAncient, 2350961206) --  Add to Global Table
