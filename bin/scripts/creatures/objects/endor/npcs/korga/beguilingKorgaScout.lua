...
beguilingKorgaScout = Creature:new {
	objectName = "beguilingKorgaScout",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Korga Tribe",
	gender = "",

	speciesName = "beguiling_korga_scout",
...
Creatures:addCreature(beguilingKorgaScout, 2350961206) --  Add to Global Table
