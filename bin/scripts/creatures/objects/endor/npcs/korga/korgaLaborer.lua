...
korgaLaborer = Creature:new {
	objectName = "korgaLaborer",  -- Lua Object Name
	creatureType = "NPC",
	faction = "korga_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "korga_laborer",
...
Creatures:addCreature(korgaLaborer, 2350961206) --  Add to Global Table
