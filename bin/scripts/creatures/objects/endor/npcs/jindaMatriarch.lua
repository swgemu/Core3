...
jindaMatriarch = Creature:new {
      objectName = "jindaMatriarch",  -- Lua Object Name
      creatureType = "NPC",
      faction = "Jinda Tribe",
      gender = "",

      name = "Jinda matriarch",
...
Creatures:addCreature(jindaMatriarch, 1346681647) --  Add to Global Table
