...
merekDeathsHead = Creature:new {
	objectName = "merekDeathsHead",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "merek_deaths_head",
...
Creatures:addCreature(merekDeathsHead, 21982066) --  Add to Global Table
