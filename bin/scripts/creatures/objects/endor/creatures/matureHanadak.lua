...
matureHanadak = Creature:new {
	objectName = "matureHanadak",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "mature_hanadak",
...
Creatures:addCreature(matureHanadak, 737828942) --  Add to Global Table
