...
arachneWebmaster = Creature:new {
	objectName = "arachneWebmaster",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "arachne_webmaster",
...
Creatures:addCreature(arachneWebmaster, 1157055229) --  Add to Global Table
