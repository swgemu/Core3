...
mantigrueInsaneBerserker = Creature:new {
	objectName = "mantigrueInsaneBerserker",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(mantigrueInsaneBerserker, 4249958797) --  Add to Global Table
