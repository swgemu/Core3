...
lanternBird = Creature:new {
	objectName = "lanternBird",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "lantern_bird",
...
Creatures:addCreature(lanternBird, 1183906554) --  Add to Global Table
