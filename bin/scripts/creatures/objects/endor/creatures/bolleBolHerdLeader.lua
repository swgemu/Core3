...
bolleBolHerdLeader = Creature:new {
	objectName = "bolleBolHerdLeader",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "bolle_bol_herd_leader",
...
Creatures:addCreature(bolleBolHerdLeader, 2905349573) --  Add to Global Table
