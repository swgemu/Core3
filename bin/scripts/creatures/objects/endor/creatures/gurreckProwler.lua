...
gurreckProwler = Creature:new {
	objectName = "gurreckProwler",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "gurreck_prowler",
...
Creatures:addCreature(gurreckProwler, 1386599736) --  Add to Global Table
