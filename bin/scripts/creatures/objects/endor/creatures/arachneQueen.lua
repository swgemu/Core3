...
arachneQueen = Creature:new {
	objectName = "arachneQueen",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "queen_arachne",
...
Creatures:addCreature(arachneQueen, 1157055229) --  Add to Global Table
