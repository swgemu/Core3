...
mantigrueReaper = Creature:new {
	objectName = "mantigrueReaper",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "mantigrue_reaper",
...
Creatures:addCreature(mantigrueReaper, 1684536430) --  Add to Global Table
