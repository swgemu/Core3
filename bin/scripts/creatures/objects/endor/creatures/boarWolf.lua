...
boarWolf = Creature:new {
	objectName = "boarWolf",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "boar_wolf",
...
Creatures:addCreature(boarWolf, 1815686462) --  Add to Global Table
