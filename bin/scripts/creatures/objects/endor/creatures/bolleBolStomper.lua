...
bolleBolStomper = Creature:new {
      objectName = "bolleBolStomper",  -- Lua Object Name
      creatureType = "ANIMAL",
      faction = "Bolle Bol",
      gender = "",

      name = "a Bolle Bol Stomper",
...
Creatures:addCreature(bolleBolStomper, 2905349573) --  Add to Global Table
