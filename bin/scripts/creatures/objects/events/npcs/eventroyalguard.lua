...
eventroyalguard = Creature:new {
      objectName = "eventroyalguard",  -- Lua Object Name
      creatureType = "NPC",
      faction = "Imperial",
      gender = "",

      stfName = "Royal Imperial Guard",
      objectCRC = 4225004735, 
      ...
      lootGroup = 0,50, -- Group it belongs to for loot
...
Creatures:addCreature(eventroyalguard, 4225004735) --  Add to Global Table
