...
eventpalpatine = Creature:new {
      objectName = "eventpalpatine",  -- Lua Object Name
      creatureType = "NPC",
      faction = "Imperial",
      gender = "",

      stfName = "Emporer Palpatine",
...
Creatures:addCreature(eventpalpatine, 3254768126) --  Add to Global Table
