...
grizzledBarkMite = Creature:new {
	objectName = "grizzledBarkMite",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
	...
	skills = { "barkMiteAttack7", "barkMiteAttack3" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(grizzledBarkMite, 2318119001) --  Add to Global Table
