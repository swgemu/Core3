...
tortonPygmyMatriarch = Creature:new {
	objectName = "tortonPygmyMatriarch",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "torton_pygmy_matriarch",
...
Creatures:addCreature(tortonPygmyMatriarch, 2343686181) --  Add to Global Table
