...
tortonPygmyAdolescent = Creature:new {
	objectName = "tortonPygmyAdolescent",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "torton_pygmy_adolescent",
...
Creatures:addCreature(tortonPygmyAdolescent, 2343686181) --  Add to Global Table
