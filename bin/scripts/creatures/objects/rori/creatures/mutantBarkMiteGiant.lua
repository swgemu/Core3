...
mutantBarkMiteGiant = Creature:new {
	objectName = "mutantBarkMiteGiant",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "mutant_bark_mite_giant",
...
Creatures:addCreature(mutantBarkMiteGiant, 1247872509) --  Add to Global Table
