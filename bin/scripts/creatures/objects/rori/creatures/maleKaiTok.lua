...
maleKaiTok = Creature:new {
	objectName = "maleKaiTok",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
	...
	skills = { "kaiTokAttack3", "kaiTokAttack2" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(maleKaiTok, 1823266132) --  Add to Global Table
