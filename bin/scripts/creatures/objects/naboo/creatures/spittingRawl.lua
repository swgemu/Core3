...
spittingRawl = Creature:new {
	...
	--skills = { " Ranged attack (spit)", " Poison attack (strong)", " Blind attack" }
	skills = { "rawlAttack3", "rawlAttack2", "rawlAttack4" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(spittingRawl, 304357171) --  Add to Global Table
