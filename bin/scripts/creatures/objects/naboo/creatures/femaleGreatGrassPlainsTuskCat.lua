...
femaleGreatGrassPlainsTuskCat = Creature:new {
	objectName = "femaleGreatGrassPlainsTuskCat",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "female",
...
Creatures:addCreature(femaleGreatGrassPlainsTuskCat, 2922712105) --  Add to Global Table
