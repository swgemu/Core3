...
alphaVeermok = Creature:new {
	objectName = "alphaVeermok",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "alpha_veermok",
...
Creatures:addCreature(alphaVeermok, 873755149) --  Add to Global Table
