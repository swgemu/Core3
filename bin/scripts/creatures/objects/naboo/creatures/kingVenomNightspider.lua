...
kingVenomNightspider = Creature:new {
	objectName = "kingVenomNightspider",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(kingVenomNightspider, 894333200) --  Add to Global Table
