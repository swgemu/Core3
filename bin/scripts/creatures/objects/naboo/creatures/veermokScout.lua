...
veermokScout = Creature:new {
	objectName = "veermokScout",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "veermok_scout",
...
Creatures:addCreature(veermokScout, 798042116) --  Add to Global Table
