...
bachelorGualama = Creature:new {
	objectName = "bachelorGualama",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(bachelorGualama, 2511253817) --  Add to Global Table
