...
veermokHunter = Creature:new {
	objectName = "veermokHunter",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "veermok_hunter",
...
Creatures:addCreature(veermokHunter, 798042116) --  Add to Global Table
