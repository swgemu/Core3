...
imperialStaffCorporal = Creature:new {
	objectName = "imperialStaffCorporal",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",
	...
	skills = { "imperialStaffCorporalAttack1" },
	respawnTimer = 180,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(imperialStaffCorporal, 2701430666) --  Add to Global Table
