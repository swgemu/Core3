...
imperialCivilPatrolCaptain = Creature:new {
	objectName = "imperialCivilPatrolCaptain",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",
	...
	skills = { "imperialCivilPatrolCaptainAttack1" },
	respawnTimer = 180,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(imperialCivilPatrolCaptain, 152421728) --  Add to Global Table
