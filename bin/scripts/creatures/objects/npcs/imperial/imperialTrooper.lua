...
imperialTrooper = Creature:new {
	objectName = "imperialTrooper",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	speciesName = "imperial_trooper",
	...
	skills = { "imperialTrooperAttack1" },
	respawnTimer = 180,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(imperialTrooper, 1623607949) --  Add to Global Table
