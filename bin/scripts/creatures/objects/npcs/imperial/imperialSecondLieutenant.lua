...
imperialSecondLieutenant = Creature:new {
	objectName = "imperialSecondLieutenant",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a ed Imperial Second Lieutenant", 
...
Creatures:addCreature(imperialSecondLieutenant, 3317919928) --  Add to Global Table
