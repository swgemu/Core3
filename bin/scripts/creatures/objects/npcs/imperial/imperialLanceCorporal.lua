...
imperialLanceCorporal = Creature:new {
	objectName = "imperialLanceCorporal",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a ed Imperial Lance Corporal", 
...
Creatures:addCreature(imperialLanceCorporal, 2701430666) --  Add to Global Table
