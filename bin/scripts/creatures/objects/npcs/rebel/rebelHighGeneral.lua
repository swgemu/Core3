...
rebelHighGeneral = Creature:new {
	objectName = "rebelHighGeneral",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",
	...
	skills = { "rebelHighGeneralAttack1", "rebelHighGeneralAttack2" },
	respawnTimer = 180,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(rebelHighGeneral, 1895884541) --  Add to Global Table
