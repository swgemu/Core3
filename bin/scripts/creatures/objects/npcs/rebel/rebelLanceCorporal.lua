...
rebelLanceCorporal = Creature:new {
	objectName = "rebelLanceCorporal",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	speciesName = "rebel_lance_corporal",
...
Creatures:addCreature(rebelLanceCorporal, 3527361510) --  Add to Global Table
