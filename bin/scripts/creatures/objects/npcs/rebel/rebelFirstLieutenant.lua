...
rebelFirstLieutenant = Creature:new {
	objectName = "rebelFirstLieutenant",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	speciesName = "rebel_first_lieutenant",
	stfName = "mob/creature_names", 
	objectCRC = 1053270126, 
	socialGroup = "Rebel",
	level = 20,
	...
	skills = { "rebelFirstLieutenantAttack1", "rebelFirstLieutenantAttack2" },
	respawnTimer = 180,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(rebelFirstLieutenant, 1053270126) --  Add to Global Table
