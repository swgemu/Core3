...
rebelSergeant = Creature:new {
	objectName = "rebelSergeant",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	speciesName = "rebel_sergeant",
	...
	skills = { "rebelSergeantAttack1", "rebelSergeantAttack2" },
	respawnTimer = 300,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(rebelSergeant, 4110720926) --  Add to Global Table
