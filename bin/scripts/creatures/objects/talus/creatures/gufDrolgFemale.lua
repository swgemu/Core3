...
gufDrolgFemale = Creature:new {
	objectName = "gufDrolgFemale",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "female",
...
Creatures:addCreature(gufDrolgFemale, 1297255033) --  Add to Global Table
