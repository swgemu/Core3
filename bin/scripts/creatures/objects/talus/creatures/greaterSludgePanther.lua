...
greaterSludgePanther = Creature:new {
	objectName = "greaterSludgePanther",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(greaterSludgePanther, 2403761131) --  Add to Global Table
