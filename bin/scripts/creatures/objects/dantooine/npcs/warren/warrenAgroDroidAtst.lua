...
warrenAgroDroidAtst = Creature:new {
	objectName = "warrenAgroDroidAtst",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Warren Cyborg",
	gender = "",

	speciesName = "warren_agro_droid_atst",
	...
	skills = { "warrenAttack1", "warrenAttack2" },
	respawnTimer = 180,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(warrenAgroDroidAtst, 2128352281) -- Add to Global Table
