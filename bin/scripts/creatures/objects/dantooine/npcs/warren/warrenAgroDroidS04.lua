...
warrenAgroDroidS04 = Creature:new {
	objectName = "warrenAgroDroidS04",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Warren Teraud",
	gender = "",

	speciesName = "warren_agro_droid_s04",
...
Creatures:addCreature(warrenAgroDroidS04, 162667025) -- Add to Global Table
