...
jantaHarvester = Creature:new {
      objectName = "jantaHarvester",  -- Lua Object Name
      creatureType = "NPC",
      faction = "Janla Tribe",
      gender = "",

      name = "Janta harvester",
      objectCRC = 4083847450, 
      socialGroup = "Janla Tribe",
      named = FALSE, 
...
Creatures:addCreature(jantaHarvester, 4083847450) --  Add to Global Table
