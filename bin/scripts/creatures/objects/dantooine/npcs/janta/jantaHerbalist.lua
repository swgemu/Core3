...
jantaHerbalist = Creature:new {
	objectName = "jantaHerbalist",  -- Lua Object Name
	creatureType = "NPC",
	faction = "janta_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "janta_herbalist",
	...
	alternateWeaponMinDamage = 305,
	alternateWeaponMaxDamage = 320,
...
Creatures:addCreature(jantaHerbalist, 4083847450) --  Add to Global Table
