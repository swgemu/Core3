...
jantaRockshaper = Creature:new {
	objectName = "jantaRockshaper",  -- Lua Object Name
	creatureType = "NPC",
	faction = "janta_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "janta_rockshaper",
	...
	alternateWeaponMinDamage = 495,
	alternateWeaponMaxDamage = 700,
...
Creatures:addCreature(jantaRockshaper, 4083847450) --  Add to Global Table
