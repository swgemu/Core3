...
jantaHunter = Creature:new {
	objectName = "jantaHunter",  -- Lua Object Name
	creatureType = "NPC",
	faction = "janta_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "janta_hunter",
	...
	alternateWeaponMinDamage = 415,
	alternateWeaponMaxDamage = 540,
...
Creatures:addCreature(jantaHunter, 4083847450) --  Add to Global Table
