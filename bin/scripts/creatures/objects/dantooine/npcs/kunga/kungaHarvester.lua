...
kungaHarvester = Creature:new {
	objectName = "kungaHarvester",  -- Lua Object Name
	creatureType = "NPC",
	faction = "kunga_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "kunga_harvester",
	...
	alternateWeaponMinDamage = 260,
	alternateWeaponMaxDamage = 270,
...
Creatures:addCreature(kungaHarvester, 4083847450) --  Add to Global Table
