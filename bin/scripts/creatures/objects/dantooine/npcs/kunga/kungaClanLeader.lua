...
kungaClanLeader = Creature:new {
	objectName = "kungaClanLeader",  -- Lua Object Name
	creatureType = "NPC",
	faction = "kunga_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "kunga_clan_leader",
...
Creatures:addCreature(kungaClanLeader, 4083847450) --  Add to Global Table
