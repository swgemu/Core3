...
kungaWarrior = Creature:new {
	objectName = "kungaWarrior",  -- Lua Object Name
	creatureType = "NPC",
	faction = "kunga_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "kunga_warrior",
...
Creatures:addCreature(kungaWarrior, 4083847450) --  Add to Global Table
