...
kungaHunter = Creature:new {
	objectName = "kungaHunter",  -- Lua Object Name
	creatureType = "NPC",
	faction = "kunga_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "kunga_hunter",
...
Creatures:addCreature(kungaHunter, 4083847450) --  Add to Global Table
