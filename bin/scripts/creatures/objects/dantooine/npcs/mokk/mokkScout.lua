...
mokkScout = Creature:new {
	objectName = "mokkScout",  -- Lua Object Name
	creatureType = "NPC",
	faction = "mokk_tribe", 
	factionPoints = 20,
	gender = "",

	speciesName = "mokk_scout",
...
Creatures:addCreature(mokkScout, 4083847450) --  Add to Global Table
