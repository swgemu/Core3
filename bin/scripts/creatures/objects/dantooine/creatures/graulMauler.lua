...
graulMauler = Creature:new {
	objectName = "graulMauler",  -- Lua Object Name
	creatureType = "ANIMAL",
	faction = "Graul",
	gender = "",

	speciesName = "graul_mauler",
...
Creatures:addCreature(graulMauler, 3456488947) --  Add to Global Table
