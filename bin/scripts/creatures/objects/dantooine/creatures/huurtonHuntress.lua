...
huurtonHuntress = Creature:new {
	objectName = "huurtonHuntress",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "huurton_huntress",
...
Creatures:addCreature(huurtonHuntress, 3338559238) --  Add to Global Table
