...
warrenThune = Creature:new {
	objectName = "warrenThune",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "warren_thune",
...
Creatures:addCreature(warrenThune, 2682548889) --  Add to Global Table
