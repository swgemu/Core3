...
thuneGrasslandGuardian = Creature:new {
	objectName = "thuneGrasslandGuardian",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(thuneGrasslandGuardian, 2147765074) --  Add to Global Table
