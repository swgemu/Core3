...
savageQuenker = Creature:new {
	objectName = "savageQuenker",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "savage_quenker",
...
Creatures:addCreature(savageQuenker, 894437668) --  Add to Global Table
