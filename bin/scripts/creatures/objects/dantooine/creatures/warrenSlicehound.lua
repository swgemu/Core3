...
warrenSlicehound = Creature:new {
	objectName = "warrenSlicehound",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "warren_slicehound",
...
Creatures:addCreature(warrenSlicehound, 3500363411) --  Add to Global Table
