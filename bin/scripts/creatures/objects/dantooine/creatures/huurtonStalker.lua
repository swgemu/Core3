...
huurtonStalker = Creature:new {
	objectName = "huurtonStalker",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "huurton_stalker",
...
Creatures:addCreature(huurtonStalker, 3338559238) --  Add to Global Table
