...
voritorLizard = Creature:new {
	objectName = "voritorLizard",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
	...
	skills = { "voritorAttack5", "voritorAttack6" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(voritorLizard, 1766827549) --  Add to Global Table
