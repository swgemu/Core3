...
warrenCyborgHuurton = Creature:new {
	objectName = "warrenCyborgHuurton",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "warren_cyborg_huurton",
...
Creatures:addCreature(warrenCyborgHuurton, 3011024511) --  Add to Global Table
