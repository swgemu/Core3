...
corvetteRebelEnsign = Creature:new {
	objectName = "corvetteRebelEnsign",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",
...
Creatures:addCreature(corvetteRebelEnsign, 2508023537) --  Add to Global Table
