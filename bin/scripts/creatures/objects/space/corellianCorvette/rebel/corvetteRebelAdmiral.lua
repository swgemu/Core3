...
corvetteRebelAdmiral = Creature:new {
	objectName = "corvetteRebelAdmiral",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",
...
Creatures:addCreature(corvetteRebelAdmiral, 3089637617) -- Add to Global Table
