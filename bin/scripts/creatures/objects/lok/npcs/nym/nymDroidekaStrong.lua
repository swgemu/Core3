...
nymDroidekaStrong = Creature:new {
	objectName = "nymDroidekaStrong",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Nym",
	gender = "",

	speciesName = "nym_droideka_strong",
...
Creatures:addCreature(nymDroidekaStrong, 2412922465) -- Add to Global Table
