...
gorgeVesp = Creature:new {
	objectName = "gorgeVesp",  -- Lua Object Name
	creatureType = "ANIMAL",
	faction = "Vesp",
	gender = "",

	speciesName = "gorge_vesp",
	...
	skills = { "vespAttack3", "vespAttack2", "vespAttack4" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(gorgeVesp, 3698435149) --  Add to Global Table
