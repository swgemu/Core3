...
langlatchMale = Creature:new {
	objectName = "langlatchMale",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "male",

	speciesName = "langlatch_male",
...
Creatures:addCreature(langlatchMale, 2513300255) --  Add to Global Table
