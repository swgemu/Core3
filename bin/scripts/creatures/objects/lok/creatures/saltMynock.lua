...
saltMynock = Creature:new {
	objectName = "saltMynock",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
	...
	datapadItemCRC = 1986283606,
	datapadItemCRC = 2085682547,
	mountCRC = 0,
	mountSpeed = 0,
	mountAcceleration = 0,
...
Creatures:addCreature(saltMynock, 1848263825) --  Add to Global Table
