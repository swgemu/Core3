...
maleSnorbalCalf = Creature:new {
	objectName = "maleSnorbalCalf",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "male_snorbal_calf",
...
Creatures:addCreature(maleSnorbalCalf, 581977565) --  Add to Global Table
