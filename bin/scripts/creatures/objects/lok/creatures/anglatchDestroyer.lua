...
anglatchDestroyer = Creature:new {
      objectName = "anglatchDestroyer",  -- Lua Object Name
      creatureType = "ANIMAL",
      faction = "Langlatch",
      gender = "",

      name = "a Anglatch Destroyer",
...
Creatures:addCreature(anglatchDestroyer, 2513300255) --  Add to Global Table
