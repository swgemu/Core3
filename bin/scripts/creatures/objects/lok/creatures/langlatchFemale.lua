...
langlatchFemale = Creature:new {
	objectName = "langlatchFemale",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "female",

	speciesName = "langlatch_female",
...
Creatures:addCreature(langlatchFemale, 2513300255) --  Add to Global Table
