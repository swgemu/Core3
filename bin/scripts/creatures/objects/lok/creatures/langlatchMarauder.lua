...
langlatchMarauder = Creature:new {
	objectName = "langlatchMarauder",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "langlatch_marauder",
...
Creatures:addCreature(langlatchMarauder, 2513300255) --  Add to Global Table
