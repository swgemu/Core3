...
lordNyaxMinion = Creature:new {
      objectName = "lordNyaxMinion",  -- Lua Object Name
      creatureType = "NPC",
      faction = "Lord Nyax",
      gender = "",

      name = "minion of Lord Nyax",
...
Creatures:addCreature(lordNyaxMinion, 1086114556) --  Add to Global Table
