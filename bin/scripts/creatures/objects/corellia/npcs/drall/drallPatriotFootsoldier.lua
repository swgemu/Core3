...
drallPatriotFootsoldier = Creature:new {
	objectName = "drallPatriotFootsoldier",  -- Lua Object Name
	creatureType = "NPC",
	faction = "drall", 
	factionPoints = 20,
	gender = "",

	speciesName = "drall_patriot_footsoldier",
...
Creatures:addCreature(drallPatriotFootsoldier, 3116494340) --  Add to Global Table
