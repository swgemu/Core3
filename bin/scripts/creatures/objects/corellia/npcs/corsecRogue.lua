...
corsecRogue = Creature:new {
      objectName = "corsecRogue",  -- Lua Object Name
      creatureType = "NPC",
      faction = "Rogue Corsec",
      gender = "",

      name = "rogue CorSec trooper",
...
Creatures:addCreature(corsecRogue, 3630538207) --  Add to Global Table
