...
monumenterBandit = Creature:new {
	objectName = "monumenterBandit",  -- Lua Object Name
	creatureType = "NPC",
	faction = "monumenter", 
	factionPoints = 20,
	gender = "",

	speciesName = "monumenter_bandit",
...
Creatures:addCreature(monumenterBandit, 00000000000) -- Add to Global Table
