...
monumenterSmuggler = Creature:new {
	objectName = "monumenterSmuggler",  -- Lua Object Name
	creatureType = "NPC",
	faction = "monumenter", 
	factionPoints = 20,
	gender = "",

	speciesName = "monumenter_smuggler",
...
Creatures:addCreature(monumenterSmuggler, 00000000000) -- Add to Global Table
