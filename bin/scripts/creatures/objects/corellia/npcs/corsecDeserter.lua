...
corsecDeserter = Creature:new {
      objectName = "corsecDeserter",  -- Lua Object Name
      creatureType = "NPC",
      faction = "Rogue Corsec",
      gender = "",

      name = "CorSec deserter",
...
Creatures:addCreature(corsecDeserter, 3630538207) --  Add to Global Table
