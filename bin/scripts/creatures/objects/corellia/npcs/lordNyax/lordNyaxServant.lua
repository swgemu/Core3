...
lordNyaxServant = Creature:new {
	objectName = "lordNyaxServant",  -- Lua Object Name
	creatureType = "NPC",
	faction = "followers_of_lord_nyax", 
	factionPoints = 20,
	gender = "",

	speciesName = "lord_nyax_servant",
...
Creatures:addCreature(lordNyaxServant, 2873284654) --  Add to Global Table
