...
afarathuCultSavage = Creature:new {
	objectName = "afarathuCultSavage",  -- Lua Object Name
	creatureType = "NPC",
	faction = "afarathu", 
	factionPoints = 20,
	gender = "",

	speciesName = "afarathu_cult_savage",
...
Creatures:addCreature(afarathuCultSavage, 3021148797) --  Add to Global Table
