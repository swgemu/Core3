...
corsecMasterSergeantAggro = Creature:new {
	objectName = "corsecMasterSergeantAggro",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Corsec [aggro]",
	gender = "",

	speciesName = "corsec_master_sergeant_aggro",
...
Creatures:addCreature(corsecMasterSergeantAggro, 466282881) -- Add to Global Table
