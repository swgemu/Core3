...
corsecLieutenantAggro = Creature:new {
	objectName = "corsecLieutenantAggro",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Corsec [aggro]",
	gender = "",

	speciesName = "corsec_lieutenant_aggro",
...
Creatures:addCreature(corsecLieutenantAggro, 3254959481) -- Add to Global Table
