...
corsecAgentAggro = Creature:new {
	objectName = "corsecAgentAggro",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Corsec [aggro]",
	gender = "",

	speciesName = "corsec_agent_aggro",
...
Creatures:addCreature(corsecAgentAggro, 3630538207) -- Add to Global Table
