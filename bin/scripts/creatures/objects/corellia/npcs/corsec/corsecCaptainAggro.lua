...
corsecCaptainAggro = Creature:new {
	objectName = "corsecCaptainAggro",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Corsec [aggro]",
	gender = "",

	speciesName = "corsec_captain_aggro",
...
Creatures:addCreature(corsecCaptainAggro, 466282881) -- Add to Global Table
