...
smashBallBully = Creature:new {
	objectName = "smashBallBully",  -- Lua Object Name
	creatureType = "NPC",
	faction = "smashball", 
	factionPoints = 20,
	gender = "",

	speciesName = "smashball_bully",
...
Creatures:addCreature(smashBallBully, 1527998977) -- Add to Global Table
