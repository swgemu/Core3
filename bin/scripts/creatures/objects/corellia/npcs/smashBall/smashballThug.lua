...
smashBallThug = Creature:new {
	objectName = "smashBallThug",  -- Lua Object Name
	creatureType = "NPC",
	faction = "smashball", 
	factionPoints = 20,
	gender = "",

	speciesName = "smashball_thug",
...
Creatures:addCreature(smashBallThug, 1527998977) -- Add to Global Table
