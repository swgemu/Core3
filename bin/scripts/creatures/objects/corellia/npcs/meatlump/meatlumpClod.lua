...
meatlumpClod = Creature:new {
	objectName = "meatlumpClod",  -- Lua Object Name
	creatureType = "NPC",
	faction = "meatlump", 
	factionPoints = 20,
	gender = "",

	speciesName = "meatlump_clod",
...
Creatures:addCreature(meatlumpClod, 2735939972) -- Add to Global Table
