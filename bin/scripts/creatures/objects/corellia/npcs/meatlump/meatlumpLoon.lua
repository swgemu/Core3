...
meatlumpLoon = Creature:new {
	objectName = "meatlumpLoon",  -- Lua Object Name
	creatureType = "NPC",
	faction = "meatlump", 
	factionPoints = 20,
	gender = "",

	speciesName = "meatlump_loon",
...
Creatures:addCreature(meatlumpLoon, 1633608178) -- Add to Global Table
