...
meatlumpCretin = Creature:new {
	objectName = "meatlumpCretin",  -- Lua Object Name
	creatureType = "NPC",
	faction = "meatlump", 
	factionPoints = 20,
	gender = "",

	speciesName = "meatlump_cretin",
...
Creatures:addCreature(meatlumpCretin, 3682831326) -- Add to Global Table
