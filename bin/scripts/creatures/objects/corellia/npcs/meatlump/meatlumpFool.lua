...
meatlumpFool = Creature:new {
	objectName = "meatlumpFool",  -- Lua Object Name
	creatureType = "NPC",
	faction = "meatlump", 
	factionPoints = 20,
	gender = "",

	speciesName = "meatlump_fool",
...
Creatures:addCreature(meatlumpFool, 296359878) -- Add to Global Table
