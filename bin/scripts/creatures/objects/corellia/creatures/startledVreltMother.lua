...
startledVreltMother = Creature:new {
	...
	--skills = { " Ranged attack (spit)", " Intimidation attack", " Knockdown attack" }
	skills = { "vreltAttack3", "vreltAttack5" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(startledVreltMother, 2882436158) --  Add to Global Table
