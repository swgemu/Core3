...
crimsonSandPanther = Creature:new {
	objectName = "crimsonSandPanther",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(crimsonSandPanther, 3569435698) --  Add to Global Table
