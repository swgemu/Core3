...
savageHumbaba = Creature:new {
	objectName = "savageHumbaba",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
	...
	skills = { "humbabaAttack2", "humbabaAttack3" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(savageHumbaba, 1217993661) --  Add to Global Table
