...
femaleForestSliceHound = Creature:new {
	objectName = "femaleForestSliceHound",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(femaleForestSliceHound, 2917464836) --  Add to Global Table
