...
juvenileCanyonKraytStress = Creature:new {
	objectName = "juvenileCanyonKraytStress",  -- Lua Object Name
	creatureType = "ANIMAL",
	faction = "Krayt Dragon",
	gender = "",

	stfName = "a stressed juvenile canyon krayt dragon",
	objectCRC = 899113216, 
...
Creatures:addCreature(juvenileCanyonKraytStress, 899113216) --  Add to Global Table
