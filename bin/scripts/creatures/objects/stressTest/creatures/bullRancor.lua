...
bullRancorStress = Creature:new {
	objectName = "bullRancorStress",  -- Lua Object Name
	creatureType = "ANIMAL",
	faction = "Rancor",
	gender = "",
	...
	tame = 0.001,  -- Likely hood to be tamed
...
Creatures:addCreature(bullRancorStress, 837719973) --  Add to Global Table
