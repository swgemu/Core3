...
rebelLanceCorporalStress = Creature:new {
	objectName = "rebelLanceCorporalStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Rebel Lance Corporal", 
...
Creatures:addCreature(rebelLanceCorporalStress, 3527361510) --  Add to Global Table
