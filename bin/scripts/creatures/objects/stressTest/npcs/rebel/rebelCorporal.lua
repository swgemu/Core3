...
rebelCorporalStress = Creature:new {
	objectName = "rebelCorporalStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Rebel corporal", 
...
Creatures:addCreature(rebelCorporalStress, 1281722081) --  Add to Global Table
