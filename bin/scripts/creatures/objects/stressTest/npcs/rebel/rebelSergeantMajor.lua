...
rebelSergeantMajorStress = Creature:new {
	objectName = "rebelSergeantMajorStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",
...
Creatures:addCreature(rebelSergeantMajorStress, 3881398557) --  Add to Global Table
