...
rebelWarrantOfficerIStress = Creature:new {
	objectName = "rebelWarrantOfficerIStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",
	...
	skills = { "rebelAttack52", "rebelAttack51", "rebelAttack54", "rebelAttack53", "rebelAttack55", "rebelAttack56", "rebelAttack57", "rebelAttack58" },
	respawnTimer = 180,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(rebelWarrantOfficerIStress, 3172332319) --  Add to Global Table
