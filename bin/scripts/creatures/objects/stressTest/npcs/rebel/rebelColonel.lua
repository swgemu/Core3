...
rebelColonelStress = Creature:new {
	objectName = "rebelColonelStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Rebel colonel",
...
Creatures:addCreature(rebelColonelStress, 1803030018) --  Add to Global Table
