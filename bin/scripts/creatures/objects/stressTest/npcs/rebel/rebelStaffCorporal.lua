...
rebelStaffCorporalStress = Creature:new {
	objectName = "rebelStaffCorporalStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	speciesName = "rebel_staff_corporal",
	...
	weapon = "object/draft_schematic/weapon/shared_rifle_light_blaster_laser_carbine.iff", -- File path to weapon -> object\xxx\xxx\xx
...
Creatures:addCreature(rebelStaffCorporalStress, 760067467) --  Add to Global Table
