...
rebelSergeantStress = Creature:new {
	objectName = "rebelSergeantStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Rebel Sergeant", 
...
Creatures:addCreature(rebelSergeantStress, 4110720926) --  Add to Global Table
