...
rebelLieutenantColonelStress = Creature:new {
	objectName = "rebelLieutenantColonelStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Rebel Lieutenant Colonel", 
...
Creatures:addCreature(rebelLieutenantColonelStress, 3658140104) --  Add to Global Table
