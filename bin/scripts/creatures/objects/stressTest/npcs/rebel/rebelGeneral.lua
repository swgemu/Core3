...
rebelGeneralStress = Creature:new {
	objectName = "rebelGeneralStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Rebel General", 
	objectCRC = 354934529, 
	socialGroup = "rebel",
...
Creatures:addCreature(rebelGeneralStress, 354934529) --  Add to Global Table
