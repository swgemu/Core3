...
rebelMajorStress = Creature:new {
	objectName = "rebelMajorStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Rebel Major", 
	objectCRC = 450207030, 
	socialGroup = "Rebel",
...
Creatures:addCreature(rebelMajorStress, 450207030) --  Add to Global Table
