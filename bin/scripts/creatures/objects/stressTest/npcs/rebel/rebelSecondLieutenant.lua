...
rebelSecondLieutenantStress = Creature:new {
	objectName = "rebelSecondLieutenantStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",
...
Creatures:addCreature(rebelSecondLieutenantStress, 2209774811) --  Add to Global Table
