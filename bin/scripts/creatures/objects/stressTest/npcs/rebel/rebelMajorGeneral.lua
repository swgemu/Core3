...
rebelMajorGeneralStress = Creature:new {
	objectName = "rebelMajorGeneralStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "rebel", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Rebel Major General", 
...
Creatures:addCreature(rebelMajorGeneralStress, 2341542693) --  Add to Global Table
