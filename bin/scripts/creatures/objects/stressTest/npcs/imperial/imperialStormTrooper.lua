...
imperialStormTrooperStress = Creature:new {
	objectName = "imperialStormTrooperStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",
...
Creatures:addCreature(imperialStormTrooperStress, 3128894413) --  Add to Global Table
