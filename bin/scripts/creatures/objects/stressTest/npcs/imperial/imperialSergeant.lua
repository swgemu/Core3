...
imperialSergeantStress = Creature:new {
	objectName = "imperialSergeantStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial sergeant", 
...
Creatures:addCreature(imperialSergeantStress, 3317919928) --  Add to Global Table
