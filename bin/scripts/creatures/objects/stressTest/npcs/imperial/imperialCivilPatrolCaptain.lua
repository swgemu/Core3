...
imperialCivilPatrolCaptainStress = Creature:new {
	objectName = "imperialCivilPatrolCaptainStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed civil patrol captain", 
	objectCRC = 152421728, 
...
Creatures:addCreature(imperialCivilPatrolCaptainStress, 152421728) --  Add to Global Table
