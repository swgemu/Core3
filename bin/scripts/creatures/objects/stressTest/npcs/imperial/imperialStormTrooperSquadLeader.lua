...
imperialStormTrooperSquadLeaderStress = Creature:new {
	objectName = "imperialStormTrooperSquadLeaderStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial stormtrooper squad leader", 
...
Creatures:addCreature(imperialStormTrooperSquadLeaderStress, 2642423881) --  Add to Global Table
