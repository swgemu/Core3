...
imperialSergeantMajorStress = Creature:new {
	objectName = "imperialSergeantMajorStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial Sergeant Major", 
...
Creatures:addCreature(imperialSergeantMajorStress, 1476291957) --  Add to Global Table
