...
imperialMajorGeneralStress = Creature:new {
	objectName = "imperialMajorGeneralStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial Major General", 
...
Creatures:addCreature(imperialMajorGeneralStress, 3799379131) --  Add to Global Table
