...
imperialDarkTrooperStress = Creature:new {
	objectName = "imperialDarkTrooperStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Dark Trooper", 
...
Creatures:addCreature(imperialDarkTrooperStress, 1312348723) --  Add to Global Table
