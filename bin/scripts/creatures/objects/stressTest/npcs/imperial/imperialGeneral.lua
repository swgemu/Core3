...
imperialGeneralStress = Creature:new {
	objectName = "imperialGeneralStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial General", 
...
Creatures:addCreature(imperialGeneralStress, 3799379131) --  Add to Global Table
