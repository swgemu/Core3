...
imperialStormTrooperCommandoStress = Creature:new {
	objectName = "imperialStormTrooperCommandoStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial storm commando", 
...
Creatures:addCreature(imperialStormTrooperCommandoStress, 3037629485) --  Add to Global Table
