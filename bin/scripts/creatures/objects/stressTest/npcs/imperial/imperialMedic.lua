...
imperialMedicStress = Creature:new {
	objectName = "imperialMedicStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial medic", 
...
Creatures:addCreature(imperialMedicStress, 1258151269) --  Add to Global Table
