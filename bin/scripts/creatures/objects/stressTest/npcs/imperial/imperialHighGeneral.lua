...
imperialHighGeneralStress = Creature:new {
	objectName = "imperialHighGeneralStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial High General",
...
Creatures:addCreature(imperialHighGeneralStress, 3799379131) --  Add to Global Table
