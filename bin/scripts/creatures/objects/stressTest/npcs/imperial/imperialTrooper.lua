...
imperialTrooperStress = Creature:new {
	objectName = "imperialTrooperStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial trooper", 
...
Creatures:addCreature(imperialTrooperStress, 1623607949) --  Add to Global Table
