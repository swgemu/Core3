...
imperialFirstLieutenantStress = Creature:new {
	objectName = "imperialFirstLieutenantStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial 1st lieutenant", 
...
Creatures:addCreature(imperialFirstLieutenantStress, 3317919928) --  Add to Global Table
