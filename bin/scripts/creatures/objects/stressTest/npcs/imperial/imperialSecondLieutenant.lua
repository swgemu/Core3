...
imperialSecondLieutenantStress = Creature:new {
	objectName = "imperialSecondLieutenantStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial Second Lieutenant", 
...
Creatures:addCreature(imperialSecondLieutenantStress, 3317919928) --  Add to Global Table
