...
imperialScoutTrooperStress = Creature:new {
	objectName = "imperialScoutTrooperStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial scout trooper", 
...
Creatures:addCreature(imperialScoutTrooperStress, 3260762182) --  Add to Global Table
