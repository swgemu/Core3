...
imperialLanceCorporalStress = Creature:new {
	objectName = "imperialLanceCorporalStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial Lance Corporal", 
...
Creatures:addCreature(imperialLanceCorporalStress, 2701430666) --  Add to Global Table
