...
imperialMajorStress = Creature:new {
	objectName = "imperialMajorStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial Major", 
...
Creatures:addCreature(imperialMajorStress, 1953999744) --  Add to Global Table
