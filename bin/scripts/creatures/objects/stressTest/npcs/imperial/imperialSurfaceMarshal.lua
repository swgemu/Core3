...
imperialSurfaceMarshalStress = Creature:new {
	objectName = "imperialSurfaceMarshalStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",
...
Creatures:addCreature(imperialSurfaceMarshalStress, 3498321727) --  Add to Global Table
