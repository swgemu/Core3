...
imperialSharpshooterStress = Creature:new {
	objectName = "imperialSharpshooterStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial sharpshooter", 
...
Creatures:addCreature(imperialSharpshooterStress, 1623607949) --  Add to Global Table
