...
imperialStaffCorporalStress = Creature:new {
	objectName = "imperialStaffCorporalStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial Staff Corporal", 
...
Creatures:addCreature(imperialStaffCorporalStress, 2701430666) --  Add to Global Table
