...
imperialColonelStress = Creature:new {
	objectName = "imperialColonelStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",

	stfName = "a stressed Imperial Colonel", 
...
Creatures:addCreature(imperialColonelStress, 2701430666) --  Add to Global Table
