...
imperialPrivateStress = Creature:new {
	objectName = "imperialPrivateStress",  -- Lua Object Name
	creatureType = "NPC",
	faction = "imperial", 
	factionPoints = 20,
	gender = "",
	...
	lootGroup = "0,11,15,19,33,42", -- Group it belongs to for loots
...
Creatures:addCreature(imperialPrivateStress, 519244536) --  Add to Global Table
