...
nightsisterRancorTamer = Creature:new {
	objectName = "nightsisterRancorTamer",  -- Lua Object Name
	creatureType = "NPC",
	faction = "Nightsister",
	gender = "",

	speciesName = "nightsister_rancor_tamer",
...
Creatures:addCreature(nightsisterRancorTamer, 764979635) --  Add to Global Table
