...
singingMtnClanHuntress = Creature:new {
      objectName = "singingMtnClanHuntress",  -- Lua Object Name
      creatureType = "NPC",
      faction = "Mtn. Clan",
      gender = "",

      name = "Singing Mountain clan huntress",
...
Creatures:addCreature(singingMtnClanHuntress, 1615915310) --  Add to Global Table
