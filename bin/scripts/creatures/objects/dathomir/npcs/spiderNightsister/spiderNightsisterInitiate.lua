...
spiderNightsisterInitiate = Creature:new {
	objectName = "spiderNightsisterInitiate",  -- Lua Object Name
	creatureType = "NPC",
	faction = "spider_nightsister", 
	factionPoints = 20,
	gender = "",

	speciesName = "spider_nightsister_initiate",
	stfName = "mob/creature_names", 
	objectCRC = 3869716156, 
...
Creatures:addCreature(spiderNightsisterInitiate, 3869716156) -- Add to Global Table
