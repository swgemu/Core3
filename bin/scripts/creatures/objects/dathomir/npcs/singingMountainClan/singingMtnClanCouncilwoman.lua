...
singingMtnClanCouncilwoman = Creature:new {
	objectName = "singingMtnClanCouncilwoman",  -- Lua Object Name
	creatureType = "NPC",
	faction = "mtn_clan", 
	factionPoints = 20,
	gender = "",

	speciesName = "singing_mtn_clan_councilwoman",
	...
	lootGroup = "0,1,3,4,11,15,19,33,99", -- Group it belongs to for loot
...
Creatures:addCreature(singingMtnClanCouncilwoman, 905293113) --  Add to Global Table
