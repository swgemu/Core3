...
singingMtnClanSentry = Creature:new {
	objectName = "singingMtnClanSentry",  -- Lua Object Name
	creatureType = "NPC",
	faction = "mtn_clan", 
	factionPoints = 20,
	gender = "",
...
Creatures:addCreature(singingMtnClanSentry, 1197970667) --  Add to Global Table
