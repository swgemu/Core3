...
gapingSpiderHunter = Creature:new {
	objectName = "gapingSpiderHunter",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "gaping_spider_hunter",
...
Creatures:addCreature(gapingSpiderHunter, 874176443) --  Add to Global Table
