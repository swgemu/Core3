...
ancientReptilianFlier = Creature:new {
	objectName = "ancientReptilianFlier",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(ancientReptilianFlier, 2270001055) --  Add to Global Table
