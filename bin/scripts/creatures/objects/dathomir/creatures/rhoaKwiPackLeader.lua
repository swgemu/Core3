...
rhoaKwiPackLeader = Creature:new {
	objectName = "rhoaKwiPackLeader",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(rhoaKwiPackLeader, 2111021739) --  Add to Global Table
