...
gapingSpiderBroodling = Creature:new {
	objectName = "gapingSpiderBroodling",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(gapingSpiderBroodling, 670298183) --  Add to Global Table
