...
caveGapingSpiderRecluseGiant = Creature:new {
	...
	--skills = { " Area attack (combo)", " Poison attack (strong)", "" }
	skills = { "gapingSpiderAttack8", "gapingSpiderAttack1" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(caveGapingSpiderRecluseGiant, 9986579) --  Add to Global Table
