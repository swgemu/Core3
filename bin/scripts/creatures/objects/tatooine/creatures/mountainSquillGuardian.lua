...
mountainSquillGuardian = Creature:new {
	objectName = "mountainSquillGuardian",  -- Lua Object Name
	creatureType = "ANIMAL",
	faction = "Squill",
	gender = "",

	speciesName = "mountain_squill_guardian",
...
Creatures:addCreature(mountainSquillGuardian, 807169980) --  Add to Global Table
