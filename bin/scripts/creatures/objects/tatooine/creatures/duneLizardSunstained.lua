...
duneLizardSunstained = Creature:new {
	objectName = "duneLizardSunstained",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "dune_lizard_sunstained",
...
Creatures:addCreature(duneLizardSunstained, 3554679154) --  Add to Global Table
