...
mountainWorrt = Creature:new {
      ...
      skills = { "mountainWorrtAttack1" },
	  -- skills = { " Knockdown attack", " Dizzy attack", " Ranged attack (spit)" }
      respawnTimer = 60,

      behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(mountainWorrt, 239900799) --  Add to Global Table
