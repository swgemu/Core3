...
rockBeetleCave = Creature:new {
	objectName = "rockBeetleCave",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "rock_beetle_cave",
...
Creatures:addCreature(rockBeetleCave, 1381990465) --  Add to Global Table
