...
duneBantha = Creature:new {
	objectName = "duneBantha",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "dune_bantha",
	...
	datapadItemCRC = 4245924782,
	mountCRC = 2053492545,
	mountSpeed = 14.0,
	mountAcceleration = 14.0,
...
Creatures:addCreature(duneBantha, 3918529401) --  Add to Global Table
