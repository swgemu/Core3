...
dragonet = Creature:new {
	objectName = "dragonet",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "dragonet",
	...
	skills = { "dragonetAttack1", "dragonetAttack2" },
...
Creatures:addCreature(dragonet, 3554679154) --  Add to Global Table
