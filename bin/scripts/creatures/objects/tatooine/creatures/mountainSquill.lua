...
mountainSquill = Creature:new {
	objectName = "mountainSquill",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "mountain_squill",
...
Creatures:addCreature(mountainSquill, 807169980) --  Add to Global Table
