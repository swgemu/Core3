...
cuPaWonderous = Creature:new {
      objectName = "cuPaWonderous",  -- Lua Object Name
      creatureType = "ANIMAL",
      faction = "CuPa",
      gender = "",
...
Creatures:addCreature(cuPaWonderous, 1883442736) --  Add to Global Table
