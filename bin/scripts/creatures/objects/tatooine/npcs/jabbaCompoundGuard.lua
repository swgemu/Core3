...
jabbaCompoundGuard = Creature:new {
      objectName = "jabbaCompoundGuard",  -- Lua Object Name
      creatureType = "NPC",
      faction = "Jabba",
      gender = "",

      name = "Jabba's compound guard",
      ...
      lootGroup = "0,11,15,19,21,33,34,39", -- Group it belongs to for loot
...
Creatures:addCreature(jabbaCompoundGuard, 3315833874) --  Add to Global Table
