...
tuskenCommoner = Creature:new {
	objectName = "tuskenCommoner",  -- Lua Object Name
	creatureType = "NPC",
	faction = "tusken_raider", 
	factionPoints = 20,
	gender = "",

	speciesName = "tusken_commoner",
...
Creatures:addCreature(tuskenCommoner, 3780705985) --  Add to Global Table
