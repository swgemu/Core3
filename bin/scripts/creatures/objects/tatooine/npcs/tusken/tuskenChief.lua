...
tuskenChief = Creature:new {
	objectName = "tuskenChief",  -- Lua Object Name
	creatureType = "NPC",
	faction = "tusken_raider",
	gender = "",
 
	speciesName = "tusken_chief",
...
Creatures:addCreature(tuskenChief, 3780705985) --  Add to Global Table
