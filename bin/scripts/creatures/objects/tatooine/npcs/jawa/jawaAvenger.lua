...
jawaAvenger = Creature:new {
	objectName = "jawaAvenger",  -- Lua Object Name
	creatureType = "NPC",
	faction = "jawa", 
	factionPoints = 20,
	gender = "",

	speciesName = "jawa_avenger",
...
Creatures:addCreature(jawaAvenger, 3444186231) --  Add to Global Table
