...
tuskenCaptain = Creature:new {
      objectName = "tuskenCaptain",  -- Lua Object Name
      creatureType = "NPC",
      ...
      lootGroup = "0,10,1,2,3,72", -- Group it belongs to for loot
...
Creatures:addCreature(tuskenCaptain, 3780705985) --  Add to Global Table
