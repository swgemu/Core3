...
nightsisterProtector = Creature:new {
	objectName = "nightsisterProtector", -- name of the lua Object
	
	name = "a Nightsister protector",
...
Creatures:addCreature(nightsisterProtector, 2893162759) --- Add to global creature table
