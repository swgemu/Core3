...
nightsisterInitiate = Creature:new {
	objectName = "nightsisterInitiate", -- name of the lua Object
	
	name = "a Nightsister initiate",
	objectCRC = 531141629,
...
Creatures:addCreature(nightsisterInitiate, 531141629) --- Add to global creature table
