...
nightsisterSentinel = Creature:new {
	objectName = "nightsisterSentinel", -- name of the lua Object
	
	name = "a Nightsister sentinel",
...
Creatures:addCreature(nightsisterSentinel, 3303384094) --- Add to global creature table
