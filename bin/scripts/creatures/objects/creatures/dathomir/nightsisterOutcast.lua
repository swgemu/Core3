...
nightsisterOutcast = Creature:new {
	objectName = "nightsisterOutcast", -- name of the lua Object
	
	name = "a Nightsister outcast",
...
Creatures:addCreature(nightsisterOutcast, 2430135288) --- Add to global creature table
