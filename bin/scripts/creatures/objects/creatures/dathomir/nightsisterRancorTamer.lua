...
nightsisterRancorTamer = Creature:new {
	objectName = "nightsisterRancorTamer", -- name of the lua Object
	
	name = "a Nightsister rancor tamer",
	objectCRC = 764979635,
...
Creatures:addCreature(nightsisterRancorTamer, 764979635) --- Add to global creature table
