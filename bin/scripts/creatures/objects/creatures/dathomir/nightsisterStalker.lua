...
nightsisterStalker = Creature:new {
	objectName = "nightsisterStalker", -- name of the lua Object
	
	name = "a Nightsister stalker",
...
Creatures:addCreature(nightsisterStalker, 1157182633) --- Add to global creature table
