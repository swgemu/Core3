...
nightsisterSentry = Creature:new {
	objectName = "nightsisterSentry", -- name of the lua Object
	
	name = "a Nightsister sentry",
	objectCRC = 780342276,
...
Creatures:addCreature(nightsisterSentry, 780342276) --- Add to global creature table
