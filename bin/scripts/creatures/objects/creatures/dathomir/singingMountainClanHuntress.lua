...
singingMountainClanHuntress = Creature:new {
	objectName = "singingMountainClanHuntress", -- name of the lua Object
	
	name = "a Singing Mountain Clan huntress",
	objectCRC = 1615915310,
	socialGroup = "mtnClan",
	named = TRUE,
...
Creatures:addCreature(singingMountainClanHuntress, 1615915310) --- Add to global creature table
