...
blackSunAssassinDWB = Creature:new {
	objectName = "blackSunAssassinDWB", -- name of the lua Object
	
	name = "a Black Sun Assassin",
...
Creatures:addCreature(blackSunAssassinDWB, 3627888108) --- Add to global creature table
