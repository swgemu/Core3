...
deathWatchWraithDWB = Creature:new {
	objectName = "deathWatchWraithDWB", -- name of the lua Object
	
	name = "a Death Watch Wraith",
...
Creatures:addCreature(deathWatchWraithDWB, 3553170937) --- Add to global creature table
