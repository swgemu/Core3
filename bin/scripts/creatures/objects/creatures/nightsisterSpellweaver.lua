...
nightsisterSpellweaver = Creature:new {
	objectName = "nightsisterSpellweaver", -- name of the lua Object
	
	name = "a Nightsister spellweaver",
...
Creatures:addCreature(nightsisterSpellweaver, 2291851149) --- Add to global creature table
