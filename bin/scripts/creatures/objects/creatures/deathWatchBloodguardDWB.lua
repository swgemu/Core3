...
deathWatchBloodguardDWB = Creature:new {
	objectName = "deathWatchBloodguardDWB", -- name of the lua Object
	
	name = "a Death Watch Bloodguard",
...
Creatures:addCreature(deathWatchBloodguardDWB, 3286146806) --- Add to global creature table
