...
singingMountainClanScout = Creature:new {
	objectName = "singingMountainClanScout", -- name of the lua Object
	
	name = "a Singing Mountain Clan Scout",
...
Creatures:addCreature(singingMountainClanScout, 1250467023) --- Add to global creature table
