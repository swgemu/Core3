...
skreegHunter = Creature:new {
	objectName = "skreegHunter",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "skreeg_hunter",
...
Creatures:addCreature(skreegHunter, 2391906030) --  Add to Global Table
