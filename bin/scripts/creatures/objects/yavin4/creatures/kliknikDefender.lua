...
kliknikDefender = Creature:new {
	objectName = "kliknikDefender",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "kliknik_defender",
	...
	skills = { "kliknikAttack7", "kliknikAttack10" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(kliknikDefender, 965104200) --  Add to Global Table
