...
skreegFemale = Creature:new {
	objectName = "skreegFemale",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "skreeg_female",
...
Creatures:addCreature(skreegFemale, 2391906030) --  Add to Global Table
