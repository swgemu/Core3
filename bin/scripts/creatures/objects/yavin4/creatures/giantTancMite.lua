...
giantTancMite = Creature:new {
	objectName = "giantTancMite",  -- Lua Object Name
	creatureType = "ANIMAL",
	faction = "Tancmite",
	gender = "",

	speciesName = "giant_tanc_mite",
	...
	skills = { "tancMiteAttack1", "tancMiteAttack2" },
	respawnTimer = 60,

	behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(giantTancMite, 2091826918) --  Add to Global Table
