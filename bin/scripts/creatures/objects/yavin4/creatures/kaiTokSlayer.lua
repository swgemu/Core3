...
kaiTokSlayer = Creature:new {
      objectName = "kaiTokSlayer",  -- Lua Object Name
      creatureType = "ANIMAL",
      faction = "KaiTok",
      gender = "",

	  speciesName = "kai_tok_slayer",
      ...
      skills = { "kaiTokAttack6", "kaiTokAttack5" },
      respawnTimer = 60,

      behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(kaiTokSlayer, 1823266132) --  Add to Global Table
