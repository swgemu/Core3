...
kliknikWarrior = Creature:new {
	objectName = "kliknikWarrior",  -- Lua Object Name
	creatureType = "ANIMAL",
	faction = "Kliknik",
	gender = "",

	speciesName = "kliknik_warrior",
...
Creatures:addCreature(kliknikWarrior, 965104200) --  Add to Global Table
