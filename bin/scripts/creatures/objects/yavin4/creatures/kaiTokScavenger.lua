...
kaiTokScavenger = Creature:new {
	objectName = "kaiTokScavenger",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",

	speciesName = "kai_tok_scavenger",
...
Creatures:addCreature(kaiTokScavenger, 1823266132) --  Add to Global Table
