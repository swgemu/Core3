...
gackleBatMyrmidonLord = Creature:new {
	objectName = "gackleBatMyrmidonLord",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(gackleBatMyrmidonLord, 2791266544) --  Add to Global Table
