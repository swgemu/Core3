...
stintarilProwler = Creature:new {
      objectName = "stintarilProwler",  -- Lua Object Name
      creatureType = "ANIMAL",
      faction = "Stinaril",
      gender = "",

	  speciesName = "stintaril_prowler",
      ...
      skills = { "stintarilAttack1", "stintarilAttack2" },
      respawnTimer = 60,

      behaviorScript = "", -- Link to the behavior script for this object
}

Creatures:addCreature(stintarilProwler, 3055227574) --  Add to Global Table
