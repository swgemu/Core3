...
tancMiteEviscerator = Creature:new {
	objectName = "tancMiteEviscerator",  -- Lua Object Name
	creatureType = "ANIMAL",
	gender = "",
...
Creatures:addCreature(tancMiteEviscerator, 3413073886) --  Add to Global Table
