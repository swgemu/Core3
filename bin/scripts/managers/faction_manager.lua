...
addFaction("kunga_tribe","dantari,mokk_tribe","")
...
addFaction("mokk","dantari,janta_tribe","")
...
addFaction("nym","bloordrazor,canyon_corsair","")
...
addFaction("sith_shadow_assassin","fs_villager","imperial,rebel")
