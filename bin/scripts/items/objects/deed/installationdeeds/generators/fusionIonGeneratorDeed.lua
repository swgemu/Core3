...
fusionIonGeneratorDeed = Deed:new {
	stfName = "fusion_generator_deed_name",
	...
	targetObjectFile = "object/installation/generators/shared_power_generator_fusion_style_1.iff",
	
	targetConstructionObjectCRC = 1103585647,
	
	maintenanceRate = 60.0,
	baseExtractionRate = 10.0,
