...
microFloraFarmDeed = Deed:new {
	...
	targetStfName = "flora_farm_small",
	
	--Required for EnterStructurePlacementModeMessage
	targetObjectFile = "object/installation/mining_organic/shared_mining_organic_flora_farm.iff",
	...
	harvesterType = RESOURCETYPE_FLORA,
