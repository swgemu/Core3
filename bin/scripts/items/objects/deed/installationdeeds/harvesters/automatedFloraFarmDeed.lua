...
automatedFloraFarmDeed = Deed:new {
	stfName = "flora_harvester_medium_deed_name",
	...
	targetObjectFile = "object/installation/mining_organic/shared_mining_organic_flora_farm_medium.iff",
