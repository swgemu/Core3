...
naturalGasProcessorDeed = Deed:new {
	stfName = "gas_harvester_medium_deed_name",
	...
	targetStfName = "gas_mine",
	
	--Required for EnterStructurePlacementModeMessage
	targetObjectFile = "object/installation/mining_gas/shared_mining_gas_harvester_style_2.iff",
