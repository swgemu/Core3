...
addBFProfession("Master Droid Engineer", "Crafting Professions", "crafting_droidengineer_master");
...
addBFProfession("Master Merchant", "Crafting Professions", "crafting_merchant_master");