...
void ZoneServer::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<ZoneServerImplementation*>(servant));
}
...
Object* ZoneServerImplementation::clone() {
	return dynamic_cast<Object*>(new ZoneServerImplementation(*this));
}
