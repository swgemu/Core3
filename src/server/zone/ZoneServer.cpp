...
void ZoneServerImplementation::test() {
	...
	// server/zone/ZoneServer.idl(118):  		Zone zone = new Zone(null, null, 0);
	Zone* zone = _ref0 = new Zone(NULL, NULL, 0);
	// server/zone/ZoneServer.idl(119):  		zone.getHeight(0, 1);
	zone->getHeight(0, 1);
}
