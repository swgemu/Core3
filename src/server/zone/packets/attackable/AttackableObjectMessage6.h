...
#ifndef ATTACKABLEOBJECTMESSAGE6_H_
#define ATTACKABLEOBJECTMESSAGE6_H_

#include "../BaseLineMessage.h"

#include "../../objects/attackable/AttackableObject.h"

class AttackableObjectMessage6 : public BaseLineMessage {
public:
	AttackableObjectMessage6(AttackableObject* tano) 
