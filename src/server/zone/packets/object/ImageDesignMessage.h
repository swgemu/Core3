...
public:
	//TODO: Why are there three objects involved in this!? What exactly is "object"
	ImageDesignStartMessage(CreatureObject* object, CreatureObject* designer, CreatureObject* client, uint64 tent, int type = 0)
