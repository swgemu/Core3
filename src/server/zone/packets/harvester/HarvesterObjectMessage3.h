...
public:
	HarvesterObjectMessage3(uint64 hoId)
			: BaseLineMessage(hoId, 0x48494E4F, 3, 0x05) {
		insertFloat(1.0);
		...
		insertInt(0);
		insertInt(0);
		insertInt(0x01000000);
		insertInt(0);
		insertInt(0);
		insertInt(0x03E80000); //might be a float.
		insertInt(0x00010000); //refer to hardcode below.
		insertByte(0);
		insertByte(0);
		insertInt(0);
