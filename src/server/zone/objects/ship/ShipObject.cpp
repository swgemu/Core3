...
ShipObject::ShipObject(DistributedObjectServant* obj) : SceneObject(obj) {
}
...
DistributedObjectAdapter* ShipObjectHelper::createAdapter(DistributedObjectServant* obj) {
	DistributedObjectAdapter* adapter = new ShipObjectAdapter((ShipObjectImplementation*) obj);

	DistributedObjectStub* stub = new ShipObject(obj);
