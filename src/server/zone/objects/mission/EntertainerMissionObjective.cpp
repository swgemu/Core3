...
void EntertainerMissionObjective::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<EntertainerMissionObjectiveImplementation*>(servant));
}
...
Object* EntertainerMissionObjectiveImplementation::clone() {
	return dynamic_cast<Object*>(new EntertainerMissionObjectiveImplementation(*this));
}
