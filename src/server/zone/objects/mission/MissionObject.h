...
public:
	...
	bool updateStatus(int type, unsigned int objCrc, const String& str, int increment = 1);

	void checkComplete();

	void setMissionName(const String& tstr);
...
public:
	...
	bool updateStatus(int type, unsigned int objCrc, const String& str, int increment);
...
protected:
	...
	String _param2_updateStatus__int_int_String_int_;
	String _param0_setMissionName__String_;
