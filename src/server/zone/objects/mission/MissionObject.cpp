...
void MissionObject::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<MissionObjectImplementation*>(servant));
}
...
Object* MissionObjectImplementation::clone() {
	return dynamic_cast<Object*>(new MissionObjectImplementation(*this));
}
