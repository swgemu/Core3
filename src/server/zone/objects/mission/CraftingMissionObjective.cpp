...
void CraftingMissionObjective::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<CraftingMissionObjectiveImplementation*>(servant));
}
...
Object* CraftingMissionObjectiveImplementation::clone() {
	return dynamic_cast<Object*>(new CraftingMissionObjectiveImplementation(*this));
}
