...
OneHandMeleeWeapon::OneHandMeleeWeapon(LuaObject* templateData) : MeleeWeaponObject(DummyConstructorParameter::instance()) {
	_impl = new OneHandMeleeWeaponImplementation(templateData);
	_impl->_setStub(this);
}
