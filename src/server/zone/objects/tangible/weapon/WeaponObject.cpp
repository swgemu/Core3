...
void WeaponObject::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<WeaponObjectImplementation*>(servant));
}
...
Object* WeaponObjectImplementation::clone() {
	return dynamic_cast<Object*>(new WeaponObjectImplementation(*this));
}
