...
/*
 *	server/zone/objects/tangible/craftingtool/CraftingTool.h generated by Engine3 IDL compiler 0.51
 */
...
class CraftingToolHelper : public ORBClassHelper, public Singleton<CraftingToolHelper> {
public:
	CraftingToolHelper();
