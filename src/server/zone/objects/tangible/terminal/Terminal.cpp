...
/*
 *	server/zone/objects/tangible/terminal/Terminal.cpp generated by Engine3 IDL compiler 0.51
 */
...
Packet* TerminalAdapter::invokeMethod(uint32 methid, ORBMethodInvocation* inv) {
...
ORBClassHelper* TerminalHelper::instance = new TerminalHelper();
...
ORBClassHelper* TerminalHelper::getInstance() {
	if (instance == NULL)
		return instance = new TerminalHelper();
	else
		return instance;
}
...
ORBObjectStub* TerminalServant::_getStub() {
	return _this;
}
