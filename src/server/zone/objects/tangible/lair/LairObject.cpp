...
/*
 *	server/zone/objects/tangible/lair/LairObject.cpp generated by Engine3 IDL compiler 0.51
 */
...
Packet* LairObjectAdapter::invokeMethod(uint32 methid, ORBMethodInvocation* inv) {
...
ORBObjectStub* LairObjectServant::_getStub() {
	return _this;
}
