...
void ClothingObject::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<ClothingObjectImplementation*>(servant));
}
...
Object* ClothingObjectImplementation::clone() {
	return dynamic_cast<Object*>(new ClothingObjectImplementation(*this));
}
