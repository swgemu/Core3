...
TransactionalObject* WearableObjectImplementation::clone() {
	WearableObjectImplementation* objectCopy = new WearableObjectImplementation(DummyConstructorParameter::instance());
	*((WearableObjectImplementation*) objectCopy) = *this;
