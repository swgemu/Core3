...
/*
 *	server/zone/objects/tangible/weapons/MeleeWeapon.h generated by Engine3 IDL compiler 0.51
 */
...
class MeleeWeaponHelper : public ORBClassHelper, public Singleton<MeleeWeaponHelper> {
public:
	MeleeWeaponHelper();
