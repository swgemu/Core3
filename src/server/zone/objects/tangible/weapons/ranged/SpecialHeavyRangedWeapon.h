...
/*
 *	server/zone/objects/tangible/weapons/ranged/SpecialHeavyRangedWeapon.h generated by Engine3 IDL compiler 0.51
 */
...
protected:
	...
	SpecialHeavyRangedWeapon(ORBObjectServant* obj);
...
class SpecialHeavyRangedWeaponHelper : public ORBClassHelper, public Singleton<SpecialHeavyRangedWeaponHelper> {
public:
