...
/*
 *	server/zone/objects/tangible/weapons/ranged/CarbineRangedWeapon.cpp generated by Engine3 IDL compiler 0.51
 */
...
Packet* CarbineRangedWeaponAdapter::invokeMethod(uint32 methid, ORBMethodInvocation* inv) {
...
ORBObjectStub* CarbineRangedWeaponServant::_getStub() {
	return _this;
}
