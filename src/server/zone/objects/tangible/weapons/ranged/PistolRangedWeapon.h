...
/*
 *	server/zone/objects/tangible/weapons/ranged/PistolRangedWeapon.h generated by Engine3 IDL compiler 0.51
 */
...
class PistolRangedWeaponHelper : public ORBClassHelper, public Singleton<PistolRangedWeaponHelper> {
public:
...
public:
	PistolRangedWeaponServant(unsigned long long objid, unsigned int tempcrc, const unicode& n, const string& tempn, int tp, bool eqp);
