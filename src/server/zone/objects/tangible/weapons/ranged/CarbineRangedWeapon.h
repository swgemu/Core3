...
/*
 *	server/zone/objects/tangible/weapons/ranged/CarbineRangedWeapon.h generated by Engine3 IDL compiler 0.51
 */
...
class CarbineRangedWeaponHelper : public ORBClassHelper, public Singleton<CarbineRangedWeaponHelper> {
public:
