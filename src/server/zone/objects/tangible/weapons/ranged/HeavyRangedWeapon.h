...
/*
 *	server/zone/objects/tangible/weapons/ranged/HeavyRangedWeapon.h generated by Engine3 IDL compiler 0.51
 */
...
class HeavyRangedWeaponHelper : public ORBClassHelper, public Singleton<HeavyRangedWeaponHelper> {
public:
