...
/*
 *	server/zone/objects/tangible/weapons/RangedWeapon.h generated by Engine3 IDL compiler 0.51
 */
...
class RangedWeaponHelper : public ORBClassHelper, public Singleton<RangedWeaponHelper> {
public:
	RangedWeaponHelper();
