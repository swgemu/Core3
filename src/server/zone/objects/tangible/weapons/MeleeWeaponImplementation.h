...
#ifndef MELEEWEAPONIMPLEMENTATION_H_
#define MELEEWEAPONIMPLEMENTATION_H_

#include "MeleeWeapon.h"

class MeleeWeaponImplementation : public MeleeWeaponServant {
...
#endif /*MELEEWEAPONIMPLEMENTATION_H_*/
