...
/*
 *	server/zone/objects/tangible/weapons/melee/OneHandedMeleeWeapon.h generated by Engine3 IDL compiler 0.51
 */
...
public:
	...
	OneHandedMeleeWeapon(ORBObjectServant* obj);
...
class OneHandedMeleeWeaponHelper : public ORBClassHelper, public Singleton<OneHandedMeleeWeaponHelper> {
public:
