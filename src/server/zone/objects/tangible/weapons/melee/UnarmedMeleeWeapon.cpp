...
/*
 *	server/zone/objects/tangible/weapons/melee/UnarmedMeleeWeapon.cpp generated by Engine3 IDL compiler 0.51
 */
...
Packet* UnarmedMeleeWeaponAdapter::invokeMethod(uint32 methid, ORBMethodInvocation* inv) {
...
ORBObjectStub* UnarmedMeleeWeaponServant::_getStub() {
	return _this;
}
