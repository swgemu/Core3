...
/*
 *	server/zone/objects/tangible/weapons/melee/UnarmedMeleeWeapon.h generated by Engine3 IDL compiler 0.51
 */
...
class UnarmedMeleeWeaponHelper : public ORBClassHelper, public Singleton<UnarmedMeleeWeaponHelper> {
public:
