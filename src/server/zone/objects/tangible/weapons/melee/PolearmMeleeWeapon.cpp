...
/*
 *	server/zone/objects/tangible/weapons/melee/PolearmMeleeWeapon.cpp generated by Engine3 IDL compiler 0.51
 */
...
Packet* PolearmMeleeWeaponAdapter::invokeMethod(uint32 methid, ORBMethodInvocation* inv) {
...
ORBObjectStub* PolearmMeleeWeaponServant::_getStub() {
	return _this;
}
