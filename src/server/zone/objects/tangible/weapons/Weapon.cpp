...
Weapon::Weapon(DistributedObjectServant* obj) : TangibleObject(obj) {
}
...
DistributedObjectAdapter* WeaponHelper::createAdapter(DistributedObjectServant* obj) {
	DistributedObjectAdapter* adapter = new WeaponAdapter((WeaponImplementation*) obj);

	DistributedObjectStub* stub = new Weapon(obj);
