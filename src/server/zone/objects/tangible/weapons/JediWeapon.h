...
/*
 *	server/zone/objects/tangible/weapons/JediWeapon.h generated by Engine3 IDL compiler 0.51
 */
...
class JediWeaponHelper : public ORBClassHelper, public Singleton<JediWeaponHelper> {
public:
	JediWeaponHelper();
