...
#ifndef POLEARMJEDIWEAPONIMPLEMENTATION_H_
#define POLEARMJEDIWEAPONIMPLEMENTATION_H_
...
public:
	...
	void init() {
		objectSubType = TangibleObjectImplementation::POLEARMSABER;

		//setType(9);
		//setCategory(0x30);
		//This fixes the creature bug causing creatures to do 4k dmg
		setType(POLEARMSABER);
		setCategory(JEDI);
...
#endif /*POLEARMJEDIWEAPONIMPLEMENTATION_H_*/
