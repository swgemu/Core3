...
#ifndef ONEHANDEDJEDIWEAPONIMPLEMENTATION_H_
#define ONEHANDEDJEDIWEAPONIMPLEMENTATION_H_
...
class OneHandedJediWeaponImplementation : public OneHandedJediWeaponServant {
...
#endif /*ONEHANDEDJEDIWEAPONIMPLEMENTATION_H_*/
