...
void TangibleObject::updateCustomName(Player* player, const String& value) {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		((TangibleObjectImplementation*) _impl)->updateCustomName(player, value);
}
...
void TangibleObjectAdapter::updateCustomName(Player* player, const String& value) {
	return ((TangibleObjectImplementation*) impl)->updateCustomName(player, value);
}
