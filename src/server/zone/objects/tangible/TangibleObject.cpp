...
void TangibleObject::setCraftersSerial(String& serial) {
	...
	if (_implementation == NULL) {
		...
		DistributedMethod method(this, RPC_SETCRAFTERSSERIAL__STRING_);
...
bool TangibleObject::isFromFactoryCrate() {
	...
	if (_implementation == NULL) {
		...
		DistributedMethod method(this, RPC_ISFROMFACTORYCRATE__);
...
void TangibleObject::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<TangibleObjectImplementation*>(servant));
}
...
Object* TangibleObjectImplementation::clone() {
	return dynamic_cast<Object*>(new TangibleObjectImplementation(*this));
}
