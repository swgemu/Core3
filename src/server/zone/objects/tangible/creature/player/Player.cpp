...
void Player::updateAdminLevel(unsigned int level) {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		((PlayerImplementation*) _impl)->updateAdminLevel(level);
}

void Player::setAdminLevel(unsigned int level) {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
unsigned int Player::getAdminLevel() {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
void Player::loadMissions() {
	if (_impl == NULL) {
		...
		((PlayerImplementation*) _impl)->loadMissions();
}
...
void Player::subtractDraftSchematic(const unsigned int schematicID) {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		((PlayerImplementation*) _impl)->subtractDraftSchematic(schematicID);
}

unsigned int Player::getDraftSchematicMapSize() {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		return ((PlayerImplementation*) _impl)->getDraftSchematicMapSize();
}
...
DraftSchematic* Player::getDraftSchematicByID(unsigned int schematicID) {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		return ((PlayerImplementation*) _impl)->getDraftSchematicByID(schematicID);
}

int Player::getDraftSchematicIndex(unsigned int schematicID) {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		return ((PlayerImplementation*) _impl)->getDraftSchematicIndex(schematicID);
}

DraftSchematic* Player::getDraftSchematicByIndex(int index) {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		return ((PlayerImplementation*) _impl)->getDraftSchematicByIndex(index);
}
...
void Player::loadStaffChat() {
	if (_impl == NULL) {
		...
		((PlayerImplementation*) _impl)->loadStaffChat();
}
...
bool Player::hasWaypoint(WaypointObject* wp) {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		return ((PlayerImplementation*) _impl)->hasWaypoint(wp);
}

bool Player::hasWaypoint(unsigned long long wpid) {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		return ((PlayerImplementation*) _impl)->hasWaypoint(wpid);
}
...
unsigned long long Player::getTrap() {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		return ((PlayerImplementation*) _impl)->getTrap();
}

unsigned long long Player::getGrenade() {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		return ((PlayerImplementation*) _impl)->getGrenade();
}

unsigned long long Player::getHeavyRangedWeapon() {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		return ((PlayerImplementation*) _impl)->getHeavyRangedWeapon();
}
...
Packet* PlayerAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case 224:
		...
		break;
	case 225:
		updateAdminLevel(inv->getUnsignedIntParameter());
		break;
	case 226:
	...
	case 306:
		...
		break;
	case 307:
		subtractDraftSchematic(inv->getUnsignedIntParameter());
		break;
	case 308:
		resp->insertInt(getDraftSchematicMapSize());
		break;
	case 309:
		resp->insertInt(getDraftSchematicUpdateCount(inv->getUnsignedIntParameter()));
		break;
	case 310:
		resp->insertLong(getDraftSchematicByID(inv->getUnsignedIntParameter())->_getObjectID());
		break;
	case 311:
		resp->insertSignedInt(getDraftSchematicIndex(inv->getUnsignedIntParameter()));
		break;
	case 312:
		resp->insertLong(getDraftSchematicByIndex(inv->getSignedIntParameter())->_getObjectID());
		break;
	case 313:
	...
	case 399:
		...
		break;
	case 400:
		resp->insertLong(getTrap());
		break;
	case 401:
		resp->insertLong(getGrenade());
		break;
	case 402:
		resp->insertLong(getHeavyRangedWeapon());
		break;
	case 403:
...
void PlayerAdapter::updateAdminLevel(unsigned int level) {
	return ((PlayerImplementation*) impl)->updateAdminLevel(level);
}

void PlayerAdapter::setAdminLevel(unsigned int level) {
	return ((PlayerImplementation*) impl)->setAdminLevel(level);
}

unsigned int PlayerAdapter::getAdminLevel() {
...
void PlayerAdapter::loadMissions() {
	return ((PlayerImplementation*) impl)->loadMissions();
}
...
void PlayerAdapter::subtractDraftSchematic(const unsigned int schematicID) {
	return ((PlayerImplementation*) impl)->subtractDraftSchematic(schematicID);
}

unsigned int PlayerAdapter::getDraftSchematicMapSize() {
	return ((PlayerImplementation*) impl)->getDraftSchematicMapSize();
}
...
DraftSchematic* PlayerAdapter::getDraftSchematicByID(unsigned int schematicID) {
	return ((PlayerImplementation*) impl)->getDraftSchematicByID(schematicID);
}

int PlayerAdapter::getDraftSchematicIndex(unsigned int schematicID) {
	return ((PlayerImplementation*) impl)->getDraftSchematicIndex(schematicID);
}

DraftSchematic* PlayerAdapter::getDraftSchematicByIndex(int index) {
	return ((PlayerImplementation*) impl)->getDraftSchematicByIndex(index);
}
...
void PlayerAdapter::loadStaffChat() {
	return ((PlayerImplementation*) impl)->loadStaffChat();
}
...
bool PlayerAdapter::hasWaypoint(WaypointObject* wp) {
	return ((PlayerImplementation*) impl)->hasWaypoint(wp);
}

bool PlayerAdapter::hasWaypoint(unsigned long long wpid) {
	return ((PlayerImplementation*) impl)->hasWaypoint(wpid);
}
...
unsigned long long PlayerAdapter::getTrap() {
	return ((PlayerImplementation*) impl)->getTrap();
}

unsigned long long PlayerAdapter::getGrenade() {
	return ((PlayerImplementation*) impl)->getGrenade();
}

unsigned long long PlayerAdapter::getHeavyRangedWeapon() {
	return ((PlayerImplementation*) impl)->getHeavyRangedWeapon();
}
