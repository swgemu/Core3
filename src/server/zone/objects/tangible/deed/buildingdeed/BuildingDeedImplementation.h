...
#ifndef BUILDINGDEEDIMPLEMENTATION_H_
#define BUILDINGDEEDIMPLEMENTATION_H_

#include "BuildingDeed.h"

class BuildingDeedImplementation : public BuildingDeedServant {
...
public:
	BuildingDeedImplementation(CreatureObject* creature, uint32 objcrc, const UnicodeString& customname, const String& stfname);
	BuildingDeedImplementation(uint64 objid, uint32 objcrc, const UnicodeString& customname, const String& stfname);
	...
	inline void setCellCount(uint32 cellcount) {
		cellCount = cellcount;
		String attr("cellCount");
		itemAttributes->setIntAttribute(attr, cellCount);
	}
...
#endif /* BUILDINGDEEDIMPLEMENTATION_H_ */
