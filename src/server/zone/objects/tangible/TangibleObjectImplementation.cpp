...
void TangibleObjectImplementation::addSerializableVariables() {
	...
	addSerializableVariable("templateID", &templateID);
	addSerializableVariable("objectSubType", &objectSubType);
	addSerializableVariable("objectCount", &objectCount);
	addSerializableVariable("equipped", &equipped);
	addSerializableVariable("insured", &insured);
	addSerializableVariable("pvpStatusBitmask", &pvpStatusBitmask);
	addSerializableVariable("playerUseMask", &playerUseMask);
	addSerializableVariable("misoAsocKey", &misoAsocKey);
	addSerializableVariable("craftersName", &craftersName);
	addSerializableVariable("craftedSerial", &craftedSerial);
	addSerializableVariable("wasLooted", &wasLooted);
	addSerializableVariable("complexity", &complexity);
	addSerializableVariable("volume", &volume);
	addSerializableVariable("sliced", &sliced);
	addSerializableVariable("slicable", &slicable);
	addSerializableVariable("slicerID", &slicerID);
...
void TangibleObjectImplementation::setDefender(SceneObject* defender) {
	...
	SceneObjectReference<SceneObject> temp = NULL;
...
void TangibleObjectImplementation::decay(float decayRate) {
	...
	if (conditionDamage > maxCondition)
		conditionDamage = (float) maxCondition;
