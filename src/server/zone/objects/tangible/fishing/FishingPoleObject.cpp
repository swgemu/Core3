...
void FishingPoleObject::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<FishingPoleObjectImplementation*>(servant));
}
...
Object* FishingPoleObjectImplementation::clone() {
	return dynamic_cast<Object*>(new FishingPoleObjectImplementation(*this));
}
