...
ShipComponent::ShipComponent(DistributedObjectServant* obj) : TangibleObject(obj) {
}
...
DistributedObjectAdapter* ShipComponentHelper::createAdapter(DistributedObjectServant* obj) {
	DistributedObjectAdapter* adapter = new ShipComponentAdapter((ShipComponentImplementation*) obj);

	DistributedObjectStub* stub = new ShipComponent(obj);
