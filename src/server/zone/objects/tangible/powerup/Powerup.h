...
/*
 *	server/zone/objects/tangible/powerup/Powerup.h generated by Engine3 IDL compiler 0.51
 */
...
class PowerupHelper : public ORBClassHelper, public Singleton<PowerupHelper> {
public:
	PowerupHelper();
