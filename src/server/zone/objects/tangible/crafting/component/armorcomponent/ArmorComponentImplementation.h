...
#ifndef ARMORCOMPONENTIMPLEMENTATION_H_
#define ARMORCOMPONENTIMPLEMENTATION_H_
...
class ArmorComponentImplementation : public ArmorComponentServant {
protected:

	Vector<String> specialResists;
...
public:
	...
	String& getSpecialResist(int i) {
		return specialResists.get(i);
	}

	int getSpecialResistCount() {
		return specialResists.size();
	}
