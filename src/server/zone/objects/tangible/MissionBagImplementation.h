...
#ifndef MISSIONBAGIMPLEMENTATION_H_
#define MISSIONBAGIMPLEMENTATION_H_
...
class MissionBagImplementation : public MissionBagServant {
...
#endif /*MISSIONBAGIMPLEMENTATION_H_*/
