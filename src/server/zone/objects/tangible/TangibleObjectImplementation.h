...
protected:
	...
	UnsignedInteger optionsBitmask;

	UnsignedInteger templateID;
	...
	UnsignedInteger pvpStatusBitmask;

	UnsignedShort playerUseMask;
	...
	SerializableVector<SceneObjectReference<SceneObject> > defenderList;
