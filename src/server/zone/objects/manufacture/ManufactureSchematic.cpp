...
/*
 *	server/zone/objects/manufacture/ManufactureSchematic.cpp generated by Engine3 IDL compiler 0.51
 */
...
Packet* ManufactureSchematicAdapter::invokeMethod(uint32 methid, ORBMethodInvocation* inv) {
...
ORBClassHelper* ManufactureSchematicHelper::instance = new ManufactureSchematicHelper();
...
ORBClassHelper* ManufactureSchematicHelper::getInstance() {
	if (instance == NULL)
		return instance = new ManufactureSchematicHelper();
	else
		return instance;
}
...
ORBObjectStub* ManufactureSchematicServant::_getStub() {
	return _this;
}
