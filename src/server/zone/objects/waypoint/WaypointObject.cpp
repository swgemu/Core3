...
TransactionalObject* WaypointObjectImplementation::clone() {
	WaypointObjectImplementation* objectCopy = new WaypointObjectImplementation(DummyConstructorParameter::instance());
	*((WaypointObjectImplementation*) objectCopy) = *this;
