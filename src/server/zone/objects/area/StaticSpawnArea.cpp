...
void StaticSpawnArea::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<StaticSpawnAreaImplementation*>(servant));
}
...
Object* StaticSpawnAreaImplementation::clone() {
	return dynamic_cast<Object*>(new StaticSpawnAreaImplementation(*this));
}
