...
void TrainerCreature::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<TrainerCreatureImplementation*>(servant));
}
...
Object* TrainerCreatureImplementation::clone() {
	return dynamic_cast<Object*>(new TrainerCreatureImplementation(*this));
}
