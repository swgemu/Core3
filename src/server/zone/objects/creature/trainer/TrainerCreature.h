...
/*
 *	server/zone/objects/creature/trainer/TrainerCreature.h generated by Engine3 IDL compiler 0.51
 */
...
class TrainerCreatureHelper : public ORBClassHelper, public Singleton<TrainerCreatureHelper> {
public:
