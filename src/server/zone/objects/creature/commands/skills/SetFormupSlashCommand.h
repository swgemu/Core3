...
class SetFormupSlashCommand : public QueueCommand {
public:

	SetFormupSlashCommand(const String& name, ZoneProcessServerImplementation* server)
...
#endif //SETFORMUPSLASHCOMMAND_H_
