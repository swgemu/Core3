...
#ifndef FORCEHEALSELFSKILL_H_
#define FORCEHEALSELFSKILL_H_

#include "../HealSelfSkill.h"

class ForceHealSelfSkill : public HealSelfSkill {
	int forceCost;
