...
#ifndef DANCESELFSKILL_H_
#define DANCESELFSKILL_H_

#include "../SelfSkill.h"

class DanceSelfSkill : public SelfSkill {

public:
	DanceSelfSkill(const string& name, const string& effect, ZoneProcessServerImplementation* serv) : SelfSkill(name, effect.c_str(), ENTERTAIN, serv) {
	}
