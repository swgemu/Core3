...
#ifndef MUSICSELFSKILL_H_
#define MUSICSELFSKILL_H_

#include "../SelfSkill.h"

class MusicSelfSkill : public SelfSkill {

public:
	MusicSelfSkill(const string& name, const string& effect, ZoneProcessServerImplementation* serv) : SelfSkill(name, effect.c_str(), ENTERTAIN, serv) {
	}
