...
bool CreatureObject::isDrivingVehicle() {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		return ((CreatureObjectImplementation*) _impl)->isDrivingVehicle();
}
...
bool CreatureObject::isMountedCreature() {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		return ((CreatureObjectImplementation*) _impl)->isMountedCreature();
}
...
void CreatureObject::setAggressiveBaby(bool ag) {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, 443);
		method.addBooleanParameter(ag);

		method.executeWithVoidReturn();
	} else
		((CreatureObjectImplementation*) _impl)->setAggressiveBaby(ag);
}

bool CreatureObject::isAggressiveBaby() {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		return ((CreatureObjectImplementation*) _impl)->isAggressiveBaby();
}
...
int CreatureObject::getNumberOfSkills() {
	if (_impl == NULL) {
		...
		DistributedMethod method(this, 654);
...
void CreatureObject::updateZone(bool lightUpdate, bool sendPackets) {
	if (_impl == NULL) {
		...
		DistributedMethod method(this, 655);
...
void CreatureObject::updateZoneWithParent(unsigned long long cell, bool lightUpdate, bool sendPackets) {
	if (_impl == NULL) {
		...
		DistributedMethod method(this, 656);
...
bool CreatureObject::isDisabled() {
	if (_impl == NULL) {
		...
		DistributedMethod method(this, 657);
...
Packet* CreatureObjectAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case 34:
		...
		break;
	case 35:
		resp->insertBoolean(isDrivingVehicle());
		break;
	case 36:
	...
	case 48:
		...
		break;
	case 49:
		resp->insertBoolean(isMountedCreature());
		break;
	case 50:
	...
	case 442:
		...
		break;
	case 443:
		setAggressiveBaby(inv->getBooleanParameter());
		break;
	case 444:
		resp->insertBoolean(isAggressiveBaby());
		break;
	case 445:
...
bool CreatureObjectAdapter::isDrivingVehicle() {
	return ((CreatureObjectImplementation*) impl)->isDrivingVehicle();
}
...
bool CreatureObjectAdapter::isMountedCreature() {
	return ((CreatureObjectImplementation*) impl)->isMountedCreature();
}
...
void CreatureObjectAdapter::setAggressiveBaby(bool ag) {
	return ((CreatureObjectImplementation*) impl)->setAggressiveBaby(ag);
}

bool CreatureObjectAdapter::isAggressiveBaby() {
	return ((CreatureObjectImplementation*) impl)->isAggressiveBaby();
}
