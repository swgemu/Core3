...
void CreatureObject::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<CreatureObjectImplementation*>(servant));
}
...
Object* CreatureObjectImplementation::clone() {
	return dynamic_cast<Object*>(new CreatureObjectImplementation(*this));
}
