...
void StructureObject::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<StructureObjectImplementation*>(servant));
}
...
Object* StructureObjectImplementation::clone() {
	return dynamic_cast<Object*>(new StructureObjectImplementation(*this));
}
