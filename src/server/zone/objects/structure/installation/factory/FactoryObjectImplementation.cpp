...
FactoryObjectImplementation::FactoryObjectImplementation(uint64 objid)
		: FactoryObjectServant(objid) {

	init();
}


FactoryObjectImplementation::FactoryObjectImplementation(uint64 objid, InstallationDeed* deed)
		: FactoryObjectServant(objid) {
