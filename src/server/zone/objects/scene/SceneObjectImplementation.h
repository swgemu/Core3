...
#include "variables/ItemAttributes.h"

#include "variables/CustomizationVariables.h"
...
protected:
	...
	UnsignedInteger movementCounter;
	Bool moving;
	...
	SceneObjectReference<SceneObject> parent;

	UnsignedInteger linkType;
	...
	UnsignedLong associatedArea;

	Bool attackable;

	SerializableVectorMap<SceneObjectReference<GroupObject>, Integer> groupDamageList;
	SerializableVectorMap<SceneObjectReference<CreatureObject>, ReferenceSlot<DamageDone> > playerDamageList;
...
public:
	...
	inline void getCustomizationString(String& appearance) {
		customizationVariables.getData(appearance);
	}
