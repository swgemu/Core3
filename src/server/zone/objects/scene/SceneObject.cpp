...
SceneObjectImplementation::SceneObjectImplementation() {
	_initializeImplementation();
	// server/zone/objects/scene/SceneObject.idl(385):  		initializePrivateData();
	initializePrivateData();
}

void SceneObjectImplementation::finalize() {
	// server/zone/objects/scene/SceneObject.idl(389):  		Logger.info("deleting object from memory", true);
	Logger::info("deleting object from memory", true);
}

void SceneObjectImplementation::notifyLoadFromDatabase() {
	// server/zone/objects/scene/SceneObject.idl(417):  	}
	if (zone != NULL){
	// server/zone/objects/scene/SceneObject.idl(418):  			insertToZone(zone);
	insertToZone(zone);
}
}

void SceneObjectImplementation::info(const String& msg, bool forced) {
	// server/zone/objects/scene/SceneObject.idl(430):  		Logger.info(msg, forced);
	Logger::info(msg, forced);
}

void SceneObjectImplementation::error(const String& msg) {
	// server/zone/objects/scene/SceneObject.idl(440):  		Logger.error(msg);
	Logger::error(msg);
}

int SceneObjectImplementation::inRangeObjectCount() {
	// server/zone/objects/scene/SceneObject.idl(450):  		return QuadTreeEntry.inRangeObjectCount();
	return QuadTreeEntry::inRangeObjectCount();
}

QuadTreeEntry* SceneObjectImplementation::getInRangeObject(int index) {
	// server/zone/objects/scene/SceneObject.idl(461):  		return QuadTreeEntry.getInRangeObject(index);
	return QuadTreeEntry::getInRangeObject(index);
}

bool SceneObjectImplementation::isInRange(QuadTreeEntry* obj, float range) {
	// server/zone/objects/scene/SceneObject.idl(492):  		return QuadTreeEntry.isInRange(obj, range);
	return QuadTreeEntry::isInRange(obj, range);
}

void SceneObjectImplementation::removeInRangeObject(QuadTreeEntry* obj) {
	// server/zone/objects/scene/SceneObject.idl(496):  		QuadTreeEntry.removeInRangeObject(obj);
	QuadTreeEntry::removeInRangeObject(obj);
}

void SceneObjectImplementation::synchronizedUIListen(SceneObject* player, int value) {
	// server/zone/objects/scene/SceneObject.idl(538):  		Logger.info("Unhandled synchronizedUIListen", true);
...
void SceneObjectImplementation::synchronizedUIStopListen(SceneObject* player, int value) {
	// server/zone/objects/scene/SceneObject.idl(549):  		Logger.info("Unhandled synchronizedUIStopListen", true);
	Logger::info("Unhandled synchronizedUIStopListen", true);
}

int SceneObjectImplementation::canBeDestroyed(PlayerCreature* player) {
	// server/zone/objects/scene/SceneObject.idl(590):  		return 0;
	return 0;
}
...
void SceneObjectImplementation::setCustomObjectName(const UnicodeString& name, bool notifyClient) {
	// server/zone/objects/scene/SceneObject.idl(720):  		objectName.setCustomString(name);
...
int SceneObjectImplementation::compareTo(SceneObject* obj) {
	...
	else 	// server/zone/objects/scene/SceneObject.idl(861):  
	if (getObjectID() > obj->getObjectID())	// server/zone/objects/scene/SceneObject.idl(862):  			return -1;
	return -1;
...
unsigned long long SceneObjectImplementation::getParentID() {
	// server/zone/objects/scene/SceneObject.idl(883):  
	if (parent != NULL){
	// server/zone/objects/scene/SceneObject.idl(884):  			return parent.getObjectID();
...
void SceneObjectImplementation::addPendingTask(const String& name, Task* task) {
	// server/zone/objects/scene/SceneObject.idl(898):  		pendingTasks.put(name, task);
	(&pendingTasks)->put(name, task);
}

void SceneObjectImplementation::removePendingTask(const String& name) {
	// server/zone/objects/scene/SceneObject.idl(909):  		pendingTasks.drop(name);
	(&pendingTasks)->drop(name);
}

Task* SceneObjectImplementation::getPendingTask(const String& name) {
	// server/zone/objects/scene/SceneObject.idl(920):  		return pendingTasks.get(name);
...
Vector3 SceneObjectImplementation::getPosition() {
	// server/zone/objects/scene/SceneObject.idl(975):  		return QuadTreeEntry.getPosition();
	return QuadTreeEntry::getPosition();
}

float SceneObjectImplementation::getPositionX() {
	// server/zone/objects/scene/SceneObject.idl(991):  		return QuadTreeEntry.getPositionX();
	return QuadTreeEntry::getPositionX();
}

float SceneObjectImplementation::getPositionZ() {
	// server/zone/objects/scene/SceneObject.idl(995):  		return QuadTreeEntry.getPositionZ();
	return QuadTreeEntry::getPositionZ();
}

float SceneObjectImplementation::getPositionY() {
	// server/zone/objects/scene/SceneObject.idl(999):  		return QuadTreeEntry.getPositionY();
	return QuadTreeEntry::getPositionY();
}

float SceneObjectImplementation::getDirectionX() {
	// server/zone/objects/scene/SceneObject.idl(1003):  		return direction.getX();
	return (&direction)->getX();
}

float SceneObjectImplementation::getDirectionZ() {
	// server/zone/objects/scene/SceneObject.idl(1007):  		return direction.getZ();
	return (&direction)->getZ();
}

float SceneObjectImplementation::getDirectionY() {
	// server/zone/objects/scene/SceneObject.idl(1011):  		return direction.getY();
	return (&direction)->getY();
}

float SceneObjectImplementation::getDirectionW() {
	// server/zone/objects/scene/SceneObject.idl(1015):  		return direction.getW();
	return (&direction)->getW();
}

unsigned int SceneObjectImplementation::getClientObjectCRC() {
	// server/zone/objects/scene/SceneObject.idl(1022):  		return clientObjectCRC;
	return clientObjectCRC;
}

unsigned int SceneObjectImplementation::getServerObjectCRC() {
	// server/zone/objects/scene/SceneObject.idl(1026):  		return serverObjectCRC;
	return serverObjectCRC;
}

bool SceneObjectImplementation::isWaypointObject() {
	// server/zone/objects/scene/SceneObject.idl(1030):  		return gameObjectType == WAYPOINT;
	return gameObjectType == WAYPOINT;
}

StringId* SceneObjectImplementation::getObjectName() {
	// server/zone/objects/scene/SceneObject.idl(1035):  		return objectName;
	return (&objectName);
}

String SceneObjectImplementation::getObjectNameStringIdFile() {
	// server/zone/objects/scene/SceneObject.idl(1039):  		return objectName.getFile();
	return (&objectName)->getFile();
}

String SceneObjectImplementation::getObjectNameStringIdName() {
	// server/zone/objects/scene/SceneObject.idl(1043):  		return objectName.getStringID();
	return (&objectName)->getStringID();
}

StringId* SceneObjectImplementation::getDetailedDescription() {
	// server/zone/objects/scene/SceneObject.idl(1048):  		return detailedDescription;
	return (&detailedDescription);
}

int SceneObjectImplementation::getArrangementDescriptorSize() {
	// server/zone/objects/scene/SceneObject.idl(1052):  		return arrangementDescriptors.size();
	return (&arrangementDescriptors)->size();
}

String SceneObjectImplementation::getArrangementDescriptor(int idx) {
	// server/zone/objects/scene/SceneObject.idl(1056):  		return arrangementDescriptors.get(idx);
	return (&arrangementDescriptors)->get(idx);
}

String SceneObjectImplementation::getSlotDescriptor(int idx) {
	// server/zone/objects/scene/SceneObject.idl(1060):  		return slotDescriptors.get(idx);
	return (&slotDescriptors)->get(idx);
}

bool SceneObjectImplementation::hasSlotDescriptor(const String& descr) {
	// server/zone/objects/scene/SceneObject.idl(1064):  
	for (	// server/zone/objects/scene/SceneObject.idl(1064):  		for (int i = 0;
	int i = 0;
	i < (&slotDescriptors)->size();
 ++i) {
	// server/zone/objects/scene/SceneObject.idl(1065):  		}
	if ((&slotDescriptors)->get(i) == descr)	// server/zone/objects/scene/SceneObject.idl(1066):  				return true;
	return true;
}
	// server/zone/objects/scene/SceneObject.idl(1069):  		return false;
	return false;
}

SceneObject* SceneObjectImplementation::getSlottedObject(const String& slot) {
	// server/zone/objects/scene/SceneObject.idl(1073):  		return slottedObjects.get(slot);
	return (&slottedObjects)->get(slot);
}

int SceneObjectImplementation::getSlotDescriptorSize() {
	// server/zone/objects/scene/SceneObject.idl(1077):  		return slotDescriptors.size();
	return (&slotDescriptors)->size();
}

int SceneObjectImplementation::getContainerObjectsSize() {
	// server/zone/objects/scene/SceneObject.idl(1081):  		return containerObjects.size();
	return (&containerObjects)->size();
}

bool SceneObjectImplementation::hasFullContainerObjects() {
	// server/zone/objects/scene/SceneObject.idl(1085):  		return containerObjects.size() == containerVolumeLimit;
	return (&containerObjects)->size() == containerVolumeLimit;
}

SceneObject* SceneObjectImplementation::getContainerObject(int idx) {
	// server/zone/objects/scene/SceneObject.idl(1089):  		return containerObjects.get(idx);
	return (&containerObjects)->get(idx);
}

ZoneClientSession* SceneObjectImplementation::getClient() {
	// server/zone/objects/scene/SceneObject.idl(1093):  		return null;
	return NULL;
}

unsigned int SceneObjectImplementation::getGameObjectType() {
	// server/zone/objects/scene/SceneObject.idl(1097):  		return gameObjectType;
	return gameObjectType;
}

unsigned int SceneObjectImplementation::getContainmentType() {
	// server/zone/objects/scene/SceneObject.idl(1101):  		return containmentType;
	return containmentType;
}

Zone* SceneObjectImplementation::getZone() {
	// server/zone/objects/scene/SceneObject.idl(1105):  		return zone;
	return zone;
}

float SceneObjectImplementation::getDirectionAngle() {
	// server/zone/objects/scene/SceneObject.idl(1109):  		return direction.getDegrees();
	return (&direction)->getDegrees();
}

float SceneObjectImplementation::getSpecialDirectionAngle() {
	// server/zone/objects/scene/SceneObject.idl(1113):  		return direction.getSpecialDegrees();
	return (&direction)->getSpecialDegrees();
}

unsigned int SceneObjectImplementation::getMovementCounter() {
	// server/zone/objects/scene/SceneObject.idl(1131):  		return movementCounter;
	return movementCounter;
}

SceneObject* SceneObjectImplementation::getParent() {
	// server/zone/objects/scene/SceneObject.idl(1135):  		return parent;
	return parent;
}

ZoneServer* SceneObjectImplementation::getZoneServer() {
	// server/zone/objects/scene/SceneObject.idl(1139):  		return server.getZoneServer();
	return server->getZoneServer();
}

UnicodeString SceneObjectImplementation::getCustomObjectName() {
	// server/zone/objects/scene/SceneObject.idl(1168):  		return objectName.getCustomString();
	return (&objectName)->getCustomString();
}

bool SceneObjectImplementation::isInQuadTree() {
	// server/zone/objects/scene/SceneObject.idl(1172):  		return QuadTreeEntry.isInQuadTree();
	return QuadTreeEntry::isInQuadTree();
}

String SceneObjectImplementation::getLoggingName() {
	// server/zone/objects/scene/SceneObject.idl(1176):  		return Logger.getLoggingName();
	return Logger::getLoggingName();
}

bool SceneObjectImplementation::isPlayerCreature() {
	// server/zone/objects/scene/SceneObject.idl(1180):  		return gameObjectType == PLAYERCREATURE;
...
bool SceneObjectImplementation::isGarage() {
	// server/zone/objects/scene/SceneObject.idl(1200):  		return gameObjectType == GARAGEBUILDING || gameObjectType == GARAGEINSTALLATION;
...
bool SceneObjectImplementation::isFishingPoleObject() {
	// server/zone/objects/scene/SceneObject.idl(1248):  		return gameObjectType == FISHINGPOLE;
...
SceneObject* SceneObjectImplementation::getContainerObject(unsigned long long objectID) {
	// server/zone/objects/scene/SceneObject.idl(1364):  		return containerObjects.get(objectID);
	return (&containerObjects)->get(objectID);
}

bool SceneObjectImplementation::isStaticObject() {
	// server/zone/objects/scene/SceneObject.idl(1370):  		return staticObject;
	return staticObject;
}
...
ActiveArea* SceneObjectImplementation::getActiveArea() {
	// server/zone/objects/scene/SceneObject.idl(1386):  		return activeArea;
	return activeArea;
}

int SceneObjectImplementation::getMapLocationsType1() {
	// server/zone/objects/scene/SceneObject.idl(1390):  		return templateObject.getMapLocationsType1();
	return templateObject->getMapLocationsType1();
}

int SceneObjectImplementation::getMapLocationsType2() {
	// server/zone/objects/scene/SceneObject.idl(1394):  		return templateObject.getMapLocationsType2();
	return templateObject->getMapLocationsType2();
}

int SceneObjectImplementation::getMapLocationsType3() {
	// server/zone/objects/scene/SceneObject.idl(1398):  		return templateObject.getMapLocationsType3();
	return templateObject->getMapLocationsType3();
}

void SceneObjectImplementation::createChildObjects() {
	// server/zone/objects/scene/SceneObject.idl(1402):  		return;
	return;
}
