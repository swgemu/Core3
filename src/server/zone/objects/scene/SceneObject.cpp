...
void SceneObject::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<SceneObjectImplementation*>(servant));
}
...
Object* SceneObjectImplementation::clone() {
	return dynamic_cast<Object*>(new SceneObjectImplementation(*this));
}
