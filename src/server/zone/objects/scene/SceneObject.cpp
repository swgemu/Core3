...
void SceneObjectImplementation::notifyLoadFromDatabase() {
	// server/zone/objects/scene/SceneObject.idl(394):  	}
	if (zone != NULL){
	// server/zone/objects/scene/SceneObject.idl(395):  			insertToZone(zone);
	insertToZone(zone);
}
}

void SceneObjectImplementation::info(const String& msg, bool forced) {
	// server/zone/objects/scene/SceneObject.idl(407):  		Logger.info(msg, forced);
	Logger::info(msg, forced);
}

void SceneObjectImplementation::error(const String& msg) {
	// server/zone/objects/scene/SceneObject.idl(417):  		Logger.error(msg);
	Logger::error(msg);
}

int SceneObjectImplementation::inRangeObjectCount() {
	// server/zone/objects/scene/SceneObject.idl(427):  		return QuadTreeEntry.inRangeObjectCount();
	return QuadTreeEntry::inRangeObjectCount();
}

QuadTreeEntry* SceneObjectImplementation::getInRangeObject(int index) {
	// server/zone/objects/scene/SceneObject.idl(438):  		return QuadTreeEntry.getInRangeObject(index);
	return QuadTreeEntry::getInRangeObject(index);
}

bool SceneObjectImplementation::isInRange(SceneObject* obj, float range) {
	// server/zone/objects/scene/SceneObject.idl(450):  		return QuadTreeEntry.isInRange(obj.getPositionX(), obj.getPositionY(), range);
...
bool SceneObjectImplementation::isInRange(QuadTreeEntry* obj, float range) {
	// server/zone/objects/scene/SceneObject.idl(463):  		return QuadTreeEntry.isInRange(obj, range);
	return QuadTreeEntry::isInRange(obj, range);
}

void SceneObjectImplementation::removeInRangeObject(QuadTreeEntry* obj) {
	// server/zone/objects/scene/SceneObject.idl(467):  		QuadTreeEntry.removeInRangeObject(obj);
...
void SceneObjectImplementation::setCustomObjectName(const UnicodeString& name, bool notifyClient) {
	// server/zone/objects/scene/SceneObject.idl(688):  		objectName.setCustomString(name);
	(&objectName)->setCustomString(name);
}

void SceneObjectImplementation::notifyCloseContainer(PlayerCreature* player) {
	// server/zone/objects/scene/SceneObject.idl(720):  
	for (	// server/zone/objects/scene/SceneObject.idl(720):  		for (int i = 0;
	int i = 0;
	i < (&closeContainerObservers)->size();
 ++i) {
	// server/zone/objects/scene/SceneObject.idl(721):  			CloseContainerObserver observer = closeContainerObservers.get(i);
	CloseContainerObserver* observer = (&closeContainerObservers)->get(i);
	// server/zone/objects/scene/SceneObject.idl(723):  			int res = observer.notifyCloseContainer(player, this);
	int res = observer->notifyCloseContainer(player, _this);
	// server/zone/objects/scene/SceneObject.idl(725):  		}
	if (res == 1){
	// server/zone/objects/scene/SceneObject.idl(726):  				closeContainerObservers.drop(observer);
	(&closeContainerObservers)->drop(observer);
	// server/zone/objects/scene/SceneObject.idl(727):  				i = i - 1;
	i = i - 1;
}
}
}
...
void SceneObjectImplementation::attachPositionChangedObserver(SceneObjectObserver* observer) {
	// server/zone/objects/scene/SceneObject.idl(916):  		positionChangedObservers.put(observer);
...
void SceneObjectImplementation::attachCloseContainerObserver(CloseContainerObserver* observer) {
	// server/zone/objects/scene/SceneObject.idl(924):  		closeContainerObservers.put(observer);
...
void SceneObjectImplementation::deattachCloseContainerObserver(CloseContainerObserver* observer) {
	// server/zone/objects/scene/SceneObject.idl(932):  		closeContainerObservers.drop(observer);
	(&closeContainerObservers)->drop(observer);
}

void SceneObjectImplementation::deattachPositionChangedObserver(SceneObjectObserver* observer) {
	// server/zone/objects/scene/SceneObject.idl(940):  		positionChangedObservers.drop(observer);
	(&positionChangedObservers)->drop(observer);
}

int SceneObjectImplementation::notifySelfPositionUpdate() {
	// server/zone/objects/scene/SceneObject.idl(951):  
	for (	// server/zone/objects/scene/SceneObject.idl(951):  		for (int i = 0;
	int i = 0;
	i < (&positionChangedObservers)->size();
 ++i) {
	// server/zone/objects/scene/SceneObject.idl(952):  			SceneObjectObserver observer = positionChangedObservers.get(i);
	SceneObjectObserver* observer = (&positionChangedObservers)->get(i);
	// server/zone/objects/scene/SceneObject.idl(954):  			int res = observer.notify(this);
	int res = observer->notify(_this);
	// server/zone/objects/scene/SceneObject.idl(956):  		}
	if (res == 1){
	// server/zone/objects/scene/SceneObject.idl(957):  				positionChangedObservers.drop(observer);
	(&positionChangedObservers)->drop(observer);
	// server/zone/objects/scene/SceneObject.idl(958):  				i = i - 1;
	i = i - 1;
}
}
	// server/zone/objects/scene/SceneObject.idl(962):  		return 0;
	return 0;
}

int SceneObjectImplementation::notifyObjectInserted(SceneObject* object) {
	// server/zone/objects/scene/SceneObject.idl(970):  		return 0;
	return 0;
}

int SceneObjectImplementation::notifyObjectRemoved(SceneObject* object) {
	// server/zone/objects/scene/SceneObject.idl(978):  		return 0;
	return 0;
}

bool SceneObjectImplementation::hasNotifiedSentObject(SceneObject* object) {
	// server/zone/objects/scene/SceneObject.idl(982):  		return notifiedSentObjects.contains(object);
	return (&notifiedSentObjects)->contains(object);
}

void SceneObjectImplementation::addNotifiedSentObject(SceneObject* object) {
	// server/zone/objects/scene/SceneObject.idl(986):  		notifiedSentObjects.put(object);
	(&notifiedSentObjects)->put(object);
}

void SceneObjectImplementation::removeNotifiedSentObject(SceneObject* object) {
	// server/zone/objects/scene/SceneObject.idl(990):  		notifiedSentObjects.drop(object);
	(&notifiedSentObjects)->drop(object);
}

float SceneObjectImplementation::getPositionX() {
	// server/zone/objects/scene/SceneObject.idl(996):  		return QuadTreeEntry.getPositionX();
	return QuadTreeEntry::getPositionX();
}

float SceneObjectImplementation::getPositionZ() {
	// server/zone/objects/scene/SceneObject.idl(1000):  		return QuadTreeEntry.getPositionZ();
	return QuadTreeEntry::getPositionZ();
}

float SceneObjectImplementation::getPositionY() {
	// server/zone/objects/scene/SceneObject.idl(1004):  		return QuadTreeEntry.getPositionY();
	return QuadTreeEntry::getPositionY();
}

float SceneObjectImplementation::getDirectionX() {
	// server/zone/objects/scene/SceneObject.idl(1008):  		return direction.getX();
	return (&direction)->getX();
}

float SceneObjectImplementation::getDirectionZ() {
	// server/zone/objects/scene/SceneObject.idl(1012):  		return direction.getZ();
	return (&direction)->getZ();
}

float SceneObjectImplementation::getDirectionY() {
	// server/zone/objects/scene/SceneObject.idl(1016):  		return direction.getY();
	return (&direction)->getY();
}

float SceneObjectImplementation::getDirectionW() {
	// server/zone/objects/scene/SceneObject.idl(1020):  		return direction.getW();
	return (&direction)->getW();
}

unsigned int SceneObjectImplementation::getClientObjectCRC() {
	// server/zone/objects/scene/SceneObject.idl(1028):  		return clientObjectCRC;
	return clientObjectCRC;
}

unsigned int SceneObjectImplementation::getServerObjectCRC() {
	// server/zone/objects/scene/SceneObject.idl(1032):  		return serverObjectCRC;
	return serverObjectCRC;
}

bool SceneObjectImplementation::isWaypointObject() {
	// server/zone/objects/scene/SceneObject.idl(1036):  		return gameObjectType == WAYPOINT;
	return gameObjectType == WAYPOINT;
}

StringId* SceneObjectImplementation::getObjectName() {
	// server/zone/objects/scene/SceneObject.idl(1041):  		return objectName;
	return (&objectName);
}

String SceneObjectImplementation::getObjectNameStringIdFile() {
	// server/zone/objects/scene/SceneObject.idl(1045):  		return objectName.getFile();
	return (&objectName)->getFile();
}

String SceneObjectImplementation::getObjectNameStringIdName() {
	// server/zone/objects/scene/SceneObject.idl(1049):  		return objectName.getStringID();
	return (&objectName)->getStringID();
}

StringId* SceneObjectImplementation::getDetailedDescription() {
	// server/zone/objects/scene/SceneObject.idl(1054):  		return detailedDescription;
	return (&detailedDescription);
}

int SceneObjectImplementation::getArrangementDescriptorSize() {
	// server/zone/objects/scene/SceneObject.idl(1058):  		return arrangementDescriptors.size();
	return (&arrangementDescriptors)->size();
}

String SceneObjectImplementation::getArrangementDescriptor(int idx) {
	// server/zone/objects/scene/SceneObject.idl(1062):  		return arrangementDescriptors.get(idx);
	return (&arrangementDescriptors)->get(idx);
}

String SceneObjectImplementation::getSlotDescriptor(int idx) {
	// server/zone/objects/scene/SceneObject.idl(1066):  		return slotDescriptors.get(idx);
	return (&slotDescriptors)->get(idx);
}

SceneObject* SceneObjectImplementation::getSlottedObject(const String& slot) {
	// server/zone/objects/scene/SceneObject.idl(1070):  		return slottedObjects.get(slot);
	return (&slottedObjects)->get(slot);
}

int SceneObjectImplementation::getSlotDescriptorSize() {
	// server/zone/objects/scene/SceneObject.idl(1074):  		return slotDescriptors.size();
	return (&slotDescriptors)->size();
}

int SceneObjectImplementation::getContainerObjectsSize() {
	// server/zone/objects/scene/SceneObject.idl(1078):  		return containerObjects.size();
	return (&containerObjects)->size();
}

bool SceneObjectImplementation::hasFullContainerObjects() {
	// server/zone/objects/scene/SceneObject.idl(1082):  		return containerObjects.size() == containerVolumeLimit;
	return (&containerObjects)->size() == containerVolumeLimit;
}

SceneObject* SceneObjectImplementation::getContainerObject(int idx) {
	// server/zone/objects/scene/SceneObject.idl(1086):  		return containerObjects.get(idx);
	return (&containerObjects)->get(idx);
}

ZoneClientSession* SceneObjectImplementation::getClient() {
	// server/zone/objects/scene/SceneObject.idl(1090):  		return null;
	return NULL;
}

unsigned int SceneObjectImplementation::getGameObjectType() {
	// server/zone/objects/scene/SceneObject.idl(1094):  		return gameObjectType;
	return gameObjectType;
}

unsigned int SceneObjectImplementation::getContainmentType() {
	// server/zone/objects/scene/SceneObject.idl(1098):  		return containmentType;
	return containmentType;
}

Zone* SceneObjectImplementation::getZone() {
	// server/zone/objects/scene/SceneObject.idl(1102):  		return zone;
	return zone;
}

float SceneObjectImplementation::getDirectionAngle() {
	// server/zone/objects/scene/SceneObject.idl(1106):  		return direction.getDegrees();
	return (&direction)->getDegrees();
}

float SceneObjectImplementation::getSpecialDirectionAngle() {
	// server/zone/objects/scene/SceneObject.idl(1110):  		return direction.getSpecialDegrees();
...
UnicodeString SceneObjectImplementation::getCustomObjectName() {
	// server/zone/objects/scene/SceneObject.idl(1150):  		return objectName.getCustomString();
	return (&objectName)->getCustomString();
}

bool SceneObjectImplementation::isInQuadTree() {
	// server/zone/objects/scene/SceneObject.idl(1154):  		return QuadTreeEntry.isInQuadTree();
	return QuadTreeEntry::isInQuadTree();
}

String SceneObjectImplementation::getLoggingName() {
	// server/zone/objects/scene/SceneObject.idl(1158):  		return Logger.getLoggingName();
	return Logger::getLoggingName();
}

bool SceneObjectImplementation::isPlayerCreature() {
	// server/zone/objects/scene/SceneObject.idl(1162):  		return gameObjectType == PLAYERCREATURE;
...
bool SceneObjectImplementation::isInstrument() {
	// server/zone/objects/scene/SceneObject.idl(1202):  		return gameObjectType == INSTRUMENT;
...
bool SceneObjectImplementation::isFishingPoleObject() {
	// server/zone/objects/scene/SceneObject.idl(1210):  		return gameObjectType == FISHINGPOLE;
...
SceneObject* SceneObjectImplementation::getContainerObject(unsigned long long objectID) {
	// server/zone/objects/scene/SceneObject.idl(1314):  		return containerObjects.get(objectID);
	return (&containerObjects)->get(objectID);
}

bool SceneObjectImplementation::isStaticObject() {
	// server/zone/objects/scene/SceneObject.idl(1318):  		return staticObject;
	return staticObject;
}

bool SceneObjectImplementation::isControlDevice() {
	// server/zone/objects/scene/SceneObject.idl(1322):  		return false;
	return false;
}
