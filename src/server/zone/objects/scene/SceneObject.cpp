...
bool SceneObjectImplementation::isBazaarTerminal() {
	// server/zone/objects/scene/SceneObject.idl(1356):  		return gameObjectType == BAZAAR;
	return gameObjectType == BAZAAR;
}

bool SceneObjectImplementation::isFishingBait() {
	// server/zone/objects/scene/SceneObject.idl(1360):  		return gameObjectType == FISHINGBAIT;
	return gameObjectType == FISHINGBAIT;
}

void SceneObjectImplementation::setPosition(float x, float z, float y) {
	// server/zone/objects/scene/SceneObject.idl(1364):  		QuadTreeEntry.setPosition(x, z, y);
	QuadTreeEntry::setPosition(x, z, y);
}

void SceneObjectImplementation::initializePosition(float x, float z, float y) {
	// server/zone/objects/scene/SceneObject.idl(1368):  		QuadTreeEntry.initializePosition(x, z, y);
	QuadTreeEntry::initializePosition(x, z, y);
}

void SceneObjectImplementation::setGameObjectType(unsigned int type) {
	// server/zone/objects/scene/SceneObject.idl(1372):  		gameObjectType = type;
	gameObjectType = type;
}

void SceneObjectImplementation::addActiveArea(ActiveArea* area) {
	// server/zone/objects/scene/SceneObject.idl(1376):  		activeAreas.put(area);
	(&activeAreas)->put(area);
}

void SceneObjectImplementation::dropActiveArea(ActiveArea* area) {
	// server/zone/objects/scene/SceneObject.idl(1380):  		activeAreas.drop(area);
	(&activeAreas)->drop(area);
}

void SceneObjectImplementation::setClientObjectCRC(unsigned int objCRC) {
	// server/zone/objects/scene/SceneObject.idl(1384):  		clientObjectCRC = objCRC;
	clientObjectCRC = objCRC;
}

void SceneObjectImplementation::setServerObjectCRC(unsigned int objCRC) {
	// server/zone/objects/scene/SceneObject.idl(1388):  		serverObjectCRC = objCRC;
	serverObjectCRC = objCRC;
}

void SceneObjectImplementation::setParent(SceneObject* par) {
	// server/zone/objects/scene/SceneObject.idl(1392):  		parent = par;
	parent = par;
}

void SceneObjectImplementation::setZoneProcessServer(ZoneProcessServer* srv) {
	// server/zone/objects/scene/SceneObject.idl(1397):  		server = srv;
	server = srv;
}

void SceneObjectImplementation::setZone(Zone* zon) {
	// server/zone/objects/scene/SceneObject.idl(1404):  		zone = zon;
	zone = zon;
}

void SceneObjectImplementation::setDirection(float fw, float fx, float fy, float fz) {
	// server/zone/objects/scene/SceneObject.idl(1408):  		direction.set(fw, fx, fy, fz);
	(&direction)->set(fw, fx, fy, fz);
}

void SceneObjectImplementation::setDirection(float headingAngleRadians) {
	// server/zone/objects/scene/SceneObject.idl(1412):  		direction.setHeadingDirection(headingAngleRadians);
	(&direction)->setHeadingDirection(headingAngleRadians);
}

void SceneObjectImplementation::setMovementCounter(unsigned int count) {
	// server/zone/objects/scene/SceneObject.idl(1419):  		movementCounter = count;
	movementCounter = count;
}

void SceneObjectImplementation::incrementMovementCounter() {
	// server/zone/objects/scene/SceneObject.idl(1423):  		movementCounter++;
	movementCounter ++;
}

void SceneObjectImplementation::setContainmentType(unsigned int type) {
	// server/zone/objects/scene/SceneObject.idl(1427):  		containmentType = type;
	containmentType = type;
}

void SceneObjectImplementation::setLoggingName(const String& name) {
	// server/zone/objects/scene/SceneObject.idl(1431):  		Logger.setLoggingName(name);
	Logger::setLoggingName(name);
}

void SceneObjectImplementation::setStaticObject(bool val) {
	// server/zone/objects/scene/SceneObject.idl(1435):  		staticObject = val;
	staticObject = val;
}

VectorMap<unsigned long long, ManagedReference<SceneObject* > >* SceneObjectImplementation::getContainerObjects() {
	// server/zone/objects/scene/SceneObject.idl(1440):  		return containerObjects;
	return (&containerObjects);
}

bool SceneObjectImplementation::hasObjectInContainer(unsigned long long objectID) {
	// server/zone/objects/scene/SceneObject.idl(1444):  		return containerObjects.contains(objectID);
	return (&containerObjects)->contains(objectID);
}

bool SceneObjectImplementation::hasObjectInSlottedContainer(SceneObject* object) {
	// server/zone/objects/scene/SceneObject.idl(1448):  		int arrangementSize = object.getArrangementDescriptorSize();
	int arrangementSize = object->getArrangementDescriptorSize();
	// server/zone/objects/scene/SceneObject.idl(1450):  		SceneObject 
	if (arrangementSize == 0){
	// server/zone/objects/scene/SceneObject.idl(1451):  			return false;
	return false;
}
	// server/zone/objects/scene/SceneObject.idl(1454):  obj = slottedObjects.get(object.getArrangementDescriptor(0));
	SceneObject* obj = (&slottedObjects)->get(object->getArrangementDescriptor(0));
	// server/zone/objects/scene/SceneObject.idl(1456):  
	if (object == obj){
	// server/zone/objects/scene/SceneObject.idl(1457):  			return true;
	return true;
}

	else {
	// server/zone/objects/scene/SceneObject.idl(1459):  			return false;
	return false;
}
}

SceneObject* SceneObjectImplementation::getContainerObject(unsigned long long objectID) {
	// server/zone/objects/scene/SceneObject.idl(1464):  		return containerObjects.get(objectID);
	return (&containerObjects)->get(objectID);
}

bool SceneObjectImplementation::isStaticObject() {
	// server/zone/objects/scene/SceneObject.idl(1470):  		return staticObject;
	return staticObject;
}
...
Vector<ManagedReference<ActiveArea* > >* SceneObjectImplementation::getActiveAreas() {
	// server/zone/objects/scene/SceneObject.idl(1503):  		return activeAreas;
	return (&activeAreas);
}

ActiveArea* SceneObjectImplementation::getActiveRegion() {
	// server/zone/objects/scene/SceneObject.idl(1507):  
	for (	// server/zone/objects/scene/SceneObject.idl(1507):  		for (int i = 0;
	int i = 0;
	i < (&activeAreas)->size();
i ++) {
	// server/zone/objects/scene/SceneObject.idl(1508):  			ActiveArea region = activeAreas.get(i);
	ActiveArea* region = (&activeAreas)->get(i);
	// server/zone/objects/scene/SceneObject.idl(1510):  		}
	if (region->isRegion()){
	// server/zone/objects/scene/SceneObject.idl(1511):  				return region;
	return region;
}
}
	// server/zone/objects/scene/SceneObject.idl(1515):  		return null;
	return NULL;
}

bool SceneObjectImplementation::hasActiveArea(ActiveArea* area) {
	// server/zone/objects/scene/SceneObject.idl(1519):  		return activeAreas.contains(area);
	return (&activeAreas)->contains(area);
}

int SceneObjectImplementation::getMapLocationsType1() {
	// server/zone/objects/scene/SceneObject.idl(1523):  		return templateObject.getMapLocationsType1();
	return templateObject->getMapLocationsType1();
}

int SceneObjectImplementation::getMapLocationsType2() {
	// server/zone/objects/scene/SceneObject.idl(1527):  		return templateObject.getMapLocationsType2();
	return templateObject->getMapLocationsType2();
}

int SceneObjectImplementation::getMapLocationsType3() {
	// server/zone/objects/scene/SceneObject.idl(1531):  		return templateObject.getMapLocationsType3();
