...
bool SceneObjectImplementation::isPlayer() {
	// server/zone/objects/scene/SceneObject.idl(293):  return true;
	return true;
}

bool SceneObjectImplementation::addObject(SceneObject* object) {
	// server/zone/objects/scene/SceneObject.idl(297):  return 
	if (containerType == 0x1){
	// server/zone/objects/scene/SceneObject.idl(298):  int arrangementSize = object.getArrangementDescriptorSize();
	int arrangementSize = object->getArrangementDescriptorSize();
	// server/zone/objects/scene/SceneObject.idl(300):  
	for (	// server/zone/objects/scene/SceneObject.idl(300):  for (int i = 0;
	int i = 0x0;
	i < arrangementSize;
 ++i) {
	// server/zone/objects/scene/SceneObject.idl(301):  string childArrangement = object.getArrangementDescriptor(i);
	String childArrangement = object->getArrangementDescriptor(i);
	// server/zone/objects/scene/SceneObject.idl(303):  }
	if (this->children->contains(childArrangement))	// server/zone/objects/scene/SceneObject.idl(304):  return false;
	return false;
}
}
	// server/zone/objects/scene/SceneObject.idl(309):  true;
	return true;
}
...
unsigned long long SceneObjectImplementation::getObjectID() {
	// server/zone/objects/scene/SceneObject.idl(325):  return QuadTreeEntry.objectID;
	return QuadTreeEntry::objectID;
}

float SceneObjectImplementation::getPositionX() {
	// server/zone/objects/scene/SceneObject.idl(329):  return QuadTreeEntry.getPositionX();
	return QuadTreeEntry::getPositionX();
}

float SceneObjectImplementation::getPositionZ() {
	// server/zone/objects/scene/SceneObject.idl(333):  return QuadTreeEntry.getPositionZ();
	return QuadTreeEntry::getPositionZ();
}

float SceneObjectImplementation::getPositionY() {
	// server/zone/objects/scene/SceneObject.idl(337):  return QuadTreeEntry.getPositionY();
	return QuadTreeEntry::getPositionY();
}

float SceneObjectImplementation::getDirectionX() {
	// server/zone/objects/scene/SceneObject.idl(341):  return direction.getX();
	return direction->getX();
}

float SceneObjectImplementation::getDirectionZ() {
	// server/zone/objects/scene/SceneObject.idl(345):  return direction.getZ();
	return direction->getZ();
}

float SceneObjectImplementation::getDirectionY() {
	// server/zone/objects/scene/SceneObject.idl(349):  return direction.getY();
	return direction->getY();
}

float SceneObjectImplementation::getDirectionW() {
	// server/zone/objects/scene/SceneObject.idl(353):  return direction.getW();
	return direction->getW();
}

unsigned int SceneObjectImplementation::getObjectCRC() {
	// server/zone/objects/scene/SceneObject.idl(357):  return this.objectCRC;
	return this->objectCRC;
}

StringId* SceneObjectImplementation::getObjectName() {
	// server/zone/objects/scene/SceneObject.idl(361):  return this.objectName;
	return this->objectName;
}

int SceneObjectImplementation::getArrangementDescriptorSize() {
	// server/zone/objects/scene/SceneObject.idl(365):  return arrangementDescriptors.size();
	return arrangementDescriptors->size();
}

String SceneObjectImplementation::getArrangementDescriptor(int idx) {
	// server/zone/objects/scene/SceneObject.idl(369):  return arrangementDescriptors.get(idx);
	return arrangementDescriptors->get(idx);
}

String SceneObjectImplementation::getSlotDescriptor(int idx) {
	// server/zone/objects/scene/SceneObject.idl(373):  return slotDescriptors.get(idx);
	return slotDescriptors->get(idx);
}

int SceneObjectImplementation::getArrangementDescriptorSize() {
	// server/zone/objects/scene/SceneObject.idl(377):  return slotDescriptors.size();
	return slotDescriptors->size();
}

unsigned int SceneObjectImplementation::getGameObjectType() {
	// server/zone/objects/scene/SceneObject.idl(381):  return this.gameObjectType;
	return this->gameObjectType;
}

void SceneObjectImplementation::setPosition(float x, float z, float y) {
	// server/zone/objects/scene/SceneObject.idl(385):  QuadTreeEntry.setPosition(x, z, y);
	QuadTreeEntry::setPosition(x, z, y);
}

void SceneObjectImplementation::setGameObjectType(unsigned int type) {
	// server/zone/objects/scene/SceneObject.idl(389):  this.gameObjectType = type;
	this->gameObjectType = type;
}

void SceneObjectImplementation::setObjectCRC(unsigned int objCRC) {
	// server/zone/objects/scene/SceneObject.idl(393):  this.objectCRC = objCRC;
	this->objectCRC = objCRC;
}

void SceneObjectImplementation::setParent(SceneObject* parent) {
	// server/zone/objects/scene/SceneObject.idl(397):  this.parent = parent;
	this->parent = parent;
}
