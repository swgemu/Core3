...
/*
 *	server/zone/objects/auction/AuctionItem.h generated by Engine3 IDL compiler 0.51
 */
...
class AuctionItemAdapter : public RWLockableAdapter {
public:
...
class AuctionItemServant : public RWLockableImplementation {
public:
	AuctionItem* _this;
