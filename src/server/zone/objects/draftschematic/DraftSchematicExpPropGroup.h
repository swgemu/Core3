...
/*
 *	server/zone/objects/draftschematic/DraftSchematicExpPropGroup.h generated by Engine3 IDL compiler 0.51
 */
...
class DraftSchematicExpPropGroupAdapter : public ORBObjectAdapter {
public:
...
class DraftSchematicExpPropGroupHelper : public ORBClassHelper, public Singleton<DraftSchematicExpPropGroupHelper> {
public:
...
class DraftSchematicExpPropGroupServant : public ORBObjectServant {
public:
