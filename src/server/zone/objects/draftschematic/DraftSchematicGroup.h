...
/*
 *	server/zone/objects/draftschematic/DraftSchematicGroup.h generated by Engine3 IDL compiler 0.51
 */
...
class DraftSchematicGroupAdapter : public ORBObjectAdapter {
public:
...
class DraftSchematicGroupHelper : public ORBClassHelper, public Singleton<DraftSchematicGroupHelper> {
public:
...
class DraftSchematicGroupServant : public ORBObjectServant {
public:
