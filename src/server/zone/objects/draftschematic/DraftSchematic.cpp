...
void DraftSchematic::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<DraftSchematicImplementation*>(servant));
}
...
Object* DraftSchematicImplementation::clone() {
	return dynamic_cast<Object*>(new DraftSchematicImplementation(*this));
}
