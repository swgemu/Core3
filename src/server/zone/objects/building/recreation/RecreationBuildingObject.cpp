...
void RecreationBuildingObject::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<RecreationBuildingObjectImplementation*>(servant));
}
...
Object* RecreationBuildingObjectImplementation::clone() {
	return dynamic_cast<Object*>(new RecreationBuildingObjectImplementation(*this));
}
