...
int PlayerCreature::getSavedZoneID() {
	...
	if (_implementation == NULL) {
		...
		DistributedMethod method(this, RPC_GETSAVEDZONEID__);
...
void PlayerCreature::setSavedZoneID(int id) {
	...
	if (_implementation == NULL) {
		...
		DistributedMethod method(this, RPC_SETSAVEDZONEID__INT_);
...
void PlayerCreature::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<PlayerCreatureImplementation*>(servant));
}
...
Object* PlayerCreatureImplementation::clone() {
	return dynamic_cast<Object*>(new PlayerCreatureImplementation(*this));
}
