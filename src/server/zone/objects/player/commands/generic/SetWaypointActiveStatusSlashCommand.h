...
class SetWaypointActiveStatusSlashCommand : public QueueCommand {
public:

	SetWaypointActiveStatusSlashCommand(const String& name, ZoneProcessServerImplementation* server)
