...
class NpcConversationSelectSlashCommand : public QueueCommand {
public:

	NpcConversationSelectSlashCommand(const String& name, ZoneProcessServerImplementation* server)
