...
/*
 *	server/zone/objects/player/sui/banktransferbox/SuiBankTransferBox.cpp generated by Engine3 IDL compiler 0.51
 */
...
SuiBankTransferBox::SuiBankTransferBox(ORBObjectServant* obj) : SuiBox(obj) {
}
...
Packet* SuiBankTransferBoxAdapter::invokeMethod(uint32 methid, ORBMethodInvocation* inv) {
...
ORBObject* SuiBankTransferBoxHelper::instantiateObject() {
	return new SuiBankTransferBox();
}

ORBObjectAdapter* SuiBankTransferBoxHelper::createAdapter(ORBObjectServant* obj) {
	ORBObjectAdapter* adapter = new SuiBankTransferBoxAdapter((SuiBankTransferBoxImplementation*) obj);

	ORBObjectStub* stub = new SuiBankTransferBox(obj);
...
void SuiBankTransferBoxServant::_setStub(ORBObjectStub* stub) {
	_this = (SuiBankTransferBox*) stub;
	SuiBoxServant::_setStub(stub);
}

ORBObjectStub* SuiBankTransferBoxServant::_getStub() {
	return _this;
}
