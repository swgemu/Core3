...
/*
 *	server/zone/objects/player/sui/banktransferbox/SuiBankTransferBox.h generated by Engine3 IDL compiler 0.51
 */
...
class SuiBankTransferBoxHelper : public ORBClassHelper, public Singleton<SuiBankTransferBoxHelper> {
public:
