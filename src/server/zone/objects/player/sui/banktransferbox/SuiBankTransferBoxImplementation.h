...
#ifndef SUIBANKTRANSFERBOXIMPLEMENTATION_H_
#define SUIBANKTRANSFERBOXIMPLEMENTATION_H_
...
public:
	SuiBankTransferBoxImplementation(Player* player, uint32 boxType);
...
#endif /*SUIBANKTRANSFERBOXIMPLEMENTATION_H_*/
