...
#ifndef SUIINPUTBOXIMPLEMENTATION_H_
#define SUIINPUTBOXIMPLEMENTATION_H_
...
public:
	...
	inline void setMaxInputSize(int size) {
		maxInputSize = size;
	}
	...
	inline bool isFilterBox() {
		return inputType == FILTER;
	}

};

#endif /*SUIINPUTBOXEVENT_H_*/
