...
class RequestWaypointAtPositionSlashCommand : public SlashCommand {
public:

	RequestWaypointAtPositionSlashCommand(const String& name, ZoneProcessServerImplementation* server)
