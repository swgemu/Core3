...
class RequestResourceWeightsBatchSlashCommand : public SlashCommand {
public:

	RequestResourceWeightsBatchSlashCommand(const String& name, ZoneProcessServerImplementation* server)
