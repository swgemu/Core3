...
#ifndef UNINVITESLASHCOMMAND_H_

#define UNINVITESLASHCOMMAND_H_


#include "../../../scene/SceneObject.h"

class UninviteSlashCommand : public SlashCommand {
public:

	UninviteSlashCommand(const String& name, ZoneProcessServerImplementation* server)
