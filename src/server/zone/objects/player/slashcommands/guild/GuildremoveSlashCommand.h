...
class GuildremoveSlashCommand : public SlashCommand {
public:

	GuildremoveSlashCommand(const String& name, ZoneProcessServerImplementation* server)
		: SlashCommand(name, server) {

	}

	/*
	 * Need to Lock the Player* before and unlock the Player* after this method wherever it is called from.
