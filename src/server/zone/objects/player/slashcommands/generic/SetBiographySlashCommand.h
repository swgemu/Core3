...
class SetBiographySlashCommand : public SlashCommand {
public:

	SetBiographySlashCommand(const String& name, ZoneProcessServerImplementation* server)
