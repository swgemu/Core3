...
#ifndef SETWAYPOINTNAMESLASHCOMMAND_H_

#define SETWAYPOINTNAMESLASHCOMMAND_H_


#include "../../../scene/SceneObject.h"
#include "../../../waypoint/WaypointObject.h"

class SetWaypointNameSlashCommand : public SlashCommand {
public:

	SetWaypointNameSlashCommand(const String& name, ZoneProcessServerImplementation* server)
	...
	bool doSlashCommand(Player* player, Message* packet) {
		...
		uint64 wpId = packet->parseLong(); //get the waypoint id
...
#endif //SETWAYPOINTNAMESLASHCOMMAND_H_
