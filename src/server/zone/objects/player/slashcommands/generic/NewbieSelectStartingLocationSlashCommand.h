...
class NewbieSelectStartingLocationSlashCommand : public SlashCommand {
public:

	NewbieSelectStartingLocationSlashCommand(const String& name, ZoneProcessServerImplementation* server)
