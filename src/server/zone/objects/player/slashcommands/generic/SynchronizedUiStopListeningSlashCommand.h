...
class SynchronizedUiStopListeningSlashCommand : public SlashCommand {
public:

	SynchronizedUiStopListeningSlashCommand(const String& name, ZoneProcessServerImplementation* server)
