...
class ExtractObjectSlashCommand : public SlashCommand {
public:

	ExtractObjectSlashCommand(const String& name, ZoneProcessServerImplementation* server)
	...
	bool doSlashCommand(Player* player, Message* packet) {
		...
		//System::out << "In ExtractObjectSlashCommand()" << endl;
		...
		FactoryCrate* crate = (FactoryCrate*) object;
