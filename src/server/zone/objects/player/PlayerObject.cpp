...
PlayerObject::PlayerObject(DistributedObjectServant* obj) : SceneObject(obj) {
}
...
DistributedObjectAdapter* PlayerObjectHelper::createAdapter(DistributedObjectServant* obj) {
	DistributedObjectAdapter* adapter = new PlayerObjectAdapter((PlayerObjectImplementation*) obj);

	DistributedObjectStub* stub = new PlayerObject(obj);
