...
void ResourceSpawn::_setImplementation(DistributedObjectServant* servant) {
	setObject(dynamic_cast<ResourceSpawnImplementation*>(servant));
}
...
Object* ResourceSpawnImplementation::clone() {
	return dynamic_cast<Object*>(new ResourceSpawnImplementation(*this));
}
