...
/*
 *	server/zone/objects/resource/ResourceContainer.h generated by Engine3 IDL compiler 0.51
 */
...
class ResourceContainer : public SceneObject {
public:
	ResourceContainer();
...
class ResourceContainerAdapter : public SceneObjectAdapter {
public:
...
class ResourceContainerServant : public SceneObjectImplementation {
public:
	ResourceContainer* _this;

public:
	ResourceContainerServant(unsigned long long oid);
