...
ZoneClient::ZoneClient() : DistributedObjectStub(NULL) {
}

ZoneClient::ZoneClient(DistributedObjectServant* obj) : DistributedObjectStub(obj) {
}

ZoneClient::ZoneClient(ZoneClient& ref) : DistributedObjectStub(ref) {
}
...
DistributedObjectAdapter* ZoneClientHelper::createAdapter(DistributedObjectServant* obj) {
	DistributedObjectAdapter* adapter = new ZoneClientAdapter((ZoneClientImplementation*) obj);

	DistributedObjectStub* stub = new ZoneClient(obj);
