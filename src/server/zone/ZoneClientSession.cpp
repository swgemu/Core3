...
TransactionalObject* ZoneClientSessionImplementation::clone() {
	ZoneClientSessionImplementation* objectCopy = new ZoneClientSessionImplementation(DummyConstructorParameter::instance());
	*((ZoneClientSessionImplementation*) objectCopy) = *this;
