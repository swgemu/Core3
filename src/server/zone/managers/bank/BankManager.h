...
/*
 *	server/zone/managers/bank/BankManager.h generated by Engine3 IDL compiler 0.51
 */
...
class BankManagerAdapter : public ORBObjectAdapter {
public:
...
class BankManagerHelper : public ORBClassHelper, public Singleton<BankManagerHelper> {
public:
	BankManagerHelper();
...
class BankManagerServant : public ORBObjectServant {
public:
	BankManager* _this;
