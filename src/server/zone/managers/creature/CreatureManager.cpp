...
void CreatureManager::scheduleDespawnCreature(Creature* creature) {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
		...
		((CreatureManagerImplementation*) _impl)->scheduleDespawnCreature(creature);
}
...
Creature* CreatureManager::spawnCreature(unsigned int objcrc, float x, float y, int bitmask, bool baby, bool doLock) {
	if (_impl == NULL) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
Packet* CreatureManagerAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case 13:
		...
		break;
	case 14:
		scheduleDespawnCreature((Creature*) inv->getObjectParameter());
		break;
	case 15:
...
void CreatureManagerAdapter::scheduleDespawnCreature(Creature* creature) {
	return ((CreatureManagerImplementation*) impl)->scheduleDespawnCreature(creature);
}
...
Creature* CreatureManagerAdapter::spawnCreature(unsigned int objcrc, float x, float y, int bitmask, bool baby, bool doLock) {
