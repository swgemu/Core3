...
#ifndef STRUCTUREMANAGERSAVESTATEEVENT_H_
#define STRUCTUREMANAGERSAVESTATEEVENT_H_
...
class StructureManagerSaveStateEvent : public Event {
...
#endif /* STRUCTUREMANAGERSAVESTATEEVENT_H_ */
