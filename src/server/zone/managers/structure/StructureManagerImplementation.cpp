...
StructureManagerImplementation::StructureManagerImplementation(Zone* zne, ZoneProcessServerImplementation* svr)
		: StructureManagerServant(), Logger("StructureManager") {
	zone = zne;
	server = svr;
