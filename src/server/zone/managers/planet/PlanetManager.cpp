...
PlanetManager::PlanetManager() : DistributedObjectStub(NULL) {
}

PlanetManager::PlanetManager(DistributedObjectServant* obj) : DistributedObjectStub(obj) {
}

PlanetManager::PlanetManager(PlanetManager& ref) : DistributedObjectStub(ref) {
}
...
DistributedObjectAdapter* PlanetManagerHelper::createAdapter(DistributedObjectServant* obj) {
	DistributedObjectAdapter* adapter = new PlanetManagerAdapter((PlanetManagerImplementation*) obj);

	DistributedObjectStub* stub = new PlanetManager(obj);
