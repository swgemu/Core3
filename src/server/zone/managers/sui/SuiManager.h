...
public:
	...
	void handleStructureDestroyRequest(uint32 boxID, Player* player, uint32 cancel);
	void handleStructureDestroyCode(uint32 boxID, Player* player, uint32 cancel, const int destroycode);
