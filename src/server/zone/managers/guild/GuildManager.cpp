/*
 *	server/zone/managers/guild/GuildManager.cpp generated by engine3 IDL compiler 0.61
 */
...
GuildManager::GuildManager(ZoneServer* serv, ZoneProcessServerImplementation* proc) : ManagedService(DummyConstructorParameter::instance()) {
...
GuildManagerImplementation::GuildManagerImplementation(ZoneServer* serv, ZoneProcessServerImplementation* proc) {
	_initializeImplementation();
