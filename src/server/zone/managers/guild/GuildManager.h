/*
 *	server/zone/managers/guild/GuildManager.h generated by engine3 IDL compiler 0.61
 */
...
public:
	GuildManager(ZoneServer* serv, ZoneProcessServerImplementation* proc);
...
public:
	GuildManagerImplementation(ZoneServer* serv, ZoneProcessServerImplementation* proc);
