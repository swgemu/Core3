...
PlayerManager::PlayerManager() : DistributedObjectStub(NULL) {
}

PlayerManager::PlayerManager(DistributedObjectServant* obj) : DistributedObjectStub(obj) {
}

PlayerManager::PlayerManager(PlayerManager& ref) : DistributedObjectStub(ref) {
}
...
DistributedObjectAdapter* PlayerManagerHelper::createAdapter(DistributedObjectServant* obj) {
	DistributedObjectAdapter* adapter = new PlayerManagerAdapter((PlayerManagerImplementation*) obj);

	DistributedObjectStub* stub = new PlayerManager(obj);
