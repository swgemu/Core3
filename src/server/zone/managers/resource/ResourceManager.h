...
/*
 *	server/zone/managers/resource/ResourceManager.h generated by Engine3 IDL compiler 0.51
 */
...
class ResourceManagerAdapter : public ORBObjectAdapter {
public:
...
protected:
	string _param0_makeResourceName__string_bool_;
};
