...
/*
 *	server/zone/managers/resource/SpawnLocation.h generated by Engine3 IDL compiler 0.51
 */
...
class SpawnLocation : public ORBObjectStub {
public:
	SpawnLocation();
	SpawnLocation(ORBObjectServant* obj);
	SpawnLocation(SpawnLocation& ref);
...
class SpawnLocationAdapter : public ORBObjectAdapter {
public:
