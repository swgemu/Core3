...
public:
	SpawnLocationImplementation(uint64 id, int inPlanet, float inX, float inY, float inRadius, float inMax, uint64 et, String& inPool) : SpawnLocationServant() {
		objectID = id;
		planet = inPlanet;
		x = inX;
		y = inY;
