...
void GameCommandHandler::printRoomTree(StringTokenizer tokenizer, Player* player) {
	String object;
	tokenizer.getStringToken(object);
	...
	uint32 objectCRC = object.hashCode();

	SceneObject* obj = zoneServer->createObject(objectCRC);
	/*SceneObjectCreateMessage* msg = new SceneObjectCreateMessage(player->getNewItemID(), object.hashCode());
