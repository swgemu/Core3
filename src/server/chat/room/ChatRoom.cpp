...
ChatRoom::ChatRoom() : DistributedObjectStub(NULL) {
}

ChatRoom::ChatRoom(DistributedObjectServant* obj) : DistributedObjectStub(obj) {
}

ChatRoom::ChatRoom(ChatRoom& ref) : DistributedObjectStub(ref) {
}
...
DistributedObjectAdapter* ChatRoomHelper::createAdapter(DistributedObjectServant* obj) {
	DistributedObjectAdapter* adapter = new ChatRoomAdapter((ChatRoomImplementation*) obj);

	DistributedObjectStub* stub = new ChatRoom(obj);
